...
class Cards {
    ...
    public static inline var cards = [[
        ...
        "School bus has flat tire. Stop to help, wait one then move forwa" + "rd one on next turn, plus the draw.",
        ...
        "Runaway zoo animals on freeway. Pull over and lock doors. Wait o" + "ne."
        ...
        "Blowout, radiator overheats, battery dies, and your clunker give" + "s up. Get new car and 'go to' card.",
        ...
        "Blowout on freeway. Good Samaratin changes your tire and moves y" + "ou forward two.",
        ...
        "Instant winner, (NOT pick a new 'from-to' card and car, then st" + "art over and move forward three.",
        ...
        "Family in distress. Stop and help. Wait with them for help to co" + "me.",
        ...
        "Move forward four. If you pass your destination, too bad. Your m" + "ust go four."
        ...
        "Flashing lights behind. Pull over. Keep calm. Show ID and insura" + "nce. Cop says you're ok. Move 3."
        ...
        "Rollover on right shoulder. Call 911. Stop and help. Then carefu" + "lly go forward one.",
        "Olympics in town. Freeway clear. Go forward two."

    ], [

        "Caught in diamond lane with no passenger. Get ticket, then go ba" + "ck one.",
        ...
        "Following too closely. Stop to get warning from police, then wai" + "t here till next turn.",
        ...
        "Police lay down tack strip. You get four flat tires. Wrecker tak" + "es your forward two for repairs.",
        ...
        "Electric cars only today on freeway. Sorry, your car uses gasoli" + "ne. Stay put.",
        ...
        "Student visiting day at Cal Poly Pomona. Take car full of high s" + "chool seniors to visit campus.",
        ...
        "Man behind has road rage. Speed up, go to next exit, call 911, a" + "nd then go right one.",
        ...
        "Border patrol stops traffic to chase illegal immigrants. Wait he" + "re one, but on next turn go up two, plus dice roll."

    ], [

        "Work swing shift. Freeway clear at 4 A.M. Go forward to next off" + "ramp for breakfast, then forward one.",
