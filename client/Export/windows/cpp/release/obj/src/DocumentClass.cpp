...
void DocumentClass_obj::__construct(){
            	HX_STACK_FRAME("DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",381,0x0780ded5)
            	HX_STACK_THIS(this)
HXLINE( 383)		::openfl::Lib_obj::current->addChild(hx::ObjectPtr<OBJ_>(this));
HXLINE( 384)		super::__construct();
HXLINE( 385)		this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("addedToStage",63,22,55,0c),false,false));
            	}
