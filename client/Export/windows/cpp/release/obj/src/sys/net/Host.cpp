...
HXLINE(  59)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_38f389caf85c6b40_47_toString)
HXLINE(  47)		if (hx::IsNull( this->ipv6 )) {
HXLINE(  47)			return _hx_std_host_to_string(this->ip);
            		}
            		else {
HXLINE(  47)			return _hx_std_host_to_string_ipv6(this->ipv6);
            		}
