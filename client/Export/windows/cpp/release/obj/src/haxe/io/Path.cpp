...
::String Path_obj::toString(){
            	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",115,0x4f1aa280)
            	HX_STACK_THIS(this)
...
::String Path_obj::join(::Array< ::String > paths){
            		...
            		Bool _hx_run(::String s){
            			HX_STACK_FRAME("haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",190,0x4f1aa280)
            			HX_STACK_ARG(s,"s")
HXLINE( 190)			Bool _hx_tmp = hx::IsNotNull( s );
...
HXLINE( 226)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__new(HX_("([^:])/+",d7,b8,64,f0),HX_("g",67,00,00,00));
HXLINE( 227)		regex->replace(tmp,(HX_("$1",8d,1f,00,00) + HX_("/",2f,00,00,00)));
HXLINE( 228)		HX_VARI(  ::StringBuf,acc) =  ::StringBuf_obj::__new();
...
HXLINE( 231)				HX_VARI( Int,i) = _g11++;
HXLINE( 232)				{
HXLINE( 232)					HX_VARI_NAME(  ::Dynamic,_g21,"_g2") = tmp.charCodeAt(i);
HXDLIN( 232)					Bool _hx_tmp2 = hx::IsNull( _g21 );
HXDLIN( 232)					if (_hx_tmp2) {
HXLINE( 239)						colon = false;
HXLINE( 240)						if (slashes) {
HXLINE( 241)							{
HXLINE( 241)								Bool _hx_tmp3 = hx::IsNotNull( acc->charBuf );
HXDLIN( 241)								if (_hx_tmp3) {
HXLINE( 241)									acc->flush();
            								}
HXDLIN( 241)								acc->b->push(HX_("/",2f,00,00,00));
            							}
HXLINE( 242)							slashes = false;
            						}
HXLINE( 244)						{
HXLINE( 244)							Bool _hx_tmp4 = hx::IsNotNull( acc->charBuf );
HXDLIN( 244)							if (_hx_tmp4) {
HXLINE( 244)								acc->flush();
            							}
HXDLIN( 244)							::String _hx_tmp5 = ::Std_obj::string(::String::fromCharCode(_g21));
HXDLIN( 244)							acc->b->push(_hx_tmp5);
            						}
            					}
            					else {
...
HXLINE( 240)								if (slashes) {
HXLINE( 241)									{
HXLINE( 241)										Bool _hx_tmp6 = hx::IsNotNull( acc->charBuf );
...
HXLINE( 244)								{
HXLINE( 244)									Bool _hx_tmp7 = hx::IsNotNull( acc->charBuf );
HXDLIN( 244)									if (_hx_tmp7) {
HXLINE( 244)										acc->flush();
            									}
HXDLIN( 244)									::String _hx_tmp8 = ::Std_obj::string(::String::fromCharCode(_g21));
HXDLIN( 244)									acc->b->push(_hx_tmp8);
            								}
            							}
HXLINE( 236)							goto _hx_goto_4;
            						}
            						if (  (_hx_switch_0==(int)58) ){
HXLINE( 234)							{
HXLINE( 234)								Bool _hx_tmp9 = hx::IsNotNull( acc->charBuf );
HXDLIN( 234)								if (_hx_tmp9) {
HXLINE( 234)									acc->flush();
            								}
HXDLIN( 234)								acc->b->push(HX_(":",3a,00,00,00));
            							}
...
HXLINE( 240)							if (slashes) {
HXLINE( 241)								{
HXLINE( 241)									Bool _hx_tmp10 = hx::IsNotNull( acc->charBuf );
...
HXLINE( 244)							{
HXLINE( 244)								Bool _hx_tmp11 = hx::IsNotNull( acc->charBuf );
HXDLIN( 244)								if (_hx_tmp11) {
HXLINE( 244)									acc->flush();
            								}
HXDLIN( 244)								::String _hx_tmp12 = ::Std_obj::string(::String::fromCharCode(_g21));
HXDLIN( 244)								acc->b->push(_hx_tmp12);
            							}
            						}
            						_hx_goto_4:;
            					}
...
HXLINE( 247)		Bool _hx_tmp13 = hx::IsNotNull( acc->charBuf );
HXDLIN( 247)		if (_hx_tmp13) {
HXLINE( 247)			acc->flush();
            		}
HXDLIN( 247)		return acc->b->join(HX_("",00,00,00,00));
            	}
...
Bool Path_obj::isAbsolute(::String path){
            	HX_STACK_FRAME("haxe.io.Path","isAbsolute",0xb396db4a,"haxe.io.Path.isAbsolute","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",301,0x4f1aa280)
            	HX_STACK_ARG(path,"path")
HXLINE( 302)		Bool _hx_tmp = ::StringTools_obj::startsWith(path,HX_("/",2f,00,00,00));
HXDLIN( 302)		if (_hx_tmp) {
HXLINE( 302)			return true;
            		}
HXLINE( 303)		::String _hx_tmp1 = path.charAt((int)1);
HXDLIN( 303)		if ((_hx_tmp1 == HX_(":",3a,00,00,00))) {
