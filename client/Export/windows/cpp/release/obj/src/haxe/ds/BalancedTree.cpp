...
HXLINE( 101)			Bool _hx_tmp = !(hx::IsNotNull( node ));
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,exists,return )
 ...
 ::Dynamic BalancedTree_obj::keys(){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","keys",0xe94e62a5,"haxe.ds.BalancedTree.keys","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",126,0x9022da28)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC3(BalancedTree_obj,setLoop,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::removeLoop( ::Dynamic k, ::haxe::ds::TreeNode node){
            	...
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(node,"node")
HXLINE( 146)		Bool _hx_tmp = hx::IsNull( node );
...
HXLINE( 149)				 ::haxe::ds::TreeNode _hx_tmp1 = this->removeLoop(k,node->left);
HXLINE( 148)				return this->balance(_hx_tmp1,node->key,node->value,node->right);
            			}
            			else {
HXLINE( 150)				 ::haxe::ds::TreeNode _hx_tmp2 = this->removeLoop(k,node->right);
HXLINE( 148)				return this->balance(node->left,node->key,node->value,_hx_tmp2);
            			}
            		}
...
void BalancedTree_obj::keysLoop( ::haxe::ds::TreeNode node,::cpp::VirtualArray acc){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","keysLoop",0x20d5eba9,"haxe.ds.BalancedTree.keysLoop","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",162,0x9022da28)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(node,"node")
            	HX_STACK_ARG(acc,"acc")
HXLINE( 162)		Bool _hx_tmp = hx::IsNotNull( node );
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,keysLoop,(void))
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::merge( ::haxe::ds::TreeNode t1, ::haxe::ds::TreeNode t2){
            	...
            	HX_STACK_ARG(t1,"t1")
            	HX_STACK_ARG(t2,"t2")
HXLINE( 170)		Bool _hx_tmp = hx::IsNull( t1 );
HXDLIN( 170)		if (_hx_tmp) {
HXLINE( 170)			return t2;
            		}
HXLINE( 171)		Bool _hx_tmp1 = hx::IsNull( t2 );
HXDLIN( 171)		if (_hx_tmp1) {
HXLINE( 171)			return t1;
            		}
HXLINE( 172)		HX_VARI(  ::haxe::ds::TreeNode,t) = this->minBinding(t2);
HXLINE( 173)		 ::haxe::ds::TreeNode _hx_tmp2 = this->removeMinBinding(t2);
HXDLIN( 173)		return this->balance(t1,t->key,t->value,_hx_tmp2);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,merge,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::minBinding( ::haxe::ds::TreeNode t){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 177)		Bool _hx_tmp = hx::IsNull( t );
HXDLIN( 177)		if (_hx_tmp) {
HXLINE( 177)			HX_STACK_DO_THROW(HX_("Not_found",b6,92,a5,ea));
            		}
            		else {
HXLINE( 178)			Bool _hx_tmp1 = hx::IsNull( t->left );
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,minBinding,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::removeMinBinding( ::haxe::ds::TreeNode t){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 183)		Bool _hx_tmp = hx::IsNull( t->left );
HXDLIN( 183)		if (_hx_tmp) {
HXLINE( 183)			return t->right;
            		}
            		else {
HXLINE( 184)			 ::haxe::ds::TreeNode _hx_tmp1 = this->removeMinBinding(t->left);
HXLINE( 183)			return this->balance(_hx_tmp1,t->key,t->value,t->right);
            		}
