...
HX_DEFINE_STACK_FRAME(_hx_pos_59aca28affdf7337_79_write,"haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",79,0x660ed7d4)
...
HX_DEFINE_STACK_FRAME(_hx_pos_59aca28affdf7337_167_fieldsString,"haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",167,0x660ed7d4)
HX_DEFINE_STACK_FRAME(_hx_pos_59aca28affdf7337_193_quote,"haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",193,0x660ed7d4)
...
HX_DEFINE_STACK_FRAME(_hx_pos_59aca28affdf7337_225_quoteUtf8,"haxe.format.JsonPrinter","quoteUtf8",0x88683e62,"haxe.format.JsonPrinter.quoteUtf8","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",225,0x660ed7d4)
...
HX_DEFINE_STACK_FRAME(_hx_pos_59aca28affdf7337_44_print,"haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",44,0x660ed7d4)
namespace haxe{
namespace format{
...
HXLINE(  81)		{
HXLINE(  81)			HX_VARI(  ::ValueType,_g) = ::Type_obj::_hx_typeof(v);
...
HXLINE( 136)						_this->b->push(HX_("null",87,9e,0e,49));
            				...
            				break;
            				case (int)1: {
HXLINE(  87)					HX_VARI_NAME( ::String,v1,"v") = ( (::String)(v) );
HXDLIN(  87)					{
...
HXLINE(  87)							HX_VARI_NAME( ::Array< ::String >,_this2,"_this") = _this1->b;
HXDLIN(  87)							_this2->push(::Std_obj::string(v1));
            				...
            				break;
            				case (int)2: {
HXLINE(  89)					HX_VAR_NAME( ::String,v2,"v");
...
HXDLIN(  89)					{
HXLINE(  89)						HX_VARI_NAME(  ::StringBuf,_this3,"_this") = this->buf;
...
HXLINE(  89)							HX_VARI_NAME( ::Array< ::String >,_this4,"_this") = _this3->b;
HXDLIN(  89)							_this4->push(::Std_obj::string(v2));
            				...
            				break;
            				case (int)3: {
HXLINE( 134)					HX_VARI_NAME( ::String,v3,"v") = ( (::String)(v) );
HXDLIN( 134)					{
HXLINE( 134)						HX_VARI_NAME(  ::StringBuf,_this5,"_this") = this->buf;
...
HXLINE( 134)							HX_VARI_NAME( ::Array< ::String >,_this6,"_this") = _this5->b;
...
HXLINE(  85)					this->fieldsString(v,::Reflect_obj::fields(v));
            				...
            				break;
            				case (int)5: {
HXLINE(  91)					HX_VARI_NAME(  ::StringBuf,_this7,"_this") = this->buf;
...
HXLINE( 104)										HX_VARI_NAME(  ::StringBuf,_this10,"_this") = this->buf;
...
HXLINE( 105)										HX_VARI_NAME( ::String,v5,"v") = ::StringTools_obj::lpad(HX_("",00,00,00,00),this->indent,(this->nind * this->indent.length));
HXDLIN( 105)										{
HXLINE( 105)											HX_VARI_NAME(  ::StringBuf,_this11,"_this") = this->buf;
...
HXLINE( 105)												HX_VARI_NAME( ::Array< ::String >,_this12,"_this") = _this11->b;
...
HXLINE( 110)											HX_VARI_NAME(  ::StringBuf,_this13,"_this") = this->buf;
...
HXLINE( 111)											HX_VARI_NAME( ::String,v6,"v") = ::StringTools_obj::lpad(HX_("",00,00,00,00),this->indent,(this->nind * this->indent.length));
HXDLIN( 111)											{
HXLINE( 111)												HX_VARI_NAME(  ::StringBuf,_this14,"_this") = this->buf;
...
HXLINE( 111)													HX_VARI_NAME( ::Array< ::String >,_this15,"_this") = _this14->b;
...
HXLINE( 114)							{
HXLINE( 114)								HX_VARI_NAME(  ::StringBuf,_this16,"_this") = this->buf;
...
HXLINE( 116)								HX_VARI_NAME(  ::haxe::ds::StringMap,v7,"v") = ( ( ::haxe::ds::StringMap)(v) );
HXLINE( 117)								HX_VARI(  ::Dynamic,o) =  ::Dynamic(hx::Anon_obj::Create(0));
HXLINE( 118)								{
HXLINE( 118)									HX_VARI_NAME(  ::Dynamic,k1,"k") = v7->keys();
HXDLIN( 118)									while(( (bool)(k1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 118)										HX_VARI_NAME( ::String,k2,"k") = ( (::String)(k1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 123)									this->quote(( ( ::Date)(v) )->toString());
            								}
            								else {
HXLINE( 128)									this->fieldsString(v,::Reflect_obj::fields(v));
            				...
            				break;
            				case (int)7: {
HXLINE( 132)					HX_VARI_NAME( ::String,v8,"v") = ( (::String)(_hx_getEnumValueIndex(v)) );
HXDLIN( 132)					{
HXLINE( 132)						HX_VARI_NAME(  ::StringBuf,_this17,"_this") = this->buf;
HXDLIN( 132)						if (hx::IsNotNull( _this17->charBuf )) {
HXLINE( 132)							_this17->flush();
            						}
HXDLIN( 132)						if (hx::IsNull( _this17->b )) {
HXLINE( 132)							_this17->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v8));
            						}
            						else {
HXLINE( 132)							HX_VARI_NAME( ::Array< ::String >,_this18,"_this") = _this17->b;
HXDLIN( 132)							_this18->push(::Std_obj::string(v8));
            						}
            					}
            				}
            				break;
            				case (int)8: {
HXLINE(  83)					HX_VARI_NAME(  ::StringBuf,_this19,"_this") = this->buf;
...
HXLINE( 178)							_this3->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v1));
            						}
            						else {
HXLINE( 178)							HX_VARI_NAME( ::Array< ::String >,_this4,"_this") = _this3->b;
HXDLIN( 178)							_this4->push(::Std_obj::string(v1));
            						}
            					}
            				}
HXLINE( 179)				this->quote(f);
HXLINE( 180)				{
HXLINE( 180)					HX_VARI_NAME(  ::StringBuf,_this5,"_this") = this->buf;
...
HXLINE( 181)					HX_VARI_NAME(  ::StringBuf,_this6,"_this") = this->buf;
...
HXLINE( 186)						HX_VARI_NAME(  ::StringBuf,_this7,"_this") = this->buf;
...
HXDLIN( 187)						{
HXLINE( 187)							HX_VARI_NAME(  ::StringBuf,_this8,"_this") = this->buf;
HXDLIN( 187)							if (hx::IsNotNull( _this8->charBuf )) {
HXLINE( 187)								_this8->flush();
            							}
HXDLIN( 187)							if (hx::IsNull( _this8->b )) {
HXLINE( 187)								_this8->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v2));
            							}
            							else {
HXLINE( 187)								HX_VARI_NAME( ::Array< ::String >,_this9,"_this") = _this8->b;
HXDLIN( 187)								_this9->push(::Std_obj::string(v2));
            							}
            						}
            					}
            				}
...
HXLINE( 190)		{
HXLINE( 190)			HX_VARI_NAME(  ::StringBuf,_this10,"_this") = this->buf;
...
void JsonPrinter_obj::quote(::String s){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE( 195)		HX_VARI_NAME( int,s1,"s") = s.length;
...
HXDLIN( 203)			HX_VARI( int,c) = s.cca((i - (int)1));
...
void JsonPrinter_obj::quoteUtf8(::String s){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE( 226)		HX_VARI(  ::haxe::Utf8,u) =  ::haxe::Utf8_obj::__alloc( HX_CTX ,null());
HXLINE( 227)		{
...
HXDLIN( 239)			HX_VARI( ::String,x) = u->toString();
...
HXLINE( 239)				HX_VARI_NAME( ::Array< ::String >,_this2,"_this") = _this1->b;
HXDLIN( 239)				_this2->push(::Std_obj::string(x));
            			}
            		}
HXLINE( 240)		{
HXLINE( 240)			HX_VARI_NAME(  ::StringBuf,_this3,"_this") = this->buf;
...
::String JsonPrinter_obj::print( ::Dynamic o, ::Dynamic replacer,::String space){
            	...
            	HX_STACK_ARG(replacer,"replacer")
            	HX_STACK_ARG(space,"space")
HXLINE(  45)		HX_VARI(  ::haxe::format::JsonPrinter,printer) =  ::haxe::format::JsonPrinter_obj::__alloc( HX_CTX ,replacer,space);
