...
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_29_getColor,"Player","getColor",0x3ba9877a,"Player.getColor","Player.hx",29,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_32_setColor,"Player","setColor",0xea06e0ee,"Player.setColor","Player.hx",32,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_37_setLoc,"Player","setLoc",0xda5d3b4b,"Player.setLoc","Player.hx",37,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_62_getLoc,"Player","getLoc",0x0e14e6d7,"Player.getLoc","Player.hx",62,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_65_setDest,"Player","setDest",0x31e56937,"Player.setDest","Player.hx",65,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_87_isMe,"Player","isMe",0x1a1169ef,"Player.isMe","Player.hx",87,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_91_getDest,"Player","getDest",0x3ee3d82b,"Player.getDest","Player.hx",91,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_94_onGoal,"Player","onGoal",0x51e6eb1f,"Player.onGoal","Player.hx",94,0xa27fc9dd)
HX_LOCAL_STACK_FRAME(_hx_pos_9d6b32c958ffa4d3_97_arrived,"Player","arrived",0x69bb5680,"Player.arrived","Player.hx",97,0xa27fc9dd)
...
::String Player_obj::getColor(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_29_getColor)
...
void Player_obj::setColor(::String c){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_32_setColor)
HXLINE(  33)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  33)		_hx_tmp((((HX_("",00,00,00,00) + this->user) + HX_(".color <- ",64,6b,4a,93)) + c),hx::SourceInfo(HX_("Player.hx",dd,c9,7f,a2),33,HX_("Player",81,5f,4d,6c),HX_("setColor",61,da,90,58)));
...
void Player_obj::setLoc(::String l){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_37_setLoc)
HXLINE(  39)		bool _hx_tmp;
HXDLIN(  39)		if (this->isMe()) {
...
HXLINE(  41)		if (this->isMe()) {
HXLINE(  41)			this->g->t->map->get(l).StaticCast<  ::Node >()->set_visible(true);
            		}
HXLINE(  43)		 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN(  43)		_hx_tmp1((((HX_("",00,00,00,00) + this->user) + HX_(".loc <- ",81,98,bb,49)) + this->loc),hx::SourceInfo(HX_("Player.hx",dd,c9,7f,a2),43,HX_("Player",81,5f,4d,6c),HX_("setLoc",fe,e1,69,6f)));
HXLINE(  46)		if (this->isMe()) {
HXLINE(  46)			this->g->v->animating = true;
            		}
HXLINE(  48)		{
HXLINE(  48)			::String _g = this->color;
...
::String Player_obj::getLoc(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_62_getLoc)
...
void Player_obj::setDest(::String d){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_65_setDest)
HXLINE(  67)		this->dest = d;
HXLINE(  69)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  69)		_hx_tmp((((HX_("",00,00,00,00) + this->user) + HX_(".dest <- ",ff,97,e7,81)) + this->dest),hx::SourceInfo(HX_("Player.hx",dd,c9,7f,a2),69,HX_("Player",81,5f,4d,6c),HX_("setDest",24,9f,ea,07)));
HXLINE(  71)		{
HXLINE(  71)			::String _g = this->color;
HXDLIN(  71)			::String _hx_switch_0 = _g;
            			if (  (_hx_switch_0==HX_("b",62,00,00,00)) ){
HXLINE(  76)				this->g->v->aimBD(this->dest);
HXDLIN(  76)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("g",67,00,00,00)) ){
HXLINE(  75)				this->g->v->aimGD(this->dest);
HXDLIN(  75)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("i",69,00,00,00)) ){
...
bool Player_obj::isMe(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_87_isMe)
...
::String Player_obj::getDest(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_91_getDest)
...
bool Player_obj::onGoal(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_94_onGoal)
...
void Player_obj::arrived(){
            	HX_STACKFRAME(&_hx_pos_9d6b32c958ffa4d3_97_arrived)
...
hx::ObjectPtr< Player_obj > Player_obj::__new( ::Globals g,::String user) {
	...
	__this->__construct(g,user);
	return __this;
}

hx::ObjectPtr< Player_obj > Player_obj::__alloc(hx::Ctx *_hx_ctx, ::Globals g,::String user) {
