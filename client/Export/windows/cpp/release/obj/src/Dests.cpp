...
void Dests_obj::__construct(){
            	HX_STACK_FRAME("Dests","new",0xfe617523,"Dests.new","Dests.hx",5,0xab0abfad)
            	HX_STACK_THIS(this)
HXLINE(  16)		HX_VARI(  ::openfl::display::Tile,tile) =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  16)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
HXDLIN(  16)		set->addRect(png->rect);
HXDLIN(  16)		tile->set_tileset(set);
HXDLIN(  16)		this->v = tile;
HXLINE(  15)		HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  15)		HX_VARI_NAME(  ::openfl::display::Tileset,set1,"set") =  ::openfl::display::Tileset_obj::__new(png1,null());
HXDLIN(  15)		set1->addRect(png1->rect);
HXDLIN(  15)		tile1->set_tileset(set1);
HXDLIN(  15)		this->i = tile1;
HXLINE(  14)		HX_VARI_NAME(  ::openfl::display::Tile,tile2,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  14)		HX_VARI_NAME(  ::openfl::display::Tileset,set2,"set") =  ::openfl::display::Tileset_obj::__new(png2,null());
HXDLIN(  14)		set2->addRect(png2->rect);
HXDLIN(  14)		tile2->set_tileset(set2);
HXDLIN(  14)		this->b = tile2;
HXLINE(  13)		HX_VARI_NAME(  ::openfl::display::Tile,tile3,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  13)		HX_VARI_NAME(  ::openfl::display::Tileset,set3,"set") =  ::openfl::display::Tileset_obj::__new(png3,null());
HXDLIN(  13)		set3->addRect(png3->rect);
HXDLIN(  13)		tile3->set_tileset(set3);
HXDLIN(  13)		this->g = tile3;
HXLINE(  12)		HX_VARI_NAME(  ::openfl::display::Tile,tile4,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  12)		HX_VARI_NAME(  ::openfl::display::Tileset,set4,"set") =  ::openfl::display::Tileset_obj::__new(png4,null());
HXDLIN(  12)		set4->addRect(png4->rect);
HXDLIN(  12)		tile4->set_tileset(set4);
HXDLIN(  12)		this->y = tile4;
HXLINE(  11)		HX_VARI_NAME(  ::openfl::display::Tile,tile5,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  11)		HX_VARI_NAME(  ::openfl::display::Tileset,set5,"set") =  ::openfl::display::Tileset_obj::__new(png5,null());
HXDLIN(  11)		set5->addRect(png5->rect);
HXDLIN(  11)		tile5->set_tileset(set5);
HXDLIN(  11)		this->o = tile5;
HXLINE(  10)		HX_VARI_NAME(  ::openfl::display::Tile,tile6,"tile") =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
...
HXDLIN(  10)		HX_VARI_NAME(  ::openfl::display::Tileset,set6,"set") =  ::openfl::display::Tileset_obj::__new(png6,null());
...
{
{
            	HX_STACK_FRAME("Dests","boot",0x8efe0a0f,"Dests.boot","Dests.hx",7,0xab0abfad)
HXLINE(   7)		WIDTH = (int)74;
            	}
{
            	HX_STACK_FRAME("Dests","boot",0x8efe0a0f,"Dests.boot","Dests.hx",8,0xab0abfad)
