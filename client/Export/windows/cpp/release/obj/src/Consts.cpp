...
HXLINE(  69)		Float _hx_tmp = t->get_width();
HXDLIN(  69)		t->set_x((x - ((Float)_hx_tmp / (Float)(int)2)));
HXLINE(  70)		t->set_y(y);
HXLINE(  71)		t->set_autoSize((int)0);
HXLINE(  72)		t->set_selectable(false);
HXLINE(  75)		 ::openfl::text::Font _this = ::openfl::Assets_obj::getFont(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),null());
HXLINE(  74)		t->setTextFormat( ::openfl::text::TextFormat_obj::__new(_this->name,pt,c,true,null(),null(),null(),null(),null(),null(),null(),null(),null()),null(),null());
HXLINE(  81)		return t;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(Consts_obj,text,return )
 ...
 ::openfl::text::TextField Consts_obj::textBox(::String s,Float x,Float y,Int pt){
            	HX_STACK_FRAME("Consts","textBox",0x1ff996c0,"Consts.textBox","Consts.hx",84,0xf1f392ee)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(pt,"pt")
HXLINE(  85)		HX_VARI(  ::openfl::text::TextField,t) =  ::openfl::text::TextField_obj::__new();
HXLINE(  86)		t->set_embedFonts(true);
HXLINE(  88)		 ::openfl::text::Font _this = ::openfl::Assets_obj::getFont(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),null());
HXLINE(  87)		t->setTextFormat( ::openfl::text::TextFormat_obj::__new(_this->name,pt,(int)8323072,true,null(),null(),null(),null(),null(),null(),null(),null(),null()),null(),null());
...
HXLINE( 101)		Float _hx_tmp = t->get_width();
HXDLIN( 101)		Int _hx_tmp1 = ::Std_obj::_hx_int(((Float)_hx_tmp / (Float)pt));
HXDLIN( 101)		t->set_maxChars(_hx_tmp1);
...
Float Consts_obj::diff(Float a,Float b){
            	HX_STACK_FRAME("Consts","diff",0x0180c763,"Consts.diff","Consts.hx",111,0xf1f392ee)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
Float Consts_obj::dist(Int ax,Int ay,Int bx,Int by){
            	HX_STACK_FRAME("Consts","dist",0x0180d2c4,"Consts.dist","Consts.hx",118,0xf1f392ee)
            	HX_STACK_ARG(ax,"ax")
            	HX_STACK_ARG(ay,"ay")
            	HX_STACK_ARG(bx,"bx")
            	HX_STACK_ARG(by,"by")
HXLINE( 118)		Float _hx_tmp = ::Math_obj::pow((bx - ax),(int)2);
HXDLIN( 118)		Float _hx_tmp1 = ::Math_obj::pow((by - ay),(int)2);
HXDLIN( 118)		return ::Math_obj::sqrt((_hx_tmp + _hx_tmp1));
            	}
...
Float Consts_obj::scale(Int w,Int h){
            	HX_STACK_FRAME("Consts","scale",0xee35556c,"Consts.scale","Consts.hx",125,0xf1f392ee)
            	HX_STACK_ARG(w,"w")
            	HX_STACK_ARG(h,"h")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Consts_obj,scale,return )
 ...
 ::openfl::media::Sound Consts_obj::sound(::String dir){
            	HX_STACK_FRAME("Consts","sound",0xf63313b1,"Consts.sound","Consts.hx",132,0xf1f392ee)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Consts_obj,sound,return )
 ...
 ::openfl::display::BitmapData Consts_obj::bmp(::String dir){
            	HX_STACK_FRAME("Consts","bmp",0xc32866a7,"Consts.bmp","Consts.hx",139,0xf1f392ee)
            	HX_STACK_ARG(dir,"dir")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Consts_obj,bmp,return )
 ...
 ::openfl::display::Tileset Consts_obj::tileset(::String dir){
            	HX_STACK_FRAME("Consts","tileset",0xc6d30496,"Consts.tileset","Consts.hx",145,0xf1f392ee)
            	HX_STACK_ARG(dir,"dir")
HXLINE( 146)		HX_VARI(  ::openfl::display::BitmapData,png) = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + dir),null());
HXLINE( 147)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Consts_obj,tileset,return )
 ...
 ::openfl::display::Tile Consts_obj::tile(::String dir){
            	HX_STACK_FRAME("Consts","tile",0x0c14368c,"Consts.tile","Consts.hx",155,0xf1f392ee)
            	HX_STACK_ARG(dir,"dir")
HXLINE( 156)		HX_VARI(  ::openfl::display::Tile,tile) =  ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 157)		HX_VARI(  ::openfl::display::BitmapData,png) = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + dir),null());
HXDLIN( 157)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
...
Int h = __o_h.Default(-1);
            	HX_STACK_FRAME("Consts","tilemap",0xc6ce7390,"Consts.tilemap","Consts.hx",164,0xf1f392ee)
            	HX_STACK_ARG(dir,"dir")
            	HX_STACK_ARG(w,"w")
            	HX_STACK_ARG(h,"h")
HXLINE( 165)		HX_VARI(  ::openfl::display::BitmapData,png) = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + dir),null());
HXDLIN( 165)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
HXDLIN( 165)		set->addRect(png->rect);
HXLINE( 168)		Int _hx_tmp;
HXDLIN( 168)		if ((w < (int)0)) {
HXLINE( 168)			_hx_tmp = ::Std_obj::_hx_int(set->getRect((int)0)->width);
            		}
            		else {
HXLINE( 168)			_hx_tmp = w;
            		}
HXLINE( 169)		Int _hx_tmp1;
HXDLIN( 169)		if ((h < (int)0)) {
HXLINE( 169)			_hx_tmp1 = ::Std_obj::_hx_int(set->getRect((int)0)->height);
            		}
            		else {
HXLINE( 169)			_hx_tmp1 = h;
            		}
HXLINE( 167)		HX_VARI(  ::openfl::display::Tilemap,map) =  ::openfl::display::Tilemap_obj::__new(_hx_tmp,_hx_tmp1,set,null());
HXLINE( 173)		map->addTile( ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null()));
HXLINE( 175)		return map;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Consts_obj,tilemap,return )
 ...
 ::openfl::display::Sprite Consts_obj::mapToSprite( ::openfl::display::Tilemap map){
            	HX_STACK_FRAME("Consts","mapToSprite",0x411122fe,"Consts.mapToSprite","Consts.hx",181,0xf1f392ee)
            	HX_STACK_ARG(map,"map")
HXLINE( 182)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__new();
...
Int y = __o_y.Default(0);
            	HX_STACK_FRAME("Consts","sprite",0x07e55ae3,"Consts.sprite","Consts.hx",191,0xf1f392ee)
            	HX_STACK_ARG(dir,"dir")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 192)		HX_VARI(  ::openfl::display::BitmapData,png) = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + dir),null());
HXDLIN( 192)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
HXDLIN( 192)		set->addRect(png->rect);
HXDLIN( 192)		Int _hx_tmp;
HXDLIN( 192)		_hx_tmp = ::Std_obj::_hx_int(set->getRect((int)0)->width);
HXDLIN( 192)		Int _hx_tmp1;
HXDLIN( 192)		_hx_tmp1 = ::Std_obj::_hx_int(set->getRect((int)0)->height);
HXDLIN( 192)		HX_VARI(  ::openfl::display::Tilemap,map) =  ::openfl::display::Tilemap_obj::__new(_hx_tmp,_hx_tmp1,set,null());
HXDLIN( 192)		map->addTile( ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null()));
HXDLIN( 192)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__new();
HXDLIN( 192)		sprite->addChild(map);
...
Float Consts_obj::center(Float line,Float point){
            	HX_STACK_FRAME("Consts","center",0x4a2aa4b3,"Consts.center","Consts.hx",203,0xf1f392ee)
...
::Array< ::Dynamic> Consts_obj::locations( ::openfl::display::BitmapData image){
            	HX_STACK_FRAME("Consts","locations",0xab0aa080,"Consts.locations","Consts.hx",209,0xf1f392ee)
...
HXLINE( 216)				HX_VARI( Int,j) = _g1++;
HXLINE( 217)				{
HXLINE( 217)					HX_VARI( Int,_g3) = (int)0;
HXDLIN( 217)					HX_VARI( Int,_g2) = image->width;
HXDLIN( 217)					while((_g3 < _g2)){
HXLINE( 217)						HX_VARI( Int,i) = _g3++;
HXLINE( 218)						HX_VARI( Bool,newLoc) = true;
HXLINE( 220)						Int _hx_tmp = image->getPixel(i,j);
HXDLIN( 220)						if ((_hx_tmp == (int)16711680)) {
HXLINE( 221)							Bool _hx_tmp1 = (points->length > (int)0);
...
HXDLIN( 222)										Int _hx_tmp3 = (( (Int)(p->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) ) - i);
HXDLIN( 222)										Float _hx_tmp4 = ::Math_obj::abs(_hx_tmp3);
HXDLIN( 222)										if ((_hx_tmp4 <= (int)12)) {
HXLINE( 222)											Int _hx_tmp5 = (( (Int)(p->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) ) - j);
HXDLIN( 222)											Float _hx_tmp6 = ::Math_obj::abs(_hx_tmp5);
HXDLIN( 222)											_hx_tmp2 = (_hx_tmp6 <= (int)13);
            										}
            										else {
...
Int Consts_obj::nameToIndex(::String name,::Array< ::String > names){
            	HX_STACK_FRAME("Consts","nameToIndex",0x6d6628ee,"Consts.nameToIndex","Consts.hx",234,0xf1f392ee)
