...
HX_DEFINE_STACK_FRAME(_hx_pos_69efd8c9269cf369_7_new,"Game","new",0x79ba3204,"Game.new","Game.hx",7,0x56a4f9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_69efd8c9269cf369_16_pushIn,"Game","pushIn",0xe6a0393b,"Game.pushIn","Game.hx",16,0x56a4f9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_69efd8c9269cf369_20_popOut,"Game","popOut",0x702a4859,"Game.popOut","Game.hx",20,0x56a4f9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_69efd8c9269cf369_25_addAnimation,"Game","addAnimation",0xdb835a7f,"Game.addAnimation","Game.hx",25,0x56a4f9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_69efd8c9269cf369_28_frame,"Game","frame",0x6f808ad1,"Game.frame","Game.hx",28,0x56a4f9ec)

void Game_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_69efd8c9269cf369_7_new)
...
void Game_obj::pushIn(){
            	HX_STACKFRAME(&_hx_pos_69efd8c9269cf369_16_pushIn)
...
void Game_obj::popOut(){
            	HX_STACKFRAME(&_hx_pos_69efd8c9269cf369_20_popOut)
...
void Game_obj::addAnimation(::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_69efd8c9269cf369_25_addAnimation)
...
void Game_obj::frame( ::openfl::events::Event e){
            	HX_STACKFRAME(&_hx_pos_69efd8c9269cf369_28_frame)
HXLINE(  29)		Float time = ((Float)::lime::_hx_system::System_obj::getTimer() / (Float)(int)1000);
HXLINE(  31)		{
HXLINE(  31)			int _g = (int)0;
HXDLIN(  31)			::Array< ::Dynamic> _g1 = this->animatibles;
HXDLIN(  31)			while((_g < _g1->length)){
HXLINE(  31)				 ::Dynamic a = _g1->__get(_g);
HXDLIN(  31)				_g = (_g + (int)1);
HXDLIN(  31)				bool _hx_tmp;
HXDLIN(  31)				if (( (bool)(a->__Field(HX_("animating",1e,ee,34,4b),hx::paccDynamic)) )) {
HXLINE(  31)					_hx_tmp = (time > ( (Float)(a->__Field(HX_("future",43,98,4e,73),hx::paccDynamic)) ));
            				}
            				else {
HXLINE(  31)					_hx_tmp = false;
            				}
HXDLIN(  31)				if (_hx_tmp) {
HXLINE(  32)					a->__Field(HX_("transition",95,8d,af,58),hx::paccDynamic)();
