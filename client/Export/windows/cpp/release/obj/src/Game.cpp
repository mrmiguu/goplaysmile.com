...
HX_DEFINE_STACK_FRAME(_hx_pos_69efd8c9269cf369_16_pushIn,"Game","pushIn",0xe6a0393b,"Game.pushIn","Game.hx",16,0x56a4f9ec)
HX_DEFINE_STACK_FRAME(_hx_pos_69efd8c9269cf369_20_popOut,"Game","popOut",0x702a4859,"Game.popOut","Game.hx",20,0x56a4f9ec)
HX_DEFINE_STACK_FRAME(_hx_pos_69efd8c9269cf369_25_addAnimation,"Game","addAnimation",0xdb835a7f,"Game.addAnimation","Game.hx",25,0x56a4f9ec)
HX_DEFINE_STACK_FRAME(_hx_pos_69efd8c9269cf369_28_frame,"Game","frame",0x6f808ad1,"Game.frame","Game.hx",28,0x56a4f9ec)
...
void Game_obj::frame( ::openfl::events::Event e){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(e,"e")
HXLINE(  29)		HX_VARI( Float,time) = ((Float)::lime::_hx_system::System_obj::getTimer() / (Float)(int)1000);
HXLINE(  31)		{
