...
void Button_obj::__construct( ::Globals g, ::openfl::display::Sprite parent,::String dir){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",10,0xf1be03ec)
            		}
            		HX_END_LOCAL_FUNC0((void))

            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(0)
            		void _hx_run(){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",9,0xf1be03ec)
            		}
            		HX_END_LOCAL_FUNC0((void))

            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_2, ::Button,_gthis) HXARGC(1)
            		void _hx_run( ::Dynamic _){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",24,0xf1be03ec)
            			HX_STACK_ARG(_,"_")
HXLINE(  24)			_gthis->pushIn();
            		...
            		void _hx_run( ::Dynamic _1){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",25,0xf1be03ec)
            			HX_STACK_ARG(_1,"_1")
HXLINE(  25)			_gthis->popOut();
            		...
            		void _hx_run( ::Dynamic _2){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",26,0xf1be03ec)
            			HX_STACK_ARG(_2,"_2")
HXLINE(  26)			_gthis->reset();
            		...
            		void _hx_run( ::Dynamic _3){
            			HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",27,0xf1be03ec)
            			HX_STACK_ARG(_3,"_3")
HXLINE(  27)			_gthis->reset();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("Button","new",0x9489e804,"Button.new","Button.hx",8,0xf1be03ec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(g,"g")
...
HXLINE(  16)		HX_VARI(  ::Button,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  17)		super::__construct();
HXLINE(  19)		this->g = g;
HXLINE(  21)		HX_VARI(  ::openfl::display::BitmapData,png) = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + ((HX_("",00,00,00,00) + dir) + HX_("_up.png",b5,6e,d6,d1))),null());
HXDLIN(  21)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__new(png,null());
HXDLIN(  21)		set->addRect(png->rect);
HXDLIN(  21)		Int _hx_tmp = ::Std_obj::_hx_int(set->getRect((int)0)->width);
HXDLIN(  21)		Int _hx_tmp1 = ::Std_obj::_hx_int(set->getRect((int)0)->height);
HXDLIN(  21)		HX_VARI(  ::openfl::display::Tilemap,map) =  ::openfl::display::Tilemap_obj::__new(_hx_tmp,_hx_tmp1,set,null());
HXDLIN(  21)		map->addTile( ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null()));
HXDLIN(  21)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__new();
HXDLIN(  21)		sprite->addChild(map);
HXDLIN(  21)		sprite->set_x((int)0);
HXDLIN(  21)		sprite->set_y((int)0);
HXDLIN(  21)		this->up = sprite;
HXLINE(  22)		HX_VARI_NAME(  ::openfl::display::BitmapData,png1,"png") = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + ((HX_("",00,00,00,00) + dir) + HX_("_down.png",fc,f5,61,b0))),null());
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Tileset,set1,"set") =  ::openfl::display::Tileset_obj::__new(png1,null());
HXDLIN(  22)		set1->addRect(png1->rect);
HXDLIN(  22)		Int _hx_tmp2 = ::Std_obj::_hx_int(set1->getRect((int)0)->width);
HXDLIN(  22)		Int _hx_tmp3 = ::Std_obj::_hx_int(set1->getRect((int)0)->height);
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Tilemap,map1,"map") =  ::openfl::display::Tilemap_obj::__new(_hx_tmp2,_hx_tmp3,set1,null());
HXDLIN(  22)		map1->addTile( ::openfl::display::Tile_obj::__new(null(),null(),null(),null(),null(),null()));
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Sprite,sprite1,"sprite") =  ::openfl::display::Sprite_obj::__new();
HXDLIN(  22)		sprite1->addChild(map1);
HXDLIN(  22)		sprite1->set_x((int)0);
HXDLIN(  22)		sprite1->set_y((int)0);
HXDLIN(  22)		this->down = sprite1;
...
hx::ObjectPtr< Button_obj > Button_obj::__new( ::Globals g, ::openfl::display::Sprite parent,::String dir)
{
	...
	_hx_result->__construct(g,parent,dir);
	return _hx_result;
}
...
void Button_obj::onPush( ::Dynamic f){
            	HX_STACK_FRAME("Button","onPush",0xfec46175,"Button.onPush","Button.hx",34,0xf1be03ec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void Button_obj::onPop( ::Dynamic f){
            	HX_STACK_FRAME("Button","onPop",0xd2133a56,"Button.onPop","Button.hx",35,0xf1be03ec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void Button_obj::pushIn(){
            	HX_STACK_FRAME("Button","pushIn",0x8406433b,"Button.pushIn","Button.hx",37,0xf1be03ec)
            	HX_STACK_THIS(this)
HXLINE(  38)		{
HXLINE(  38)			HX_VARI( Int,_g1) = (int)0;
HXDLIN(  38)			HX_VARI( Int,_g) = this->get_numChildren();
HXDLIN(  38)			while((_g1 < _g)){
HXLINE(  38)				HX_VARI( Int,i) = _g1++;
HXLINE(  39)				HX_VARI(  ::openfl::display::DisplayObject,child) = this->getChildAt(i);
...
HXLINE(  41)					Float _hx_tmp1 = child->get_y();
HXDLIN(  41)					child->set_y((_hx_tmp1 + (int)3));
            				}
            			}
            		}
...
void Button_obj::reset(){
            	HX_STACK_FRAME("Button","reset",0x866e9273,"Button.reset","Button.hx",51,0xf1be03ec)
            	HX_STACK_THIS(this)
HXLINE(  52)		Bool _hx_tmp = this->pushed;
HXDLIN(  52)		if (_hx_tmp) {
HXLINE(  52)			HX_VARI( Int,_g1) = (int)0;
HXDLIN(  52)			HX_VARI( Int,_g) = this->get_numChildren();
HXDLIN(  52)			while((_g1 < _g)){
HXLINE(  52)				HX_VARI( Int,i) = _g1++;
HXLINE(  53)				HX_VARI(  ::openfl::display::DisplayObject,child) = this->getChildAt(i);
HXLINE(  54)				Bool _hx_tmp1;
HXDLIN(  54)				if (hx::IsNotEq( child,this->up )) {
HXLINE(  54)					_hx_tmp1 = hx::IsNotEq( child,this->down );
            				}
            				else {
HXLINE(  54)					_hx_tmp1 = false;
            				}
HXDLIN(  54)				if (_hx_tmp1) {
HXLINE(  55)					Float _hx_tmp2 = child->get_y();
HXDLIN(  55)					child->set_y((_hx_tmp2 - (int)3));
            				}
            			}
            		}
...
void Button_obj::popOut(){
            	HX_STACK_FRAME("Button","popOut",0x0d905259,"Button.popOut","Button.hx",63,0xf1be03ec)
            	HX_STACK_THIS(this)
