...
HX_DEFINE_STACK_FRAME(_hx_pos_95476733ad03172e_34_onPush,"Button","onPush",0xfec46175,"Button.onPush","Button.hx",34,0xf1be03ec)
HX_DEFINE_STACK_FRAME(_hx_pos_95476733ad03172e_35_onPop,"Button","onPop",0xd2133a56,"Button.onPop","Button.hx",35,0xf1be03ec)
HX_DEFINE_STACK_FRAME(_hx_pos_95476733ad03172e_37_pushIn,"Button","pushIn",0x8406433b,"Button.pushIn","Button.hx",37,0xf1be03ec)
HX_DEFINE_STACK_FRAME(_hx_pos_95476733ad03172e_51_reset,"Button","reset",0x866e9273,"Button.reset","Button.hx",51,0xf1be03ec)
HX_DEFINE_STACK_FRAME(_hx_pos_95476733ad03172e_63_popOut,"Button","popOut",0x0d905259,"Button.popOut","Button.hx",63,0xf1be03ec)
...
HXDLIN(  21)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,null());
HXDLIN(  21)		set->addRect(png->rect);
HXDLIN(  21)		HX_VARI( int,map) = ::Std_obj::_hx_int(set->getRect((int)0)->width);
HXDLIN(  21)		HX_VARI_NAME(  ::openfl::display::Tilemap,map2,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map,::Std_obj::_hx_int(set->getRect((int)0)->height),set,null());
HXDLIN(  21)		map2->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXDLIN(  21)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Tileset,set1,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png1,null());
HXDLIN(  22)		set1->addRect(png1->rect);
HXDLIN(  22)		HX_VARI_NAME( int,map3,"map") = ::Std_obj::_hx_int(set1->getRect((int)0)->width);
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Tilemap,map5,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map3,::Std_obj::_hx_int(set1->getRect((int)0)->height),set1,null());
HXDLIN(  22)		map5->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXDLIN(  22)		HX_VARI_NAME(  ::openfl::display::Sprite,sprite1,"sprite") =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXDLIN(  22)		sprite1->addChild(map5);
...
HXLINE(  39)				HX_VARI(  ::openfl::display::DisplayObject,child) = this->getChildAt((_g1 - (int)1));
...
HXLINE(  41)					child->set_y((child->get_y() + (int)3));
            				}
            			}
            		}
...
HXLINE(  53)				HX_VARI(  ::openfl::display::DisplayObject,child) = this->getChildAt((_g1 - (int)1));
...
HXLINE(  55)					child->set_y((child->get_y() - (int)3));
            				}
            			}
            		}
