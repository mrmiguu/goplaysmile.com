...
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_38_pushIn,"Connection","pushIn",0x78f8d28f,"Connection.pushIn","Connection.hx",38,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_42_popOut,"Connection","popOut",0x0282e1ad,"Connection.popOut","Connection.hx",42,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_45_read,"Connection","read",0xaac03586,"Connection.read","Connection.hx",45,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_87_initArrived,"Connection","initArrived",0x01d8b70d,"Connection.initArrived","Connection.hx",87,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_94_playerColorArrived,"Connection","playerColorArrived",0xc653287b,"Connection.playerColorArrived","Connection.hx",94,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_99_dieInfoArrived,"Connection","dieInfoArrived",0x8290ee6f,"Connection.dieInfoArrived","Connection.hx",99,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_104_playerLocationArrived,"Connection","playerLocationArrived",0xb8d65827,"Connection.playerLocationArrived","Connection.hx",104,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_109_playerDestinationArrived,"Connection","playerDestinationArrived",0x87aa5570,"Connection.playerDestinationArrived","Connection.hx",109,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_114_playerArrived,"Connection","playerArrived",0xd4a9b6dc,"Connection.playerArrived","Connection.hx",114,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_119_playerExperienceArrived,"Connection","playerExperienceArrived",0x45bf1712,"Connection.playerExperienceArrived","Connection.hx",119,0x20395940)
HX_LOCAL_STACK_FRAME(_hx_pos_cbe74dae291f5d27_127_clientLoop,"Connection","clientLoop",0x5c45cc7f,"Connection.clientLoop","Connection.hx",127,0x20395940)
...
HXDLIN(  34)			::cpp::VirtualArray t = ::cpp::VirtualArray_obj::__new(3)->init(0,HX_("login",69,d9,f3,78))->init(1,user)->init(2,pass);
HXDLIN(  34)			 ::haxe::Serializer serial =  ::haxe::Serializer_obj::__alloc( HX_CTX );
HXDLIN(  34)			{
HXLINE(  34)				int _g = (int)0;
HXDLIN(  34)				while((_g < t->get_length())){
HXLINE(  34)					 ::Dynamic token = t->__get(_g);
...
HXLINE(  46)		 ::haxe::Unserializer serial =  ::haxe::Unserializer_obj::__alloc( HX_CTX ,packet);
HXLINE(  48)		{
HXLINE(  48)			::String _g = ::Std_obj::string(serial->unserialize());
...
HXLINE( 128)		Float time = ((Float)::lime::_hx_system::System_obj::getTimer() / (Float)(int)1000);
HXLINE( 129)		 ::Dynamic sockets = ::sys::net::Socket_obj::select(this->readers,this->writers,null(),(int)0);
