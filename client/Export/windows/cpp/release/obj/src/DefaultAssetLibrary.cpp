...
HXLINE( 111)		this->classTypes->set(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),hx::ClassOf< ::__ASSET__assets_etc_lucon_ttf >());
HXLINE( 112)		this->types->set(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),HX_("FONT",cf,25,81,2e));
...
void DefaultAssetLibrary_obj::loadManifest(){
            	HX_STACK_FRAME("DefaultAssetLibrary","loadManifest",0x6f596c77,"DefaultAssetLibrary.loadManifest","DefaultAssetLibrary.hx",367,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE( 369)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(HX_("__ASSET_MANIFEST__",fe,d8,3a,3a));
HXLINE( 372)		Bool _hx_tmp = hx::IsNotNull( bytes );
HXDLIN( 372)		if (_hx_tmp) {
HXLINE( 374)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXLINE( 375)			manifest->basePath = this->rootPath;
HXLINE( 376)			this->_hx___fromManifest(manifest);
            		}
            		else {
HXLINE( 382)			HX_VARI_NAME(  ::lime::utils::AssetManifest,manifest1,"manifest") = ::lime::utils::AssetManifest_obj::fromFile((this->rootPath + HX_("manifest",af,fb,29,d0)));
HXLINE( 384)			Bool _hx_tmp1 = hx::IsNotNull( manifest1 );
HXDLIN( 384)			if (_hx_tmp1) {
HXLINE( 386)				manifest1->basePath = this->rootPath;
HXLINE( 387)				this->_hx___fromManifest(manifest1);
            			}
            			else {
