...
HX_DEFINE_STACK_FRAME(_hx_pos_fffeb3ab353ef1d6_366_loadManifest,"DefaultAssetLibrary","loadManifest",0x6f596c77,"DefaultAssetLibrary.loadManifest","DefaultAssetLibrary.hx",366,0x0fc48912)
...
void DefaultAssetLibrary_obj::loadManifest(){
            	HX_STACKFRAME(&_hx_pos_fffeb3ab353ef1d6_366_loadManifest)
            	HX_STACK_THIS(this)
HXLINE( 368)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(HX_("__ASSET_MANIFEST__",fe,d8,3a,3a));
HXLINE( 371)		if (hx::IsNotNull( bytes )) {
HXLINE( 373)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXLINE( 374)			manifest->basePath = this->rootPath;
HXLINE( 375)			this->_hx___fromManifest(manifest);
            		}
            		else {
HXLINE( 381)			HX_VARI_NAME(  ::lime::utils::AssetManifest,manifest1,"manifest") = ::lime::utils::AssetManifest_obj::fromFile((this->rootPath + HX_("manifest",af,fb,29,d0)));
HXLINE( 383)			if (hx::IsNotNull( manifest1 )) {
HXLINE( 385)				manifest1->basePath = this->rootPath;
HXLINE( 386)				this->_hx___fromManifest(manifest1);
            			}
            			else {
HXLINE( 390)				::lime::utils::Log_obj::warn(HX_("Could not load asset manifest (bytes was null)",21,51,77,e6),hx::SourceInfo(HX_("DefaultAssetLibrary.hx",12,89,c4,0f),390,HX_("DefaultAssetLibrary",2c,3d,78,3a),HX_("loadManifest",f5,e7,92,89)));
            			}
            		}
            	}
