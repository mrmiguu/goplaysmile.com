...
HX_DEFINE_STACK_FRAME(_hx_pos_b97562e956fad93d_10_new,"Node","new",0xb7119014,"Node.new","Node.hx",10,0xe41f0ddc)

void Node_obj::__construct(::String id, ::openfl::display::Sprite sprite){
            	HX_GC_STACKFRAME(&_hx_pos_b97562e956fad93d_10_new)
HXLINE(  11)		super::__construct();
HXLINE(  13)		this->id = id;
HXLINE(  15)		int w = (int)-1;
HXDLIN(  15)		int h = (int)-1;
HXDLIN(  15)		 ::openfl::display::BitmapData png = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + ((HX_("maps/3d_",76,c7,61,3a) + id) + HX_(".png",3b,2d,bd,1e))),null());
HXDLIN(  15)		 ::openfl::display::Tileset set =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,null());
HXDLIN(  15)		set->addRect(png->rect);
HXDLIN(  15)		 ::openfl::display::Tileset set1 = set;
HXDLIN(  15)		int map;
HXDLIN(  15)		if ((w < (int)0)) {
HXLINE(  15)			map = ::Std_obj::_hx_int(set1->getRect((int)0)->width);
            		}
            		else {
HXLINE(  15)			map = w;
            		}
HXDLIN(  15)		int map1;
HXDLIN(  15)		if ((h < (int)0)) {
HXLINE(  15)			map1 = ::Std_obj::_hx_int(set1->getRect((int)0)->height);
            		}
            		else {
HXLINE(  15)			map1 = h;
            		}
HXDLIN(  15)		 ::openfl::display::Tilemap map2 =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map,map1,set1,null());
HXDLIN(  15)		map2->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
HXDLIN(  15)		 ::openfl::display::Sprite sprite1 =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXDLIN(  15)		sprite1->addChild(map2);
HXDLIN(  15)		 ::openfl::display::Sprite sprite2 = sprite1;
HXDLIN(  15)		sprite2->set_x((int)0);
HXDLIN(  15)		sprite2->set_y((int)0);
HXDLIN(  15)		this->addChild(sprite2);
HXLINE(  17)		this->set_x((((Float)240.) - ((Float)this->get_width() / (Float)(int)2)));
HXLINE(  18)		this->set_y(((int)800 - this->get_height()));
...
bool Node_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x19c29573) {
		...
		if (inClassId<=(int)0x33e33622) {
			return inClassId==(int)0x1b123bf8 || inClassId==(int)0x33e33622;
		} else {
...
hx::ObjectPtr< Node_obj > Node_obj::__new(::String id, ::openfl::display::Sprite sprite) {
	...
	__this->__construct(id,sprite);
	return __this;
}

hx::ObjectPtr< Node_obj > Node_obj::__alloc(hx::Ctx *_hx_ctx,::String id, ::openfl::display::Sprite sprite) {
...
{
	hx::Object *dummy = new Node_obj;
	Node_obj::_hx_vtable = *(void **)dummy;
