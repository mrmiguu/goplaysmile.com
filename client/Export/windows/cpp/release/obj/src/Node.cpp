...
HXDLIN(  15)		HX_VAR( int,map);
HXDLIN(  15)		map = ::Std_obj::_hx_int(set->getRect((int)0)->width);
HXDLIN(  15)		int map1;
HXDLIN(  15)		map1 = ::Std_obj::_hx_int(set->getRect((int)0)->height);
HXDLIN(  15)		HX_VARI_NAME(  ::openfl::display::Tilemap,map2,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map,map1,set,null());
HXDLIN(  15)		map2->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXDLIN(  15)		HX_VARI_NAME(  ::openfl::display::Sprite,sprite1,"sprite") =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
