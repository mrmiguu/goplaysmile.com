...
void Radio_obj::__construct(::Dynamic b1,::Dynamic b2){
            	HX_STACK_FRAME("Radio","new",0x7f822b4d,"Radio.new","Radio.hx",7,0xce0f7cc3)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b1,"b1")
            	HX_STACK_ARG(b2,"b2")
...
void Radio_obj::add(::Dynamic b){
            	HX_STACK_FRAME("Radio","add",0x7f784d0e,"Radio.add","Radio.hx",10,0xce0f7cc3)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
...
void Radio_obj::push(::Dynamic b){
            	HX_STACK_FRAME("Radio","push",0x13c2464d,"Radio.push","Radio.hx",15,0xce0f7cc3)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
HXLINE(  16)		{
...
HXLINE(  19)		Int _hx_tmp = this->radio->indexOf(b,null());
HXDLIN(  19)		::IButton_obj::pushIn(this->radio->__get(_hx_tmp));
            	}
