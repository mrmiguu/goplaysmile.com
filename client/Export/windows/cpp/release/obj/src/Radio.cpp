...
HX_LOCAL_STACK_FRAME(_hx_pos_a58daca459661213_10_add,"Radio","add",0x7f784d0e,"Radio.add","Radio.hx",10,0xce0f7cc3)
HX_LOCAL_STACK_FRAME(_hx_pos_a58daca459661213_15_push,"Radio","push",0x13c2464d,"Radio.push","Radio.hx",15,0xce0f7cc3)
...
HXLINE(  16)		{
HXLINE(  16)			int _g = (int)0;
HXDLIN(  16)			::Array< ::Dynamic> _g1 = this->radio;
HXDLIN(  16)			while((_g < _g1->length)){
HXLINE(  16)				::Dynamic r = _g1->__get(_g);
HXDLIN(  16)				_g = (_g + (int)1);
HXLINE(  17)				::IButton_obj::popOut(r);
            			}
            		}
HXLINE(  19)		::Array< ::Dynamic> _hx_tmp = this->radio;
HXDLIN(  19)		::IButton_obj::pushIn(_hx_tmp->__get(this->radio->indexOf(b,null())));
            	}
