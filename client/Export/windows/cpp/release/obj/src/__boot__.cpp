...
::openfl::_internal::renderer::opengl::GLTilemap_obj::__register();
...
::lime::graphics::opengl::ExtensionPackedDepthStencil_obj::__register();
...
::openfl::display::IPreloader_obj::__register();
...
::lime::app::Promise_lime_utils_Bytes_obj::__register();
::lime::app::Promise_lime_text_Font_obj::__register();
::lime::app::Promise_lime_graphics_Image_obj::__register();
::lime::app::Promise_lime_audio_AudioBuffer_obj::__register();
::lime::app::Promise_lime_AssetLibrary_obj::__register();
...
::Radio_obj::__register();
::Player_obj::__register();
::Paperdoll_obj::__register();
::Node_obj::__register();
...
::Globals_obj::__register();
::Field_obj::__register();
::EReg_obj::__register();
::Die_obj::__register();
::SpriteSheet_obj::__register();
::__ASSET__OPENFL__assets_etc_lucon_ttf_obj::__register();
::__ASSET__assets_etc_lucon_ttf_obj::__register();
...
::lime::graphics::cairo::_CairoFontFace::CairoFontFace_Impl__obj::__boot();
::lime::graphics::cairo::_CairoFontOptions::CairoFontOptions_Impl__obj::__boot();
::lime::graphics::cairo::_CairoImageSurface::CairoImageSurface_Impl__obj::__boot();
...
::lime::graphics::opengl::ExtensionPackedDepthStencil_obj::__boot();
...
::lime::net::curl::CURLEasy_obj::__boot();
::lime::_hx_system::BackgroundWorker_obj::__boot();
::lime::_hx_system::CFFI_obj::__boot();
::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::__boot();
...
::lime::utils::compress::Deflate_obj::__boot();
::lime::utils::compress::LZMA_obj::__boot();
::lime::utils::compress::Zlib_obj::__boot();
...
::openfl::_internal::renderer::opengl::GLTilemap_obj::__boot();
