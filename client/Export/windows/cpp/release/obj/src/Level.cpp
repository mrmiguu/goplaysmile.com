...
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_38_begin,"Level","begin",0x8b652b9f,"Level.begin","Level.hx",38,0x000d33da)
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_43_end,"Level","end",0x0b7ddbd1,"Level.end","Level.hx",43,0x000d33da)
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_52_updateBar,"Level","updateBar",0x8e63c3c0,"Level.updateBar","Level.hx",52,0x000d33da)
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_55_set,"Level","set",0x0b887398,"Level.set","Level.hx",55,0x000d33da)
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_67_increaseLevel,"Level","increaseLevel",0xd77c11d8,"Level.increaseLevel","Level.hx",67,0x000d33da)
HX_DEFINE_STACK_FRAME(_hx_pos_ac17baf8e1623e9e_75_updateText,"Level","updateText",0x14d06a20,"Level.updateText","Level.hx",75,0x000d33da)
...
HXDLIN(  30)		HX_VARI(  ::openfl::text::TextField,t) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
...
void Level_obj::end(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  43)		if ((this->state == (this->states - (int)1))) {
...
void Level_obj::updateBar(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  52)		this->bar->set_width(((Float)((int)480 * this->exp) / (Float)(this->req - (int)1)));
            	}
...
void Level_obj::updateText(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  75)		this->text->set_text((HX_("",00,00,00,00) + this->lv));
            	}
