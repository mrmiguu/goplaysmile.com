...
HX_DEFINE_STACK_FRAME(_hx_pos_e641650405b6e704_29_player,"Globals","player",0x7eb9e67f,"Globals.player","Globals.hx",29,0x4ea1ef2e)
HX_DEFINE_STACK_FRAME(_hx_pos_e641650405b6e704_37_me,"Globals","me",0x4ea1f376,"Globals.me","Globals.hx",37,0x4ea1ef2e)
HX_DEFINE_STACK_FRAME(_hx_pos_e641650405b6e704_41_errSfx,"Globals","errSfx",0x9854353e,"Globals.errSfx","Globals.hx",41,0x4ea1ef2e)
HX_DEFINE_STACK_FRAME(_hx_pos_e641650405b6e704_45_pushSfx,"Globals","pushSfx",0x4f1225ed,"Globals.pushSfx","Globals.hx",45,0x4ea1ef2e)
HX_DEFINE_STACK_FRAME(_hx_pos_e641650405b6e704_49_popSfx,"Globals","popSfx",0x42bb0292,"Globals.popSfx","Globals.hx",49,0x4ea1ef2e)
...
HXDLIN(  22)				_g->push(::openfl::media::Sound_obj::fromFile((HX_("assets/",4c,2a,dc,36) + ((HX_("etc/pop",d6,87,6f,e9) + (_g1 - (int)1)) + HX_(".ogg",e1,64,bc,1e)))));
            			}
            		}
...
HXDLIN(  21)				_g2->push(::openfl::media::Sound_obj::fromFile((HX_("assets/",4c,2a,dc,36) + ((HX_("etc/push",f5,e3,2b,58) + (_g11 - (int)1)) + HX_(".ogg",e1,64,bc,1e)))));
            			}
            		}
...
HXDLIN(  31)			( ( ::haxe::ds::StringMap)(this1) )->set(user, ::Player_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),user));
            		}
...
void Globals_obj::pushSfx(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  45)		this->pushes->__get(::Std_obj::random(this->pushes->length)).StaticCast<  ::openfl::media::Sound >()->play(null(),null(),null());
            	}
...
void Globals_obj::popSfx(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  49)		this->pops->__get(::Std_obj::random(this->pushes->length)).StaticCast<  ::openfl::media::Sound >()->play(null(),null(),null());
            	}
