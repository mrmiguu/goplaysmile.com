...
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_45_i,"Card","i",0xef6dce6b,"Card.i","Card.hx",45,0x90a6cece)
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_49_sel,"Card","sel",0x01566e1c,"Card.sel","Card.hx",49,0x90a6cece)
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_61_begin,"Card","begin",0x0c8fe12b,"Card.begin","Card.hx",61,0x90a6cece)
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_62_during,"Card","during",0xfbba7e7f,"Card.during","Card.hx",62,0x90a6cece)
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_63_end,"Card","end",0x014bd65d,"Card.end","Card.hx",63,0x90a6cece)
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_65_progress,"Card","progress",0x1897cdeb,"Card.progress","Card.hx",65,0x90a6cece)
...
HXDLIN(  17)				_g->push(::openfl::media::Sound_obj::fromFile((HX_("assets/",4c,2a,dc,36) + ((HX_("cars/vroom",21,a6,9d,78) + (_g1 - (int)1)) + HX_(".ogg",e1,64,bc,1e)))));
            			}
            		}
...
HXLINE(  32)		this->g = g;
HXLINE(  34)		HX_VARI( int,w) = ::Std_obj::_hx_int(roller->get_width());
HXDLIN(  34)		HX_VARI( int,h) = ::Std_obj::_hx_int(roller->get_height());
...
HXDLIN(  34)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,null());
HXDLIN(  34)		set->addRect(png->rect);
HXDLIN(  34)		HX_VAR( int,map);
HXDLIN(  34)		if ((w < (int)0)) {
HXLINE(  34)			map = ::Std_obj::_hx_int(set->getRect((int)0)->width);
            		}
            		else {
HXLINE(  34)			map = w;
            		}
...
HXLINE(  34)			map1 = ::Std_obj::_hx_int(set->getRect((int)0)->height);
            		}
            		else {
HXLINE(  34)			map1 = h;
            		}
HXDLIN(  34)		HX_VARI_NAME(  ::openfl::display::Tilemap,map2,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map,map1,set,null());
HXDLIN(  34)		map2->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE(  36)		this->focus = map2->getTileAt((int)0);
HXLINE(  37)		map2->addTile((this->_hx_double =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null())));
HXLINE(  39)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXDLIN(  39)		sprite->addChild(map2);
...
HXLINE(  56)			this->_hx_double->set_y((this->focus->get_y() - this->h));
            		}
            		else {
HXLINE(  57)			Float _hx_tmp2 = this->focus->get_y();
HXDLIN(  57)			Float _hx_tmp3 = this->roller->get_height();
HXDLIN(  57)			if ((_hx_tmp2 < (_hx_tmp3 - this->h))) {
HXLINE(  57)				this->_hx_double->set_y((this->focus->get_y() + this->h));
            			}
            			else {
...
HXLINE(  72)					this->vrooms->__get(::Std_obj::random(this->vrooms->length)).StaticCast<  ::openfl::media::Sound >()->play(null(),null(),null());
            				}
            			}
HXLINE(  76)			return;
            		}
