...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,add,(void))
 ...
 ::Dynamic List_obj::pop(){
            	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","C:\\HaxeToolkit\\haxe\\std/List.hx",99,0x1e139e47)
            	HX_STACK_THIS(this)
HXLINE( 100)		Bool _hx_tmp = hx::IsNull( this->h );
HXDLIN( 100)		if (_hx_tmp) {
HXLINE( 101)			return null();
            		}
HXLINE( 102)		HX_VARI(  ::Dynamic,x) = this->h->item;
HXLINE( 103)		this->h = this->h->next;
HXLINE( 104)		Bool _hx_tmp1 = hx::IsNull( this->h );
...
void List_obj::clear(){
            	HX_STACK_FRAME("List","clear",0xd148c59d,"List.clear","C:\\HaxeToolkit\\haxe\\std/List.hx",123,0x1e139e47)
            	HX_STACK_THIS(this)
