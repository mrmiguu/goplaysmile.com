...
Int y = __o_y.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",780,0xb13849fd)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 782)		this->type = type;
HXLINE( 783)		this->id = id;
HXLINE( 784)		this->index = index;
HXLINE( 785)		this->value = value;
HXLINE( 786)		this->x = x;
HXLINE( 787)		this->y = y;
            	}
...
Dynamic JoystickEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",794,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 794)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__new(this->type,this->id,this->index,this->value,this->x,this->y);
            	}
