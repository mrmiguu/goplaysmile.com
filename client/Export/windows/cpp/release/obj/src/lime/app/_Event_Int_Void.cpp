...
void _Event_Int_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_Int_Void","new",0xcfe12134,"lime.app._Event_Int_Void.new","lime/app/Event.hx",26,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_Int_Void","add",0xcfd742f5,"lime.app._Event_Int_Void.add","lime/app/Event.hx",38,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_Int_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_Int_Void","cancel",0xcbf9d926,"lime.app._Event_Int_Void.cancel","lime/app/Event.hx",216,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_Int_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Int_Void","has",0xcfdc902e,"lime.app._Event_Int_Void.has","lime/app/Event.hx",252,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 255)		{
...
void _Event_Int_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Int_Void","remove",0x184e87f0,"lime.app._Event_Int_Void.remove","lime/app/Event.hx",267,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_Int_Void_obj::dispatch(Int a){
            	HX_STACK_FRAME("lime.app._Event_Int_Void","dispatch",0x203cfd66,"lime.app._Event_Int_Void.dispatch","lime/app/Event.hx",140,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
