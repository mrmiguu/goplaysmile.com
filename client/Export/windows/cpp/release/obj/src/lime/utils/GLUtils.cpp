...
Dynamic GLUtils_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::graphics::opengl::GLShader GLUtils_obj::compileShader(::String source,Int type){
            	HX_STACK_FRAME("lime.utils.GLUtils","compileShader",0x55bd7600,"lime.utils.GLUtils.compileShader","lime/utils/GLUtils.hx",18,0xaa32e64a)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(type,"type")
HXLINE(  20)		HX_VARI(  ::lime::graphics::opengl::GLShader,shader) = ::lime::graphics::opengl::GL_obj::context->createShader(type);
...
HXLINE(  24)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::context->getShaderParameter(shader,(int)35713);
HXDLIN(  24)		if ((_hx_tmp == (int)0)) {
HXLINE(  26)			HX_VAR( ::String,message);
...
HXLINE(  34)			::String _hx_tmp1 = ::lime::graphics::opengl::GL_obj::context->getShaderInfoLog(shader);
HXDLIN(  34)			hx::AddEq(message,(HX_("\n",0a,00,00,00) + _hx_tmp1));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GLUtils_obj,compileShader,return )
 ...
 ::lime::graphics::opengl::GLProgram GLUtils_obj::createProgram(::String vertexSource,::String fragmentSource){
            	HX_STACK_FRAME("lime.utils.GLUtils","createProgram",0x574727f0,"lime.utils.GLUtils.createProgram","lime/utils/GLUtils.hx",44,0xaa32e64a)
            	HX_STACK_ARG(vertexSource,"vertexSource")
            	HX_STACK_ARG(fragmentSource,"fragmentSource")
HXLINE(  46)		HX_VARI(  ::lime::graphics::opengl::GLShader,vertexShader) = ::lime::utils::GLUtils_obj::compileShader(vertexSource,(int)35633);
HXLINE(  47)		HX_VARI(  ::lime::graphics::opengl::GLShader,fragmentShader) = ::lime::utils::GLUtils_obj::compileShader(fragmentSource,(int)35632);
HXLINE(  49)		HX_VARI(  ::lime::graphics::opengl::GLProgram,program) = ::lime::graphics::opengl::GL_obj::context->createProgram();
...
HXLINE(  54)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::context->getProgramParameter(program,(int)35714);
HXDLIN(  54)		if ((_hx_tmp == (int)0)) {
