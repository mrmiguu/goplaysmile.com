...
Dynamic ALSource_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic ALSource_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.media.openal._ALSource.ALSource_Impl_","_new",0xa5dfa9aa,"lime.media.openal._ALSource.ALSource_Impl_._new","lime/media/openal/ALSource.hx",12,0x6c7b0443)
