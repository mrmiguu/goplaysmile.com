...
void GLShader_obj::__construct(Int version, ::Dynamic id){
            	HX_STACK_FRAME("lime.graphics.opengl.GLShader","new",0xa0326c51,"lime.graphics.opengl.GLShader.new","lime/graphics/opengl/GLShader.hx",10,0x4f56a5be)
            	HX_STACK_THIS(this)
...
::String GLShader_obj::getType(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLShader","getType",0xe5e58ae1,"lime.graphics.opengl.GLShader.getType","lime/graphics/opengl/GLShader.hx",15,0x4f56a5be)
            	HX_STACK_THIS(this)
...
Bool GLShader_obj::isValid(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLShader","isValid",0x94980123,"lime.graphics.opengl.GLShader.isValid","lime/graphics/opengl/GLShader.hx",22,0x4f56a5be)
            	HX_STACK_THIS(this)
HXLINE(  22)		Bool _hx_tmp;
HXDLIN(  22)		 ::Dynamic a = this->id;
HXDLIN(  22)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(  22)		if ((_hx_tmp1 != (int)0)) {
