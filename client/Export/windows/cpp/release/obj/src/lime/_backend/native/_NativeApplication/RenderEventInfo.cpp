...
void RenderEventInfo_obj::__construct( ::Dynamic type,::hx::EnumBase context){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.RenderEventInfo","new",0xcf12fe07,"lime._backend.native._NativeApplication.RenderEventInfo.new","lime/_backend/native/NativeApplication.hx",927,0xb13849fd)
            	HX_STACK_THIS(this)
...
Dynamic RenderEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::RenderEventInfo RenderEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.RenderEventInfo","clone",0xa78638c4,"lime._backend.native._NativeApplication.RenderEventInfo.clone","lime/_backend/native/NativeApplication.hx",937,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 937)		return  ::lime::_backend::native::_NativeApplication::RenderEventInfo_obj::__new(this->type,this->context);
            	}
