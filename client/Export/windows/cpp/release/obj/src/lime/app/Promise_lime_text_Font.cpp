...
void Promise_lime_text_Font_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","new",0x708368f3,"lime.app.Promise_lime_text_Font.new","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_lime_text_Font_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::complete( ::lime::text::Font data){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","complete",0x0a877346,"lime.app.Promise_lime_text_Font.complete","lime/app/Promise.hx",28,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,complete,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","completeWith",0xf69b306c,"lime.app.Promise_lime_text_Font.completeWith","lime/app/Promise.hx",54,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","error",0x00deef1b,"lime.app.Promise_lime_text_Font.error","lime/app/Promise.hx",66,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,error,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","progress",0x10ea6a3a,"lime.app.Promise_lime_text_Font.progress","lime/app/Promise.hx",92,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_text_Font_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isComplete",0x8a9ff559,"lime.app.Promise_lime_text_Font.get_isComplete","lime/app/Promise.hx",122,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_text_Font_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isError",0xc3d0b328,"lime.app.Promise_lime_text_Font.get_isError","lime/app/Promise.hx",129,0x10ba4f0b)
            	HX_STACK_THIS(this)
