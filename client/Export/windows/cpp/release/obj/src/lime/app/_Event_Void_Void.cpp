...
void _Event_Void_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_Void_Void","new",0xd4bd07f3,"lime.app._Event_Void_Void.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_Void_Void","add",0xd4b329b4,"lime.app._Event_Void_Void.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_Void_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_Void_Void","cancel",0x875173c7,"lime.app._Event_Void_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_Void_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Void_Void","has",0xd4b876ed,"lime.app._Event_Void_Void.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void _Event_Void_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Void_Void","remove",0xd3a62291,"lime.app._Event_Void_Void.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_Void_Void_obj::dispatch(){
            	HX_STACK_FRAME("lime.app._Event_Void_Void","dispatch",0x14a94247,"lime.app._Event_Void_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
            	HX_STACK_THIS(this)
