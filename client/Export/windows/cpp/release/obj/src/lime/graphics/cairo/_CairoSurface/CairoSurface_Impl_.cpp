...
HXLINE(  17)		::lime::graphics::cairo::_CairoSurface::CairoSurface_Impl__obj::cffi_lime_cairo_surface_flush(hx::DynamicPtr(this1));
            	}
...
HXLINE(  31)		::lime::graphics::cairo::_CairoSurface::CairoSurface_Impl__obj::cffi_lime_cairo_surface_flush(hx::DynamicPtr(surface));
            	}
...
static hx::StaticInfo CairoSurface_Impl__obj_sStaticStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(void *) &CairoSurface_Impl__obj::cffi_lime_cairo_surface_flush,HX_HCSTRING("cffi_lime_cairo_surface_flush","\x4a","\xdb","\xf2","\xdb")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACK_FRAME("lime.graphics.cairo._CairoSurface.CairoSurface_Impl_","boot",0x426f3cc1,"lime.graphics.cairo._CairoSurface.CairoSurface_Impl_.boot","lime/graphics/cairo/CairoSurface.hx",31,0x58ce1be8)
HXLINE(  31)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_surface_flush",51,85,bf,ed),HX_("ov",27,61,00,00),false);
HXDLIN(  31)		cffi_lime_cairo_surface_flush = inValue;
            	}
}
