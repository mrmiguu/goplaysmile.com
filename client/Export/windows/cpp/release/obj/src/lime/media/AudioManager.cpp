...
void AudioManager_obj::init(::hx::EnumBase context){
            	HX_STACK_FRAME("lime.media.AudioManager","init",0x83630824,"lime.media.AudioManager.init","lime/media/AudioManager.hx",27,0x63af6ea2)
            	HX_STACK_ARG(context,"context")
HXLINE(  27)		Bool _hx_tmp = hx::IsNull( ::lime::media::AudioManager_obj::context );
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  29)			Bool _hx_tmp1 = hx::IsNull( context );
HXDLIN(  29)			if (_hx_tmp1) {
HXLINE(  55)				::lime::media::AudioManager_obj::context = ::lime::media::AudioContext_obj::OPENAL( ::lime::media::ALCAudioContext_obj::__new(), ::lime::media::ALAudioContext_obj::__new());
HXLINE(  57)				HX_VARI(  ::Dynamic,device) = ::lime::media::openal::ALC_obj::openDevice(null());
HXLINE(  58)				HX_VARI(  ::Dynamic,ctx) = ::lime::media::openal::ALC_obj::createContext(device,null());
...
void AudioManager_obj::resume(){
            	HX_STACK_FRAME("lime.media.AudioManager","resume",0xd988a3c1,"lime.media.AudioManager.resume","lime/media/AudioManager.hx",77,0x63af6ea2)
HXLINE(  77)		Bool _hx_tmp = hx::IsNotNull( ::lime::media::AudioManager_obj::context );
HXDLIN(  77)		if (_hx_tmp) {
HXLINE(  79)			HX_VARI( ::hx::EnumBase,_g) = ::lime::media::AudioManager_obj::context;
HXDLIN(  79)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN(  79)			if ((_hx_tmp1 == (int)0)) {
HXLINE(  81)				HX_VARI(  ::lime::media::ALCAudioContext,alc) = _g->_hx_getObject(0).StaticCast<  ::lime::media::ALCAudioContext >();
HXDLIN(  81)				{
HXLINE(  83)					HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE(  85)					Bool _hx_tmp2 = hx::IsNotNull( currentContext );
HXDLIN(  85)					if (_hx_tmp2) {
HXLINE(  87)						HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
...
void AudioManager_obj::shutdown(){
            	HX_STACK_FRAME("lime.media.AudioManager","shutdown",0xb121e3aa,"lime.media.AudioManager.shutdown","lime/media/AudioManager.hx",104,0x63af6ea2)
HXLINE( 104)		Bool _hx_tmp = hx::IsNotNull( ::lime::media::AudioManager_obj::context );
HXDLIN( 104)		if (_hx_tmp) {
HXLINE( 106)			HX_VARI( ::hx::EnumBase,_g) = ::lime::media::AudioManager_obj::context;
HXDLIN( 106)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN( 106)			if ((_hx_tmp1 == (int)0)) {
HXLINE( 108)				HX_VARI(  ::lime::media::ALCAudioContext,alc) = _g->_hx_getObject(0).StaticCast<  ::lime::media::ALCAudioContext >();
HXDLIN( 108)				{
HXLINE( 110)					HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE( 112)					Bool _hx_tmp2 = hx::IsNotNull( currentContext );
HXDLIN( 112)					if (_hx_tmp2) {
HXLINE( 114)						HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
HXLINE( 115)						alc->makeContextCurrent(null());
HXLINE( 116)						alc->destroyContext(currentContext);
HXLINE( 117)						alc->closeDevice(device);
            					}
            				}
            			}
            		}
...
void AudioManager_obj::suspend(){
            	HX_STACK_FRAME("lime.media.AudioManager","suspend",0x09fdc6e8,"lime.media.AudioManager.suspend","lime/media/AudioManager.hx",132,0x63af6ea2)
HXLINE( 132)		Bool _hx_tmp = hx::IsNotNull( ::lime::media::AudioManager_obj::context );
HXDLIN( 132)		if (_hx_tmp) {
HXLINE( 134)			HX_VARI( ::hx::EnumBase,_g) = ::lime::media::AudioManager_obj::context;
HXDLIN( 134)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN( 134)			if ((_hx_tmp1 == (int)0)) {
HXLINE( 136)				HX_VARI(  ::lime::media::ALCAudioContext,alc) = _g->_hx_getObject(0).StaticCast<  ::lime::media::ALCAudioContext >();
HXDLIN( 136)				{
HXLINE( 138)					HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE( 140)					Bool _hx_tmp2 = hx::IsNotNull( currentContext );
HXDLIN( 140)					if (_hx_tmp2) {
HXLINE( 142)						alc->suspendContext(currentContext);
HXLINE( 143)						HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
HXLINE( 144)						alc->pauseDevice(device);
            					}
            				}
            			}
            		}
