...
Int y = __o_y.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",1067,0xb13849fd)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1069)		this->type = type;
HXLINE(1070)		this->windowID = windowID;
HXLINE(1071)		this->width = width;
HXLINE(1072)		this->height = height;
HXLINE(1073)		this->x = x;
HXLINE(1074)		this->y = y;
            	}
...
Dynamic WindowEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1081,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1081)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__new(this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
