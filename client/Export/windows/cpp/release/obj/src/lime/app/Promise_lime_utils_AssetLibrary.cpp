...
void Promise_lime_utils_AssetLibrary_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","new",0x0f34710b,"lime.app.Promise_lime_utils_AssetLibrary.new","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_lime_utils_AssetLibrary_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::complete( ::lime::utils::AssetLibrary data){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","complete",0xfdaa142e,"lime.app.Promise_lime_utils_AssetLibrary.complete","lime/app/Promise.hx",28,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,complete,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","completeWith",0xd4846554,"lime.app.Promise_lime_utils_AssetLibrary.completeWith","lime/app/Promise.hx",54,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","error",0x73f42d33,"lime.app.Promise_lime_utils_AssetLibrary.error","lime/app/Promise.hx",66,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,error,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","progress",0x040d0b22,"lime.app.Promise_lime_utils_AssetLibrary.progress","lime/app/Promise.hx",92,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_utils_AssetLibrary_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","get_isComplete",0x9cee3441,"lime.app.Promise_lime_utils_AssetLibrary.get_isComplete","lime/app/Promise.hx",122,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_utils_AssetLibrary_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","get_isError",0x4d6b9340,"lime.app.Promise_lime_utils_AssetLibrary.get_isError","lime/app/Promise.hx",129,0x10ba4f0b)
            	HX_STACK_THIS(this)
