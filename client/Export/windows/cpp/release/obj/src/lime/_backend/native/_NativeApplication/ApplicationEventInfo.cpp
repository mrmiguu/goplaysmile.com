...
Int deltaTime = __o_deltaTime.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.ApplicationEventInfo","new",0x285f59a7,"lime._backend.native._NativeApplication.ApplicationEventInfo.new","lime/_backend/native/NativeApplication.hx",669,0xb13849fd)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 671)		this->type = type;
HXLINE( 672)		this->deltaTime = deltaTime;
            	}
...
Dynamic ApplicationEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",679,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 679)		return  ::lime::_backend::native::_NativeApplication::ApplicationEventInfo_obj::__new(this->type,this->deltaTime);
            	}
