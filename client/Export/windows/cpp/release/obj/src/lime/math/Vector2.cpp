...
Float y = __o_y.Default(0);
            	HX_STACK_FRAME("lime.math.Vector2","new",0xaef3c434,"lime.math.Vector2.new","lime/math/Vector2.hx",22,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(  24)		this->x = x;
...
Dynamic Vector2_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::math::Vector2 Vector2_obj::add( ::lime::math::Vector2 v){
            	HX_STACK_FRAME("lime.math.Vector2","add",0xaee9e5f5,"lime.math.Vector2.add","lime/math/Vector2.hx",32,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  32)		return  ::lime::math::Vector2_obj::__new((v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector2_obj,add,return )
 ...
 ::lime::math::Vector2 Vector2_obj::clone(){
            	HX_STACK_FRAME("lime.math.Vector2","clone",0xd5c6a431,"lime.math.Vector2.clone","lime/math/Vector2.hx",39,0x7105521c)
            	HX_STACK_THIS(this)
HXLINE(  39)		return  ::lime::math::Vector2_obj::__new(this->x,this->y);
            	}
...
Bool Vector2_obj::equals( ::lime::math::Vector2 toCompare){
            	HX_STACK_FRAME("lime.math.Vector2","equals",0xe9ae16eb,"lime.math.Vector2.equals","lime/math/Vector2.hx",55,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
HXLINE(  55)		Bool _hx_tmp;
HXDLIN(  55)		Bool _hx_tmp1 = hx::IsNotNull( toCompare );
...
void Vector2_obj::normalize(Float thickness){
            	HX_STACK_FRAME("lime.math.Vector2","normalize",0xeaffc261,"lime.math.Vector2.normalize","lime/math/Vector2.hx",69,0x7105521c)
            	HX_STACK_THIS(this)
...
HXLINE(  75)			Float _hx_tmp1 = ((this->x * this->x) + (this->y * this->y));
HXDLIN(  75)			Float _hx_tmp2 = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  75)			HX_VARI( Float,norm) = ((Float)thickness / (Float)_hx_tmp2);
HXLINE(  76)			hx::MultEq(this->x,norm);
HXLINE(  77)			hx::MultEq(this->y,norm);
            		}
            	}
...
void Vector2_obj::offset(Float dx,Float dy){
            	HX_STACK_FRAME("lime.math.Vector2","offset",0x89fac03f,"lime.math.Vector2.offset","lime/math/Vector2.hx",84,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  86)		hx::AddEq(this->x,dx);
HXLINE(  87)		hx::AddEq(this->y,dy);
            	}
...
void Vector2_obj::setTo(Float xa,Float ya){
            	HX_STACK_FRAME("lime.math.Vector2","setTo",0x07932291,"lime.math.Vector2.setTo","lime/math/Vector2.hx",99,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xa,"xa")
            	HX_STACK_ARG(ya,"ya")
...
HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,setTo,(void))
 ...
 ::lime::math::Vector2 Vector2_obj::subtract( ::lime::math::Vector2 v){
            	HX_STACK_FRAME("lime.math.Vector2","subtract",0x656920c0,"lime.math.Vector2.subtract","lime/math/Vector2.hx",108,0x7105521c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 108)		return  ::lime::math::Vector2_obj::__new((this->x - v->x),(this->y - v->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector2_obj,subtract,return )
 ...
 ::Dynamic Vector2_obj::_hx___toFlashPoint(){
            	HX_STACK_FRAME("lime.math.Vector2","__toFlashPoint",0xf695b9a7,"lime.math.Vector2.__toFlashPoint","lime/math/Vector2.hx",118,0x7105521c)
            	HX_STACK_THIS(this)
...
Float Vector2_obj::get_length(){
            	HX_STACK_FRAME("lime.math.Vector2","get_length",0xc2e9f35b,"lime.math.Vector2.get_length","lime/math/Vector2.hx",133,0x7105521c)
            	HX_STACK_THIS(this)
HXLINE( 133)		Float _hx_tmp = ((this->x * this->x) + (this->y * this->y));
HXDLIN( 133)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
Float Vector2_obj::distance( ::lime::math::Vector2 pt1, ::lime::math::Vector2 pt2){
            	HX_STACK_FRAME("lime.math.Vector2","distance",0xd9513ee1,"lime.math.Vector2.distance","lime/math/Vector2.hx",44,0x7105521c)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,distance,return )
 ...
 ::lime::math::Vector2 Vector2_obj::interpolate( ::lime::math::Vector2 pt1, ::lime::math::Vector2 pt2,Float f){
            	HX_STACK_FRAME("lime.math.Vector2","interpolate",0xdb68bc95,"lime.math.Vector2.interpolate","lime/math/Vector2.hx",62,0x7105521c)
            	HX_STACK_ARG(pt1,"pt1")
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  62)		return  ::lime::math::Vector2_obj::__new((pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Vector2_obj,interpolate,return )
 ...
 ::lime::math::Vector2 Vector2_obj::polar(Float len,Float angle){
            	HX_STACK_FRAME("lime.math.Vector2","polar",0x53f58092,"lime.math.Vector2.polar","lime/math/Vector2.hx",94,0x7105521c)
            	HX_STACK_ARG(len,"len")
            	HX_STACK_ARG(angle,"angle")
HXLINE(  94)		Float _hx_tmp = ::Math_obj::cos(angle);
HXDLIN(  94)		Float _hx_tmp1 = (len * _hx_tmp);
HXDLIN(  94)		Float _hx_tmp2 = ::Math_obj::sin(angle);
HXDLIN(  94)		return  ::lime::math::Vector2_obj::__new(_hx_tmp1,(len * _hx_tmp2));
            	}
