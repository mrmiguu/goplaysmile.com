...
void Promise_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise","new",0x895fc147,"lime.app.Promise.new","lime/app/Promise.hx",18,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise","get_isComplete",0x07c29585,"lime.app.Promise.get_isComplete","lime/app/Promise.hx",117,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise","get_isError",0x4bfb7f7c,"lime.app.Promise.get_isError","lime/app/Promise.hx",124,0x10ba4f0b)
            	HX_STACK_THIS(this)
