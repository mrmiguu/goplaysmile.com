...
Dynamic Rectangle_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::math::Rectangle Rectangle_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  37)		return  ::lime::math::Rectangle_obj::__new(this->x,this->y,this->width,this->height);
            	}
...
HXLINE( 108)		if ((x1 <= x0)) {
HXLINE( 110)			return  ::lime::math::Rectangle_obj::__new(null(),null(),null(),null());
            		}
...
HXLINE( 117)		if ((y1 <= y0)) {
HXLINE( 119)			return  ::lime::math::Rectangle_obj::__new(null(),null(),null(),null());
            		}
HXLINE( 123)		return  ::lime::math::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
            	}
...
void Rectangle_obj::setEmpty(){
            	HX_STACK_FRAME("lime.math.Rectangle","setEmpty",0x429f2657,"lime.math.Rectangle.setEmpty","lime/math/Rectangle.hx",172,0xce0be93c)
            	HX_STACK_THIS(this)
...
HXLINE( 197)		Bool _hx_tmp = (tx < tx0);
HXDLIN( 197)		if (_hx_tmp) {
HXLINE( 197)			tx0 = tx;
            		}
HXLINE( 198)		Bool _hx_tmp1 = (ty < ty0);
HXDLIN( 198)		if (_hx_tmp1) {
HXLINE( 198)			ty0 = ty;
            		}
HXLINE( 199)		Bool _hx_tmp2 = (tx > tx1);
HXDLIN( 199)		if (_hx_tmp2) {
HXLINE( 199)			tx1 = tx;
            		}
HXLINE( 200)		Bool _hx_tmp3 = (ty > ty1);
...
HXLINE( 205)		Bool _hx_tmp4 = (tx < tx0);
HXDLIN( 205)		if (_hx_tmp4) {
HXLINE( 205)			tx0 = tx;
            		}
HXLINE( 206)		Bool _hx_tmp5 = (ty < ty0);
HXDLIN( 206)		if (_hx_tmp5) {
HXLINE( 206)			ty0 = ty;
            		}
HXLINE( 207)		Bool _hx_tmp6 = (tx > tx1);
HXDLIN( 207)		if (_hx_tmp6) {
HXLINE( 207)			tx1 = tx;
            		}
HXLINE( 208)		Bool _hx_tmp7 = (ty > ty1);
HXDLIN( 208)		if (_hx_tmp7) {
HXLINE( 208)			ty1 = ty;
            		}
HXLINE( 210)		tx = ((m->a * this->x) + (m->c * (this->y + this->height)));
HXLINE( 211)		ty = ((m->b * this->x) + (m->d * (this->y + this->height)));
HXLINE( 213)		Bool _hx_tmp8 = (tx < tx0);
HXDLIN( 213)		if (_hx_tmp8) {
HXLINE( 213)			tx0 = tx;
            		}
HXLINE( 214)		Bool _hx_tmp9 = (ty < ty0);
HXDLIN( 214)		if (_hx_tmp9) {
HXLINE( 214)			ty0 = ty;
            		}
HXLINE( 215)		Bool _hx_tmp10 = (tx > tx1);
HXDLIN( 215)		if (_hx_tmp10) {
HXLINE( 215)			tx1 = tx;
            		}
HXLINE( 216)		Bool _hx_tmp11 = (ty > ty1);
HXDLIN( 216)		if (_hx_tmp11) {
HXLINE( 216)			ty1 = ty;
            		}
HXLINE( 218)		return  ::lime::math::Rectangle_obj::__new((tx0 + m->tx),(ty0 + m->ty),(tx1 - tx0),(ty1 - ty0));
            	}
...
HXDLIN( 236)		Float _hx_tmp2 = this->get_right();
HXDLIN( 236)		Float _hx_tmp3 = toUnion->get_right();
HXDLIN( 236)		if ((_hx_tmp2 < _hx_tmp3)) {
...
HXDLIN( 238)		Float _hx_tmp4 = this->get_bottom();
HXDLIN( 238)		Float _hx_tmp5 = toUnion->get_bottom();
HXDLIN( 238)		if ((_hx_tmp4 < _hx_tmp5)) {
HXLINE( 238)			y1 = toUnion->get_bottom();
            		}
            		else {
HXLINE( 238)			y1 = this->get_bottom();
            		}
HXLINE( 240)		return  ::lime::math::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
            	}
...
HXLINE( 256)		Bool _hx_tmp1 = (this->x < x);
HXDLIN( 256)		if (_hx_tmp1) {
HXLINE( 256)			this->x = x;
            		}
HXLINE( 257)		Bool _hx_tmp2 = (this->y < y);
HXDLIN( 257)		if (_hx_tmp2) {
HXLINE( 257)			this->y = y;
            		}
HXLINE( 258)		Float _hx_tmp3 = this->get_right();
HXDLIN( 258)		if ((_hx_tmp3 > (x + width))) {
HXLINE( 258)			this->width = ((x + width) - this->x);
            		}
HXLINE( 259)		Float _hx_tmp4 = this->get_bottom();
HXDLIN( 259)		if ((_hx_tmp4 > (y + height))) {
...
HXLINE( 279)		Bool _hx_tmp1 = (this->x > x);
HXDLIN( 279)		if (_hx_tmp1) {
HXLINE( 279)			this->x = x;
            		}
HXLINE( 280)		Bool _hx_tmp2 = (this->y > y);
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_bottom,return )
 ...
 ::lime::math::Vector2 Rectangle_obj::get_bottomRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 307)		return  ::lime::math::Vector2_obj::__new((this->x + this->width),(this->y + this->height));
            	}
...
Float Rectangle_obj::set_left(Float l){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
HXLINE( 310)		hx::SubEq(this->width,(l - this->x));
HXDLIN( 310)		this->x = l;
HXDLIN( 310)		return l;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_right,return )
 ...
 ::lime::math::Vector2 Rectangle_obj::get_size(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 313)		return  ::lime::math::Vector2_obj::__new(this->width,this->height);
            	}
...
Float Rectangle_obj::set_top(Float t){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 316)		hx::SubEq(this->height,(t - this->y));
HXDLIN( 316)		this->y = t;
HXDLIN( 316)		return t;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_top,return )
 ...
 ::lime::math::Vector2 Rectangle_obj::get_topLeft(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 317)		return  ::lime::math::Vector2_obj::__new(this->x,this->y);
            	}
