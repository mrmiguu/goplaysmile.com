...
void Application_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Application","new",0x9354427c,"lime.app.Application.new","lime/app/Application.hx",29,0x8bc55476)
            	HX_STACK_THIS(this)
HXLINE(  42)		this->onUpdate =  ::lime::app::_Event_Int_Void_obj::__new();
HXLINE(  55)		super::__construct();
HXLINE(  57)		Bool _hx_tmp = hx::IsNull( ::lime::app::Application_obj::current );
...
HXLINE(  64)		this->windowByID =  ::haxe::ds::IntMap_obj::__new();
HXLINE(  66)		this->backend =  ::lime::_backend::native::NativeApplication_obj::__new(hx::ObjectPtr<OBJ_>(this));
...
HXLINE(  82)		Bool _hx_tmp = (this->_hx___renderers->length > (int)0);
...
HXLINE(  92)		Bool _hx_tmp1 = (this->_hx___windows->length > (int)0);
...
void Application_obj::addRenderer( ::lime::graphics::Renderer renderer){
            	HX_STACK_FRAME("lime.app.Application","addRenderer",0x0a61eaa0,"lime.app.Application.addRenderer","lime/app/Application.hx",112,0x8bc55476)
            	HX_STACK_THIS(this)
...
void Application_obj::create( ::Dynamic config){
            	HX_STACK_FRAME("lime.app.Application","create",0x35e42e60,"lime.app.Application.create","lime/app/Application.hx",131,0x8bc55476)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(config,"config")
HXLINE( 133)		this->config = config;
HXLINE( 135)		this->backend->create(config);
HXLINE( 137)		Bool _hx_tmp = hx::IsNotNull( config );
HXDLIN( 137)		if (_hx_tmp) {
HXLINE( 139)			Bool _hx_tmp1 = ::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00));
HXDLIN( 139)			if (_hx_tmp1) {
HXLINE( 141)				Float value = ( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) );
HXDLIN( 141)				this->backend->setFrameRate(value);
            			}
HXLINE( 145)			Bool _hx_tmp2 = ::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8));
...
HXDLIN( 147)					++_g;
HXLINE( 149)					HX_VARI(  ::lime::ui::Window,window) =  ::lime::ui::Window_obj::__new(windowConfig);
HXLINE( 150)					this->createWindow(window);
            				}
            			}
HXLINE( 160)			Bool _hx_tmp3;
HXDLIN( 160)			Bool _hx_tmp4 = hx::IsNotNull( this->_hx___preloader );
HXDLIN( 160)			if (_hx_tmp4) {
HXLINE( 160)				_hx_tmp3 = this->_hx___preloader->complete;
            			}
            			else {
...
void Application_obj::createWindow( ::lime::ui::Window window){
            	HX_STACK_FRAME("lime.app.Application","createWindow",0xb3683e70,"lime.app.Application.createWindow","lime/app/Application.hx",182,0x8bc55476)
            	HX_STACK_THIS(this)
...
HXLINE( 192)		Bool _hx_tmp = hx::IsNull( window->renderer );
HXDLIN( 192)		if (_hx_tmp) {
HXLINE( 194)			HX_VARI(  ::lime::graphics::Renderer,renderer) =  ::lime::graphics::Renderer_obj::__new(window);
HXLINE( 195)			this->addRenderer(renderer);
            		}
HXLINE( 199)		window->create(hx::ObjectPtr<OBJ_>(this));
HXLINE( 201)		{
HXLINE( 201)			Int key = window->id;
HXDLIN( 201)			this->windowByID->set(key,window);
            		}
...
Int Application_obj::exec(){
            	HX_STACK_FRAME("lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",214,0x8bc55476)
            	HX_STACK_THIS(this)
...
void Application_obj::onModuleExit(Int code){
            	HX_STACK_FRAME("lime.app.Application","onModuleExit",0x4a2a2a4d,"lime.app.Application.onModuleExit","lime/app/Application.hx",225,0x8bc55476)
            	HX_STACK_THIS(this)
...
void Application_obj::onWindowClose( ::lime::ui::Window window){
            	HX_STACK_FRAME("lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",232,0x8bc55476)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
...
void Application_obj::removeModule(::Dynamic module){
            	HX_STACK_FRAME("lime.app.Application","removeModule",0x6e873a74,"lime.app.Application.removeModule","lime/app/Application.hx",243,0x8bc55476)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(module,"module")
HXLINE( 243)		Bool _hx_tmp = hx::IsNotNull( module );
...
void Application_obj::removeWindow( ::lime::ui::Window window){
            	HX_STACK_FRAME("lime.app.Application","removeWindow",0x004099b8,"lime.app.Application.removeWindow","lime/app/Application.hx",255,0x8bc55476)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
HXLINE( 255)		Bool _hx_tmp;
HXDLIN( 255)		Bool _hx_tmp1 = hx::IsNotNull( window );
HXDLIN( 255)		if (_hx_tmp1) {
HXLINE( 255)			Int key = window->id;
HXDLIN( 255)			_hx_tmp = this->windowByID->exists(key);
            		}
            		else {
...
HXLINE( 258)			{
HXLINE( 258)				Int key1 = window->id;
HXDLIN( 258)				this->windowByID->remove(key1);
            			}
HXLINE( 259)			window->close();
HXLINE( 261)			Bool _hx_tmp2 = hx::IsNotNull( window->renderer );
HXDLIN( 261)			if (_hx_tmp2) {
HXLINE( 263)				this->removeRenderer(window->renderer);
            			}
HXLINE( 267)			Bool _hx_tmp3 = hx::IsEq( this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >(),window );
HXDLIN( 267)			if (_hx_tmp3) {
HXLINE( 269)				this->window = null();
            			}
HXLINE( 273)			Bool _hx_tmp4 = (this->_hx___windows->length == (int)0);
...
void Application_obj::setPreloader( ::lime::app::Preloader preloader){
            	HX_STACK_FRAME("lime.app.Application","setPreloader",0xe5520ed8,"lime.app.Application.setPreloader","lime/app/Application.hx",284,0x8bc55476)
            	HX_STACK_THIS(this)
...
Float Application_obj::get_frameRate(){
            	HX_STACK_FRAME("lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",306,0x8bc55476)
            	HX_STACK_THIS(this)
...
Float Application_obj::set_frameRate(Float value){
            	HX_STACK_FRAME("lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",313,0x8bc55476)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,set_frameRate,return )
 ...
 ::lime::app::Preloader Application_obj::get_preloader(){
            	HX_STACK_FRAME("lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",320,0x8bc55476)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_preloader,return )
 ...
 ::lime::graphics::Renderer Application_obj::get_renderer(){
            	HX_STACK_FRAME("lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",327,0x8bc55476)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> Application_obj::get_renderers(){
            	HX_STACK_FRAME("lime.app.Application","get_renderers",0x05eb56c3,"lime.app.Application.get_renderers","lime/app/Application.hx",334,0x8bc55476)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_renderers,return )
 ...
 ::lime::ui::Window Application_obj::get_window(){
            	HX_STACK_FRAME("lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",341,0x8bc55476)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> Application_obj::get_windows(){
            	HX_STACK_FRAME("lime.app.Application","get_windows",0x94992cb6,"lime.app.Application.get_windows","lime/app/Application.hx",348,0x8bc55476)
            	HX_STACK_THIS(this)
