...
void ALCAudioContext_obj::__construct(){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","new",0xe1958d20,"lime.media.ALCAudioContext.new","lime/media/ALCAudioContext.hx",14,0x002ac592)
            	HX_STACK_THIS(this)
...
Bool ALCAudioContext_obj::closeDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","closeDevice",0x34347f2e,"lime.media.ALCAudioContext.closeDevice","lime/media/ALCAudioContext.hx",49,0x002ac592)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,closeDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::createContext( ::Dynamic device,::Array< Int > attrlist){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","createContext",0x5bcf9b13,"lime.media.ALCAudioContext.createContext","lime/media/ALCAudioContext.hx",56,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
void ALCAudioContext_obj::destroyContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","destroyContext",0xfe557f55,"lime.media.ALCAudioContext.destroyContext","lime/media/ALCAudioContext.hx",63,0x002ac592)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,destroyContext,(void))
 ...
 ::Dynamic ALCAudioContext_obj::getContextsDevice( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getContextsDevice",0x539c7b50,"lime.media.ALCAudioContext.getContextsDevice","lime/media/ALCAudioContext.hx",70,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,getContextsDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::getCurrentContext(){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getCurrentContext",0x508a46ac,"lime.media.ALCAudioContext.getCurrentContext","lime/media/ALCAudioContext.hx",77,0x002ac592)
            	HX_STACK_THIS(this)
...
Int ALCAudioContext_obj::getError( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getError",0xa27ae692,"lime.media.ALCAudioContext.getError","lime/media/ALCAudioContext.hx",84,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
::String ALCAudioContext_obj::getErrorString( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getErrorString",0xffadbd03,"lime.media.ALCAudioContext.getErrorString","lime/media/ALCAudioContext.hx",91,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getIntegerv",0x4f8a886e,"lime.media.ALCAudioContext.getIntegerv","lime/media/ALCAudioContext.hx",98,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
::String ALCAudioContext_obj::getString( ::Dynamic device,Int param){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","getString",0x48d67ec7,"lime.media.ALCAudioContext.getString","lime/media/ALCAudioContext.hx",105,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
...
Bool ALCAudioContext_obj::makeContextCurrent( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","makeContextCurrent",0x06ff07d8,"lime.media.ALCAudioContext.makeContextCurrent","lime/media/ALCAudioContext.hx",112,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,makeContextCurrent,return )
 ...
 ::Dynamic ALCAudioContext_obj::openDevice(::String deviceName){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","openDevice",0xe997a340,"lime.media.ALCAudioContext.openDevice","lime/media/ALCAudioContext.hx",119,0x002ac592)
            	HX_STACK_THIS(this)
...
void ALCAudioContext_obj::pauseDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","pauseDevice",0x6df540ec,"lime.media.ALCAudioContext.pauseDevice","lime/media/ALCAudioContext.hx",126,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
void ALCAudioContext_obj::processContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","processContext",0x4447d280,"lime.media.ALCAudioContext.processContext","lime/media/ALCAudioContext.hx",133,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
...
void ALCAudioContext_obj::resumeDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","resumeDevice",0xa7c76563,"lime.media.ALCAudioContext.resumeDevice","lime/media/ALCAudioContext.hx",140,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
void ALCAudioContext_obj::suspendContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.ALCAudioContext","suspendContext",0x772eb113,"lime.media.ALCAudioContext.suspendContext","lime/media/ALCAudioContext.hx",147,0x002ac592)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
