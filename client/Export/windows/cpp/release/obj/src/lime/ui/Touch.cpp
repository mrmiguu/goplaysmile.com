...
HXLINE(  28)		this->dx = dx;
HXLINE(  29)		this->dy = dy;
HXLINE(  30)		this->pressure = pressure;
HXLINE(  31)		this->device = device;
            	}
...
hx::ObjectPtr< Touch_obj > Touch_obj::__new(Float x,Float y,Int id,Float dx,Float dy,Float pressure,Int device)
{
	...
	_hx_result->__construct(x,y,id,dx,dy,pressure,device);
	return _hx_result;
}
...
{
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",10,0xf69781a0)
HXLINE(  10)		onEnd =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",11,0xf69781a0)
HXLINE(  11)		onMove =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",12,0xf69781a0)
HXLINE(  12)		onStart =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
}
