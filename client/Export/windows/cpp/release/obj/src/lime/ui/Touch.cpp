...
void Touch_obj::__construct(Float x,Float y,Int id,Float dx,Float dy,Float pressure,Int device){
            	HX_STACK_FRAME("lime.ui.Touch","new",0xc7f37270,"lime.ui.Touch.new","lime/ui/Touch.hx",28,0xf69781a0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(id,"id")
...
{
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",15,0xf69781a0)
HXLINE(  15)		onEnd =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",16,0xf69781a0)
HXLINE(  16)		onMove =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",17,0xf69781a0)
HXLINE(  17)		onStart =  ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
            	}
}
