...
void _HTTPRequest_openfl_utils_ByteArray_obj::__construct(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest_openfl_utils_ByteArray","new",0xb743fd13,"lime.net._HTTPRequest_openfl_utils_ByteArray.new","lime/net/HTTPRequest.hx",329,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE( 329)		super::__construct(uri);
            	}
...
Dynamic _HTTPRequest_openfl_utils_ByteArray_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic _HTTPRequest_openfl_utils_ByteArray_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.net._HTTPRequest_openfl_utils_ByteArray","fromBytes",0xc0fc2794,"lime.net._HTTPRequest_openfl_utils_ByteArray.fromBytes","openfl/net/URLLoader.hx",62,0x11daec0d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  62)		return ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(bytes);
            	}
