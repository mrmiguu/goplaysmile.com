...
Dynamic ALContext_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic ALContext_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.media.openal._ALContext.ALContext_Impl_","_new",0x7c63ff3e,"lime.media.openal._ALContext.ALContext_Impl_._new","lime/media/openal/ALContext.hx",13,0x28b7a4af)
