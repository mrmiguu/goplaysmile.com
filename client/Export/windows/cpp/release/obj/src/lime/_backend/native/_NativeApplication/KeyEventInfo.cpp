...
Int modifier = __o_modifier.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",846,0xb13849fd)
            	HX_STACK_THIS(this)
...
Dynamic KeyEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",858,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 858)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__new(this->type,this->windowID,this->keyCode,this->modifier);
            	}
