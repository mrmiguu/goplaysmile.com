...
void Preloader_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Preloader","new",0x922e2422,"lime.app.Preloader.new","lime/app/Preloader.hx",23,0xcf198510)
            	HX_STACK_THIS(this)
HXLINE(  28)		this->onProgress =  ::lime::app::_Event_Int_Int_Void_obj::__new();
HXLINE(  27)		this->onComplete =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  45)		this->onProgress->add(this->update_dyn(),null(),null());
            	}
...
void Preloader_obj::create( ::Dynamic config){
            	HX_STACK_FRAME("lime.app.Preloader","create",0x6b66587a,"lime.app.Preloader.create","lime/app/Preloader.hx",62,0xcf198510)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(config,"config")
HXLINE(  62)		this->start();
            	}
...
void Preloader_obj::start(){
            	HX_STACK_FRAME("lime.app.Preloader","start",0xfff3bca4,"lime.app.Preloader.start","lime/app/Preloader.hx",273,0xcf198510)
            	HX_STACK_THIS(this)
HXLINE( 275)		this->complete = true;
HXLINE( 285)		this->onComplete->dispatch();
            	}
...
void Preloader_obj::update(Int loaded,Int total){
            	HX_STACK_FRAME("lime.app.Preloader","update",0x765c7787,"lime.app.Preloader.update","lime/app/Preloader.hx",290,0xcf198510)
            	HX_STACK_THIS(this)
