...
void Promise_openfl_display_BitmapData_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","new",0x68417acd,"lime.app.Promise_openfl_display_BitmapData.new","lime/app/Promise.hx",18,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_openfl_display_BitmapData_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::complete( ::openfl::display::BitmapData data){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","complete",0x7cf86b2c,"lime.app.Promise_openfl_display_BitmapData.complete","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,complete,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","completeWith",0xc87d1352,"lime.app.Promise_openfl_display_BitmapData.completeWith","lime/app/Promise.hx",49,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,completeWith,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","error",0xf1a8ab75,"lime.app.Promise_openfl_display_BitmapData.error","lime/app/Promise.hx",61,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,error,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","progress",0x835b6220,"lime.app.Promise_openfl_display_BitmapData.progress","lime/app/Promise.hx",87,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_display_BitmapData_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isComplete",0x02ecddbf,"lime.app.Promise_openfl_display_BitmapData.get_isComplete","lime/app/Promise.hx",117,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_display_BitmapData_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isError",0x531b2f02,"lime.app.Promise_openfl_display_BitmapData.get_isError","lime/app/Promise.hx",124,0x10ba4f0b)
            	HX_STACK_THIS(this)
