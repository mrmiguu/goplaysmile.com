...
Float w = __o_w.Default(((Float)0.));
            	HX_STACK_FRAME("lime.math.Vector4","new",0xd5c0ed36,"lime.math.Vector4.new","lime/math/Vector4.hx",25,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
...
Dynamic Vector4_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::math::Vector4 Vector4_obj::add( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","add",0xd5b70ef7,"lime.math.Vector4.add","lime/math/Vector4.hx",37,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  37)		return  ::lime::math::Vector4_obj::__new((this->x + a->x),(this->y + a->y),(this->z + a->z),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector4_obj,add,return )
 ...
 ::lime::math::Vector4 Vector4_obj::clone(){
            	HX_STACK_FRAME("lime.math.Vector4","clone",0x28f191b3,"lime.math.Vector4.clone","lime/math/Vector4.hx",56,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE(  56)		return  ::lime::math::Vector4_obj::__new(this->x,this->y,this->z,this->w);
            	}
...
void Vector4_obj::copyFrom( ::lime::math::Vector4 sourceVector4){
            	HX_STACK_FRAME("lime.math.Vector4","copyFrom",0xb64da729,"lime.math.Vector4.copyFrom","lime/math/Vector4.hx",61,0x7257bf5a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Vector4_obj,copyFrom,(void))
 ...
 ::lime::math::Vector4 Vector4_obj::crossProduct( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","crossProduct",0xdc193ff9,"lime.math.Vector4.crossProduct","lime/math/Vector4.hx",72,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  72)		return  ::lime::math::Vector4_obj::__new(((this->y * a->z) - (this->z * a->y)),((this->z * a->x) - (this->x * a->z)),((this->x * a->y) - (this->y * a->x)),(int)1);
            	}
...
void Vector4_obj::decrementBy( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","decrementBy",0xf530fda0,"lime.math.Vector4.decrementBy","lime/math/Vector4.hx",77,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  79)		hx::SubEq(this->x,a->x);
HXLINE(  80)		hx::SubEq(this->y,a->y);
HXLINE(  81)		hx::SubEq(this->z,a->z);
            	}
...
Float Vector4_obj::dotProduct( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","dotProduct",0xf4c9f190,"lime.math.Vector4.dotProduct","lime/math/Vector4.hx",99,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  99)		return (((this->x * a->x) + (this->y * a->y)) + (this->z * a->z));
            	}
...
Bool Vector4_obj::equals( ::lime::math::Vector4 toCompare, ::Dynamic __o_allFour){
 ::Dynamic allFour = __o_allFour.Default(false);
            	HX_STACK_FRAME("lime.math.Vector4","equals",0x5c12fb29,"lime.math.Vector4.equals","lime/math/Vector4.hx",106,0x7257bf5a)
            	HX_STACK_THIS(this)
...
void Vector4_obj::incrementBy( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","incrementBy",0x3c274cbc,"lime.math.Vector4.incrementBy","lime/math/Vector4.hx",111,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 113)		hx::AddEq(this->x,a->x);
HXLINE( 114)		hx::AddEq(this->y,a->y);
HXLINE( 115)		hx::AddEq(this->z,a->z);
            	}
...
Bool Vector4_obj::nearEquals( ::lime::math::Vector4 toCompare,Float tolerance, ::Dynamic __o_allFour){
 ::Dynamic allFour = __o_allFour.Default(false);
            	HX_STACK_FRAME("lime.math.Vector4","nearEquals",0xb54b3b31,"lime.math.Vector4.nearEquals","lime/math/Vector4.hx",122,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
...
HXDLIN( 122)		Float _hx_tmp2 = (this->x - toCompare->x);
HXDLIN( 122)		Float _hx_tmp3 = ::Math_obj::abs(_hx_tmp2);
HXDLIN( 122)		if ((_hx_tmp3 < tolerance)) {
HXLINE( 122)			Float _hx_tmp4 = (this->y - toCompare->y);
HXDLIN( 122)			Float _hx_tmp5 = ::Math_obj::abs(_hx_tmp4);
HXDLIN( 122)			_hx_tmp1 = (_hx_tmp5 < tolerance);
            		}
            		else {
HXLINE( 122)			_hx_tmp1 = false;
            		}
HXDLIN( 122)		if (_hx_tmp1) {
HXLINE( 122)			Float _hx_tmp6 = (this->z - toCompare->z);
HXDLIN( 122)			Float _hx_tmp7 = ::Math_obj::abs(_hx_tmp6);
HXDLIN( 122)			_hx_tmp = (_hx_tmp7 < tolerance);
            		}
            		else {
...
HXLINE( 122)				Float _hx_tmp8 = (this->w - toCompare->w);
HXDLIN( 122)				Float _hx_tmp9 = ::Math_obj::abs(_hx_tmp8);
HXDLIN( 122)				return (_hx_tmp9 < tolerance);
            			}
            			else {
...
void Vector4_obj::negate(){
            	HX_STACK_FRAME("lime.math.Vector4","negate",0x03394eac,"lime.math.Vector4.negate","lime/math/Vector4.hx",127,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE( 129)		hx::MultEq(this->x,(int)-1);
HXLINE( 130)		hx::MultEq(this->y,(int)-1);
HXLINE( 131)		hx::MultEq(this->z,(int)-1);
            	}
...
Float Vector4_obj::normalize(){
            	HX_STACK_FRAME("lime.math.Vector4","normalize",0xecbc98e3,"lime.math.Vector4.normalize","lime/math/Vector4.hx",136,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE( 138)		Float _hx_tmp = (((this->x * this->x) + (this->y * this->y)) + (this->z * this->z));
HXDLIN( 138)		HX_VARI( Float,l) = ::Math_obj::sqrt(_hx_tmp);
HXLINE( 140)		if ((l != (int)0)) {
HXLINE( 142)			hx::DivEq(this->x,l);
HXLINE( 143)			hx::DivEq(this->y,l);
HXLINE( 144)			hx::DivEq(this->z,l);
            		}
HXLINE( 148)		return l;
            	}
...
void Vector4_obj::project(){
            	HX_STACK_FRAME("lime.math.Vector4","project",0xf5d652af,"lime.math.Vector4.project","lime/math/Vector4.hx",153,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE( 155)		hx::DivEq(this->x,this->w);
HXLINE( 156)		hx::DivEq(this->y,this->w);
HXLINE( 157)		hx::DivEq(this->z,this->w);
            	}
...
void Vector4_obj::scaleBy(Float s){
            	HX_STACK_FRAME("lime.math.Vector4","scaleBy",0x64f27ed7,"lime.math.Vector4.scaleBy","lime/math/Vector4.hx",162,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE( 164)		hx::MultEq(this->x,s);
HXLINE( 165)		hx::MultEq(this->y,s);
HXLINE( 166)		hx::MultEq(this->z,s);
            	}
...
void Vector4_obj::setTo(Float xa,Float ya,Float za){
            	HX_STACK_FRAME("lime.math.Vector4","setTo",0x5abe1013,"lime.math.Vector4.setTo","lime/math/Vector4.hx",171,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xa,"xa")
            	HX_STACK_ARG(ya,"ya")
            	HX_STACK_ARG(za,"za")
...
HX_DEFINE_DYNAMIC_FUNC3(Vector4_obj,setTo,(void))
 ...
 ::lime::math::Vector4 Vector4_obj::subtract( ::lime::math::Vector4 a){
            	HX_STACK_FRAME("lime.math.Vector4","subtract",0xe5fe107e,"lime.math.Vector4.subtract","lime/math/Vector4.hx",182,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 182)		return  ::lime::math::Vector4_obj::__new((this->x - a->x),(this->y - a->y),(this->z - a->z),null());
            	}
...
::String Vector4_obj::toString(){
            	HX_STACK_FRAME("lime.math.Vector4","toString",0x265b6c16,"lime.math.Vector4.toString","lime/math/Vector4.hx",189,0x7257bf5a)
            	HX_STACK_THIS(this)
...
Float Vector4_obj::get_length(){
            	HX_STACK_FRAME("lime.math.Vector4","get_length",0x4668ce99,"lime.math.Vector4.get_length","lime/math/Vector4.hx",203,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE( 203)		Float _hx_tmp = (((this->x * this->x) + (this->y * this->y)) + (this->z * this->z));
HXDLIN( 203)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
Float Vector4_obj::get_lengthSquared(){
            	HX_STACK_FRAME("lime.math.Vector4","get_lengthSquared",0xe5b2d78e,"lime.math.Vector4.get_lengthSquared","lime/math/Vector4.hx",210,0x7257bf5a)
            	HX_STACK_THIS(this)
HXLINE( 210)		return (((this->x * this->x) + (this->y * this->y)) + (this->z * this->z));
            	}
...
Float Vector4_obj::angleBetween( ::lime::math::Vector4 a, ::lime::math::Vector4 b){
            	HX_STACK_FRAME("lime.math.Vector4","angleBetween",0xe2247e9f,"lime.math.Vector4.angleBetween","lime/math/Vector4.hx",42,0x7257bf5a)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE(  44)		HX_VARI(  ::lime::math::Vector4,a0) =  ::lime::math::Vector4_obj::__new(a->x,a->y,a->z,a->w);
HXLINE(  45)		{
HXLINE(  45)			Float _hx_tmp = (((a0->x * a0->x) + (a0->y * a0->y)) + (a0->z * a0->z));
HXDLIN(  45)			HX_VARI( Float,l) = ::Math_obj::sqrt(_hx_tmp);
HXDLIN(  45)			if ((l != (int)0)) {
HXLINE(  45)				hx::DivEq(a0->x,l);
HXDLIN(  45)				hx::DivEq(a0->y,l);
HXDLIN(  45)				hx::DivEq(a0->z,l);
            			}
            		}
HXLINE(  46)		HX_VARI(  ::lime::math::Vector4,b0) =  ::lime::math::Vector4_obj::__new(b->x,b->y,b->z,b->w);
HXLINE(  47)		{
HXLINE(  47)			Float _hx_tmp1 = (((b0->x * b0->x) + (b0->y * b0->y)) + (b0->z * b0->z));
HXDLIN(  47)			HX_VARI_NAME( Float,l1,"l") = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  47)			if ((l1 != (int)0)) {
HXLINE(  47)				hx::DivEq(b0->x,l1);
HXDLIN(  47)				hx::DivEq(b0->y,l1);
HXDLIN(  47)				hx::DivEq(b0->z,l1);
            			}
            		}
HXLINE(  49)		Float _hx_tmp2 = (((a0->x * b0->x) + (a0->y * b0->y)) + (a0->z * b0->z));
HXDLIN(  49)		return ::Math_obj::acos(_hx_tmp2);
            	}
...
Float Vector4_obj::distance( ::lime::math::Vector4 pt1, ::lime::math::Vector4 pt2){
            	HX_STACK_FRAME("lime.math.Vector4","distance",0x59e62e9f,"lime.math.Vector4.distance","lime/math/Vector4.hx",86,0x7257bf5a)
            	HX_STACK_ARG(pt1,"pt1")
            	HX_STACK_ARG(pt2,"pt2")
HXLINE(  88)		HX_VARI( Float,x) = (pt2->x - pt1->x);
HXLINE(  89)		HX_VARI( Float,y) = (pt2->y - pt1->y);
HXLINE(  90)		HX_VARI( Float,z) = (pt2->z - pt1->z);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Vector4_obj,distance,return )
 ...
 ::lime::math::Vector4 Vector4_obj::get_X_AXIS(){
            	HX_STACK_FRAME("lime.math.Vector4","get_X_AXIS",0xb513fadb,"lime.math.Vector4.get_X_AXIS","lime/math/Vector4.hx",217,0x7257bf5a)
HXLINE( 217)		return  ::lime::math::Vector4_obj::__new((int)1,(int)0,(int)0,null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vector4_obj,get_X_AXIS,return )
 ...
 ::lime::math::Vector4 Vector4_obj::get_Y_AXIS(){
            	HX_STACK_FRAME("lime.math.Vector4","get_Y_AXIS",0x1b6f573a,"lime.math.Vector4.get_Y_AXIS","lime/math/Vector4.hx",224,0x7257bf5a)
HXLINE( 224)		return  ::lime::math::Vector4_obj::__new((int)0,(int)1,(int)0,null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vector4_obj,get_Y_AXIS,return )
 ...
 ::lime::math::Vector4 Vector4_obj::get_Z_AXIS(){
            	HX_STACK_FRAME("lime.math.Vector4","get_Z_AXIS",0x81cab399,"lime.math.Vector4.get_Z_AXIS","lime/math/Vector4.hx",231,0x7257bf5a)
HXLINE( 231)		return  ::lime::math::Vector4_obj::__new((int)0,(int)0,(int)1,null());
            	}
