...
Dynamic Vector4_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::math::Vector4 Vector4_obj::add( ::lime::math::Vector4 a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  31)		return  ::lime::math::Vector4_obj::__new((this->x + a->x),(this->y + a->y),(this->z + a->z),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector4_obj,add,return )
 ...
 ::lime::math::Vector4 Vector4_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  50)		return  ::lime::math::Vector4_obj::__new(this->x,this->y,this->z,this->w);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector4_obj,copyFrom,(void))
 ...
 ::lime::math::Vector4 Vector4_obj::crossProduct( ::lime::math::Vector4 a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  66)		return  ::lime::math::Vector4_obj::__new(((this->y * a->z) - (this->z * a->y)),((this->z * a->x) - (this->x * a->z)),((this->x * a->y) - (this->y * a->x)),(int)1);
            	}
...
void Vector4_obj::decrementBy( ::lime::math::Vector4 a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  73)		hx::SubEq(this->x,a->x);
HXLINE(  74)		hx::SubEq(this->y,a->y);
HXLINE(  75)		hx::SubEq(this->z,a->z);
            	}
...
void Vector4_obj::incrementBy( ::lime::math::Vector4 a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 107)		hx::AddEq(this->x,a->x);
HXLINE( 108)		hx::AddEq(this->y,a->y);
HXLINE( 109)		hx::AddEq(this->z,a->z);
            	}
...
Bool Vector4_obj::nearEquals( ::lime::math::Vector4 toCompare,Float tolerance, ::Dynamic __o_allFour){
 ::Dynamic allFour = __o_allFour.Default(false);
            	HX_STACK_FRAME("lime.math.Vector4","nearEquals",0xb54b3b31,"lime.math.Vector4.nearEquals","lime/math/Vector4.hx",116,0x7257bf5a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
...
HXDLIN( 116)		Float _hx_tmp2 = (this->x - toCompare->x);
HXDLIN( 116)		Float _hx_tmp3 = ::Math_obj::abs(_hx_tmp2);
HXDLIN( 116)		if ((_hx_tmp3 < tolerance)) {
HXLINE( 116)			Float _hx_tmp4 = (this->y - toCompare->y);
HXDLIN( 116)			Float _hx_tmp5 = ::Math_obj::abs(_hx_tmp4);
HXDLIN( 116)			_hx_tmp1 = (_hx_tmp5 < tolerance);
            		}
            		else {
HXLINE( 116)			_hx_tmp1 = false;
            		}
HXDLIN( 116)		if (_hx_tmp1) {
HXLINE( 116)			Float _hx_tmp6 = (this->z - toCompare->z);
HXDLIN( 116)			Float _hx_tmp7 = ::Math_obj::abs(_hx_tmp6);
HXDLIN( 116)			_hx_tmp = (_hx_tmp7 < tolerance);
            		}
            		else {
...
HXLINE( 116)				Float _hx_tmp8 = (this->w - toCompare->w);
HXDLIN( 116)				Float _hx_tmp9 = ::Math_obj::abs(_hx_tmp8);
HXDLIN( 116)				return (_hx_tmp9 < tolerance);
            			}
            			else {
...
void Vector4_obj::negate(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 123)		hx::MultEq(this->x,(int)-1);
HXLINE( 124)		hx::MultEq(this->y,(int)-1);
HXLINE( 125)		hx::MultEq(this->z,(int)-1);
            	}
...
Float Vector4_obj::normalize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 132)		Float _hx_tmp = (((this->x * this->x) + (this->y * this->y)) + (this->z * this->z));
HXDLIN( 132)		HX_VARI( Float,l) = ::Math_obj::sqrt(_hx_tmp);
HXLINE( 134)		if ((l != (int)0)) {
HXLINE( 136)			hx::DivEq(this->x,l);
HXLINE( 137)			hx::DivEq(this->y,l);
HXLINE( 138)			hx::DivEq(this->z,l);
            		}
HXLINE( 142)		return l;
            	}
...
void Vector4_obj::project(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 149)		hx::DivEq(this->x,this->w);
HXLINE( 150)		hx::DivEq(this->y,this->w);
HXLINE( 151)		hx::DivEq(this->z,this->w);
            	}
...
void Vector4_obj::scaleBy(Float s){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE( 158)		hx::MultEq(this->x,s);
HXLINE( 159)		hx::MultEq(this->y,s);
HXLINE( 160)		hx::MultEq(this->z,s);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Vector4_obj,setTo,(void))
 ...
 ::lime::math::Vector4 Vector4_obj::subtract( ::lime::math::Vector4 a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 176)		return  ::lime::math::Vector4_obj::__new((this->x - a->x),(this->y - a->y),(this->z - a->z),null());
            	}
...
Float Vector4_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 197)		Float _hx_tmp = (((this->x * this->x) + (this->y * this->y)) + (this->z * this->z));
HXDLIN( 197)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
Float Vector4_obj::angleBetween( ::lime::math::Vector4 a, ::lime::math::Vector4 b){
            	...
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE(  38)		HX_VARI(  ::lime::math::Vector4,a0) =  ::lime::math::Vector4_obj::__new(a->x,a->y,a->z,a->w);
HXLINE(  39)		{
HXLINE(  39)			Float _hx_tmp = (((a0->x * a0->x) + (a0->y * a0->y)) + (a0->z * a0->z));
HXDLIN(  39)			HX_VARI( Float,l) = ::Math_obj::sqrt(_hx_tmp);
HXDLIN(  39)			if ((l != (int)0)) {
HXLINE(  39)				hx::DivEq(a0->x,l);
HXDLIN(  39)				hx::DivEq(a0->y,l);
HXDLIN(  39)				hx::DivEq(a0->z,l);
            			}
            		}
HXLINE(  40)		HX_VARI(  ::lime::math::Vector4,b0) =  ::lime::math::Vector4_obj::__new(b->x,b->y,b->z,b->w);
HXLINE(  41)		{
HXLINE(  41)			Float _hx_tmp1 = (((b0->x * b0->x) + (b0->y * b0->y)) + (b0->z * b0->z));
HXDLIN(  41)			HX_VARI_NAME( Float,l1,"l") = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  41)			if ((l1 != (int)0)) {
HXLINE(  41)				hx::DivEq(b0->x,l1);
HXDLIN(  41)				hx::DivEq(b0->y,l1);
HXDLIN(  41)				hx::DivEq(b0->z,l1);
            			}
            		}
HXLINE(  43)		Float _hx_tmp2 = (((a0->x * b0->x) + (a0->y * b0->y)) + (a0->z * b0->z));
HXDLIN(  43)		return ::Math_obj::acos(_hx_tmp2);
            	}
...
HXLINE( 211)		return  ::lime::math::Vector4_obj::__new((int)1,(int)0,(int)0,null());
            	}
...
HXLINE( 218)		return  ::lime::math::Vector4_obj::__new((int)0,(int)1,(int)0,null());
            	}
...
HXLINE( 225)		return  ::lime::math::Vector4_obj::__new((int)0,(int)0,(int)1,null());
            	}
