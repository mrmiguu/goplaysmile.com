...
Dynamic Deflate_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::haxe::io::Bytes Deflate_obj::compress( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.compress.Deflate","compress",0x2979d39b,"lime.utils.compress.Deflate.compress","lime/utils/compress/Deflate.hx",27,0x7e6cac08)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  27)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  27)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(bytes);
HXDLIN(  27)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_deflate_compress(_hx_tmp,hx::DynamicPtr(bytes1))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Deflate_obj,compress,return )
 ...
 ::haxe::io::Bytes Deflate_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.compress.Deflate","decompress",0x4c84c45c,"lime.utils.compress.Deflate.decompress","lime/utils/compress/Deflate.hx",63,0x7e6cac08)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  63)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  63)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(bytes);
HXDLIN(  63)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_deflate_decompress(_hx_tmp,hx::DynamicPtr(bytes1))) );
HXDLIN(  63)		return Dynamic(hx::DynamicPtr(inVal));
            	}
