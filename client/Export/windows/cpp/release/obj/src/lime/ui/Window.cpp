...
HXLINE(  55)		this->onTextInput =  ::lime::app::_Event_String_Void_obj::__new();
HXLINE(  54)		this->onTextEdit =  ::lime::app::_Event_String_Int_Int_Void_obj::__new();
HXLINE(  53)		this->onRestore =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  52)		this->onResize =  ::lime::app::_Event_Int_Int_Void_obj::__new();
HXLINE(  51)		this->onMove =  ::lime::app::_Event_Float_Float_Void_obj::__new();
HXLINE(  50)		this->onMouseWheel =  ::lime::app::_Event_Float_Float_Void_obj::__new();
HXLINE(  49)		this->onMouseUp =  ::lime::app::_Event_Float_Float_Int_Void_obj::__new();
HXLINE(  48)		this->onMouseMoveRelative =  ::lime::app::_Event_Float_Float_Void_obj::__new();
HXLINE(  47)		this->onMouseMove =  ::lime::app::_Event_Float_Float_Void_obj::__new();
HXLINE(  46)		this->onMouseDown =  ::lime::app::_Event_Float_Float_Int_Void_obj::__new();
HXLINE(  45)		this->onMinimize =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  44)		this->onLeave =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  43)		this->onKeyUp =  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__new();
HXLINE(  42)		this->onKeyDown =  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__new();
HXLINE(  41)		this->onFullscreen =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  40)		this->onFocusOut =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  39)		this->onFocusIn =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  38)		this->onEnter =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  37)		this->onDropFile =  ::lime::app::_Event_String_Void_obj::__new();
HXLINE(  36)		this->onDeactivate =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  35)		this->onCreate =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  34)		this->onClose =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  33)		this->onActivate =  ::lime::app::_Event_Void_Void_obj::__new();
...
HXLINE(  92)		Bool _hx_tmp = hx::IsNotNull( config );
HXDLIN(  92)		if (_hx_tmp) {
HXLINE(  94)			Bool _hx_tmp1 = ::Reflect_obj::hasField(config,HX_("width",06,b6,62,ca));
HXDLIN(  94)			if (_hx_tmp1) {
HXLINE(  94)				this->_hx___width = config->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic);
            			}
HXLINE(  95)			Bool _hx_tmp2 = ::Reflect_obj::hasField(config,HX_("height",e7,07,4c,02));
HXDLIN(  95)			if (_hx_tmp2) {
HXLINE(  95)				this->_hx___height = config->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic);
            			}
HXLINE(  96)			Bool _hx_tmp3 = ::Reflect_obj::hasField(config,HX_("x",78,00,00,00));
HXDLIN(  96)			if (_hx_tmp3) {
HXLINE(  96)				this->_hx___x = config->__Field(HX_("x",78,00,00,00),hx::paccDynamic);
            			}
HXLINE(  97)			Bool _hx_tmp4 = ::Reflect_obj::hasField(config,HX_("y",79,00,00,00));
HXDLIN(  97)			if (_hx_tmp4) {
HXLINE(  97)				this->_hx___y = config->__Field(HX_("y",79,00,00,00),hx::paccDynamic);
            			}
HXLINE(  98)			Bool _hx_tmp5 = ::Reflect_obj::hasField(config,HX_("fullscreen",3b,3a,b4,f9));
HXDLIN(  98)			if (_hx_tmp5) {
HXLINE(  98)				this->_hx___fullscreen = config->__Field(HX_("fullscreen",3b,3a,b4,f9),hx::paccDynamic);
            			}
HXLINE(  99)			Bool _hx_tmp6 = ::Reflect_obj::hasField(config,HX_("borderless",45,46,71,17));
HXDLIN(  99)			if (_hx_tmp6) {
HXLINE(  99)				this->_hx___borderless = config->__Field(HX_("borderless",45,46,71,17),hx::paccDynamic);
            			}
HXLINE( 100)			Bool _hx_tmp7 = ::Reflect_obj::hasField(config,HX_("resizable",6b,37,50,a9));
HXDLIN( 100)			if (_hx_tmp7) {
HXLINE( 100)				this->_hx___resizable = config->__Field(HX_("resizable",6b,37,50,a9),hx::paccDynamic);
            			}
HXLINE( 101)			Bool _hx_tmp8 = ::Reflect_obj::hasField(config,HX_("title",98,15,3b,10));
HXDLIN( 101)			if (_hx_tmp8) {
HXLINE( 101)				this->_hx___title = ( (::String)(config->__Field(HX_("title",98,15,3b,10),hx::paccDynamic)) );
            			}
            		}
HXLINE( 105)		this->backend =  ::lime::_backend::native::NativeWindow_obj::__new(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Window_obj::alert(::String message,::String title){
            	HX_STACK_FRAME("lime.ui.Window","alert",0xe7cddb7f,"lime.ui.Window.alert","lime/ui/Window.hx",112,0x6ac7286d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
            	HX_STACK_ARG(title,"title")
HXLINE( 112)		this->backend->alert(message,title);
            	}
...
void Window_obj::close(){
            	HX_STACK_FRAME("lime.ui.Window","close",0x0ea29bdb,"lime.ui.Window.close","lime/ui/Window.hx",119,0x6ac7286d)
            	HX_STACK_THIS(this)
...
HXLINE( 162)		::lime::ui::Gamepad_obj::addMappings(::Array_obj< ::String >::fromData( _hx_array_data_0,25));
HXLINE( 257)		Bool _hx_tmp = hx::IsNotNull( this->renderer );
...
void Window_obj::focus(){
            	HX_STACK_FRAME("lime.ui.Window","focus",0xcac8e3fb,"lime.ui.Window.focus","lime/ui/Window.hx",268,0x6ac7286d)
            	HX_STACK_THIS(this)
HXLINE( 268)		this->backend->focus();
            	}
...
void Window_obj::move(Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 275)		this->backend->move(x,y);
...
HXLINE( 285)		this->backend->resize(width,height);
...
HXLINE( 295)		Bool _hx_tmp = hx::IsNull( image );
HXDLIN( 295)		if (_hx_tmp) {
HXLINE( 297)			return;
            		}
HXLINE( 301)		this->backend->setIcon(image);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Window_obj,toString,return )
 ...
 ::lime::_hx_system::Display Window_obj::get_display(){
            	HX_STACK_FRAME("lime.ui.Window","get_display",0x816e4abc,"lime.ui.Window.get_display","lime/ui/Window.hx",322,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::get_borderless(){
            	HX_STACK_FRAME("lime.ui.Window","get_borderless",0x37452e0b,"lime.ui.Window.get_borderless","lime/ui/Window.hx",329,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::set_borderless(Bool value){
            	HX_STACK_FRAME("lime.ui.Window","set_borderless",0x5765167f,"lime.ui.Window.set_borderless","lime/ui/Window.hx",336,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::get_enableTextEvents(){
            	HX_STACK_FRAME("lime.ui.Window","get_enableTextEvents",0xb1dee44f,"lime.ui.Window.get_enableTextEvents","lime/ui/Window.hx",343,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::set_enableTextEvents(Bool value){
            	HX_STACK_FRAME("lime.ui.Window","set_enableTextEvents",0x7e969bc3,"lime.ui.Window.set_enableTextEvents","lime/ui/Window.hx",350,0x6ac7286d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
Bool Window_obj::get_fullscreen(){
            	HX_STACK_FRAME("lime.ui.Window","get_fullscreen",0x19882201,"lime.ui.Window.get_fullscreen","lime/ui/Window.hx",357,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::set_fullscreen(Bool value){
            	HX_STACK_FRAME("lime.ui.Window","set_fullscreen",0x39a80a75,"lime.ui.Window.set_fullscreen","lime/ui/Window.hx",364,0x6ac7286d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
Int Window_obj::get_height(){
            	HX_STACK_FRAME("lime.ui.Window","get_height",0x425314ad,"lime.ui.Window.get_height","lime/ui/Window.hx",371,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::get_maximized(){
            	HX_STACK_FRAME("lime.ui.Window","get_maximized",0xaea9c112,"lime.ui.Window.get_maximized","lime/ui/Window.hx",386,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::get_minimized(){
            	HX_STACK_FRAME("lime.ui.Window","get_minimized",0xd866ae80,"lime.ui.Window.get_minimized","lime/ui/Window.hx",401,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Bool Window_obj::get_resizable(){
            	HX_STACK_FRAME("lime.ui.Window","get_resizable",0x5918ea65,"lime.ui.Window.get_resizable","lime/ui/Window.hx",416,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Float Window_obj::get_scale(){
            	HX_STACK_FRAME("lime.ui.Window","get_scale",0x19cffc84,"lime.ui.Window.get_scale","lime/ui/Window.hx",431,0x6ac7286d)
            	HX_STACK_THIS(this)
...
::String Window_obj::get_title(){
            	HX_STACK_FRAME("lime.ui.Window","get_title",0xb13c4392,"lime.ui.Window.get_title","lime/ui/Window.hx",438,0x6ac7286d)
            	HX_STACK_THIS(this)
...
::String Window_obj::set_title(::String value){
            	HX_STACK_FRAME("lime.ui.Window","set_title",0x948d2f9e,"lime.ui.Window.set_title","lime/ui/Window.hx",445,0x6ac7286d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 445)		return (this->_hx___title = this->backend->setTitle(value));
            	}
...
Int Window_obj::get_width(){
            	HX_STACK_FRAME("lime.ui.Window","get_width",0x6b63e400,"lime.ui.Window.get_width","lime/ui/Window.hx",452,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Int Window_obj::get_x(){
            	HX_STACK_FRAME("lime.ui.Window","get_x",0x57a02972,"lime.ui.Window.get_x","lime/ui/Window.hx",467,0x6ac7286d)
            	HX_STACK_THIS(this)
...
Int Window_obj::get_y(){
            	HX_STACK_FRAME("lime.ui.Window","get_y",0x57a02973,"lime.ui.Window.get_y","lime/ui/Window.hx",482,0x6ac7286d)
            	HX_STACK_THIS(this)
