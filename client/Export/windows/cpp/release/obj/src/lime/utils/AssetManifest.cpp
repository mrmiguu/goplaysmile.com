...
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_105_serialize,"lime.utils.AssetManifest","serialize",0x0634cbfb,"lime.utils.AssetManifest.serialize","lime/utils/AssetManifest.hx",105,0x0cdd5257)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_57_fromFile,"lime.utils.AssetManifest","fromFile",0x2911ab4b,"lime.utils.AssetManifest.fromFile","lime/utils/AssetManifest.hx",57,0x0cdd5257)
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_64_loadFromBytes,"lime.utils.AssetManifest","loadFromBytes",0x6e69db36,"lime.utils.AssetManifest.loadFromBytes","lime/utils/AssetManifest.hx",64,0x0cdd5257)
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_73_loadFromFile,"lime.utils.AssetManifest","loadFromFile",0xc63f9e11,"lime.utils.AssetManifest.loadFromFile","lime/utils/AssetManifest.hx",73,0x0cdd5257)
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_71_loadFromFile,"lime.utils.AssetManifest","loadFromFile",0xc63f9e11,"lime.utils.AssetManifest.loadFromFile","lime/utils/AssetManifest.hx",71,0x0cdd5257)
HX_LOCAL_STACK_FRAME(_hx_pos_8a07fa6861abdf37_80_parse,"lime.utils.AssetManifest","parse",0x50ea14ce,"lime.utils.AssetManifest.parse","lime/utils/AssetManifest.hx",80,0x0cdd5257)
namespace lime{
namespace utils{
...
HXLINE( 109)		 ::Dynamic manifestData =  ::Dynamic(hx::Anon_obj::Create(0));
...
HXLINE(  86)		 ::Dynamic manifestData =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,data)->parseRec();
HXLINE(  87)		 ::lime::utils::AssetManifest manifest =  ::lime::utils::AssetManifest_obj::__alloc( HX_CTX );
