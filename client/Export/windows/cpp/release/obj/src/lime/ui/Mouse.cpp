...
HXLINE(  13)		::lime::_backend::native::NativeMouse_obj::hide();
            	}
...
HXLINE(  20)		::lime::_backend::native::NativeMouse_obj::show();
            	}
...
HXLINE(  27)		::lime::_backend::native::NativeMouse_obj::warp(x,y,window);
            	}
...
HXLINE(  41)		return ::lime::_backend::native::NativeMouse_obj::get_cursor();
            	}
...
HXLINE(  48)		return ::lime::_backend::native::NativeMouse_obj::set_cursor(value);
            	}
...
HXLINE(  55)		return ::lime::_backend::native::NativeMouse_obj::get_lock();
            	}
...
Bool Mouse_obj::set_lock(Bool value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(  62)		return ::lime::_backend::native::NativeMouse_obj::set_lock(value);
            	}
