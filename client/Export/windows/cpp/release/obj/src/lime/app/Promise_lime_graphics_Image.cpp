...
void Promise_lime_graphics_Image_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","new",0xe4010c79,"lime.app.Promise_lime_graphics_Image.new","lime/app/Promise.hx",18,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_lime_graphics_Image_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_lime_graphics_Image Promise_lime_graphics_Image_obj::complete( ::lime::graphics::Image data){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","complete",0x918d4a00,"lime.app.Promise_lime_graphics_Image.complete","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_graphics_Image_obj,complete,return )
 ...
 ::lime::app::Promise_lime_graphics_Image Promise_lime_graphics_Image_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","completeWith",0xbccbec26,"lime.app.Promise_lime_graphics_Image.completeWith","lime/app/Promise.hx",49,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_graphics_Image_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_graphics_Image Promise_lime_graphics_Image_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","error",0x89b10021,"lime.app.Promise_lime_graphics_Image.error","lime/app/Promise.hx",61,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_graphics_Image_obj,error,return )
 ...
 ::lime::app::Promise_lime_graphics_Image Promise_lime_graphics_Image_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","progress",0x97f040f4,"lime.app.Promise_lime_graphics_Image.progress","lime/app/Promise.hx",87,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_graphics_Image_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isComplete",0xcb429393,"lime.app.Promise_lime_graphics_Image.get_isComplete","lime/app/Promise.hx",117,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_graphics_Image_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isError",0x9c864cae,"lime.app.Promise_lime_graphics_Image.get_isError","lime/app/Promise.hx",124,0x10ba4f0b)
            	HX_STACK_THIS(this)
