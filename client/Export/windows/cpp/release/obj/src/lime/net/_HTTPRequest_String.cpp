...
void _HTTPRequest_String_obj::__construct(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest_String","new",0x883ccdf0,"lime.net._HTTPRequest_String.new","lime/net/HTTPRequest.hx",134,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE( 134)		super::__construct(uri);
            	}
...
Dynamic _HTTPRequest_String_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Future _HTTPRequest_String_obj::load(::String uri){
            		...
            		void _hx_run(::String text){
            			HX_STACK_FRAME("lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",153,0x339db723)
...
HXLINE( 156)			promise->complete(_gthis->responseData);
            	...
            	HX_STACK_FRAME("lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",139,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE( 139)		HX_VARI(  ::lime::net::_HTTPRequest_String,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 141)		Bool _hx_tmp = hx::IsNotNull( uri );
HXDLIN( 141)		if (_hx_tmp) {
HXLINE( 143)			this->uri = uri;
            		}
HXLINE( 147)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
HXLINE( 148)		HX_VARI(  ::lime::app::Future,future) = this->backend->loadText(this->uri);
HXLINE( 150)		future->onProgress(promise->progress_dyn());
HXLINE( 151)		future->onError(promise->error_dyn());
HXLINE( 153)		future->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
HXLINE( 160)		return promise->future;
            	}
