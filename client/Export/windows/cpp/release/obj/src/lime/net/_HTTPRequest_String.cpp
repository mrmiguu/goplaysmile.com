...
void _HTTPRequest_String_obj::__construct(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest_String","new",0x883ccdf0,"lime.net._HTTPRequest_String.new","lime/net/HTTPRequest.hx",141,0x339db723)
            	HX_STACK_THIS(this)
...
Dynamic _HTTPRequest_String_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Future _HTTPRequest_String_obj::load(::String uri){
            		...
            		void _hx_run(::String text){
            			HX_STACK_FRAME("lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",160,0x339db723)
...
HXLINE( 148)		Bool _hx_tmp = hx::IsNotNull( uri );
HXDLIN( 148)		if (_hx_tmp) {
HXLINE( 150)			this->uri = uri;
            		}
HXLINE( 154)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
