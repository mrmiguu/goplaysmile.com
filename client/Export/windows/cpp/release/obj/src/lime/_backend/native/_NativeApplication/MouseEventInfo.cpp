...
Float movementY = __o_movementY.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",865,0xb13849fd)
            	HX_STACK_THIS(this)
...
HXLINE( 867)		this->type = type;
HXLINE( 868)		this->windowID = (int)0;
HXLINE( 869)		this->x = x;
HXLINE( 870)		this->y = y;
HXLINE( 871)		this->button = button;
HXLINE( 872)		this->movementX = movementX;
HXLINE( 873)		this->movementY = movementY;
            	}
...
hx::ObjectPtr< MouseEventInfo_obj > MouseEventInfo_obj::__new( ::Dynamic type,hx::Null< Int >  __o_windowID,hx::Null< Float >  __o_x,hx::Null< Float >  __o_y,hx::Null< Int >  __o_button,hx::Null< Float >  __o_movementX,hx::Null< Float >  __o_movementY)
{
	...
	_hx_result->__construct(type,__o_windowID,__o_x,__o_y,__o_button,__o_movementX,__o_movementY);
	return _hx_result;
}
...
Dynamic MouseEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",880,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 880)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__new(this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
