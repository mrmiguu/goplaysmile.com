...
Float value = __o_value.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",759,0xb13849fd)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< GamepadEventInfo_obj > GamepadEventInfo_obj::__new( ::Dynamic type,hx::Null< Int >  __o_id,hx::Null< Int >  __o_button,hx::Null< Int >  __o_axis,hx::Null< Float >  __o_value)
{
	...
	_hx_result->__construct(type,__o_id,__o_button,__o_axis,__o_value);
	return _hx_result;
}
...
Dynamic GamepadEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",772,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 772)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__new(this->type,this->id,this->button,this->axis,this->value);
            	}
