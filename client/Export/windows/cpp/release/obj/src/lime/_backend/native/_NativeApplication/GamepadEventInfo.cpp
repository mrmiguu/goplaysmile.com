...
Float value = __o_value.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",737,0xb13849fd)
            	HX_STACK_THIS(this)
...
HXLINE( 739)		this->type = type;
HXLINE( 740)		this->id = id;
HXLINE( 741)		this->button = button;
HXLINE( 742)		this->axis = axis;
HXLINE( 743)		this->value = value;
            	}
...
Dynamic GamepadEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",750,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 750)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__new(this->type,this->id,this->button,this->axis,this->value);
            	}
