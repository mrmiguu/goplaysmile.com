...
Int CairoFTFontFace_Impl__obj::FT_LOAD_FORCE_AUTOHINT;
 ...
 ::Dynamic CairoFTFontFace_Impl__obj::_new(){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","_new",0x5b2d72e8,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_._new","lime/graphics/cairo/CairoFTFontFace.hx",17,0x9647c8cd)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CairoFTFontFace_Impl__obj,_new,return )
 ...
 ::Dynamic CairoFTFontFace_Impl__obj::create( ::lime::text::Font face,Int loadFlags){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","create",0x7e957443,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_.create","lime/graphics/cairo/CairoFTFontFace.hx",27,0x9647c8cd)
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(loadFlags,"loadFlags")
HXLINE(  27)		 ::Dynamic face1 = face->src;
HXDLIN(  27)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_ft_font_face_create(hx::DynamicPtr(face1),loadFlags)) );
HXDLIN(  27)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
{
{
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","boot",0x5d29e1b9,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_.boot","lime/graphics/cairo/CairoFTFontFace.hx",14,0x9647c8cd)
