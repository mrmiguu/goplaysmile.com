...
Int CairoFTFontFace_Impl__obj::FT_LOAD_FORCE_AUTOHINT;
 ...
 ::Dynamic CairoFTFontFace_Impl__obj::_new(){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","_new",0x5b2d72e8,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_._new","lime/graphics/cairo/CairoFTFontFace.hx",18,0x9647c8cd)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CairoFTFontFace_Impl__obj,_new,return )
 ...
 ::Dynamic CairoFTFontFace_Impl__obj::create( ::lime::text::Font face,Int loadFlags){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","create",0x7e957443,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_.create","lime/graphics/cairo/CairoFTFontFace.hx",28,0x9647c8cd)
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(loadFlags,"loadFlags")
HXLINE(  28)		 ::Dynamic face1 = face->src;
HXDLIN(  28)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::_CairoFTFontFace::CairoFTFontFace_Impl__obj::cffi_lime_cairo_ft_font_face_create(hx::DynamicPtr(face1),loadFlags)) );
...
HXLINE(  44)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::_CairoFTFontFace::CairoFTFontFace_Impl__obj::cffi_lime_cairo_ft_font_face_create(hx::DynamicPtr(face),flags)) );
HXDLIN(  44)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
static hx::StaticInfo CairoFTFontFace_Impl__obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(void *) &CairoFTFontFace_Impl__obj::cffi_lime_cairo_ft_font_face_create,HX_HCSTRING("cffi_lime_cairo_ft_font_face_create","\x97","\x02","\x73","\x99")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","boot",0x5d29e1b9,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_.boot","lime/graphics/cairo/CairoFTFontFace.hx",15,0x9647c8cd)
HXLINE(  15)		FT_LOAD_FORCE_AUTOHINT = (int)32;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_","boot",0x5d29e1b9,"lime.graphics.cairo._CairoFTFontFace.CairoFTFontFace_Impl_.boot","lime/graphics/cairo/CairoFTFontFace.hx",44,0x9647c8cd)
HXLINE(  44)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_ft_font_face_create",de,6b,31,70),HX_("oio",15,96,54,00),false);
HXDLIN(  44)		cffi_lime_cairo_ft_font_face_create = inValue;
            	}
}
