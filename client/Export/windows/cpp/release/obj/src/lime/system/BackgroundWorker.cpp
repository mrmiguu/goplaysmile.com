...
void BackgroundWorker_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  27)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  26)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  25)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  24)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__new();
            	}
...
void BackgroundWorker_obj::cancel(){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","cancel",0x890a1736,"lime.system.BackgroundWorker.cancel","lime/system/BackgroundWorker.hx",44,0x4a0958ac)
            	HX_STACK_THIS(this)
HXLINE(  46)		this->canceled = true;
HXLINE(  50)		this->_hx___workerThread = null();
            	}
...
void BackgroundWorker_obj::run( ::Dynamic message){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","run",0x36e7900f,"lime.system.BackgroundWorker.run","lime/system/BackgroundWorker.hx",57,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE(  59)		this->canceled = false;
HXLINE(  60)		this->completed = false;
HXLINE(  61)		this->_hx___runMessage = message;
HXLINE(  65)		this->_hx___messageQueue =  ::cpp::vm::Deque_obj::__new();
HXLINE(  66)		this->_hx___workerThread = ::cpp::vm::Thread_obj::create(this->_hx___doWork_dyn());
HXLINE(  68)		::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            	}
...
void BackgroundWorker_obj::sendComplete( ::Dynamic message){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","sendComplete",0x4fa2f0dd,"lime.system.BackgroundWorker.sendComplete","lime/system/BackgroundWorker.hx",79,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE(  81)		this->completed = true;
HXLINE(  85)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE);
HXLINE(  86)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendError( ::Dynamic message){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","sendError",0xa2871d24,"lime.system.BackgroundWorker.sendError","lime/system/BackgroundWorker.hx",102,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE( 106)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR);
HXLINE( 107)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendProgress( ::Dynamic message){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","sendProgress",0x5605e7d1,"lime.system.BackgroundWorker.sendProgress","lime/system/BackgroundWorker.hx",127,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE( 127)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::_hx___doWork(){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","__doWork",0x193122d8,"lime.system.BackgroundWorker.__doWork","lime/system/BackgroundWorker.hx",144,0x4a0958ac)
            	HX_STACK_THIS(this)
HXLINE( 144)		this->doWork->dispatch(this->_hx___runMessage);
            	}
...
void BackgroundWorker_obj::_hx___update(Int deltaTime){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","__update",0x813601e5,"lime.system.BackgroundWorker.__update","lime/system/BackgroundWorker.hx",164,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 168)		HX_VARI(  ::Dynamic,message) = this->_hx___messageQueue->pop(false);
HXLINE( 170)		Bool _hx_tmp = hx::IsNotNull( message );
HXDLIN( 170)		if (_hx_tmp) {
HXLINE( 172)			if (hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR )) {
HXLINE( 174)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 176)				Bool _hx_tmp1 = !(this->canceled);
HXDLIN( 176)				if (_hx_tmp1) {
HXLINE( 178)					this->canceled = true;
HXLINE( 179)					 ::Dynamic _hx_tmp2 = this->_hx___messageQueue->pop(false);
HXDLIN( 179)					this->onError->dispatch(_hx_tmp2);
            				}
            			}
            			else {
HXLINE( 183)				if (hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE )) {
HXLINE( 185)					::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 187)					Bool _hx_tmp3 = !(this->canceled);
HXDLIN( 187)					if (_hx_tmp3) {
HXLINE( 189)						this->canceled = true;
HXLINE( 190)						 ::Dynamic _hx_tmp4 = this->_hx___messageQueue->pop(false);
HXDLIN( 190)						this->onComplete->dispatch(_hx_tmp4);
            					}
            				}
            				else {
HXLINE( 196)					Bool _hx_tmp5 = !(this->canceled);
HXDLIN( 196)					if (_hx_tmp5) {
HXLINE( 198)						this->onProgress->dispatch(message);
            					}
            				}
            			}
            		}
...
{
{
            	HX_STACK_FRAME("lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",19,0x4a0958ac)
HXLINE(  19)		MESSAGE_COMPLETE = HX_("__COMPLETE__",39,bf,f1,2c);
            	}
{
            	HX_STACK_FRAME("lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",20,0x4a0958ac)
HXLINE(  20)		MESSAGE_ERROR = HX_("__ERROR__",a8,e1,2c,eb);
            	}
}
