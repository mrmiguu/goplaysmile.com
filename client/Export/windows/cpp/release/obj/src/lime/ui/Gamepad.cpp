...
void Gamepad_obj::__construct(Int id){
            	HX_STACK_FRAME("lime.ui.Gamepad","new",0xd780a212,"lime.ui.Gamepad.new","lime/ui/Gamepad.hx",16,0x36bc843e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  29)		this->onDisconnect =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  28)		this->onButtonUp =  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__new();
HXLINE(  27)		this->onButtonDown =  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__new();
HXLINE(  26)		this->onAxisMove =  ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void_obj::__new();
...
::String Gamepad_obj::get_guid(){
            	HX_STACK_FRAME("lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",82,0x36bc843e)
            	HX_STACK_THIS(this)
HXLINE(  82)		Int id = this->id;
HXDLIN(  82)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_guid(id)) );
...
::String Gamepad_obj::get_name(){
            	HX_STACK_FRAME("lime.ui.Gamepad","get_name",0x33fdf6e2,"lime.ui.Gamepad.get_name","lime/ui/Gamepad.hx",96,0x36bc843e)
            	HX_STACK_THIS(this)
HXLINE(  96)		Int id = this->id;
HXDLIN(  96)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_name(id)) );
HXDLIN(  96)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
void Gamepad_obj::addMappings(::Array< ::String > mappings){
            	HX_STACK_FRAME("lime.ui.Gamepad","addMappings",0x7dce3c98,"lime.ui.Gamepad.addMappings","lime/ui/Gamepad.hx",43,0x36bc843e)
...
void Gamepad_obj::_hx___connect(Int id){
            	HX_STACK_FRAME("lime.ui.Gamepad","__connect",0x06daaffc,"lime.ui.Gamepad.__connect","lime/ui/Gamepad.hx",51,0x36bc843e)
            	HX_STACK_ARG(id,"id")
HXLINE(  51)		Bool _hx_tmp = !(::lime::ui::Gamepad_obj::devices->exists(id));
HXDLIN(  51)		if (_hx_tmp) {
HXLINE(  53)			HX_VARI(  ::lime::ui::Gamepad,gamepad) =  ::lime::ui::Gamepad_obj::__new(id);
...
void Gamepad_obj::_hx___disconnect(Int id){
            	HX_STACK_FRAME("lime.ui.Gamepad","__disconnect",0x04d0478a,"lime.ui.Gamepad.__disconnect","lime/ui/Gamepad.hx",62,0x36bc843e)
            	HX_STACK_ARG(id,"id")
HXLINE(  64)		HX_VARI(  ::lime::ui::Gamepad,gamepad) = ::lime::ui::Gamepad_obj::devices->get(id).StaticCast<  ::lime::ui::Gamepad >();
HXLINE(  65)		Bool _hx_tmp = hx::IsNotNull( gamepad );
HXDLIN(  65)		if (_hx_tmp) {
HXLINE(  65)			gamepad->connected = false;
            		}
HXLINE(  66)		::lime::ui::Gamepad_obj::devices->remove(id);
HXLINE(  67)		Bool _hx_tmp1 = hx::IsNotNull( gamepad );
...
{
{
            	HX_STACK_FRAME("lime.ui.Gamepad","boot",0xb1262e40,"lime.ui.Gamepad.boot","lime/ui/Gamepad.hx",19,0x36bc843e)
HXLINE(  19)		devices =  ::haxe::ds::IntMap_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Gamepad","boot",0xb1262e40,"lime.ui.Gamepad.boot","lime/ui/Gamepad.hx",20,0x36bc843e)
HXLINE(  20)		onConnect =  ::lime::app::_Event_lime_ui_Gamepad_Void_obj::__new();
            	}
}
