...
Int device = __o_device.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1045,0xb13849fd)
            	HX_STACK_THIS(this)
...
Dynamic TouchEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1061,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1061)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__new(this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
