...
Int length = __o_length.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","new",0xb1ead390,"lime._backend.native._NativeApplication.TextEventInfo.new","lime/_backend/native/NativeApplication.hx",1003,0xb13849fd)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< TextEventInfo_obj > TextEventInfo_obj::__new( ::Dynamic type,hx::Null< Int >  __o_windowID,::String __o_text,hx::Null< Int >  __o_start,hx::Null< Int >  __o_length)
{
	...
	_hx_result->__construct(type,__o_windowID,__o_text,__o_start,__o_length);
	return _hx_result;
}
...
Dynamic TextEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",1016,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1016)		return  ::lime::_backend::native::_NativeApplication::TextEventInfo_obj::__new(this->type,this->windowID,this->text,this->start,this->length);
            	}
