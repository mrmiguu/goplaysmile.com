...
Int length = __o_length.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","new",0xb1ead390,"lime._backend.native._NativeApplication.TextEventInfo.new","lime/_backend/native/NativeApplication.hx",981,0xb13849fd)
            	HX_STACK_THIS(this)
...
HXLINE( 983)		this->type = type;
HXLINE( 984)		this->windowID = windowID;
HXLINE( 985)		this->text = text;
HXLINE( 986)		this->start = start;
HXLINE( 987)		this->length = length;
            	}
...
Dynamic TextEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",994,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 994)		return  ::lime::_backend::native::_NativeApplication::TextEventInfo_obj::__new(this->type,this->windowID,this->text,this->start,this->length);
            	}
