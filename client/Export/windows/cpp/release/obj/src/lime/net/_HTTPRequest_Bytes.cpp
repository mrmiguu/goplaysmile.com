...
void _HTTPRequest_Bytes_obj::__construct(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest_Bytes","new",0xc45547d0,"lime.net._HTTPRequest_Bytes.new","lime/net/HTTPRequest.hx",88,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE(  88)		super::__construct(uri);
            	}
...
Dynamic _HTTPRequest_Bytes_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic _HTTPRequest_Bytes_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.net._HTTPRequest_Bytes","fromBytes",0x58799e11,"lime.net._HTTPRequest_Bytes.fromBytes","lime/net/HTTPRequest.hx",95,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  95)		return bytes;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(_HTTPRequest_Bytes_obj,fromBytes,return )
 ...
 ::lime::app::Future _HTTPRequest_Bytes_obj::load(::String uri){
            		...
            		void _hx_run( ::haxe::io::Bytes bytes){
            			HX_STACK_FRAME("lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",114,0x339db723)
            			HX_STACK_ARG(bytes,"bytes")
HXLINE( 116)			_gthis->responseData = _gthis->fromBytes(bytes);
HXLINE( 117)			promise->complete(_gthis->responseData);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",100,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE( 100)		HX_VARI(  ::lime::net::_HTTPRequest_Bytes,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 102)		Bool _hx_tmp = hx::IsNotNull( uri );
HXDLIN( 102)		if (_hx_tmp) {
HXLINE( 104)			this->uri = uri;
            		}
HXLINE( 108)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
HXLINE( 109)		HX_VARI(  ::lime::app::Future,future) = this->backend->loadData(this->uri,null());
HXLINE( 111)		future->onProgress(promise->progress_dyn());
HXLINE( 112)		future->onError(promise->error_dyn());
HXLINE( 114)		future->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
