...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1308_new,"lime.graphics.utils._ImageDataUtil.ImageDataView","new",0xaa0478bd,"lime.graphics.utils._ImageDataUtil.ImageDataView.new","lime/graphics/utils/ImageDataUtil.hx",1308,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1339_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1339,0x494d921f)
HX_LOCAL_STACK_FRAME(_hx_pos_ca97c355311e00fd_1354_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1354,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1308_new)
HXLINE(1310)		this->image = image;
HXLINE(1312)		if (hx::IsNull( rect )) {
HXLINE(1314)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1318)			if ((rect->x < (int)0)) {
HXLINE(1318)				rect->x = (int)0;
            			}
HXLINE(1319)			if ((rect->y < (int)0)) {
HXLINE(1319)				rect->y = (int)0;
            			}
HXLINE(1320)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1320)				rect->width = (image->width - rect->x);
            			}
HXLINE(1321)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1321)				rect->height = (image->height - rect->y);
            			}
HXLINE(1322)			if ((rect->width < (int)0)) {
HXLINE(1322)				rect->width = (int)0;
            			}
HXLINE(1323)			if ((rect->height < (int)0)) {
...
HXLINE(1334)		int _hx_tmp = this->stride;
HXDLIN(1334)		int _hx_tmp1 = (_hx_tmp * (this->y + image->offsetY));
HXDLIN(1334)		this->offset = (_hx_tmp1 + ((this->x + image->offsetX) * (int)4));
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1339_clip)
...
HXLINE(1347)		int _hx_tmp = this->stride;
HXDLIN(1347)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1347)		this->offset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1354_row)
HXLINE(1354)		int _hx_tmp = this->offset;
HXDLIN(1354)		return (_hx_tmp + (this->stride * y));
            	}
