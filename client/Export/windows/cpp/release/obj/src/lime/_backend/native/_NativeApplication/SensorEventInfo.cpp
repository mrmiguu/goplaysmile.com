...
Float z = __o_z.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","new",0x51c6b8a3,"lime._backend.native._NativeApplication.SensorEventInfo.new","lime/_backend/native/NativeApplication.hx",964,0xb13849fd)
            	HX_STACK_THIS(this)
...
Dynamic SensorEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",977,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 977)		return  ::lime::_backend::native::_NativeApplication::SensorEventInfo_obj::__new(this->type,this->id,this->x,this->y,this->z);
            	}
