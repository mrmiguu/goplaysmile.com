...
Float z = __o_z.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","new",0x51c6b8a3,"lime._backend.native._NativeApplication.SensorEventInfo.new","lime/_backend/native/NativeApplication.hx",942,0xb13849fd)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE( 944)		this->type = type;
HXLINE( 945)		this->id = id;
HXLINE( 946)		this->x = x;
HXLINE( 947)		this->y = y;
HXLINE( 948)		this->z = z;
            	}
...
Dynamic SensorEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",955,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 955)		return  ::lime::_backend::native::_NativeApplication::SensorEventInfo_obj::__new(this->type,this->id,this->x,this->y,this->z);
            	}
