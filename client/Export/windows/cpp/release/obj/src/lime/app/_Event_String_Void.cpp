...
void _Event_String_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_String_Void","cancel",0xfe89ec44,"lime.app._Event_String_Void.cancel","lime/app/Event.hx",216,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_String_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_String_Void","has",0x6d2e7e50,"lime.app._Event_String_Void.has","lime/app/Event.hx",252,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 255)		{
...
void _Event_String_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_String_Void","remove",0x4ade9b0e,"lime.app._Event_String_Void.remove","lime/app/Event.hx",267,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_String_Void_obj::dispatch(::String a){
            	HX_STACK_FRAME("lime.app._Event_String_Void","dispatch",0x254e9404,"lime.app._Event_String_Void.dispatch","lime/app/Event.hx",140,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
