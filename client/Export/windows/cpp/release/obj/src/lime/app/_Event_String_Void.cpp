...
void _Event_String_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_String_Void","new",0x6d330f56,"lime.app._Event_String_Void.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_String_Void","add",0x6d293117,"lime.app._Event_String_Void.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_String_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_String_Void","cancel",0xfe89ec44,"lime.app._Event_String_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_String_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_String_Void","has",0x6d2e7e50,"lime.app._Event_String_Void.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void _Event_String_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_String_Void","remove",0x4ade9b0e,"lime.app._Event_String_Void.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_String_Void_obj::dispatch(::String a){
            	HX_STACK_FRAME("lime.app._Event_String_Void","dispatch",0x254e9404,"lime.app._Event_String_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
