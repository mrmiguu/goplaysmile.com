...
void Promise_openfl_media_Sound_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","new",0x5f28f541,"lime.app.Promise_openfl_media_Sound.new","lime/app/Promise.hx",18,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_openfl_media_Sound_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_openfl_media_Sound Promise_openfl_media_Sound_obj::complete( ::openfl::media::Sound data){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","complete",0x0c1c8c38,"lime.app.Promise_openfl_media_Sound.complete","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_media_Sound_obj,complete,return )
 ...
 ::lime::app::Promise_openfl_media_Sound Promise_openfl_media_Sound_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","completeWith",0xdb94aa5e,"lime.app.Promise_openfl_media_Sound.completeWith","lime/app/Promise.hx",49,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_media_Sound_obj,completeWith,return )
 ...
 ::lime::app::Promise_openfl_media_Sound Promise_openfl_media_Sound_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","error",0x0d3aaae9,"lime.app.Promise_openfl_media_Sound.error","lime/app/Promise.hx",61,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_media_Sound_obj,error,return )
 ...
 ::lime::app::Promise_openfl_media_Sound Promise_openfl_media_Sound_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","progress",0x127f832c,"lime.app.Promise_openfl_media_Sound.progress","lime/app/Promise.hx",87,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_media_Sound_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","get_isComplete",0xbc614fcb,"lime.app.Promise_openfl_media_Sound.get_isComplete","lime/app/Promise.hx",117,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_media_Sound_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_media_Sound","get_isError",0xaa703d76,"lime.app.Promise_openfl_media_Sound.get_isError","lime/app/Promise.hx",124,0x10ba4f0b)
            	HX_STACK_THIS(this)
