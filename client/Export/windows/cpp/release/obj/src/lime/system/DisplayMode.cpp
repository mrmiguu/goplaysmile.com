...
void DisplayMode_obj::__construct(Int width,Int height,Int refreshRate,Int pixelFormat){
            	HX_STACK_FRAME("lime.system.DisplayMode","new",0x2251a8d1,"lime.system.DisplayMode.new","lime/system/DisplayMode.hx",36,0xb4b505df)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< DisplayMode_obj > DisplayMode_obj::__new(Int width,Int height,Int refreshRate,Int pixelFormat)
{
	...
	_hx_result->__construct(width,height,refreshRate,pixelFormat);
	return _hx_result;
}
