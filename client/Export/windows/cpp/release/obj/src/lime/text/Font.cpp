...
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_74_decompose,"lime.text.Font","decompose",0x6e29ff3a,"lime.text.Font.decompose","lime/text/Font.hx",74,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_156_getGlyph,"lime.text.Font","getGlyph",0x5bf955cd,"lime.text.Font.getGlyph","lime/text/Font.hx",156,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_164_getGlyphs,"lime.text.Font","getGlyphs",0x1e31be06,"lime.text.Font.getGlyphs","lime/text/Font.hx",164,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_176_getGlyphMetrics,"lime.text.Font","getGlyphMetrics",0x8c9677f6,"lime.text.Font.getGlyphMetrics","lime/text/Font.hx",176,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_195_renderGlyph,"lime.text.Font","renderGlyph",0xe6e51a3f,"lime.text.Font.renderGlyph","lime/text/Font.hx",195,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_393_renderGlyphs,"lime.text.Font","renderGlyphs",0x2191dd54,"lime.text.Font.renderGlyphs","lime/text/Font.hx",393,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_397___fromBytes,"lime.text.Font","__fromBytes",0x257c2b4a,"lime.text.Font.__fromBytes","lime/text/Font.hx",397,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_418___fromFile,"lime.text.Font","__fromFile",0x6331ec7d,"lime.text.Font.__fromFile","lime/text/Font.hx",418,0x3be57807)
...
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_554___setSize,"lime.text.Font","__setSize",0x86a86dec,"lime.text.Font.__setSize","lime/text/Font.hx",554,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_570_get_ascender,"lime.text.Font","get_ascender",0x190d2c57,"lime.text.Font.get_ascender","lime/text/Font.hx",570,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_581_get_descender,"lime.text.Font","get_descender",0xcf2c6cf7,"lime.text.Font.get_descender","lime/text/Font.hx",581,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_592_get_height,"lime.text.Font","get_height",0x11455407,"lime.text.Font.get_height","lime/text/Font.hx",592,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_603_get_numGlyphs,"lime.text.Font","get_numGlyphs",0x835f4c0d,"lime.text.Font.get_numGlyphs","lime/text/Font.hx",603,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_614_get_underlinePosition,"lime.text.Font","get_underlinePosition",0xf48b45b5,"lime.text.Font.get_underlinePosition","lime/text/Font.hx",614,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_625_get_underlineThickness,"lime.text.Font","get_underlineThickness",0x8f66b6e8,"lime.text.Font.get_underlineThickness","lime/text/Font.hx",625,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_636_get_unitsPerEM,"lime.text.Font","get_unitsPerEM",0x81c292b6,"lime.text.Font.get_unitsPerEM","lime/text/Font.hx",636,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_91_fromBytes,"lime.text.Font","fromBytes",0x65a32e2a,"lime.text.Font.fromBytes","lime/text/Font.hx",91,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_107_fromFile,"lime.text.Font","fromFile",0x07a4e59d,"lime.text.Font.fromFile","lime/text/Font.hx",107,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_125_loadFromBytes,"lime.text.Font","loadFromBytes",0x5727f7a4,"lime.text.Font.loadFromBytes","lime/text/Font.hx",125,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_132_loadFromFile,"lime.text.Font","loadFromFile",0x5ed36963,"lime.text.Font.loadFromFile","lime/text/Font.hx",132,0x3be57807)
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_146_loadFromName,"lime.text.Font","loadFromName",0x64170d32,"lime.text.Font.loadFromName","lime/text/Font.hx",146,0x3be57807)
namespace lime{
namespace text{
...
HXLINE(  79)		 ::Dynamic data = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_outline_decompose(hx::DynamicPtr(this->src),(int)20480)) );
...
::String characters = __o_characters.Default(HX_HCSTRING("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^`'\"/\\&*()[]{}<>|:;_-+=?,. ","\xc1","\xf6","\x34","\x50"));
            	HX_STACKFRAME(&_hx_pos_51012fd6257f8a4a_164_getGlyphs)
HXLINE( 167)		 ::Dynamic glyphs = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_glyph_indices(hx::DynamicPtr(this->src),characters)) );
...
HXLINE( 179)		 ::Dynamic value = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_glyph_metrics(hx::DynamicPtr(this->src),glyph)) );
HXLINE( 180)		 ::lime::text::GlyphMetrics metrics =  ::lime::text::GlyphMetrics_obj::__alloc( HX_CTX );
...
HXLINE( 201)		 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc((int)0);
HXLINE( 204)		int dataPosition = (int)0;
...
HXLINE( 208)			int bytes1 = bytes->b->__get(dataPosition);
HXDLIN( 208)			::Array< unsigned char > bytes2 = bytes->b;
HXDLIN( 208)			int index = ((int)bytes1 | (int)((int)bytes2->__get((dataPosition + (int)1)) << (int)(int)8));
HXDLIN( 208)			::Array< unsigned char > bytes3 = bytes->b;
HXDLIN( 208)			int index1 = ((int)index | (int)((int)bytes3->__get((dataPosition + (int)2)) << (int)(int)16));
HXDLIN( 208)			::Array< unsigned char > bytes4 = bytes->b;
HXDLIN( 208)			int index2 = ((int)index1 | (int)((int)bytes4->__get((dataPosition + (int)3)) << (int)(int)24));
HXDLIN( 208)			dataPosition = (dataPosition + (int)4);
HXLINE( 209)			int bytes5 = bytes->b->__get(dataPosition);
HXDLIN( 209)			::Array< unsigned char > bytes6 = bytes->b;
HXDLIN( 209)			int width = ((int)bytes5 | (int)((int)bytes6->__get((dataPosition + (int)1)) << (int)(int)8));
HXDLIN( 209)			::Array< unsigned char > bytes7 = bytes->b;
HXDLIN( 209)			int width1 = ((int)width | (int)((int)bytes7->__get((dataPosition + (int)2)) << (int)(int)16));
HXDLIN( 209)			::Array< unsigned char > bytes8 = bytes->b;
HXDLIN( 209)			int width2 = ((int)width1 | (int)((int)bytes8->__get((dataPosition + (int)3)) << (int)(int)24));
HXDLIN( 209)			dataPosition = (dataPosition + (int)4);
HXLINE( 210)			int bytes9 = bytes->b->__get(dataPosition);
HXDLIN( 210)			::Array< unsigned char > bytes10 = bytes->b;
HXDLIN( 210)			int height = ((int)bytes9 | (int)((int)bytes10->__get((dataPosition + (int)1)) << (int)(int)8));
HXDLIN( 210)			::Array< unsigned char > bytes11 = bytes->b;
HXDLIN( 210)			int height1 = ((int)height | (int)((int)bytes11->__get((dataPosition + (int)2)) << (int)(int)16));
HXDLIN( 210)			::Array< unsigned char > bytes12 = bytes->b;
HXDLIN( 210)			int height2 = ((int)height1 | (int)((int)bytes12->__get((dataPosition + (int)3)) << (int)(int)24));
HXDLIN( 210)			dataPosition = (dataPosition + (int)4);
HXLINE( 211)			int bytes13 = bytes->b->__get(dataPosition);
HXDLIN( 211)			::Array< unsigned char > bytes14 = bytes->b;
HXDLIN( 211)			int x = ((int)bytes13 | (int)((int)bytes14->__get((dataPosition + (int)1)) << (int)(int)8));
HXDLIN( 211)			::Array< unsigned char > bytes15 = bytes->b;
HXDLIN( 211)			int x1 = ((int)x | (int)((int)bytes15->__get((dataPosition + (int)2)) << (int)(int)16));
HXDLIN( 211)			::Array< unsigned char > bytes16 = bytes->b;
HXDLIN( 211)			int x2 = ((int)x1 | (int)((int)bytes16->__get((dataPosition + (int)3)) << (int)(int)24));
HXDLIN( 211)			dataPosition = (dataPosition + (int)4);
HXLINE( 212)			int bytes17 = bytes->b->__get(dataPosition);
HXDLIN( 212)			::Array< unsigned char > bytes18 = bytes->b;
HXDLIN( 212)			int y = ((int)bytes17 | (int)((int)bytes18->__get((dataPosition + (int)1)) << (int)(int)8));
HXDLIN( 212)			::Array< unsigned char > bytes19 = bytes->b;
HXDLIN( 212)			int y1 = ((int)y | (int)((int)bytes19->__get((dataPosition + (int)2)) << (int)(int)16));
HXDLIN( 212)			::Array< unsigned char > bytes20 = bytes->b;
HXDLIN( 212)			int y2 = ((int)y1 | (int)((int)bytes20->__get((dataPosition + (int)3)) << (int)(int)24));
HXDLIN( 212)			dataPosition = (dataPosition + (int)4);
HXLINE( 214)			 ::haxe::io::Bytes data = bytes->sub(dataPosition,(width2 * height2));
HXLINE( 215)			dataPosition = (dataPosition + (width2 * height2));
HXLINE( 217)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 217)			if (hx::IsNotNull( data )) {
HXLINE( 217)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 217)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 217)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 217)				int bufferByteLength = data->length;
HXDLIN( 217)				int elementSize = _this->bytesPerElement;
HXDLIN( 217)				int newByteLength = bufferByteLength;
HXDLIN( 217)				{
HXLINE( 217)					newByteLength = bufferByteLength;
...
HXDLIN( 217)			 ::lime::graphics::ImageBuffer buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width2,height2,(int)1,null());
HXLINE( 218)			 ::lime::graphics::Image image =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,buffer,(int)0,(int)0,width2,height2,null(),null());
HXLINE( 219)			image->x = x2;
HXLINE( 220)			image->y = y2;
...
HXLINE(  95)		 ::lime::text::Font font =  ::lime::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 111)		 ::lime::text::Font font =  ::lime::text::Font_obj::__alloc( HX_CTX ,null());
