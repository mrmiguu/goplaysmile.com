...
void Font_obj::__construct(::String name){
            	HX_STACK_FRAME("lime.text.Font","new",0x97494f29,"lime.text.Font.new","lime/text/Font.hx",57,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  59)		Bool _hx_tmp = hx::IsNotNull( name );
HXDLIN(  59)		if (_hx_tmp) {
HXLINE(  61)			this->name = name;
            		}
HXLINE(  65)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___fontPath );
...
Dynamic Font_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Font_obj::decompose(){
            	HX_STACK_FRAME("lime.text.Font","decompose",0x6e29ff3a,"lime.text.Font.decompose","lime/text/Font.hx",74,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE(  78)		Bool _hx_tmp = hx::IsNull( this->src );
HXDLIN(  78)		if (_hx_tmp) {
HXLINE(  78)			HX_STACK_DO_THROW(HX_("Uninitialized font handle.",3a,84,ab,29));
            		}
HXLINE(  79)		 ::Dynamic handle = this->src;
HXDLIN(  79)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_outline_decompose(hx::DynamicPtr(handle),(int)20480)) );
HXDLIN(  79)		HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  80)		return data;
            	}
...
Int Font_obj::getGlyph(::String character){
            	HX_STACK_FRAME("lime.text.Font","getGlyph",0x5bf955cd,"lime.text.Font.getGlyph","lime/text/Font.hx",156,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(character,"character")
HXLINE( 156)		 ::Dynamic handle = this->src;
HXDLIN( 156)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_glyph_index(hx::DynamicPtr(handle),character)) );
            	}
...
::String characters = __o_characters.Default(HX_HCSTRING("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^`'\"/\\&*()[]{}<>|:;_-+=?,. ","\xc1","\xf6","\x34","\x50"));
            	HX_STACK_FRAME("lime.text.Font","getGlyphs",0x1e31be06,"lime.text.Font.getGlyphs","lime/text/Font.hx",164,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(characters,"characters")
HXLINE( 167)		 ::Dynamic handle = this->src;
HXDLIN( 167)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_glyph_indices(hx::DynamicPtr(handle),characters)) );
HXDLIN( 167)		HX_VARI(  ::Dynamic,glyphs) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 168)		return glyphs;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Font_obj,getGlyphs,return )
 ...
 ::lime::text::GlyphMetrics Font_obj::getGlyphMetrics(Int glyph){
            	HX_STACK_FRAME("lime.text.Font","getGlyphMetrics",0x8c9677f6,"lime.text.Font.getGlyphMetrics","lime/text/Font.hx",176,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(glyph,"glyph")
HXLINE( 179)		 ::Dynamic handle = this->src;
HXDLIN( 179)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_glyph_metrics(hx::DynamicPtr(handle),glyph)) );
HXDLIN( 179)		HX_VARI(  ::Dynamic,value) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 180)		HX_VARI(  ::lime::text::GlyphMetrics,metrics) =  ::lime::text::GlyphMetrics_obj::__new();
HXLINE( 182)		metrics->advance =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("horizontalAdvance",fe,57,3e,ce),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("verticalAdvance",ac,8e,f7,57),hx::paccDynamic)));
HXLINE( 183)		metrics->height =  ::Dynamic(value->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic));
HXLINE( 184)		metrics->horizontalBearing =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("horizontalBearingX",ae,21,22,6c),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("horizontalBearingY",af,21,22,6c),hx::paccDynamic)));
HXLINE( 185)		metrics->verticalBearing =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("verticalBearingX",40,c3,78,64),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("verticalBearingY",41,c3,78,64),hx::paccDynamic)));
...
HX_DEFINE_DYNAMIC_FUNC1(Font_obj,getGlyphMetrics,return )
 ...
 ::lime::graphics::Image Font_obj::renderGlyph(Int glyph,Int fontSize){
            	HX_STACK_FRAME("lime.text.Font","renderGlyph",0xe6e51a3f,"lime.text.Font.renderGlyph","lime/text/Font.hx",195,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(glyph,"glyph")
...
HXLINE( 206)		 ::Dynamic handle = this->src;
HXDLIN( 206)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 206)		Bool _hx_tmp1 = ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_render_glyph(_hx_tmp,glyph,hx::DynamicPtr(bytes))) );
...
HXDLIN( 217)			Bool _hx_tmp2 = hx::IsNotNull( data );
HXDLIN( 217)			if (_hx_tmp2) {
HXLINE( 217)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
...
HXDLIN( 217)				Float _hx_tmp3 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 217)				_this->length = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 217)				this1 = _this;
            			}
            			else {
HXLINE( 217)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            			}
HXDLIN( 217)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new(this1,width,height,(int)1,null());
HXLINE( 218)			HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__new(buffer,(int)0,(int)0,width,height,null(),null());
...
HX_DEFINE_DYNAMIC_FUNC2(Font_obj,renderGlyph,return )
 ...
 ::haxe::ds::IntMap Font_obj::renderGlyphs(::Array< Int > glyphs,Int fontSize){
            	HX_STACK_FRAME("lime.text.Font","renderGlyphs",0x2191dd54,"lime.text.Font.renderGlyphs","lime/text/Font.hx",393,0x3be57807)
            	HX_STACK_THIS(this)
...
void Font_obj::_hx___fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.text.Font","__fromBytes",0x257c2b4a,"lime.text.Font.__fromBytes","lime/text/Font.hx",397,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 399)		this->_hx___fontPath = null();
HXLINE( 403)		this->_hx___fontPathWithoutDirectory = null();
HXLINE( 405)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_load(hx::DynamicPtr(bytes))) );
HXDLIN( 405)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 405)		this->src = _hx_tmp;
HXLINE( 407)		Bool _hx_tmp1;
HXDLIN( 407)		Bool _hx_tmp2 = hx::IsNotNull( this->src );
HXDLIN( 407)		if (_hx_tmp2) {
HXLINE( 407)			_hx_tmp1 = hx::IsNull( this->name );
            		}
            		else {
HXLINE( 407)			_hx_tmp1 = false;
            		}
HXDLIN( 407)		if (_hx_tmp1) {
HXLINE( 409)			 ::Dynamic handle = this->src;
HXDLIN( 409)			 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_family_name(hx::DynamicPtr(handle))) );
HXDLIN( 409)			 ::Dynamic _hx_tmp3 = Dynamic(hx::DynamicPtr(inVal1));
HXDLIN( 409)			this->name = ( (::String)(_hx_tmp3) );
            		}
            	}
...
void Font_obj::_hx___fromFile(::String path){
            	HX_STACK_FRAME("lime.text.Font","__fromFile",0x6331ec7d,"lime.text.Font.__fromFile","lime/text/Font.hx",418,0x3be57807)
            	HX_STACK_THIS(this)
...
HXLINE( 426)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_load(hx::DynamicPtr(this->_hx___fontPath))) );
HXDLIN( 426)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 426)		this->src = _hx_tmp;
HXLINE( 428)		Bool _hx_tmp1;
HXDLIN( 428)		Bool _hx_tmp2 = hx::IsNotNull( this->src );
HXDLIN( 428)		if (_hx_tmp2) {
HXLINE( 428)			_hx_tmp1 = hx::IsNull( this->name );
            		}
            		else {
HXLINE( 428)			_hx_tmp1 = false;
            		}
HXDLIN( 428)		if (_hx_tmp1) {
HXLINE( 430)			 ::Dynamic handle = this->src;
HXDLIN( 430)			 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_family_name(hx::DynamicPtr(handle))) );
HXDLIN( 430)			 ::Dynamic _hx_tmp3 = Dynamic(hx::DynamicPtr(inVal1));
HXDLIN( 430)			this->name = ( (::String)(_hx_tmp3) );
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Font_obj,_hx___fromFile,(void))
 ...
 ::lime::app::Future Font_obj::_hx___loadFromName(::String name){
            	HX_STACK_FRAME("lime.text.Font","__loadFromName",0x6b610412,"lime.text.Font.__loadFromName","lime/text/Font.hx",463,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 465)		HX_VARI(  ::lime::app::Promise_lime_text_Font,promise) =  ::lime::app::Promise_lime_text_Font_obj::__new();
...
void Font_obj::_hx___setSize(Int size){
            	HX_STACK_FRAME("lime.text.Font","__setSize",0x86a86dec,"lime.text.Font.__setSize","lime/text/Font.hx",554,0x3be57807)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE( 554)		 ::Dynamic handle = this->src;
HXDLIN( 554)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_set_size(hx::DynamicPtr(handle),size);
            	}
...
Int Font_obj::get_ascender(){
            	HX_STACK_FRAME("lime.text.Font","get_ascender",0x190d2c57,"lime.text.Font.get_ascender","lime/text/Font.hx",570,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 570)		 ::Dynamic handle = this->src;
HXDLIN( 570)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_ascender(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_descender(){
            	HX_STACK_FRAME("lime.text.Font","get_descender",0xcf2c6cf7,"lime.text.Font.get_descender","lime/text/Font.hx",581,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 581)		 ::Dynamic handle = this->src;
HXDLIN( 581)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_descender(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_height(){
            	HX_STACK_FRAME("lime.text.Font","get_height",0x11455407,"lime.text.Font.get_height","lime/text/Font.hx",592,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 592)		 ::Dynamic handle = this->src;
HXDLIN( 592)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_height(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_numGlyphs(){
            	HX_STACK_FRAME("lime.text.Font","get_numGlyphs",0x835f4c0d,"lime.text.Font.get_numGlyphs","lime/text/Font.hx",603,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 603)		 ::Dynamic handle = this->src;
HXDLIN( 603)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_num_glyphs(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_underlinePosition(){
            	HX_STACK_FRAME("lime.text.Font","get_underlinePosition",0xf48b45b5,"lime.text.Font.get_underlinePosition","lime/text/Font.hx",614,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 614)		 ::Dynamic handle = this->src;
HXDLIN( 614)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_underline_position(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_underlineThickness(){
            	HX_STACK_FRAME("lime.text.Font","get_underlineThickness",0x8f66b6e8,"lime.text.Font.get_underlineThickness","lime/text/Font.hx",625,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 625)		 ::Dynamic handle = this->src;
HXDLIN( 625)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_underline_thickness(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_unitsPerEM(){
            	HX_STACK_FRAME("lime.text.Font","get_unitsPerEM",0x81c292b6,"lime.text.Font.get_unitsPerEM","lime/text/Font.hx",636,0x3be57807)
            	HX_STACK_THIS(this)
HXLINE( 636)		 ::Dynamic handle = this->src;
HXDLIN( 636)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_font_get_units_per_em(hx::DynamicPtr(handle))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Font_obj,get_unitsPerEM,return )
 ...
 ::lime::text::Font Font_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.text.Font","fromBytes",0x65a32e2a,"lime.text.Font.fromBytes","lime/text/Font.hx",91,0x3be57807)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  93)		Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN(  93)		if (_hx_tmp) {
HXLINE(  93)			return null();
            		}
HXLINE(  95)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__new(null());
HXLINE(  96)		font->_hx___fromBytes(bytes);
HXLINE(  99)		Bool _hx_tmp1 = hx::IsNotNull( font->src );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::lime::text::Font Font_obj::fromFile(::String path){
            	HX_STACK_FRAME("lime.text.Font","fromFile",0x07a4e59d,"lime.text.Font.fromFile","lime/text/Font.hx",107,0x3be57807)
            	HX_STACK_ARG(path,"path")
HXLINE( 109)		Bool _hx_tmp = hx::IsNull( path );
HXDLIN( 109)		if (_hx_tmp) {
HXLINE( 109)			return null();
            		}
HXLINE( 111)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__new(null());
HXLINE( 112)		font->_hx___fromFile(path);
HXLINE( 115)		Bool _hx_tmp1 = hx::IsNotNull( font->src );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromFile,return )
 ...
 ::lime::app::Future Font_obj::loadFromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.text.Font","loadFromBytes",0x5727f7a4,"lime.text.Font.loadFromBytes","lime/text/Font.hx",125,0x3be57807)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 125)		 ::lime::text::Font _hx_tmp = ::lime::text::Font_obj::fromBytes(bytes);
HXDLIN( 125)		return ::lime::app::Future_obj::withValue(_hx_tmp);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromBytes,return )
 ...
 ::lime::app::Future Font_obj::loadFromFile(::String path){
            	HX_STACK_FRAME("lime.text.Font","loadFromFile",0x5ed36963,"lime.text.Font.loadFromFile","lime/text/Font.hx",132,0x3be57807)
            	HX_STACK_ARG(path,"path")
HXLINE( 132)		 ::lime::text::Font _hx_tmp = ::lime::text::Font_obj::fromFile(path);
HXDLIN( 132)		return ::lime::app::Future_obj::withValue(_hx_tmp);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromFile,return )
 ...
 ::lime::app::Future Font_obj::loadFromName(::String path){
            	HX_STACK_FRAME("lime.text.Font","loadFromName",0x64170d32,"lime.text.Font.loadFromName","lime/text/Font.hx",146,0x3be57807)
            	HX_STACK_ARG(path,"path")
