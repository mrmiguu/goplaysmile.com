...
{
{
            	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",137,0x300eb2b2)
HXLINE( 137)		NONE = (int)0;
            	}
{
            	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",138,0x300eb2b2)
HXLINE( 138)		ERROR = (int)1;
            	}
{
            	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",139,0x300eb2b2)
HXLINE( 139)		WARN = (int)2;
            	}
{
            	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",140,0x300eb2b2)
HXLINE( 140)		INFO = (int)3;
            	}
{
            	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",141,0x300eb2b2)
HXLINE( 141)		DEBUG = (int)4;
            	}
{
