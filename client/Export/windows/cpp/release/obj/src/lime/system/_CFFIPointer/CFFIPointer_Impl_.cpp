...
Dynamic CFFIPointer_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic CFFIPointer_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.system._CFFIPointer.CFFIPointer_Impl_","_new",0xca839748,"lime.system._CFFIPointer.CFFIPointer_Impl_._new","lime/system/CFFIPointer.hx",11,0x1e20e50d)
...
HXLINE(  20)		Bool _hx_tmp = hx::IsNotNull( this1 );
HXDLIN(  20)		if (_hx_tmp) {
HXLINE(  23)			return ( (Float)(::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::cffi_lime_cffi_get_native_pointer(hx::DynamicPtr(this1))) );
            		}
...
Bool CFFIPointer_Impl__obj::equals( ::Dynamic a,Int b){
            	...
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE(  33)		Float _hx_tmp = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(  33)		return (_hx_tmp == b);
            	}
...
HXDLIN(  34)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
...
HXDLIN(  36)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
...
HXDLIN(  38)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
HXDLIN(  38)		return (_hx_tmp >= _hx_tmp1);
            	}
...
HXDLIN(  40)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
HXDLIN(  40)		return (_hx_tmp < _hx_tmp1);
            	}
...
HXDLIN(  42)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
HXDLIN(  42)		return (_hx_tmp <= _hx_tmp1);
            	}
...
HXDLIN(  44)		Float _hx_tmp1 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(b);
HXDLIN(  44)		return (_hx_tmp != _hx_tmp1);
            	}
...
HXLINE(  55)		return ( (Float)(::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::cffi_lime_cffi_get_native_pointer(hx::DynamicPtr(ptr))) );
            	}
...
static hx::StaticInfo CFFIPointer_Impl__obj_sStaticStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(void *) &CFFIPointer_Impl__obj::cffi_lime_cffi_get_native_pointer,HX_HCSTRING("cffi_lime_cffi_get_native_pointer","\xe6","\x38","\xa0","\xf9")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACK_FRAME("lime.system._CFFIPointer.CFFIPointer_Impl_","boot",0xcc800619,"lime.system._CFFIPointer.CFFIPointer_Impl_.boot","lime/system/CFFIPointer.hx",55,0x1e20e50d)
HXLINE(  55)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cffi_get_native_pointer",6d,f2,d7,07),HX_("od",15,61,00,00),false);
HXDLIN(  55)		cffi_lime_cffi_get_native_pointer = inValue;
            	}
}
