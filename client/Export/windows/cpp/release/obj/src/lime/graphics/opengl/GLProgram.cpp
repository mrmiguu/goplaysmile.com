...
void GLProgram_obj::__construct(Int version, ::Dynamic id){
            	HX_STACK_FRAME("lime.graphics.opengl.GLProgram","new",0x2d826a7c,"lime.graphics.opengl.GLProgram.new","lime/graphics/opengl/GLProgram.hx",16,0x48d7ea15)
            	HX_STACK_THIS(this)
...
void GLProgram_obj::attach( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.opengl.GLProgram","attach",0x80ff9b29,"lime.graphics.opengl.GLProgram.attach","lime/graphics/opengl/GLProgram.hx",26,0x48d7ea15)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> GLProgram_obj::getShaders(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLProgram","getShaders",0x3da5291c,"lime.graphics.opengl.GLProgram.getShaders","lime/graphics/opengl/GLProgram.hx",33,0x48d7ea15)
            	HX_STACK_THIS(this)
...
::String GLProgram_obj::getType(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLProgram","getType",0x50477a8c,"lime.graphics.opengl.GLProgram.getType","lime/graphics/opengl/GLProgram.hx",40,0x48d7ea15)
            	HX_STACK_THIS(this)
