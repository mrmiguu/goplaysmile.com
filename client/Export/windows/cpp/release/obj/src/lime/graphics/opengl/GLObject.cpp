...
void GLObject_obj::__construct(Int version, ::Dynamic id){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GLObject.hx",23,0x63842264)
            	HX_STACK_THIS(this)
...
::String GLObject_obj::getType(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","getType",0x2e94747b,"lime.graphics.opengl.GLObject.getType","lime/graphics/opengl/GLObject.hx",31,0x63842264)
            	HX_STACK_THIS(this)
...
void GLObject_obj::invalidate(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","invalidate",0x6335e050,"lime.graphics.opengl.GLObject.invalidate","lime/graphics/opengl/GLObject.hx",35,0x63842264)
            	HX_STACK_THIS(this)
...
Bool GLObject_obj::isValid(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","isValid",0xdd46eabd,"lime.graphics.opengl.GLObject.isValid","lime/graphics/opengl/GLObject.hx",39,0x63842264)
            	HX_STACK_THIS(this)
HXLINE(  39)		Bool _hx_tmp = hx::IsNotNull( this->id );
...
Bool GLObject_obj::isInvalid(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","isInvalid",0xbfb002f8,"lime.graphics.opengl.GLObject.isInvalid","lime/graphics/opengl/GLObject.hx",43,0x63842264)
            	HX_STACK_THIS(this)
...
::String GLObject_obj::toString(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","toString",0x511dc841,"lime.graphics.opengl.GLObject.toString","lime/graphics/opengl/GLObject.hx",47,0x63842264)
            	HX_STACK_THIS(this)
HXLINE(  47)		::String _hx_tmp = this->getType();
HXDLIN(  47)		return (((_hx_tmp + HX_("(",28,00,00,00)) + this->id) + HX_(")",29,00,00,00));
            	}
...
Bool GLObject_obj::get_invalidated(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","get_invalidated",0xee183f2b,"lime.graphics.opengl.GLObject.get_invalidated","lime/graphics/opengl/GLObject.hx",53,0x63842264)
            	HX_STACK_THIS(this)
...
Bool GLObject_obj::get_valid(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","get_valid",0xf5cb7c1e,"lime.graphics.opengl.GLObject.get_valid","lime/graphics/opengl/GLObject.hx",57,0x63842264)
            	HX_STACK_THIS(this)
