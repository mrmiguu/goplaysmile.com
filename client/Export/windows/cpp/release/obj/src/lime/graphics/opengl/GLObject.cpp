...
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_23_new,"lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GLObject.hx",23,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_31_getType,"lime.graphics.opengl.GLObject","getType",0x2e94747b,"lime.graphics.opengl.GLObject.getType","lime/graphics/opengl/GLObject.hx",31,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_35_invalidate,"lime.graphics.opengl.GLObject","invalidate",0x6335e050,"lime.graphics.opengl.GLObject.invalidate","lime/graphics/opengl/GLObject.hx",35,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_39_isValid,"lime.graphics.opengl.GLObject","isValid",0xdd46eabd,"lime.graphics.opengl.GLObject.isValid","lime/graphics/opengl/GLObject.hx",39,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_43_isInvalid,"lime.graphics.opengl.GLObject","isInvalid",0xbfb002f8,"lime.graphics.opengl.GLObject.isInvalid","lime/graphics/opengl/GLObject.hx",43,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_47_toString,"lime.graphics.opengl.GLObject","toString",0x511dc841,"lime.graphics.opengl.GLObject.toString","lime/graphics/opengl/GLObject.hx",47,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_53_get_invalidated,"lime.graphics.opengl.GLObject","get_invalidated",0xee183f2b,"lime.graphics.opengl.GLObject.get_invalidated","lime/graphics/opengl/GLObject.hx",53,0x63842264)
HX_LOCAL_STACK_FRAME(_hx_pos_c90540f6711aaf63_57_get_valid,"lime.graphics.opengl.GLObject","get_valid",0xf5cb7c1e,"lime.graphics.opengl.GLObject.get_valid","lime/graphics/opengl/GLObject.hx",57,0x63842264)
namespace lime{
namespace graphics{
namespace opengl{

void GLObject_obj::__construct(int version, ::Dynamic id){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_23_new)
HXLINE(  25)		this->version = version;
...
::String GLObject_obj::getType(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_31_getType)
HXLINE(  31)		return HX_("GLObject",c4,da,30,7f);
            	}
...
void GLObject_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_35_invalidate)
HXLINE(  35)		this->id = null();
            	}
...
bool GLObject_obj::isValid(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_39_isValid)
HXLINE(  39)		if (hx::IsNotNull( this->id )) {
HXLINE(  39)			int _hx_tmp = this->version;
HXDLIN(  39)			return (_hx_tmp == ::lime::graphics::opengl::GL_obj::get_version());
            		}
            		else {
...
bool GLObject_obj::isInvalid(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_43_isInvalid)
HXLINE(  43)		return !(this->isValid());
            	}
...
::String GLObject_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_47_toString)
HXLINE(  47)		::String _hx_tmp = (this->getType() + HX_("(",28,00,00,00));
HXDLIN(  47)		return ((_hx_tmp + this->id) + HX_(")",29,00,00,00));
            	}
...
bool GLObject_obj::get_invalidated(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_53_get_invalidated)
HXLINE(  53)		return this->isInvalid();
            	}
...
bool GLObject_obj::get_valid(){
            	HX_STACKFRAME(&_hx_pos_c90540f6711aaf63_57_get_valid)
HXLINE(  57)		return this->isValid();
            	}
