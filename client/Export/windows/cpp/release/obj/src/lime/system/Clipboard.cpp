...
::String Clipboard_obj::get_text(){
            	HX_STACK_FRAME("lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",37,0x9490b5ee)
HXLINE(  40)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_clipboard_get_text()) );
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACK_FRAME("lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",56,0x9490b5ee)
