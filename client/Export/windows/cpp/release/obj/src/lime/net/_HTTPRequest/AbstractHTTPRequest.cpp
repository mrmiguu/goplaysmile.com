...
void AbstractHTTPRequest_obj::__construct(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest.AbstractHTTPRequest","new",0x2f7ffcbb,"lime.net._HTTPRequest.AbstractHTTPRequest.new","lime/net/HTTPRequest.hx",42,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE(  44)		this->uri = uri;
HXLINE(  46)		this->contentType = HX_("application/x-www-form-urlencoded",9e,61,91,fa);
HXLINE(  47)		this->followRedirects = true;
HXLINE(  48)		this->formData =  ::haxe::ds::StringMap_obj::__new();
HXLINE(  49)		this->headers = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  50)		this->method = HX_("GET",76,1c,36,00);
HXLINE(  51)		this->timeout = (int)30000;
HXLINE(  54)		this->backend =  ::lime::_backend::native::NativeHTTPRequest_obj::__new();
HXLINE(  55)		this->backend->init(hx::ObjectPtr<OBJ_>(this));
            	}
...
void AbstractHTTPRequest_obj::cancel(){
            	HX_STACK_FRAME("lime.net._HTTPRequest.AbstractHTTPRequest","cancel",0x9e11abff,"lime.net._HTTPRequest.AbstractHTTPRequest.cancel","lime/net/HTTPRequest.hx",64,0x339db723)
            	HX_STACK_THIS(this)
HXLINE(  64)		this->backend->cancel();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AbstractHTTPRequest_obj,cancel,(void))
 ...
 ::lime::app::Future AbstractHTTPRequest_obj::load(::String uri){
            	HX_STACK_FRAME("lime.net._HTTPRequest.AbstractHTTPRequest","load",0x5f323d6b,"lime.net._HTTPRequest.AbstractHTTPRequest.load","lime/net/HTTPRequest.hx",72,0x339db723)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
