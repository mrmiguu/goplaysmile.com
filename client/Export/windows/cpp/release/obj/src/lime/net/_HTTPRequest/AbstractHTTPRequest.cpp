...
HXLINE(  55)		this->formData =  ::haxe::ds::StringMap_obj::__new();
...
HXLINE(  61)		this->backend =  ::lime::_backend::native::NativeHTTPRequest_obj::__new();
...
void AbstractHTTPRequest_obj::cancel(){
            	HX_STACK_FRAME("lime.net._HTTPRequest.AbstractHTTPRequest","cancel",0x9e11abff,"lime.net._HTTPRequest.AbstractHTTPRequest.cancel","lime/net/HTTPRequest.hx",71,0x339db723)
            	HX_STACK_THIS(this)
