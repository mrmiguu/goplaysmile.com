...
void GLTexture_obj::__construct(Int version, ::Dynamic id){
            	HX_STACK_FRAME("lime.graphics.opengl.GLTexture","new",0x6cdd6053,"lime.graphics.opengl.GLTexture.new","lime/graphics/opengl/GLTexture.hx",10,0xaab4bc1e)
            	HX_STACK_THIS(this)
...
::String GLTexture_obj::getType(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLTexture","getType",0x3be7a7e3,"lime.graphics.opengl.GLTexture.getType","lime/graphics/opengl/GLTexture.hx",15,0xaab4bc1e)
            	HX_STACK_THIS(this)
