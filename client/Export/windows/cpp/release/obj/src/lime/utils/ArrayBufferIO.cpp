...
Int ArrayBufferIO_obj::getInt16( ::haxe::io::Bytes buffer,Int byteOffset){
            	HX_STACK_FRAME("lime.utils.ArrayBufferIO","getInt16",0x764c5d83,"lime.utils.ArrayBufferIO.getInt16","lime/utils/ArrayBufferView.hx",486,0xb543acf8)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE( 486)		return ::__hxcpp_memory_get_i16(buffer->b,byteOffset);
            	}
...
Int ArrayBufferIO_obj::getInt16_BE( ::haxe::io::Bytes buffer,Int byteOffset){
            	HX_STACK_FRAME("lime.utils.ArrayBufferIO","getInt16_BE",0x50eb063f,"lime.utils.ArrayBufferIO.getInt16_BE","lime/utils/ArrayBufferView.hx",503,0xb543acf8)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE( 503)		return ::__hxcpp_memory_get_i16(buffer->b,byteOffset);
            	}
...
HXLINE( 521)		::__hxcpp_memory_set_i16(buffer->b,byteOffset,value);
            	}
...
void ArrayBufferIO_obj::setInt16_BE( ::haxe::io::Bytes buffer,Int byteOffset,Int value){
            	...
            	HX_STACK_ARG(byteOffset,"byteOffset")
            	HX_STACK_ARG(value,"value")
HXLINE( 537)		::__hxcpp_memory_set_i16(buffer->b,byteOffset,value);
            	}
