...
HXLINE(  23)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_options_create()) );
...
Int CairoFontOptions_Impl__obj::get_antialias( ::Dynamic this1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_","get_antialias",0xacf70356,"lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_.get_antialias","lime/graphics/cairo/CairoFontOptions.hx",41,0x355ba586)
            	HX_STACK_ARG(this1,"this1")
HXLINE(  41)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_options_get_antialias(hx::DynamicPtr(this1))) );
            	}
...
Int CairoFontOptions_Impl__obj::get_hintMetrics( ::Dynamic this1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_","get_hintMetrics",0xb7d30224,"lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_.get_hintMetrics","lime/graphics/cairo/CairoFontOptions.hx",63,0x355ba586)
            	HX_STACK_ARG(this1,"this1")
HXLINE(  63)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_options_get_hint_metrics(hx::DynamicPtr(this1))) );
            	}
...
Int CairoFontOptions_Impl__obj::get_hintStyle( ::Dynamic this1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_","get_hintStyle",0xb5ba9ad2,"lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_.get_hintStyle","lime/graphics/cairo/CairoFontOptions.hx",86,0x355ba586)
            	HX_STACK_ARG(this1,"this1")
HXLINE(  86)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_options_get_hint_style(hx::DynamicPtr(this1))) );
            	}
...
Int CairoFontOptions_Impl__obj::get_subpixelOrder( ::Dynamic this1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_","get_subpixelOrder",0x298e5e50,"lime.graphics.cairo._CairoFontOptions.CairoFontOptions_Impl_.get_subpixelOrder","lime/graphics/cairo/CairoFontOptions.hx",108,0x355ba586)
            	HX_STACK_ARG(this1,"this1")
HXLINE( 108)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_options_get_subpixel_order(hx::DynamicPtr(this1))) );
            	}
