...
void Event_obj::cancel(){
            	HX_STACK_FRAME("lime.app.Event","cancel",0xfb4b3cd4,"lime.app.Event.cancel","lime/app/Event.hx",216,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool Event_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",252,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 255)		{
HXLINE( 255)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 255)			HX_VARI( ::cpp::VirtualArray,_g1) = this->_hx___listeners;
...
void Event_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",267,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 270)		HX_VARI( Int,i) = this->_hx___listeners->get_length();
...
HXLINE( 276)				this->_hx___listeners->splice(i,(int)1);
