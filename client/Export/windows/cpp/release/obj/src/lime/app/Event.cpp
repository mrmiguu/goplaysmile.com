...
void Event_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Event","new",0xaf38c4c6,"lime.app.Event.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app.Event","add",0xaf2ee687,"lime.app.Event.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void Event_obj::cancel(){
            	HX_STACK_FRAME("lime.app.Event","cancel",0xfb4b3cd4,"lime.app.Event.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool Event_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void Event_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
