...
void FutureWork_obj::queue( ::Dynamic state){
            	HX_STACK_FRAME("lime.app._Future.FutureWork","queue",0x91987fc9,"lime.app._Future.FutureWork.queue","lime/app/Future.hx",267,0x058e0853)
            	HX_STACK_ARG(state,"state")
HXLINE( 269)		Bool _hx_tmp = hx::IsNull( ::lime::app::_Future::FutureWork_obj::threadPool );
HXDLIN( 269)		if (_hx_tmp) {
HXLINE( 271)			::lime::app::_Future::FutureWork_obj::threadPool =  ::lime::_hx_system::ThreadPool_obj::__new(null(),null());
HXLINE( 272)			::lime::app::_Future::FutureWork_obj::threadPool->doWork->add(::lime::app::_Future::FutureWork_obj::threadPool_doWork_dyn(),null(),null());
HXLINE( 273)			::lime::app::_Future::FutureWork_obj::threadPool->onComplete->add(::lime::app::_Future::FutureWork_obj::threadPool_onComplete_dyn(),null(),null());
HXLINE( 274)			::lime::app::_Future::FutureWork_obj::threadPool->onError->add(::lime::app::_Future::FutureWork_obj::threadPool_onError_dyn(),null(),null());
            		}
HXLINE( 278)		::lime::app::_Future::FutureWork_obj::threadPool->queue(state);
            	}
...
void FutureWork_obj::threadPool_doWork( ::Dynamic state){
            	HX_STACK_FRAME("lime.app._Future.FutureWork","threadPool_doWork",0x0c558ecd,"lime.app._Future.FutureWork.threadPool_doWork","lime/app/Future.hx",292,0x058e0853)
            	HX_STACK_ARG(state,"state")
HXLINE( 292)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 294)			HX_VARI(  ::Dynamic,result) =  ::Dynamic(state->__Field(HX_("work",d1,01,fd,4e),hx::paccDynamic))();
HXLINE( 295)			::lime::app::_Future::FutureWork_obj::threadPool->sendComplete( ::Dynamic(hx::Anon_obj::Create(2)
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 299)				::lime::app::_Future::FutureWork_obj::threadPool->sendError( ::Dynamic(hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("promise",9b,cd,e9,f7), ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)))
...
void FutureWork_obj::threadPool_onComplete( ::Dynamic state){
            	HX_STACK_FRAME("lime.app._Future.FutureWork","threadPool_onComplete",0x6b927949,"lime.app._Future.FutureWork.threadPool_onComplete","lime/app/Future.hx",308,0x058e0853)
            	HX_STACK_ARG(state,"state")
HXLINE( 308)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("complete",b9,00,c8,7f),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)));
            	}
...
void FutureWork_obj::threadPool_onError( ::Dynamic state){
            	HX_STACK_FRAME("lime.app._Future.FutureWork","threadPool_onError",0xc65d5938,"lime.app._Future.FutureWork.threadPool_onError","lime/app/Future.hx",315,0x058e0853)
            	HX_STACK_ARG(state,"state")
HXLINE( 315)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)));
            	}
