...
HXLINE(  15)		this->onRender =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  14)		this->onContextRestored =  ::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__new();
HXLINE(  13)		this->onContextLost =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  24)		this->window = window;
HXLINE(  26)		this->backend =  ::lime::_backend::native::NativeRenderer_obj::__new(hx::ObjectPtr<OBJ_>(this));
HXLINE(  28)		this->window->renderer = hx::ObjectPtr<OBJ_>(this);
            	}
...
void Renderer_obj::create(){
            	HX_STACK_FRAME("lime.graphics.Renderer","create",0x6b7d5f7d,"lime.graphics.Renderer.create","lime/graphics/Renderer.hx",35,0x16f09331)
            	HX_STACK_THIS(this)
HXLINE(  35)		this->backend->create();
            	}
...
void Renderer_obj::flip(){
            	HX_STACK_FRAME("lime.graphics.Renderer","flip",0xde6538ee,"lime.graphics.Renderer.flip","lime/graphics/Renderer.hx",42,0x16f09331)
            	HX_STACK_THIS(this)
HXLINE(  42)		this->backend->flip();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Renderer_obj,flip,(void))
 ...
 ::lime::graphics::Image Renderer_obj::readPixels( ::lime::math::Rectangle rect){
            	HX_STACK_FRAME("lime.graphics.Renderer","readPixels",0xd6a0a024,"lime.graphics.Renderer.readPixels","lime/graphics/Renderer.hx",49,0x16f09331)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE(  49)		return this->backend->readPixels(rect);
            	}
...
void Renderer_obj::render(){
            	HX_STACK_FRAME("lime.graphics.Renderer","render",0xf49763d7,"lime.graphics.Renderer.render","lime/graphics/Renderer.hx",56,0x16f09331)
            	HX_STACK_THIS(this)
HXLINE(  56)		this->backend->render();
            	}
