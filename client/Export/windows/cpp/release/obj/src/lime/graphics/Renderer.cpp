...
void Renderer_obj::__construct( ::lime::ui::Window window){
            	HX_STACK_FRAME("lime.graphics.Renderer","new",0x7185ed3f,"lime.graphics.Renderer.new","lime/graphics/Renderer.hx",14,0x16f09331)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
HXLINE(  20)		this->onRender =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  19)		this->onContextRestored =  ::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__new();
HXLINE(  18)		this->onContextLost =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  29)		this->window = window;
HXLINE(  31)		this->backend =  ::lime::_backend::native::NativeRenderer_obj::__new(hx::ObjectPtr<OBJ_>(this));
...
void Renderer_obj::create(){
            	HX_STACK_FRAME("lime.graphics.Renderer","create",0x6b7d5f7d,"lime.graphics.Renderer.create","lime/graphics/Renderer.hx",40,0x16f09331)
            	HX_STACK_THIS(this)
...
void Renderer_obj::flip(){
            	HX_STACK_FRAME("lime.graphics.Renderer","flip",0xde6538ee,"lime.graphics.Renderer.flip","lime/graphics/Renderer.hx",47,0x16f09331)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Renderer_obj,flip,(void))
 ...
 ::lime::graphics::Image Renderer_obj::readPixels( ::lime::math::Rectangle rect){
            	HX_STACK_FRAME("lime.graphics.Renderer","readPixels",0xd6a0a024,"lime.graphics.Renderer.readPixels","lime/graphics/Renderer.hx",54,0x16f09331)
            	HX_STACK_THIS(this)
...
void Renderer_obj::render(){
            	HX_STACK_FRAME("lime.graphics.Renderer","render",0xf49763d7,"lime.graphics.Renderer.render","lime/graphics/Renderer.hx",61,0x16f09331)
            	HX_STACK_THIS(this)
