...
void Module_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		this->onExit =  ::lime::app::_Event_Int_Void_obj::__new();
HXLINE(  33)		this->_hx___renderers = ::Array_obj< ::Dynamic>::__new();
HXLINE(  34)		this->_hx___windows = ::Array_obj< ::Dynamic>::__new();
            	}
...
void Module_obj::addRenderer( ::lime::graphics::Renderer renderer){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addRenderer",0xd23c47c8,"lime.app.Module.addRenderer","lime/app/Module.hx",41,0x653a538a)
HXLINE(  41)			f(a1);
            		}
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addRenderer",0xd23c47c8,"lime.app.Module.addRenderer","lime/app/Module.hx",42,0x653a538a)
HXLINE(  42)			f1(a11);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(::hx::EnumBase a2){
            			HX_STACK_FRAME("lime.app.Module","addRenderer",0xd23c47c8,"lime.app.Module.addRenderer","lime/app/Module.hx",43,0x653a538a)
            			HX_STACK_ARG(a2,"a2")
HXLINE(  43)			f2(a12,a2);
            		}
...
HXLINE(  41)		 ::Dynamic f = this->render_dyn();
HXDLIN(  41)		 ::lime::graphics::Renderer a1 = renderer;
HXDLIN(  41)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN(  41)		renderer->onRender->add(_hx_tmp,null(),null());
HXLINE(  42)		 ::Dynamic f1 = this->onRenderContextLost_dyn();
HXDLIN(  42)		 ::lime::graphics::Renderer a11 = renderer;
HXDLIN(  42)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN(  42)		renderer->onContextLost->add(_hx_tmp1,null(),null());
HXLINE(  43)		 ::Dynamic f2 = this->onRenderContextRestored_dyn();
HXDLIN(  43)		 ::lime::graphics::Renderer a12 = renderer;
HXDLIN(  43)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN(  43)		renderer->onContextRestored->add(_hx_tmp2,null(),null());
HXLINE(  45)		this->_hx___renderers->push(renderer);
            	}
...
void Module_obj::addWindow( ::lime::ui::Window window){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",52,0x653a538a)
HXLINE(  52)			f(a1);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",53,0x653a538a)
HXLINE(  53)			f1(a11);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",54,0x653a538a)
HXLINE(  54)			f2(a12);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",55,0x653a538a)
HXLINE(  55)			f3(a13);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(::String a2){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",56,0x653a538a)
            			HX_STACK_ARG(a2,"a2")
HXLINE(  56)			f4(a14,a2);
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",57,0x653a538a)
HXLINE(  57)			f5(a15);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",58,0x653a538a)
HXLINE(  58)			f6(a16);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",59,0x653a538a)
HXLINE(  59)			f7(a17);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",60,0x653a538a)
HXLINE(  60)			f8(a18);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(Int a21,Int a3){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",61,0x653a538a)
            			HX_STACK_ARG(a21,"a21")
            			HX_STACK_ARG(a3,"a3")
HXLINE(  61)			f9(a19,a21,a3);
            		}
            		...
            		void _hx_run(Int a22,Int a31){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",62,0x653a538a)
            			HX_STACK_ARG(a22,"a22")
            			HX_STACK_ARG(a31,"a31")
HXLINE(  62)			f10(a110,a22,a31);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_11, ::Dynamic,f11, ::lime::ui::Window,a111) HXARGC(0)
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",63,0x653a538a)
HXLINE(  63)			f11(a111);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",64,0x653a538a)
HXLINE(  64)			f12(a112);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(Float x,Float y,Int a23){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",65,0x653a538a)
            			HX_STACK_ARG(x,"x")
            			HX_STACK_ARG(y,"y")
            			HX_STACK_ARG(a23,"a23")
HXLINE(  65)			f13(a113,x,y,a23);
            		}
            		...
            		void _hx_run(Float x1,Float y1){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",66,0x653a538a)
            			HX_STACK_ARG(x1,"x1")
            			HX_STACK_ARG(y1,"y1")
HXLINE(  66)			f14(a114,x1,y1);
            		}
            		HX_END_LOCAL_FUNC2((void))
            		...
            		void _hx_run(Float x2,Float y2){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",67,0x653a538a)
            			HX_STACK_ARG(x2,"x2")
            			HX_STACK_ARG(y2,"y2")
HXLINE(  67)			f15(a115,x2,y2);
            		}
            		HX_END_LOCAL_FUNC2((void))
            		...
            		void _hx_run(Float x3,Float y3,Int a24){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",68,0x653a538a)
            			HX_STACK_ARG(x3,"x3")
            			HX_STACK_ARG(y3,"y3")
            			HX_STACK_ARG(a24,"a24")
HXLINE(  68)			f16(a116,x3,y3,a24);
            		}
            		HX_END_LOCAL_FUNC3((void))
            		...
            		void _hx_run(Float a25,Float a32){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",69,0x653a538a)
            			HX_STACK_ARG(a25,"a25")
            			HX_STACK_ARG(a32,"a32")
HXLINE(  69)			f17(a117,a25,a32);
            		}
            		HX_END_LOCAL_FUNC2((void))
            		...
            		void _hx_run(Float x4,Float y4){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",70,0x653a538a)
            			HX_STACK_ARG(x4,"x4")
            			HX_STACK_ARG(y4,"y4")
HXLINE(  70)			f18(a118,x4,y4);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_19, ::Dynamic,f19, ::lime::ui::Window,a119) HXARGC(2)
            		void _hx_run(Int a26,Int a33){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",71,0x653a538a)
            			HX_STACK_ARG(a26,"a26")
            			HX_STACK_ARG(a33,"a33")
HXLINE(  71)			f19(a119,a26,a33);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_20, ::lime::ui::Window,a120, ::Dynamic,f20) HXARGC(0)
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",72,0x653a538a)
HXLINE(  72)			f20(a120);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(::String a27,Int a34,Int a4){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",73,0x653a538a)
            			HX_STACK_ARG(a27,"a27")
            			HX_STACK_ARG(a34,"a34")
            			HX_STACK_ARG(a4,"a4")
HXLINE(  73)			f21(a121,a27,a34,a4);
            		}
            		HX_END_LOCAL_FUNC3((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_22, ::lime::ui::Window,a122, ::Dynamic,f22) HXARGC(1)
            		void _hx_run(::String a28){
            			HX_STACK_FRAME("lime.app.Module","addWindow",0x1a90fb35,"lime.app.Module.addWindow","lime/app/Module.hx",74,0x653a538a)
            			HX_STACK_ARG(a28,"a28")
HXLINE(  74)			f22(a122,a28);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(  52)		 ::Dynamic f = this->onWindowActivate_dyn();
HXDLIN(  52)		 ::lime::ui::Window a1 = window;
HXDLIN(  52)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN(  52)		window->onActivate->add(_hx_tmp,null(),null());
HXLINE(  53)		 ::Dynamic f1 = this->_hx___onWindowClose_dyn();
HXDLIN(  53)		 ::lime::ui::Window a11 = window;
HXDLIN(  53)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN(  53)		window->onClose->add(_hx_tmp1,null(),null());
HXLINE(  54)		 ::Dynamic f2 = this->onWindowCreate_dyn();
HXDLIN(  54)		 ::lime::ui::Window a12 = window;
HXDLIN(  54)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN(  54)		window->onCreate->add(_hx_tmp2,null(),null());
HXLINE(  55)		 ::Dynamic f3 = this->onWindowDeactivate_dyn();
HXDLIN(  55)		 ::lime::ui::Window a13 = window;
HXDLIN(  55)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(a13,f3));
HXDLIN(  55)		window->onDeactivate->add(_hx_tmp3,null(),null());
HXLINE(  56)		 ::Dynamic f4 = this->onWindowDropFile_dyn();
HXDLIN(  56)		 ::lime::ui::Window a14 = window;
HXDLIN(  56)		 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_4(a14,f4));
HXDLIN(  56)		window->onDropFile->add(_hx_tmp4,null(),null());
HXLINE(  57)		 ::Dynamic f5 = this->onWindowEnter_dyn();
HXDLIN(  57)		 ::lime::ui::Window a15 = window;
HXDLIN(  57)		 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_5(f5,a15));
HXDLIN(  57)		window->onEnter->add(_hx_tmp5,null(),null());
HXLINE(  58)		 ::Dynamic f6 = this->onWindowFocusIn_dyn();
HXDLIN(  58)		 ::lime::ui::Window a16 = window;
HXDLIN(  58)		 ::Dynamic _hx_tmp6 =  ::Dynamic(new _hx_Closure_6(f6,a16));
HXDLIN(  58)		window->onFocusIn->add(_hx_tmp6,null(),null());
HXLINE(  59)		 ::Dynamic f7 = this->onWindowFocusOut_dyn();
HXDLIN(  59)		 ::lime::ui::Window a17 = window;
HXDLIN(  59)		 ::Dynamic _hx_tmp7 =  ::Dynamic(new _hx_Closure_7(a17,f7));
HXDLIN(  59)		window->onFocusOut->add(_hx_tmp7,null(),null());
HXLINE(  60)		 ::Dynamic f8 = this->onWindowFullscreen_dyn();
HXDLIN(  60)		 ::lime::ui::Window a18 = window;
HXDLIN(  60)		 ::Dynamic _hx_tmp8 =  ::Dynamic(new _hx_Closure_8(a18,f8));
HXDLIN(  60)		window->onFullscreen->add(_hx_tmp8,null(),null());
HXLINE(  61)		 ::Dynamic f9 = this->onKeyDown_dyn();
HXDLIN(  61)		 ::lime::ui::Window a19 = window;
HXDLIN(  61)		 ::Dynamic _hx_tmp9 =  ::Dynamic(new _hx_Closure_9(f9,a19));
HXDLIN(  61)		window->onKeyDown->add(_hx_tmp9,null(),null());
HXLINE(  62)		 ::Dynamic f10 = this->onKeyUp_dyn();
HXDLIN(  62)		 ::lime::ui::Window a110 = window;
HXDLIN(  62)		 ::Dynamic _hx_tmp10 =  ::Dynamic(new _hx_Closure_10(f10,a110));
HXDLIN(  62)		window->onKeyUp->add(_hx_tmp10,null(),null());
HXLINE(  63)		 ::Dynamic f11 = this->onWindowLeave_dyn();
HXDLIN(  63)		 ::lime::ui::Window a111 = window;
HXDLIN(  63)		 ::Dynamic _hx_tmp11 =  ::Dynamic(new _hx_Closure_11(f11,a111));
HXDLIN(  63)		window->onLeave->add(_hx_tmp11,null(),null());
HXLINE(  64)		 ::Dynamic f12 = this->onWindowMinimize_dyn();
HXDLIN(  64)		 ::lime::ui::Window a112 = window;
HXDLIN(  64)		 ::Dynamic _hx_tmp12 =  ::Dynamic(new _hx_Closure_12(a112,f12));
HXDLIN(  64)		window->onMinimize->add(_hx_tmp12,null(),null());
HXLINE(  65)		 ::Dynamic f13 = this->onMouseDown_dyn();
HXDLIN(  65)		 ::lime::ui::Window a113 = window;
HXDLIN(  65)		 ::Dynamic _hx_tmp13 =  ::Dynamic(new _hx_Closure_13(f13,a113));
HXDLIN(  65)		window->onMouseDown->add(_hx_tmp13,null(),null());
HXLINE(  66)		 ::Dynamic f14 = this->onMouseMove_dyn();
HXDLIN(  66)		 ::lime::ui::Window a114 = window;
HXDLIN(  66)		 ::Dynamic _hx_tmp14 =  ::Dynamic(new _hx_Closure_14(f14,a114));
HXDLIN(  66)		window->onMouseMove->add(_hx_tmp14,null(),null());
HXLINE(  67)		 ::Dynamic f15 = this->onMouseMoveRelative_dyn();
HXDLIN(  67)		 ::lime::ui::Window a115 = window;
HXDLIN(  67)		 ::Dynamic _hx_tmp15 =  ::Dynamic(new _hx_Closure_15(f15,a115));
HXDLIN(  67)		window->onMouseMoveRelative->add(_hx_tmp15,null(),null());
HXLINE(  68)		 ::Dynamic f16 = this->onMouseUp_dyn();
HXDLIN(  68)		 ::lime::ui::Window a116 = window;
HXDLIN(  68)		 ::Dynamic _hx_tmp16 =  ::Dynamic(new _hx_Closure_16(a116,f16));
HXDLIN(  68)		window->onMouseUp->add(_hx_tmp16,null(),null());
HXLINE(  69)		 ::Dynamic f17 = this->onMouseWheel_dyn();
HXDLIN(  69)		 ::lime::ui::Window a117 = window;
HXDLIN(  69)		 ::Dynamic _hx_tmp17 =  ::Dynamic(new _hx_Closure_17(f17,a117));
HXDLIN(  69)		window->onMouseWheel->add(_hx_tmp17,null(),null());
HXLINE(  70)		 ::Dynamic f18 = this->onWindowMove_dyn();
HXDLIN(  70)		 ::lime::ui::Window a118 = window;
HXDLIN(  70)		 ::Dynamic _hx_tmp18 =  ::Dynamic(new _hx_Closure_18(a118,f18));
HXDLIN(  70)		window->onMove->add(_hx_tmp18,null(),null());
HXLINE(  71)		 ::Dynamic f19 = this->onWindowResize_dyn();
HXDLIN(  71)		 ::lime::ui::Window a119 = window;
HXDLIN(  71)		 ::Dynamic _hx_tmp19 =  ::Dynamic(new _hx_Closure_19(f19,a119));
HXDLIN(  71)		window->onResize->add(_hx_tmp19,null(),null());
HXLINE(  72)		 ::Dynamic f20 = this->onWindowRestore_dyn();
HXDLIN(  72)		 ::lime::ui::Window a120 = window;
HXDLIN(  72)		 ::Dynamic _hx_tmp20 =  ::Dynamic(new _hx_Closure_20(a120,f20));
HXDLIN(  72)		window->onRestore->add(_hx_tmp20,null(),null());
HXLINE(  73)		 ::Dynamic f21 = this->onTextEdit_dyn();
HXDLIN(  73)		 ::lime::ui::Window a121 = window;
HXDLIN(  73)		 ::Dynamic _hx_tmp21 =  ::Dynamic(new _hx_Closure_21(a121,f21));
HXDLIN(  73)		window->onTextEdit->add(_hx_tmp21,null(),null());
HXLINE(  74)		 ::Dynamic f22 = this->onTextInput_dyn();
HXDLIN(  74)		 ::lime::ui::Window a122 = window;
HXDLIN(  74)		 ::Dynamic _hx_tmp22 =  ::Dynamic(new _hx_Closure_22(a122,f22));
HXDLIN(  74)		window->onTextInput->add(_hx_tmp22,null(),null());
HXLINE(  76)		Bool _hx_tmp23 = (window->id > (int)-1);
HXDLIN(  76)		if (_hx_tmp23) {
HXLINE(  78)			this->onWindowCreate(window);
            		}
HXLINE(  82)		this->_hx___windows->push(window);
            	}
...
HXLINE(  89)		this->_hx___application = application;
HXLINE(  91)		application->onExit->add(this->onModuleExit_dyn(),false,(int)0);
HXLINE(  92)		application->onUpdate->add(this->update_dyn(),null(),null());
HXLINE(  94)		{
HXLINE(  94)			HX_VARI(  ::Dynamic,tmp) = ::lime::ui::Gamepad_obj::devices->iterator();
HXDLIN(  94)			while(true){
HXLINE(  94)				Bool _hx_tmp = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(  94)				if (_hx_tmp) {
HXLINE(  94)					goto _hx_goto_0;
            				}
HXDLIN(  94)				HX_VARI(  ::lime::ui::Gamepad,gamepad) = ( ( ::lime::ui::Gamepad)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(  96)				this->_hx___onGamepadConnect(gamepad);
            			}
            			_hx_goto_0:;
            		}
HXLINE( 100)		::lime::ui::Gamepad_obj::onConnect->add(this->_hx___onGamepadConnect_dyn(),null(),null());
HXLINE( 102)		{
HXLINE( 102)			HX_VARI_NAME(  ::Dynamic,tmp1,"tmp") = ::lime::ui::Joystick_obj::devices->iterator();
HXDLIN( 102)			while(true){
HXLINE( 102)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(tmp1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 102)				if (_hx_tmp1) {
HXLINE( 102)					goto _hx_goto_1;
            				}
HXDLIN( 102)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)( ::Dynamic(tmp1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 104)				this->_hx___onJoystickConnect(joystick);
            			}
            			_hx_goto_1:;
            		}
HXLINE( 108)		::lime::ui::Joystick_obj::onConnect->add(this->_hx___onJoystickConnect_dyn(),null(),null());
HXLINE( 110)		::lime::ui::Touch_obj::onStart->add(this->onTouchStart_dyn(),null(),null());
HXLINE( 111)		::lime::ui::Touch_obj::onMove->add(this->onTouchMove_dyn(),null(),null());
HXLINE( 112)		::lime::ui::Touch_obj::onEnd->add(this->onTouchEnd_dyn(),null(),null());
            	}
...
void Module_obj::removeRenderer( ::lime::graphics::Renderer renderer){
            	HX_STACK_FRAME("lime.app.Module","removeRenderer",0xe9a118e3,"lime.app.Module.removeRenderer","lime/app/Module.hx",119,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderer,"renderer")
HXLINE( 119)		Bool _hx_tmp;
HXDLIN( 119)		Bool _hx_tmp1 = hx::IsNotNull( renderer );
HXDLIN( 119)		if (_hx_tmp1) {
HXLINE( 119)			Int _hx_tmp2 = this->_hx___renderers->indexOf(renderer,null());
HXDLIN( 119)			_hx_tmp = (_hx_tmp2 > (int)-1);
            		}
            		else {
HXLINE( 119)			_hx_tmp = false;
            		}
HXDLIN( 119)		if (_hx_tmp) {
HXLINE( 121)			this->_hx___renderers->remove(renderer);
            		}
            	}
...
void Module_obj::removeWindow( ::lime::ui::Window window){
            	HX_STACK_FRAME("lime.app.Module","removeWindow",0x1777bf90,"lime.app.Module.removeWindow","lime/app/Module.hx",130,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
HXLINE( 130)		Bool _hx_tmp;
HXDLIN( 130)		Bool _hx_tmp1 = hx::IsNotNull( window );
HXDLIN( 130)		if (_hx_tmp1) {
HXLINE( 130)			Int _hx_tmp2 = this->_hx___windows->indexOf(window,null());
HXDLIN( 130)			_hx_tmp = (_hx_tmp2 > (int)-1);
            		}
            		else {
HXLINE( 130)			_hx_tmp = false;
            		}
HXDLIN( 130)		if (_hx_tmp) {
HXLINE( 132)			this->_hx___windows->remove(window);
            		}
            	}
...
void Module_obj::setPreloader( ::lime::app::Preloader preloader){
            	HX_STACK_FRAME("lime.app.Module","setPreloader",0xfc8934b0,"lime.app.Module.setPreloader","lime/app/Module.hx",139,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(preloader,"preloader")
HXLINE( 141)		Bool _hx_tmp = hx::IsNotNull( this->_hx___preloader );
HXDLIN( 141)		if (_hx_tmp) {
HXLINE( 143)			this->_hx___preloader->onProgress->remove(this->onPreloadProgress_dyn());
HXLINE( 144)			this->_hx___preloader->onComplete->remove(this->onPreloadComplete_dyn());
            		}
HXLINE( 148)		this->_hx___preloader = preloader;
HXLINE( 150)		Bool _hx_tmp1;
HXDLIN( 150)		Bool _hx_tmp2 = hx::IsNotNull( preloader );
HXDLIN( 150)		if (_hx_tmp2) {
HXLINE( 150)			_hx_tmp1 = preloader->complete;
            		}
            		else {
HXLINE( 150)			_hx_tmp1 = true;
            		}
HXDLIN( 150)		if (_hx_tmp1) {
HXLINE( 152)			this->onPreloadComplete();
            		}
            		else {
HXLINE( 156)			preloader->onProgress->add(this->onPreloadProgress_dyn(),null(),null());
HXLINE( 157)			preloader->onComplete->add(this->onPreloadComplete_dyn(),null(),null());
            		}
            	}
...
void Module_obj::unregisterModule( ::lime::app::Application application){
            	HX_STACK_FRAME("lime.app.Module","unregisterModule",0x4c0689c4,"lime.app.Module.unregisterModule","lime/app/Module.hx",164,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(application,"application")
HXLINE( 166)		this->_hx___application->onExit->remove(this->onModuleExit_dyn());
HXLINE( 167)		this->_hx___application->onUpdate->remove(this->update_dyn());
HXLINE( 169)		::lime::ui::Gamepad_obj::onConnect->remove(this->_hx___onGamepadConnect_dyn());
HXLINE( 170)		::lime::ui::Joystick_obj::onConnect->remove(this->_hx___onJoystickConnect_dyn());
HXLINE( 171)		::lime::ui::Touch_obj::onStart->remove(this->onTouchStart_dyn());
HXLINE( 172)		::lime::ui::Touch_obj::onMove->remove(this->onTouchMove_dyn());
HXLINE( 173)		::lime::ui::Touch_obj::onEnd->remove(this->onTouchEnd_dyn());
HXLINE( 175)		this->onModuleExit((int)0);
            	}
...
void Module_obj::onGamepadAxisMove( ::lime::ui::Gamepad gamepad,Int axis,Float value){
            	HX_STACK_FRAME("lime.app.Module","onGamepadAxisMove",0x43570df8,"lime.app.Module.onGamepadAxisMove","lime/app/Module.hx",186,0x653a538a)
            	HX_STACK_THIS(this)
...
void Module_obj::onGamepadButtonDown( ::lime::ui::Gamepad gamepad,Int button){
            	HX_STACK_FRAME("lime.app.Module","onGamepadButtonDown",0xdb9e1a9a,"lime.app.Module.onGamepadButtonDown","lime/app/Module.hx",194,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
...
void Module_obj::onGamepadButtonUp( ::lime::ui::Gamepad gamepad,Int button){
            	HX_STACK_FRAME("lime.app.Module","onGamepadButtonUp",0x0f950a93,"lime.app.Module.onGamepadButtonUp","lime/app/Module.hx",202,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
            	HX_STACK_ARG(button,"button")
            	}
...
void Module_obj::onGamepadConnect( ::lime::ui::Gamepad gamepad){
            	HX_STACK_FRAME("lime.app.Module","onGamepadConnect",0xa4a7b504,"lime.app.Module.onGamepadConnect","lime/app/Module.hx",209,0x653a538a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
            	}
...
void Module_obj::onRenderContextRestored( ::lime::graphics::Renderer renderer,::hx::EnumBase context){
...
void Module_obj::_hx___onGamepadConnect( ::lime::ui::Gamepad gamepad){
            		...
            		void _hx_run(Int a2,Float a3){
            			HX_STACK_FRAME("lime.app.Module","__onGamepadConnect",0xebb94f24,"lime.app.Module.__onGamepadConnect","lime/app/Module.hx",537,0x653a538a)
            			HX_STACK_ARG(a2,"a2")
            			HX_STACK_ARG(a3,"a3")
HXLINE( 537)			f(a1,a2,a3);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::lime::ui::Gamepad,a11, ::Dynamic,f1) HXARGC(1)
            		void _hx_run(Int a21){
            			HX_STACK_FRAME("lime.app.Module","__onGamepadConnect",0xebb94f24,"lime.app.Module.__onGamepadConnect","lime/app/Module.hx",538,0x653a538a)
            			HX_STACK_ARG(a21,"a21")
HXLINE( 538)			f1(a11,a21);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_2, ::lime::ui::Gamepad,a12, ::Dynamic,f2) HXARGC(1)
            		void _hx_run(Int a22){
            			HX_STACK_FRAME("lime.app.Module","__onGamepadConnect",0xebb94f24,"lime.app.Module.__onGamepadConnect","lime/app/Module.hx",539,0x653a538a)
            			HX_STACK_ARG(a22,"a22")
HXLINE( 539)			f2(a12,a22);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_3, ::lime::ui::Gamepad,a13, ::Dynamic,f3) HXARGC(0)
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","__onGamepadConnect",0xebb94f24,"lime.app.Module.__onGamepadConnect","lime/app/Module.hx",540,0x653a538a)
HXLINE( 540)			f3(a13);
            		}
            		HX_END_LOCAL_FUNC0((void))
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
HXLINE( 535)		this->onGamepadConnect(gamepad);
HXLINE( 537)		 ::Dynamic f = this->onGamepadAxisMove_dyn();
HXDLIN( 537)		 ::lime::ui::Gamepad a1 = gamepad;
HXDLIN( 537)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN( 537)		gamepad->onAxisMove->add(_hx_tmp,null(),null());
HXLINE( 538)		 ::Dynamic f1 = this->onGamepadButtonDown_dyn();
HXDLIN( 538)		 ::lime::ui::Gamepad a11 = gamepad;
HXDLIN( 538)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN( 538)		gamepad->onButtonDown->add(_hx_tmp1,null(),null());
HXLINE( 539)		 ::Dynamic f2 = this->onGamepadButtonUp_dyn();
HXDLIN( 539)		 ::lime::ui::Gamepad a12 = gamepad;
HXDLIN( 539)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN( 539)		gamepad->onButtonUp->add(_hx_tmp2,null(),null());
HXLINE( 540)		 ::Dynamic f3 = this->onGamepadDisconnect_dyn();
HXDLIN( 540)		 ::lime::ui::Gamepad a13 = gamepad;
HXDLIN( 540)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(a13,f3));
HXDLIN( 540)		gamepad->onDisconnect->add(_hx_tmp3,null(),null());
            	}
...
void Module_obj::_hx___onJoystickConnect( ::lime::ui::Joystick joystick){
            		...
            		void _hx_run(Int a2,Float a3){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",549,0x653a538a)
            			HX_STACK_ARG(a2,"a2")
            			HX_STACK_ARG(a3,"a3")
HXLINE( 549)			f(a1,a2,a3);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::lime::ui::Joystick,a11, ::Dynamic,f1) HXARGC(1)
            		void _hx_run(Int a21){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",550,0x653a538a)
            			HX_STACK_ARG(a21,"a21")
HXLINE( 550)			f1(a11,a21);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_2, ::lime::ui::Joystick,a12, ::Dynamic,f2) HXARGC(1)
            		void _hx_run(Int a22){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",551,0x653a538a)
            			HX_STACK_ARG(a22,"a22")
HXLINE( 551)			f2(a12,a22);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_3, ::lime::ui::Joystick,a13, ::Dynamic,f3) HXARGC(0)
            		void _hx_run(){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",552,0x653a538a)
HXLINE( 552)			f3(a13);
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(Int a23,Int a31){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",553,0x653a538a)
            			HX_STACK_ARG(a23,"a23")
            			HX_STACK_ARG(a31,"a31")
HXLINE( 553)			f4(a14,a23,a31);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_5, ::Dynamic,f5, ::lime::ui::Joystick,a15) HXARGC(2)
            		void _hx_run(Int a24,Float a32){
            			HX_STACK_FRAME("lime.app.Module","__onJoystickConnect",0x01b46c53,"lime.app.Module.__onJoystickConnect","lime/app/Module.hx",554,0x653a538a)
            			HX_STACK_ARG(a24,"a24")
            			HX_STACK_ARG(a32,"a32")
HXLINE( 554)			f5(a15,a24,a32);
            		}
            		HX_END_LOCAL_FUNC2((void))
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(joystick,"joystick")
HXLINE( 547)		this->onJoystickConnect(joystick);
HXLINE( 549)		 ::Dynamic f = this->onJoystickAxisMove_dyn();
HXDLIN( 549)		 ::lime::ui::Joystick a1 = joystick;
HXDLIN( 549)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN( 549)		joystick->onAxisMove->add(_hx_tmp,null(),null());
HXLINE( 550)		 ::Dynamic f1 = this->onJoystickButtonDown_dyn();
HXDLIN( 550)		 ::lime::ui::Joystick a11 = joystick;
HXDLIN( 550)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN( 550)		joystick->onButtonDown->add(_hx_tmp1,null(),null());
HXLINE( 551)		 ::Dynamic f2 = this->onJoystickButtonUp_dyn();
HXDLIN( 551)		 ::lime::ui::Joystick a12 = joystick;
HXDLIN( 551)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN( 551)		joystick->onButtonUp->add(_hx_tmp2,null(),null());
HXLINE( 552)		 ::Dynamic f3 = this->onJoystickDisconnect_dyn();
HXDLIN( 552)		 ::lime::ui::Joystick a13 = joystick;
HXDLIN( 552)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(a13,f3));
HXDLIN( 552)		joystick->onDisconnect->add(_hx_tmp3,null(),null());
HXLINE( 553)		 ::Dynamic f4 = this->onJoystickHatMove_dyn();
HXDLIN( 553)		 ::lime::ui::Joystick a14 = joystick;
HXDLIN( 553)		 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_4(a14,f4));
HXDLIN( 553)		joystick->onHatMove->add(_hx_tmp4,null(),null());
HXLINE( 554)		 ::Dynamic f5 = this->onJoystickTrackballMove_dyn();
HXDLIN( 554)		 ::lime::ui::Joystick a15 = joystick;
HXDLIN( 554)		 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_5(f5,a15));
HXDLIN( 554)		joystick->onTrackballMove->add(_hx_tmp5,null(),null());
            	}
...
void Module_obj::_hx___onWindowClose( ::lime::ui::Window window){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
HXLINE( 561)		this->onWindowClose(window);
HXLINE( 563)		this->_hx___windows->remove(window);
            	}
