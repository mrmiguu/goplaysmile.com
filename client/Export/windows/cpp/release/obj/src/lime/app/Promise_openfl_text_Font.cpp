...
void Promise_openfl_text_Font_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","new",0xe920a52e,"lime.app.Promise_openfl_text_Font.new","lime/app/Promise.hx",18,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_openfl_text_Font_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_openfl_text_Font Promise_openfl_text_Font_obj::complete( ::openfl::text::Font data){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","complete",0x397f012b,"lime.app.Promise_openfl_text_Font.complete","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_text_Font_obj,complete,return )
 ...
 ::lime::app::Promise_openfl_text_Font Promise_openfl_text_Font_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","completeWith",0xc7a014d1,"lime.app.Promise_openfl_text_Font.completeWith","lime/app/Promise.hx",49,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_text_Font_obj,completeWith,return )
 ...
 ::lime::app::Promise_openfl_text_Font Promise_openfl_text_Font_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","error",0xc86ff016,"lime.app.Promise_openfl_text_Font.error","lime/app/Promise.hx",61,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_text_Font_obj,error,return )
 ...
 ::lime::app::Promise_openfl_text_Font Promise_openfl_text_Font_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","progress",0x3fe1f81f,"lime.app.Promise_openfl_text_Font.progress","lime/app/Promise.hx",87,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_text_Font_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","get_isComplete",0x51f27cfe,"lime.app.Promise_openfl_text_Font.get_isComplete","lime/app/Promise.hx",117,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_text_Font_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_text_Font","get_isError",0xd3ad2263,"lime.app.Promise_openfl_text_Font.get_isError","lime/app/Promise.hx",124,0x10ba4f0b)
            	HX_STACK_THIS(this)
