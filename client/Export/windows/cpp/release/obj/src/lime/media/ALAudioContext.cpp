...
void ALAudioContext_obj::__construct(){
            	HX_STACK_FRAME("lime.media.ALAudioContext","new",0xb8b5b3f9,"lime.media.ALAudioContext.new","lime/media/ALAudioContext.hx",15,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::bufferData( ::Dynamic buffer,Int format, ::lime::utils::ArrayBufferView data,Int size,Int freq){
            	HX_STACK_FRAME("lime.media.ALAudioContext","bufferData",0x038a70d1,"lime.media.ALAudioContext.bufferData","lime/media/ALAudioContext.hx",91,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::buffer3f( ::Dynamic buffer,Int param,Float value1,Float value2,Float value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","buffer3f",0x247f9b9a,"lime.media.ALAudioContext.buffer3f","lime/media/ALAudioContext.hx",98,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
...
void ALAudioContext_obj::buffer3i( ::Dynamic buffer,Int param,Int value1,Int value2,Int value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","buffer3i",0x247f9b9d,"lime.media.ALAudioContext.buffer3i","lime/media/ALAudioContext.hx",105,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value1,"value1")
...
void ALAudioContext_obj::bufferf( ::Dynamic buffer,Int param,Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","bufferf",0xbc6ec77f,"lime.media.ALAudioContext.bufferf","lime/media/ALAudioContext.hx",112,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
void ALAudioContext_obj::bufferfv( ::Dynamic buffer,Int param,::Array< Float > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","bufferfv",0x247fc817,"lime.media.ALAudioContext.bufferfv","lime/media/ALAudioContext.hx",119,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
void ALAudioContext_obj::bufferi( ::Dynamic buffer,Int param,Int value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","bufferi",0xbc6ec782,"lime.media.ALAudioContext.bufferi","lime/media/ALAudioContext.hx",126,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::bufferiv( ::Dynamic buffer,Int param,::Array< Int > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","bufferiv",0x247fcab4,"lime.media.ALAudioContext.bufferiv","lime/media/ALAudioContext.hx",133,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(values,"values")
...
void ALAudioContext_obj::deleteBuffer( ::Dynamic buffer){
            	HX_STACK_FRAME("lime.media.ALAudioContext","deleteBuffer",0xdf7844d2,"lime.media.ALAudioContext.deleteBuffer","lime/media/ALAudioContext.hx",140,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
...
void ALAudioContext_obj::deleteBuffers(::cpp::VirtualArray buffers){
            	HX_STACK_FRAME("lime.media.ALAudioContext","deleteBuffers",0xa9c3f361,"lime.media.ALAudioContext.deleteBuffers","lime/media/ALAudioContext.hx",147,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::deleteSource( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","deleteSource",0x411538ad,"lime.media.ALAudioContext.deleteSource","lime/media/ALAudioContext.hx",154,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::deleteSources(::cpp::VirtualArray sources){
            	HX_STACK_FRAME("lime.media.ALAudioContext","deleteSources",0xb17c5f26,"lime.media.ALAudioContext.deleteSources","lime/media/ALAudioContext.hx",161,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::disable(Int capability){
            	HX_STACK_FRAME("lime.media.ALAudioContext","disable",0xbc368e01,"lime.media.ALAudioContext.disable","lime/media/ALAudioContext.hx",168,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::distanceModel(Int distanceModel){
            	HX_STACK_FRAME("lime.media.ALAudioContext","distanceModel",0x6d8afd0d,"lime.media.ALAudioContext.distanceModel","lime/media/ALAudioContext.hx",175,0x07c77c95)
            	HX_STACK_THIS(this)
...
void ALAudioContext_obj::dopplerFactor(Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","dopplerFactor",0x08aeeab6,"lime.media.ALAudioContext.dopplerFactor","lime/media/ALAudioContext.hx",182,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::dopplerVelocity(Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","dopplerVelocity",0xac04dbc4,"lime.media.ALAudioContext.dopplerVelocity","lime/media/ALAudioContext.hx",189,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::enable(Int capability){
            	HX_STACK_FRAME("lime.media.ALAudioContext","enable",0x6357508a,"lime.media.ALAudioContext.enable","lime/media/ALAudioContext.hx",196,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(capability,"capability")
...
HX_DEFINE_DYNAMIC_FUNC1(ALAudioContext_obj,enable,(void))
 ...
 ::Dynamic ALAudioContext_obj::genSource(){
            	HX_STACK_FRAME("lime.media.ALAudioContext","genSource",0xcec98de4,"lime.media.ALAudioContext.genSource","lime/media/ALAudioContext.hx",203,0x07c77c95)
            	HX_STACK_THIS(this)
...
::cpp::VirtualArray ALAudioContext_obj::genSources(Int n){
            	HX_STACK_FRAME("lime.media.ALAudioContext","genSources",0x21929a0f,"lime.media.ALAudioContext.genSources","lime/media/ALAudioContext.hx",210,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
...
HX_DEFINE_DYNAMIC_FUNC1(ALAudioContext_obj,genSources,return )
 ...
 ::Dynamic ALAudioContext_obj::genBuffer(){
            	HX_STACK_FRAME("lime.media.ALAudioContext","genBuffer",0x6d2c9a09,"lime.media.ALAudioContext.genBuffer","lime/media/ALAudioContext.hx",217,0x07c77c95)
            	HX_STACK_THIS(this)
...
::cpp::VirtualArray ALAudioContext_obj::genBuffers(Int n){
            	HX_STACK_FRAME("lime.media.ALAudioContext","genBuffers",0x19da2e4a,"lime.media.ALAudioContext.genBuffers","lime/media/ALAudioContext.hx",224,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
...
Bool ALAudioContext_obj::getBoolean(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBoolean",0x3d772239,"lime.media.ALAudioContext.getBoolean","lime/media/ALAudioContext.hx",231,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBooleanv",0x8ac6d01d,"lime.media.ALAudioContext.getBooleanv","lime/media/ALAudioContext.hx",238,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
::Array< Float > ALAudioContext_obj::getBuffer3f( ::Dynamic buffer,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBuffer3f",0x76b69122,"lime.media.ALAudioContext.getBuffer3f","lime/media/ALAudioContext.hx",245,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
::Array< Int > ALAudioContext_obj::getBuffer3i( ::Dynamic buffer,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBuffer3i",0x76b69125,"lime.media.ALAudioContext.getBuffer3i","lime/media/ALAudioContext.hx",252,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
Float ALAudioContext_obj::getBufferf( ::Dynamic buffer,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBufferf",0x7108daf7,"lime.media.ALAudioContext.getBufferf","lime/media/ALAudioContext.hx",259,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBufferfv",0x76b6bd9f,"lime.media.ALAudioContext.getBufferfv","lime/media/ALAudioContext.hx",266,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
Int ALAudioContext_obj::getBufferi( ::Dynamic buffer,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBufferi",0x7108dafa,"lime.media.ALAudioContext.getBufferi","lime/media/ALAudioContext.hx",273,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getBufferiv",0x76b6c03c,"lime.media.ALAudioContext.getBufferiv","lime/media/ALAudioContext.hx",280,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
Float ALAudioContext_obj::getDouble(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getDouble",0xc8e3d0a0,"lime.media.ALAudioContext.getDouble","lime/media/ALAudioContext.hx",287,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getDoublev",0xfe72bbd6,"lime.media.ALAudioContext.getDoublev","lime/media/ALAudioContext.hx",294,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
Int ALAudioContext_obj::getEnumValue(::String ename){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getEnumValue",0xdfa8fe81,"lime.media.ALAudioContext.getEnumValue","lime/media/ALAudioContext.hx",301,0x07c77c95)
            	HX_STACK_THIS(this)
...
Int ALAudioContext_obj::getError(){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getError",0x4a824d19,"lime.media.ALAudioContext.getError","lime/media/ALAudioContext.hx",308,0x07c77c95)
            	HX_STACK_THIS(this)
...
::String ALAudioContext_obj::getErrorString(){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getErrorString",0x621742ca,"lime.media.ALAudioContext.getErrorString","lime/media/ALAudioContext.hx",315,0x07c77c95)
            	HX_STACK_THIS(this)
...
Float ALAudioContext_obj::getFloat(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getFloat",0xd9ef46ed,"lime.media.ALAudioContext.getFloat","lime/media/ALAudioContext.hx",322,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getFloatv",0xd76ec8e9,"lime.media.ALAudioContext.getFloatv","lime/media/ALAudioContext.hx",329,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
Int ALAudioContext_obj::getInteger(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getInteger",0xd693f54f,"lime.media.ALAudioContext.getInteger","lime/media/ALAudioContext.hx",336,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getIntegerv",0xeae2b047,"lime.media.ALAudioContext.getIntegerv","lime/media/ALAudioContext.hx",343,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
::Array< Float > ALAudioContext_obj::getListener3f(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListener3f",0x1f264b56,"lime.media.ALAudioContext.getListener3f","lime/media/ALAudioContext.hx",350,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
::Array< Int > ALAudioContext_obj::getListener3i(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListener3i",0x1f264b59,"lime.media.ALAudioContext.getListener3i","lime/media/ALAudioContext.hx",357,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Float ALAudioContext_obj::getListenerf(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListenerf",0xab306343,"lime.media.ALAudioContext.getListenerf","lime/media/ALAudioContext.hx",364,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListenerfv",0x1f2677d3,"lime.media.ALAudioContext.getListenerfv","lime/media/ALAudioContext.hx",371,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
Int ALAudioContext_obj::getListeneri(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListeneri",0xab306346,"lime.media.ALAudioContext.getListeneri","lime/media/ALAudioContext.hx",378,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getListeneriv",0x1f267a70,"lime.media.ALAudioContext.getListeneriv","lime/media/ALAudioContext.hx",385,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
HX_DEFINE_DYNAMIC_FUNC2(ALAudioContext_obj,getListeneriv,return )
 ...
 ::Dynamic ALAudioContext_obj::getProcAddress(::String fname){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getProcAddress",0x647d64cf,"lime.media.ALAudioContext.getProcAddress","lime/media/ALAudioContext.hx",392,0x07c77c95)
            	HX_STACK_THIS(this)
...
::Array< Float > ALAudioContext_obj::getSource3f( ::Dynamic source,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSource3f",0x305c71bd,"lime.media.ALAudioContext.getSource3f","lime/media/ALAudioContext.hx",399,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
...
Float ALAudioContext_obj::getSourcef( ::Dynamic source,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSourcef",0x78c146bc,"lime.media.ALAudioContext.getSourcef","lime/media/ALAudioContext.hx",406,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
...
::Array< Int > ALAudioContext_obj::getSource3i( ::Dynamic source,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSource3i",0x305c71c0,"lime.media.ALAudioContext.getSource3i","lime/media/ALAudioContext.hx",413,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSourcefv",0x305c9e3a,"lime.media.ALAudioContext.getSourcefv","lime/media/ALAudioContext.hx",420,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
HX_DEFINE_DYNAMIC_FUNC3(ALAudioContext_obj,getSourcefv,return )
 ...
 ::Dynamic ALAudioContext_obj::getSourcei( ::Dynamic source,Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSourcei",0x78c146bf,"lime.media.ALAudioContext.getSourcei","lime/media/ALAudioContext.hx",427,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
...
Int count = __o_count.Default(1);
            	HX_STACK_FRAME("lime.media.ALAudioContext","getSourceiv",0x305ca0d7,"lime.media.ALAudioContext.getSourceiv","lime/media/ALAudioContext.hx",434,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(count,"count")
...
::String ALAudioContext_obj::getString(Int param){
            	HX_STACK_FRAME("lime.media.ALAudioContext","getString",0xa748ce60,"lime.media.ALAudioContext.getString","lime/media/ALAudioContext.hx",441,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
...
Bool ALAudioContext_obj::isBuffer( ::Dynamic buffer){
            	HX_STACK_FRAME("lime.media.ALAudioContext","isBuffer",0xa07fca51,"lime.media.ALAudioContext.isBuffer","lime/media/ALAudioContext.hx",448,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
...
Bool ALAudioContext_obj::isEnabled(Int capability){
            	HX_STACK_FRAME("lime.media.ALAudioContext","isEnabled",0x9bf19e10,"lime.media.ALAudioContext.isEnabled","lime/media/ALAudioContext.hx",455,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(capability,"capability")
...
Bool ALAudioContext_obj::isExtensionPresent(::String extname){
            	HX_STACK_FRAME("lime.media.ALAudioContext","isExtensionPresent",0x512909cd,"lime.media.ALAudioContext.isExtensionPresent","lime/media/ALAudioContext.hx",462,0x07c77c95)
            	HX_STACK_THIS(this)
...
Bool ALAudioContext_obj::isSource( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","isSource",0x021cbe2c,"lime.media.ALAudioContext.isSource","lime/media/ALAudioContext.hx",469,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
void ALAudioContext_obj::listener3f(Int param,Float value1,Float value2,Float value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listener3f",0x9920e3ce,"lime.media.ALAudioContext.listener3f","lime/media/ALAudioContext.hx",476,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value1,"value1")
            	HX_STACK_ARG(value2,"value2")
...
void ALAudioContext_obj::listener3i(Int param,Int value1,Int value2,Int value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listener3i",0x9920e3d1,"lime.media.ALAudioContext.listener3i","lime/media/ALAudioContext.hx",483,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value1,"value1")
            	HX_STACK_ARG(value2,"value2")
...
void ALAudioContext_obj::listenerf(Int param,Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listenerf",0x0d5081cb,"lime.media.ALAudioContext.listenerf","lime/media/ALAudioContext.hx",490,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::listenerfv(Int param,::Array< Float > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listenerfv",0x9921104b,"lime.media.ALAudioContext.listenerfv","lime/media/ALAudioContext.hx",497,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(values,"values")
...
void ALAudioContext_obj::listeneri(Int param,Int value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listeneri",0x0d5081ce,"lime.media.ALAudioContext.listeneri","lime/media/ALAudioContext.hx",504,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::listeneriv(Int param,::Array< Int > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","listeneriv",0x992112e8,"lime.media.ALAudioContext.listeneriv","lime/media/ALAudioContext.hx",511,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(values,"values")
...
void ALAudioContext_obj::source3f( ::Dynamic source,Int param,Float value1,Float value2,Float value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","source3f",0xde257c35,"lime.media.ALAudioContext.source3f","lime/media/ALAudioContext.hx",518,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value1,"value1")
...
void ALAudioContext_obj::source3i( ::Dynamic source,Int param,Int value1,Int value2,Int value3){
            	HX_STACK_FRAME("lime.media.ALAudioContext","source3i",0xde257c38,"lime.media.ALAudioContext.source3i","lime/media/ALAudioContext.hx",525,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value1,"value1")
...
void ALAudioContext_obj::sourcef( ::Dynamic source,Int param,Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcef",0xc4273344,"lime.media.ALAudioContext.sourcef","lime/media/ALAudioContext.hx",532,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::sourcefv( ::Dynamic source,Int param,::Array< Float > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcefv",0xde25a8b2,"lime.media.ALAudioContext.sourcefv","lime/media/ALAudioContext.hx",539,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(values,"values")
...
void ALAudioContext_obj::sourcei( ::Dynamic source,Int param, ::Dynamic value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcei",0xc4273347,"lime.media.ALAudioContext.sourcei","lime/media/ALAudioContext.hx",546,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(value,"value")
...
void ALAudioContext_obj::sourceiv( ::Dynamic source,Int param,::Array< Int > values){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceiv",0xde25ab4f,"lime.media.ALAudioContext.sourceiv","lime/media/ALAudioContext.hx",553,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(values,"values")
...
void ALAudioContext_obj::sourcePlay( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcePlay",0xe2d4c5f6,"lime.media.ALAudioContext.sourcePlay","lime/media/ALAudioContext.hx",560,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
void ALAudioContext_obj::sourcePlayv(::cpp::VirtualArray sources){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcePlayv",0x975871c0,"lime.media.ALAudioContext.sourcePlayv","lime/media/ALAudioContext.hx",567,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sources,"sources")
...
void ALAudioContext_obj::sourceStop( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceStop",0xe4d68804,"lime.media.ALAudioContext.sourceStop","lime/media/ALAudioContext.hx",574,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
void ALAudioContext_obj::sourceStopv(::cpp::VirtualArray sources){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceStopv",0x56e07bf2,"lime.media.ALAudioContext.sourceStopv","lime/media/ALAudioContext.hx",581,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sources,"sources")
...
void ALAudioContext_obj::sourceRewind( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceRewind",0xa972467d,"lime.media.ALAudioContext.sourceRewind","lime/media/ALAudioContext.hx",588,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
void ALAudioContext_obj::sourceRewindv(::cpp::VirtualArray sources){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceRewindv",0x9a8b6759,"lime.media.ALAudioContext.sourceRewindv","lime/media/ALAudioContext.hx",595,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sources,"sources")
...
void ALAudioContext_obj::sourcePause( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcePause",0x902240b4,"lime.media.ALAudioContext.sourcePause","lime/media/ALAudioContext.hx",602,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
void ALAudioContext_obj::sourcePausev(::cpp::VirtualArray sources){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourcePausev",0x8dd65d42,"lime.media.ALAudioContext.sourcePausev","lime/media/ALAudioContext.hx",609,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sources,"sources")
...
void ALAudioContext_obj::sourceQueueBuffer( ::Dynamic source, ::Dynamic buffer){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceQueueBuffer",0xbf910daf,"lime.media.ALAudioContext.sourceQueueBuffer","lime/media/ALAudioContext.hx",616,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(buffer,"buffer")
...
void ALAudioContext_obj::sourceQueueBuffers( ::Dynamic source,Int nb,::cpp::VirtualArray buffers){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceQueueBuffers",0xdf5aebe4,"lime.media.ALAudioContext.sourceQueueBuffers","lime/media/ALAudioContext.hx",623,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(nb,"nb")
            	HX_STACK_ARG(buffers,"buffers")
...
Int ALAudioContext_obj::sourceUnqueueBuffer( ::Dynamic source){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceUnqueueBuffer",0xefe58f76,"lime.media.ALAudioContext.sourceUnqueueBuffer","lime/media/ALAudioContext.hx",630,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
...
::cpp::VirtualArray ALAudioContext_obj::sourceUnqueueBuffers( ::Dynamic source,Int nb){
            	HX_STACK_FRAME("lime.media.ALAudioContext","sourceUnqueueBuffers",0xf8f7f83d,"lime.media.ALAudioContext.sourceUnqueueBuffers","lime/media/ALAudioContext.hx",637,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(nb,"nb")
...
void ALAudioContext_obj::speedOfSound(Float value){
            	HX_STACK_FRAME("lime.media.ALAudioContext","speedOfSound",0xb26d48b8,"lime.media.ALAudioContext.speedOfSound","lime/media/ALAudioContext.hx",644,0x07c77c95)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
