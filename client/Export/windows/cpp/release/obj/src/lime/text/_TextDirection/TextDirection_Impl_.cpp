...
HXLINE(  22)		hx::XorEq(this1,(int)1);
            	}
...
{
{
            	HX_STACK_FRAME("lime.text._TextDirection.TextDirection_Impl_","boot",0x169dca61,"lime.text._TextDirection.TextDirection_Impl_.boot","lime/text/TextDirection.hx",7,0x7a217b74)
HXLINE(   7)		INVALID = (int)0;
            	}
{
            	HX_STACK_FRAME("lime.text._TextDirection.TextDirection_Impl_","boot",0x169dca61,"lime.text._TextDirection.TextDirection_Impl_.boot","lime/text/TextDirection.hx",8,0x7a217b74)
HXLINE(   8)		LEFT_TO_RIGHT = (int)4;
            	}
{
            	HX_STACK_FRAME("lime.text._TextDirection.TextDirection_Impl_","boot",0x169dca61,"lime.text._TextDirection.TextDirection_Impl_.boot","lime/text/TextDirection.hx",9,0x7a217b74)
HXLINE(   9)		RIGHT_TO_LEFT = (int)5;
            	}
{
            	HX_STACK_FRAME("lime.text._TextDirection.TextDirection_Impl_","boot",0x169dca61,"lime.text._TextDirection.TextDirection_Impl_.boot","lime/text/TextDirection.hx",10,0x7a217b74)
HXLINE(  10)		TOP_TO_BOTTOM = (int)6;
            	}
{
            	HX_STACK_FRAME("lime.text._TextDirection.TextDirection_Impl_","boot",0x169dca61,"lime.text._TextDirection.TextDirection_Impl_.boot","lime/text/TextDirection.hx",11,0x7a217b74)
