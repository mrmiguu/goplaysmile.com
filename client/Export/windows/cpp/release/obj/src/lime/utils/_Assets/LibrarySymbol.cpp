...
void LibrarySymbol_obj::__construct(::String id){
            	HX_STACK_FRAME("lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",603,0x95055f23)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACK_FRAME("lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",613,0x95055f23)
            	HX_STACK_THIS(this)
...
Bool LibrarySymbol_obj::exists(::String type){
            	HX_STACK_FRAME("lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",614,0x95055f23)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
