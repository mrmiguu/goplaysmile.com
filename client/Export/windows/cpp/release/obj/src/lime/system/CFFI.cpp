...
void CFFI_obj::__init__(){
            	HX_STACK_FRAME("::lime::_hx_system::CFFI_obj","__init__",0xd08dc78c,"::lime::_hx_system::CFFI_obj.__init__","lime/system/CFFI.hx",31,0x441ad672)
...
HXLINE(  75)		Bool _hx_tmp = !(::lime::_hx_system::CFFI_obj::enabled);
HXDLIN(  75)		if (_hx_tmp) {
            			HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            			 ::Dynamic _hx_run(::cpp::VirtualArray _hx___){
            				HX_STACK_FRAME("lime.system.CFFI","load",0x60b2e828,"lime.system.CFFI.load","lime/system/CFFI.hx",77,0x441ad672)
...
HXLINE(  86)		Bool _hx_tmp1 = hx::IsNull( ::lime::_hx_system::CFFI_obj::_hx___moduleNames );
HXDLIN(  86)		if (_hx_tmp1) {
HXLINE(  86)			::lime::_hx_system::CFFI_obj::_hx___moduleNames =  ::haxe::ds::StringMap_obj::__new();
            		}
HXLINE(  88)		if (lazy) {
...
HXLINE( 109)			Bool _hx_tmp2 = ::lime::_hx_system::CFFI_obj::_hx___moduleNames->exists(library);
...
HXLINE( 143)			Bool _hx_tmp3 = hx::IsNull( result );
...
HXLINE( 149)			Bool _hx_tmp4 = hx::IsNull( result );
HXDLIN( 149)			if (_hx_tmp4) {
HXLINE( 151)				result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(library,library,method,args);
            			}
HXLINE( 155)			Bool _hx_tmp5 = hx::IsNull( result );
HXDLIN( 155)			if (_hx_tmp5) {
HXLINE( 157)				HX_VAR( ::String,slash);
HXDLIN( 157)				::String _hx_tmp6 = ::lime::_hx_system::CFFI_obj::_hx___sysName().substr((int)7,null()).toLowerCase();
HXDLIN( 157)				if ((_hx_tmp6 == HX_("windows",83,de,74,e8))) {
...
HXLINE( 162)					::String _hx_tmp7 = (((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash);
HXDLIN( 162)					::String _hx_tmp8 = ::lime::_hx_system::CFFI_obj::_hx___sysName();
HXDLIN( 162)					result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((((_hx_tmp7 + _hx_tmp8) + slash) + library),library,method,args);
HXLINE( 164)					Bool _hx_tmp9 = hx::IsNull( result );
HXDLIN( 164)					if (_hx_tmp9) {
HXLINE( 166)						::String _hx_tmp10 = (((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash);
HXDLIN( 166)						::String _hx_tmp11 = ::lime::_hx_system::CFFI_obj::_hx___sysName();
HXDLIN( 166)						result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(((((_hx_tmp10 + _hx_tmp11) + HX_("64",3e,2f,00,00)) + slash) + library),library,method,args);
            					}
            				}
            			}
HXLINE( 174)			::String _hx_tmp12 = ::Std_obj::string(result);
HXDLIN( 174)			::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Result : ",e9,19,2c,14) + _hx_tmp12));
            		}
...
::String CFFI_obj::_hx___findHaxelib(::String library){
            	HX_STACK_FRAME("lime.system.CFFI","__findHaxelib",0xf1a39a44,"lime.system.CFFI.__findHaxelib","lime/system/CFFI.hx",217,0x441ad672)
            	HX_STACK_ARG(library,"library")
HXLINE( 221)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 223)			HX_VARI(  ::sys::io::Process,proc) =  ::sys::io::Process_obj::__new(HX_("haxelib",df,b6,80,08),::Array_obj< ::String >::__new(2)->init(0,HX_("path",a5,e5,51,4a))->init(1,library));
HXLINE( 225)			Bool _hx_tmp = hx::IsNotNull( proc );
...
HXLINE( 235)						::String _hx_tmp1 = s.substr((int)0,(int)1);
HXDLIN( 235)						if ((_hx_tmp1 != HX_("-",2d,00,00,00))) {
...
void CFFI_obj::_hx___loaderTrace(::String message){
            	HX_STACK_FRAME("lime.system.CFFI","__loaderTrace",0x9278b410,"lime.system.CFFI.__loaderTrace","lime/system/CFFI.hx",262,0x441ad672)
            	HX_STACK_ARG(message,"message")
HXLINE( 266)		HX_VARI(  ::Dynamic,get_env) = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("get_env",84,cc,c1,26),(int)1);
HXLINE( 267)		 ::Dynamic _hx_tmp = get_env(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b));
HXDLIN( 267)		HX_VARI( Bool,debug) = hx::IsNotNull( _hx_tmp );
HXLINE( 272)		if (debug) {
...
::String CFFI_obj::_hx___sysName(){
            	HX_STACK_FRAME("lime.system.CFFI","__sysName",0x178f5196,"lime.system.CFFI.__sysName","lime/system/CFFI.hx",320,0x441ad672)
HXLINE( 324)		HX_VARI(  ::Dynamic,sys_string) = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),(int)0);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CFFI_obj,_hx___sysName,return )
 ...
 ::Dynamic CFFI_obj::_hx___tryLoad(::String name,::String library,::String func,Int args){
            	HX_STACK_FRAME("lime.system.CFFI","__tryLoad",0xe7c4e49f,"lime.system.CFFI.__tryLoad","lime/system/CFFI.hx",336,0x441ad672)
...
HXLINE( 354)			Bool _hx_tmp = hx::IsNotNull( result );
...
{
{
            	HX_STACK_FRAME("lime.system.CFFI","boot",0x5a16d234,"lime.system.CFFI.boot","lime/system/CFFI.hx",19,0x441ad672)
