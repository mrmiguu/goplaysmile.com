...
void ALCAudioContext_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		this->ALL_DEVICES_SPECIFIER = (int)4115;
HXLINE(  31)		this->DEFAULT_ALL_DEVICES_SPECIFIER = (int)4114;
HXLINE(  30)		this->ENUMERATE_ALL_EXT = (int)1;
HXLINE(  29)		this->EXTENSIONS = (int)4102;
HXLINE(  28)		this->DEVICE_SPECIFIER = (int)4101;
HXLINE(  27)		this->DEFAULT_DEVICE_SPECIFIER = (int)4100;
HXLINE(  26)		this->ALL_ATTRIBUTES = (int)4099;
HXLINE(  25)		this->ATTRIBUTES_SIZE = (int)4098;
HXLINE(  24)		this->OUT_OF_MEMORY = (int)40965;
HXLINE(  23)		this->INVALID_VALUE = (int)40964;
HXLINE(  22)		this->INVALID_ENUM = (int)40963;
HXLINE(  21)		this->INVALID_CONTEXT = (int)40962;
HXLINE(  20)		this->INVALID_DEVICE = (int)40961;
HXLINE(  19)		this->NO_ERROR = (int)0;
HXLINE(  18)		this->STEREO_SOURCES = (int)4113;
HXLINE(  17)		this->MONO_SOURCES = (int)4112;
HXLINE(  16)		this->SYNC = (int)4105;
HXLINE(  15)		this->REFRESH = (int)4104;
HXLINE(  14)		this->FREQUENCY = (int)4103;
...
HXLINE(  44)		return ::lime::audio::openal::ALC_obj::closeDevice(device);
            	}
...
HXLINE(  51)		return ::lime::audio::openal::ALC_obj::createContext(device,attrlist);
            	}
...
HXLINE(  58)		::lime::audio::openal::ALC_obj::destroyContext(context);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,destroyContext,(void))
 ...
 ::Dynamic ALCAudioContext_obj::getContextsDevice( ::Dynamic context){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
HXLINE(  65)		return ::lime::audio::openal::ALC_obj::getContextsDevice(context);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,getContextsDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::getCurrentContext(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  72)		return ::lime::audio::openal::ALC_obj::getCurrentContext();
            	}
...
Int ALCAudioContext_obj::getError( ::Dynamic device){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
HXLINE(  79)		return ::lime::audio::openal::ALC_obj::getError(device);
            	}
...
::String ALCAudioContext_obj::getErrorString( ::Dynamic device){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
HXLINE(  86)		return ::lime::audio::openal::ALC_obj::getErrorString(device);
            	}
...
HXLINE(  93)		return ::lime::audio::openal::ALC_obj::getIntegerv(device,param,count);
            	}
...
::String ALCAudioContext_obj::getString( ::Dynamic device,Int param){
            	...
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
HXLINE( 100)		return ::lime::audio::openal::ALC_obj::getString(device,param);
            	}
...
Bool ALCAudioContext_obj::makeContextCurrent( ::Dynamic context){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
HXLINE( 107)		return ::lime::audio::openal::ALC_obj::makeContextCurrent(context);
            	}
...
HXLINE( 114)		return ::lime::audio::openal::ALC_obj::openDevice(deviceName);
            	}
...
void ALCAudioContext_obj::pauseDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.audio.ALCAudioContext","pauseDevice",0x5b995bde,"lime.audio.ALCAudioContext.pauseDevice","lime/audio/ALCAudioContext.hx",121,0x89fdd0e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
HXLINE( 121)		::lime::audio::openal::ALC_obj::pauseDevice(device);
            	}
...
void ALCAudioContext_obj::processContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.audio.ALCAudioContext","processContext",0x44a59ace,"lime.audio.ALCAudioContext.processContext","lime/audio/ALCAudioContext.hx",128,0x89fdd0e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
HXLINE( 128)		::lime::audio::openal::ALC_obj::processContext(context);
            	}
...
void ALCAudioContext_obj::resumeDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.audio.ALCAudioContext","resumeDevice",0xa9bade31,"lime.audio.ALCAudioContext.resumeDevice","lime/audio/ALCAudioContext.hx",135,0x89fdd0e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
HXLINE( 135)		::lime::audio::openal::ALC_obj::resumeDevice(device);
            	}
...
void ALCAudioContext_obj::suspendContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.audio.ALCAudioContext","suspendContext",0x778c7961,"lime.audio.ALCAudioContext.suspendContext","lime/audio/ALCAudioContext.hx",142,0x89fdd0e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
HXLINE( 142)		::lime::audio::openal::ALC_obj::suspendContext(context);
            	}
