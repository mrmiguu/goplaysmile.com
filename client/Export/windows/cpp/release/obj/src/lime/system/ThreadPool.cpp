...
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_69_queue,"lime.system.ThreadPool","queue",0xd03ecc0f,"lime.system.ThreadPool.queue","lime/system/ThreadPool.hx",69,0x8993fbb2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_112_sendError,"lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",112,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_123_sendProgress,"lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",123,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_135___doWork,"lime.system.ThreadPool","__doWork",0xcfdf765e,"lime.system.ThreadPool.__doWork","lime/system/ThreadPool.hx",135,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_156___update,"lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",156,0x8993fbb2)
namespace lime{
...
HXLINE(  36)		this->_hx___workResult =  ::cpp::vm::Deque_obj::__alloc( HX_CTX );
HXLINE(  34)		this->_hx___workIncoming =  ::cpp::vm::Deque_obj::__alloc( HX_CTX );
...
HXLINE(  42)		this->minThreads = minThreads;
HXLINE(  43)		this->maxThreads = maxThreads;
HXLINE(  45)		this->currentThreads = (int)0;
HXLINE(  48)		this->_hx___workQueued = (int)0;
HXLINE(  49)		this->_hx___workCompleted = (int)0;
            	}
...
void ThreadPool_obj::queue( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_69_queue)
HXLINE(  73)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workIncoming;
HXDLIN(  73)		_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE(  74)		this->_hx___workQueued++;
HXLINE(  76)		bool _hx_tmp1;
HXDLIN(  76)		if ((this->currentThreads < this->maxThreads)) {
HXLINE(  76)			int _hx_tmp2 = this->currentThreads;
HXDLIN(  76)			_hx_tmp1 = (_hx_tmp2 < (this->_hx___workQueued - this->_hx___workCompleted));
            		}
            		else {
HXLINE(  76)			_hx_tmp1 = false;
            		}
HXDLIN(  76)		if (_hx_tmp1) {
HXLINE(  78)			this->currentThreads++;
HXLINE(  79)			::cpp::vm::Thread_obj::create(this->_hx___doWork_dyn());
            		}
HXLINE(  83)		if (!(::lime::app::Application_obj::current->onUpdate->has(this->_hx___update_dyn()))) {
HXLINE(  85)			::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            		}
            	}
...
HXLINE( 101)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 101)		_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_112_sendError)
HXLINE( 112)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 112)		_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_123_sendProgress)
HXLINE( 123)		 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 123)		_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
            	}
...
void ThreadPool_obj::_hx___doWork(){
            	HX_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_135___doWork)
HXLINE( 135)		while(true){
HXLINE( 137)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workIncoming->pop(true).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 139)			if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn() )) {
HXLINE( 141)				this->doWork->dispatch(message->state);
            			}
            			else {
HXLINE( 143)				if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn() )) {
...
void ThreadPool_obj::_hx___update(int deltaTime){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_156___update)
HXLINE( 156)		if ((this->_hx___workQueued > this->_hx___workCompleted)) {
HXLINE( 158)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 160)			while(hx::IsNotNull( message )){
HXLINE( 162)				{
HXLINE( 162)					 ::lime::_hx_system::_ThreadPool::ThreadPoolMessageType _g = message->type;
HXDLIN( 162)					switch((int)(_hx_getEnumValueIndex(_g))){
            						case (int)0: case (int)1: {
HXLINE( 170)							this->_hx___workCompleted++;
HXLINE( 172)							bool _hx_tmp;
HXDLIN( 172)							int _hx_tmp1 = this->currentThreads;
HXDLIN( 172)							if ((_hx_tmp1 <= (this->_hx___workQueued - this->_hx___workCompleted))) {
HXLINE( 172)								_hx_tmp = (this->currentThreads > this->maxThreads);
            							}
            							else {
HXLINE( 172)								_hx_tmp = true;
            							}
HXDLIN( 172)							if (_hx_tmp) {
HXLINE( 174)								this->currentThreads--;
HXLINE( 175)								 ::cpp::vm::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN( 175)								_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
HXLINE( 179)							if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn() )) {
HXLINE( 181)								this->onComplete->dispatch(message->state);
            							}
            							else {
HXLINE( 185)								this->onError->dispatch(message->state);
            							}
            						}
            						break;
            						case (int)3: {
HXLINE( 166)							this->onProgress->dispatch(message->state);
            						}
            						break;
            						default:{
            						}
...
HXLINE( 193)				message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
            			}
            		}
            		else {
HXLINE( 201)			bool _hx_tmp3;
HXDLIN( 201)			if ((this->currentThreads == (int)0)) {
HXLINE( 201)				_hx_tmp3 = (this->minThreads <= (int)0);
            			}
            			else {
