...
Int maxThreads = __o_maxThreads.Default(1);
            	HX_STACK_FRAME("lime.system.ThreadPool","new",0xfea2d35e,"lime.system.ThreadPool.new","lime/system/ThreadPool.hx",21,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(minThreads,"minThreads")
            	HX_STACK_ARG(maxThreads,"maxThreads")
HXLINE(  36)		this->_hx___workResult =  ::cpp::vm::Deque_obj::__new();
HXLINE(  34)		this->_hx___workIncoming =  ::cpp::vm::Deque_obj::__new();
HXLINE(  30)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  29)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  28)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  25)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__new();
...
hx::ObjectPtr< ThreadPool_obj > ThreadPool_obj::__new(hx::Null< Int >  __o_minThreads,hx::Null< Int >  __o_maxThreads)
{
	...
	_hx_result->__construct(__o_minThreads,__o_maxThreads);
	return _hx_result;
}
...
void ThreadPool_obj::queue( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","queue",0xd03ecc0f,"lime.system.ThreadPool.queue","lime/system/ThreadPool.hx",69,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE(  73)		this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
...
HXLINE(  83)		Bool _hx_tmp1 = !(::lime::app::Application_obj::current->onUpdate->has(this->_hx___update_dyn()));
...
void ThreadPool_obj::sendComplete( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendComplete",0x5f287f63,"lime.system.ThreadPool.sendComplete","lime/system/ThreadPool.hx",101,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 101)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",112,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 112)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",123,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 123)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
            	}
...
void ThreadPool_obj::_hx___doWork(){
            	HX_STACK_FRAME("lime.system.ThreadPool","__doWork",0xcfdf765e,"lime.system.ThreadPool.__doWork","lime/system/ThreadPool.hx",135,0x8993fbb2)
            	HX_STACK_THIS(this)
...
void ThreadPool_obj::_hx___update(Int deltaTime){
            	HX_STACK_FRAME("lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",156,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 156)		Bool _hx_tmp = (this->_hx___workQueued > this->_hx___workCompleted);
...
HXLINE( 160)				Bool _hx_tmp1 = !(hx::IsNotNull( message ));
HXDLIN( 160)				if (_hx_tmp1) {
HXLINE( 160)					goto _hx_goto_1;
            				}
HXLINE( 162)				{
HXLINE( 162)					Int _hx_tmp2 = ( ( ::hx::EnumBase)(message->type) )->_hx_getIndex();
HXDLIN( 162)					switch((int)(_hx_tmp2)){
...
HXLINE( 172)								_hx_tmp3 = (this->currentThreads > this->maxThreads);
            							}
            							else {
...
HXLINE( 175)								this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
...
HXLINE( 201)			Bool _hx_tmp4;
HXDLIN( 201)			if ((this->currentThreads == (int)0)) {
HXLINE( 201)				_hx_tmp4 = (this->minThreads <= (int)0);
            			}
            			else {
