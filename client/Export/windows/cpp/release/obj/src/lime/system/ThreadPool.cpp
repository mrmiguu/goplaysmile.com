...
HXLINE(  31)		this->_hx___workResult =  ::cpp::vm::Deque_obj::__new();
HXLINE(  29)		this->_hx___workIncoming =  ::cpp::vm::Deque_obj::__new();
HXLINE(  25)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  24)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  23)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  20)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__new();
...
HXLINE(  68)		this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
...
HXLINE(  78)		Bool _hx_tmp1 = !(::lime::app::Application_obj::current->onUpdate->has(this->_hx___update_dyn()));
...
void ThreadPool_obj::sendComplete( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendComplete",0x5f287f63,"lime.system.ThreadPool.sendComplete","lime/system/ThreadPool.hx",96,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE(  96)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",107,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 107)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	HX_STACK_FRAME("lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",118,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 118)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
            	}
...
void ThreadPool_obj::_hx___update(Int deltaTime){
            	HX_STACK_FRAME("lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",151,0x8993fbb2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 151)		Bool _hx_tmp = (this->_hx___workQueued > this->_hx___workCompleted);
...
HXLINE( 155)				Bool _hx_tmp1 = !(hx::IsNotNull( message ));
HXDLIN( 155)				if (_hx_tmp1) {
HXLINE( 155)					goto _hx_goto_1;
            				}
HXLINE( 157)				{
HXLINE( 157)					Int _hx_tmp2 = ( ( ::hx::EnumBase)(message->type) )->_hx_getIndex();
...
HXLINE( 167)								_hx_tmp3 = (this->currentThreads > this->maxThreads);
            							}
            							else {
...
HXLINE( 170)								this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__new(::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
...
HXLINE( 196)				_hx_tmp4 = (this->minThreads <= (int)0);
            			}
            			else {
