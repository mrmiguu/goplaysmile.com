...
void NativeGLRenderContext_obj::__construct(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","new",0x501c8638,"lime._backend.native.NativeGLRenderContext.new","lime/_backend/native/NativeGLRenderContext.hx",30,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::activeTexture(Int texture){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","activeTexture",0x2df1878d,"lime._backend.native.NativeGLRenderContext.activeTexture","lime/_backend/native/NativeGLRenderContext.hx",397,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::attachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","attachShader",0x0f459ff2,"lime._backend.native.NativeGLRenderContext.attachShader","lime/_backend/native/NativeGLRenderContext.hx",403,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 406)		program->attach(shader);
HXLINE( 407)		{
HXLINE( 407)			 ::Dynamic program1 = program->id;
HXDLIN( 407)			 ::Dynamic shader1 = shader->id;
HXDLIN( 407)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 407)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_attach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            		}
            	}
...
void NativeGLRenderContext_obj::bindAttribLocation( ::lime::graphics::opengl::GLProgram program,Int index,::String name){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bindAttribLocation",0xed1e4364,"lime._backend.native.NativeGLRenderContext.bindAttribLocation","lime/_backend/native/NativeGLRenderContext.hx",416,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(name,"name")
HXLINE( 416)		 ::Dynamic program1 = program->id;
HXDLIN( 416)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_bind_attrib_location(hx::DynamicPtr(program1),index,name);
            	}
...
void NativeGLRenderContext_obj::bindBuffer(Int target, ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bindBuffer",0x9f36c7c5,"lime._backend.native.NativeGLRenderContext.bindBuffer","lime/_backend/native/NativeGLRenderContext.hx",425,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 425)		 ::Dynamic buffer1;
HXDLIN( 425)		Bool _hx_tmp = hx::IsNull( buffer );
...
void NativeGLRenderContext_obj::bindFramebuffer(Int target, ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bindFramebuffer",0xb64fe008,"lime._backend.native.NativeGLRenderContext.bindFramebuffer","lime/_backend/native/NativeGLRenderContext.hx",434,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 434)		 ::Dynamic framebuffer1;
HXDLIN( 434)		Bool _hx_tmp = hx::IsNull( framebuffer );
...
void NativeGLRenderContext_obj::bindRenderbuffer(Int target, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bindRenderbuffer",0x5620395b,"lime._backend.native.NativeGLRenderContext.bindRenderbuffer","lime/_backend/native/NativeGLRenderContext.hx",443,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 443)		 ::Dynamic renderbuffer1;
HXDLIN( 443)		Bool _hx_tmp = hx::IsNull( renderbuffer );
...
void NativeGLRenderContext_obj::bindTexture(Int target, ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bindTexture",0x9e082a76,"lime._backend.native.NativeGLRenderContext.bindTexture","lime/_backend/native/NativeGLRenderContext.hx",452,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE( 452)		 ::Dynamic texture1;
HXDLIN( 452)		Bool _hx_tmp = hx::IsNull( texture );
...
void NativeGLRenderContext_obj::blendColor(Float red,Float green,Float blue,Float alpha){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","blendColor",0x892c687a,"lime._backend.native.NativeGLRenderContext.blendColor","lime/_backend/native/NativeGLRenderContext.hx",461,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::blendEquation(Int mode){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","blendEquation",0xd9f50cd5,"lime._backend.native.NativeGLRenderContext.blendEquation","lime/_backend/native/NativeGLRenderContext.hx",470,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::blendEquationSeparate(Int modeRGB,Int modeAlpha){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","blendEquationSeparate",0x0b8b4558,"lime._backend.native.NativeGLRenderContext.blendEquationSeparate","lime/_backend/native/NativeGLRenderContext.hx",479,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::blendFunc(Int sfactor,Int dfactor){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","blendFunc",0x2076a40d,"lime._backend.native.NativeGLRenderContext.blendFunc","lime/_backend/native/NativeGLRenderContext.hx",488,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::blendFuncSeparate(Int srcRGB,Int dstRGB,Int srcAlpha,Int dstAlpha){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","blendFuncSeparate",0xc4cad490,"lime._backend.native.NativeGLRenderContext.blendFuncSeparate","lime/_backend/native/NativeGLRenderContext.hx",497,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::bufferData(Int target, ::lime::utils::ArrayBufferView data,Int usage){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bufferData",0x39ebf472,"lime._backend.native.NativeGLRenderContext.bufferData","lime/_backend/native/NativeGLRenderContext.hx",506,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(usage,"usage")
HXLINE( 506)		Int byteOffset = data->byteOffset;
HXDLIN( 506)		Int size = data->byteLength;
HXDLIN( 506)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(data->buffer),byteOffset,size,usage);
            	}
...
void NativeGLRenderContext_obj::bufferSubData(Int target,Int offset, ::lime::utils::ArrayBufferView data){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","bufferSubData",0x1d2c6a82,"lime._backend.native.NativeGLRenderContext.bufferSubData","lime/_backend/native/NativeGLRenderContext.hx",517,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(offset,"offset")
            	HX_STACK_ARG(data,"data")
HXLINE( 517)		Int byteOffset = data->byteOffset;
HXDLIN( 517)		Int size = data->byteLength;
HXDLIN( 517)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(data->buffer),byteOffset,size);
            	}
...
Int NativeGLRenderContext_obj::checkFramebufferStatus(Int target){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","checkFramebufferStatus",0x44fc773f,"lime._backend.native.NativeGLRenderContext.checkFramebufferStatus","lime/_backend/native/NativeGLRenderContext.hx",528,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
HXLINE( 528)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
void NativeGLRenderContext_obj::clear(Int mask){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","clear",0xa41f4d65,"lime._backend.native.NativeGLRenderContext.clear","lime/_backend/native/NativeGLRenderContext.hx",539,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::clearColor(Float red,Float green,Float blue,Float alpha){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","clearColor",0xc5dee5be,"lime._backend.native.NativeGLRenderContext.clearColor","lime/_backend/native/NativeGLRenderContext.hx",548,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(red,"red")
            	HX_STACK_ARG(green,"green")
            	HX_STACK_ARG(blue,"blue")
...
void NativeGLRenderContext_obj::clearDepth(Float depth){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","clearDepth",0x52ac655e,"lime._backend.native.NativeGLRenderContext.clearDepth","lime/_backend/native/NativeGLRenderContext.hx",557,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::clearStencil(Int s){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","clearStencil",0xb8503f17,"lime._backend.native.NativeGLRenderContext.clearStencil","lime/_backend/native/NativeGLRenderContext.hx",566,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
void NativeGLRenderContext_obj::colorMask(Bool red,Bool green,Bool blue,Bool alpha){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","colorMask",0x3c9e73c7,"lime._backend.native.NativeGLRenderContext.colorMask","lime/_backend/native/NativeGLRenderContext.hx",575,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(red,"red")
            	HX_STACK_ARG(green,"green")
            	HX_STACK_ARG(blue,"blue")
...
void NativeGLRenderContext_obj::compileShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","compileShader",0xb1f9e4d0,"lime._backend.native.NativeGLRenderContext.compileShader","lime/_backend/native/NativeGLRenderContext.hx",584,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 584)		 ::Dynamic shader1 = shader->id;
HXDLIN( 584)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_compile_shader(hx::DynamicPtr(shader1));
            	}
...
void NativeGLRenderContext_obj::compressedTexImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::lime::utils::ArrayBufferView data){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","compressedTexImage2D",0xbfcb0fcf,"lime._backend.native.NativeGLRenderContext.compressedTexImage2D","lime/_backend/native/NativeGLRenderContext.hx",590,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
...
HXDLIN( 593)		Bool _hx_tmp = hx::IsNull( data );
...
HXDLIN( 594)			Bool _hx_tmp1 = hx::IsNull( data );
...
void NativeGLRenderContext_obj::compressedTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::lime::utils::ArrayBufferView data){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","compressedTexSubImage2D",0x325d67ab,"lime._backend.native.NativeGLRenderContext.compressedTexSubImage2D","lime/_backend/native/NativeGLRenderContext.hx",602,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(level,"level")
...
HXDLIN( 605)		Bool _hx_tmp = hx::IsNull( data );
...
HXDLIN( 606)			Bool _hx_tmp1 = hx::IsNull( data );
...
void NativeGLRenderContext_obj::copyTexImage2D(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","copyTexImage2D",0x6bb4ba03,"lime._backend.native.NativeGLRenderContext.copyTexImage2D","lime/_backend/native/NativeGLRenderContext.hx",617,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(level,"level")
            	HX_STACK_ARG(internalformat,"internalformat")
...
void NativeGLRenderContext_obj::copyTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","copyTexSubImage2D",0x9eb915f7,"lime._backend.native.NativeGLRenderContext.copyTexSubImage2D","lime/_backend/native/NativeGLRenderContext.hx",626,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(level,"level")
            	HX_STACK_ARG(xoffset,"xoffset")
...
HX_DEFINE_DYNAMIC_FUNC8(NativeGLRenderContext_obj,copyTexSubImage2D,(void))
 ...
 ::lime::graphics::opengl::GLBuffer NativeGLRenderContext_obj::createBuffer(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createBuffer",0x4fb7cc44,"lime._backend.native.NativeGLRenderContext.createBuffer","lime/_backend/native/NativeGLRenderContext.hx",635,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 635)		Int _hx_tmp = this->get_version();
HXDLIN( 635)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_buffer()) );
HXDLIN( 635)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 635)		return  ::lime::graphics::opengl::GLBuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeGLRenderContext_obj,createBuffer,return )
 ...
 ::lime::graphics::opengl::GLFramebuffer NativeGLRenderContext_obj::createFramebuffer(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createFramebuffer",0xc6f32f29,"lime._backend.native.NativeGLRenderContext.createFramebuffer","lime/_backend/native/NativeGLRenderContext.hx",646,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 646)		Int _hx_tmp = this->get_version();
HXDLIN( 646)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_framebuffer()) );
HXDLIN( 646)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 646)		return  ::lime::graphics::opengl::GLFramebuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeGLRenderContext_obj,createFramebuffer,return )
 ...
 ::lime::graphics::opengl::GLProgram NativeGLRenderContext_obj::createProgram(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createProgram",0xb38396c0,"lime._backend.native.NativeGLRenderContext.createProgram","lime/_backend/native/NativeGLRenderContext.hx",657,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 657)		Int _hx_tmp = this->get_version();
HXDLIN( 657)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_program()) );
HXDLIN( 657)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 657)		return  ::lime::graphics::opengl::GLProgram_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeGLRenderContext_obj,createProgram,return )
 ...
 ::lime::graphics::opengl::GLRenderbuffer NativeGLRenderContext_obj::createRenderbuffer(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createRenderbuffer",0xd462271a,"lime._backend.native.NativeGLRenderContext.createRenderbuffer","lime/_backend/native/NativeGLRenderContext.hx",668,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 668)		Int _hx_tmp = this->get_version();
HXDLIN( 668)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_render_buffer()) );
HXDLIN( 668)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 668)		return  ::lime::graphics::opengl::GLRenderbuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeGLRenderContext_obj,createRenderbuffer,return )
 ...
 ::lime::graphics::opengl::GLShader NativeGLRenderContext_obj::createShader(Int type){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createShader",0x9c43ce69,"lime._backend.native.NativeGLRenderContext.createShader","lime/_backend/native/NativeGLRenderContext.hx",679,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 679)		Int _hx_tmp = this->get_version();
HXDLIN( 679)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_shader(type)) );
HXDLIN( 679)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 679)		return  ::lime::graphics::opengl::GLShader_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(NativeGLRenderContext_obj,createShader,return )
 ...
 ::lime::graphics::opengl::GLTexture NativeGLRenderContext_obj::createTexture(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","createTexture",0x5e6b1517,"lime._backend.native.NativeGLRenderContext.createTexture","lime/_backend/native/NativeGLRenderContext.hx",690,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 690)		Int _hx_tmp = this->get_version();
HXDLIN( 690)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_create_texture()) );
HXDLIN( 690)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 690)		return  ::lime::graphics::opengl::GLTexture_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
void NativeGLRenderContext_obj::cullFace(Int mode){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","cullFace",0x1ccf0297,"lime._backend.native.NativeGLRenderContext.cullFace","lime/_backend/native/NativeGLRenderContext.hx",701,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
...
void NativeGLRenderContext_obj::deleteBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteBuffer",0x93fab2b3,"lime._backend.native.NativeGLRenderContext.deleteBuffer","lime/_backend/native/NativeGLRenderContext.hx",707,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 710)		{
HXLINE( 710)			 ::Dynamic buffer1 = buffer->id;
HXDLIN( 710)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_buffer(hx::DynamicPtr(buffer1));
            		}
...
void NativeGLRenderContext_obj::deleteFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteFramebuffer",0x4a0b965a,"lime._backend.native.NativeGLRenderContext.deleteFramebuffer","lime/_backend/native/NativeGLRenderContext.hx",717,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 720)		{
HXLINE( 720)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN( 720)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_framebuffer(hx::DynamicPtr(framebuffer1));
            		}
...
void NativeGLRenderContext_obj::deleteProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteProgram",0x29ca5171,"lime._backend.native.NativeGLRenderContext.deleteProgram","lime/_backend/native/NativeGLRenderContext.hx",727,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 730)		{
HXLINE( 730)			 ::Dynamic program1 = program->id;
HXDLIN( 730)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_program(hx::DynamicPtr(program1));
            		}
...
void NativeGLRenderContext_obj::deleteRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteRenderbuffer",0x06a40ac9,"lime._backend.native.NativeGLRenderContext.deleteRenderbuffer","lime/_backend/native/NativeGLRenderContext.hx",737,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 740)		{
HXLINE( 740)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 740)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_render_buffer(hx::DynamicPtr(renderbuffer1));
            		}
...
void NativeGLRenderContext_obj::deleteShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteShader",0xe086b4d8,"lime._backend.native.NativeGLRenderContext.deleteShader","lime/_backend/native/NativeGLRenderContext.hx",747,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 750)		{
HXLINE( 750)			 ::Dynamic shader1 = shader->id;
HXDLIN( 750)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_shader(hx::DynamicPtr(shader1));
            		}
...
void NativeGLRenderContext_obj::deleteTexture( ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","deleteTexture",0xd4b1cfc8,"lime._backend.native.NativeGLRenderContext.deleteTexture","lime/_backend/native/NativeGLRenderContext.hx",757,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(texture,"texture")
HXLINE( 760)		{
HXLINE( 760)			 ::Dynamic texture1 = texture->id;
HXDLIN( 760)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_delete_texture(hx::DynamicPtr(texture1));
            		}
...
void NativeGLRenderContext_obj::depthFunc(Int func){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","depthFunc",0xb322edbf,"lime._backend.native.NativeGLRenderContext.depthFunc","lime/_backend/native/NativeGLRenderContext.hx",770,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::depthMask(Bool flag){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","depthMask",0xb7b44367,"lime._backend.native.NativeGLRenderContext.depthMask","lime/_backend/native/NativeGLRenderContext.hx",779,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::depthRange(Float zNear,Float zFar){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","depthRange",0xe703cee2,"lime._backend.native.NativeGLRenderContext.depthRange","lime/_backend/native/NativeGLRenderContext.hx",788,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::detachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","detachShader",0x477ba000,"lime._backend.native.NativeGLRenderContext.detachShader","lime/_backend/native/NativeGLRenderContext.hx",797,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 797)		 ::Dynamic program1 = program->id;
HXDLIN( 797)		 ::Dynamic shader1 = shader->id;
HXDLIN( 797)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 797)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_detach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            	}
...
void NativeGLRenderContext_obj::disable(Int cap){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","disable",0x6aacebc0,"lime._backend.native.NativeGLRenderContext.disable","lime/_backend/native/NativeGLRenderContext.hx",806,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::disableVertexAttribArray(Int index){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","disableVertexAttribArray",0xb250550b,"lime._backend.native.NativeGLRenderContext.disableVertexAttribArray","lime/_backend/native/NativeGLRenderContext.hx",815,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
void NativeGLRenderContext_obj::drawArrays(Int mode,Int first,Int count){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","drawArrays",0xa02c2906,"lime._backend.native.NativeGLRenderContext.drawArrays","lime/_backend/native/NativeGLRenderContext.hx",824,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
...
void NativeGLRenderContext_obj::drawElements(Int mode,Int count,Int type,Int offset){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","drawElements",0xb6859183,"lime._backend.native.NativeGLRenderContext.drawElements","lime/_backend/native/NativeGLRenderContext.hx",833,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
            	HX_STACK_ARG(count,"count")
            	HX_STACK_ARG(type,"type")
...
void NativeGLRenderContext_obj::enable(Int cap){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","enable",0xe8242fab,"lime._backend.native.NativeGLRenderContext.enable","lime/_backend/native/NativeGLRenderContext.hx",842,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cap,"cap")
...
void NativeGLRenderContext_obj::enableVertexAttribArray(Int index){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","enableVertexAttribArray",0xa839f8c0,"lime._backend.native.NativeGLRenderContext.enableVertexAttribArray","lime/_backend/native/NativeGLRenderContext.hx",851,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
void NativeGLRenderContext_obj::finish(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","finish",0x761bc17b,"lime._backend.native.NativeGLRenderContext.finish","lime/_backend/native/NativeGLRenderContext.hx",860,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::flush(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","flush",0x5e5f3e9c,"lime._backend.native.NativeGLRenderContext.flush","lime/_backend/native/NativeGLRenderContext.hx",869,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::framebufferRenderbuffer(Int target,Int attachment,Int renderbuffertarget, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","framebufferRenderbuffer",0x32928f3b,"lime._backend.native.NativeGLRenderContext.framebufferRenderbuffer","lime/_backend/native/NativeGLRenderContext.hx",878,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(renderbuffertarget,"renderbuffertarget")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 878)		 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 878)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,hx::DynamicPtr(renderbuffer1));
            	}
...
void NativeGLRenderContext_obj::framebufferTexture2D(Int target,Int attachment,Int textarget, ::lime::graphics::opengl::GLTexture texture,Int level){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","framebufferTexture2D",0xbf8f9de8,"lime._backend.native.NativeGLRenderContext.framebufferTexture2D","lime/_backend/native/NativeGLRenderContext.hx",887,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(attachment,"attachment")
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE( 887)		 ::Dynamic texture1 = texture->id;
HXDLIN( 887)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,hx::DynamicPtr(texture1),level);
            	}
...
void NativeGLRenderContext_obj::frontFace(Int mode){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","frontFace",0x999ba9be,"lime._backend.native.NativeGLRenderContext.frontFace","lime/_backend/native/NativeGLRenderContext.hx",896,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
...
void NativeGLRenderContext_obj::generateMipmap(Int target){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","generateMipmap",0xe24bbfc5,"lime._backend.native.NativeGLRenderContext.generateMipmap","lime/_backend/native/NativeGLRenderContext.hx",905,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
...
HX_DEFINE_DYNAMIC_FUNC1(NativeGLRenderContext_obj,generateMipmap,(void))
 ...
 ::Dynamic NativeGLRenderContext_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,Int index){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getActiveAttrib",0x3210a53e,"lime._backend.native.NativeGLRenderContext.getActiveAttrib","lime/_backend/native/NativeGLRenderContext.hx",911,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 914)		 ::Dynamic program1 = program->id;
HXDLIN( 914)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_active_attrib(hx::DynamicPtr(program1),index)) );
HXDLIN( 914)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 915)		return result;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(NativeGLRenderContext_obj,getActiveAttrib,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,Int index){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getActiveUniform",0x18b6b8c0,"lime._backend.native.NativeGLRenderContext.getActiveUniform","lime/_backend/native/NativeGLRenderContext.hx",923,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 926)		 ::Dynamic program1 = program->id;
HXDLIN( 926)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_active_uniform(hx::DynamicPtr(program1),index)) );
HXDLIN( 926)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 927)		return result;
            	}
...
::Array< ::Dynamic> NativeGLRenderContext_obj::getAttachedShaders( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getAttachedShaders",0x6264cbdc,"lime._backend.native.NativeGLRenderContext.getAttachedShaders","lime/_backend/native/NativeGLRenderContext.hx",938,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
...
Int NativeGLRenderContext_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getAttribLocation",0x571a5aad,"lime._backend.native.NativeGLRenderContext.getAttribLocation","lime/_backend/native/NativeGLRenderContext.hx",949,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE( 949)		 ::Dynamic program1 = program->id;
HXDLIN( 949)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_attrib_location(hx::DynamicPtr(program1),name)) );
            	}
...
Int NativeGLRenderContext_obj::getBufferParameter(Int target,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getBufferParameter",0xe3a1f5bb,"lime._backend.native.NativeGLRenderContext.getBufferParameter","lime/_backend/native/NativeGLRenderContext.hx",960,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 960)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(NativeGLRenderContext_obj,getBufferParameter,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getContextAttributes(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getContextAttributes",0x494f1158,"lime._backend.native.NativeGLRenderContext.getContextAttributes","lime/_backend/native/NativeGLRenderContext.hx",968,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 971)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_context_attributes()) );
HXDLIN( 971)		HX_VARI(  ::Dynamic,base) = Dynamic(hx::DynamicPtr(inVal));
...
Int NativeGLRenderContext_obj::getError(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getError",0x439df67a,"lime._backend.native.NativeGLRenderContext.getError","lime/_backend/native/NativeGLRenderContext.hx",985,0x396c0759)
            	HX_STACK_THIS(this)
HXLINE( 985)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_error()) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeGLRenderContext_obj,getError,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getExtension(::String name){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getExtension",0x5134ff31,"lime._backend.native.NativeGLRenderContext.getExtension","lime/_backend/native/NativeGLRenderContext.hx",999,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 999)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_extension(name)) );
HXDLIN( 999)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int NativeGLRenderContext_obj::getFramebufferAttachmentParameter(Int target,Int attachment,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getFramebufferAttachmentParameter",0xabff2f67,"lime._backend.native.NativeGLRenderContext.getFramebufferAttachmentParameter","lime/_backend/native/NativeGLRenderContext.hx",1010,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1010)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(NativeGLRenderContext_obj,getFramebufferAttachmentParameter,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getParameter(Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getParameter",0xb4d4a15b,"lime._backend.native.NativeGLRenderContext.getParameter","lime/_backend/native/NativeGLRenderContext.hx",1021,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pname,"pname")
HXLINE(1021)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_parameter(pname)) );
HXDLIN(1021)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String NativeGLRenderContext_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getProgramInfoLog",0xc7fd31a0,"lime._backend.native.NativeGLRenderContext.getProgramInfoLog","lime/_backend/native/NativeGLRenderContext.hx",1032,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1032)		 ::Dynamic program1 = program->id;
HXDLIN(1032)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_program_info_log(hx::DynamicPtr(program1))) );
HXDLIN(1032)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int NativeGLRenderContext_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getProgramParameter",0xd798a913,"lime._backend.native.NativeGLRenderContext.getProgramParameter","lime/_backend/native/NativeGLRenderContext.hx",1043,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1043)		 ::Dynamic program1 = program->id;
HXDLIN(1043)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_program_parameter(hx::DynamicPtr(program1),pname)) );
            	}
...
Int NativeGLRenderContext_obj::getRenderbufferParameter(Int target,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getRenderbufferParameter",0xa4b3aca5,"lime._backend.native.NativeGLRenderContext.getRenderbufferParameter","lime/_backend/native/NativeGLRenderContext.hx",1054,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1054)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String NativeGLRenderContext_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getShaderInfoLog",0x353140c3,"lime._backend.native.NativeGLRenderContext.getShaderInfoLog","lime/_backend/native/NativeGLRenderContext.hx",1065,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1065)		 ::Dynamic shader1 = shader->id;
HXDLIN(1065)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_shader_info_log(hx::DynamicPtr(shader1))) );
HXDLIN(1065)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int NativeGLRenderContext_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getShaderParameter",0x054906f6,"lime._backend.native.NativeGLRenderContext.getShaderParameter","lime/_backend/native/NativeGLRenderContext.hx",1076,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1076)		 ::Dynamic shader1 = shader->id;
HXDLIN(1076)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_shader_parameter(hx::DynamicPtr(shader1),pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(NativeGLRenderContext_obj,getShaderParameter,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getShaderPrecisionFormat(Int shadertype,Int precisiontype){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getShaderPrecisionFormat",0x36aba422,"lime._backend.native.NativeGLRenderContext.getShaderPrecisionFormat","lime/_backend/native/NativeGLRenderContext.hx",1084,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shadertype,"shadertype")
            	HX_STACK_ARG(precisiontype,"precisiontype")
HXLINE(1087)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
HXDLIN(1087)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
...
::String NativeGLRenderContext_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getShaderSource",0x93f2bd6e,"lime._backend.native.NativeGLRenderContext.getShaderSource","lime/_backend/native/NativeGLRenderContext.hx",1099,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1099)		 ::Dynamic shader1 = shader->id;
HXDLIN(1099)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_shader_source(hx::DynamicPtr(shader1))) );
HXDLIN(1099)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::Array< ::String > NativeGLRenderContext_obj::getSupportedExtensions(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getSupportedExtensions",0xdbf4ca14,"lime._backend.native.NativeGLRenderContext.getSupportedExtensions","lime/_backend/native/NativeGLRenderContext.hx",1107,0x396c0759)
            	HX_STACK_THIS(this)
...
Int NativeGLRenderContext_obj::getTexParameter(Int target,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getTexParameter",0xa1c1b250,"lime._backend.native.NativeGLRenderContext.getTexParameter","lime/_backend/native/NativeGLRenderContext.hx",1123,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1123)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(NativeGLRenderContext_obj,getTexParameter,return )
 ...
 ::Dynamic NativeGLRenderContext_obj::getUniform( ::lime::graphics::opengl::GLProgram program,Int location){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getUniform",0xab3dfc66,"lime._backend.native.NativeGLRenderContext.getUniform","lime/_backend/native/NativeGLRenderContext.hx",1134,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(location,"location")
HXLINE(1134)		 ::Dynamic program1 = program->id;
HXDLIN(1134)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_uniform(hx::DynamicPtr(program1),location)) );
HXDLIN(1134)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int NativeGLRenderContext_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getUniformLocation",0x1ec1fcbb,"lime._backend.native.NativeGLRenderContext.getUniformLocation","lime/_backend/native/NativeGLRenderContext.hx",1145,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(1145)		 ::Dynamic program1 = program->id;
HXDLIN(1145)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_uniform_location(hx::DynamicPtr(program1),name)) );
            	}
...
Int NativeGLRenderContext_obj::getVertexAttrib(Int index,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getVertexAttrib",0x720a495c,"lime._backend.native.NativeGLRenderContext.getVertexAttrib","lime/_backend/native/NativeGLRenderContext.hx",1156,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1156)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int NativeGLRenderContext_obj::getVertexAttribOffset(Int index,Int pname){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","getVertexAttribOffset",0xbaf1c20f,"lime._backend.native.NativeGLRenderContext.getVertexAttribOffset","lime/_backend/native/NativeGLRenderContext.hx",1167,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1167)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void NativeGLRenderContext_obj::hint(Int target,Int mode){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","hint",0xc4e4a4af,"lime._backend.native.NativeGLRenderContext.hint","lime/_backend/native/NativeGLRenderContext.hx",1178,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
...
Bool NativeGLRenderContext_obj::isBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isBuffer",0x999b73b2,"lime._backend.native.NativeGLRenderContext.isBuffer","lime/_backend/native/NativeGLRenderContext.hx",1187,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(1187)		Bool _hx_tmp;
HXDLIN(1187)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN(1187)		if (_hx_tmp1) {
HXLINE(1187)			 ::Dynamic a = buffer->id;
HXDLIN(1187)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1187)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1187)			_hx_tmp = false;
            		}
HXDLIN(1187)		if (_hx_tmp) {
HXLINE(1187)			 ::Dynamic buffer1 = buffer->id;
HXDLIN(1187)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_buffer(hx::DynamicPtr(buffer1))) );
            		}
            		else {
...
Bool NativeGLRenderContext_obj::isContextLost(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isContextLost",0x05275381,"lime._backend.native.NativeGLRenderContext.isContextLost","lime/_backend/native/NativeGLRenderContext.hx",1197,0x396c0759)
            	HX_STACK_THIS(this)
...
Bool NativeGLRenderContext_obj::isEnabled(Int cap){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isEnabled",0x9b0a298f,"lime._backend.native.NativeGLRenderContext.isEnabled","lime/_backend/native/NativeGLRenderContext.hx",1205,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cap,"cap")
HXLINE(1205)		return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool NativeGLRenderContext_obj::isFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isFramebuffer",0x5ab3d8fb,"lime._backend.native.NativeGLRenderContext.isFramebuffer","lime/_backend/native/NativeGLRenderContext.hx",1216,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(1216)		Bool _hx_tmp;
HXDLIN(1216)		Bool _hx_tmp1 = hx::IsNotNull( framebuffer );
HXDLIN(1216)		if (_hx_tmp1) {
HXLINE(1216)			 ::Dynamic a = framebuffer->id;
HXDLIN(1216)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1216)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1216)			_hx_tmp = false;
            		}
HXDLIN(1216)		if (_hx_tmp) {
HXLINE(1216)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN(1216)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_framebuffer(hx::DynamicPtr(framebuffer1))) );
            		}
            		else {
...
Bool NativeGLRenderContext_obj::isProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isProgram",0x10d26f92,"lime._backend.native.NativeGLRenderContext.isProgram","lime/_backend/native/NativeGLRenderContext.hx",1227,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1227)		Bool _hx_tmp;
HXDLIN(1227)		Bool _hx_tmp1 = hx::IsNotNull( program );
HXDLIN(1227)		if (_hx_tmp1) {
HXLINE(1227)			 ::Dynamic a = program->id;
HXDLIN(1227)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1227)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1227)			_hx_tmp = false;
            		}
HXDLIN(1227)		if (_hx_tmp) {
HXLINE(1227)			 ::Dynamic program1 = program->id;
HXDLIN(1227)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_program(hx::DynamicPtr(program1))) );
            		}
            		else {
...
Bool NativeGLRenderContext_obj::isRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isRenderbuffer",0x89361508,"lime._backend.native.NativeGLRenderContext.isRenderbuffer","lime/_backend/native/NativeGLRenderContext.hx",1238,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(1238)		Bool _hx_tmp;
HXDLIN(1238)		Bool _hx_tmp1 = hx::IsNotNull( renderbuffer );
HXDLIN(1238)		if (_hx_tmp1) {
HXLINE(1238)			 ::Dynamic a = renderbuffer->id;
HXDLIN(1238)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1238)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1238)			_hx_tmp = false;
            		}
HXDLIN(1238)		if (_hx_tmp) {
HXLINE(1238)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN(1238)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_renderbuffer(hx::DynamicPtr(renderbuffer1))) );
            		}
            		else {
...
Bool NativeGLRenderContext_obj::isShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isShader",0xe62775d7,"lime._backend.native.NativeGLRenderContext.isShader","lime/_backend/native/NativeGLRenderContext.hx",1249,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1249)		Bool _hx_tmp;
HXDLIN(1249)		Bool _hx_tmp1 = hx::IsNotNull( shader );
HXDLIN(1249)		if (_hx_tmp1) {
HXLINE(1249)			 ::Dynamic a = shader->id;
HXDLIN(1249)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1249)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1249)			_hx_tmp = false;
            		}
HXDLIN(1249)		if (_hx_tmp) {
HXLINE(1249)			 ::Dynamic shader1 = shader->id;
HXDLIN(1249)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_shader(hx::DynamicPtr(shader1))) );
            		}
            		else {
...
Bool NativeGLRenderContext_obj::isTexture( ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","isTexture",0xbbb9ede9,"lime._backend.native.NativeGLRenderContext.isTexture","lime/_backend/native/NativeGLRenderContext.hx",1260,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(texture,"texture")
HXLINE(1260)		Bool _hx_tmp;
HXDLIN(1260)		Bool _hx_tmp1 = hx::IsNotNull( texture );
HXDLIN(1260)		if (_hx_tmp1) {
HXLINE(1260)			 ::Dynamic a = texture->id;
HXDLIN(1260)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN(1260)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE(1260)			_hx_tmp = false;
            		}
HXDLIN(1260)		if (_hx_tmp) {
HXLINE(1260)			 ::Dynamic texture1 = texture->id;
HXDLIN(1260)			return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_texture(hx::DynamicPtr(texture1))) );
            		}
            		else {
...
void NativeGLRenderContext_obj::lineWidth(Float width){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","lineWidth",0x2a38614a,"lime._backend.native.NativeGLRenderContext.lineWidth","lime/_backend/native/NativeGLRenderContext.hx",1271,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(width,"width")
...
void NativeGLRenderContext_obj::linkProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","linkProgram",0x8c31fb82,"lime._backend.native.NativeGLRenderContext.linkProgram","lime/_backend/native/NativeGLRenderContext.hx",1280,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1280)		 ::Dynamic program1 = program->id;
HXDLIN(1280)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_link_program(hx::DynamicPtr(program1));
            	}
...
void NativeGLRenderContext_obj::pixelStorei(Int pname,Int param){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","pixelStorei",0x837e8266,"lime._backend.native.NativeGLRenderContext.pixelStorei","lime/_backend/native/NativeGLRenderContext.hx",1289,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pname,"pname")
...
void NativeGLRenderContext_obj::polygonOffset(Float factor,Float units){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","polygonOffset",0x3d949985,"lime._backend.native.NativeGLRenderContext.polygonOffset","lime/_backend/native/NativeGLRenderContext.hx",1298,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::readPixels(Int x,Int y,Int width,Int height,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","readPixels",0x2c9e084b,"lime._backend.native.NativeGLRenderContext.readPixels","lime/_backend/native/NativeGLRenderContext.hx",1304,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
...
HXDLIN(1307)		Bool _hx_tmp = hx::IsNull( pixels );
...
HXDLIN(1308)			Bool _hx_tmp1 = hx::IsNull( pixels );
...
void NativeGLRenderContext_obj::renderbufferStorage(Int target,Int internalformat,Int width,Int height){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","renderbufferStorage",0xc86c86dd,"lime._backend.native.NativeGLRenderContext.renderbufferStorage","lime/_backend/native/NativeGLRenderContext.hx",1319,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(internalformat,"internalformat")
            	HX_STACK_ARG(width,"width")
...
void NativeGLRenderContext_obj::sampleCoverage(Float value,Bool invert){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","sampleCoverage",0xc2bf515a,"lime._backend.native.NativeGLRenderContext.sampleCoverage","lime/_backend/native/NativeGLRenderContext.hx",1328,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::scissor(Int x,Int y,Int width,Int height){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","scissor",0xbe3ba9f4,"lime._backend.native.NativeGLRenderContext.scissor","lime/_backend/native/NativeGLRenderContext.hx",1337,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
...
void NativeGLRenderContext_obj::shaderSource( ::lime::graphics::opengl::GLShader shader,::String source){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","shaderSource",0xfee81d08,"lime._backend.native.NativeGLRenderContext.shaderSource","lime/_backend/native/NativeGLRenderContext.hx",1346,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(source,"source")
HXLINE(1346)		 ::Dynamic shader1 = shader->id;
HXDLIN(1346)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_shader_source(hx::DynamicPtr(shader1),source);
            	}
...
void NativeGLRenderContext_obj::stencilFunc(Int func,Int ref,Int mask){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilFunc",0x4374d138,"lime._backend.native.NativeGLRenderContext.stencilFunc","lime/_backend/native/NativeGLRenderContext.hx",1355,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(func,"func")
...
void NativeGLRenderContext_obj::stencilFuncSeparate(Int face,Int func,Int ref,Int mask){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilFuncSeparate",0xf3caa4bb,"lime._backend.native.NativeGLRenderContext.stencilFuncSeparate","lime/_backend/native/NativeGLRenderContext.hx",1364,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::stencilMask(Int mask){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilMask",0x480626e0,"lime._backend.native.NativeGLRenderContext.stencilMask","lime/_backend/native/NativeGLRenderContext.hx",1373,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mask,"mask")
...
void NativeGLRenderContext_obj::stencilMaskSeparate(Int face,Int mask){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilMaskSeparate",0x07a5e263,"lime._backend.native.NativeGLRenderContext.stencilMaskSeparate","lime/_backend/native/NativeGLRenderContext.hx",1382,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
...
void NativeGLRenderContext_obj::stencilOp(Int fail,Int zfail,Int zpass){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilOp",0x6fc72215,"lime._backend.native.NativeGLRenderContext.stencilOp","lime/_backend/native/NativeGLRenderContext.hx",1391,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::stencilOpSeparate(Int face,Int fail,Int zfail,Int zpass){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","stencilOpSeparate",0x4d549a98,"lime._backend.native.NativeGLRenderContext.stencilOpSeparate","lime/_backend/native/NativeGLRenderContext.hx",1400,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(fail,"fail")
            	HX_STACK_ARG(zfail,"zfail")
...
void NativeGLRenderContext_obj::texImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","texImage2D",0x5fdfb1ee,"lime._backend.native.NativeGLRenderContext.texImage2D","lime/_backend/native/NativeGLRenderContext.hx",1406,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(level,"level")
            	HX_STACK_ARG(internalformat,"internalformat")
...
HXDLIN(1409)		Bool _hx_tmp = hx::IsNull( pixels );
...
HXDLIN(1410)			Bool _hx_tmp1 = hx::IsNull( pixels );
...
void NativeGLRenderContext_obj::texParameterf(Int target,Int pname,Float param){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","texParameterf",0x13789b3c,"lime._backend.native.NativeGLRenderContext.texParameterf","lime/_backend/native/NativeGLRenderContext.hx",1421,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
...
void NativeGLRenderContext_obj::texParameteri(Int target,Int pname,Int param){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","texParameteri",0x13789b3f,"lime._backend.native.NativeGLRenderContext.texParameteri","lime/_backend/native/NativeGLRenderContext.hx",1430,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
...
void NativeGLRenderContext_obj::texSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","texSubImage2D",0xffd7a2ec,"lime._backend.native.NativeGLRenderContext.texSubImage2D","lime/_backend/native/NativeGLRenderContext.hx",1436,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(level,"level")
            	HX_STACK_ARG(xoffset,"xoffset")
...
HXDLIN(1439)		Bool _hx_tmp = hx::IsNull( pixels );
...
HXDLIN(1440)			Bool _hx_tmp1 = hx::IsNull( pixels );
...
void NativeGLRenderContext_obj::uniform1f(Int location,Float x){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform1f",0x20b8c921,"lime._backend.native.NativeGLRenderContext.uniform1f","lime/_backend/native/NativeGLRenderContext.hx",1451,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
...
void NativeGLRenderContext_obj::uniform1fv(Int location, ::lime::utils::ArrayBufferView x){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform1fv",0x80f73435,"lime._backend.native.NativeGLRenderContext.uniform1fv","lime/_backend/native/NativeGLRenderContext.hx",1460,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
...
void NativeGLRenderContext_obj::uniform1i(Int location,Int x){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform1i",0x20b8c924,"lime._backend.native.NativeGLRenderContext.uniform1i","lime/_backend/native/NativeGLRenderContext.hx",1471,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
...
void NativeGLRenderContext_obj::uniform1iv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform1iv",0x80f736d2,"lime._backend.native.NativeGLRenderContext.uniform1iv","lime/_backend/native/NativeGLRenderContext.hx",1480,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform2f(Int location,Float x,Float y){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform2f",0x20b8ca00,"lime._backend.native.NativeGLRenderContext.uniform2f","lime/_backend/native/NativeGLRenderContext.hx",1491,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform2fv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform2fv",0x80f7f676,"lime._backend.native.NativeGLRenderContext.uniform2fv","lime/_backend/native/NativeGLRenderContext.hx",1500,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform2i(Int location,Int x,Int y){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform2i",0x20b8ca03,"lime._backend.native.NativeGLRenderContext.uniform2i","lime/_backend/native/NativeGLRenderContext.hx",1511,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform2iv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform2iv",0x80f7f913,"lime._backend.native.NativeGLRenderContext.uniform2iv","lime/_backend/native/NativeGLRenderContext.hx",1520,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform3f(Int location,Float x,Float y,Float z){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform3f",0x20b8cadf,"lime._backend.native.NativeGLRenderContext.uniform3f","lime/_backend/native/NativeGLRenderContext.hx",1531,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform3fv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform3fv",0x80f8b8b7,"lime._backend.native.NativeGLRenderContext.uniform3fv","lime/_backend/native/NativeGLRenderContext.hx",1540,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform3i(Int location,Int x,Int y,Int z){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform3i",0x20b8cae2,"lime._backend.native.NativeGLRenderContext.uniform3i","lime/_backend/native/NativeGLRenderContext.hx",1551,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform3iv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform3iv",0x80f8bb54,"lime._backend.native.NativeGLRenderContext.uniform3iv","lime/_backend/native/NativeGLRenderContext.hx",1560,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform4f(Int location,Float x,Float y,Float z,Float w){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform4f",0x20b8cbbe,"lime._backend.native.NativeGLRenderContext.uniform4f","lime/_backend/native/NativeGLRenderContext.hx",1571,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform4fv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform4fv",0x80f97af8,"lime._backend.native.NativeGLRenderContext.uniform4fv","lime/_backend/native/NativeGLRenderContext.hx",1580,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniform4i(Int location,Int x,Int y,Int z,Int w){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform4i",0x20b8cbc1,"lime._backend.native.NativeGLRenderContext.uniform4i","lime/_backend/native/NativeGLRenderContext.hx",1591,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::uniform4iv(Int location, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniform4iv",0x80f97d95,"lime._backend.native.NativeGLRenderContext.uniform4iv","lime/_backend/native/NativeGLRenderContext.hx",1600,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniformMatrix2fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniformMatrix2fv",0x06c20db5,"lime._backend.native.NativeGLRenderContext.uniformMatrix2fv","lime/_backend/native/NativeGLRenderContext.hx",1611,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
...
void NativeGLRenderContext_obj::uniformMatrix3fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniformMatrix3fv",0x06c2cff6,"lime._backend.native.NativeGLRenderContext.uniformMatrix3fv","lime/_backend/native/NativeGLRenderContext.hx",1622,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::uniformMatrix4fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","uniformMatrix4fv",0x06c39237,"lime._backend.native.NativeGLRenderContext.uniformMatrix4fv","lime/_backend/native/NativeGLRenderContext.hx",1633,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
...
void NativeGLRenderContext_obj::useProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","useProgram",0x9d24a225,"lime._backend.native.NativeGLRenderContext.useProgram","lime/_backend/native/NativeGLRenderContext.hx",1648,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1650)		this->_hx___currentProgram = program;
HXLINE(1653)		{
HXLINE(1653)			 ::Dynamic program1;
HXDLIN(1653)			Bool _hx_tmp = hx::IsNull( program );
...
void NativeGLRenderContext_obj::validateProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","validateProgram",0xbdfd9a66,"lime._backend.native.NativeGLRenderContext.validateProgram","lime/_backend/native/NativeGLRenderContext.hx",1662,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1662)		 ::Dynamic program1 = program->id;
HXDLIN(1662)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_validate_program(hx::DynamicPtr(program1));
            	}
...
void NativeGLRenderContext_obj::vertexAttrib1f(Int indx,Float x){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib1f",0xdaf47d8b,"lime._backend.native.NativeGLRenderContext.vertexAttrib1f","lime/_backend/native/NativeGLRenderContext.hx",1671,0x396c0759)
            	HX_STACK_THIS(this)
...
void NativeGLRenderContext_obj::vertexAttrib1fv(Int indx, ::lime::utils::ArrayBufferView values){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib1fv",0xbaf95c8b,"lime._backend.native.NativeGLRenderContext.vertexAttrib1fv","lime/_backend/native/NativeGLRenderContext.hx",1680,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
...
void NativeGLRenderContext_obj::vertexAttrib2f(Int indx,Float x,Float y){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib2f",0xdaf47e6a,"lime._backend.native.NativeGLRenderContext.vertexAttrib2f","lime/_backend/native/NativeGLRenderContext.hx",1691,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::vertexAttrib2fv(Int indx, ::lime::utils::ArrayBufferView values){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib2fv",0xbafa1ecc,"lime._backend.native.NativeGLRenderContext.vertexAttrib2fv","lime/_backend/native/NativeGLRenderContext.hx",1700,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
...
void NativeGLRenderContext_obj::vertexAttrib3f(Int indx,Float x,Float y,Float z){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib3f",0xdaf47f49,"lime._backend.native.NativeGLRenderContext.vertexAttrib3f","lime/_backend/native/NativeGLRenderContext.hx",1711,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::vertexAttrib3fv(Int indx, ::lime::utils::ArrayBufferView values){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib3fv",0xbafae10d,"lime._backend.native.NativeGLRenderContext.vertexAttrib3fv","lime/_backend/native/NativeGLRenderContext.hx",1720,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
...
void NativeGLRenderContext_obj::vertexAttrib4f(Int indx,Float x,Float y,Float z,Float w){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib4f",0xdaf48028,"lime._backend.native.NativeGLRenderContext.vertexAttrib4f","lime/_backend/native/NativeGLRenderContext.hx",1731,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void NativeGLRenderContext_obj::vertexAttrib4fv(Int indx, ::lime::utils::ArrayBufferView values){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttrib4fv",0xbafba34e,"lime._backend.native.NativeGLRenderContext.vertexAttrib4fv","lime/_backend/native/NativeGLRenderContext.hx",1740,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
...
void NativeGLRenderContext_obj::vertexAttribPointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","vertexAttribPointer",0x80b1ea67,"lime._backend.native.NativeGLRenderContext.vertexAttribPointer","lime/_backend/native/NativeGLRenderContext.hx",1751,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indx,"indx")
...
void NativeGLRenderContext_obj::viewport(Int x,Int y,Int width,Int height){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","viewport",0x0d42678e,"lime._backend.native.NativeGLRenderContext.viewport","lime/_backend/native/NativeGLRenderContext.hx",1760,0x396c0759)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
...
Int NativeGLRenderContext_obj::get_version(){
            	HX_STACK_FRAME("lime._backend.native.NativeGLRenderContext","get_version",0x05a29507,"lime._backend.native.NativeGLRenderContext.get_version","lime/_backend/native/NativeGLRenderContext.hx",1766,0x396c0759)
            	HX_STACK_THIS(this)
