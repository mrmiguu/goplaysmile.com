...
void _Event_Dynamic_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","new",0xa035b3a4,"lime.app._Event_Dynamic_Void.new","lime/app/Event.hx",26,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","add",0xa02bd565,"lime.app._Event_Dynamic_Void.add","lime/app/Event.hx",38,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_Dynamic_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","cancel",0xb3546cb6,"lime.app._Event_Dynamic_Void.cancel","lime/app/Event.hx",216,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_Dynamic_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","has",0xa031229e,"lime.app._Event_Dynamic_Void.has","lime/app/Event.hx",252,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 255)		{
...
void _Event_Dynamic_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","remove",0xffa91b80,"lime.app._Event_Dynamic_Void.remove","lime/app/Event.hx",267,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_Dynamic_Void_obj::dispatch( ::Dynamic a){
            	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","dispatch",0x820f94f6,"lime.app._Event_Dynamic_Void.dispatch","lime/app/Event.hx",140,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
