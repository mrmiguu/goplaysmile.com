...
Int bitsPerPixel = __o_bitsPerPixel.Default(32);
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",49,0x6475c2cd)
            	HX_STACK_THIS(this)
...
HXDLIN(  55)		Bool _hx_tmp1 = hx::IsNull( format );
...
Dynamic ImageBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",62,0x6475c2cd)
            	HX_STACK_THIS(this)
HXLINE(  64)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new(this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 108)		Bool _hx_tmp = hx::IsNotNull( this->data );
HXDLIN( 108)		if (_hx_tmp) {
HXLINE( 110)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 111)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 112)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 112)			Bool _hx_tmp1 = hx::IsNotNull( bytes );
...
HXDLIN( 112)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 112)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 112)				HX_VARI( Int,bufferByteLength) = bytes->length;
HXDLIN( 112)				{
HXLINE( 112)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 112)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 112)					if ((bufferByteLength < (int)0)) {
HXLINE( 112)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 112)				_this->buffer = bytes;
HXDLIN( 112)				_this->byteOffset = (int)0;
HXDLIN( 112)				_this->byteLength = bufferByteLength;
HXDLIN( 112)				Float _hx_tmp2 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 112)				_this->length = ::Std_obj::_hx_int(_hx_tmp2);
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",146,0x6475c2cd)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",153,0x6475c2cd)
            	HX_STACK_THIS(this)
...
Int ImageBuffer_obj::get_stride(){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",185,0x6475c2cd)
            	HX_STACK_THIS(this)
