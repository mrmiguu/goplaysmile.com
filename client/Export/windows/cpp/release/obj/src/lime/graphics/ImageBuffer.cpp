...
HXLINE(  46)		this->data = data;
HXLINE(  47)		this->width = width;
HXLINE(  48)		this->height = height;
HXLINE(  49)		this->bitsPerPixel = bitsPerPixel;
HXLINE(  50)		Int _hx_tmp;
HXDLIN(  50)		Bool _hx_tmp1 = hx::IsNull( format );
HXDLIN(  50)		if (_hx_tmp1) {
HXLINE(  50)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(  50)			_hx_tmp = format;
            		}
HXDLIN(  50)		this->format = _hx_tmp;
HXLINE(  51)		this->premultiplied = false;
HXLINE(  52)		this->transparent = true;
            	}
...
hx::ObjectPtr< ImageBuffer_obj > ImageBuffer_obj::__new( ::lime::utils::ArrayBufferView data,hx::Null< Int >  __o_width,hx::Null< Int >  __o_height,hx::Null< Int >  __o_bitsPerPixel, ::Dynamic format)
{
	...
	_hx_result->__construct(data,__o_width,__o_height,__o_bitsPerPixel,format);
	return _hx_result;
}
...
Dynamic ImageBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  59)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new(this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 103)		Bool _hx_tmp = hx::IsNotNull( this->data );
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 105)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 106)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 107)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 107)			Bool _hx_tmp1 = hx::IsNotNull( bytes );
HXDLIN( 107)			if (_hx_tmp1) {
HXLINE( 107)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 107)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 107)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 107)				HX_VARI( Int,bufferByteLength) = bytes->length;
HXDLIN( 107)				{
HXLINE( 107)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 107)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 107)					if ((bufferByteLength < (int)0)) {
HXLINE( 107)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 107)				_this->buffer = bytes;
HXDLIN( 107)				_this->byteOffset = (int)0;
HXDLIN( 107)				_this->byteLength = bufferByteLength;
HXDLIN( 107)				Float _hx_tmp2 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 107)				_this->length = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 107)				this1 = _this;
            			}
            			else {
HXLINE( 107)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            			}
HXDLIN( 107)			buffer->data = this1;
            		}
HXLINE( 112)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 113)		buffer->format = this->format;
HXLINE( 114)		buffer->premultiplied = this->premultiplied;
HXLINE( 115)		buffer->transparent = this->transparent;
HXLINE( 116)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",141,0x6475c2cd)
            	HX_STACK_THIS(this)
HXLINE( 141)		return this->_hx___srcCustom;
            	}
...
HXLINE( 169)		this->_hx___srcCustom = value;
...
Int ImageBuffer_obj::get_stride(){
            	HX_STACK_FRAME("lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",180,0x6475c2cd)
            	HX_STACK_THIS(this)
HXLINE( 180)		return (this->width * (int)4);
            	}
