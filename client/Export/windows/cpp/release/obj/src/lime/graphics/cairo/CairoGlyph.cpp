...
Float y = __o_y.Default(0);
            	HX_STACK_FRAME("lime.graphics.cairo.CairoGlyph","new",0x55c88ba6,"lime.graphics.cairo.CairoGlyph.new","lime/graphics/cairo/CairoGlyph.hx",18,0x7c7a7209)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< CairoGlyph_obj > CairoGlyph_obj::__new(Int index,hx::Null< Float >  __o_x,hx::Null< Float >  __o_y)
{
	...
	_hx_result->__construct(index,__o_x,__o_y);
	return _hx_result;
}
