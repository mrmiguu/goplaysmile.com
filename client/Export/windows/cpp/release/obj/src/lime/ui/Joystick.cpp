...
void Joystick_obj::__construct(Int id){
            	HX_STACK_FRAME("lime.ui.Joystick","new",0xd76b52cf,"lime.ui.Joystick.new","lime/ui/Joystick.hx",15,0x26e848e1)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  34)		this->onTrackballMove =  ::lime::app::_Event_Int_Float_Void_obj::__new();
HXLINE(  33)		this->onHatMove =  ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void_obj::__new();
HXLINE(  32)		this->onDisconnect =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  31)		this->onButtonUp =  ::lime::app::_Event_Int_Void_obj::__new();
HXLINE(  30)		this->onButtonDown =  ::lime::app::_Event_Int_Void_obj::__new();
HXLINE(  29)		this->onAxisMove =  ::lime::app::_Event_Int_Float_Void_obj::__new();
...
::String Joystick_obj::get_guid(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_guid",0xa0372443,"lime.ui.Joystick.get_guid","lime/ui/Joystick.hx",87,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE(  87)		Int id = this->id;
HXDLIN(  87)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_device_guid(id)) );
HXDLIN(  87)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String Joystick_obj::get_name(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_name",0xa4c87905,"lime.ui.Joystick.get_name","lime/ui/Joystick.hx",101,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE( 101)		Int id = this->id;
HXDLIN( 101)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_device_name(id)) );
...
Int Joystick_obj::get_numAxes(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_numAxes",0x6e0a2811,"lime.ui.Joystick.get_numAxes","lime/ui/Joystick.hx",115,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE( 115)		Int id = this->id;
HXDLIN( 115)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_axes(id)) );
            	}
...
Int Joystick_obj::get_numButtons(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_numButtons",0x8a7f5ed5,"lime.ui.Joystick.get_numButtons","lime/ui/Joystick.hx",129,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE( 129)		Int id = this->id;
HXDLIN( 129)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_buttons(id)) );
            	}
...
Int Joystick_obj::get_numHats(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_numHats",0x72993fa4,"lime.ui.Joystick.get_numHats","lime/ui/Joystick.hx",143,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE( 143)		Int id = this->id;
HXDLIN( 143)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_hats(id)) );
            	}
...
Int Joystick_obj::get_numTrackballs(){
            	HX_STACK_FRAME("lime.ui.Joystick","get_numTrackballs",0xfaa6bf15,"lime.ui.Joystick.get_numTrackballs","lime/ui/Joystick.hx",154,0x26e848e1)
            	HX_STACK_THIS(this)
HXLINE( 154)		Int id = this->id;
HXDLIN( 154)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_joystick_get_num_trackballs(id)) );
            	}
...
void Joystick_obj::_hx___connect(Int id){
            	HX_STACK_FRAME("lime.ui.Joystick","__connect",0x47420c79,"lime.ui.Joystick.__connect","lime/ui/Joystick.hx",47,0x26e848e1)
            	HX_STACK_ARG(id,"id")
HXLINE(  47)		Bool _hx_tmp = !(::lime::ui::Joystick_obj::devices->exists(id));
HXDLIN(  47)		if (_hx_tmp) {
HXLINE(  49)			HX_VARI(  ::lime::ui::Joystick,joystick) =  ::lime::ui::Joystick_obj::__new(id);
...
void Joystick_obj::_hx___disconnect(Int id){
            	HX_STACK_FRAME("lime.ui.Joystick","__disconnect",0xe10a172d,"lime.ui.Joystick.__disconnect","lime/ui/Joystick.hx",58,0x26e848e1)
            	HX_STACK_ARG(id,"id")
HXLINE(  60)		HX_VARI(  ::lime::ui::Joystick,joystick) = ::lime::ui::Joystick_obj::devices->get(id).StaticCast<  ::lime::ui::Joystick >();
HXLINE(  61)		Bool _hx_tmp = hx::IsNotNull( joystick );
HXDLIN(  61)		if (_hx_tmp) {
HXLINE(  61)			joystick->connected = false;
            		}
HXLINE(  62)		::lime::ui::Joystick_obj::devices->remove(id);
HXLINE(  63)		Bool _hx_tmp1 = hx::IsNotNull( joystick );
...
{
{
            	HX_STACK_FRAME("lime.ui.Joystick","boot",0x9e9622e3,"lime.ui.Joystick.boot","lime/ui/Joystick.hx",18,0x26e848e1)
HXLINE(  18)		devices =  ::haxe::ds::IntMap_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.ui.Joystick","boot",0x9e9622e3,"lime.ui.Joystick.boot","lime/ui/Joystick.hx",19,0x26e848e1)
HXLINE(  19)		onConnect =  ::lime::app::_Event_lime_ui_Joystick_Void_obj::__new();
            	}
}
