...
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_54_new,"lime.media.AudioBuffer","new",0x18eea6a5,"lime.media.AudioBuffer.new","lime/media/AudioBuffer.hx",54,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_61_dispose,"lime.media.AudioBuffer","dispose",0xa3b05d64,"lime.media.AudioBuffer.dispose","lime/media/AudioBuffer.hx",61,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_449_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",449,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_482_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",482,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_89_fromBytes,"lime.media.AudioBuffer","fromBytes",0x20c94aa6,"lime.media.AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",89,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_128_fromFile,"lime.media.AudioBuffer","fromFile",0x1084eca1,"lime.media.AudioBuffer.fromFile","lime/media/AudioBuffer.hx",128,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_211_fromFiles,"lime.media.AudioBuffer","fromFiles",0x63ca20b2,"lime.media.AudioBuffer.fromFiles","lime/media/AudioBuffer.hx",211,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_249_fromURL,"lime.media.AudioBuffer","fromURL",0x4067bcea,"lime.media.AudioBuffer.fromURL","lime/media/AudioBuffer.hx",249,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_291_fromVorbisFile,"lime.media.AudioBuffer","fromVorbisFile",0x6dde6b54,"lime.media.AudioBuffer.fromVorbisFile","lime/media/AudioBuffer.hx",291,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_318_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",318,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_411_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",411,0xf6fabaad)
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_379_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",379,0xf6fabaad)
namespace lime{
namespace media{

void AudioBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_54_new)
            	HX_STACK_THIS(this)
            	}
...
void AudioBuffer_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_61_dispose)
            	HX_STACK_THIS(this)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_449_get_src)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_482_set_src)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 482)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::codecs::vorbis::VorbisFile)(value) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,set_src,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_89_fromBytes)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  91)		if (hx::IsNull( bytes )) {
HXLINE(  91)			return null();
            		}
HXLINE( 100)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXDLIN( 101)		if (hx::IsNotNull( buffer )) {
HXLINE( 101)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 101)			_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
...
HXLINE( 103)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_audio_load(hx::DynamicPtr(bytes),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBytes,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_128_fromFile)
            	HX_STACK_ARG(path,"path")
HXLINE( 130)		if (hx::IsNull( path )) {
HXLINE( 130)			return null();
            		}
HXLINE( 179)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXDLIN( 180)		if (hx::IsNotNull( buffer )) {
HXLINE( 180)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 180)			_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
...
HXLINE( 182)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_audio_load(hx::DynamicPtr(path),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFile,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFiles(::Array< ::String > paths){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_211_fromFiles)
...
HXLINE( 226)				if (hx::IsNotNull( buffer )) {
...
void AudioBuffer_obj::fromURL(::String url, ::Dynamic handler){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_249_fromURL)
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(handler,"handler")
HXLINE( 249)		bool _hx_tmp;
HXDLIN( 249)		bool _hx_tmp1;
HXDLIN( 249)		if (hx::IsNotNull( url )) {
HXLINE( 249)			_hx_tmp1 = (url.indexOf(HX_("http://",52,75,cd,5a),null()) == (int)-1);
            		}
            		else {
HXLINE( 249)			_hx_tmp1 = false;
            		}
HXDLIN( 249)		if (_hx_tmp1) {
HXLINE( 249)			_hx_tmp = (url.indexOf(HX_("https://",cf,b4,ae,3e),null()) == (int)-1);
            		}
            		else {
HXLINE( 249)			_hx_tmp = false;
            		}
HXDLIN( 249)		if (_hx_tmp) {
HXLINE( 251)			handler(::lime::media::AudioBuffer_obj::fromFile(url));
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AudioBuffer_obj,fromURL,(void))
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromVorbisFile( ::lime::media::codecs::vorbis::VorbisFile vorbisFile){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_291_fromVorbisFile)
...
HXLINE( 297)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromVorbisFile,return )
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_318_loadFromFile)
            	HX_STACK_ARG(path,"path")
HXLINE( 320)		HX_VARI(  ::lime::app::Promise_lime_media_AudioBuffer,promise) =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 322)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) = ::lime::media::AudioBuffer_obj::fromFile(path);
HXLINE( 324)		if (hx::IsNotNull( audioBuffer )) {
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFiles(::Array< ::String > paths){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0,::Array< ::String >,paths) HXARGC(0)
            		 ::lime::media::AudioBuffer _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_411_loadFromFiles)
HXLINE( 411)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_379_loadFromFiles)
            	HX_STACK_ARG(paths,"paths")
HXLINE( 381)		HX_VARI(  ::lime::app::Promise_lime_media_AudioBuffer,promise) =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 411)		promise->completeWith( ::lime::app::Future_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(paths)),true));
