...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_465_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",465,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_498_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",498,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_250_fromURL,"lime.media.AudioBuffer","fromURL",0x4067bcea,"lime.media.AudioBuffer.fromURL","lime/media/AudioBuffer.hx",250,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_386_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",386,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_427_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",427,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_395_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",395,0xf6fabaad)
namespace lime{
namespace media{
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_465_get_src)
HXLINE( 465)		return this->_hx___srcVorbisFile;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_498_set_src)
HXLINE( 498)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::codecs::vorbis::VorbisFile)(value) ));
            	}
...
HXDLIN( 102)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
...
HXDLIN( 102)			{
HXLINE( 102)				newByteLength = bufferByteLength;
...
HXDLIN( 102)			_this->byteOffset = (int)0;
...
HXDLIN( 181)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
...
HXDLIN( 181)			{
HXLINE( 181)				newByteLength = bufferByteLength;
...
HXDLIN( 181)			_this->byteOffset = (int)0;
...
void AudioBuffer_obj::fromURL(::String url, ::Dynamic handler){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_250_fromURL)
HXLINE( 250)		bool _hx_tmp;
HXDLIN( 250)		bool _hx_tmp1;
HXDLIN( 250)		if (hx::IsNotNull( url )) {
HXLINE( 250)			_hx_tmp1 = (url.indexOf(HX_("http://",52,75,cd,5a),null()) == (int)-1);
            		}
            		else {
HXLINE( 250)			_hx_tmp1 = false;
            		}
HXDLIN( 250)		if (_hx_tmp1) {
HXLINE( 250)			_hx_tmp = (url.indexOf(HX_("https://",cf,b4,ae,3e),null()) == (int)-1);
            		}
            		else {
HXLINE( 250)			_hx_tmp = false;
            		}
HXDLIN( 250)		if (_hx_tmp) {
HXLINE( 252)			handler(::lime::media::AudioBuffer_obj::fromFile(url));
            		}
            	}
...
HXLINE( 294)		if (hx::IsNull( vorbisFile )) {
HXLINE( 294)			return null();
            		}
HXLINE( 296)		 ::lime::media::codecs::vorbis::VorbisInfo info = vorbisFile->info(null());
HXLINE( 298)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 299)		audioBuffer->channels = info->channels;
HXLINE( 300)		audioBuffer->sampleRate = info->rate;
HXLINE( 301)		audioBuffer->bitsPerSample = (int)16;
HXLINE( 302)		audioBuffer->_hx___srcVorbisFile = vorbisFile;
HXLINE( 304)		return audioBuffer;
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes bytes){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_386_loadFromFile)
HXLINE( 386)			return ::lime::app::Future_obj::withValue(::lime::media::AudioBuffer_obj::fromBytes(bytes));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_319_loadFromFile)
HXLINE( 383)		 ::lime::net::_HTTPRequest_Bytes request =  ::lime::net::_HTTPRequest_Bytes_obj::__alloc( HX_CTX ,null());
HXLINE( 384)		return request->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFiles(::Array< ::String > paths){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0,::Array< ::String >,paths) HXARGC(0)
            		 ::lime::media::AudioBuffer _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_427_loadFromFiles)
HXLINE( 427)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_395_loadFromFiles)
HXLINE( 397)		 ::lime::app::Promise_lime_media_AudioBuffer promise =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 427)		promise->completeWith( ::lime::app::Future_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(paths)),true));
HXLINE( 431)		return promise->future;
            	}
