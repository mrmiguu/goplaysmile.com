...
HXLINE(  17)		this->glyph = glyph;
HXLINE(  18)		this->advance = advance;
HXLINE(  20)		Bool _hx_tmp = hx::IsNotNull( offset );
HXDLIN(  20)		if (_hx_tmp) {
HXLINE(  22)			this->offset = offset;
            		}
            		else {
HXLINE(  26)			this->offset =  ::lime::math::Vector2_obj::__new(null(),null());
            		}
            	}
