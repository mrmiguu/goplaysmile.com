...
void ApplicationMain_obj::main(){
            	HX_STACK_FRAME("ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","ApplicationMain.hx",25,0x0780ded5)
HXLINE(  27)		::ApplicationMain_obj::config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("",00,00,00,00))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("56",61,2e,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(20)
            				...
            				->setFixed(3,HX_("width",06,b6,62,ca),(int)480)
            				...
            				->setFixed(8,HX_("height",e7,07,4c,02),(int)800)
...
HXLINE(  78)		::ApplicationMain_obj::create();
            	}
...
void ApplicationMain_obj::create(){
            	HX_STACK_FRAME("ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",84,0x0780ded5)
HXLINE(  86)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__new();
HXLINE(  87)		app->create(::ApplicationMain_obj::config);
HXLINE(  89)		::ApplicationMain_obj::preloader =  ::openfl::display::Preloader_obj::__new( ::openfl::display::DefaultPreloader_obj::__new());
HXLINE(  90)		::ApplicationMain_obj::preloader->onComplete->add(::ApplicationMain_obj::registerLibrary_dyn(),null(),null());
HXLINE(  91)		app->setPreloader(::ApplicationMain_obj::preloader);
HXLINE(  92)		::ApplicationMain_obj::preloader->onComplete->add(::ApplicationMain_obj::init_dyn(),null(),null());
HXLINE(  93)		::ApplicationMain_obj::preloader->create(::ApplicationMain_obj::config);
HXLINE( 118)		HX_VARI( Int,result) = app->exec();
HXLINE( 121)		::lime::_hx_system::System_obj::exit(result);
            	}
...
void ApplicationMain_obj::init(){
            	HX_STACK_FRAME("ApplicationMain","init",0x9137fa15,"ApplicationMain.init","ApplicationMain.hx",197,0x0780ded5)
HXLINE( 199)		HX_VARI( ::Array< Int >,loaded) = ::Array_obj< Int >::fromData( _hx_array_data_0,1);
HXLINE( 200)		HX_VARI( Int,total) = (int)0;
HXLINE( 213)		::ApplicationMain_obj::preloader = null();
HXLINE( 218)		if ((total == (int)0)) {
HXLINE( 220)			::ApplicationMain_obj::start();
            		}
            	}
...
void ApplicationMain_obj::registerLibrary(){
            	HX_STACK_FRAME("ApplicationMain","registerLibrary",0xbc0f4ff3,"ApplicationMain.registerLibrary","ApplicationMain.hx",229,0x0780ded5)
HXLINE( 229)		::lime::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b), ::DefaultAssetLibrary_obj::__new());
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(ApplicationMain_obj,registerLibrary,(void))

void ApplicationMain_obj::start(){
            	HX_STACK_FRAME("ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",234,0x0780ded5)
HXLINE( 242)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 294)			 ::DocumentClass_obj::__new();
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 248)				::openfl::Lib_obj::current->stage->_hx___handleError(e);
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
            		}
HXLINE( 252)		::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("resize",f4,59,7b,08),false,false));
HXLINE( 254)		Bool _hx_tmp = ::openfl::Lib_obj::current->stage->window->_hx___fullscreen;
HXDLIN( 254)		if (_hx_tmp) {
HXLINE( 256)			::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__new(HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            		}
            	}
