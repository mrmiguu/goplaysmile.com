...
HX_DEFINE_STACK_FRAME(_hx_pos_6fcf922b66429816_86_create,"ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",86,0x0780ded5)
HX_DEFINE_STACK_FRAME(_hx_pos_6fcf922b66429816_189_start,"ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",189,0x0780ded5)
...
HXLINE(  29)		::ApplicationMain_obj::config =  ::Dynamic(hx::Anon_obj::Create(9)
            			...
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("70",19,30,00,00))
...
HXLINE(  88)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__alloc( HX_CTX );
HXLINE(  89)		app->create(::ApplicationMain_obj::config);
HXLINE(  91)		HX_VARI(  ::DefaultAssetLibrary,library) =  ::DefaultAssetLibrary_obj::__alloc( HX_CTX );
...
HXLINE( 105)		::lime::_hx_system::System_obj::exit(app->exec());
            	}
...
HXLINE( 207)		::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("resize",f4,59,7b,08),false,false));
HXLINE( 209)		if (::openfl::Lib_obj::current->stage->window->_hx___fullscreen) {
HXLINE( 211)			::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            		}
            	}
