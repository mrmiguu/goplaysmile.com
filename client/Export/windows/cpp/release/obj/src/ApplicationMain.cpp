...
HXLINE(  29)		::ApplicationMain_obj::config =  ::Dynamic(hx::Anon_obj::Create(9)
            			...
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("97",de,31,00,00))
...
void ApplicationMain_obj::create(){
            	HX_STACK_FRAME("ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",86,0x0780ded5)
HXLINE(  88)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__new();
HXLINE(  89)		app->create(::ApplicationMain_obj::config);
HXLINE(  91)		HX_VARI(  ::DefaultAssetLibrary,library) =  ::DefaultAssetLibrary_obj::__new();
HXLINE(  92)		::lime::utils::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b),library);
HXLINE(  94)		::ApplicationMain_obj::preloader =  ::openfl::display::Preloader_obj::__new( ::openfl::display::DefaultPreloader_obj::__new());
...
HXLINE( 102)		HX_VARI( Int,result) = app->exec();
...
void ApplicationMain_obj::start(){
            	HX_STACK_FRAME("ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",189,0x0780ded5)
HXLINE( 197)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 249)			 ::DocumentClass_obj::__new();
            		}
            		catch( ::Dynamic _hx_e){
...
HXLINE( 207)		::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("resize",f4,59,7b,08),false,false));
HXLINE( 209)		Bool _hx_tmp = ::openfl::Lib_obj::current->stage->window->_hx___fullscreen;
HXDLIN( 209)		if (_hx_tmp) {
HXLINE( 211)			::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__new(HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            		}
            	}
