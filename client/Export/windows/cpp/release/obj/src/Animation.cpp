...
void Animation_obj::__construct(Int frames,Float delay){
            	HX_STACK_FRAME("Animation","new",0x6e1eb1d6,"Animation.new","Animation.hx",25,0x7224da5a)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< Animation_obj > Animation_obj::__new(Int frames,Float delay)
{
	...
	_hx_result->__construct(frames,delay);
	return _hx_result;
}
...
void Animation_obj::begin(){
            	HX_STACK_FRAME("Animation","begin",0x4fb4951f,"Animation.begin","Animation.hx",31,0x7224da5a)
            	HX_STACK_THIS(this)
            	}
...
void Animation_obj::during(){
            	HX_STACK_FRAME("Animation","during",0x78b3400b,"Animation.during","Animation.hx",32,0x7224da5a)
            	HX_STACK_THIS(this)
            	}
...
void Animation_obj::end(){
            	HX_STACK_FRAME("Animation","end",0x6e17e551,"Animation.end","Animation.hx",33,0x7224da5a)
            	HX_STACK_THIS(this)
            	}
...
void Animation_obj::transition(){
            	HX_STACK_FRAME("Animation","transition",0x4bb366df,"Animation.transition","Animation.hx",35,0x7224da5a)
            	HX_STACK_THIS(this)
HXLINE(  37)		Bool _hx_tmp = (this->frame == (int)0);
HXDLIN(  37)		if (_hx_tmp) {
HXLINE(  37)			this->begin();
            		}
            		else {
HXLINE(  38)			Bool _hx_tmp1 = (this->frame == (this->frames - (int)1));
...
HXLINE(  41)		Int _hx_tmp2 = (this->frame + (int)1);
HXDLIN(  41)		this->frame = hx::Mod(_hx_tmp2,this->frames);
            	}
