...
HX_DEFINE_STACK_FRAME(_hx_pos_99e38b06967cbf51_46_getText,"Field","getText",0xce2b2c8f,"Field.getText","Field.hx",46,0x85a79a64)
HX_DEFINE_STACK_FRAME(_hx_pos_99e38b06967cbf51_55_setText,"Field","setText",0xc12cbd9b,"Field.setText","Field.hx",55,0x85a79a64)
...
HXLINE(  25)		HX_VARI(  ::openfl::text::TextField,t) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXDLIN(  25)		t->set_embedFonts(true);
HXDLIN(  25)		t->set_text(HX_("",00,00,00,00));
HXDLIN(  25)		t->set_x((x - ((Float)t->get_width() / (Float)(int)2)));
HXDLIN(  25)		t->set_y(y);
HXDLIN(  25)		t->set_autoSize((int)0);
HXDLIN(  25)		t->set_selectable(false);
HXDLIN(  25)		t->setTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::openfl::Assets_obj::getFont(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),null())->name,(int)72,(int)16777215,true,null(),null(),null(),null(),null(),null(),null(),null(),null()),null(),null());
HXDLIN(  25)		this->f = t;
...
HXDLIN(  27)				HX_VARI_NAME(  ::openfl::display::Tileset,set1,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png1,null());
HXDLIN(  27)				set1->addRect(png1->rect);
HXDLIN(  27)				HX_VARI_NAME( int,map3,"map") = ::Std_obj::_hx_int(set1->getRect((int)0)->width);
HXDLIN(  27)				HX_VARI_NAME(  ::openfl::display::Tilemap,map5,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map3,::Std_obj::_hx_int(set1->getRect((int)0)->height),set1,null());
HXDLIN(  27)				map5->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXDLIN(  27)				HX_VARI_NAME(  ::openfl::display::Sprite,sprite1,"sprite") =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXDLIN(  27)				sprite1->addChild(map5);
...
HXDLIN(  28)		HX_VARI_NAME(  ::openfl::display::Tileset,set2,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png2,null());
HXDLIN(  28)		set2->addRect(png2->rect);
HXDLIN(  28)		HX_VARI_NAME( int,map6,"map") = ::Std_obj::_hx_int(set2->getRect((int)0)->width);
HXDLIN(  28)		HX_VARI_NAME(  ::openfl::display::Tilemap,map8,"map") =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,map6,::Std_obj::_hx_int(set2->getRect((int)0)->height),set2,null());
HXDLIN(  28)		map8->addTile( ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXDLIN(  28)		HX_VARI_NAME(  ::openfl::display::Sprite,sprite2,"sprite") =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXDLIN(  28)		sprite2->addChild(map8);
...
HXDLIN(  33)				_g11 = (_g11 + (int)1);
HXLINE(  34)				m->set_y(this->l->get_y());
HXLINE(  35)				this->addChild(m);
            			}
            		}
HXLINE(  38)		 ::openfl::display::Sprite _hx_tmp = this->r;
HXDLIN(  38)		_hx_tmp->set_y(this->l->get_y());
...
::String Field_obj::getText(){
            	HX_STACKFRAME(&_hx_pos_99e38b06967cbf51_46_getText)
            	HX_STACK_THIS(this)
...
void Field_obj::setText(::String t){
            	HX_STACKFRAME(&_hx_pos_99e38b06967cbf51_55_setText)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE(  56)		HX_VARI( ::String,t20) = t;
HXLINE(  58)		if ((t.length > (int)11)) {
HXLINE(  59)			this->g->errSfx();
HXLINE(  60)			t20 = t.substr((int)0,(int)11);
            		}
HXLINE(  63)		if ((t20.length == (int)0)) {
...
HXLINE(  69)			if ((t20.length == (int)1)) {
HXLINE(  70)				this->l->set_x((((Float)240.) - ((Float)(this->tE * (int)2) / (Float)(int)2)));
...
HXLINE(  75)				this->r->set_x((this->l->get_x() + this->tE));
HXLINE(  76)				this->r->set_visible(true);
            			}
            			else {
HXLINE(  78)				this->l->set_x((((Float)240.) - ((Float)((this->tE * (int)2) + (this->tW * (t20.length - (int)1))) / (Float)(int)2)));
...
HXLINE(  82)						_g13 = (_g13 + (int)1);
HXDLIN(  82)						HX_VARI( int,i) = (_g13 - (int)1);
HXLINE(  83)						if ((i == (int)0)) {
HXLINE(  83)							this->ms->__get((int)0).StaticCast<  ::openfl::display::Sprite >()->set_x((this->l->get_x() + this->tE));
            						}
            						else {
HXLINE(  84)							this->ms->__get(i).StaticCast<  ::openfl::display::Sprite >()->set_x((this->ms->__get((i - (int)1)).StaticCast<  ::openfl::display::Sprite >()->get_x() + this->tW));
            						}
HXLINE(  86)						this->ms->__get(i).StaticCast<  ::openfl::display::Sprite >()->set_visible(true);
            					}
            				}
HXLINE(  89)				this->r->set_x((this->ms->__get((t20.length - (int)2)).StaticCast<  ::openfl::display::Sprite >()->get_x() + this->tW));
...
hx::ObjectPtr< Field_obj > Field_obj::__new( ::Globals g,Float x,Float y) {
	...
	__this->__construct(g,x,y);
	return __this;
}

hx::ObjectPtr< Field_obj > Field_obj::__alloc(hx::Ctx *_hx_ctx, ::Globals g,Float x,Float y) {
