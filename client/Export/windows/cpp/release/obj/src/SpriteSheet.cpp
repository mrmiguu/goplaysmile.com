...
HX_LOCAL_STACK_FRAME(_hx_pos_de9aac0f8bd8a0c3_55_begin,"SpriteSheet","begin",0xf3ffc6f5,"SpriteSheet.begin","SpriteSheet.hx",55,0x6645c6c4)
HX_LOCAL_STACK_FRAME(_hx_pos_de9aac0f8bd8a0c3_56_during,"SpriteSheet","during",0x9633a975,"SpriteSheet.during","SpriteSheet.hx",56,0x6645c6c4)
HX_LOCAL_STACK_FRAME(_hx_pos_de9aac0f8bd8a0c3_57_end,"SpriteSheet","end",0x16c5d5a7,"SpriteSheet.end","SpriteSheet.hx",57,0x6645c6c4)
HX_LOCAL_STACK_FRAME(_hx_pos_de9aac0f8bd8a0c3_59_transition,"SpriteSheet","transition",0x4495cd49,"SpriteSheet.transition","SpriteSheet.hx",59,0x6645c6c4)
...
HXLINE(  35)		 ::openfl::display::BitmapData png = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + file),null());
HXLINE(  36)		int png1 = png->width;
HXDLIN(  36)		int w = ::Std_obj::_hx_int(((Float)png1 / (Float)(this->frames = frames)));
HXLINE(  37)		int png2 = png->height;
HXDLIN(  37)		int h = ::Std_obj::_hx_int(((Float)png2 / (Float)(this->states = states)));
HXLINE(  40)		::Array< ::Dynamic> _g = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  40)		{
HXLINE(  40)			int _g2 = (int)0;
HXDLIN(  40)			int _g1 = states;
HXDLIN(  40)			while((_g2 < _g1)){
HXLINE(  40)				_g2 = (_g2 + (int)1);
HXDLIN(  40)				int s = (_g2 - (int)1);
HXLINE(  41)				{
HXLINE(  41)					int _g4 = (int)0;
HXDLIN(  41)					int _g3 = frames;
HXDLIN(  41)					while((_g4 < _g3)){
HXLINE(  41)						_g4 = (_g4 + (int)1);
HXDLIN(  41)						int f = (_g4 - (int)1);
HXDLIN(  41)						_g->push( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(f * w),(s * h),w,h));
            					}
            				}
            			}
            		}
HXLINE(  39)		 ::openfl::display::Tilemap map =  ::openfl::display::Tilemap_obj::__alloc( HX_CTX ,w,h, ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,_g),null());
HXLINE(  43)		this->addChild(map);
HXLINE(  45)		::Array< ::Dynamic> _g11 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  45)		{
HXLINE(  45)			int _g31 = (int)0;
HXDLIN(  45)			int _g21 = states;
HXDLIN(  45)			while((_g31 < _g21)){
HXLINE(  45)				_g31 = (_g31 + (int)1);
HXDLIN(  45)				int s1 = (_g31 - (int)1);
HXLINE(  46)				{
HXLINE(  46)					int _g5 = (int)0;
HXDLIN(  46)					int _g41 = frames;
HXDLIN(  46)					while((_g5 < _g41)){
HXLINE(  46)						_g5 = (_g5 + (int)1);
HXDLIN(  46)						int f1 = (_g5 - (int)1);
HXDLIN(  46)						_g11->push( ::openfl::display::Tile_obj::__alloc( HX_CTX ,((s1 * frames) + f1),null(),null(),null(),null(),null(),null(),null()));
            					}
            				}
            			}
            		}
HXLINE(  45)		this->tiles = _g11;
HXLINE(  48)		map->addTiles(this->tiles);
HXLINE(  50)		{
HXLINE(  50)			int _g22 = (int)0;
HXDLIN(  50)			::Array< ::Dynamic> _g32 = this->tiles;
HXDLIN(  50)			while((_g22 < _g32->length)){
HXLINE(  50)				 ::openfl::display::Tile t = _g32->__get(_g22).StaticCast<  ::openfl::display::Tile >();
HXDLIN(  50)				_g22 = (_g22 + (int)1);
HXDLIN(  50)				t->visible = false;
            			}
            		}
HXLINE(  51)		::Array< ::Dynamic> _hx_tmp = this->tiles;
HXDLIN(  51)		_hx_tmp->__get(((frames * states) - (int)1)).StaticCast<  ::openfl::display::Tile >()->visible = true;
...
HXLINE(  62)			int _hx_tmp = this->frame;
HXDLIN(  62)			if ((_hx_tmp == (this->frames - (int)1))) {
HXLINE(  62)				this->end();
            			}
            			else {
HXLINE(  63)				this->during();
            			}
            		}
HXLINE(  65)		::Array< ::Dynamic> _hx_tmp1 = this->tiles;
HXLINE(  66)		int _hx_tmp2;
HXDLIN(  66)		if ((this->frame > (int)0)) {
HXLINE(  66)			_hx_tmp2 = this->frame;
            		}
            		else {
HXLINE(  66)			_hx_tmp2 = this->frames;
            		}
HXLINE(  65)		_hx_tmp1->__get((((this->lastState * this->frames) + _hx_tmp2) - (int)1)).StaticCast<  ::openfl::display::Tile >()->visible = false;
HXLINE(  68)		::Array< ::Dynamic> _hx_tmp3 = this->tiles;
HXDLIN(  68)		_hx_tmp3->__get(((this->state * this->frames) + this->frame)).StaticCast<  ::openfl::display::Tile >()->visible = true;
