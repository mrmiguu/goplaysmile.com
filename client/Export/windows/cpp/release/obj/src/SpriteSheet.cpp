...
void SpriteSheet_obj::__construct(::String file,Int frames,Int states,Float delay){
            	HX_STACK_FRAME("SpriteSheet","new",0x16cca22c,"SpriteSheet.new","SpriteSheet.hx",29,0x6645c6c4)
            	HX_STACK_THIS(this)
...
HXLINE(  36)		Int _hx_tmp = png->width;
HXDLIN(  36)		Int _hx_tmp1 = (this->frames = frames);
HXDLIN(  36)		HX_VARI( Int,w) = ::Std_obj::_hx_int(((Float)_hx_tmp / (Float)_hx_tmp1));
HXLINE(  37)		Int _hx_tmp2 = png->height;
HXDLIN(  37)		Int _hx_tmp3 = (this->states = states);
HXDLIN(  37)		HX_VARI( Int,h) = ::Std_obj::_hx_int(((Float)_hx_tmp2 / (Float)_hx_tmp3));
HXLINE(  40)		HX_VARI( ::Array< ::Dynamic>,_g) = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  40)		{
HXLINE(  40)			HX_VARI( Int,_g2) = (int)0;
HXDLIN(  40)			while((_g2 < states)){
HXLINE(  40)				HX_VARI( Int,s) = _g2++;
HXLINE(  41)				{
HXLINE(  41)					HX_VARI( Int,_g4) = (int)0;
HXDLIN(  41)					while((_g4 < frames)){
HXLINE(  41)						HX_VARI( Int,f) = _g4++;
HXDLIN(  41)						_g->push( ::openfl::geom::Rectangle_obj::__new((f * w),(s * h),w,h));
            					}
            				}
            			}
            		}
HXLINE(  39)		HX_VARI(  ::openfl::display::Tilemap,map) =  ::openfl::display::Tilemap_obj::__new(w,h, ::openfl::display::Tileset_obj::__new(png,_g),null());
...
HXLINE(  45)				HX_VARI_NAME( Int,s1,"s") = _g3++;
HXLINE(  46)				{
HXLINE(  46)					HX_VARI( Int,_g5) = (int)0;
HXDLIN(  46)					while((_g5 < frames)){
HXLINE(  46)						HX_VARI_NAME( Int,f1,"f") = _g5++;
HXDLIN(  46)						_g1->push( ::openfl::display::Tile_obj::__new(((s1 * frames) + f1),null(),null(),null(),null(),null()));
            					}
            				}
            			}
            		}
...
hx::ObjectPtr< SpriteSheet_obj > SpriteSheet_obj::__new(::String file,Int frames,Int states,Float delay)
{
	...
	_hx_result->__construct(file,frames,states,delay);
	return _hx_result;
}
...
void SpriteSheet_obj::begin(){
            	HX_STACK_FRAME("SpriteSheet","begin",0xf3ffc6f5,"SpriteSheet.begin","SpriteSheet.hx",55,0x6645c6c4)
            	HX_STACK_THIS(this)
            	}
...
void SpriteSheet_obj::during(){
            	HX_STACK_FRAME("SpriteSheet","during",0x9633a975,"SpriteSheet.during","SpriteSheet.hx",56,0x6645c6c4)
            	HX_STACK_THIS(this)
            	}
...
void SpriteSheet_obj::end(){
            	HX_STACK_FRAME("SpriteSheet","end",0x16c5d5a7,"SpriteSheet.end","SpriteSheet.hx",57,0x6645c6c4)
            	HX_STACK_THIS(this)
            	}
...
void SpriteSheet_obj::transition(){
            	HX_STACK_FRAME("SpriteSheet","transition",0x4495cd49,"SpriteSheet.transition","SpriteSheet.hx",59,0x6645c6c4)
            	HX_STACK_THIS(this)
HXLINE(  61)		Bool _hx_tmp = (this->frame == (int)0);
HXDLIN(  61)		if (_hx_tmp) {
HXLINE(  61)			this->begin();
            		}
            		else {
HXLINE(  62)			Bool _hx_tmp1 = (this->frame == (this->frames - (int)1));
...
HXLINE(  65)		Int _hx_tmp2 = (this->lastState * this->frames);
HXLINE(  66)		Int _hx_tmp3;
HXDLIN(  66)		if ((this->frame > (int)0)) {
HXLINE(  66)			_hx_tmp3 = this->frame;
            		}
            		else {
HXLINE(  66)			_hx_tmp3 = this->frames;
            		}
HXLINE(  65)		this->tiles->__get(((_hx_tmp2 + _hx_tmp3) - (int)1)).StaticCast<  ::openfl::display::Tile >()->visible = false;
HXLINE(  68)		Int _hx_tmp4 = ((this->state * this->frames) + this->frame);
HXDLIN(  68)		this->tiles->__get(_hx_tmp4).StaticCast<  ::openfl::display::Tile >()->visible = true;
HXLINE(  70)		this->lastState = this->state;
HXLINE(  72)		Int _hx_tmp5 = (this->frame + (int)1);
HXDLIN(  72)		this->frame = hx::Mod(_hx_tmp5,this->frames);
            	}
