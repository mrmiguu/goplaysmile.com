...
HX_DEFINE_STACK_FRAME(_hx_pos_7da90120c9111fe2_6_boot,"Cars","boot",0x1e6f4d01,"Cars.boot","Cars.hx",6,0x9a91021f)
HX_DEFINE_STACK_FRAME(_hx_pos_7da90120c9111fe2_7_boot,"Cars","boot",0x1e6f4d01,"Cars.boot","Cars.hx",7,0x9a91021f)

void Cars_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7da90120c9111fe2_5_new)
            	HX_STACK_THIS(this)
HXLINE(  15)		HX_VARI(  ::openfl::display::Tile,tile) =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  15)		HX_VARI(  ::openfl::display::Tileset,set) =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,null());
HXDLIN(  15)		set->addRect(png->rect);
HXDLIN(  15)		tile->set_tileset(set);
HXDLIN(  15)		this->v = tile;
HXLINE(  14)		HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  14)		HX_VARI_NAME(  ::openfl::display::Tileset,set1,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png1,null());
HXDLIN(  14)		set1->addRect(png1->rect);
HXDLIN(  14)		tile1->set_tileset(set1);
HXDLIN(  14)		this->i = tile1;
HXLINE(  13)		HX_VARI_NAME(  ::openfl::display::Tile,tile2,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  13)		HX_VARI_NAME(  ::openfl::display::Tileset,set2,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png2,null());
HXDLIN(  13)		set2->addRect(png2->rect);
HXDLIN(  13)		tile2->set_tileset(set2);
HXDLIN(  13)		this->b = tile2;
HXLINE(  12)		HX_VARI_NAME(  ::openfl::display::Tile,tile3,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  12)		HX_VARI_NAME(  ::openfl::display::Tileset,set3,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png3,null());
HXDLIN(  12)		set3->addRect(png3->rect);
HXDLIN(  12)		tile3->set_tileset(set3);
HXDLIN(  12)		this->g = tile3;
HXLINE(  11)		HX_VARI_NAME(  ::openfl::display::Tile,tile4,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  11)		HX_VARI_NAME(  ::openfl::display::Tileset,set4,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png4,null());
HXDLIN(  11)		set4->addRect(png4->rect);
HXDLIN(  11)		tile4->set_tileset(set4);
HXDLIN(  11)		this->y = tile4;
HXLINE(  10)		HX_VARI_NAME(  ::openfl::display::Tile,tile5,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  10)		HX_VARI_NAME(  ::openfl::display::Tileset,set5,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png5,null());
HXDLIN(  10)		set5->addRect(png5->rect);
HXDLIN(  10)		tile5->set_tileset(set5);
HXDLIN(  10)		this->o = tile5;
HXLINE(   9)		HX_VARI_NAME(  ::openfl::display::Tile,tile6,"tile") =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(   9)		HX_VARI_NAME(  ::openfl::display::Tileset,set6,"set") =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png6,null());
