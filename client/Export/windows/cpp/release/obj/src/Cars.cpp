...
HX_DEFINE_STACK_FRAME(_hx_pos_7da90120c9111fe2_5_new,"Cars","new",0xa4555671,"Cars.new","Cars.hx",5,0x9a91021f)
HX_LOCAL_STACK_FRAME(_hx_pos_7da90120c9111fe2_6_boot,"Cars","boot",0x1e6f4d01,"Cars.boot","Cars.hx",6,0x9a91021f)
HX_LOCAL_STACK_FRAME(_hx_pos_7da90120c9111fe2_7_boot,"Cars","boot",0x1e6f4d01,"Cars.boot","Cars.hx",7,0x9a91021f)

void Cars_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7da90120c9111fe2_5_new)
HXLINE(  15)		 ::openfl::display::Tile tile =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  15)		 ::openfl::display::BitmapData png = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/v.png",41,e5,ab,4b)),null());
HXDLIN(  15)		 ::openfl::display::Tileset set =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png,null());
HXDLIN(  15)		set->addRect(png->rect);
HXDLIN(  15)		tile->set_tileset(set);
HXDLIN(  15)		this->v = tile;
HXLINE(  14)		 ::openfl::display::Tile tile1 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  14)		 ::openfl::display::BitmapData png1 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/i.png",b4,5a,76,cf)),null());
HXDLIN(  14)		 ::openfl::display::Tileset set1 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png1,null());
HXDLIN(  14)		set1->addRect(png1->rect);
HXDLIN(  14)		tile1->set_tileset(set1);
HXDLIN(  14)		this->i = tile1;
HXLINE(  13)		 ::openfl::display::Tile tile2 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  13)		 ::openfl::display::BitmapData png2 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/b.png",2d,4b,a8,c7)),null());
HXDLIN(  13)		 ::openfl::display::Tileset set2 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png2,null());
HXDLIN(  13)		set2->addRect(png2->rect);
HXDLIN(  13)		tile2->set_tileset(set2);
HXDLIN(  13)		this->b = tile2;
HXLINE(  12)		 ::openfl::display::Tile tile3 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  12)		 ::openfl::display::BitmapData png3 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/g.png",b2,31,a9,a8)),null());
HXDLIN(  12)		 ::openfl::display::Tileset set3 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png3,null());
HXDLIN(  12)		set3->addRect(png3->rect);
HXDLIN(  12)		tile3->set_tileset(set3);
HXDLIN(  12)		this->g = tile3;
HXLINE(  11)		 ::openfl::display::Tile tile4 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  11)		 ::openfl::display::BitmapData png4 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/y.png",c4,a2,df,05)),null());
HXDLIN(  11)		 ::openfl::display::Tileset set4 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png4,null());
HXDLIN(  11)		set4->addRect(png4->rect);
HXDLIN(  11)		tile4->set_tileset(set4);
HXDLIN(  11)		this->y = tile4;
HXLINE(  10)		 ::openfl::display::Tile tile5 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(  10)		 ::openfl::display::BitmapData png5 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/o.png",ba,d5,dd,43)),null());
HXDLIN(  10)		 ::openfl::display::Tileset set5 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png5,null());
HXDLIN(  10)		set5->addRect(png5->rect);
HXDLIN(  10)		tile5->set_tileset(set5);
HXDLIN(  10)		this->o = tile5;
HXLINE(   9)		 ::openfl::display::Tile tile6 =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN(   9)		 ::openfl::display::BitmapData png6 = ::openfl::Assets_obj::getBitmapData((HX_("assets/",4c,2a,dc,36) + HX_("cars/r.png",3d,93,11,fe)),null());
HXDLIN(   9)		 ::openfl::display::Tileset set6 =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,png6,null());
...
bool Cars_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2c9349ff;
}
...
hx::ObjectPtr< Cars_obj > Cars_obj::__new() {
	hx::ObjectPtr< Cars_obj > __this = new Cars_obj();
	__this->__construct();
	return __this;
}

hx::ObjectPtr< Cars_obj > Cars_obj::__alloc(hx::Ctx *_hx_ctx) {
	Cars_obj *__this = (Cars_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Cars_obj), true, "Cars"));
	*(void **)__this = Cars_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
{
	hx::Object *dummy = new Cars_obj;
	Cars_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_7da90120c9111fe2_6_boot)
HXLINE(   6)		WIDTH = (int)78;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7da90120c9111fe2_7_boot)
