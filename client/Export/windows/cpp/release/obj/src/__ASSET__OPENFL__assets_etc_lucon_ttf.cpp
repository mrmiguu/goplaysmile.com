...
void __ASSET__OPENFL__assets_etc_lucon_ttf_obj::__construct(){
            	HX_STACK_FRAME("__ASSET__OPENFL__assets_etc_lucon_ttf","new",0x52a77d8b,"__ASSET__OPENFL__assets_etc_lucon_ttf.new","DefaultAssetLibrary.hx",3121,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE(3121)		this->_hx___fontPath = HX_("assets/etc/lucon.ttf",8a,7b,49,6b);
HXDLIN(3121)		this->name = HX_("Lucida Console",e3,71,b4,0b);
HXDLIN(3121)		super::__construct(null());
            	}
