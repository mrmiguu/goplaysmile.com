...
void __ASSET__assets_etc_lucon_ttf_obj::__construct(){
            	HX_STACK_FRAME("__ASSET__assets_etc_lucon_ttf","new",0xa27036db,"__ASSET__assets_etc_lucon_ttf.new","DefaultAssetLibrary.hx",3108,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE(3108)		this->_hx___fontPath = HX_("assets/etc/lucon.ttf",8a,7b,49,6b);
HXDLIN(3108)		this->name = HX_("Lucida Console",e3,71,b4,0b);
HXDLIN(3108)		super::__construct(null());
            	}
