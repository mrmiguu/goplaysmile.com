...
Dynamic TimerEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event TimerEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  20)		HX_VARI(  ::openfl::events::TimerEvent,event) =  ::openfl::events::TimerEvent_obj::__new(this->type,this->bubbles,this->cancelable);
...
::String TimerEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.TimerEvent","toString",0x793b7c4e,"openfl.events.TimerEvent.toString","openfl/events/TimerEvent.hx",31,0x5c7b7b12)
            	HX_STACK_THIS(this)
HXLINE(  31)		return this->_hx___formatToString(HX_("TimerEvent",35,32,87,fd),::Array_obj< ::String >::fromData( _hx_array_data_0,3));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.TimerEvent","boot",0xc33d36d4,"openfl.events.TimerEvent.boot","openfl/events/TimerEvent.hx",7,0x5c7b7b12)
HXLINE(   7)		TIMER = HX_("timer",c5,bf,35,10);
            	}
{
            	HX_STACK_FRAME("openfl.events.TimerEvent","boot",0xc33d36d4,"openfl.events.TimerEvent.boot","openfl/events/TimerEvent.hx",8,0x5c7b7b12)
