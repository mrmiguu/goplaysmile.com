...
void DOMRenderer_obj::__construct( ::openfl::display::Stage stage, ::lime::graphics::DOMRenderContext element){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","new",0x90a7aed0,"openfl._internal.renderer.dom.DOMRenderer.new","openfl/_internal/renderer/dom/DOMRenderer.hx",31,0xc812e2a0)
            	HX_STACK_THIS(this)
...
void DOMRenderer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","clear",0x7c37cbfd,"openfl._internal.renderer.dom.DOMRenderer.clear","openfl/_internal/renderer/dom/DOMRenderer.hx",123,0xc812e2a0)
            	HX_STACK_THIS(this)
...
HXLINE( 123)			Int _hx_tmp = _g1->get_length();
HXDLIN( 123)			if (!((_g < _hx_tmp))) {
HXLINE( 123)				goto _hx_goto_0;
            			}
HXDLIN( 123)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN( 123)			++_g;
...
void DOMRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",155,0xc812e2a0)
            	HX_STACK_THIS(this)
HXLINE( 157)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE( 159)		Bool _hx_tmp = !(this->stage->_hx___transparent);
...
void DOMRenderer_obj::applyStyle( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession,Bool setTransform,Bool setAlpha,Bool setClip){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","applyStyle",0x6484f073,"openfl._internal.renderer.dom.DOMRenderer.applyStyle","openfl/_internal/renderer/dom/DOMRenderer.hx",70,0xc812e2a0)
...
void DOMRenderer_obj::updateClip( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","updateClip",0x2f8d2909,"openfl._internal.renderer.dom.DOMRenderer.updateClip","openfl/_internal/renderer/dom/DOMRenderer.hx",178,0xc812e2a0)
            	HX_STACK_ARG(displayObject,"displayObject")
            	HX_STACK_ARG(renderSession,"renderSession")
