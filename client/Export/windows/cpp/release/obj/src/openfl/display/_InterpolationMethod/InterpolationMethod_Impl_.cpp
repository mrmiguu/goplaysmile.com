...
Dynamic InterpolationMethod_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic InterpolationMethod_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._InterpolationMethod.InterpolationMethod_Impl_","fromString",0x8e1d4c22,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.fromString","openfl/display/InterpolationMethod.hx",11,0x1fa1c725)
...
::String InterpolationMethod_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._InterpolationMethod.InterpolationMethod_Impl_","toString",0x7209ff33,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.toString","openfl/display/InterpolationMethod.hx",23,0x1fa1c725)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._InterpolationMethod.InterpolationMethod_Impl_","boot",0x602d2339,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.boot","openfl/display/InterpolationMethod.hx",6,0x1fa1c725)
HXLINE(   6)		LINEAR_RGB = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._InterpolationMethod.InterpolationMethod_Impl_","boot",0x602d2339,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.boot","openfl/display/InterpolationMethod.hx",7,0x1fa1c725)
HXLINE(   7)		RGB = (int)1;
            	}
}
