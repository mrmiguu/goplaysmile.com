...
HXLINE(  28)		this->x = x;
HXLINE(  29)		this->y = y;
HXLINE(  30)		this->width = width;
HXLINE(  31)		this->height = height;
            	}
...
Dynamic Rectangle_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::geom::Rectangle Rectangle_obj::clone(){
            	HX_STACK_FRAME("openfl.geom.Rectangle","clone",0x6896edaa,"openfl.geom.Rectangle.clone","openfl/geom/Rectangle.hx",38,0xf2fb2b03)
            	HX_STACK_THIS(this)
HXLINE(  38)		return  ::openfl::geom::Rectangle_obj::__new(this->x,this->y,this->width,this->height);
            	}
...
Bool Rectangle_obj::contains(Float x,Float y){
            	HX_STACK_FRAME("openfl.geom.Rectangle","contains",0x39912df2,"openfl.geom.Rectangle.contains","openfl/geom/Rectangle.hx",45,0xf2fb2b03)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(  45)		Bool _hx_tmp;
HXDLIN(  45)		Bool _hx_tmp1;
HXDLIN(  45)		if ((x >= this->x)) {
HXLINE(  45)			_hx_tmp1 = (y >= this->y);
            		}
            		else {
HXLINE(  45)			_hx_tmp1 = false;
            		}
HXDLIN(  45)		if (_hx_tmp1) {
HXLINE(  45)			Float _hx_tmp2 = this->get_right();
HXDLIN(  45)			_hx_tmp = (x < _hx_tmp2);
            		}
            		else {
HXLINE(  45)			_hx_tmp = false;
            		}
HXDLIN(  45)		if (_hx_tmp) {
HXLINE(  45)			Float _hx_tmp3 = this->get_bottom();
HXDLIN(  45)			return (y < _hx_tmp3);
            		}
            		else {
...
Bool Rectangle_obj::containsPoint( ::openfl::geom::Point point){
            	HX_STACK_FRAME("openfl.geom.Rectangle","containsPoint",0xa42628fe,"openfl.geom.Rectangle.containsPoint","openfl/geom/Rectangle.hx",52,0xf2fb2b03)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE(  52)		return this->contains(point->x,point->y);
            	}
...
Bool Rectangle_obj::containsRect( ::openfl::geom::Rectangle rect){
            	HX_STACK_FRAME("openfl.geom.Rectangle","containsRect",0x6ba48836,"openfl.geom.Rectangle.containsRect","openfl/geom/Rectangle.hx",59,0xf2fb2b03)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE(  59)		Bool _hx_tmp;
HXDLIN(  59)		if (!((rect->width <= (int)0))) {
HXLINE(  59)			_hx_tmp = (rect->height <= (int)0);
            		}
            		else {
...
HXDLIN(  61)			if ((rect->x > this->x)) {
HXLINE(  61)				_hx_tmp2 = (rect->y > this->y);
            			}
            			else {
HXLINE(  61)				_hx_tmp2 = false;
            			}
HXDLIN(  61)			if (_hx_tmp2) {
HXLINE(  61)				Float _hx_tmp3 = rect->get_right();
HXDLIN(  61)				Float _hx_tmp4 = this->get_right();
HXDLIN(  61)				_hx_tmp1 = (_hx_tmp3 < _hx_tmp4);
            			}
            			else {
HXLINE(  61)				_hx_tmp1 = false;
            			}
HXDLIN(  61)			if (_hx_tmp1) {
HXLINE(  61)				Float _hx_tmp5 = rect->get_bottom();
HXDLIN(  61)				Float _hx_tmp6 = this->get_bottom();
HXDLIN(  61)				return (_hx_tmp5 < _hx_tmp6);
            			}
            			else {
...
HXLINE(  65)				_hx_tmp8 = (rect->y >= this->y);
            			}
            			else {
HXLINE(  65)				_hx_tmp8 = false;
            			}
HXDLIN(  65)			if (_hx_tmp8) {
HXLINE(  65)				Float _hx_tmp9 = rect->get_right();
HXDLIN(  65)				Float _hx_tmp10 = this->get_right();
HXDLIN(  65)				_hx_tmp7 = (_hx_tmp9 <= _hx_tmp10);
            			}
            			else {
HXLINE(  65)				_hx_tmp7 = false;
            			}
HXDLIN(  65)			if (_hx_tmp7) {
HXLINE(  65)				Float _hx_tmp11 = rect->get_bottom();
HXDLIN(  65)				Float _hx_tmp12 = this->get_bottom();
HXDLIN(  65)				return (_hx_tmp11 <= _hx_tmp12);
            			}
            			else {
...
HXLINE(  74)		this->x = sourceRect->x;
HXLINE(  75)		this->y = sourceRect->y;
HXLINE(  76)		this->width = sourceRect->width;
HXLINE(  77)		this->height = sourceRect->height;
            	}
...
Bool Rectangle_obj::equals( ::openfl::geom::Rectangle toCompare){
            	HX_STACK_FRAME("openfl.geom.Rectangle","equals",0xcd1e1752,"openfl.geom.Rectangle.equals","openfl/geom/Rectangle.hx",84,0xf2fb2b03)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
HXLINE(  84)		Bool _hx_tmp;
HXDLIN(  84)		Bool _hx_tmp1;
HXDLIN(  84)		Bool _hx_tmp2;
HXDLIN(  84)		Bool _hx_tmp3 = hx::IsNotNull( toCompare );
HXDLIN(  84)		if (_hx_tmp3) {
HXLINE(  84)			_hx_tmp2 = (this->x == toCompare->x);
            		}
            		else {
HXLINE(  84)			_hx_tmp2 = false;
            		}
HXDLIN(  84)		if (_hx_tmp2) {
HXLINE(  84)			_hx_tmp1 = (this->y == toCompare->y);
            		}
            		else {
HXLINE(  84)			_hx_tmp1 = false;
            		}
HXDLIN(  84)		if (_hx_tmp1) {
HXLINE(  84)			_hx_tmp = (this->width == toCompare->width);
            		}
            		else {
HXLINE(  84)			_hx_tmp = false;
            		}
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  84)			return (this->height == toCompare->height);
            		}
            		else {
...
void Rectangle_obj::inflate(Float dx,Float dy){
            	...
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  91)		hx::SubEq(this->x,dx);
HXDLIN(  91)		hx::AddEq(this->width,(dx * (int)2));
HXLINE(  92)		hx::SubEq(this->y,dy);
HXDLIN(  92)		hx::AddEq(this->height,(dy * (int)2));
            	}
...
void Rectangle_obj::inflatePoint( ::openfl::geom::Point point){
            	HX_STACK_FRAME("openfl.geom.Rectangle","inflatePoint",0xf7c1779c,"openfl.geom.Rectangle.inflatePoint","openfl/geom/Rectangle.hx",99,0xf2fb2b03)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE(  99)		this->inflate(point->x,point->y);
            	}
...
HXLINE( 106)		HX_VAR( Float,x0);
HXDLIN( 106)		if ((this->x < toIntersect->x)) {
HXLINE( 106)			x0 = toIntersect->x;
            		}
            		else {
HXLINE( 106)			x0 = this->x;
            		}
HXLINE( 107)		HX_VAR( Float,x1);
HXDLIN( 107)		Float _hx_tmp = this->get_right();
HXDLIN( 107)		Float _hx_tmp1 = toIntersect->get_right();
HXDLIN( 107)		if ((_hx_tmp > _hx_tmp1)) {
HXLINE( 107)			x1 = toIntersect->get_right();
            		}
            		else {
HXLINE( 107)			x1 = this->get_right();
            		}
HXLINE( 109)		if ((x1 <= x0)) {
HXLINE( 111)			return  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            		}
HXLINE( 115)		HX_VAR( Float,y0);
HXDLIN( 115)		if ((this->y < toIntersect->y)) {
HXLINE( 115)			y0 = toIntersect->y;
            		}
            		else {
HXLINE( 115)			y0 = this->y;
            		}
HXLINE( 116)		HX_VAR( Float,y1);
HXDLIN( 116)		Float _hx_tmp2 = this->get_bottom();
HXDLIN( 116)		Float _hx_tmp3 = toIntersect->get_bottom();
HXDLIN( 116)		if ((_hx_tmp2 > _hx_tmp3)) {
HXLINE( 116)			y1 = toIntersect->get_bottom();
            		}
            		else {
HXLINE( 116)			y1 = this->get_bottom();
            		}
HXLINE( 118)		if ((y1 <= y0)) {
HXLINE( 120)			return  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            		}
HXLINE( 124)		return  ::openfl::geom::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
            	}
...
HXLINE( 132)		HX_VAR( Float,x1);
HXDLIN( 132)		Float _hx_tmp = this->get_right();
HXDLIN( 132)		Float _hx_tmp1 = toIntersect->get_right();
HXDLIN( 132)		if ((_hx_tmp > _hx_tmp1)) {
...
HXLINE( 141)		HX_VAR( Float,y1);
HXDLIN( 141)		Float _hx_tmp2 = this->get_bottom();
HXDLIN( 141)		Float _hx_tmp3 = toIntersect->get_bottom();
HXDLIN( 141)		if ((_hx_tmp2 > _hx_tmp3)) {
HXLINE( 141)			y1 = toIntersect->get_bottom();
            		}
            		else {
HXLINE( 141)			y1 = this->get_bottom();
            		}
HXLINE( 143)		return (y1 > y0);
            	}
...
Bool Rectangle_obj::isEmpty(){
            	HX_STACK_FRAME("openfl.geom.Rectangle","isEmpty",0x84f8a5d0,"openfl.geom.Rectangle.isEmpty","openfl/geom/Rectangle.hx",150,0xf2fb2b03)
            	HX_STACK_THIS(this)
HXLINE( 150)		if (!((this->width <= (int)0))) {
HXLINE( 150)			return (this->height <= (int)0);
            		}
            		else {
...
void Rectangle_obj::offset(Float dx,Float dy){
            	...
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 157)		hx::AddEq(this->x,dx);
HXLINE( 158)		hx::AddEq(this->y,dy);
            	}
...
void Rectangle_obj::offsetPoint( ::openfl::geom::Point point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 165)		hx::AddEq(this->x,point->x);
HXLINE( 166)		hx::AddEq(this->y,point->y);
            	}
...
void Rectangle_obj::setEmpty(){
            	HX_STACK_FRAME("openfl.geom.Rectangle","setEmpty",0x8b24775e,"openfl.geom.Rectangle.setEmpty","openfl/geom/Rectangle.hx",173,0xf2fb2b03)
            	HX_STACK_THIS(this)
HXLINE( 173)		this->x = (this->y = (this->width = (this->height = (int)0)));
            	}
...
HXLINE( 180)		this->x = xa;
HXLINE( 181)		this->y = ya;
HXLINE( 182)		this->width = widtha;
HXLINE( 183)		this->height = heighta;
            	}
...
::String Rectangle_obj::toString(){
            	HX_STACK_FRAME("openfl.geom.Rectangle","toString",0x4584a47f,"openfl.geom.Rectangle.toString","openfl/geom/Rectangle.hx",190,0xf2fb2b03)
            	HX_STACK_THIS(this)
HXLINE( 190)		return ((((((((HX_("(x=",ed,c2,1e,00) + this->x) + HX_(", y=",18,15,2e,1d)) + this->y) + HX_(", width=",eb,04,57,53)) + this->width) + HX_(", height=",82,32,07,68)) + this->height) + HX_(")",29,00,00,00));
            	}
...
HXDLIN( 197)		if ((this->width != (int)0)) {
HXLINE( 197)			_hx_tmp = (this->height == (int)0);
            		}
            		else {
HXLINE( 197)			_hx_tmp = true;
            		}
HXDLIN( 197)		if (_hx_tmp) {
HXLINE( 199)			return toUnion->clone();
            		}
            		else {
HXLINE( 201)			Bool _hx_tmp1;
HXDLIN( 201)			if ((toUnion->width != (int)0)) {
HXLINE( 201)				_hx_tmp1 = (toUnion->height == (int)0);
            			}
            			else {
HXLINE( 201)				_hx_tmp1 = true;
            			}
HXDLIN( 201)			if (_hx_tmp1) {
HXLINE( 203)				return this->clone();
            			}
            		}
HXLINE( 207)		HX_VAR( Float,x0);
HXDLIN( 207)		if ((this->x > toUnion->x)) {
HXLINE( 207)			x0 = toUnion->x;
            		}
            		else {
HXLINE( 207)			x0 = this->x;
            		}
HXLINE( 208)		HX_VAR( Float,x1);
HXDLIN( 208)		Float _hx_tmp2 = this->get_right();
HXDLIN( 208)		Float _hx_tmp3 = toUnion->get_right();
HXDLIN( 208)		if ((_hx_tmp2 < _hx_tmp3)) {
HXLINE( 208)			x1 = toUnion->get_right();
            		}
            		else {
HXLINE( 208)			x1 = this->get_right();
            		}
HXLINE( 209)		HX_VAR( Float,y0);
HXDLIN( 209)		if ((this->y > toUnion->y)) {
HXLINE( 209)			y0 = toUnion->y;
            		}
            		else {
HXLINE( 209)			y0 = this->y;
            		}
HXLINE( 210)		HX_VAR( Float,y1);
HXDLIN( 210)		Float _hx_tmp4 = this->get_bottom();
HXDLIN( 210)		Float _hx_tmp5 = toUnion->get_bottom();
HXDLIN( 210)		if ((_hx_tmp4 < _hx_tmp5)) {
HXLINE( 210)			y1 = toUnion->get_bottom();
            		}
            		else {
HXLINE( 210)			y1 = this->get_bottom();
            		}
HXLINE( 212)		return  ::openfl::geom::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
            	}
...
HXDLIN( 219)		if ((this->width == (int)0)) {
HXLINE( 219)			_hx_tmp = (this->height == (int)0);
            		}
            		else {
...
HXLINE( 225)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 226)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 227)		HX_VARI( Float,offsetRight) = ((Float)0.0);
HXLINE( 228)		HX_VARI( Float,offsetBottom) = ((Float)0.0);
HXLINE( 230)		if ((this->x < x)) {
HXLINE( 230)			offsetX = (x - this->x);
            		}
HXLINE( 231)		if ((this->y < y)) {
HXLINE( 231)			offsetY = (y - this->y);
            		}
HXLINE( 232)		Float _hx_tmp1 = this->get_right();
HXDLIN( 232)		if ((_hx_tmp1 > (x + width))) {
HXLINE( 232)			Float _hx_tmp2 = (x + width);
HXDLIN( 232)			Float _hx_tmp3 = this->get_right();
HXDLIN( 232)			offsetRight = (_hx_tmp2 - _hx_tmp3);
            		}
HXLINE( 233)		Float _hx_tmp4 = this->get_bottom();
HXDLIN( 233)		if ((_hx_tmp4 > (y + height))) {
HXLINE( 233)			Float _hx_tmp5 = (y + height);
HXDLIN( 233)			Float _hx_tmp6 = this->get_bottom();
HXDLIN( 233)			offsetBottom = (_hx_tmp5 - _hx_tmp6);
            		}
HXLINE( 235)		hx::AddEq(this->x,offsetX);
HXLINE( 236)		hx::AddEq(this->y,offsetY);
HXLINE( 237)		hx::AddEq(this->width,(offsetRight - offsetX));
HXLINE( 238)		hx::AddEq(this->height,(offsetBottom - offsetY));
            	}
...
HXDLIN( 245)		if ((this->width == (int)0)) {
HXLINE( 245)			_hx_tmp = (this->height == (int)0);
            		}
            		else {
...
HXLINE( 247)			this->x = x;
HXLINE( 248)			this->y = y;
HXLINE( 249)			this->width = width;
HXLINE( 250)			this->height = height;
HXLINE( 251)			return;
            		}
HXLINE( 255)		HX_VARI( Float,cacheRight) = this->get_right();
HXLINE( 256)		HX_VARI( Float,cacheBottom) = this->get_bottom();
HXLINE( 258)		Bool _hx_tmp1 = (this->x > x);
HXDLIN( 258)		if (_hx_tmp1) {
HXLINE( 260)			this->x = x;
HXLINE( 261)			this->width = (cacheRight - x);
            		}
HXLINE( 263)		Bool _hx_tmp2 = (this->y > y);
HXDLIN( 263)		if (_hx_tmp2) {
HXLINE( 265)			this->y = y;
HXLINE( 266)			this->height = (cacheBottom - y);
            		}
HXLINE( 268)		if ((cacheRight < (x + width))) {
HXLINE( 268)			this->width = ((x + width) - this->x);
            		}
HXLINE( 269)		if ((cacheBottom < (y + height))) {
HXLINE( 269)			this->height = ((y + height) - this->y);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(Rectangle_obj,_hx___expand,(void))
 ...
 ::lime::math::Rectangle Rectangle_obj::_hx___toLimeRectangle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 276)		Bool _hx_tmp = hx::IsNull( ::openfl::geom::Rectangle_obj::_hx___limeRectangle );
HXDLIN( 276)		if (_hx_tmp) {
HXLINE( 278)			::openfl::geom::Rectangle_obj::_hx___limeRectangle =  ::lime::math::Rectangle_obj::__new(null(),null(),null(),null());
            		}
HXLINE( 282)		::openfl::geom::Rectangle_obj::_hx___limeRectangle->setTo(this->x,this->y,this->width,this->height);
HXLINE( 283)		return ::openfl::geom::Rectangle_obj::_hx___limeRectangle;
            	}
...
void Rectangle_obj::_hx___transform( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix m){
            	...
            	HX_STACK_ARG(rect,"rect")
            	HX_STACK_ARG(m,"m")
HXLINE( 290)		HX_VARI( Float,tx0) = ((m->a * this->x) + (m->c * this->y));
HXLINE( 291)		HX_VARI( Float,tx1) = tx0;
HXLINE( 292)		HX_VARI( Float,ty0) = ((m->b * this->x) + (m->d * this->y));
HXLINE( 293)		HX_VARI( Float,ty1) = ty0;
HXLINE( 295)		HX_VARI( Float,tx) = ((m->a * (this->x + this->width)) + (m->c * this->y));
HXLINE( 296)		HX_VARI( Float,ty) = ((m->b * (this->x + this->width)) + (m->d * this->y));
HXLINE( 298)		Bool _hx_tmp = (tx < tx0);
HXDLIN( 298)		if (_hx_tmp) {
HXLINE( 298)			tx0 = tx;
            		}
HXLINE( 299)		Bool _hx_tmp1 = (ty < ty0);
HXDLIN( 299)		if (_hx_tmp1) {
HXLINE( 299)			ty0 = ty;
            		}
HXLINE( 300)		Bool _hx_tmp2 = (tx > tx1);
HXDLIN( 300)		if (_hx_tmp2) {
HXLINE( 300)			tx1 = tx;
            		}
HXLINE( 301)		Bool _hx_tmp3 = (ty > ty1);
HXDLIN( 301)		if (_hx_tmp3) {
HXLINE( 301)			ty1 = ty;
            		}
HXLINE( 303)		tx = ((m->a * (this->x + this->width)) + (m->c * (this->y + this->height)));
HXLINE( 304)		ty = ((m->b * (this->x + this->width)) + (m->d * (this->y + this->height)));
HXLINE( 306)		Bool _hx_tmp4 = (tx < tx0);
HXDLIN( 306)		if (_hx_tmp4) {
HXLINE( 306)			tx0 = tx;
            		}
HXLINE( 307)		Bool _hx_tmp5 = (ty < ty0);
HXDLIN( 307)		if (_hx_tmp5) {
HXLINE( 307)			ty0 = ty;
            		}
HXLINE( 308)		Bool _hx_tmp6 = (tx > tx1);
HXDLIN( 308)		if (_hx_tmp6) {
HXLINE( 308)			tx1 = tx;
            		}
HXLINE( 309)		Bool _hx_tmp7 = (ty > ty1);
HXDLIN( 309)		if (_hx_tmp7) {
HXLINE( 309)			ty1 = ty;
            		}
HXLINE( 311)		tx = ((m->a * this->x) + (m->c * (this->y + this->height)));
HXLINE( 312)		ty = ((m->b * this->x) + (m->d * (this->y + this->height)));
HXLINE( 314)		Bool _hx_tmp8 = (tx < tx0);
HXDLIN( 314)		if (_hx_tmp8) {
HXLINE( 314)			tx0 = tx;
            		}
HXLINE( 315)		Bool _hx_tmp9 = (ty < ty0);
HXDLIN( 315)		if (_hx_tmp9) {
HXLINE( 315)			ty0 = ty;
            		}
HXLINE( 316)		Bool _hx_tmp10 = (tx > tx1);
HXDLIN( 316)		if (_hx_tmp10) {
HXLINE( 316)			tx1 = tx;
            		}
HXLINE( 317)		Bool _hx_tmp11 = (ty > ty1);
HXDLIN( 317)		if (_hx_tmp11) {
HXLINE( 317)			ty1 = ty;
            		}
HXLINE( 319)		Float _hx_tmp12 = (tx0 + m->tx);
HXDLIN( 319)		Float _hx_tmp13 = (ty0 + m->ty);
HXDLIN( 319)		rect->setTo(_hx_tmp12,_hx_tmp13,(tx1 - tx0),(ty1 - ty0));
            	}
...
Float Rectangle_obj::get_bottom(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 331)		return (this->y + this->height);
            	}
...
Float Rectangle_obj::set_bottom(Float b){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
HXLINE( 332)		this->height = (b - this->y);
HXDLIN( 332)		return b;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_bottom,return )
 ...
 ::openfl::geom::Point Rectangle_obj::get_bottomRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 333)		return  ::openfl::geom::Point_obj::__new((this->x + this->width),(this->y + this->height));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Rectangle_obj,get_bottomRight,return )
 ...
 ::openfl::geom::Point Rectangle_obj::set_bottomRight( ::openfl::geom::Point p){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
HXLINE( 334)		this->width = (p->x - this->x);
HXDLIN( 334)		this->height = (p->y - this->y);
HXDLIN( 334)		return p->clone();
            	}
...
Float Rectangle_obj::set_left(Float l){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
HXLINE( 336)		hx::SubEq(this->width,(l - this->x));
HXDLIN( 336)		this->x = l;
HXDLIN( 336)		return l;
            	}
...
Float Rectangle_obj::get_right(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 337)		return (this->x + this->width);
            	}
...
Float Rectangle_obj::set_right(Float r){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
HXLINE( 338)		this->width = (r - this->x);
HXDLIN( 338)		return r;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_right,return )
 ...
 ::openfl::geom::Point Rectangle_obj::get_size(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 339)		return  ::openfl::geom::Point_obj::__new(this->width,this->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Rectangle_obj,get_size,return )
 ...
 ::openfl::geom::Point Rectangle_obj::set_size( ::openfl::geom::Point p){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
HXLINE( 340)		this->width = p->x;
HXDLIN( 340)		this->height = p->y;
...
Float Rectangle_obj::set_top(Float t){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 342)		hx::SubEq(this->height,(t - this->y));
HXDLIN( 342)		this->y = t;
HXDLIN( 342)		return t;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_top,return )
 ...
 ::openfl::geom::Point Rectangle_obj::get_topLeft(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 343)		return  ::openfl::geom::Point_obj::__new(this->x,this->y);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Rectangle_obj,get_topLeft,return )
 ...
 ::openfl::geom::Point Rectangle_obj::set_topLeft( ::openfl::geom::Point p){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(p,"p")
HXLINE( 344)		this->x = p->x;
HXDLIN( 344)		this->y = p->y;
HXDLIN( 344)		return p->clone();
            	}
...
{
{
            	HX_STACK_FRAME("openfl.geom.Rectangle","boot",0x09003285,"openfl.geom.Rectangle.boot","openfl/geom/Rectangle.hx",11,0xf2fb2b03)
HXLINE(  11)		_hx___temp =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            	}
}
