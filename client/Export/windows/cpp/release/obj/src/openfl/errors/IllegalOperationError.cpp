...
HX_DEFINE_STACK_FRAME(_hx_pos_4cf27cf07614edf1_7_new,"openfl.errors.IllegalOperationError","new",0x7489b4a4,"openfl.errors.IllegalOperationError.new","openfl/errors/IllegalOperationError.hx",7,0x72707d6c)
namespace openfl{
namespace errors{
...
::String message = __o_message.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_4cf27cf07614edf1_7_new)
