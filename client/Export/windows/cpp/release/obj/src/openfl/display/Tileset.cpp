...
HX_LOCAL_STACK_FRAME(_hx_pos_7b61decb5082045e_37_addRect,"openfl.display.Tileset","addRect",0x4caf7981,"openfl.display.Tileset.addRect","openfl/display/Tileset.hx",37,0x8bc15676)
HX_LOCAL_STACK_FRAME(_hx_pos_7b61decb5082045e_50_clone,"openfl.display.Tileset","clone",0xb9a11df9,"openfl.display.Tileset.clone","openfl/display/Tileset.hx",50,0x8bc15676)
HX_LOCAL_STACK_FRAME(_hx_pos_7b61decb5082045e_67_getRect,"openfl.display.Tileset","getRect",0xe2f4e676,"openfl.display.Tileset.getRect","openfl/display/Tileset.hx",67,0x8bc15676)
HX_LOCAL_STACK_FRAME(_hx_pos_7b61decb5082045e_87_set_bitmapData,"openfl.display.Tileset","set_bitmapData",0x56e7e85a,"openfl.display.Tileset.set_bitmapData","openfl/display/Tileset.hx",87,0x8bc15676)
namespace openfl{
namespace display{
...
HXLINE(  26)				 ::openfl::geom::Rectangle rect = rects->__get(_g).StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(  41)		 ::openfl::display::_Tileset::TileData tileData =  ::openfl::display::_Tileset::TileData_obj::__alloc( HX_CTX ,rect);
...
HXLINE(  52)		 ::openfl::display::Tileset tileset =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,this->bitmapData,null());
HXLINE(  53)		 ::openfl::geom::Rectangle rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE(  55)		{
HXLINE(  55)			int _g = (int)0;
HXDLIN(  55)			::Array< ::Dynamic> _g1 = this->_hx___data;
HXDLIN(  55)			while((_g < _g1->length)){
HXLINE(  55)				 ::openfl::display::_Tileset::TileData tileData = _g1->__get(_g).StaticCast<  ::openfl::display::_Tileset::TileData >();
...
HXDLIN(  91)			::Array< ::Dynamic> _g1 = this->_hx___data;
HXDLIN(  91)			while((_g < _g1->length)){
HXLINE(  91)				 ::openfl::display::_Tileset::TileData data = _g1->__get(_g).StaticCast<  ::openfl::display::_Tileset::TileData >();
