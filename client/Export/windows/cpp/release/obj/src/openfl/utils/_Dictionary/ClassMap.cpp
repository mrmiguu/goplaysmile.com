...
void ClassMap_obj::__construct(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","new",0xf688c28a,"openfl.utils._Dictionary.ClassMap.new","openfl/utils/Dictionary.hx",186,0x5979b1eb)
            	HX_STACK_THIS(this)
HXLINE( 188)		this->types =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 189)		this->values =  ::haxe::ds::StringMap_obj::__new();
            	}
...
static ::haxe::IMap_obj _hx_openfl_utils__Dictionary_ClassMap__hx_haxe_IMap= {
	...
	( void (hx::Object::*)( ::Dynamic, ::Dynamic))&::openfl::utils::_Dictionary::ClassMap_obj::set,
...
Bool ClassMap_obj::exists( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","exists",0xb39161f2,"openfl.utils._Dictionary.ClassMap.exists","openfl/utils/Dictionary.hx",196,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 196)		return this->types->exists(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,exists,return )
 ...
 ::Dynamic ClassMap_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","get",0xf68372c0,"openfl.utils._Dictionary.ClassMap.get","openfl/utils/Dictionary.hx",203,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 203)		return this->values->get(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,get,return )
 ...
 ::Dynamic ClassMap_obj::keys(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","keys",0xbf25d48a,"openfl.utils._Dictionary.ClassMap.keys","openfl/utils/Dictionary.hx",210,0x5979b1eb)
            	HX_STACK_THIS(this)
HXLINE( 210)		return this->types->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,keys,return )
 ...
 ::Dynamic ClassMap_obj::iterator(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","iterator",0xc9353f84,"openfl.utils._Dictionary.ClassMap.iterator","openfl/utils/Dictionary.hx",217,0x5979b1eb)
            	HX_STACK_THIS(this)
HXLINE( 217)		return this->values->iterator();
            	}
...
Bool ClassMap_obj::remove( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","remove",0xf839e05a,"openfl.utils._Dictionary.ClassMap.remove","openfl/utils/Dictionary.hx",222,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 224)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
HXLINE( 225)		Bool _hx_tmp = !(this->types->remove(name));
HXDLIN( 225)		if (_hx_tmp) {
HXLINE( 225)			return this->values->remove(name);
            		}
            		else {
...
void ClassMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","set",0xf68c8dcc,"openfl.utils._Dictionary.ClassMap.set","openfl/utils/Dictionary.hx",230,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
            	HX_STACK_ARG(value,"value")
HXLINE( 232)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
HXLINE( 234)		this->types->set(name,key);
HXLINE( 235)		this->values->set(name,value);
            	}
...
::String ClassMap_obj::toString(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","toString",0x6e09c642,"openfl.utils._Dictionary.ClassMap.toString","openfl/utils/Dictionary.hx",242,0x5979b1eb)
            	HX_STACK_THIS(this)
HXLINE( 242)		return this->values->toString();
            	}
