...
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_151_new,"openfl.utils._Dictionary.ClassMap","new",0xf688c28a,"openfl.utils._Dictionary.ClassMap.new","openfl/utils/Dictionary.hx",151,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_161_exists,"openfl.utils._Dictionary.ClassMap","exists",0xb39161f2,"openfl.utils._Dictionary.ClassMap.exists","openfl/utils/Dictionary.hx",161,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_168_get,"openfl.utils._Dictionary.ClassMap","get",0xf68372c0,"openfl.utils._Dictionary.ClassMap.get","openfl/utils/Dictionary.hx",168,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_175_keys,"openfl.utils._Dictionary.ClassMap","keys",0xbf25d48a,"openfl.utils._Dictionary.ClassMap.keys","openfl/utils/Dictionary.hx",175,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_182_iterator,"openfl.utils._Dictionary.ClassMap","iterator",0xc9353f84,"openfl.utils._Dictionary.ClassMap.iterator","openfl/utils/Dictionary.hx",182,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_187_remove,"openfl.utils._Dictionary.ClassMap","remove",0xf839e05a,"openfl.utils._Dictionary.ClassMap.remove","openfl/utils/Dictionary.hx",187,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_195_set,"openfl.utils._Dictionary.ClassMap","set",0xf68c8dcc,"openfl.utils._Dictionary.ClassMap.set","openfl/utils/Dictionary.hx",195,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_207_toString,"openfl.utils._Dictionary.ClassMap","toString",0x6e09c642,"openfl.utils._Dictionary.ClassMap.toString","openfl/utils/Dictionary.hx",207,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void ClassMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e4d60601e770703e_151_new)
HXLINE( 153)		this->types =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 154)		this->values =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool ClassMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_161_exists)
HXLINE( 161)		::Dynamic this1 = this->types;
HXDLIN( 161)		return ( ( ::haxe::ds::StringMap)(this1) )->exists(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,exists,return )
 ...
 ::Dynamic ClassMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_168_get)
HXLINE( 168)		::Dynamic this1 = this->values;
HXDLIN( 168)		return ( ( ::haxe::ds::StringMap)(this1) )->get(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,get,return )
 ...
 ::Dynamic ClassMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_175_keys)
HXLINE( 175)		return this->types->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,keys,return )
 ...
 ::Dynamic ClassMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_182_iterator)
HXLINE( 182)		return this->values->iterator();
            	}
...
bool ClassMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_187_remove)
HXLINE( 189)		::String name = ::Type_obj::getClassName(key);
HXLINE( 190)		if (!(this->types->remove(name))) {
HXLINE( 190)			return this->values->remove(name);
            		}
            		else {
...
void ClassMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_195_set)
HXLINE( 197)		::String name = ::Type_obj::getClassName(key);
HXLINE( 199)		this->types->set(name,key);
HXLINE( 200)		this->values->set(name,value);
            	}
...
::String ClassMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_207_toString)
HXLINE( 207)		return this->values->toString();
            	}
