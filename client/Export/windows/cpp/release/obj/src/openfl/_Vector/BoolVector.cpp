...
void BoolVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::Array< Bool > array){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","new",0x3a8665a9,"openfl._Vector.BoolVector.new","openfl/Vector.hx",295,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 297)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN( 297)		if (_hx_tmp) {
HXLINE( 299)			array = ::Array_obj< Bool >::__new();
            		}
HXLINE( 303)		this->_hx___array = array;
HXLINE( 305)		Bool _hx_tmp1 = hx::IsNotNull( length );
...
::Dynamic BoolVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","concat",0x25e9276b,"openfl._Vector.BoolVector.concat","openfl/Vector.hx",318,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 318)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN( 318)		if (_hx_tmp) {
HXLINE( 320)			::Array< Bool > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 320)			return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE( 324)			::Array< Bool > _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::BoolVector >::cast(a)->_hx___array);
HXDLIN( 324)			return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic BoolVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","copy",0xf3d4c64c,"openfl._Vector.BoolVector.copy","openfl/Vector.hx",333,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 333)		Bool _hx_tmp = this->fixed;
HXDLIN( 333)		::Array< Bool > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 333)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
Bool BoolVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","get",0x3a8115df,"openfl._Vector.BoolVector.get","openfl/Vector.hx",340,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int BoolVector_obj::indexOf(Bool x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.BoolVector","indexOf",0xd8a0b692,"openfl._Vector.BoolVector.indexOf","openfl/Vector.hx",353,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
void BoolVector_obj::insertAt(Int index,Bool element){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","insertAt",0xaf7e1ea3,"openfl._Vector.BoolVector.insertAt","openfl/Vector.hx",372,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,insertAt,(void))
 ...
 ::Dynamic BoolVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","iterator",0x80f8ec05,"openfl._Vector.BoolVector.iterator","openfl/Vector.hx",383,0x4a01873c)
            	HX_STACK_THIS(this)
...
::String BoolVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","join",0xf8753e81,"openfl._Vector.BoolVector.join","openfl/Vector.hx",390,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int BoolVector_obj::lastIndexOf(Bool x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.BoolVector","lastIndexOf",0xfa91835c,"openfl._Vector.BoolVector.lastIndexOf","openfl/Vector.hx",395,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,lastIndexOf,return )
 ...
 ::Dynamic BoolVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","pop",0x3a87f2da,"openfl._Vector.BoolVector.pop","openfl/Vector.hx",413,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 413)		Bool _hx_tmp = !(this->fixed);
...
Int BoolVector_obj::push(Bool x){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","push",0xfc711c71,"openfl._Vector.BoolVector.push","openfl/Vector.hx",428,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 428)		Bool _hx_tmp = !(this->fixed);
...
void BoolVector_obj::reverse(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","reverse",0x12dda6eb,"openfl._Vector.BoolVector.reverse","openfl/Vector.hx",443,0x4a01873c)
            	HX_STACK_THIS(this)
...
Bool BoolVector_obj::set(Int index,Bool value){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","set",0x3a8a30eb,"openfl._Vector.BoolVector.set","openfl/Vector.hx",450,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,set,return )
 ...
 ::Dynamic BoolVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","shift",0x981c260b,"openfl._Vector.BoolVector.shift","openfl/Vector.hx",465,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 465)		Bool _hx_tmp = !(this->fixed);
...
::Dynamic BoolVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.BoolVector","slice",0x9ac0fddb,"openfl._Vector.BoolVector.slice","openfl/Vector.hx",480,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE( 480)		::Array< Bool > _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN( 480)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void BoolVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","sort",0xfe6831f5,"openfl._Vector.BoolVector.sort","openfl/Vector.hx",487,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
::Dynamic BoolVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","splice",0x1db7a3d3,"openfl._Vector.BoolVector.splice","openfl/Vector.hx",494,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE( 494)		::Array< Bool > _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN( 494)		return  ::openfl::_Vector::BoolVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String BoolVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","toString",0x25cd72c3,"openfl._Vector.BoolVector.toString","openfl/Vector.hx",501,0x4a01873c)
            	HX_STACK_THIS(this)
...
void BoolVector_obj::unshift(Bool x){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","unshift",0x70955152,"openfl._Vector.BoolVector.unshift","openfl/Vector.hx",508,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 508)		Bool _hx_tmp = !(this->fixed);
...
Int BoolVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","get_length",0x8b6b9a86,"openfl._Vector.BoolVector.get_length","openfl/Vector.hx",526,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int BoolVector_obj::set_length(Int value){
            	HX_STACK_FRAME("openfl._Vector.BoolVector","set_length",0x8ee938fa,"openfl._Vector.BoolVector.set_length","openfl/Vector.hx",531,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 533)		Bool _hx_tmp = !(this->fixed);
