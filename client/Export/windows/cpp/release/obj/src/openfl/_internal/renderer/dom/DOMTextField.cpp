...
HX_LOCAL_STACK_FRAME(_hx_pos_584059f88c62c757_356___getAttributeMatch,"openfl._internal.renderer.dom.DOMTextField","__getAttributeMatch",0x294ef003,"openfl._internal.renderer.dom.DOMTextField.__getAttributeMatch","openfl/_internal/renderer/dom/DOMTextField.hx",356,0xc9b27f2c)
...
::String DOMTextField_obj::_hx___getAttributeMatch( ::EReg regex){
            	HX_STACKFRAME(&_hx_pos_584059f88c62c757_356___getAttributeMatch)
HXLINE( 356)		if (hx::IsNotNull( regex->matched((int)2) )) {
HXLINE( 356)			return regex->matched((int)2);
            		}
            		else {
HXLINE( 356)			return regex->matched((int)3);
            		}
...
HXLINE(  22)		_hx___regexColor =  ::EReg_obj::__alloc( HX_CTX ,HX_("color=(\"#([^\"]+)\"|'#([^']+)')",36,15,0f,76),HX_("i",69,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_23_boot)
HXLINE(  23)		_hx___regexFace =  ::EReg_obj::__alloc( HX_CTX ,HX_("face=(\"([^\"]+)\"|'([^']+)')",1e,00,2b,89),HX_("i",69,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_24_boot)
HXLINE(  24)		_hx___regexFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("<font ([^>]+)>",eb,24,d0,0a),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_25_boot)
HXLINE(  25)		_hx___regexCloseFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("</font>",3c,82,5f,8e),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_584059f88c62c757_26_boot)
HXLINE(  26)		_hx___regexSize =  ::EReg_obj::__alloc( HX_CTX ,HX_("size=(\"([^\"]+)\"|'([^']+)')>",bc,32,a4,3e),HX_("i",69,00,00,00));
            	}
}
