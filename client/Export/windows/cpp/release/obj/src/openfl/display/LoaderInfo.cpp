...
void LoaderInfo_obj::_hx___complete(){
            	HX_STACK_FRAME("openfl.display.LoaderInfo","__complete",0x9858c05c,"openfl.display.LoaderInfo.__complete","openfl/display/LoaderInfo.hx",79,0x88528a51)
            	HX_STACK_THIS(this)
HXLINE(  79)		Bool _hx_tmp = !(this->_hx___completed);
HXDLIN(  79)		if (_hx_tmp) {
HXLINE(  81)			Bool _hx_tmp1 = (this->bytesLoaded < this->bytesTotal);
...
HXLINE(  90)			this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
HXLINE( 102)		this->dispatchEvent( ::openfl::events::ProgressEvent_obj::__new(HX_("progress",ad,f7,2a,86),false,false,bytesLoaded,bytesTotal));
            	}
...
HXLINE(  59)		HX_VARI(  ::openfl::display::LoaderInfo,loaderInfo) =  ::openfl::display::LoaderInfo_obj::__new();
HXLINE(  60)		loaderInfo->uncaughtErrorEvents =  ::openfl::events::UncaughtErrorEvents_obj::__new();
HXLINE(  62)		Bool _hx_tmp = hx::IsNotNull( loader );
...
{
{
            	HX_STACK_FRAME("openfl.display.LoaderInfo","boot",0xb25bbc75,"openfl.display.LoaderInfo.boot","openfl/display/LoaderInfo.hx",19,0x88528a51)
