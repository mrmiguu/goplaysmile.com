...
void DynamicTextSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.DynamicTextSymbol","new",0x78d87e53,"openfl._internal.symbols.DynamicTextSymbol.new","openfl/_internal/symbols/DynamicTextSymbol.hx",39,0xa6a1bd40)
            	HX_STACK_THIS(this)
...
Dynamic DynamicTextSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject DynamicTextSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.DynamicTextSymbol","__createObject",0x2c1ac2e8,"openfl._internal.symbols.DynamicTextSymbol.__createObject","openfl/_internal/symbols/DynamicTextSymbol.hx",44,0xa6a1bd40)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  46)		HX_VARI(  ::openfl::text::TextField,textField) =  ::openfl::text::TextField_obj::__new();
HXLINE(  47)		textField->_hx___fromSymbol(swf,hx::ObjectPtr<OBJ_>(this));
HXLINE(  48)		return textField;
            	}
