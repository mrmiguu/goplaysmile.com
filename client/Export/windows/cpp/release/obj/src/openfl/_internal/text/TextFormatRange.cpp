...
void TextFormatRange_obj::__construct( ::openfl::text::TextFormat format,Int start,Int end){
            	HX_STACK_FRAME("openfl._internal.text.TextFormatRange","new",0x4f23249a,"openfl._internal.text.TextFormatRange.new","openfl/_internal/text/TextFormatRange.hx",20,0x601dbd55)
            	HX_STACK_THIS(this)
