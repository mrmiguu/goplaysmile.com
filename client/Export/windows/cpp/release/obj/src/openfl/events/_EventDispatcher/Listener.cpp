...
void Listener_obj::__construct( ::Dynamic callback,Bool useCapture,Int priority){
            	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",357,0xe2270714)
            	HX_STACK_THIS(this)
...
Bool Listener_obj::match( ::Dynamic callback,Bool useCapture){
            	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",368,0xe2270714)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(useCapture,"useCapture")
HXLINE( 368)		Bool _hx_tmp = ::Reflect_obj::compareMethods(this->callback,callback);
