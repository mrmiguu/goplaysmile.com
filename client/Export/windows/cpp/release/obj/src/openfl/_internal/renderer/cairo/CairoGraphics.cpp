...
HXLINE( 596)						if (stroke) {
HXLINE( 598)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::closePath(::openfl::_internal::renderer::cairo::CairoGraphics_obj::hasStroke);
            						}
HXLINE( 602)						::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->moveTo((positionX - offsetX),(positionY - offsetY));
HXLINE( 604)						Bool _hx_tmp74 = hx::IsNull( c12->buffer->o->__get(c12->oPos) );
HXDLIN( 604)						if (_hx_tmp74) {
...
HXLINE( 612)							Float _hx_tmp75;
HXDLIN( 612)							if (hx::IsGreater( c12->buffer->o->__get(c12->oPos),(int)0 )) {
HXLINE( 612)								_hx_tmp75 = c12->buffer->o->__get(c12->oPos);
            							}
            							else {
HXLINE( 612)								_hx_tmp75 = (int)1;
            							}
HXDLIN( 612)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->set_lineWidth(_hx_tmp75);
HXLINE( 614)							Bool _hx_tmp76 = hx::IsNull( c12->buffer->o->__get((c12->oPos + (int)3)) );
HXDLIN( 614)							if (_hx_tmp76) {
...
HXDLIN( 620)								Int _hx_tmp77;
HXDLIN( 620)								 ::Dynamic _hx_switch_1 = _g21;
            								if (  (_hx_switch_1==(int)0) ){
HXLINE( 620)									_hx_tmp77 = (int)2;
HXDLIN( 620)									goto _hx_goto_9;
            								}
            								if (  (_hx_switch_1==(int)1) ){
HXLINE( 620)									_hx_tmp77 = (int)0;
HXDLIN( 620)									goto _hx_goto_9;
            								}
            								/* default */{
HXLINE( 620)									_hx_tmp77 = (int)1;
            								}
            								_hx_goto_9:;
HXDLIN( 620)								::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->set_lineJoin(_hx_tmp77);
            							}
HXLINE( 630)							Bool _hx_tmp78 = hx::IsNull( c12->buffer->o->__get((c12->oPos + (int)2)) );
HXDLIN( 630)							if (_hx_tmp78) {
...
HXDLIN( 636)								Int _hx_tmp79;
HXDLIN( 636)								 ::Dynamic _hx_switch_2 = _g22;
            								if (  (_hx_switch_2==(int)0) ){
HXLINE( 636)									_hx_tmp79 = (int)0;
HXDLIN( 636)									goto _hx_goto_10;
            								}
            								if (  (_hx_switch_2==(int)2) ){
HXLINE( 636)									_hx_tmp79 = (int)2;
HXDLIN( 636)									goto _hx_goto_10;
            								}
            								/* default */{
HXLINE( 636)									_hx_tmp79 = (int)1;
            								}
            								_hx_goto_10:;
HXDLIN( 636)								::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->set_lineCap(_hx_tmp79);
            							}
HXLINE( 646)							Int _hx_tmp80 = (c12->fPos + (int)1);
HXDLIN( 646)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->set_miterLimit(c12->buffer->f->__get(_hx_tmp80));
...
HXLINE( 652)							Bool _hx_tmp81 = (c12->buffer->f->__get(c12->fPos) == (int)1);
HXDLIN( 652)							if (_hx_tmp81) {
...
HXLINE( 658)								::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokePattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createRGBA(r,g,b,c12->buffer->f->__get(c12->fPos));
            					...
            					case (int)15: {
HXLINE( 574)						{
HXLINE( 574)							Int _hx_tmp82 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 574)							switch((int)(_hx_tmp82)){
            								case (int)0: {
...
HXLINE( 576)						Float _hx_tmp83 = (c13->buffer->f->__get(c13->fPos) - offsetX);
HXDLIN( 576)						Float _hx_tmp84 = c13->buffer->f->__get((c13->fPos + (int)1));
HXDLIN( 576)						::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->lineTo(_hx_tmp83,(_hx_tmp84 - offsetY));
...
HXLINE( 579)						positionY = c13->buffer->f->__get((c13->fPos + (int)1));
            					...
            					case (int)16: {
HXLINE( 583)						{
HXLINE( 583)							Int _hx_tmp85 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 583)							switch((int)(_hx_tmp85)){
            								case (int)0: {
...
HXLINE( 584)						Float _hx_tmp86 = (c14->buffer->f->__get(c14->fPos) - offsetX);
HXDLIN( 584)						Float _hx_tmp87 = c14->buffer->f->__get((c14->fPos + (int)1));
HXDLIN( 584)						::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->moveTo(_hx_tmp86,(_hx_tmp87 - offsetY));
...
HXLINE( 591)						startY = c14->buffer->f->__get((c14->fPos + (int)1));
            					...
            					default:{
HXLINE( 914)						{
HXLINE( 914)							Int _hx_tmp88 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 914)							switch((int)(_hx_tmp88)){
            								case (int)0: {
...
HXLINE( 924)			Bool _hx_tmp89;
HXDLIN( 924)			if (stroke) {
HXLINE( 924)				_hx_tmp89 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::hasStroke;
            			}
            			else {
HXLINE( 924)				_hx_tmp89 = false;
            			}
HXDLIN( 924)			if (_hx_tmp89) {
HXLINE( 926)				Bool _hx_tmp90;
HXDLIN( 926)				if (::openfl::_internal::renderer::cairo::CairoGraphics_obj::hasFill) {
HXLINE( 926)					_hx_tmp90 = closeGap;
            				}
            				else {
HXLINE( 926)					_hx_tmp90 = false;
            				}
HXDLIN( 926)				if (_hx_tmp90) {
HXLINE( 928)					::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->lineTo((startX - offsetX),(startY - offsetY));
            				}
            				else {
HXLINE( 930)					Bool _hx_tmp91;
HXDLIN( 930)					Bool _hx_tmp92;
HXDLIN( 930)					if (closeGap) {
HXLINE( 930)						_hx_tmp92 = (positionX == startX);
            					}
            					else {
HXLINE( 930)						_hx_tmp92 = false;
            					}
HXDLIN( 930)					if (_hx_tmp92) {
HXLINE( 930)						_hx_tmp91 = (positionY == startY);
            					}
            					else {
HXLINE( 930)						_hx_tmp91 = false;
            					}
HXDLIN( 930)					if (_hx_tmp91) {
...
HXLINE( 937)				Bool _hx_tmp93 = !(::openfl::_internal::renderer::cairo::CairoGraphics_obj::hitTesting);
HXDLIN( 937)				if (_hx_tmp93) {
HXLINE( 937)					::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->strokePreserve();
            				}
            			}
HXLINE( 941)			Bool _hx_tmp94;
HXDLIN( 941)			if (!(stroke)) {
HXLINE( 941)				_hx_tmp94 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::hasFill;
            			}
            			else {
HXLINE( 941)				_hx_tmp94 = false;
            			}
HXDLIN( 941)			if (_hx_tmp94) {
...
HXLINE( 945)				Bool _hx_tmp95 = hx::IsNotNull( ::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillPatternMatrix );
HXDLIN( 945)				if (_hx_tmp95) {
...
HXLINE( 950)					Bool _hx_tmp96 = hx::IsNotNull( ::openfl::_internal::renderer::cairo::CairoGraphics_obj::pendingMatrix );
HXDLIN( 950)					if (_hx_tmp96) {
HXLINE( 952)						matrix->concat(::openfl::_internal::renderer::cairo::CairoGraphics_obj::pendingMatrix);
            					}
HXLINE( 956)					 ::Dynamic _hx_tmp97 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillPattern;
HXDLIN( 956)					 ::lime::math::Matrix3 _hx_tmp98 = matrix->_hx___toMatrix3();
HXDLIN( 956)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_matrix(_hx_tmp97,_hx_tmp98);
            				}
...
HXLINE( 962)				Bool _hx_tmp99 = hx::IsNotNull( ::openfl::_internal::renderer::cairo::CairoGraphics_obj::pendingMatrix );
HXDLIN( 962)				if (_hx_tmp99) {
HXLINE( 964)					 ::lime::math::Matrix3 _hx_tmp100 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::pendingMatrix->_hx___toMatrix3();
HXDLIN( 964)					::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->transform(_hx_tmp100);
HXLINE( 965)					Bool _hx_tmp101 = !(::openfl::_internal::renderer::cairo::CairoGraphics_obj::hitTesting);
HXDLIN( 965)					if (_hx_tmp101) {
HXLINE( 965)						::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->fillPreserve();
            					}
HXLINE( 966)					 ::lime::math::Matrix3 _hx_tmp102 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::inversePendingMatrix->_hx___toMatrix3();
HXDLIN( 966)					::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->transform(_hx_tmp102);
            				}
            				else {
HXLINE( 970)					Bool _hx_tmp103 = !(::openfl::_internal::renderer::cairo::CairoGraphics_obj::hitTesting);
HXDLIN( 970)					if (_hx_tmp103) {
