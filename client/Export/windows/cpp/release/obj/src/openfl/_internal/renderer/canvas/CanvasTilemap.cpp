...
hx::ObjectPtr< CanvasTilemap_obj > CanvasTilemap_obj::__new()
{
...
void CanvasTilemap_obj::render( ::openfl::display::Tilemap tilemap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasTilemap","render",0x42cdc289,"openfl._internal.renderer.canvas.CanvasTilemap.render","openfl/_internal/renderer/canvas/CanvasTilemap.hx",21,0xd031c225)
