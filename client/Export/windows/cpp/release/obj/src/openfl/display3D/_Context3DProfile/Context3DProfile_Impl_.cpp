...
Dynamic Context3DProfile_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Context3DProfile_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","fromString",0xdbdb0761,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.fromString","openfl/display3D/Context3DProfile.hx",15,0x8638b9ba)
...
::String Context3DProfile_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","toString",0xda661cb2,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.toString","openfl/display3D/Context3DProfile.hx",30,0x8638b9ba)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","boot",0x742ed538,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.boot","openfl/display3D/Context3DProfile.hx",7,0x8638b9ba)
HXLINE(   7)		BASELINE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","boot",0x742ed538,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.boot","openfl/display3D/Context3DProfile.hx",8,0x8638b9ba)
HXLINE(   8)		BASELINE_CONSTRAINED = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","boot",0x742ed538,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.boot","openfl/display3D/Context3DProfile.hx",9,0x8638b9ba)
HXLINE(   9)		BASELINE_EXTENDED = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","boot",0x742ed538,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.boot","openfl/display3D/Context3DProfile.hx",10,0x8638b9ba)
HXLINE(  10)		STANDARD = (int)3;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DProfile.Context3DProfile_Impl_","boot",0x742ed538,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.boot","openfl/display3D/Context3DProfile.hx",11,0x8638b9ba)
