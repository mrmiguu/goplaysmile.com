...
HX_LOCAL_STACK_FRAME(_hx_pos_dd57334273da7235_15_CheckGLError,"openfl._internal.stage3D.GLUtils","CheckGLError",0x9918f1ac,"openfl._internal.stage3D.GLUtils.CheckGLError","openfl/_internal/stage3D/GLUtils.hx",15,0x3e0a00c4)
HX_LOCAL_STACK_FRAME(_hx_pos_dd57334273da7235_9_boot,"openfl._internal.stage3D.GLUtils","boot",0x357a2923,"openfl._internal.stage3D.GLUtils.boot","openfl/_internal/stage3D/GLUtils.hx",9,0x3e0a00c4)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void GLUtils_obj::CheckGLError(){
            	HX_GC_STACKFRAME(&_hx_pos_dd57334273da7235_15_CheckGLError)
HXLINE(  16)		if (!(::openfl::_internal::stage3D::GLUtils_obj::debug)) {
HXLINE(  16)			return;
            		}
HXLINE(  18)		int error = ::lime::graphics::opengl::GL_obj::context->getError();
HXLINE(  19)		if ((error != (int)0)) {
HXLINE(  20)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,((HX_("Error calling openGL api. Error: ",3f,ad,32,17) + error) + HX_("\n",0a,00,00,00))));
            		}
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_dd57334273da7235_9_boot)
