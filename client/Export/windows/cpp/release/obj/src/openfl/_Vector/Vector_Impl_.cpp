...
HXLINE( 170)		return  ::openfl::_Vector::BoolVector_obj::__new(length,fixed,array);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Vector_Impl__obj,toBoolVector,return )
 ...
 ::openfl::_Vector::IntVector Vector_Impl__obj::toIntVector(::Dynamic t,Int length,Bool fixed,::cpp::VirtualArray array){
            	...
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 177)		return  ::openfl::_Vector::IntVector_obj::__new(length,fixed,array);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Vector_Impl__obj,toIntVector,return )
 ...
 ::openfl::_Vector::FloatVector Vector_Impl__obj::toFloatVector(::Dynamic t,Int length,Bool fixed,::cpp::VirtualArray array){
            	...
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 184)		return  ::openfl::_Vector::FloatVector_obj::__new(length,fixed,array);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Vector_Impl__obj,toFloatVector,return )
 ...
 ::openfl::_Vector::FunctionVector Vector_Impl__obj::toFunctionVector(::Dynamic t,Int length,Bool fixed,::cpp::VirtualArray array){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","toFunctionVector",0xabc41997,"openfl._Vector.Vector_Impl_.toFunctionVector","openfl/Vector.hx",192,0x4a01873c)
            	HX_STACK_ARG(t,"t")
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 192)		return  ::openfl::_Vector::FunctionVector_obj::__new(length,fixed,array);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Vector_Impl__obj,toFunctionVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::toObjectVector(::Dynamic t,Int length,Bool fixed,::cpp::VirtualArray array){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","toObjectVector",0xdd29457e,"openfl._Vector.Vector_Impl_.toObjectVector","openfl/Vector.hx",200,0x4a01873c)
            	HX_STACK_ARG(t,"t")
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 200)		return  ::openfl::_Vector::ObjectVector_obj::__new(length,fixed,array);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Vector_Impl__obj,toObjectVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::fromBoolVector( ::openfl::_Vector::BoolVector vector){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","fromBoolVector",0x5de98118,"openfl._Vector.Vector_Impl_.fromBoolVector","openfl/Vector.hx",207,0x4a01873c)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Vector_Impl__obj,fromBoolVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::fromIntVector( ::openfl::_Vector::IntVector vector){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","fromIntVector",0xcee7cce7,"openfl._Vector.Vector_Impl_.fromIntVector","openfl/Vector.hx",214,0x4a01873c)
            	HX_STACK_ARG(vector,"vector")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Vector_Impl__obj,fromIntVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::fromFloatVector( ::openfl::_Vector::FloatVector vector){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","fromFloatVector",0x1794a494,"openfl._Vector.Vector_Impl_.fromFloatVector","openfl/Vector.hx",221,0x4a01873c)
            	HX_STACK_ARG(vector,"vector")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Vector_Impl__obj,fromFloatVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::fromFunctionVector( ::openfl::_Vector::FunctionVector vector){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","fromFunctionVector",0xbc863006,"openfl._Vector.Vector_Impl_.fromFunctionVector","openfl/Vector.hx",229,0x4a01873c)
            	HX_STACK_ARG(vector,"vector")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Vector_Impl__obj,fromFunctionVector,return )
 ...
 ::openfl::_Vector::ObjectVector Vector_Impl__obj::fromObjectVector( ::openfl::_Vector::ObjectVector vector){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","fromObjectVector",0x8b3b922d,"openfl._Vector.Vector_Impl_.fromObjectVector","openfl/Vector.hx",237,0x4a01873c)
            	HX_STACK_ARG(vector,"vector")
...
Bool Vector_Impl__obj::get_fixed(::Dynamic this1){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","get_fixed",0xf51a5aea,"openfl._Vector.Vector_Impl_.get_fixed","openfl/Vector.hx",251,0x4a01873c)
            	HX_STACK_ARG(this1,"this1")
HXLINE( 251)		return ( (Bool)(this1->__Field(HX_("fixed",74,f9,a1,00),hx::paccDynamic)) );
            	}
...
Bool Vector_Impl__obj::set_fixed(::Dynamic this1,Bool value){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","set_fixed",0xd86b46f6,"openfl._Vector.Vector_Impl_.set_fixed","openfl/Vector.hx",258,0x4a01873c)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(value,"value")
...
Int Vector_Impl__obj::get_length(::Dynamic this1){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","get_length",0x93e47ab0,"openfl._Vector.Vector_Impl_.get_length","openfl/Vector.hx",265,0x4a01873c)
            	HX_STACK_ARG(this1,"this1")
HXLINE( 265)		return ( (Int)( ::Dynamic(this1->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic))()) );
            	}
...
Int Vector_Impl__obj::set_length(::Dynamic this1,Int value){
            	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","set_length",0x97621924,"openfl._Vector.Vector_Impl_.set_length","openfl/Vector.hx",272,0x4a01873c)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(value,"value")
HXLINE( 272)		return ( (Int)( ::Dynamic(this1->__Field(HX_("set_length",23,a3,0c,93),hx::paccDynamic))(value)) );
            	}
