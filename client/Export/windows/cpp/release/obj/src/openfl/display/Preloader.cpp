...
HX_LOCAL_STACK_FRAME(_hx_pos_c8b942935957ff96_90_display_onUnload,"openfl.display.Preloader","display_onUnload",0xa1bcd03d,"openfl.display.Preloader.display_onUnload","openfl/display/Preloader.hx",90,0xc399db74)
namespace openfl{
namespace display{
...
HXLINE(  50)			 ::openfl::events::Event complete =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),true,true);
HXLINE(  51)			this->display->dispatchEvent(complete);
HXLINE(  53)			if (!(complete->isDefaultPrevented())) {
HXLINE(  55)				 ::openfl::display::Sprite _hx_tmp = this->display;
HXDLIN(  55)				_hx_tmp->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("unload",ff,a0,8c,65),null(),null()));
            			}
            		}
            		else {
...
HXLINE(  76)			 ::openfl::display::Sprite _hx_tmp = this->display;
HXDLIN(  76)			_hx_tmp->dispatchEvent( ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),true,true,loaded,total));
            		}
            	}
