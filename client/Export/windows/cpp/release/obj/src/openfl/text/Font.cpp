...
void Font_obj::__construct(::String name){
            	HX_STACK_FRAME("openfl.text.Font","new",0xe13d5ce4,"openfl.text.Font.new","openfl/text/Font.hx",20,0x076bbaac)
            	HX_STACK_THIS(this)
...
::String Font_obj::get_fontName(){
            	HX_STACK_FRAME("openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",98,0x076bbaac)
            	HX_STACK_THIS(this)
...
::String Font_obj::set_fontName(::String value){
            	HX_STACK_FRAME("openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",105,0x076bbaac)
            	HX_STACK_THIS(this)
...
HXLINE(  34)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__new(null());
HXLINE(  35)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
HXLINE(  38)		Bool _hx_tmp = hx::IsNotNull( font->src );
...
HXLINE(  48)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__new(null());
HXLINE(  49)		font->_hx___fromFile(path);
HXLINE(  52)		Bool _hx_tmp = hx::IsNotNull( font->src );
...
HXLINE(  64)		Bool _hx_tmp = hx::IsNotNull( instance );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,registerFont,(void))
 ...
 ::openfl::text::Font Font_obj::_hx___fromLimeFont( ::lime::text::Font value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(  81)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__new(null());
...
{
{
            	HX_STACK_FRAME("openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",15,0x076bbaac)
