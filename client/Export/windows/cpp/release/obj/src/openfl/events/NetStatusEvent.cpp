...
hx::ObjectPtr< NetStatusEvent_obj > NetStatusEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable, ::Dynamic info)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,info);
	return _hx_result;
}
...
Dynamic NetStatusEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event NetStatusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		HX_VARI(  ::openfl::events::NetStatusEvent,event) =  ::openfl::events::NetStatusEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->info);
...
::String NetStatusEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.NetStatusEvent","toString",0x4e1f29f8,"openfl.events.NetStatusEvent.toString","openfl/events/NetStatusEvent.hx",34,0xf85a9d3c)
            	HX_STACK_THIS(this)
HXLINE(  34)		return this->_hx___formatToString(HX_("NetStatusEvent",4b,2a,fa,67),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.NetStatusEvent","boot",0x8a3a477e,"openfl.events.NetStatusEvent.boot","openfl/events/NetStatusEvent.hx",7,0xf85a9d3c)
