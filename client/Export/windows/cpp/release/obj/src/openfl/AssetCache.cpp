...
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_917_clear,"openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",917,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_968_getBitmapData,"openfl.AssetCache","getBitmapData",0x76047b71,"openfl.AssetCache.getBitmapData","openfl/Assets.hx",968,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_975_getFont,"openfl.AssetCache","getFont",0xc4a48987,"openfl.AssetCache.getFont","openfl/Assets.hx",975,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_982_getSound,"openfl.AssetCache","getSound",0xc78ea217,"openfl.AssetCache.getSound","openfl/Assets.hx",982,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_989_hasBitmapData,"openfl.AssetCache","hasBitmapData",0x33e8d735,"openfl.AssetCache.hasBitmapData","openfl/Assets.hx",989,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_996_hasFont,"openfl.AssetCache","hasFont",0xc165fa4b,"openfl.AssetCache.hasFont","openfl/Assets.hx",996,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1003_hasSound,"openfl.AssetCache","hasSound",0xf40fdcd3,"openfl.AssetCache.hasSound","openfl/Assets.hx",1003,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1008_removeBitmapData,"openfl.AssetCache","removeBitmapData",0x7d8dc6db,"openfl.AssetCache.removeBitmapData","openfl/Assets.hx",1008,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1016_removeFont,"openfl.AssetCache","removeFont",0x7ce60971,"openfl.AssetCache.removeFont","openfl/Assets.hx",1016,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1024_removeSound,"openfl.AssetCache","removeSound",0x489d0eed,"openfl.AssetCache.removeSound","openfl/Assets.hx",1024,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1034_setBitmapData,"openfl.AssetCache","setBitmapData",0xbb0a5d7d,"openfl.AssetCache.setBitmapData","openfl/Assets.hx",1034,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1041_setFont,"openfl.AssetCache","setFont",0xb7a61a93,"openfl.AssetCache.setFont","openfl/Assets.hx",1041,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1048_setSound,"openfl.AssetCache","setSound",0x75ebfb8b,"openfl.AssetCache.setSound","openfl/Assets.hx",1048,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1062_get_enabled,"openfl.AssetCache","get_enabled",0xcdc8099a,"openfl.AssetCache.get_enabled","openfl/Assets.hx",1062,0x989d477c)
HX_LOCAL_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1069_set_enabled,"openfl.AssetCache","set_enabled",0xd83510a6,"openfl.AssetCache.set_enabled","openfl/Assets.hx",1069,0x989d477c)
namespace openfl{
...
HXLINE( 925)			 ::Dynamic keys = this->bitmapData->keys();
HXLINE( 927)			{
HXLINE( 927)				 ::Dynamic key = keys;
HXDLIN( 927)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 927)					::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 929)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 931)						this->removeBitmapData(key1);
            					}
            				}
            			}
HXLINE( 937)			 ::Dynamic keys1 = this->font->keys();
HXLINE( 939)			{
HXLINE( 939)				 ::Dynamic key2 = keys1;
HXDLIN( 939)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 939)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 941)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 943)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE( 949)			 ::Dynamic keys2 = this->sound->keys();
HXLINE( 951)			{
HXLINE( 951)				 ::Dynamic key4 = keys2;
HXDLIN( 951)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 951)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 953)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE( 955)						this->removeSound(key5);
            					}
            				}
            			}
            		}
