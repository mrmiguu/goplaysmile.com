...
HXLINE(  57)			this->context->fillRect((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            		}
            		else {
...
HXLINE(  61)				this->context->clearRect((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            			}
            		}
