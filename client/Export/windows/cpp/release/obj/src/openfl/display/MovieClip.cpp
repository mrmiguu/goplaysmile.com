...
void MovieClip_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.MovieClip","new",0xe16984e8,"openfl.display.MovieClip.new","openfl/display/MovieClip.hx",53,0x2b84738a)
            	HX_STACK_THIS(this)
...
HXLINE(  62)		Bool _hx_tmp = hx::IsNotNull( ::openfl::display::MovieClip_obj::_hx___initSymbol );
...
void MovieClip_obj::addFrameScript(Int index, ::Dynamic method){
            	HX_STACK_FRAME("openfl.display.MovieClip","addFrameScript",0xff5029ef,"openfl.display.MovieClip.addFrameScript","openfl/display/MovieClip.hx",79,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(method,"method")
HXLINE(  79)		Bool _hx_tmp = hx::IsNotNull( method );
HXDLIN(  79)		if (_hx_tmp) {
HXLINE(  81)			Bool _hx_tmp1 = hx::IsNull( this->_hx___frameScripts );
HXDLIN(  81)			if (_hx_tmp1) {
HXLINE(  83)				this->_hx___frameScripts =  ::haxe::ds::IntMap_obj::__new();
            			}
HXLINE(  87)			this->_hx___frameScripts->set(index,method);
            		}
            		else {
HXLINE(  89)			Bool _hx_tmp2 = hx::IsNotNull( this->_hx___frameScripts );
...
void MovieClip_obj::gotoAndPlay( ::Dynamic frame,::String scene){
            	HX_STACK_FRAME("openfl.display.MovieClip","gotoAndPlay",0x3bade190,"openfl.display.MovieClip.gotoAndPlay","openfl/display/MovieClip.hx",100,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(scene,"scene")
HXLINE( 100)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
...
void MovieClip_obj::gotoAndStop( ::Dynamic frame,::String scene){
            	HX_STACK_FRAME("openfl.display.MovieClip","gotoAndStop",0x3dafa39e,"openfl.display.MovieClip.gotoAndStop","openfl/display/MovieClip.hx",113,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(scene,"scene")
HXLINE( 113)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
...
void MovieClip_obj::nextFrame(){
            	HX_STACK_FRAME("openfl.display.MovieClip","nextFrame",0x3b845cc2,"openfl.display.MovieClip.nextFrame","openfl/display/MovieClip.hx",126,0x2b84738a)
            	HX_STACK_THIS(this)
HXLINE( 126)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
HXDLIN( 126)		if (_hx_tmp) {
HXLINE( 128)			HX_VARI( Int,next) = (this->_hx___currentFrame + (int)1);
HXLINE( 130)			Bool _hx_tmp1 = (next > this->_hx___totalFrames);
...
void MovieClip_obj::play(){
            	HX_STACK_FRAME("openfl.display.MovieClip","play",0x5c42706c,"openfl.display.MovieClip.play","openfl/display/MovieClip.hx",145,0x2b84738a)
            	HX_STACK_THIS(this)
HXLINE( 145)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
HXDLIN( 145)		if (_hx_tmp) {
HXLINE( 147)			Bool _hx_tmp1;
HXDLIN( 147)			if (!(this->_hx___playing)) {
HXLINE( 147)				_hx_tmp1 = (this->_hx___totalFrames > (int)1);
            			}
            			else {
...
HXLINE( 152)				Float _hx_tmp2 = ((Float)(int)1000 / (Float)this->_hx___swf->frameRate);
HXDLIN( 152)				this->_hx___frameTime = ::Std_obj::_hx_int(_hx_tmp2);
...
void MovieClip_obj::prevFrame(){
            	HX_STACK_FRAME("openfl.display.MovieClip","prevFrame",0x7f95e2c2,"openfl.display.MovieClip.prevFrame","openfl/display/MovieClip.hx",165,0x2b84738a)
            	HX_STACK_THIS(this)
HXLINE( 165)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
HXDLIN( 165)		if (_hx_tmp) {
HXLINE( 167)			HX_VARI( Int,previous) = (this->_hx___currentFrame - (int)1);
HXLINE( 169)			Bool _hx_tmp1 = (previous < (int)1);
...
void MovieClip_obj::stop(){
            	HX_STACK_FRAME("openfl.display.MovieClip","stop",0x5e44327a,"openfl.display.MovieClip.stop","openfl/display/MovieClip.hx",184,0x2b84738a)
            	HX_STACK_THIS(this)
HXLINE( 184)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
HXDLIN( 184)		if (_hx_tmp) {
HXLINE( 186)			Bool _hx_tmp1 = this->_hx___playing;
...
Float MovieClip_obj::_hx___applyTween(Float start,Float end,Float ratio){
            	HX_STACK_FRAME("openfl.display.MovieClip","__applyTween",0x55791bb5,"openfl.display.MovieClip.__applyTween","openfl/display/MovieClip.hx",199,0x2b84738a)
            	HX_STACK_THIS(this)
...
void MovieClip_obj::_hx___enterFrame(Int deltaTime){
            	HX_STACK_FRAME("openfl.display.MovieClip","__enterFrame",0x9306f98d,"openfl.display.MovieClip.__enterFrame","openfl/display/MovieClip.hx",204,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 206)		Bool _hx_tmp = hx::IsNotNull( this->_hx___symbol );
HXDLIN( 206)		if (_hx_tmp) {
HXLINE( 208)			Bool _hx_tmp1 = this->_hx___playing;
HXDLIN( 208)			if (_hx_tmp1) {
HXLINE( 211)				hx::AddEq(this->_hx___timeElapsed,deltaTime);
HXLINE( 212)				Float _hx_tmp2 = ((Float)this->_hx___timeElapsed / (Float)this->_hx___frameTime);
HXDLIN( 212)				HX_VARI( Int,advanceFrames) = ::Math_obj::floor(_hx_tmp2);
HXLINE( 213)				this->_hx___timeElapsed = hx::Mod(this->_hx___timeElapsed,this->_hx___frameTime);
HXLINE( 218)				Bool _hx_tmp3 = hx::IsNotNull( this->_hx___frameScripts );
...
HXLINE( 224)						Bool _hx_tmp4 = (this->_hx___currentFrame > this->_hx___totalFrames);
HXDLIN( 224)						if (_hx_tmp4) {
HXLINE( 226)							this->_hx___currentFrame = (int)1;
            						}
HXLINE( 230)						Int key = (this->_hx___currentFrame - (int)1);
HXDLIN( 230)						Bool _hx_tmp5 = this->_hx___frameScripts->exists(key);
HXDLIN( 230)						if (_hx_tmp5) {
HXLINE( 232)							Int key1 = (this->_hx___currentFrame - (int)1);
HXDLIN( 232)							 ::Dynamic _hx_tmp6 = this->_hx___frameScripts->get(key1);
HXDLIN( 232)							_hx_tmp6();
HXLINE( 233)							if (!(this->_hx___playing)) {
HXLINE( 233)								goto _hx_goto_0;
            							}
            						}
            					}
            					_hx_goto_0:;
...
HXLINE( 241)					hx::AddEq(this->_hx___currentFrame,advanceFrames);
HXLINE( 243)					while((this->_hx___currentFrame > this->_hx___totalFrames)){
HXLINE( 245)						hx::SubEq(this->_hx___currentFrame,this->_hx___totalFrames);
            					}
            				}
...
void MovieClip_obj::_hx___fromSymbol( ::openfl::_internal::swf::SWFLite swf, ::openfl::_internal::symbols::SpriteSymbol symbol){
            	HX_STACK_FRAME("openfl.display.MovieClip","__fromSymbol",0xc2d8a9fa,"openfl.display.MovieClip.__fromSymbol","openfl/display/MovieClip.hx",262,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
            	HX_STACK_ARG(symbol,"symbol")
HXLINE( 264)		Bool _hx_tmp = hx::IsNotNull( this->_hx___objects );
...
HXLINE( 271)		this->_hx___objects =  ::haxe::ds::IntMap_obj::__new();
...
HXLINE( 277)				HX_VARI( Int,i) = _g1++;
HXLINE( 279)				Bool _hx_tmp1 = hx::IsNotNull( this->_hx___symbol->frames->__get(i).StaticCast<  ::openfl::_internal::timeline::Frame >()->label );
HXDLIN( 279)				if (_hx_tmp1) {
HXLINE( 281)					this->_hx___currentLabels->push( ::openfl::display::FrameLabel_obj::__new(this->_hx___symbol->frames->__get(i).StaticCast<  ::openfl::_internal::timeline::Frame >()->label,(i + (int)1)));
            				}
            			}
            		}
...
HXDLIN( 290)			hx::Class _hx_tmp2 = ::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 290)			HX_VARI_NAME( ::Array< ::String >,_g11,"_g1") = ::Type_obj::getInstanceFields(_hx_tmp2);
...
HXDLIN( 292)						++_g21;
HXLINE( 294)						::String _hx_tmp3 = child->get_name();
HXDLIN( 294)						if ((_hx_tmp3 == field)) {
...
HXLINE( 305)		Bool _hx_tmp4 = (this->_hx___totalFrames > (int)1);
...
Int MovieClip_obj::_hx___getFrame( ::Dynamic frame){
            	HX_STACK_FRAME("openfl.display.MovieClip","__getFrame",0x8028674f,"openfl.display.MovieClip.__getFrame","openfl/display/MovieClip.hx",314,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
HXLINE( 316)		Bool _hx_tmp = ::Std_obj::is(frame,hx::ClassOf< ::Int >());
...
HXLINE( 325)			Bool _hx_tmp1 = ::Std_obj::is(frame,hx::ClassOf< ::String >());
...
HXDLIN( 329)						++_g;
HXLINE( 331)						::String _hx_tmp2 = frameLabel->get_name();
HXDLIN( 331)						if ((_hx_tmp2 == label)) {
...
void MovieClip_obj::_hx___placeObject( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::timeline::FrameObject frameObject){
            	HX_STACK_FRAME("openfl.display.MovieClip","__placeObject",0x4de0264e,"openfl.display.MovieClip.__placeObject","openfl/display/MovieClip.hx",346,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayObject,"displayObject")
            	HX_STACK_ARG(frameObject,"frameObject")
HXLINE( 348)		Bool _hx_tmp = hx::IsNotNull( frameObject->name );
HXDLIN( 348)		if (_hx_tmp) {
HXLINE( 350)			displayObject->set_name(frameObject->name);
            		}
HXLINE( 354)		Bool _hx_tmp1 = hx::IsNotNull( frameObject->matrix );
HXDLIN( 354)		if (_hx_tmp1) {
HXLINE( 356)			displayObject->get_transform()->set_matrix(frameObject->matrix);
            		}
HXLINE( 360)		Bool _hx_tmp2 = hx::IsNotNull( frameObject->colorTransform );
HXDLIN( 360)		if (_hx_tmp2) {
HXLINE( 362)			displayObject->get_transform()->set_colorTransform(frameObject->colorTransform);
            		}
HXLINE( 366)		Bool _hx_tmp3 = hx::IsNotNull( frameObject->filters );
...
HXLINE( 370)					HX_VARI( ::hx::EnumBase,filter) = _g1->__get(_g).StaticCast< ::hx::EnumBase >();
HXDLIN( 370)					++_g;
HXLINE( 372)					Int _hx_tmp4 = ( ( ::hx::EnumBase)(filter) )->_hx_getIndex();
HXDLIN( 372)					switch((int)(_hx_tmp4)){
            						case (int)0: {
HXLINE( 376)							filters->push( ::openfl::filters::BlurFilter_obj::__new(filter->_hx_getFloat(0),filter->_hx_getFloat(1),filter->_hx_getInt(2)));
            						}
            						break;
            						case (int)1: {
HXLINE( 380)							filters->push( ::openfl::filters::ColorMatrixFilter_obj::__new(filter->_hx_getObject(0).StaticCast< ::Array< Float > >()));
            						}
            						break;
            						case (int)2: {
HXLINE( 384)							filters->push( ::openfl::filters::DropShadowFilter_obj::__new(filter->_hx_getFloat(0),filter->_hx_getFloat(1),filter->_hx_getInt(2),filter->_hx_getFloat(3),filter->_hx_getFloat(4),filter->_hx_getFloat(5),filter->_hx_getFloat(6),filter->_hx_getInt(7),filter->_hx_getBool(8),filter->_hx_getBool(9),filter->_hx_getBool(10)));
            						...
            						break;
            						case (int)3: {
HXLINE( 388)							filters->push( ::openfl::filters::GlowFilter_obj::__new(filter->_hx_getInt(0),filter->_hx_getFloat(1),filter->_hx_getFloat(2),filter->_hx_getFloat(3),filter->_hx_getFloat(4),filter->_hx_getInt(5),filter->_hx_getBool(6),filter->_hx_getBool(7)));
            						}
            						break;
            					}
            				}
...
void MovieClip_obj::_hx___renderFrame(Int index){
            	HX_STACK_FRAME("openfl.display.MovieClip","__renderFrame",0xe194945f,"openfl.display.MovieClip.__renderFrame","openfl/display/MovieClip.hx",407,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HXLINE( 458)				HX_VARI_NAME( Int,i1,"i") = _g11++;
...
HXDLIN( 472)								Bool _hx_tmp2 = hx::IsNotNull( timelineObject1 );
...
HXLINE( 478)								this->_hx___objectDepths->remove(this->_hx___objects->get((int)0).StaticCast<  ::openfl::display::_MovieClip::TimelineObject >());
HXLINE( 479)								timelineObject1 = null();
HXLINE( 480)								this->_hx___zeroSymbol = frameObject1->symbol;
            							}
HXLINE( 484)							displayObject = null();
HXLINE( 486)							Int key = frameObject1->id;
HXDLIN( 486)							Bool _hx_tmp3 = this->_hx___objects->exists(key);
HXDLIN( 486)							if (!(_hx_tmp3)) {
HXLINE( 488)								Int key1 = frameObject1->symbol;
HXDLIN( 488)								Bool _hx_tmp4 = this->_hx___swf->symbols->exists(key1);
HXDLIN( 488)								if (_hx_tmp4) {
HXLINE( 490)									Int key2 = frameObject1->symbol;
HXDLIN( 490)									symbol = this->_hx___swf->symbols->get(key2).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >();
HXLINE( 491)									displayObject = symbol->_hx___createObject(this->_hx___swf);
            								}
HXLINE( 495)								Bool _hx_tmp5 = hx::IsNotNull( displayObject );
HXDLIN( 495)								if (_hx_tmp5) {
HXLINE( 497)									timelineObject1 =  ::openfl::display::_MovieClip::TimelineObject_obj::__new(frameObject1->id,frameObject1->depth,displayObject);
HXLINE( 499)									this->_hx___objectDepths->push(timelineObject1);
HXLINE( 501)									depthChange = true;
HXLINE( 503)									{
HXLINE( 503)										Int key3 = frameObject1->id;
HXDLIN( 503)										this->_hx___objects->set(key3,timelineObject1);
            									}
            								}
            							}
            							else {
HXLINE( 509)								Int key4 = frameObject1->id;
HXDLIN( 509)								timelineObject1 = this->_hx___objects->get(key4).StaticCast<  ::openfl::display::_MovieClip::TimelineObject >();
HXLINE( 510)								displayObject = timelineObject1->displayObject;
HXLINE( 512)								Bool _hx_tmp6 = hx::IsNull( timelineObject1->displayObject->parent );
HXDLIN( 512)								if (_hx_tmp6) {
HXLINE( 514)									this->_hx___objectDepths->push(timelineObject1);
HXLINE( 516)									depthChange = true;
            								}
            							}
HXLINE( 522)							Bool _hx_tmp7 = hx::IsNotNull( displayObject );
HXDLIN( 522)							if (_hx_tmp7) {
HXLINE( 524)								this->_hx___placeObject(displayObject,frameObject1);
HXLINE( 526)								Bool _hx_tmp8 = hx::IsNotNull( mask );
HXDLIN( 526)								if (_hx_tmp8) {
HXLINE( 528)									Bool _hx_tmp9 = (( (Int)(mask->__Field(HX_("clipDepth",13,40,41,f5),hx::paccDynamic)) ) < frameObject1->depth);
...
HXLINE( 544)								Bool _hx_tmp10 = (frameObject1->clipDepth != (int)0);
HXDLIN( 544)								if (_hx_tmp10) {
...
HXLINE( 556)							Int key5 = frameObject1->id;
HXDLIN( 556)							Bool _hx_tmp11 = this->_hx___objects->exists(key5);
HXDLIN( 556)							if (_hx_tmp11) {
HXLINE( 558)								Int key6 = frameObject1->id;
HXDLIN( 558)								timelineObject1 = this->_hx___objects->get(key6).StaticCast<  ::openfl::display::_MovieClip::TimelineObject >();
HXLINE( 560)								Bool _hx_tmp12;
HXDLIN( 560)								Bool _hx_tmp13 = hx::IsNotNull( timelineObject1 );
HXDLIN( 560)								if (_hx_tmp13) {
HXLINE( 560)									_hx_tmp12 = hx::IsEq( timelineObject1->displayObject->parent,hx::ObjectPtr<OBJ_>(this) );
            								}
            								else {
HXLINE( 560)									_hx_tmp12 = false;
            								}
HXDLIN( 560)								if (_hx_tmp12) {
...
Int MovieClip_obj::_hx___sortTimelineDepth( ::openfl::display::_MovieClip::TimelineObject a, ::openfl::display::_MovieClip::TimelineObject b){
            	HX_STACK_FRAME("openfl.display.MovieClip","__sortTimelineDepth",0x441c91ec,"openfl.display.MovieClip.__sortTimelineDepth","openfl/display/MovieClip.hx",599,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
void MovieClip_obj::_hx___stopAllMovieClips(){
            	HX_STACK_FRAME("openfl.display.MovieClip","__stopAllMovieClips",0x702dce5a,"openfl.display.MovieClip.__stopAllMovieClips","openfl/display/MovieClip.hx",604,0x2b84738a)
            	HX_STACK_THIS(this)
...
void MovieClip_obj::_hx___updateFrame(){
            	HX_STACK_FRAME("openfl.display.MovieClip","__updateFrame",0xfb7bd0cc,"openfl.display.MovieClip.__updateFrame","openfl/display/MovieClip.hx",612,0x2b84738a)
            	HX_STACK_THIS(this)
HXLINE( 614)		Bool _hx_tmp = (this->_hx___currentFrame != this->_hx___lastUpdate);
...
HXLINE( 620)					_hx_tmp1 = hx::IsNotNull( this->_hx___symbol->frames->__get(frameIndex).StaticCast<  ::openfl::_internal::timeline::Frame >() );
            				}
            				else {
...
HXLINE( 630)				Bool _hx_tmp2 = hx::IsNotNull( this->_hx___currentFrameLabel );
HXDLIN( 630)				if (_hx_tmp2) {
HXLINE( 632)					this->_hx___currentLabel = this->_hx___currentFrameLabel;
            				}
            				else {
HXLINE( 636)					Bool _hx_tmp3 = (this->_hx___currentFrame != (this->_hx___lastUpdate + (int)1));
...
HXDLIN( 640)								++_g;
HXLINE( 642)								Int _hx_tmp4 = label->get_frame();
HXDLIN( 642)								Bool _hx_tmp5 = (_hx_tmp4 <= this->_hx___currentFrame);
HXDLIN( 642)								if (_hx_tmp5) {
HXLINE( 644)									this->_hx___currentLabel = label->get_name();
            								}
            								else {
HXLINE( 648)									goto _hx_goto_12;
            								}
            							}
            							_hx_goto_12:;
            						}
...
Int MovieClip_obj::get_currentFrame(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_currentFrame",0xf2ac6035,"openfl.display.MovieClip.get_currentFrame","openfl/display/MovieClip.hx",679,0x2b84738a)
            	HX_STACK_THIS(this)
...
::String MovieClip_obj::get_currentFrameLabel(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_currentFrameLabel",0x543e3d7f,"openfl.display.MovieClip.get_currentFrameLabel","openfl/display/MovieClip.hx",680,0x2b84738a)
            	HX_STACK_THIS(this)
...
::String MovieClip_obj::get_currentLabel(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_currentLabel",0x5bd7f5fc,"openfl.display.MovieClip.get_currentLabel","openfl/display/MovieClip.hx",681,0x2b84738a)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> MovieClip_obj::get_currentLabels(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_currentLabels",0x011f46f7,"openfl.display.MovieClip.get_currentLabels","openfl/display/MovieClip.hx",682,0x2b84738a)
            	HX_STACK_THIS(this)
...
Int MovieClip_obj::get_framesLoaded(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_framesLoaded",0xb37eaf4c,"openfl.display.MovieClip.get_framesLoaded","openfl/display/MovieClip.hx",683,0x2b84738a)
            	HX_STACK_THIS(this)
...
Int MovieClip_obj::get_totalFrames(){
            	HX_STACK_FRAME("openfl.display.MovieClip","get_totalFrames",0x46b3baa9,"openfl.display.MovieClip.get_totalFrames","openfl/display/MovieClip.hx",684,0x2b84738a)
            	HX_STACK_THIS(this)
