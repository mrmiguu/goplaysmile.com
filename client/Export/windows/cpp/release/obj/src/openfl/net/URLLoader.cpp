...
HXLINE(  61)		Bool _hx_tmp = hx::IsEq( this->dataFormat,(int)0 );
HXDLIN(  61)		if (_hx_tmp) {
            			...
            			void _hx_run( ::openfl::utils::ByteArrayData data){
            				HX_STACK_FRAME("openfl.net.URLLoader","load",0xd80d7061,"openfl.net.URLLoader.load","openfl/net/URLLoader.hx",69,0x11daec0d)
            				HX_STACK_ARG(data,"data")
HXLINE(  71)				_gthis->data = data;
HXLINE(  73)				HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null());
HXLINE(  74)				_gthis->dispatchEvent(event);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  63)			HX_VARI(  ::lime::net::_HTTPRequest_openfl_utils_ByteArray,httpRequest) =  ::lime::net::_HTTPRequest_openfl_utils_ByteArray_obj::__new(null());
...
HXLINE(  66)			httpRequest->load(null())->onProgress(this->httpRequest_onProgress_dyn())->onError(this->httpRequest_onError_dyn())->onComplete( ::Dynamic(new _hx_Closure_0(_gthis)));
            			...
            			void _hx_run(::String data1){
            				HX_STACK_FRAME("openfl.net.URLLoader","load",0xd80d7061,"openfl.net.URLLoader.load","openfl/net/URLLoader.hx",86,0x11daec0d)
            				HX_STACK_ARG(data1,"data1")
HXLINE(  88)				_gthis->data = data1;
HXLINE(  90)				HX_VARI_NAME(  ::openfl::events::Event,event1,"event") =  ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null());
HXLINE(  91)				_gthis->dispatchEvent(event1);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  80)			HX_VARI_NAME(  ::lime::net::_HTTPRequest_String,httpRequest1,"httpRequest") =  ::lime::net::_HTTPRequest_String_obj::__new(null());
...
HXLINE( 106)		HX_VARI( ::String,_g) = request->method;
...
HXLINE( 117)		Bool _hx_tmp1 = hx::IsNotNull( request->data );
HXDLIN( 117)		if (_hx_tmp1) {
HXLINE( 119)			Bool _hx_tmp2 = ::Std_obj::is(request->data,hx::ClassOf< ::openfl::net::URLVariables >());
HXDLIN( 119)			if (_hx_tmp2) {
HXLINE( 121)				HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(request->data);
HXLINE( 123)				{
HXLINE( 123)					HX_VARI( Int,_g1) = (int)0;
HXDLIN( 123)					while((_g1 < fields->length)){
HXLINE( 123)						HX_VARI( ::String,field) = fields->__get(_g1);
HXDLIN( 123)						++_g1;
HXLINE( 125)						{
HXLINE( 125)							 ::Dynamic value = ::Reflect_obj::field(request->data,field);
HXDLIN( 125)							( ( ::haxe::ds::StringMap)(this->_hx___httpRequest->__Field(HX_("formData",8e,d5,80,56),hx::paccDynamic)) )->set(field,value);
            						}
            					}
            				}
            			}
            			else {
HXLINE( 129)				Bool _hx_tmp3 = ::Std_obj::is(request->data,hx::ClassOf< ::haxe::io::Bytes >());
HXDLIN( 129)				if (_hx_tmp3) {
HXLINE( 131)					this->_hx___httpRequest->__SetField(HX_("data",2a,56,63,42),request->data,hx::paccDynamic);
            				}
            				else {
HXLINE( 135)					::String _hx_tmp4 = ::Std_obj::string(request->data);
HXDLIN( 135)					this->_hx___httpRequest->__SetField(HX_("data",2a,56,63,42),::haxe::io::Bytes_obj::ofString(_hx_tmp4),hx::paccDynamic);
            				}
            			}
            		}
HXLINE( 141)		this->_hx___httpRequest->__SetField(HX_("contentType",93,3c,7b,2a),request->contentType,hx::paccDynamic);
HXLINE( 143)		Bool _hx_tmp5 = hx::IsNotNull( request->requestHeaders );
HXDLIN( 143)		if (_hx_tmp5) {
HXLINE( 145)			HX_VARI_NAME( Int,_g11,"_g1") = (int)0;
HXDLIN( 145)			HX_VARI( ::Array< ::Dynamic>,_g2) = request->requestHeaders;
HXDLIN( 145)			while((_g11 < _g2->length)){
HXLINE( 145)				HX_VARI(  ::openfl::net::URLRequestHeader,header) = _g2->__get(_g11).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 145)				++_g11;
HXLINE( 147)				( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),hx::paccDynamic)) )->push( ::lime::net::HTTPRequestHeader_obj::__new(header->name,header->value));
            			}
            		}
...
void URLLoader_obj::httpRequest_onError( ::Dynamic error){
            	HX_STACK_FRAME("openfl.net.URLLoader","httpRequest_onError",0x8f111376,"openfl.net.URLLoader.httpRequest_onError","openfl/net/URLLoader.hx",167,0x11daec0d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(error,"error")
HXLINE( 167)		if (hx::IsEq( error,(int)403 )) {
HXLINE( 169)			HX_VARI(  ::openfl::events::SecurityErrorEvent,event) =  ::openfl::events::SecurityErrorEvent_obj::__new(HX_("securityError",e8,28,7c,a2),null(),null(),null(),null());
HXLINE( 170)			this->dispatchEvent(event);
            		}
            		else {
HXLINE( 174)			HX_VARI_NAME(  ::openfl::events::IOErrorEvent,event1,"event") =  ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 175)			this->dispatchEvent(event1);
            		}
            	}
...
void URLLoader_obj::httpRequest_onProgress(Int bytesLoaded,Int bytesTotal){
            	HX_STACK_FRAME("openfl.net.URLLoader","httpRequest_onProgress",0xf5cd30bf,"openfl.net.URLLoader.httpRequest_onProgress","openfl/net/URLLoader.hx",182,0x11daec0d)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytesLoaded,"bytesLoaded")
            	HX_STACK_ARG(bytesTotal,"bytesTotal")
HXLINE( 184)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__new(HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
HXLINE( 185)		event->bytesLoaded = bytesLoaded;
HXLINE( 186)		event->bytesTotal = bytesTotal;
HXLINE( 187)		this->dispatchEvent(event);
            	}
