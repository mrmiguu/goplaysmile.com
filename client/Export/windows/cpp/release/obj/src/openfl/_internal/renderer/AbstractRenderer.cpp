...
void AbstractRenderer_obj::__construct( ::openfl::display::Stage stage){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractRenderer","new",0x86c2b0b2,"openfl._internal.renderer.AbstractRenderer.new","openfl/_internal/renderer/AbstractRenderer.hx",27,0x115f79df)
            	HX_STACK_THIS(this)
...
void AbstractRenderer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractRenderer","clear",0x70808a5f,"openfl._internal.renderer.AbstractRenderer.clear","openfl/_internal/renderer/AbstractRenderer.hx",37,0x115f79df)
            	HX_STACK_THIS(this)
            	}
...
void AbstractRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractRenderer","render",0xfd7a0a44,"openfl._internal.renderer.AbstractRenderer.render","openfl/_internal/renderer/AbstractRenderer.hx",44,0x115f79df)
            	HX_STACK_THIS(this)
            	}
...
void AbstractRenderer_obj::resize(Int width,Int height){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractRenderer","resize",0x00cbf8e2,"openfl._internal.renderer.AbstractRenderer.resize","openfl/_internal/renderer/AbstractRenderer.hx",65,0x115f79df)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(  67)		this->width = width;
HXLINE(  68)		this->height = height;
            	}
