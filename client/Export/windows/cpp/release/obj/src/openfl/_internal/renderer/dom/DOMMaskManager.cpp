...
void DOMMaskManager_obj::pushMask( ::openfl::display::DisplayObject mask){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMMaskManager","pushMask",0xdaba3d2e,"openfl._internal.renderer.dom.DOMMaskManager.pushMask","openfl/_internal/renderer/dom/DOMMaskManager.hx",38,0x08bbb658)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mask,"mask")
HXLINE(  38)		 ::openfl::geom::Rectangle _hx_tmp = mask->getBounds(mask);
HXDLIN(  38)		 ::openfl::geom::Matrix _hx_tmp1 = mask->_hx___getRenderTransform();
HXDLIN(  38)		this->pushRect(_hx_tmp,_hx_tmp1);
            	}
...
HXLINE(  64)		Bool _hx_tmp = (this->numClipRects == this->clipRects->length);
HXDLIN(  64)		if (_hx_tmp) {
HXLINE(  66)			Int _hx_tmp1 = this->numClipRects;
HXDLIN(  66)			this->clipRects[_hx_tmp1] =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            		}
...
HXLINE(  73)		Bool _hx_tmp2 = (this->numClipRects > (int)0);
...
HXLINE(  80)		Bool _hx_tmp3 = (clipRect->height < (int)0);
HXDLIN(  80)		if (_hx_tmp3) {
HXLINE(  82)			clipRect->height = (int)0;
            		}
HXLINE(  86)		Bool _hx_tmp4 = (clipRect->width < (int)0);
...
Bool handleScrollRect = __o_handleScrollRect.Default(true);
            	...
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(handleScrollRect,"handleScrollRect")
HXLINE( 107)		Bool _hx_tmp = hx::IsNotNull( object->_hx___mask );
HXDLIN( 107)		if (_hx_tmp) {
HXLINE( 109)			this->popMask();
            		}
HXLINE( 113)		Bool _hx_tmp1;
HXDLIN( 113)		if (handleScrollRect) {
HXLINE( 113)			_hx_tmp1 = hx::IsNotNull( object->_hx___scrollRect );
            		}
            		else {
...
void DOMMaskManager_obj::popRect(){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMMaskManager","popRect",0x10286b0d,"openfl._internal.renderer.dom.DOMMaskManager.popRect","openfl/_internal/renderer/dom/DOMMaskManager.hx",124,0x08bbb658)
            	HX_STACK_THIS(this)
HXLINE( 124)		Bool _hx_tmp = (this->numClipRects > (int)0);
HXDLIN( 124)		if (_hx_tmp) {
HXLINE( 126)			this->numClipRects--;
HXLINE( 128)			Bool _hx_tmp1 = (this->numClipRects > (int)0);
HXDLIN( 128)			if (_hx_tmp1) {
HXLINE( 130)				Int _hx_tmp2 = (this->numClipRects - (int)1);
HXDLIN( 130)				this->currentClipRect = this->clipRects->__get(_hx_tmp2).StaticCast<  ::openfl::geom::Rectangle >();
            			}
            			else {
...
void DOMMaskManager_obj::updateClip( ::openfl::display::DisplayObject displayObject){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMMaskManager","updateClip",0x972504c1,"openfl._internal.renderer.dom.DOMMaskManager.updateClip","openfl/_internal/renderer/dom/DOMMaskManager.hx",145,0x08bbb658)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayObject,"displayObject")
HXLINE( 145)		Bool _hx_tmp = hx::IsNull( this->currentClipRect );
...
HXLINE( 152)			Bool _hx_tmp1 = hx::IsNull( displayObject->_hx___worldClip );
HXDLIN( 152)			if (_hx_tmp1) {
HXLINE( 154)				displayObject->_hx___worldClip =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            			}
...
HXLINE( 166)			Bool _hx_tmp2 = clip->equals(displayObject->_hx___worldClip);
