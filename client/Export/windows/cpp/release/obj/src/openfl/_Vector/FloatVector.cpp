...
HXLINE( 583)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN( 583)		if (_hx_tmp) {
HXLINE( 585)			array = ::Array_obj< Float >::__new();
            		}
HXLINE( 589)		this->_hx___array = array;
HXLINE( 591)		Bool _hx_tmp1 = hx::IsNotNull( length );
HXDLIN( 591)		if (_hx_tmp1) {
HXLINE( 593)			this->set_length(length);
            		}
HXLINE( 597)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic FloatVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","concat",0xbb39c8cd,"openfl._Vector.FloatVector.concat","openfl/Vector.hx",604,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 604)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN( 604)		if (_hx_tmp) {
HXLINE( 606)			::Array< Float > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 606)			return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE( 610)			::Array< Float > _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::FloatVector >::cast(a)->_hx___array);
HXDLIN( 610)			return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic FloatVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","copy",0xb028eb2e,"openfl._Vector.FloatVector.copy","openfl/Vector.hx",619,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 619)		Bool _hx_tmp = this->fixed;
HXDLIN( 619)		::Array< Float > _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 619)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
Float FloatVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","get",0x7cc8a33d,"openfl._Vector.FloatVector.get","openfl/Vector.hx",626,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 626)		return this->_hx___array->__get(index);
            	}
...
HXLINE( 633)		{
HXLINE( 633)			HX_VARI( Int,_g1) = from;
HXDLIN( 633)			HX_VARI( Int,_g) = this->_hx___array->length;
HXDLIN( 633)			while((_g1 < _g)){
HXLINE( 633)				HX_VARI( Int,i) = _g1++;
HXLINE( 635)				if ((this->_hx___array->__get(i) == x)) {
HXLINE( 637)					return i;
            				}
            			}
            		}
HXLINE( 643)		return (int)-1;
            	}
...
void FloatVector_obj::insertAt(Int index,Float element){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","insertAt",0xb3435c85,"openfl._Vector.FloatVector.insertAt","openfl/Vector.hx",650,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(element,"element")
HXLINE( 650)		Bool _hx_tmp;
HXDLIN( 650)		if (!(!(this->fixed))) {
HXLINE( 650)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 650)			_hx_tmp = true;
            		}
HXDLIN( 650)		if (_hx_tmp) {
HXLINE( 652)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,insertAt,(void))
 ...
 ::Dynamic FloatVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","iterator",0x84be29e7,"openfl._Vector.FloatVector.iterator","openfl/Vector.hx",661,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 661)		return this->_hx___array->iterator();
            	}
...
::String FloatVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","join",0xb4c96363,"openfl._Vector.FloatVector.join","openfl/Vector.hx",668,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sep,"sep")
HXLINE( 668)		return this->_hx___array->join(sep);
            	}
...
Int FloatVector_obj::lastIndexOf(Float x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 675)		HX_VARI( Int,i) = (this->_hx___array->length - (int)1);
HXLINE( 677)		while(hx::IsGreaterEq( i,from )){
HXLINE( 679)			if ((this->_hx___array->__get(i) == x)) {
HXLINE( 679)				return i;
            			}
HXLINE( 680)			--i;
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,lastIndexOf,return )
 ...
 ::Dynamic FloatVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","pop",0x7ccf8038,"openfl._Vector.FloatVector.pop","openfl/Vector.hx",691,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 691)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 691)		if (_hx_tmp) {
HXLINE( 693)			return this->_hx___array->pop();
            		}
            		else {
HXLINE( 697)			return null();
            		}
HXLINE( 691)		return ((Float)0.);
            	}
...
Int FloatVector_obj::push(Float x){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","push",0xb8c54153,"openfl._Vector.FloatVector.push","openfl/Vector.hx",706,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 706)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 706)		if (_hx_tmp) {
HXLINE( 708)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE( 712)			return this->_hx___array->length;
            		}
...
void FloatVector_obj::reverse(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 721)		this->_hx___array->reverse();
            	}
...
Float FloatVector_obj::set(Int index,Float value){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","set",0x7cd1be49,"openfl._Vector.FloatVector.set","openfl/Vector.hx",728,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(value,"value")
HXLINE( 728)		Bool _hx_tmp;
HXDLIN( 728)		if (!(!(this->fixed))) {
HXLINE( 728)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 728)			_hx_tmp = true;
            		}
HXDLIN( 728)		if (_hx_tmp) {
HXLINE( 730)			return (this->_hx___array[index] = value);
            		}
            		else {
HXLINE( 734)			return value;
            		}
HXLINE( 728)		return ((Float)0.);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FloatVector_obj,set,return )
 ...
 ::Dynamic FloatVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","shift",0xa56846e9,"openfl._Vector.FloatVector.shift","openfl/Vector.hx",743,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 743)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 743)		if (_hx_tmp) {
HXLINE( 745)			return this->_hx___array->shift();
            		}
            		else {
...
::Dynamic FloatVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.FloatVector","slice",0xa80d1eb9,"openfl._Vector.FloatVector.slice","openfl/Vector.hx",758,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE( 758)		::Array< Float > _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN( 758)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void FloatVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","sort",0xbabc56d7,"openfl._Vector.FloatVector.sort","openfl/Vector.hx",765,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 765)		this->_hx___array->sort(f);
            	}
...
::Dynamic FloatVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","splice",0xb3084535,"openfl._Vector.FloatVector.splice","openfl/Vector.hx",772,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE( 772)		::Array< Float > _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN( 772)		return  ::openfl::_Vector::FloatVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String FloatVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","toString",0x2992b0a5,"openfl._Vector.FloatVector.toString","openfl/Vector.hx",779,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 779)		return this->_hx___array->toString();
            	}
...
void FloatVector_obj::unshift(Float x){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","unshift",0x81d1e5b0,"openfl._Vector.FloatVector.unshift","openfl/Vector.hx",786,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 786)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 786)		if (_hx_tmp) {
HXLINE( 788)			this->_hx___array->unshift(x);
            		}
            	}
...
Int FloatVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.FloatVector","get_length",0xf96594e8,"openfl._Vector.FloatVector.get_length","openfl/Vector.hx",804,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 804)		return this->_hx___array->length;
            	}
...
Int FloatVector_obj::set_length(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 811)		Bool _hx_tmp = !(this->fixed);
HXDLIN( 811)		if (_hx_tmp) {
HXLINE( 815)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE( 844)		return this->_hx___array->length;
            	}
