...
HXLINE(  23)			::openfl::Lib_obj::current->stage->addEventListener(HX_("enterFrame",f5,03,50,02),::openfl::_internal::renderer::flash::FlashRenderer_obj::render_dyn(),false,(int)-2147483648,null());
            		}
...
HXLINE(  34)		 ::Dynamic instance = ::openfl::_internal::renderer::flash::FlashRenderer_obj::instances->keys();
HXDLIN(  34)		while(( (bool)(instance->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  34)			::Dynamic instance1 = instance->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
