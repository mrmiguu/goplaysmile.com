...
HX_LOCAL_STACK_FRAME(_hx_pos_9149717b628345a7_94_fill,"openfl._internal.utils.PerlinNoise","fill",0x3a79a8b8,"openfl._internal.utils.PerlinNoise.fill","openfl/_internal/utils/PerlinNoise.hx",94,0x13a5c608)
HX_LOCAL_STACK_FRAME(_hx_pos_9149717b628345a7_200_octFreqPers,"openfl._internal.utils.PerlinNoise","octFreqPers",0x79fea539,"openfl._internal.utils.PerlinNoise.octFreqPers","openfl/_internal/utils/PerlinNoise.hx",200,0x13a5c608)
HX_LOCAL_STACK_FRAME(_hx_pos_9149717b628345a7_219_seedOffset,"openfl._internal.utils.PerlinNoise","seedOffset",0x045eabd9,"openfl._internal.utils.PerlinNoise.seedOffset","openfl/_internal/utils/PerlinNoise.hx",219,0x13a5c608)
HX_LOCAL_STACK_FRAME(_hx_pos_9149717b628345a7_17_boot,"openfl._internal.utils.PerlinNoise","boot",0x37d95e67,"openfl._internal.utils.PerlinNoise.boot","openfl/_internal/utils/PerlinNoise.hx",17,0x13a5c608)
...
HXLINE(  96)		Float baseX = ((_x * this->baseFactor) + this->iXoffset);
HXLINE(  99)		_y = ((_y * this->baseFactor) + this->iYoffset);
HXLINE( 100)		_z = ((_z * this->baseFactor) + this->iZoffset);
HXLINE( 102)		int width = bitmap->width;
HXLINE( 103)		int height = bitmap->height;
HXLINE( 105)		::Array< int > p = ::openfl::_internal::utils::PerlinNoise_obj::P;
HXLINE( 106)		int octaves = this->octaves;
HXLINE( 107)		::Array< Float > aOctFreq = this->aOctFreq;
HXLINE( 108)		::Array< Float > aOctPers = this->aOctPers;
HXLINE( 110)		{
HXLINE( 110)			int _g1 = (int)0;
HXDLIN( 110)			int _g = height;
HXDLIN( 110)			while((_g1 < _g)){
HXLINE( 110)				_g1 = (_g1 + (int)1);
HXDLIN( 110)				int py = (_g1 - (int)1);
HXLINE( 112)				_x = baseX;
HXLINE( 114)				{
HXLINE( 114)					int _g3 = (int)0;
HXDLIN( 114)					int _g2 = width;
HXDLIN( 114)					while((_g3 < _g2)){
HXLINE( 114)						_g3 = (_g3 + (int)1);
HXDLIN( 114)						int px = (_g3 - (int)1);
HXLINE( 116)						Float s = ((Float)0.);
HXLINE( 118)						{
...
HXLINE( 120)								Float fFreq = aOctFreq->__get(i);
HXLINE( 121)								Float fPers = aOctPers->__get(i);
HXLINE( 123)								Float x = (_x * fFreq);
HXLINE( 124)								Float y = (_y * fFreq);
HXLINE( 125)								Float z = (_z * fFreq);
HXLINE( 127)								Float xf = (x - hx::Mod(x,(int)1));
HXLINE( 128)								Float yf = (y - hx::Mod(y,(int)1));
HXLINE( 129)								Float zf = (z - hx::Mod(z,(int)1));
HXLINE( 131)								int X = ((int)::Std_obj::_hx_int(xf) & (int)(int)255);
HXLINE( 132)								int Y = ((int)::Std_obj::_hx_int(yf) & (int)(int)255);
HXLINE( 133)								int Z = ((int)::Std_obj::_hx_int(zf) & (int)(int)255);
HXLINE( 135)								x = (x - xf);
HXLINE( 136)								y = (y - yf);
HXLINE( 137)								z = (z - zf);
HXLINE( 139)								Float u = (((x * x) * x) * ((x * ((x * (int)6) - (int)15)) + (int)10));
HXLINE( 140)								Float v = (((y * y) * y) * ((y * ((y * (int)6) - (int)15)) + (int)10));
HXLINE( 141)								Float w = (((z * z) * z) * ((z * ((z * (int)6) - (int)15)) + (int)10));
HXLINE( 143)								int A = (p->__get(X) + Y);
HXLINE( 144)								int AA = (p->__get(A) + Z);
HXLINE( 145)								int AB = (p->__get((A + (int)1)) + Z);
HXLINE( 146)								int B = (p->__get((X + (int)1)) + Y);
HXLINE( 147)								int BA = (p->__get(B) + Z);
HXLINE( 148)								int BB = (p->__get((B + (int)1)) + Z);
HXLINE( 150)								Float x1 = (x - (int)1);
HXLINE( 151)								Float y1 = (y - (int)1);
HXLINE( 152)								Float z1 = (z - (int)1);
HXLINE( 154)								int hash = ((int)p->__get((BB + (int)1)) & (int)(int)15);
HXLINE( 155)								Float g1;
...
HXDLIN( 176)								Float g82 = (g8 + g81);
HXLINE( 178)								g22 = (g22 + (u * (g12 - g22)));
HXLINE( 179)								g42 = (g42 + (u * (g32 - g42)));
HXLINE( 180)								g62 = (g62 + (u * (g52 - g62)));
HXLINE( 181)								g82 = (g82 + (u * (g72 - g82)));
HXLINE( 183)								g42 = (g42 + (v * (g22 - g42)));
HXLINE( 184)								g82 = (g82 + (v * (g62 - g82)));
HXLINE( 186)								s = (s + ((g82 + (w * (g42 - g82))) * fPers));
            							}
            						}
HXLINE( 189)						int color = ::Std_obj::_hx_int((((s * this->fPersMax) + (int)1) * (int)128));
...
HXLINE( 202)		Float fFreq;
HXDLIN( 202)		Float fPers;
...
HXDLIN( 208)			int _g = this->octaves;
