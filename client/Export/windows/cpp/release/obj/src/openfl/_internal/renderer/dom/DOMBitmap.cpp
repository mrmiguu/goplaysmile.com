...
void DOMBitmap_obj::renderCanvas( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMBitmap","renderCanvas",0x22facaf2,"openfl._internal.renderer.dom.DOMBitmap.renderCanvas","openfl/_internal/renderer/dom/DOMBitmap.hx",64,0x32124034)
            	HX_STACK_ARG(bitmap,"bitmap")
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
...
void DOMBitmap_obj::renderImage( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMBitmap","renderImage",0x8ed26a81,"openfl._internal.renderer.dom.DOMBitmap.renderImage","openfl/_internal/renderer/dom/DOMBitmap.hx",112,0x32124034)
            	HX_STACK_ARG(bitmap,"bitmap")
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
