...
Dynamic UncaughtErrorEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event UncaughtErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->error);
...
::String UncaughtErrorEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  34)		return this->_hx___formatToString(HX_("UncaughtErrorEvent",47,72,9a,e0),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
