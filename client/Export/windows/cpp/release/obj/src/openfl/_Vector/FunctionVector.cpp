...
void FunctionVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","new",0x9bdddf17,"openfl._Vector.FunctionVector.new","openfl/Vector.hx",878,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 880)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN( 880)		if (_hx_tmp) {
HXLINE( 882)			array = ::cpp::VirtualArray_obj::__new();
            		}
HXLINE( 886)		this->_hx___array = array;
HXLINE( 888)		Bool _hx_tmp1 = hx::IsNotNull( length );
...
::Dynamic FunctionVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","concat",0x3878c6bd,"openfl._Vector.FunctionVector.concat","openfl/Vector.hx",901,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 901)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN( 901)		if (_hx_tmp) {
HXLINE( 903)			::cpp::VirtualArray _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 903)			return  ::openfl::_Vector::FunctionVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE( 907)			::cpp::VirtualArray _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::FunctionVector >::cast(a)->_hx___array);
HXDLIN( 907)			return  ::openfl::_Vector::FunctionVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic FunctionVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","copy",0xbf078d1e,"openfl._Vector.FunctionVector.copy","openfl/Vector.hx",916,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 916)		Bool _hx_tmp = this->fixed;
HXDLIN( 916)		::cpp::VirtualArray _hx_tmp1 = this->_hx___array->copy();
HXDLIN( 916)		return  ::openfl::_Vector::FunctionVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FunctionVector_obj,copy,return )
 ...
 ::Dynamic FunctionVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","get",0x9bd88f4d,"openfl._Vector.FunctionVector.get","openfl/Vector.hx",923,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int FunctionVector_obj::indexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","indexOf",0x03bc7f00,"openfl._Vector.FunctionVector.indexOf","openfl/Vector.hx",936,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
HXLINE( 938)				HX_VARI( Int,i) = _g1++;
HXLINE( 940)				 ::Dynamic _hx_tmp = this->_hx___array->__get(i);
HXDLIN( 940)				Bool _hx_tmp1 = ::Reflect_obj::compareMethods(_hx_tmp,x);
...
void FunctionVector_obj::insertAt(Int index, ::Dynamic element){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","insertAt",0x3cb1b675,"openfl._Vector.FunctionVector.insertAt","openfl/Vector.hx",955,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,insertAt,(void))
 ...
 ::Dynamic FunctionVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","iterator",0x0e2c83d7,"openfl._Vector.FunctionVector.iterator","openfl/Vector.hx",966,0x4a01873c)
            	HX_STACK_THIS(this)
...
::String FunctionVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","join",0xc3a80553,"openfl._Vector.FunctionVector.join","openfl/Vector.hx",973,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int FunctionVector_obj::lastIndexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","lastIndexOf",0xc9451aca,"openfl._Vector.FunctionVector.lastIndexOf","openfl/Vector.hx",978,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 980)		HX_VARI( Int,i) = (this->_hx___array->get_length() - (int)1);
HXLINE( 982)		while(hx::IsGreaterEq( i,from )){
HXLINE( 984)			 ::Dynamic _hx_tmp = this->_hx___array->__get(i);
HXDLIN( 984)			Bool _hx_tmp1 = ::Reflect_obj::compareMethods(_hx_tmp,x);
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,lastIndexOf,return )
 ...
 ::Dynamic FunctionVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","pop",0x9bdf6c48,"openfl._Vector.FunctionVector.pop","openfl/Vector.hx",996,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE( 996)		Bool _hx_tmp = !(this->fixed);
...
Int FunctionVector_obj::push( ::Dynamic x){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","push",0xc7a3e343,"openfl._Vector.FunctionVector.push","openfl/Vector.hx",1011,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1011)		Bool _hx_tmp = !(this->fixed);
...
void FunctionVector_obj::reverse(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","reverse",0x3df96f59,"openfl._Vector.FunctionVector.reverse","openfl/Vector.hx",1026,0x4a01873c)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(FunctionVector_obj,reverse,(void))
 ...
 ::Dynamic FunctionVector_obj::set(Int index, ::Dynamic value){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","set",0x9be1aa59,"openfl._Vector.FunctionVector.set","openfl/Vector.hx",1033,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,set,return )
 ...
 ::Dynamic FunctionVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","shift",0x995756f9,"openfl._Vector.FunctionVector.shift","openfl/Vector.hx",1048,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1048)		Bool _hx_tmp = !(this->fixed);
...
::Dynamic FunctionVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","slice",0x9bfc2ec9,"openfl._Vector.FunctionVector.slice","openfl/Vector.hx",1063,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1063)		::cpp::VirtualArray _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
...
void FunctionVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","sort",0xc99af8c7,"openfl._Vector.FunctionVector.sort","openfl/Vector.hx",1070,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
::Dynamic FunctionVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","splice",0x30474325,"openfl._Vector.FunctionVector.splice","openfl/Vector.hx",1077,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE(1077)		::cpp::VirtualArray _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN(1077)		return  ::openfl::_Vector::FunctionVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String FunctionVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","toString",0xb3010a95,"openfl._Vector.FunctionVector.toString","openfl/Vector.hx",1084,0x4a01873c)
            	HX_STACK_THIS(this)
...
void FunctionVector_obj::unshift( ::Dynamic x){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","unshift",0x9bb119c0,"openfl._Vector.FunctionVector.unshift","openfl/Vector.hx",1091,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1091)		Bool _hx_tmp = !(this->fixed);
...
Int FunctionVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","get_length",0x7e924ad8,"openfl._Vector.FunctionVector.get_length","openfl/Vector.hx",1109,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int FunctionVector_obj::set_length(Int value){
            	HX_STACK_FRAME("openfl._Vector.FunctionVector","set_length",0x820fe94c,"openfl._Vector.FunctionVector.set_length","openfl/Vector.hx",1114,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1116)		Bool _hx_tmp = !(this->fixed);
