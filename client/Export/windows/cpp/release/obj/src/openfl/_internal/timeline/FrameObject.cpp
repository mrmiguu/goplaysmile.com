...
void FrameObject_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.timeline.FrameObject","new",0xc85ed3e1,"openfl._internal.timeline.FrameObject.new","openfl/_internal/timeline/FrameObject.hx",24,0xd3e45f6e)
            	HX_STACK_THIS(this)
            	}
