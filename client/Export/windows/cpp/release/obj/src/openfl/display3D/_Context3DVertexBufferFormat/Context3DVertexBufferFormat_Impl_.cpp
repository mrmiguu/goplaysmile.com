...
Dynamic Context3DVertexBufferFormat_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Context3DVertexBufferFormat_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","fromString",0x69b9a727,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.fromString","openfl/display3D/Context3DVertexBufferFormat.hx",15,0x4ab2835e)
...
::String Context3DVertexBufferFormat_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","toString",0xa34b1ef8,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.toString","openfl/display3D/Context3DVertexBufferFormat.hx",30,0x4ab2835e)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",7,0x4ab2835e)
HXLINE(   7)		BYTES_4 = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",8,0x4ab2835e)
HXLINE(   8)		FLOAT_1 = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",9,0x4ab2835e)
HXLINE(   9)		FLOAT_2 = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",10,0x4ab2835e)
HXLINE(  10)		FLOAT_3 = (int)3;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","boot",0x1307bc7e,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.boot","openfl/display3D/Context3DVertexBufferFormat.hx",11,0x4ab2835e)
