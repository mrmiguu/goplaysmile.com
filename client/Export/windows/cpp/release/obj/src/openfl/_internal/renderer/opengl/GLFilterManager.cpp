...
void GLFilterManager_obj::__construct( ::openfl::_internal::renderer::opengl::GLRenderer renderer, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLFilterManager","new",0xa57802be,"openfl._internal.renderer.opengl.GLFilterManager.new","openfl/_internal/renderer/opengl/GLFilterManager.hx",35,0xef502054)
            	HX_STACK_THIS(this)
...
HXLINE(  43)		this->matrix =  ::openfl::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
            	}
...
Dynamic GLFilterManager_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::Shader GLFilterManager_obj::pushObject( ::openfl::display::DisplayObject object){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLFilterManager","pushObject",0x4b4ad99b,"openfl._internal.renderer.opengl.GLFilterManager.pushObject","openfl/_internal/renderer/opengl/GLFilterManager.hx",48,0xef502054)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
HXLINE(  52)		Bool _hx_tmp;
HXDLIN(  52)		Bool _hx_tmp1 = hx::IsNotNull( object->_hx___filters );
...
HXLINE(  54)				_hx_tmp2 = (object->_hx___filters->__get((int)0).StaticCast<  ::openfl::filters::BitmapFilter >()->_hx___numPasses == (int)0);
            			}
            			else {
...
void GLFilterManager_obj::popObject( ::openfl::display::DisplayObject object){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLFilterManager","popObject",0x1feca00e,"openfl._internal.renderer.opengl.GLFilterManager.popObject","openfl/_internal/renderer/opengl/GLFilterManager.hx",75,0xef502054)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
HXLINE(  75)		Bool _hx_tmp;
HXDLIN(  75)		Bool _hx_tmp1 = hx::IsNotNull( object->_hx___filters );
...
HXLINE(  77)			HX_VARI(  ::openfl::filters::BitmapFilter,filter) = object->_hx___filters->__get((int)0).StaticCast<  ::openfl::filters::BitmapFilter >();
HXLINE(  78)			HX_VAR(  ::openfl::display::BitmapData,currentTarget);
HXDLIN(  78)			HX_VAR(  ::openfl::display::Shader,shader);
HXLINE(  80)			Bool _hx_tmp2;
HXDLIN(  80)			if ((object->_hx___filters->length <= (int)1)) {
HXLINE(  80)				_hx_tmp2 = (filter->_hx___numPasses > (int)0);
            			}
            			else {
...
HXDLIN(  91)					HX_VARI( Int,_g) = filter->_hx___numPasses;
HXDLIN(  91)					while((_g1 < _g)){
HXLINE(  91)						HX_VARI( Int,i) = _g1++;
HXLINE(  93)						currentTarget = this->renderer->currentRenderTarget;
HXLINE(  94)						this->renderer->getRenderTarget(true);
HXLINE(  95)						shader = filter->_hx___initShader(this->renderSession,i);
HXLINE(  97)						this->renderPass(currentTarget,shader);
            					}
            				}
HXLINE( 103)				this->filterDepth--;
HXLINE( 104)				Bool _hx_tmp3 = (this->filterDepth > (int)0);
HXDLIN( 104)				this->renderer->getRenderTarget(_hx_tmp3);
HXLINE( 106)				this->renderPass(this->renderer->currentRenderTarget,this->renderSession->shaderManager->defaultShader);
            			}
            			else {
HXLINE( 110)				this->filterDepth--;
            			}
            		}
            	}
...
void GLFilterManager_obj::renderPass( ::openfl::display::BitmapData target, ::openfl::display::Shader shader){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLFilterManager","renderPass",0xc987d4a9,"openfl._internal.renderer.opengl.GLFilterManager.renderPass","openfl/_internal/renderer/opengl/GLFilterManager.hx",119,0xef502054)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 121)		shader->get_data()->uImage0->input = target;
HXLINE( 122)		Bool _hx_tmp;
HXDLIN( 122)		if (this->renderSession->allowSmoothing) {
HXLINE( 122)			_hx_tmp = this->renderSession->upscaled;
            		}
            		else {
HXLINE( 122)			_hx_tmp = false;
            		}
HXDLIN( 122)		shader->get_data()->uImage0->smoothing = _hx_tmp;
HXLINE( 123)		shader->get_data()->uMatrix->value = this->renderer->getMatrix(this->matrix);
HXLINE( 125)		this->renderSession->shaderManager->setShader(shader);
HXLINE( 127)		Int _hx_tmp1 = this->gl->ARRAY_BUFFER;
HXDLIN( 127)		 ::lime::graphics::opengl::GLBuffer _hx_tmp2 = target->getBuffer(this->gl,(int)1);
HXDLIN( 127)		this->gl->bindBuffer(_hx_tmp1,_hx_tmp2);
HXLINE( 128)		this->gl->vertexAttribPointer(shader->get_data()->aPosition->index,(int)3,this->gl->FLOAT,false,(int)24,(int)0);
HXLINE( 129)		this->gl->vertexAttribPointer(shader->get_data()->aTexCoord->index,(int)2,this->gl->FLOAT,false,(int)24,(int)12);
HXLINE( 130)		this->gl->vertexAttribPointer(shader->get_data()->aAlpha->index,(int)1,this->gl->FLOAT,false,(int)24,(int)20);
HXLINE( 132)		this->gl->drawArrays(this->gl->TRIANGLE_STRIP,(int)0,(int)4);
            	}
