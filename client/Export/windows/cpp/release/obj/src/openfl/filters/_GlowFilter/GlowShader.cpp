...
void GlowShader_obj::__construct(){
            	HX_STACK_FRAME("openfl.filters._GlowFilter.GlowShader","new",0x65561d5f,"openfl.filters._GlowFilter.GlowShader.new","openfl/filters/GlowFilter.hx",177,0x5f568606)
            	HX_STACK_THIS(this)
...
HXLINE( 768)		Bool _hx_tmp1 = hx::IsNull( this->_hx___glVertexSource );
HXDLIN( 768)		if (_hx_tmp1) {
HXLINE( 768)			this->_hx___glVertexSource = HX_("attribute float aAlpha;\n\t\tattribute vec4 aPosition;\n\t\tattribute vec2 aTexCoord;\n\t\tvarying float vAlpha;\n\t\tvarying vec2 vTexCoord;\n\t\t\n\t\tuniform mat4 uMatrix;\n\t\t\n\t\tuniform vec2 uRadius;\n\t\tvarying vec2 vBlurCoords[7];\n\t\tuniform vec2 uTextureSize;\n\t\t\n\t\tvoid main(void) {\n\t\t\t\n\t\t\tvAlpha = aAlpha;\n\t\t\tvTexCoord = aTexCoord;\n\t\t\tgl_Position = uMatrix * aPosition;\n\t\t\t\n\t\t\tvec2 r = uRadius / uTextureSize;\n\t\t\tvBlurCoords[0] = aTexCoord - r * 1.0;\n\t\t\tvBlurCoords[1] = aTexCoord - r * 0.75;\n\t\t\tvBlurCoords[2] = aTexCoord - r * 0.5;\n\t\t\tvBlurCoords[3] = aTexCoord;\n\t\t\tvBlurCoords[4] = aTexCoord + r * 0.5;\n\t\t\tvBlurCoords[5] = aTexCoord + r * 0.75;\n\t\t\tvBlurCoords[6] = aTexCoord + r * 1.0;\n\t\t\t\n\t\t}",76,1b,0f,ea);
            		}
HXLINE( 179)		super::__construct(null());
HXLINE( 181)		 ::Dynamic(this->get_data()->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0),hx::paccDynamic);
HXLINE( 182)		 ::Dynamic(this->get_data()->__Field(HX_("uColor",ae,18,4b,a5),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(4)->init(0,(int)0)->init(1,(int)0)->init(2,(int)0)->init(3,(int)0),hx::paccDynamic);
            	}
...
void GlowShader_obj::_hx___update(){
            	HX_STACK_FRAME("openfl.filters._GlowFilter.GlowShader","__update",0x776027ca,"openfl.filters._GlowFilter.GlowShader.__update","openfl/filters/GlowFilter.hx",187,0x5f568606)
            	HX_STACK_THIS(this)
HXLINE( 189)		Int _hx_tmp = this->get_data()->uImage0->input->width;
HXDLIN( 189)		 ::Dynamic(this->get_data()->__Field(HX_("uTextureSize",c7,50,82,f3),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,_hx_tmp)->init(1,this->get_data()->uImage0->input->height),hx::paccDynamic);
HXLINE( 191)		this->super::_hx___update();
            	}
