...
Dynamic TouchEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_STACK_FRAME("openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",63,0x2fe85d0c)
            	HX_STACK_THIS(this)
HXLINE(  65)		HX_VARI(  ::openfl::events::TouchEvent,event) =  ::openfl::events::TouchEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
...
::String TouchEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",76,0x2fe85d0c)
            	HX_STACK_THIS(this)
HXLINE(  76)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_0,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACK_FRAME("openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",81,0x2fe85d0c)
            	HX_STACK_THIS(this)
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_STACK_FRAME("openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",88,0x2fe85d0c)
            	HX_STACK_ARG(type,"type")
...
HXLINE(  90)		HX_VARI(  ::openfl::events::TouchEvent,evt) =  ::openfl::events::TouchEvent_obj::__new(type,true,false,(int)0,true,local->x,local->y,(int)1,(int)1,(int)1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
