...
void TextureBase_obj::__construct( ::openfl::display3D::Context3D context,Int target){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","new",0x670078a1,"openfl.display3D.textures.TextureBase.new","openfl/display3D/textures/TextureBase.hx",18,0x7b0f92ae)
            	HX_STACK_THIS(this)
...
HXLINE(  60)		Bool _hx_tmp = hx::IsNull( ::openfl::display3D::textures::TextureBase_obj::_hx___isGLES );
...
HXDLIN(  63)			Int _hx_tmp2 = version.indexOf(HX_("OpenGL ES",5f,cb,92,95),null());
HXDLIN(  63)			if ((_hx_tmp2 > (int)-1)) {
HXLINE(  63)				Int _hx_tmp3 = version.indexOf(HX_("WebGL",99,9f,e9,5a),null());
HXDLIN(  63)				_hx_tmp1 = (_hx_tmp3 == (int)-1);
            			}
            			else {
HXLINE(  63)				_hx_tmp1 = false;
            			}
HXDLIN(  63)			::openfl::display3D::textures::TextureBase_obj::_hx___isGLES = _hx_tmp1;
            		}
HXLINE(  67)		Int _hx_tmp4;
HXDLIN(  67)		if (::openfl::display3D::textures::TextureBase_obj::_hx___isGLES) {
HXLINE(  67)			_hx_tmp4 = (int)32993;
            		}
            		else {
HXLINE(  67)			_hx_tmp4 = (int)6408;
            		}
HXDLIN(  67)		this->_hx___internalFormat = _hx_tmp4;
HXLINE(  68)		this->_hx___format = (int)32993;
HXLINE(  72)		this->_hx___memoryUsage = (int)0;
HXLINE(  73)		this->_hx___compressedMemoryUsage = (int)0;
            	}
...
void TextureBase_obj::dispose(){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","dispose",0xa678dd60,"openfl.display3D.textures.TextureBase.dispose","openfl/display3D/textures/TextureBase.hx",78,0x7b0f92ae)
            	HX_STACK_THIS(this)
HXLINE(  80)		Bool _hx_tmp = hx::IsNotNull( this->_hx___alphaTexture );
HXDLIN(  80)		if (_hx_tmp) {
HXLINE(  82)			this->_hx___alphaTexture->dispose();
            		}
HXLINE(  86)		::lime::graphics::opengl::GL_obj::context->deleteTexture(this->_hx___textureID);
HXLINE(  88)		Bool _hx_tmp1 = (this->_hx___compressedMemoryUsage > (int)0);
HXDLIN(  88)		if (_hx_tmp1) {
HXLINE(  90)			this->_hx___context->_hx___statsDecrement((int)4);
HXLINE(  91)			this->_hx___context->_hx___statsSubtract((int)9,this->_hx___compressedMemoryUsage);
HXLINE( 101)			this->_hx___compressedMemoryUsage = (int)0;
            		}
HXLINE( 105)		Bool _hx_tmp2 = (this->_hx___memoryUsage > (int)0);
HXDLIN( 105)		if (_hx_tmp2) {
HXLINE( 107)			this->_hx___context->_hx___statsDecrement((int)3);
HXLINE( 108)			this->_hx___context->_hx___statsSubtract((int)8,this->_hx___memoryUsage);
HXLINE( 118)			this->_hx___memoryUsage = (int)0;
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextureBase_obj,dispose,(void))
 ...
 ::lime::graphics::Image TextureBase_obj::_hx___getImage( ::openfl::display::BitmapData bitmapData){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__getImage",0x67fff3e4,"openfl.display3D.textures.TextureBase.__getImage","openfl/display3D/textures/TextureBase.hx",125,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bitmapData,"bitmapData")
HXLINE( 127)		HX_VARI(  ::lime::graphics::Image,image) = bitmapData->image;
HXLINE( 129)		Bool _hx_tmp;
HXDLIN( 129)		if (!(!(bitmapData->_hx___isValid))) {
HXLINE( 129)			_hx_tmp = hx::IsNull( image );
            		}
            		else {
...
HXDLIN( 168)		Bool _hx_tmp2 = !(image->get_premultiplied());
HXDLIN( 168)		if (_hx_tmp2) {
HXLINE( 168)			_hx_tmp1 = image->get_transparent();
            		}
            		else {
HXLINE( 168)			_hx_tmp1 = false;
            		}
HXDLIN( 168)		if (_hx_tmp1) {
HXLINE( 170)			image = image->clone();
HXLINE( 171)			image->set_premultiplied(true);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(TextureBase_obj,_hx___getImage,return )
 ...
 ::lime::graphics::opengl::GLTexture TextureBase_obj::_hx___getTexture(){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__getTexture",0x3c3c91a4,"openfl.display3D.textures.TextureBase.__getTexture","openfl/display3D/textures/TextureBase.hx",187,0x7b0f92ae)
            	HX_STACK_THIS(this)
HXLINE( 187)		return this->_hx___textureID;
            	}
...
void TextureBase_obj::_hx___setSamplerState( ::openfl::_internal::stage3D::SamplerState state){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__setSamplerState",0x8e361f8c,"openfl.display3D.textures.TextureBase.__setSamplerState","openfl/display3D/textures/TextureBase.hx",194,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 194)		Bool _hx_tmp = !(state->equals(this->_hx___samplerState));
HXDLIN( 194)		if (_hx_tmp) {
HXLINE( 196)			{
HXLINE( 196)				Int target = this->_hx___textureTarget;
HXDLIN( 196)				::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            			}
HXLINE( 197)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 198)			{
HXLINE( 198)				Int target1 = this->_hx___textureTarget;
HXDLIN( 198)				Int param = state->minFilter;
HXDLIN( 198)				::lime::graphics::opengl::GL_obj::context->texParameteri(target1,(int)10241,param);
            			}
HXLINE( 199)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 200)			{
HXLINE( 200)				Int target2 = this->_hx___textureTarget;
HXDLIN( 200)				Int param1 = state->magFilter;
HXDLIN( 200)				::lime::graphics::opengl::GL_obj::context->texParameteri(target2,(int)10240,param1);
            			}
HXLINE( 201)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 202)			{
HXLINE( 202)				Int target3 = this->_hx___textureTarget;
HXDLIN( 202)				Int param2 = state->wrapModeS;
HXDLIN( 202)				::lime::graphics::opengl::GL_obj::context->texParameteri(target3,(int)10242,param2);
            			}
HXLINE( 203)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 204)			{
HXLINE( 204)				Int target4 = this->_hx___textureTarget;
HXDLIN( 204)				Int param3 = state->wrapModeT;
HXDLIN( 204)				::lime::graphics::opengl::GL_obj::context->texParameteri(target4,(int)10243,param3);
            			}
HXLINE( 205)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 214)			this->_hx___samplerState = state;
            		}
            	}
...
void TextureBase_obj::_hx___trackCompressedMemoryUsage(Int memory){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__trackCompressedMemoryUsage",0x1551bb93,"openfl.display3D.textures.TextureBase.__trackCompressedMemoryUsage","openfl/display3D/textures/TextureBase.hx",221,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(memory,"memory")
HXLINE( 223)		Bool _hx_tmp = (this->_hx___compressedMemoryUsage == (int)0);
HXDLIN( 223)		if (_hx_tmp) {
HXLINE( 225)			this->_hx___context->_hx___statsIncrement((int)4);
            		}
HXLINE( 229)		hx::AddEq(this->_hx___compressedMemoryUsage,memory);
HXLINE( 230)		this->_hx___context->_hx___statsAdd((int)9,memory);
HXLINE( 240)		this->_hx___trackMemoryUsage(memory);
            	}
...
void TextureBase_obj::_hx___trackMemoryUsage(Int memory){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__trackMemoryUsage",0xc7a62994,"openfl.display3D.textures.TextureBase.__trackMemoryUsage","openfl/display3D/textures/TextureBase.hx",245,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(memory,"memory")
HXLINE( 247)		Bool _hx_tmp = (this->_hx___memoryUsage == (int)0);
HXDLIN( 247)		if (_hx_tmp) {
HXLINE( 249)			this->_hx___context->_hx___statsIncrement((int)3);
            		}
HXLINE( 253)		hx::AddEq(this->_hx___memoryUsage,memory);
HXLINE( 254)		this->_hx___context->_hx___statsAdd((int)8,memory);
            	}
