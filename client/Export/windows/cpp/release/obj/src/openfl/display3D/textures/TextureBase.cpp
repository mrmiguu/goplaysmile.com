...
HXLINE(  64)			Bool _hx_tmp1 = hx::IsNull( version );
HXDLIN(  64)			if (_hx_tmp1) {
HXLINE(  66)				::openfl::display3D::textures::TextureBase_obj::_hx___isGLES = false;
            			}
            			else {
HXLINE(  70)				Bool _hx_tmp2;
HXDLIN(  70)				Int _hx_tmp3 = version.indexOf(HX_("OpenGL ES",5f,cb,92,95),null());
HXDLIN(  70)				if ((_hx_tmp3 > (int)-1)) {
HXLINE(  70)					Int _hx_tmp4 = version.indexOf(HX_("WebGL",99,9f,e9,5a),null());
HXDLIN(  70)					_hx_tmp2 = (_hx_tmp4 == (int)-1);
            				}
            				else {
HXLINE(  70)					_hx_tmp2 = false;
            				}
HXDLIN(  70)				::openfl::display3D::textures::TextureBase_obj::_hx___isGLES = _hx_tmp2;
            			}
            		}
HXLINE(  76)		Int _hx_tmp5;
HXDLIN(  76)		if (::openfl::display3D::textures::TextureBase_obj::_hx___isGLES) {
HXLINE(  76)			_hx_tmp5 = (int)32993;
            		}
            		else {
HXLINE(  76)			_hx_tmp5 = (int)6408;
            		}
HXDLIN(  76)		this->_hx___internalFormat = _hx_tmp5;
...
void TextureBase_obj::dispose(){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","dispose",0xa678dd60,"openfl.display3D.textures.TextureBase.dispose","openfl/display3D/textures/TextureBase.hx",87,0x7b0f92ae)
            	HX_STACK_THIS(this)
HXLINE(  89)		Bool _hx_tmp = hx::IsNotNull( this->_hx___alphaTexture );
...
HXLINE(  97)		Bool _hx_tmp1 = (this->_hx___compressedMemoryUsage > (int)0);
...
HXLINE( 114)		Bool _hx_tmp2 = (this->_hx___memoryUsage > (int)0);
...
HX_DEFINE_DYNAMIC_FUNC0(TextureBase_obj,dispose,(void))
 ...
 ::lime::graphics::Image TextureBase_obj::_hx___getImage( ::openfl::display::BitmapData bitmapData){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__getImage",0x67fff3e4,"openfl.display3D.textures.TextureBase.__getImage","openfl/display3D/textures/TextureBase.hx",134,0x7b0f92ae)
            	HX_STACK_THIS(this)
...
HXDLIN( 177)		Bool _hx_tmp2 = !(image->get_premultiplied());
...
HX_DEFINE_DYNAMIC_FUNC1(TextureBase_obj,_hx___getImage,return )
 ...
 ::lime::graphics::opengl::GLTexture TextureBase_obj::_hx___getTexture(){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__getTexture",0x3c3c91a4,"openfl.display3D.textures.TextureBase.__getTexture","openfl/display3D/textures/TextureBase.hx",196,0x7b0f92ae)
            	HX_STACK_THIS(this)
...
void TextureBase_obj::_hx___setSamplerState( ::openfl::_internal::stage3D::SamplerState state){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__setSamplerState",0x8e361f8c,"openfl.display3D.textures.TextureBase.__setSamplerState","openfl/display3D/textures/TextureBase.hx",203,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 203)		Bool _hx_tmp = !(state->equals(this->_hx___samplerState));
HXDLIN( 203)		if (_hx_tmp) {
HXLINE( 205)			{
HXLINE( 205)				Int target = this->_hx___textureTarget;
HXDLIN( 205)				::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            			}
HXLINE( 206)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 207)			{
HXLINE( 207)				Int target1 = this->_hx___textureTarget;
HXDLIN( 207)				Int param = state->minFilter;
HXDLIN( 207)				::lime::graphics::opengl::GL_obj::context->texParameteri(target1,(int)10241,param);
            			}
HXLINE( 208)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 209)			{
HXLINE( 209)				Int target2 = this->_hx___textureTarget;
HXDLIN( 209)				Int param1 = state->magFilter;
HXDLIN( 209)				::lime::graphics::opengl::GL_obj::context->texParameteri(target2,(int)10240,param1);
            			}
HXLINE( 210)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 211)			{
HXLINE( 211)				Int target3 = this->_hx___textureTarget;
HXDLIN( 211)				Int param2 = state->wrapModeS;
HXDLIN( 211)				::lime::graphics::opengl::GL_obj::context->texParameteri(target3,(int)10242,param2);
            			}
HXLINE( 212)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 213)			{
HXLINE( 213)				Int target4 = this->_hx___textureTarget;
HXDLIN( 213)				Int param3 = state->wrapModeT;
HXDLIN( 213)				::lime::graphics::opengl::GL_obj::context->texParameteri(target4,(int)10243,param3);
            			}
...
void TextureBase_obj::_hx___trackCompressedMemoryUsage(Int memory){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__trackCompressedMemoryUsage",0x1551bb93,"openfl.display3D.textures.TextureBase.__trackCompressedMemoryUsage","openfl/display3D/textures/TextureBase.hx",230,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(memory,"memory")
HXLINE( 232)		Bool _hx_tmp = (this->_hx___compressedMemoryUsage == (int)0);
HXDLIN( 232)		if (_hx_tmp) {
HXLINE( 234)			this->_hx___context->_hx___statsIncrement((int)4);
            		}
HXLINE( 238)		hx::AddEq(this->_hx___compressedMemoryUsage,memory);
...
void TextureBase_obj::_hx___trackMemoryUsage(Int memory){
            	HX_STACK_FRAME("openfl.display3D.textures.TextureBase","__trackMemoryUsage",0xc7a62994,"openfl.display3D.textures.TextureBase.__trackMemoryUsage","openfl/display3D/textures/TextureBase.hx",254,0x7b0f92ae)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(memory,"memory")
HXLINE( 256)		Bool _hx_tmp = (this->_hx___memoryUsage == (int)0);
HXDLIN( 256)		if (_hx_tmp) {
HXLINE( 258)			this->_hx___context->_hx___statsIncrement((int)3);
            		}
HXLINE( 262)		hx::AddEq(this->_hx___memoryUsage,memory);
