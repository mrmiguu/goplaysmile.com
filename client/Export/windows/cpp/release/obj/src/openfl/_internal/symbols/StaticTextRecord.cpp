...
void StaticTextRecord_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.StaticTextRecord","new",0xb28773e1,"openfl._internal.symbols.StaticTextRecord.new","openfl/_internal/symbols/StaticTextSymbol.hx",138,0x451958e5)
            	HX_STACK_THIS(this)
            	}
