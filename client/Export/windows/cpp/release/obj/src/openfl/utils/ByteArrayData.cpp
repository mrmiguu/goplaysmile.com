...
Int length = __o_length.Default(0);
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","new",0x36383a32,"openfl.utils.ByteArrayData.new","openfl/utils/ByteArray.hx",249,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
void ByteArrayData_obj::clear(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","clear",0x0f8b73df,"openfl.utils.ByteArrayData.clear","openfl/utils/ByteArray.hx",274,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
void ByteArrayData_obj::compress( ::Dynamic __o_algorithm){
 ::Dynamic algorithm = __o_algorithm.Default(2);
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","compress",0xe3300490,"openfl.utils.ByteArrayData.compress","openfl/utils/ByteArray.hx",282,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
HXLINE( 297)			bytes = ::lime::utils::compress::Zlib_obj::compress(hx::ObjectPtr<OBJ_>(this));
            		...
            		_hx_goto_0:;
HXLINE( 305)		Bool _hx_tmp = hx::IsNotNull( bytes );
...
void ByteArrayData_obj::deflate(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","deflate",0x97ecc63d,"openfl.utils.ByteArrayData.deflate","openfl/utils/ByteArray.hx",319,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
void ByteArrayData_obj::inflate(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","inflate",0x010e5759,"openfl.utils.ByteArrayData.inflate","openfl/utils/ByteArray.hx",335,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
Bool ByteArrayData_obj::readBoolean(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readBoolean",0x98e809c4,"openfl.utils.ByteArrayData.readBoolean","openfl/utils/ByteArray.hx",342,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 342)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 342)		if (_hx_tmp) {
HXLINE( 344)			Int pos = this->position++;
HXDLIN( 344)			return (this->b->__get(pos) != (int)0);
            		}
            		else {
HXLINE( 348)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
...
Int ByteArrayData_obj::readByte(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readByte",0xc88bb66c,"openfl.utils.ByteArrayData.readByte","openfl/utils/ByteArray.hx",356,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
Int length = __o_length.Default(0);
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readBytes",0xb1b3e887,"openfl.utils.ByteArrayData.readBytes","openfl/utils/ByteArray.hx",373,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
            	HX_STACK_ARG(offset,"offset")
            	HX_STACK_ARG(length,"length")
HXLINE( 375)		Bool _hx_tmp = (length == (int)0);
HXDLIN( 375)		if (_hx_tmp) {
HXLINE( 375)			length = (this->length - this->position);
            		}
HXLINE( 377)		Bool _hx_tmp1 = ((this->position + length) > this->length);
HXDLIN( 377)		if (_hx_tmp1) {
HXLINE( 379)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
HXLINE( 383)		Bool _hx_tmp2 = (bytes->length < (offset + length));
...
HXLINE( 390)		hx::AddEq(this->position,length);
            	}
...
Float ByteArrayData_obj::readDouble(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readDouble",0xd7136375,"openfl.utils.ByteArrayData.readDouble","openfl/utils/ByteArray.hx",395,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 397)		HX_VARI( Int,ch1) = this->readInt();
HXLINE( 398)		HX_VARI( Int,ch2) = this->readInt();
HXLINE( 400)		Bool _hx_tmp = hx::IsEq( this->_hx___endian,(int)1 );
...
Float ByteArrayData_obj::readFloat(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readFloat",0xf6b2a5b8,"openfl.utils.ByteArrayData.readFloat","openfl/utils/ByteArray.hx",415,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 415)		Int _hx_tmp = this->readInt();
HXDLIN( 415)		return ::haxe::io::FPHelper_obj::i32ToFloat(_hx_tmp);
            	}
...
Int ByteArrayData_obj::readInt(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readInt",0xf7bc6e0b,"openfl.utils.ByteArrayData.readInt","openfl/utils/ByteArray.hx",420,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
::String ByteArrayData_obj::readMultiByte(Int length,::String charSet){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readMultiByte",0x011f243d,"openfl.utils.ByteArrayData.readMultiByte","openfl/utils/ByteArray.hx",442,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
...
Int ByteArrayData_obj::readShort(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readShort",0x70436498,"openfl.utils.ByteArrayData.readShort","openfl/utils/ByteArray.hx",447,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
Int ByteArrayData_obj::readUnsignedByte(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readUnsignedByte",0x50ca6601,"openfl.utils.ByteArrayData.readUnsignedByte","openfl/utils/ByteArray.hx",479,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 479)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 479)		if (_hx_tmp) {
HXLINE( 481)			Int pos = this->position++;
HXDLIN( 481)			return this->b->__get(pos);
            		}
            		else {
HXLINE( 485)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
...
Int ByteArrayData_obj::readUnsignedInt(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readUnsignedInt",0xac948816,"openfl.utils.ByteArrayData.readUnsignedInt","openfl/utils/ByteArray.hx",493,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
Int ByteArrayData_obj::readUnsignedShort(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readUnsignedShort",0x1ede5763,"openfl.utils.ByteArrayData.readUnsignedShort","openfl/utils/ByteArray.hx",513,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
::String ByteArrayData_obj::readUTF(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readUTF",0xf7c57243,"openfl.utils.ByteArrayData.readUTF","openfl/utils/ByteArray.hx",531,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 533)		HX_VARI( Int,bytesCount) = this->readUnsignedShort();
...
::String ByteArrayData_obj::readUTFBytes(Int length){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","readUTFBytes",0x87ebf328,"openfl.utils.ByteArrayData.readUTFBytes","openfl/utils/ByteArray.hx",539,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
HXLINE( 541)		Bool _hx_tmp = ((this->position + length) > this->length);
HXDLIN( 541)		if (_hx_tmp) {
HXLINE( 543)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
HXLINE( 547)		hx::AddEq(this->position,length);
HXLINE( 550)		Int _hx_tmp1 = (this->position - length);
HXDLIN( 550)		return this->getString(_hx_tmp1,length);
            	}
...
void ByteArrayData_obj::uncompress( ::Dynamic __o_algorithm){
 ::Dynamic algorithm = __o_algorithm.Default(2);
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","uncompress",0xb44f8369,"openfl.utils.ByteArrayData.uncompress","openfl/utils/ByteArray.hx",555,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(algorithm,"algorithm")
...
HXLINE( 570)			bytes = ::lime::utils::compress::Zlib_obj::decompress(hx::ObjectPtr<OBJ_>(this));
            		...
            		_hx_goto_1:;
HXLINE( 578)		Bool _hx_tmp = hx::IsNotNull( bytes );
...
void ByteArrayData_obj::writeBoolean(Bool value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeBoolean",0x790a5b77,"openfl.utils.ByteArrayData.writeBoolean","openfl/utils/ByteArray.hx",592,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
void ByteArrayData_obj::writeByte(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 599)		Int _hx_tmp = (this->position + (int)1);
HXDLIN( 599)		this->_hx___resize(_hx_tmp);
HXLINE( 600)		{
HXLINE( 600)			Int pos = this->position++;
HXDLIN( 600)			this->b[pos] = ((int)value & (int)(int)255);
            		}
            	}
...
HXLINE( 608)		Bool _hx_tmp = (length == (int)0);
HXDLIN( 608)		if (_hx_tmp) {
HXLINE( 608)			length = (::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes) - offset);
            		}
HXLINE( 610)		Int _hx_tmp1 = (this->position + length);
HXDLIN( 610)		this->_hx___resize(_hx_tmp1);
HXLINE( 611)		this->blit(this->position,bytes,offset,length);
HXLINE( 613)		Int _hx_tmp2 = (this->position + length);
HXDLIN( 613)		this->position = _hx_tmp2;
            	}
...
HXLINE( 622)		Bool _hx_tmp = hx::IsEq( this->_hx___endian,(int)1 );
HXDLIN( 622)		if (_hx_tmp) {
HXLINE( 624)			Int _hx_tmp1 = _hx_int64_low(int64);
HXDLIN( 624)			this->writeInt(_hx_tmp1);
HXLINE( 625)			Int _hx_tmp2 = _hx_int64_high(int64);
HXDLIN( 625)			this->writeInt(_hx_tmp2);
            		}
            		else {
HXLINE( 629)			Int _hx_tmp3 = _hx_int64_high(int64);
HXDLIN( 629)			this->writeInt(_hx_tmp3);
HXLINE( 630)			Int _hx_tmp4 = _hx_int64_low(int64);
HXDLIN( 630)			this->writeInt(_hx_tmp4);
            		}
            	}
...
void ByteArrayData_obj::writeFloat(Float value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeFloat",0x422514ab,"openfl.utils.ByteArrayData.writeFloat","openfl/utils/ByteArray.hx",637,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 639)		HX_VARI_NAME( Int,_hx_int,"int") = ::haxe::io::FPHelper_obj::floatToI32(value);
...
void ByteArrayData_obj::writeInt(Int value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeInt",0x83612a3e,"openfl.utils.ByteArrayData.writeInt","openfl/utils/ByteArray.hx",645,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 647)		Int _hx_tmp = (this->position + (int)4);
...
HXDLIN( 651)				this->b[pos] = ((int)value & (int)(int)255);
            			}
HXLINE( 652)			{
HXLINE( 652)				Int pos1 = this->position++;
HXDLIN( 652)				this->b[pos1] = ((int)((int)value >> (int)(int)8) & (int)(int)255);
            			}
HXLINE( 653)			{
HXLINE( 653)				Int pos2 = this->position++;
HXDLIN( 653)				this->b[pos2] = ((int)((int)value >> (int)(int)16) & (int)(int)255);
            			}
HXLINE( 654)			{
HXLINE( 654)				Int pos3 = this->position++;
HXDLIN( 654)				this->b[pos3] = ((int)((int)value >> (int)(int)24) & (int)(int)255);
            			}
            		}
            		else {
HXLINE( 658)			{
HXLINE( 658)				Int pos4 = this->position++;
HXDLIN( 658)				this->b[pos4] = ((int)((int)value >> (int)(int)24) & (int)(int)255);
            			}
HXLINE( 659)			{
HXLINE( 659)				Int pos5 = this->position++;
HXDLIN( 659)				this->b[pos5] = ((int)((int)value >> (int)(int)16) & (int)(int)255);
            			}
HXLINE( 660)			{
HXLINE( 660)				Int pos6 = this->position++;
HXDLIN( 660)				this->b[pos6] = ((int)((int)value >> (int)(int)8) & (int)(int)255);
            			}
HXLINE( 661)			{
HXLINE( 661)				Int pos7 = this->position++;
HXDLIN( 661)				this->b[pos7] = ((int)value & (int)(int)255);
            			}
            		}
            	}
...
void ByteArrayData_obj::writeMultiByte(::String value,::String charSet){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeMultiByte",0xebbf88b0,"openfl.utils.ByteArrayData.writeMultiByte","openfl/utils/ByteArray.hx",670,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
            	HX_STACK_ARG(charSet,"charSet")
...
void ByteArrayData_obj::writeShort(Int value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeShort",0xbbb5d38b,"openfl.utils.ByteArrayData.writeShort","openfl/utils/ByteArray.hx",675,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 677)		Int _hx_tmp = (this->position + (int)2);
HXDLIN( 677)		this->_hx___resize(_hx_tmp);
HXLINE( 679)		Bool _hx_tmp1 = hx::IsEq( this->_hx___endian,(int)1 );
HXDLIN( 679)		if (_hx_tmp1) {
HXLINE( 681)			{
HXLINE( 681)				Int pos = this->position++;
HXDLIN( 681)				this->b[pos] = value;
            			}
HXLINE( 682)			{
HXLINE( 682)				Int pos1 = this->position++;
HXDLIN( 682)				this->b[pos1] = ((int)value >> (int)(int)8);
            			}
            		}
            		else {
HXLINE( 686)			{
HXLINE( 686)				Int pos2 = this->position++;
HXDLIN( 686)				this->b[pos2] = ((int)value >> (int)(int)8);
            			}
HXLINE( 687)			{
HXLINE( 687)				Int pos3 = this->position++;
HXDLIN( 687)				this->b[pos3] = value;
            			}
            		}
            	}
...
void ByteArrayData_obj::writeUnsignedInt(Int value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUnsignedInt",0xcb6d2f49,"openfl.utils.ByteArrayData.writeUnsignedInt","openfl/utils/ByteArray.hx",696,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ByteArrayData_obj::writeUTF(::String value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUTF",0x836a2e76,"openfl.utils.ByteArrayData.writeUTF","openfl/utils/ByteArray.hx",701,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ByteArrayData_obj::writeUTFBytes(::String value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUTFBytes",0xc5d11e15,"openfl.utils.ByteArrayData.writeUTFBytes","openfl/utils/ByteArray.hx",714,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ByteArrayData_obj::_hx___fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","__fromBytes",0x684ac753,"openfl.utils.ByteArrayData.__fromBytes","openfl/utils/ByteArray.hx",719,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 721)		{
...
void ByteArrayData_obj::_hx___resize(Int size){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","__resize",0x101b8202,"openfl.utils.ByteArrayData.__resize","openfl/utils/ByteArray.hx",727,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE( 729)		Bool _hx_tmp = (size > this->__length);
...
HXLINE( 743)		Bool _hx_tmp1 = (this->length < size);
...
void ByteArrayData_obj::_hx___setData( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","__setData",0xac6a7b1e,"openfl.utils.ByteArrayData.__setData","openfl/utils/ByteArray.hx",752,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
...
Int ByteArrayData_obj::get_bytesAvailable(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_bytesAvailable",0x68329f15,"openfl.utils.ByteArrayData.get_bytesAvailable","openfl/utils/ByteArray.hx",773,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_bytesAvailable,return )
 ...
 ::Dynamic ByteArrayData_obj::get_endian(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_endian",0x95dc5cd2,"openfl.utils.ByteArrayData.get_endian","openfl/utils/ByteArray.hx",780,0xaa5cee4a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_endian,return )
 ...
 ::Dynamic ByteArrayData_obj::set_endian( ::Dynamic value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","set_endian",0x9959fb46,"openfl.utils.ByteArrayData.set_endian","openfl/utils/ByteArray.hx",787,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
HX_DEFINE_DYNAMIC_FUNC1(ByteArrayData_obj,set_endian,return )
 ...
 ::openfl::utils::ByteArrayData ByteArrayData_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","fromBytes",0x955585f3,"openfl.utils.ByteArrayData.fromBytes","openfl/utils/ByteArray.hx",324,0xaa5cee4a)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 326)		HX_VARI(  ::openfl::utils::ByteArrayData,result) =  ::openfl::utils::ByteArrayData_obj::__new(null());
