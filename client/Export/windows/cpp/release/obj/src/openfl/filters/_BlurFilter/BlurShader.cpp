...
void BlurShader_obj::_hx___update(){
            	HX_STACK_FRAME("openfl.filters._BlurFilter.BlurShader","__update",0x96830d8a,"openfl.filters._BlurFilter.BlurShader.__update","openfl/filters/BlurFilter.hx",162,0x46563eac)
            	HX_STACK_THIS(this)
