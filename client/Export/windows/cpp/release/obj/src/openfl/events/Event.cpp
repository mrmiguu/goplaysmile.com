...
Bool cancelable = __o_cancelable.Default(false);
            	HX_STACK_FRAME("openfl.events.Event","new",0x2731c6f5,"openfl.events.Event.new","openfl/events/Event.hx",59,0x7220a03b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(bubbles,"bubbles")
            	HX_STACK_ARG(cancelable,"cancelable")
HXLINE(  61)		this->type = type;
HXLINE(  62)		this->bubbles = bubbles;
HXLINE(  63)		this->cancelable = cancelable;
HXLINE(  64)		this->eventPhase = (int)2;
            	}
...
Dynamic Event_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event Event_obj::clone(){
            	HX_STACK_FRAME("openfl.events.Event","clone",0x5b9b9932,"openfl.events.Event.clone","openfl/events/Event.hx",69,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE(  71)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__new(this->type,this->bubbles,this->cancelable);
HXLINE(  72)		event->eventPhase = this->eventPhase;
HXLINE(  73)		event->target = this->target;
HXLINE(  74)		event->currentTarget = this->currentTarget;
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	HX_STACK_FRAME("openfl.events.Event","formatToString",0xed38428e,"openfl.events.Event.formatToString","openfl/events/Event.hx",80,0x7220a03b)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(p4,"p4")
            	HX_STACK_ARG(p5,"p5")
HXLINE(  82)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
HXLINE(  83)		Bool _hx_tmp = hx::IsNotNull( p1 );
HXDLIN(  83)		if (_hx_tmp) {
HXLINE(  83)			parameters->push(p1);
            		}
HXLINE(  84)		Bool _hx_tmp1 = hx::IsNotNull( p2 );
HXDLIN(  84)		if (_hx_tmp1) {
HXLINE(  84)			parameters->push(p2);
            		}
HXLINE(  85)		Bool _hx_tmp2 = hx::IsNotNull( p3 );
HXDLIN(  85)		if (_hx_tmp2) {
HXLINE(  85)			parameters->push(p3);
            		}
HXLINE(  86)		Bool _hx_tmp3 = hx::IsNotNull( p4 );
HXDLIN(  86)		if (_hx_tmp3) {
HXLINE(  86)			parameters->push(p4);
            		}
HXLINE(  87)		Bool _hx_tmp4 = hx::IsNotNull( p5 );
HXDLIN(  87)		if (_hx_tmp4) {
HXLINE(  87)			parameters->push(p5);
            		}
HXLINE(  89)		return ::Reflect_obj::callMethod(hx::ObjectPtr<OBJ_>(this),this->_hx___formatToString_dyn(),::cpp::VirtualArray_obj::__new(2)->init(0,className)->init(1,parameters));
            	}
...
Bool Event_obj::isDefaultPrevented(){
            	HX_STACK_FRAME("openfl.events.Event","isDefaultPrevented",0x5475e94b,"openfl.events.Event.isDefaultPrevented","openfl/events/Event.hx",96,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE(  96)		return this->_hx___preventDefault;
            	}
...
void Event_obj::preventDefault(){
            	HX_STACK_FRAME("openfl.events.Event","preventDefault",0xdba9c454,"openfl.events.Event.preventDefault","openfl/events/Event.hx",103,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 103)		Bool _hx_tmp = this->cancelable;
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 105)			this->_hx___preventDefault = true;
            		}
            	}
...
void Event_obj::stopImmediatePropagation(){
            	HX_STACK_FRAME("openfl.events.Event","stopImmediatePropagation",0xa67252c8,"openfl.events.Event.stopImmediatePropagation","openfl/events/Event.hx",112,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 114)		this->_hx___isCanceled = true;
HXLINE( 115)		this->_hx___isCanceledNow = true;
            	}
...
void Event_obj::stopPropagation(){
            	HX_STACK_FRAME("openfl.events.Event","stopPropagation",0xb07183ff,"openfl.events.Event.stopPropagation","openfl/events/Event.hx",122,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 122)		this->_hx___isCanceled = true;
            	}
...
::String Event_obj::toString(){
            	HX_STACK_FRAME("openfl.events.Event","toString",0x6e61ddf7,"openfl.events.Event.toString","openfl/events/Event.hx",129,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 129)		return this->_hx___formatToString(HX_("Event",fa,37,f2,08),::Array_obj< ::String >::fromData( _hx_array_data_0,3));
            	}
...
::String Event_obj::_hx___formatToString(::String className,::Array< ::String > parameters){
            	HX_STACK_FRAME("openfl.events.Event","__formatToString",0x9d75066e,"openfl.events.Event.__formatToString","openfl/events/Event.hx",134,0x7220a03b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(className,"className")
            	HX_STACK_ARG(parameters,"parameters")
HXLINE( 138)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 139)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 141)		{
HXLINE( 141)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 141)			while((_g < parameters->length)){
HXLINE( 141)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 141)				++_g;
HXLINE( 143)				arg = ::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),param);
HXLINE( 145)				Bool _hx_tmp = ::Std_obj::is(arg,hx::ClassOf< ::String >());
HXDLIN( 145)				if (_hx_tmp) {
HXLINE( 147)					::String _hx_tmp1 = ((HX_(" ",20,00,00,00) + param) + HX_("=\"",45,35,00,00));
HXDLIN( 147)					::String _hx_tmp2 = ::Std_obj::string(arg);
HXDLIN( 147)					hx::AddEq(output,((_hx_tmp1 + _hx_tmp2) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 151)					::String _hx_tmp3 = ((HX_(" ",20,00,00,00) + param) + HX_("=",3d,00,00,00));
HXDLIN( 151)					::String _hx_tmp4 = ::Std_obj::string(arg);
HXDLIN( 151)					hx::AddEq(output,(_hx_tmp3 + _hx_tmp4));
            				}
            			}
            		}
HXLINE( 157)		hx::AddEq(output,HX_("]",5d,00,00,00));
...
{
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",10,0x7220a03b)
HXLINE(  10)		ACTIVATE = HX_("activate",b3,1b,ac,e5);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",11,0x7220a03b)
HXLINE(  11)		ADDED = HX_("added",c0,d4,43,1c);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",12,0x7220a03b)
HXLINE(  12)		ADDED_TO_STAGE = HX_("addedToStage",63,22,55,0c);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",13,0x7220a03b)
HXLINE(  13)		CANCEL = HX_("cancel",7a,ed,33,b8);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",14,0x7220a03b)
HXLINE(  14)		CHANGE = HX_("change",70,91,72,b7);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",15,0x7220a03b)
HXLINE(  15)		CLEAR = HX_("clear",8d,71,5b,48);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",16,0x7220a03b)
HXLINE(  16)		CLOSE = HX_("close",b8,17,63,48);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",17,0x7220a03b)
HXLINE(  17)		COMPLETE = HX_("complete",b9,00,c8,7f);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",18,0x7220a03b)
HXLINE(  18)		CONNECT = HX_("connect",ea,3b,80,15);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",19,0x7220a03b)
HXLINE(  19)		CONTEXT3D_CREATE = HX_("context3DCreate",7c,bf,59,7b);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",20,0x7220a03b)
HXLINE(  20)		COPY = HX_("copy",b5,bb,c4,41);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",21,0x7220a03b)
HXLINE(  21)		CUT = HX_("cut",82,85,4b,00);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",22,0x7220a03b)
HXLINE(  22)		DEACTIVATE = HX_("deactivate",34,5c,01,3c);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",23,0x7220a03b)
HXLINE(  23)		ENTER_FRAME = HX_("enterFrame",f5,03,50,02);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",24,0x7220a03b)
HXLINE(  24)		EXIT_FRAME = HX_("exitFrame",2f,64,48,12);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",25,0x7220a03b)
HXLINE(  25)		FRAME_CONSTRUCTED = HX_("frameConstructed",09,89,5d,98);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",26,0x7220a03b)
HXLINE(  26)		FRAME_LABEL = HX_("frameLabel",87,42,d5,52);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",27,0x7220a03b)
HXLINE(  27)		FULLSCREEN = HX_("fullScreen",5b,ae,48,2e);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",28,0x7220a03b)
HXLINE(  28)		ID3 = HX_("id3",f8,03,50,00);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",29,0x7220a03b)
HXLINE(  29)		INIT = HX_("init",10,3b,bb,45);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",30,0x7220a03b)
HXLINE(  30)		MOUSE_LEAVE = HX_("mouseLeave",92,28,20,90);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",31,0x7220a03b)
HXLINE(  31)		OPEN = HX_("open",ca,03,b4,49);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",32,0x7220a03b)
HXLINE(  32)		PASTE = HX_("paste",53,53,56,bd);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",33,0x7220a03b)
HXLINE(  33)		REMOVED = HX_("removed",a0,1f,00,f3);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",34,0x7220a03b)
HXLINE(  34)		REMOVED_FROM_STAGE = HX_("removedFromStage",34,21,76,ba);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",35,0x7220a03b)
HXLINE(  35)		RENDER = HX_("render",56,6b,29,05);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",36,0x7220a03b)
HXLINE(  36)		RESIZE = HX_("resize",f4,59,7b,08);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",37,0x7220a03b)
HXLINE(  37)		SCROLL = HX_("scroll",0d,d8,64,47);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",38,0x7220a03b)
HXLINE(  38)		SELECT = HX_("select",fc,1a,33,6a);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",39,0x7220a03b)
HXLINE(  39)		SELECT_ALL = HX_("selectAll",85,9b,fc,8d);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",40,0x7220a03b)
HXLINE(  40)		SOUND_COMPLETE = HX_("soundComplete",a8,30,e6,1c);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",41,0x7220a03b)
HXLINE(  41)		TAB_CHILDREN_CHANGE = HX_("tabChildrenChange",44,91,b5,de);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",42,0x7220a03b)
HXLINE(  42)		TAB_ENABLED_CHANGE = HX_("tabEnabledChange",3c,45,98,72);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",43,0x7220a03b)
HXLINE(  43)		TAB_INDEX_CHANGE = HX_("tabIndexChange",cd,1d,78,90);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",44,0x7220a03b)
HXLINE(  44)		TEXTURE_READY = HX_("textureReady",88,4d,5a,df);
            	}
{
            	HX_STACK_FRAME("openfl.events.Event","boot",0x1c754ffd,"openfl.events.Event.boot","openfl/events/Event.hx",45,0x7220a03b)
HXLINE(  45)		UNLOAD = HX_("unload",ff,a0,8c,65);
            	}
}
