...
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_876_new,"openfl._internal.stage3D._AGALConverter.SamplerRegister","new",0xf340d88e,"openfl._internal.stage3D._AGALConverter.SamplerRegister.new","openfl/_internal/stage3D/AGALConverter.hx",876,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_901_toGLSL,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toGLSL",0xc158218b,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",901,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_909_toSamplerState,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toSamplerState",0x8ed80c96,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toSamplerState","openfl/_internal/stage3D/AGALConverter.hx",909,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_883_parse,"openfl._internal.stage3D._AGALConverter.SamplerRegister","parse",0x0bb77fe1,"openfl._internal.stage3D._AGALConverter.SamplerRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",883,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_876_new)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_901_toGLSL)
HXLINE( 903)		::String str = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 903)		::String str1 = (str + this->n);
HXLINE( 904)		return str1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_909_toSamplerState)
HXLINE( 911)		int magFilter = (int)0;
HXLINE( 912)		int minFilter = (int)0;
HXLINE( 913)		int wrapModeS = (int)0;
HXLINE( 914)		int wrapModeT = (int)0;
HXLINE( 917)		{
HXLINE( 917)			int _g = this->f;
HXDLIN( 917)			switch((int)(_g)){
            				case (int)0: {
HXLINE( 919)					magFilter = (int)9728;
            				}
            				break;
            				case (int)1: {
HXLINE( 920)					magFilter = (int)9729;
            				}
            				break;
            				default:{
HXLINE( 921)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE( 926)		{
HXLINE( 926)			int _g1 = this->m;
HXDLIN( 926)			switch((int)(_g1)){
            				case (int)0: {
HXLINE( 931)					if ((this->f != (int)0)) {
HXLINE( 931)						minFilter = (int)9729;
            					}
            					else {
HXLINE( 931)						minFilter = (int)9728;
            					}
            				}
            				break;
            				case (int)1: {
HXLINE( 936)					if ((this->f != (int)0)) {
HXLINE( 936)						minFilter = (int)9986;
            					}
            					else {
HXLINE( 936)						minFilter = (int)9984;
            					}
            				}
            				break;
            				case (int)2: {
HXLINE( 941)					if ((this->f != (int)0)) {
HXLINE( 941)						minFilter = (int)9987;
            					}
            					else {
HXLINE( 941)						minFilter = (int)9985;
            					}
            				}
            				break;
            				default:{
HXLINE( 945)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE( 950)		{
HXLINE( 950)			int _g2 = this->w;
HXDLIN( 950)			switch((int)(_g2)){
            				case (int)0: {
HXLINE( 954)					wrapModeS = (int)33071;
HXLINE( 955)					wrapModeT = (int)33071;
            				}
            				break;
            				case (int)1: {
HXLINE( 959)					wrapModeS = (int)10497;
HXLINE( 960)					wrapModeT = (int)10497;
            				}
            				break;
            				default:{
HXLINE( 964)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE( 968)		bool ignoreSampler = (((int)this->s & (int)(int)4) == (int)4);
HXLINE( 969)		bool centroid = (((int)this->s & (int)(int)1) == (int)1);
HXLINE( 972)		Float lodBias = ((Float)((int)((int)this->b << (int)(int)24) >> (int)(int)24) / (Float)((Float)8.0));
HXLINE( 973)		Float maxAniso = ((Float)0.0);
HXLINE( 975)		return  ::openfl::_internal::stage3D::SamplerState_obj::__alloc( HX_CTX ,minFilter,magFilter,wrapModeS,wrapModeT,lodBias,maxAniso,ignoreSampler,centroid,null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( ::cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_883_parse)
HXLINE( 885)		 ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister sr =  ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 886)		sr->programType = programType;
HXLINE( 887)		 ::cpp::Int64Struct a = _hx_int64_shr(v,(int)60);
HXDLIN( 887)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)15))));
HXLINE( 888)		 ::cpp::Int64Struct a1 = _hx_int64_shr(v,(int)56);
HXDLIN( 888)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)15))));
HXLINE( 889)		 ::cpp::Int64Struct a2 = _hx_int64_shr(v,(int)52);
HXDLIN( 889)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 890)		 ::cpp::Int64Struct a3 = _hx_int64_shr(v,(int)48);
HXDLIN( 890)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 891)		 ::cpp::Int64Struct a4 = _hx_int64_shr(v,(int)44);
HXDLIN( 891)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)15))));
HXLINE( 892)		 ::cpp::Int64Struct a5 = _hx_int64_shr(v,(int)40);
HXDLIN( 892)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)15))));
HXLINE( 893)		 ::cpp::Int64Struct a6 = _hx_int64_shr(v,(int)32);
HXDLIN( 893)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct((int)15))));
HXLINE( 894)		 ::cpp::Int64Struct a7 = _hx_int64_shr(v,(int)16);
HXDLIN( 894)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct((int)255))));
HXLINE( 895)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE( 896)		return sr;
            	}
