...
HXLINE(  50)		this->_hx___uniforms =  ::List_obj::__new();
HXLINE(  51)		this->_hx___samplerUniforms =  ::List_obj::__new();
HXLINE(  52)		this->_hx___alphaSamplerUniforms =  ::List_obj::__new();
HXLINE(  54)		Bool fixed = null();
HXDLIN(  54)		 ::openfl::_Vector::ObjectVector _hx_tmp =  ::openfl::_Vector::ObjectVector_obj::__new((int)8,fixed,null());
HXDLIN(  54)		this->_hx___samplerStates = _hx_tmp;
            	}
...
hx::ObjectPtr< Program3D_obj > Program3D_obj::__new( ::openfl::display3D::Context3D context3D)
{
	...
	_hx_result->__construct(context3D);
	return _hx_result;
}
...
HXLINE(  72)		HX_VARI( ::String,glslFragment) = ::openfl::_internal::stage3D::AGALConverter_obj::convertToGLSL(fragmentProgram,samplerStates);
...
HXLINE(  76)				HX_VARI( Int,i) = _g1++;
HXLINE(  78)				 ::openfl::_internal::stage3D::SamplerState _hx_tmp = samplerStates->__get(i).StaticCast<  ::openfl::_internal::stage3D::SamplerState >();
HXDLIN(  78)				this->_hx___setSamplerState(i,_hx_tmp);
            			}
            		}
            	}
...
HXLINE(  97)		HX_VARI(  ::List,vertexUniforms) =  ::List_obj::__new();
HXLINE(  98)		HX_VARI(  ::List,fragmentUniforms) =  ::List_obj::__new();
HXLINE( 100)		{
...
HXLINE( 108)				HX_VARI(  ::openfl::display3D::_Program3D::Uniform,uniform) =  ::openfl::display3D::_Program3D::Uniform_obj::__new();
...
HXLINE( 124)				{
HXLINE( 124)					HX_VARI( Int,_g2) = uniform->type;
...
HXLINE( 133)				hx::MultEq(uniform->regCount,uniform->size);
...
HXLINE( 141)					Bool _hx_tmp = ::StringTools_obj::startsWith(uniform->name,HX_("vc",2d,67,00,00));
HXDLIN( 141)					if (_hx_tmp) {
HXLINE( 143)						::String _hx_tmp1 = uniform->name.substring((int)2,null());
HXDLIN( 143)						uniform->regIndex = ::Std_obj::parseInt(_hx_tmp1);
HXLINE( 144)						uniform->regData = this->_hx___context->_hx___vertexConstants;
HXLINE( 145)						vertexUniforms->add(uniform);
            					}
            					else {
HXLINE( 147)						Bool _hx_tmp2 = ::StringTools_obj::startsWith(uniform->name,HX_("fc",3d,59,00,00));
HXDLIN( 147)						if (_hx_tmp2) {
HXLINE( 149)							::String _hx_tmp3 = uniform->name.substring((int)2,null());
HXDLIN( 149)							uniform->regIndex = ::Std_obj::parseInt(_hx_tmp3);
HXLINE( 150)							uniform->regData = this->_hx___context->_hx___fragmentConstants;
HXLINE( 151)							fragmentUniforms->add(uniform);
            						}
            						else {
HXLINE( 153)							Bool _hx_tmp4;
HXDLIN( 153)							Bool _hx_tmp5 = ::StringTools_obj::startsWith(uniform->name,HX_("sampler",08,c5,c9,83));
HXDLIN( 153)							if (_hx_tmp5) {
HXLINE( 153)								_hx_tmp4 = !(::StringTools_obj::endsWith(uniform->name,HX_("_alpha",9f,ee,7d,1d)));
            							}
            							else {
HXLINE( 153)								_hx_tmp4 = false;
            							}
HXDLIN( 153)							if (_hx_tmp4) {
HXLINE( 155)								::String _hx_tmp6 = uniform->name.substring((int)7,null());
HXDLIN( 155)								uniform->regIndex = ::Std_obj::parseInt(_hx_tmp6);
...
HXLINE( 158)										HX_VARI( Int,reg) = _g4++;
HXLINE( 160)										Int _hx_tmp7 = (uniform->regIndex + reg);
HXDLIN( 160)										hx::OrEq(this->_hx___samplerUsageMask,((int)(int)1 << (int)_hx_tmp7));
            									}
            								}
            							}
            							else {
HXLINE( 164)								Bool _hx_tmp8;
HXDLIN( 164)								Bool _hx_tmp9 = ::StringTools_obj::startsWith(uniform->name,HX_("sampler",08,c5,c9,83));
HXDLIN( 164)								if (_hx_tmp9) {
HXLINE( 164)									_hx_tmp8 = ::StringTools_obj::endsWith(uniform->name,HX_("_alpha",9f,ee,7d,1d));
            								}
            								else {
HXLINE( 164)									_hx_tmp8 = false;
            								}
HXDLIN( 164)								if (_hx_tmp8) {
HXLINE( 166)									Int _hx_tmp10 = uniform->name.indexOf(HX_("_",5f,00,00,00),null());
HXLINE( 167)									::String _hx_tmp11 = uniform->name.substring((int)7,((int)7 + (_hx_tmp10 - (int)7)));
HXDLIN( 167)									 ::Dynamic _hx_tmp12 = ::Std_obj::parseInt(_hx_tmp11);
HXDLIN( 167)									uniform->regIndex = (_hx_tmp12 + (int)4);
...
HXLINE( 172)				Bool _hx_tmp13 = ::openfl::display3D::Program3D_obj::verbose;
HXDLIN( 172)				if (_hx_tmp13) {
HXLINE( 174)					::String _hx_tmp14 = (((((((((HX_("",00,00,00,00) + i) + HX_(" name:",6f,1b,f0,61)) + uniform->name) + HX_(" type:",20,fc,36,e6)) + uniform->type) + HX_(" size:",39,94,44,48)) + uniform->size) + HX_(" location:",45,fc,a8,c1)) + uniform->location);
HXDLIN( 174)					::haxe::Log_obj::trace(_hx_tmp14,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),174,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__buildUniformList",44,16,c1,02)));
            				}
            			}
            		}
HXLINE( 180)		::Array< ::Dynamic> _hx_tmp15 = ::Lambda_obj::array(vertexUniforms);
HXDLIN( 180)		this->_hx___vertexUniformMap =  ::openfl::display3D::_Program3D::UniformMap_obj::__new(_hx_tmp15);
HXLINE( 181)		::Array< ::Dynamic> _hx_tmp16 = ::Lambda_obj::array(fragmentUniforms);
HXDLIN( 181)		this->_hx___fragmentUniformMap =  ::openfl::display3D::_Program3D::UniformMap_obj::__new(_hx_tmp16);
            	}
...
void Program3D_obj::_hx___deleteShaders(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 188)		Bool _hx_tmp = hx::IsNotNull( this->_hx___programID );
HXDLIN( 188)		if (_hx_tmp) {
HXLINE( 192)			this->_hx___programID = null();
            		}
HXLINE( 196)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___vertexShaderID );
...
HXLINE( 204)		Bool _hx_tmp2 = hx::IsNotNull( this->_hx___fragmentShaderID );
...
HXLINE( 212)		Bool _hx_tmp3 = (this->_hx___memUsage != (int)0);
...
HX_DEFINE_DYNAMIC_FUNC0(Program3D_obj,_hx___flush,(void))
 ...
 ::openfl::_internal::stage3D::SamplerState Program3D_obj::_hx___getSamplerState(Int sampler){
            	HX_STACK_FRAME("openfl.display3D.Program3D","__getSamplerState",0x4314690d,"openfl.display3D.Program3D.__getSamplerState","openfl/display3D/Program3D.hx",233,0x0a985b04)
            	HX_STACK_THIS(this)
...
void Program3D_obj::_hx___markDirty(Bool isVertex,Int index,Int count){
            	HX_STACK_FRAME("openfl.display3D.Program3D","__markDirty",0xf012f9b3,"openfl.display3D.Program3D.__markDirty","openfl/display3D/Program3D.hx",240,0x0a985b04)
            	HX_STACK_THIS(this)
...
void Program3D_obj::_hx___setPositionScale( ::lime::utils::ArrayBufferView positionScale){
            	HX_STACK_FRAME("openfl.display3D.Program3D","__setPositionScale",0x1baf80f1,"openfl.display3D.Program3D.__setPositionScale","openfl/display3D/Program3D.hx",255,0x0a985b04)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(positionScale,"positionScale")
HXLINE( 255)		Bool _hx_tmp = hx::IsNotNull( this->_hx___positionScale );
HXDLIN( 255)		if (_hx_tmp) {
HXLINE( 257)			{
HXLINE( 257)				Int location = this->_hx___positionScale->location;
HXDLIN( 257)				::lime::graphics::opengl::GL_obj::context->uniform4fv(location,positionScale);
            			}
...
void Program3D_obj::_hx___setSamplerState(Int sampler, ::openfl::_internal::stage3D::SamplerState state){
            	HX_STACK_FRAME("openfl.display3D.Program3D","__setSamplerState",0x3edfe619,"openfl.display3D.Program3D.__setSamplerState","openfl/display3D/Program3D.hx",267,0x0a985b04)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sampler,"sampler")
...
HXLINE( 276)		Bool _hx_tmp = ::openfl::display3D::Program3D_obj::verbose;
...
HXDLIN( 301)			Bool _hx_tmp2 = hx::IsNotNull( vertexInfoLog );
HXDLIN( 301)			if (_hx_tmp2) {
HXLINE( 301)				_hx_tmp1 = (vertexInfoLog.length != (int)0);
            			}
            			else {
...
HXLINE( 307)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__new((HX_("Error compiling vertex shader: ",1f,7c,b1,3d) + vertexInfoLog),null()));
            		}
...
HXLINE( 318)		HX_VARI( Int,fragmentCompiled) = ::lime::graphics::opengl::GL_obj::context->getShaderParameter(this->_hx___fragmentShaderID,(int)35713);
...
HXDLIN( 324)			Bool _hx_tmp4 = hx::IsNotNull( fragmentInfoLog );
HXDLIN( 324)			if (_hx_tmp4) {
HXLINE( 324)				_hx_tmp3 = (fragmentInfoLog.length != (int)0);
            			}
            			else {
...
HXLINE( 330)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__new((HX_("Error compiling fragment shader: ",33,70,4d,6d) + fragmentInfoLog),null()));
            		}
...
HXLINE( 341)				HX_VARI( Int,i) = _g++;
HXLINE( 343)				HX_VARI( ::String,name) = (HX_("va",2b,67,00,00) + i);
HXLINE( 345)				Int _hx_tmp5 = vertexShaderSource.indexOf((HX_(" ",20,00,00,00) + name),null());
HXDLIN( 345)				if ((_hx_tmp5 != (int)-1)) {
...
HXDLIN( 357)		Bool _hx_tmp7 = hx::IsNotNull( infoLog );
HXDLIN( 357)		if (_hx_tmp7) {
HXLINE( 357)			_hx_tmp6 = (infoLog.length != (int)0);
            		}
            		else {
...
HXLINE( 380)				Bool _hx_tmp = !(hx::IsNotNull( _g_head ));
HXDLIN( 380)				if (_hx_tmp) {
HXLINE( 380)					goto _hx_goto_4;
            				}
HXDLIN( 380)				HX_VARI(  ::openfl::display3D::_Program3D::Uniform,val) = ( ( ::openfl::display3D::_Program3D::Uniform)(_g_head->item) );
HXLINE( 372)				_g_head = _g_head->next;
HXLINE( 382)				Bool _hx_tmp1 = (val->regCount == (int)1);
HXDLIN( 382)				if (_hx_tmp1) {
HXLINE( 384)					{
HXLINE( 384)						Int location = val->location;
HXDLIN( 384)						Int x = val->regIndex;
HXDLIN( 384)						::lime::graphics::opengl::GL_obj::context->uniform1i(location,x);
            					}
HXLINE( 385)					::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
            				}
            				else {
HXLINE( 389)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("!!! TODO: uniform location on webgl",0c,47,d9,53)));
            				}
            			}
            			_hx_goto_4:;
            		}
...
HXLINE( 403)				Bool _hx_tmp2 = !(hx::IsNotNull( _g_head1 ));
HXDLIN( 403)				if (_hx_tmp2) {
HXLINE( 403)					goto _hx_goto_5;
            				}
HXDLIN( 403)				HX_VARI_NAME(  ::openfl::display3D::_Program3D::Uniform,val1,"val") = ( ( ::openfl::display3D::_Program3D::Uniform)(_g_head1->item) );
HXLINE( 372)				_g_head1 = _g_head1->next;
HXLINE( 405)				Bool _hx_tmp3 = (val1->regCount == (int)1);
HXDLIN( 405)				if (_hx_tmp3) {
HXLINE( 407)					{
HXLINE( 407)						Int location1 = val1->location;
HXDLIN( 407)						Int x1 = val1->regIndex;
HXDLIN( 407)						::lime::graphics::opengl::GL_obj::context->uniform1i(location1,x1);
            					}
HXLINE( 408)					::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
            				}
            				else {
HXLINE( 412)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("!!! TODO: uniform location on webgl",0c,47,d9,53)));
            				}
            			}
            			_hx_goto_5:;
            		}
...
{
{
            	HX_STACK_FRAME("openfl.display3D.Program3D","boot",0x83a78e64,"openfl.display3D.Program3D.boot","openfl/display3D/Program3D.hx",24,0x0a985b04)
