...
Dynamic Lib_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Lib_obj::as( ::Dynamic v,hx::Class c){
            	HX_STACK_FRAME("openfl.Lib","as",0x3965ffb9,"openfl.Lib.as","openfl/Lib.hx",44,0x62fb7c98)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(c,"c")
HXLINE(  44)		Bool _hx_tmp = ::Std_obj::is(v,c);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lib_obj,as,return )
 ...
 ::openfl::display::MovieClip Lib_obj::attach(::String name){
            	HX_STACK_FRAME("openfl.Lib","attach",0xe350160c,"openfl.Lib.attach","openfl/Lib.hx",55,0x62fb7c98)
            	HX_STACK_ARG(name,"name")
HXLINE(  55)		return  ::openfl::display::MovieClip_obj::__new();
            	}
...
Int Lib_obj::getTimer(){
            	HX_STACK_FRAME("openfl.Lib","getTimer",0xd73d4956,"openfl.Lib.getTimer","openfl/Lib.hx",84,0x62fb7c98)
...
HXLINE(  92)		Bool _hx_tmp = hx::IsNull( target );
HXDLIN(  92)		if (_hx_tmp) {
HXLINE(  94)			target = HX_("_blank",95,26,d9,b0);
            		}
HXLINE( 101)		::lime::_hx_system::System_obj::openURL(request->url,target);
            	}
...
void Lib_obj::notImplemented( ::Dynamic posInfo){
            	HX_STACK_FRAME("openfl.Lib","notImplemented",0x6ff873b6,"openfl.Lib.notImplemented","openfl/Lib.hx",107,0x62fb7c98)
            	HX_STACK_ARG(posInfo,"posInfo")
HXLINE( 109)		HX_VARI( ::String,api) = ((( (::String)(posInfo->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) ) + HX_(".",2e,00,00,00)) + ( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ));
HXLINE( 111)		Bool _hx_tmp = !(::openfl::Lib_obj::_hx___sentWarnings->exists(api));
HXDLIN( 111)		if (_hx_tmp) {
HXLINE( 113)			::openfl::Lib_obj::_hx___sentWarnings->set(api,true);
HXLINE( 115)			::lime::utils::Log_obj::warn((( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ) + HX_(" is not implemented",1f,12,d2,b9)),posInfo);
            		}
            	}
...
void Lib_obj::trace( ::Dynamic arg){
            	HX_STACK_FRAME("openfl.Lib","trace",0xeba99a1e,"openfl.Lib.trace","openfl/Lib.hx",146,0x62fb7c98)
            	HX_STACK_ARG(arg,"arg")
HXLINE( 146)		::haxe::Log_obj::trace(arg,hx::SourceInfo(HX_("Lib.hx",b9,80,1c,19),146,HX_("openfl.Lib",47,43,57,2f),HX_("trace",85,8e,1f,16)));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.Lib","boot",0xdf56aeb9,"openfl.Lib.boot","openfl/Lib.hx",31,0x62fb7c98)
HXLINE(  31)		current =  ::openfl::display::MovieClip_obj::__new();
            	}
{
            	HX_STACK_FRAME("openfl.Lib","boot",0xdf56aeb9,"openfl.Lib.boot","openfl/Lib.hx",36,0x62fb7c98)
HXLINE(  36)		_hx___sentWarnings =  ::haxe::ds::StringMap_obj::__new();
            	}
}
