...
HXLINE( 129)		 ::lime::utils::Bytes _hx_tmp = ::lime::utils::Bytes_obj::readFile(path);
HXDLIN( 129)		return ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromArrayBuffer(_hx_tmp);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,fromFile,return )
 ...
 ::haxe::io::Bytes ByteArray_Impl__obj::toArrayBuffer( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toArrayBuffer",0x56ee15e0,"openfl.utils._ByteArray.ByteArray_Impl_.toArrayBuffer","openfl/utils/ByteArray.hx",143,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 143)		return byteArray;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,toArrayBuffer,return )
 ...
 ::haxe::io::Bytes ByteArray_Impl__obj::toBytes( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toBytes",0xfc5d6f92,"openfl.utils._ByteArray.ByteArray_Impl_.toBytes","openfl/utils/ByteArray.hx",156,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 156)		return byteArray;
            	}
...
::Array< unsigned char > ByteArray_Impl__obj::toBytesData( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toBytesData",0xa6fe22dc,"openfl.utils._ByteArray.ByteArray_Impl_.toBytesData","openfl/utils/ByteArray.hx",170,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 170)		return byteArray->b;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_Impl__obj,toBytesData,return )
 ...
 ::lime::utils::Bytes ByteArray_Impl__obj::toLimeBytes( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","toLimeBytes",0x1aa31bbd,"openfl.utils._ByteArray.ByteArray_Impl_.toLimeBytes","openfl/utils/ByteArray.hx",184,0xaa5cee4a)
            	HX_STACK_ARG(byteArray,"byteArray")
HXLINE( 184)		return  ::lime::utils::Bytes_obj::__new(::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(byteArray),byteArray->b);
            	}
...
Int ByteArray_Impl__obj::get_length( ::openfl::utils::ByteArrayData this1){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","get_length",0xd68ebb4d,"openfl.utils._ByteArray.ByteArray_Impl_.get_length","openfl/utils/ByteArray.hx",202,0xaa5cee4a)
            	HX_STACK_ARG(this1,"this1")
HXLINE( 202)		return this1->length;
            	}
...
Int ByteArray_Impl__obj::set_length( ::openfl::utils::ByteArrayData this1,Int value){
            	HX_STACK_FRAME("openfl.utils._ByteArray.ByteArray_Impl_","set_length",0xda0c59c1,"openfl.utils._ByteArray.ByteArray_Impl_.set_length","openfl/utils/ByteArray.hx",208,0xaa5cee4a)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(value,"value")
HXLINE( 214)		if ((value > (int)0)) {
HXLINE( 216)			this1->_hx___resize(value);
            		}
HXLINE( 220)		this1->length = value;
