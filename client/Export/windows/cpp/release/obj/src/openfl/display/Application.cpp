...
void Application_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.Application","new",0x436ec718,"openfl.display.Application.new","openfl/display/Application.hx",14,0xe1d30bda)
            	HX_STACK_THIS(this)
HXLINE(  16)		super::__construct();
HXLINE(  18)		Bool _hx_tmp = hx::IsNull( ::openfl::Lib_obj::application );
HXDLIN(  18)		if (_hx_tmp) {
HXLINE(  20)			::openfl::Lib_obj::application = hx::ObjectPtr<OBJ_>(this);
            		}
            	}
...
void Application_obj::create( ::Dynamic config){
            	HX_STACK_FRAME("openfl.display.Application","create",0xb9517344,"openfl.display.Application.create","openfl/display/Application.hx",27,0xe1d30bda)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(config,"config")
HXLINE(  29)		this->config = config;
HXLINE(  31)		this->backend->create(config);
HXLINE(  34)		::openfl::Lib_obj::current->_hx___loaderInfo = ::openfl::display::LoaderInfo_obj::create(null());
HXLINE(  37)		Bool _hx_tmp = hx::IsNotNull( config );
HXDLIN(  37)		if (_hx_tmp) {
HXLINE(  39)			Bool _hx_tmp1 = ::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00));
HXDLIN(  39)			if (_hx_tmp1) {
HXLINE(  41)				Float value = ( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) );
HXDLIN(  41)				this->backend->setFrameRate(value);
            			}
HXLINE(  45)			Bool _hx_tmp2 = ::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8));
HXDLIN(  45)			if (_hx_tmp2) {
HXLINE(  47)				HX_VARI( Int,_g) = (int)0;
HXDLIN(  47)				HX_VARI( ::Array< ::Dynamic>,_g1) = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN(  47)				while((_g < _g1->length)){
HXLINE(  47)					HX_VARI(  ::Dynamic,windowConfig) = _g1->__get(_g);
HXDLIN(  47)					++_g;
HXLINE(  49)					HX_VARI(  ::openfl::display::Window,window) =  ::openfl::display::Window_obj::__new(windowConfig);
HXLINE(  50)					this->createWindow(window);
            				}
            			}
HXLINE(  60)			Bool _hx_tmp3;
HXDLIN(  60)			Bool _hx_tmp4 = hx::IsNotNull( this->_hx___preloader );
HXDLIN(  60)			if (_hx_tmp4) {
HXLINE(  60)				_hx_tmp3 = this->_hx___preloader->complete;
            			}
            			else {
HXLINE(  60)				_hx_tmp3 = true;
            			}
HXDLIN(  60)			if (_hx_tmp3) {
HXLINE(  62)				this->onPreloadComplete();
            			}
            		}
            	}
