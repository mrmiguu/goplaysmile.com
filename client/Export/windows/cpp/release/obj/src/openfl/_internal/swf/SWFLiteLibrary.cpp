...
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_58_exists,"openfl._internal.swf.SWFLiteLibrary","exists",0x9a5f8223,"openfl._internal.swf.SWFLiteLibrary.exists","openfl/_internal/swf/SWFLiteLibrary.hx",58,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_79_getImage,"openfl._internal.swf.SWFLiteLibrary","getImage",0x219672ec,"openfl._internal.swf.SWFLiteLibrary.getImage","openfl/_internal/swf/SWFLiteLibrary.hx",79,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_118_getMovieClip,"openfl._internal.swf.SWFLiteLibrary","getMovieClip",0x5607f2b1,"openfl._internal.swf.SWFLiteLibrary.getMovieClip","openfl/_internal/swf/SWFLiteLibrary.hx",118,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_125_isLocal,"openfl._internal.swf.SWFLiteLibrary","isLocal",0x6a6ec6fa,"openfl._internal.swf.SWFLiteLibrary.isLocal","openfl/_internal/swf/SWFLiteLibrary.hx",125,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_156_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",156,0xbec32034)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_130_load,"openfl._internal.swf.SWFLiteLibrary","load",0x35eb8ead,"openfl._internal.swf.SWFLiteLibrary.load","openfl/_internal/swf/SWFLiteLibrary.hx",130,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_170_loadImage,"openfl._internal.swf.SWFLiteLibrary","loadImage",0x9fc5ad6e,"openfl._internal.swf.SWFLiteLibrary.loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",170,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_188_loadImage,"openfl._internal.swf.SWFLiteLibrary","loadImage",0x9fc5ad6e,"openfl._internal.swf.SWFLiteLibrary.loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",188,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_216_unload,"openfl._internal.swf.SWFLiteLibrary","unload",0x400c0546,"openfl._internal.swf.SWFLiteLibrary.unload","openfl/_internal/swf/SWFLiteLibrary.hx",216,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_234___copyChannel,"openfl._internal.swf.SWFLiteLibrary","__copyChannel",0x00518107,"openfl._internal.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/swf/SWFLiteLibrary.hx",234,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_253___load,"openfl._internal.swf.SWFLiteLibrary","__load",0xd12f618d,"openfl._internal.swf.SWFLiteLibrary.__load","openfl/_internal/swf/SWFLiteLibrary.hx",253,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_260___loadImage,"openfl._internal.swf.SWFLiteLibrary","__loadImage",0xd3596e8e,"openfl._internal.swf.SWFLiteLibrary.__loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",260,0xbec32034)
namespace openfl{
namespace _internal{
namespace swf{
...
HXLINE(  85)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN(  85)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  85)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE(  89)					 ::openfl::_internal::symbols::BitmapSymbol bitmapSymbol = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE(  91)					if (hx::IsNotNull( bitmapSymbol->alpha )) {
HXLINE(  93)						 ::lime::graphics::Image image = this->super::getImage(id);
HXLINE(  94)						 ::lime::graphics::Image alpha = this->super::getImage(bitmapSymbol->alpha);
...
HXLINE( 130)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 132)		if (hx::IsNotNull( this->id )) {
HXLINE( 134)			this->preload->set(this->id,true);
            		}
HXLINE( 146)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
...
HXLINE( 170)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 176)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 176)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 176)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 180)					 ::openfl::_internal::symbols::BitmapSymbol bitmapSymbol = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
...
HXLINE( 184)						 ::lime::app::Promise_lime_graphics_Image promise =  ::lime::app::Promise_lime_graphics_Image_obj::__alloc( HX_CTX );
...
HXLINE( 218)		 ::openfl::_internal::symbols::BitmapSymbol bitmap;
HXLINE( 220)		{
HXLINE( 220)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 220)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 220)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 238)			 ::lime::math::Rectangle _hx_tmp = alpha->get_rect();
HXDLIN( 238)			image->copyChannel(alpha,_hx_tmp, ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()),::lime::graphics::ImageChannel_obj::RED_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
            		}
