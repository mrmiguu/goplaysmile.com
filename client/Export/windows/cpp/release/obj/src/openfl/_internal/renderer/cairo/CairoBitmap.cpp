...
HXLINE(  32)			Bool _hx_tmp3 = renderSession->roundPixels;
...
HXLINE(  41)				 ::lime::math::Matrix3 _hx_tmp4 = transform->_hx___toMatrix3();
HXDLIN(  41)				cairo->set_matrix(_hx_tmp4);
            			}
HXLINE(  45)			HX_VARI(  ::Dynamic,surface) = bitmap->bitmapData->getSurface();
HXLINE(  47)			Bool _hx_tmp5 = hx::IsNotNull( surface );
...
HXLINE(  50)				Int _hx_tmp6;
HXDLIN(  50)				Bool _hx_tmp7;
HXDLIN(  50)				if (renderSession->allowSmoothing) {
HXLINE(  50)					_hx_tmp7 = bitmap->smoothing;
            				}
            				else {
HXLINE(  50)					_hx_tmp7 = false;
            				}
HXDLIN(  50)				if (_hx_tmp7) {
HXLINE(  50)					_hx_tmp6 = (int)1;
            				}
            				else {
HXLINE(  50)					_hx_tmp6 = (int)3;
            				}
HXDLIN(  50)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp6);
HXLINE(  52)				cairo->set_source(pattern);
HXLINE(  54)				Bool _hx_tmp8 = (bitmap->_hx___worldAlpha == (int)1);
