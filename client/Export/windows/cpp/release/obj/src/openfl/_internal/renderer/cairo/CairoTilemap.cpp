...
HX_LOCAL_STACK_FRAME(_hx_pos_a3e299adbe0f9dae_25_render,"openfl._internal.renderer.cairo.CairoTilemap","render",0xc7ad047d,"openfl._internal.renderer.cairo.CairoTilemap.render","openfl/_internal/renderer/cairo/CairoTilemap.hx",25,0x8aa306f7)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
HXLINE(  33)		 ::openfl::geom::Rectangle rect = ::openfl::geom::Rectangle_obj::_hx___temp;
...
HXLINE(  37)		 ::openfl::geom::Matrix transform = tilemap->_hx___renderTransform;
HXLINE(  38)		bool roundPixels = renderSession->roundPixels;
HXLINE(  40)		 ::openfl::display::Tileset defaultTileset = tilemap->tileset;
HXLINE(  41)		 ::openfl::display::BitmapData cacheBitmapData = null();
HXLINE(  42)		 ::Dynamic surface = null();
HXLINE(  43)		 ::Dynamic pattern = null();
HXLINE(  45)		::Array< ::Dynamic> tiles;
HXDLIN(  45)		int count;
HXDLIN(  45)		 ::openfl::display::Tile tile;
HXDLIN(  45)		Float alpha;
HXDLIN(  45)		bool visible;
HXDLIN(  45)		 ::openfl::display::Tileset tileset;
HXDLIN(  45)		 ::openfl::display::_Tileset::TileData tileData;
HXDLIN(  45)		 ::openfl::display::BitmapData bitmapData;
HXLINE(  47)		tiles = tilemap->_hx___tiles;
HXLINE(  48)		count = tiles->length;
HXLINE(  50)		 ::lime::math::Matrix3 matrix =  ::lime::math::Matrix3_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE(  51)		 ::openfl::geom::Matrix tileTransform = ::openfl::geom::Matrix_obj::_hx___temp;
HXLINE(  53)		{
HXLINE(  53)			int _g1 = (int)0;
HXDLIN(  53)			int _g = count;
...
HXLINE(  85)				tileTransform->setTo((int)1,(int)0,(int)0,(int)1,-(tile->originX),-(tile->originY));
HXLINE(  86)				tileTransform->concat(tile->matrix);
HXLINE(  87)				tileTransform->concat(transform);
HXLINE(  89)				if (roundPixels) {
HXLINE(  91)					tileTransform->tx = ::Math_obj::round(tileTransform->tx);
HXLINE(  92)					tileTransform->ty = ::Math_obj::round(tileTransform->ty);
            				}
HXLINE(  96)				cairo->set_matrix(tileTransform->_hx___toMatrix3());
HXLINE(  98)				matrix->tx = tileData->x;
HXLINE(  99)				matrix->ty = tileData->y;
HXLINE( 100)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_matrix(pattern,matrix);
HXLINE( 101)				cairo->set_source(pattern);
HXLINE( 103)				cairo->save();
HXLINE( 105)				cairo->newPath();
HXLINE( 106)				cairo->rectangle((int)0,(int)0,tileData->width,tileData->height);
HXLINE( 107)				cairo->clip();
HXLINE( 109)				bool _hx_tmp5;
HXDLIN( 109)				if ((tilemap->_hx___worldAlpha == (int)1)) {
HXLINE( 109)					_hx_tmp5 = (alpha == (int)1);
            				}
            				else {
HXLINE( 109)					_hx_tmp5 = false;
            				}
HXDLIN( 109)				if (_hx_tmp5) {
HXLINE( 111)					cairo->paint();
            				}
            				else {
HXLINE( 115)					cairo->paintWithAlpha((tilemap->_hx___worldAlpha * alpha));
            				}
HXLINE( 119)				cairo->restore();
            			}
            		}
HXLINE( 123)		renderSession->maskManager->popRect();
HXLINE( 124)		renderSession->maskManager->popObject(tilemap,null());
            	}
