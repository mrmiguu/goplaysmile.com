...
Dynamic Context3DWrapMode_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Context3DWrapMode_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","fromString",0xa28ec483,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.fromString","openfl/display3D/Context3DWrapMode.hx",14,0x5bc49e6c)
...
::String Context3DWrapMode_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","toString",0x61caed54,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.toString","openfl/display3D/Context3DWrapMode.hx",28,0x5bc49e6c)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","boot",0xdab22cda,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.boot","openfl/display3D/Context3DWrapMode.hx",7,0x5bc49e6c)
HXLINE(   7)		CLAMP = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","boot",0xdab22cda,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.boot","openfl/display3D/Context3DWrapMode.hx",8,0x5bc49e6c)
HXLINE(   8)		CLAMP_U_REPEAT_V = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","boot",0xdab22cda,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.boot","openfl/display3D/Context3DWrapMode.hx",9,0x5bc49e6c)
HXLINE(   9)		REPEAT = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_","boot",0xdab22cda,"openfl.display3D._Context3DWrapMode.Context3DWrapMode_Impl_.boot","openfl/display3D/Context3DWrapMode.hx",10,0x5bc49e6c)
