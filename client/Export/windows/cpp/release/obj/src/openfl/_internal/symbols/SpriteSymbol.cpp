...
void SpriteSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.SpriteSymbol","new",0x907606b2,"openfl._internal.symbols.SpriteSymbol.new","openfl/_internal/symbols/SpriteSymbol.hx",17,0x4ab9bb1b)
            	HX_STACK_THIS(this)
...
Dynamic SpriteSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject SpriteSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.SpriteSymbol","__createObject",0xc7e3e8e9,"openfl._internal.symbols.SpriteSymbol.__createObject","openfl/_internal/symbols/SpriteSymbol.hx",26,0x4ab9bb1b)
            	HX_STACK_THIS(this)
...
HXLINE(  35)		Bool _hx_tmp = hx::IsNotNull( this->className );
HXDLIN(  35)		if (_hx_tmp) {
HXLINE(  37)			HX_VARI( hx::Class,symbolType) = ::Type_obj::resolveClass(this->className);
HXLINE(  39)			Bool _hx_tmp1 = hx::IsNotNull( symbolType );
...
HXLINE(  51)		Bool _hx_tmp2 = hx::IsNull( movieClip );
HXDLIN(  51)		if (_hx_tmp2) {
HXLINE(  53)			movieClip =  ::openfl::display::MovieClip_obj::__new();
            		}
