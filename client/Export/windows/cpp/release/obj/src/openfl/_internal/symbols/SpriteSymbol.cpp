...
void SpriteSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.SpriteSymbol","new",0x907606b2,"openfl._internal.symbols.SpriteSymbol.new","openfl/_internal/symbols/SpriteSymbol.hx",18,0x4ab9bb1b)
            	HX_STACK_THIS(this)
HXLINE(  20)		super::__construct();
HXLINE(  22)		this->frames = ::Array_obj< ::Dynamic>::__new();
            	}
...
Dynamic SpriteSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject SpriteSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.SpriteSymbol","__createObject",0xc7e3e8e9,"openfl._internal.symbols.SpriteSymbol.__createObject","openfl/_internal/symbols/SpriteSymbol.hx",27,0x4ab9bb1b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  29)		HX_VARI(  ::openfl::display::MovieClip,movieClip) = null();
...
HXLINE(  40)				movieClip = ( ( ::openfl::display::MovieClip)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  50)		Bool _hx_tmp2 = hx::IsNull( movieClip );
HXDLIN(  50)		if (_hx_tmp2) {
HXLINE(  52)			movieClip =  ::openfl::display::MovieClip_obj::__new();
            		}
HXLINE(  56)		return movieClip;
            	}
