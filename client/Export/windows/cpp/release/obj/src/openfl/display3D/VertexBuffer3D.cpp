...
hx::ObjectPtr< VertexBuffer3D_obj > VertexBuffer3D_obj::__new( ::openfl::display3D::Context3D context3D,Int numVertices,Int dataPerVertex,::String bufferUsage)
{
	...
	_hx_result->__construct(context3D,numVertices,dataPerVertex,bufferUsage);
	return _hx_result;
}
...
HXDLIN(  63)		Bool _hx_tmp = hx::IsNotNull( buffer );
HXDLIN(  63)		if (_hx_tmp) {
HXLINE(  63)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)8);
...
HXDLIN(  63)			Bool _hx_tmp1 = hx::IsNull( length );
...
HXDLIN(  63)			Float _hx_tmp2 = ((Float)newByteLength / (Float)_this->bytesPerElement);
HXDLIN(  63)			_this->length = ::Std_obj::_hx_int(_hx_tmp2);
...
void VertexBuffer3D_obj::uploadFromTypedArray( ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
HXLINE(  70)		Bool _hx_tmp = hx::IsNull( data );
...
HXLINE(  75)		{
HXLINE(  75)			Int usage = this->_hx___usage;
HXDLIN(  75)			::lime::graphics::opengl::GL_obj::context->bufferData((int)34962,data,usage);
            		}
HXLINE(  76)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  78)		Bool _hx_tmp1 = (data->byteLength != this->_hx___memoryUsage);
HXDLIN(  78)		if (_hx_tmp1) {
HXLINE(  80)			Int _hx_tmp2 = (data->byteLength - this->_hx___memoryUsage);
HXDLIN(  80)			this->_hx___context->_hx___statsAdd((int)7,_hx_tmp2);
...
void VertexBuffer3D_obj::uploadFromVector( ::openfl::_Vector::FloatVector data,Int startVertex,Int numVertices){
            	HX_STACK_FRAME("openfl.display3D.VertexBuffer3D","uploadFromVector",0xcf228b0e,"openfl.display3D.VertexBuffer3D.uploadFromVector","openfl/display3D/VertexBuffer3D.hx",88,0xb1ad396e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(startVertex,"startVertex")
            	HX_STACK_ARG(numVertices,"numVertices")
...
HXDLIN(  96)		Bool _hx_tmp = hx::IsNotNull( count );
HXDLIN(  96)		if (_hx_tmp) {
HXLINE(  96)			this1 =  ::lime::utils::ArrayBufferView_obj::__new(count,(int)8);
            		}
            		else {
...
HXLINE( 100)				{
HXLINE( 100)					HX_VARI( Float,val) = data->get(i);
HXDLIN( 100)					{
HXLINE( 100)						Int _hx_tmp1 = buffer->byteOffset;
HXDLIN( 100)						::__hxcpp_memory_set_float(buffer->buffer->b,(_hx_tmp1 + ((i - start) * (int)4)),val);
            					}
            				}
            			}
            		}
