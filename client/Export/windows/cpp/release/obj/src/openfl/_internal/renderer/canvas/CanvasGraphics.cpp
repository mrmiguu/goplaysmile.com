...
Bool strokeBefore = __o_strokeBefore.Default(false);
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","closePath",0x0426588d,"openfl._internal.renderer.canvas.CanvasGraphics.closePath","openfl/_internal/renderer/canvas/CanvasGraphics.hx",62,0x0b9ff65e)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CanvasGraphics_obj,closePath,(void))
 ...
 ::Dynamic CanvasGraphics_obj::createBitmapFill( ::openfl::display::BitmapData bitmap,Bool bitmapRepeat,Bool smooth){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","createBitmapFill",0x2a5c3b1e,"openfl._internal.renderer.canvas.CanvasGraphics.createBitmapFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",103,0x0b9ff65e)
...
void CanvasGraphics_obj::createGradientPattern( ::Dynamic type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","createGradientPattern",0x6cf339b4,"openfl._internal.renderer.canvas.CanvasGraphics.createGradientPattern","openfl/_internal/renderer/canvas/CanvasGraphics.hx",110,0x0b9ff65e)
...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,Bool repeat,Int width,Int height){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","createTempPatternCanvas",0x07b48808,"openfl._internal.renderer.canvas.CanvasGraphics.createTempPatternCanvas","openfl/_internal/renderer/canvas/CanvasGraphics.hx",158,0x0b9ff65e)
            	HX_STACK_ARG(bitmap,"bitmap")
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","drawRoundRect",0x4e8f7efe,"openfl._internal.renderer.canvas.CanvasGraphics.drawRoundRect","openfl/_internal/renderer/canvas/CanvasGraphics.hx",184,0x0b9ff65e)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
...
void CanvasGraphics_obj::endFill(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","endFill",0x3478970e,"openfl._internal.renderer.canvas.CanvasGraphics.endFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",220,0x0b9ff65e)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","endStroke",0x411cf503,"openfl._internal.renderer.canvas.CanvasGraphics.endStroke","openfl/_internal/renderer/canvas/CanvasGraphics.hx",231,0x0b9ff65e)
            	}
...
Bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",469,0x0b9ff65e)
...
Bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",476,0x0b9ff65e)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
            	HX_STACK_ARG(x3,"x3")
            	HX_STACK_ARG(y3,"y3")
HXLINE( 476)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
Bool skipT = __o_skipT.Default(false);
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",481,0x0b9ff65e)
            	HX_STACK_ARG(uvt,"uvt")
            	HX_STACK_ARG(skipT,"skipT")
HXLINE( 483)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 484)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 485)		HX_VARI( Int,len) = uvt->get_length();
HXLINE( 487)		{
HXLINE( 487)			HX_VARI( Int,_g1) = (int)1;
HXDLIN( 487)			HX_VARI( Int,_g) = (len + (int)1);
HXDLIN( 487)			while((_g1 < _g)){
HXLINE( 487)				HX_VARI( Int,t) = _g1++;
HXLINE( 489)				Bool _hx_tmp;
HXDLIN( 489)				if (skipT) {
HXLINE( 489)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 495)				tmp = uvt->get((t - (int)1));
HXLINE( 497)				Bool _hx_tmp1 = (max < tmp);
...
HXLINE( 505)		if (!(skipT)) {
HXLINE( 507)			return  ::Dynamic(hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 511)		Int length = null();
HXDLIN( 511)		Bool fixed = null();
HXDLIN( 511)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__new(length,fixed,null());
HXLINE( 513)		{
HXLINE( 513)			HX_VARI_NAME( Int,_g11,"_g1") = (int)1;
HXDLIN( 513)			HX_VARI_NAME( Int,_g2,"_g") = (len + (int)1);
HXDLIN( 513)			while((_g11 < _g2)){
HXLINE( 513)				HX_VARI_NAME( Int,t1,"t") = _g11++;
HXLINE( 515)				Bool _hx_tmp2;
HXDLIN( 515)				if (skipT) {
HXLINE( 515)					_hx_tmp2 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 521)				{
HXLINE( 521)					Float x = uvt->get((t1 - (int)1));
HXDLIN( 521)					result->push(x);
            				}
            			}
            		}
HXLINE( 525)		return  ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
Bool stroke = __o_stroke.Default(false);
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",530,0x0b9ff65e)
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession, ::openfl::geom::Matrix parentTransform){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",861,0x0b9ff65e)
            	HX_STACK_ARG(graphics,"graphics")
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1208,0x0b9ff65e)
            	HX_STACK_ARG(graphics,"graphics")
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
...
void CanvasGraphics_obj::setSmoothing(Bool smooth){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1315,0x0b9ff65e)
            	HX_STACK_ARG(smooth,"smooth")
            	}
...
{
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",40,0x0b9ff65e)
HXLINE(  40)		SIN45 = ((Float)0.70710678118654752440084436210485);
            	}
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",41,0x0b9ff65e)
HXLINE(  41)		TAN22 = ((Float)0.4142135623730950488016887242097);
            	}
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",48,0x0b9ff65e)
HXLINE(  48)		fillCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__new();
            	}
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",55,0x0b9ff65e)
