...
Dynamic Context3DRenderMode_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Context3DRenderMode_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_","fromString",0x77bca1ab,"openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_.fromString","openfl/display3D/Context3DRenderMode.hx",12,0xec19e320)
...
::String Context3DRenderMode_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_","toString",0xace3b07c,"openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_.toString","openfl/display3D/Context3DRenderMode.hx",24,0xec19e320)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_","boot",0x14103c02,"openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_.boot","openfl/display3D/Context3DRenderMode.hx",7,0xec19e320)
HXLINE(   7)		AUTO = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_","boot",0x14103c02,"openfl.display3D._Context3DRenderMode.Context3DRenderMode_Impl_.boot","openfl/display3D/Context3DRenderMode.hx",8,0xec19e320)
