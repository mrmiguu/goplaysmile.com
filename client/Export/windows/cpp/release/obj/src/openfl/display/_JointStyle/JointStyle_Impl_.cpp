...
Dynamic JointStyle_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic JointStyle_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._JointStyle.JointStyle_Impl_","fromString",0x7f19acb0,"openfl.display._JointStyle.JointStyle_Impl_.fromString","openfl/display/JointStyle.hx",12,0xc58a30ab)
...
::String JointStyle_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._JointStyle.JointStyle_Impl_","toString",0xcf598041,"openfl.display._JointStyle.JointStyle_Impl_.toString","openfl/display/JointStyle.hx",25,0xc58a30ab)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._JointStyle.JointStyle_Impl_","boot",0x74078547,"openfl.display._JointStyle.JointStyle_Impl_.boot","openfl/display/JointStyle.hx",6,0xc58a30ab)
HXLINE(   6)		BEVEL = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._JointStyle.JointStyle_Impl_","boot",0x74078547,"openfl.display._JointStyle.JointStyle_Impl_.boot","openfl/display/JointStyle.hx",7,0xc58a30ab)
HXLINE(   7)		MITER = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._JointStyle.JointStyle_Impl_","boot",0x74078547,"openfl.display._JointStyle.JointStyle_Impl_.boot","openfl/display/JointStyle.hx",8,0xc58a30ab)
