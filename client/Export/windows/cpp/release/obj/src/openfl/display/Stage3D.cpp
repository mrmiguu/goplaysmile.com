...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACK_FRAME("openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",58,0x37141b9b)
            	HX_STACK_THIS(this)
...
HXLINE(  62)		Bool _hx_tmp = hx::IsNotNull( this->context3D );
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACK_FRAME("openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",73,0x37141b9b)
            	HX_STACK_THIS(this)
...
void Stage3D_obj::_hx___createContext( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",80,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE(  80)		Bool _hx_tmp = hx::IsNotNull( renderSession->gl );
HXDLIN(  80)		if (_hx_tmp) {
HXLINE(  82)			this->context3D =  ::openfl::display3D::Context3D_obj::__new(hx::ObjectPtr<OBJ_>(this),renderSession);
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_STACK_FRAME("openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",144,0x37141b9b)
            	HX_STACK_THIS(this)
HXLINE( 146)		this->_hx___contextRequested = false;
HXLINE( 147)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__new(HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_STACK_FRAME("openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",154,0x37141b9b)
            	HX_STACK_THIS(this)
HXLINE( 154)		Bool _hx_tmp = this->_hx___contextRequested;
HXDLIN( 154)		if (_hx_tmp) {
HXLINE( 156)			this->_hx___contextRequested = false;
HXLINE( 157)			this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___renderCairo( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.Stage3D","__renderCairo",0x4faad7c9,"openfl.display.Stage3D.__renderCairo","openfl/display/Stage3D.hx",164,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
...
HXLINE( 168)		Bool _hx_tmp = this->_hx___contextRequested;
...
void Stage3D_obj::_hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.Stage3D","__renderCanvas",0x69230677,"openfl.display.Stage3D.__renderCanvas","openfl/display/Stage3D.hx",178,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
...
HXLINE( 182)		Bool _hx_tmp = this->_hx___contextRequested;
...
void Stage3D_obj::_hx___renderDOM( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.Stage3D","__renderDOM",0x9069cb83,"openfl.display.Stage3D.__renderDOM","openfl/display/Stage3D.hx",192,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
...
HXLINE( 202)		Bool _hx_tmp1 = hx::IsNotNull( this->context3D );
...
void Stage3D_obj::_hx___renderGL( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.Stage3D","__renderGL",0x25621024,"openfl.display.Stage3D.__renderGL","openfl/display/Stage3D.hx",216,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
...
HXLINE( 226)		Bool _hx_tmp1 = hx::IsNotNull( this->context3D );
HXDLIN( 226)		if (_hx_tmp1) {
HXLINE( 228)			this->_hx___resetContext3DStates();
HXLINE( 229)			Bool _hx_tmp2 = hx::IsNotNull( this->context3D );
...
HXDLIN( 229)				Bool _hx_tmp3 = hx::IsNotNull( renderSession->shaderManager->currentShader );
HXDLIN( 229)				if (_hx_tmp3) {
HXLINE( 229)					renderSession->shaderManager->setShader(null());
HXDLIN( 229)					Bool _hx_tmp4 = hx::IsNotNull( this->context3D->_hx___program );
...
void Stage3D_obj::_hx___resize(Int width,Int height){
            	HX_STACK_FRAME("openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",236,0x37141b9b)
            	HX_STACK_THIS(this)
...
void Stage3D_obj::_hx___resetContext3DStates(){
            	HX_STACK_FRAME("openfl.display.Stage3D","__resetContext3DStates",0x6c934f5c,"openfl.display.Stage3D.__resetContext3DStates","openfl/display/Stage3D.hx",250,0x37141b9b)
            	HX_STACK_THIS(this)
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACK_FRAME("openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",260,0x37141b9b)
            	HX_STACK_THIS(this)
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACK_FRAME("openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",275,0x37141b9b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 277)		this->y = value;
HXLINE( 279)		Bool _hx_tmp = hx::IsNotNull( this->context3D );
