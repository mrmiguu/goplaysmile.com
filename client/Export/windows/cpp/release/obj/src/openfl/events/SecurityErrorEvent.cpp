...
Dynamic SecurityErrorEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event SecurityErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		HX_VARI(  ::openfl::events::SecurityErrorEvent,event) =  ::openfl::events::SecurityErrorEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text,this->errorID);
...
::String SecurityErrorEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.SecurityErrorEvent","toString",0xccee4db1,"openfl.events.SecurityErrorEvent.toString","openfl/events/SecurityErrorEvent.hx",30,0x4f4e3035)
            	HX_STACK_THIS(this)
HXLINE(  30)		return this->_hx___formatToString(HX_("SecurityErrorEvent",32,ea,b2,a1),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.SecurityErrorEvent","boot",0x0eecdab7,"openfl.events.SecurityErrorEvent.boot","openfl/events/SecurityErrorEvent.hx",7,0x4f4e3035)
