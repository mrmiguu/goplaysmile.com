...
HXLINE(  84)			 ::openfl::display::DisplayObject _hx_tmp1 = symbol->downState->_hx___createObject(swf);
HXDLIN(  84)			this->set_downState(_hx_tmp1);
            		}
HXLINE(  88)		Bool _hx_tmp2 = hx::IsNotNull( symbol->hitState );
HXDLIN(  88)		if (_hx_tmp2) {
HXLINE(  90)			 ::openfl::display::DisplayObject _hx_tmp3 = symbol->hitState->_hx___createObject(swf);
HXDLIN(  90)			this->set_hitTestState(_hx_tmp3);
            		}
HXLINE(  94)		Bool _hx_tmp4 = hx::IsNotNull( symbol->overState );
HXDLIN(  94)		if (_hx_tmp4) {
HXLINE(  96)			 ::openfl::display::DisplayObject _hx_tmp5 = symbol->overState->_hx___createObject(swf);
HXDLIN(  96)			this->set_overState(_hx_tmp5);
            		}
HXLINE( 100)		Bool _hx_tmp6 = hx::IsNotNull( symbol->upState );
HXDLIN( 100)		if (_hx_tmp6) {
HXLINE( 102)			 ::openfl::display::DisplayObject _hx_tmp7 = symbol->upState->_hx___createObject(swf);
