...
Dynamic FontStyle_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic FontStyle_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","fromString",0x9783fd8f,"openfl.text._FontStyle.FontStyle_Impl_.fromString","openfl/text/FontStyle.hx",13,0x6b07f79f)
...
::String FontStyle_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","toString",0x0cd38b60,"openfl.text._FontStyle.FontStyle_Impl_.toString","openfl/text/FontStyle.hx",27,0x6b07f79f)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",6,0x6b07f79f)
HXLINE(   6)		BOLD = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",7,0x6b07f79f)
HXLINE(   7)		BOLD_ITALIC = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",8,0x6b07f79f)
HXLINE(   8)		ITALIC = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",9,0x6b07f79f)
