...
hx::ObjectPtr< NetStream_obj > NetStream_obj::__new( ::openfl::net::NetConnection connection,::String peerID)
{
	...
	_hx_result->__construct(connection,peerID);
	return _hx_result;
}
...
void NetStream_obj::video_onEnd( ::Dynamic event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 231)		this->_hx___connection->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__new(HX_("netStatus",6f,4f,ec,46),false,false, ::Dynamic(hx::Anon_obj::Create(1)
...
void NetStream_obj::video_onError( ::Dynamic event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 239)		this->_hx___connection->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__new(HX_("netStatus",6f,4f,ec,46),false,false, ::Dynamic(hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("code",2d,b1,c4,41),HX_("NetStream.Play.Stop",ab,15,72,a7)))));
...
void NetStream_obj::video_onPlaying( ::Dynamic event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 285)		this->_hx___connection->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__new(HX_("netStatus",6f,4f,ec,46),false,false, ::Dynamic(hx::Anon_obj::Create(1)
...
Float NetStream_obj::set_speed(Float value){
            	HX_STACK_FRAME("openfl.net.NetStream","set_speed",0x6d85076a,"openfl.net.NetStream.set_speed","openfl/net/NetStream.hx",346,0x9cb99312)
            	HX_STACK_THIS(this)
