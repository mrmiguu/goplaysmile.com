...
Dynamic MouseEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_STACK_FRAME("openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",96,0xd3783172)
            	HX_STACK_THIS(this)
HXLINE(  98)		HX_VARI(  ::openfl::events::MouseEvent,event) =  ::openfl::events::MouseEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
...
::String MouseEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",109,0xd3783172)
            	HX_STACK_THIS(this)
HXLINE( 109)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_0,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACK_FRAME("openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",114,0xd3783172)
            	HX_STACK_THIS(this)
            	}
...
Int delta = __o_delta.Default(0);
            	HX_STACK_FRAME("openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",70,0xd3783172)
            	HX_STACK_ARG(type,"type")
...
{
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",11,0xd3783172)
HXLINE(  11)		CLICK = HX_("click",48,7c,5e,48);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",12,0xd3783172)
HXLINE(  12)		DOUBLE_CLICK = HX_("doubleClick",77,03,76,cd);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",13,0xd3783172)
HXLINE(  13)		MIDDLE_CLICK = HX_("middleClick",b3,e4,e5,43);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",14,0xd3783172)
HXLINE(  14)		MIDDLE_MOUSE_DOWN = HX_("middleMouseDown",12,2b,fe,01);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",15,0xd3783172)
HXLINE(  15)		MIDDLE_MOUSE_UP = HX_("middleMouseUp",0b,8d,f5,3a);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",16,0xd3783172)
HXLINE(  16)		MOUSE_DOWN = HX_("mouseDown",27,b1,c2,ee);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",17,0xd3783172)
HXLINE(  17)		MOUSE_MOVE = HX_("mouseMove",d6,9b,b5,f4);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",18,0xd3783172)
HXLINE(  18)		MOUSE_OUT = HX_("mouseOut",69,e7,1d,a4);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",19,0xd3783172)
HXLINE(  19)		MOUSE_OVER = HX_("mouseOver",19,4a,0d,f6);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",20,0xd3783172)
HXLINE(  20)		MOUSE_UP = HX_("mouseUp",e0,f3,72,c0);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",21,0xd3783172)
HXLINE(  21)		MOUSE_WHEEL = HX_("mouseWheel",36,28,87,e7);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",22,0xd3783172)
HXLINE(  22)		RIGHT_CLICK = HX_("rightClick",cc,62,23,4b);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",23,0xd3783172)
HXLINE(  23)		RIGHT_MOUSE_DOWN = HX_("rightMouseDown",ab,29,d7,cd);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",24,0xd3783172)
HXLINE(  24)		RIGHT_MOUSE_UP = HX_("rightMouseUp",64,83,21,ab);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",25,0xd3783172)
HXLINE(  25)		ROLL_OUT = HX_("rollOut",11,f9,11,5d);
            	}
{
            	HX_STACK_FRAME("openfl.events.MouseEvent","boot",0x7b9c4534,"openfl.events.MouseEvent.boot","openfl/events/MouseEvent.hx",26,0xd3783172)
