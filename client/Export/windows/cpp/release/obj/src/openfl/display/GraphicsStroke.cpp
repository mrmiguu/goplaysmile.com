...
HXDLIN(  23)		if (hx::IsNotNull( caps )) {
...
HXLINE(  25)		 ::Dynamic _hx_tmp1;
HXDLIN(  25)		if (hx::IsNotNull( joints )) {
HXLINE(  25)			_hx_tmp1 = joints;
            		}
            		else {
HXLINE(  25)			_hx_tmp1 = (int)2;
            		}
HXDLIN(  25)		this->joints = _hx_tmp1;
HXLINE(  26)		this->miterLimit = miterLimit;
HXLINE(  27)		this->pixelHinting = pixelHinting;
HXLINE(  28)		 ::Dynamic _hx_tmp2;
HXDLIN(  28)		if (hx::IsNotNull( scaleMode )) {
HXLINE(  28)			_hx_tmp2 = scaleMode;
            		}
            		else {
HXLINE(  28)			_hx_tmp2 = (int)2;
            		}
HXDLIN(  28)		this->scaleMode = _hx_tmp2;
...
hx::ObjectPtr< GraphicsStroke_obj > GraphicsStroke_obj::__new(hx::Null< Float >  __o_thickness,hx::Null< bool >  __o_pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,hx::Null< Float >  __o_miterLimit,::Dynamic fill) {
	...
	__this->__construct(__o_thickness,__o_pixelHinting,scaleMode,caps,joints,__o_miterLimit,fill);
	return __this;
}

hx::ObjectPtr< GraphicsStroke_obj > GraphicsStroke_obj::__alloc(hx::Ctx *_hx_ctx,hx::Null< Float >  __o_thickness,hx::Null< bool >  __o_pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,hx::Null< Float >  __o_miterLimit,::Dynamic fill) {
