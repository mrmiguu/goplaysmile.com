...
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_272_new,"openfl.utils._Dictionary.UtilsObjectMap","new",0xb7b17cf2,"openfl.utils._Dictionary.UtilsObjectMap.new","openfl/utils/Dictionary.hx",272,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_279_exists,"openfl.utils._Dictionary.UtilsObjectMap","exists",0x51d7188a,"openfl.utils._Dictionary.UtilsObjectMap.exists","openfl/utils/Dictionary.hx",279,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_286_get,"openfl.utils._Dictionary.UtilsObjectMap","get",0xb7ac2d28,"openfl.utils._Dictionary.UtilsObjectMap.get","openfl/utils/Dictionary.hx",286,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_293_keys,"openfl.utils._Dictionary.UtilsObjectMap","keys",0x01a03522,"openfl.utils._Dictionary.UtilsObjectMap.keys","openfl/utils/Dictionary.hx",293,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_300_iterator,"openfl.utils._Dictionary.UtilsObjectMap","iterator",0xcd47cc1c,"openfl.utils._Dictionary.UtilsObjectMap.iterator","openfl/utils/Dictionary.hx",300,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_307_remove,"openfl.utils._Dictionary.UtilsObjectMap","remove",0x967f96f2,"openfl.utils._Dictionary.UtilsObjectMap.remove","openfl/utils/Dictionary.hx",307,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_314_set,"openfl.utils._Dictionary.UtilsObjectMap","set",0xb7b54834,"openfl.utils._Dictionary.UtilsObjectMap.set","openfl/utils/Dictionary.hx",314,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_321_toString,"openfl.utils._Dictionary.UtilsObjectMap","toString",0x721c52da,"openfl.utils._Dictionary.UtilsObjectMap.toString","openfl/utils/Dictionary.hx",321,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void UtilsObjectMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_272_new)
            	HX_STACK_THIS(this)
HXLINE( 272)		this->map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            	}
...
bool UtilsObjectMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_279_exists)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,exists,return )
 ...
 ::Dynamic UtilsObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_286_get)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,get,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_293_keys)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keys,return )
 ...
 ::Dynamic UtilsObjectMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_300_iterator)
            	HX_STACK_THIS(this)
...
bool UtilsObjectMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_307_remove)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
void UtilsObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_314_set)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
::String UtilsObjectMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_321_toString)
            	HX_STACK_THIS(this)
