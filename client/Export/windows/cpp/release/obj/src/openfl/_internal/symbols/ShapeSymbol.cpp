...
HXDLIN(  46)						{
HXLINE(  48)							HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(swf->symbols->get(command->_hx_getInt(0)).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >()) );
HXLINE(  49)							HX_VARI(  ::lime::graphics::Image,bitmap) = swf->library->getImage(bitmapSymbol->path);
HXLINE(  51)							Bool _hx_tmp3 = hx::IsNotNull( bitmap );
HXDLIN(  51)							if (_hx_tmp3) {
HXLINE(  53)								 ::openfl::display::BitmapData _hx_tmp4 = ::openfl::display::BitmapData_obj::fromImage(bitmap,null());
HXDLIN(  53)								graphics->beginBitmapFill(_hx_tmp4,matrix,repeat,smooth);
            							}
            						}
            					}
            					break;
...
HXLINE(  44)						graphics->beginFill(command->_hx_getInt(0),command->_hx_getFloat(1));
            					...
            					break;
            					case (int)2: {
HXLINE(  59)						graphics->beginGradientFill(command->_hx_getObject(0),command->_hx_getObject(1).StaticCast< ::Array< Int > >(),command->_hx_getObject(2).StaticCast< ::Array< Float > >(),command->_hx_getObject(3).StaticCast< ::Array< Int > >(),command->_hx_getObject(4).StaticCast<  ::openfl::geom::Matrix >(),command->_hx_getObject(5),command->_hx_getObject(6),command->_hx_getFloat(7));
            					}
            					break;
            					case (int)3: {
HXLINE(  63)						graphics->curveTo(command->_hx_getFloat(0),command->_hx_getFloat(1),command->_hx_getFloat(2),command->_hx_getFloat(3));
            					}
            					break;
            					case (int)4: {
HXLINE(  67)						graphics->endFill();
            					...
            					break;
            					case (int)5: {
HXLINE(  69)						HX_VARI(  ::Dynamic,miterLimit) = command->_hx_getObject(7);
HXDLIN(  69)						HX_VARI(  ::Dynamic,joints) = command->_hx_getObject(6);
HXDLIN(  69)						HX_VARI(  ::Dynamic,caps) = command->_hx_getObject(5);
HXDLIN(  69)						HX_VARI(  ::Dynamic,scaleMode) = command->_hx_getObject(4);
HXDLIN(  69)						HX_VARI(  ::Dynamic,pixelHinting) = command->_hx_getObject(3);
HXDLIN(  69)						HX_VARI(  ::Dynamic,alpha) = command->_hx_getObject(2);
HXDLIN(  69)						HX_VARI(  ::Dynamic,color) = command->_hx_getObject(1);
HXDLIN(  69)						HX_VARI(  ::Dynamic,thickness) = command->_hx_getObject(0);
HXLINE(  71)						Bool _hx_tmp5 = hx::IsNotNull( thickness );
HXDLIN(  71)						if (_hx_tmp5) {
HXLINE(  73)							graphics->lineStyle(thickness,color,alpha,pixelHinting,scaleMode,caps,joints,miterLimit);
            						}
            						else {
HXLINE(  77)							graphics->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
            					...
            					break;
            					case (int)6: {
HXLINE(  83)						graphics->lineTo(command->_hx_getFloat(0),command->_hx_getFloat(1));
            					}
            					break;
            					case (int)7: {
HXLINE(  87)						graphics->moveTo(command->_hx_getFloat(0),command->_hx_getFloat(1));
            					}
            					break;
            				}
            			}
...
HXLINE(  94)		this->rendered =  ::openfl::display::Shape_obj::__new();
HXLINE(  95)		 ::openfl::display::Graphics _hx_tmp6 = this->rendered->get_graphics();
HXDLIN(  95)		 ::openfl::display::Graphics _hx_tmp7 = shape->get_graphics();
HXDLIN(  95)		_hx_tmp6->copyFrom(_hx_tmp7);
