...
Dynamic FocusEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event FocusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  33)		HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->relatedObject,this->shiftKey,this->keyCode);
...
::String FocusEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  44)		return this->_hx___formatToString(HX_("FocusEvent",42,6d,d7,2e),::Array_obj< ::String >::fromData( _hx_array_data_0,6));
            	}
