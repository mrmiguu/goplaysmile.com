...
Dynamic ShaderPrecision_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic ShaderPrecision_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._ShaderPrecision.ShaderPrecision_Impl_","fromString",0xa4b5053a,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.fromString","openfl/display/ShaderPrecision.hx",11,0xf4519f71)
...
::String ShaderPrecision_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._ShaderPrecision.ShaderPrecision_Impl_","toString",0x9518c24b,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.toString","openfl/display/ShaderPrecision.hx",23,0xf4519f71)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._ShaderPrecision.ShaderPrecision_Impl_","boot",0xa4a67a51,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.boot","openfl/display/ShaderPrecision.hx",6,0xf4519f71)
HXLINE(   6)		FAST = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._ShaderPrecision.ShaderPrecision_Impl_","boot",0xa4a67a51,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.boot","openfl/display/ShaderPrecision.hx",7,0xf4519f71)
HXLINE(   7)		FULL = (int)1;
            	}
}
