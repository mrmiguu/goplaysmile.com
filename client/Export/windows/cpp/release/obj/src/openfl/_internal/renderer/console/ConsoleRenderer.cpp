...
void ConsoleRenderer_obj::__construct( ::openfl::display::Stage stage, ::lime::graphics::ConsoleRenderContext ctx){
            	HX_STACK_FRAME("openfl._internal.renderer.console.ConsoleRenderer","new",0x3dea677a,"openfl._internal.renderer.console.ConsoleRenderer.new","openfl/_internal/renderer/console/ConsoleRenderer.hx",1325,0xaf6bb8b6)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< ConsoleRenderer_obj > ConsoleRenderer_obj::__new( ::openfl::display::Stage stage, ::lime::graphics::ConsoleRenderContext ctx)
{
	...
	_hx_result->__construct(stage,ctx);
	return _hx_result;
}
...
void ConsoleRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.console.ConsoleRenderer","render",0xc9bac07c,"openfl._internal.renderer.console.ConsoleRenderer.render","openfl/_internal/renderer/console/ConsoleRenderer.hx",1334,0xaf6bb8b6)
            	HX_STACK_THIS(this)
            	}
