...
void GLShaderManager_obj::__construct( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLShaderManager","new",0xf3047071,"openfl._internal.renderer.opengl.GLShaderManager.new","openfl/_internal/renderer/opengl/GLShaderManager.hx",22,0xbe4c2a01)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gl,"gl")
HXLINE(  24)		super::__construct();
HXLINE(  26)		this->gl = gl;
HXLINE(  28)		this->defaultShader =  ::openfl::display::Shader_obj::__new(null());
...
void GLShaderManager_obj::setShader( ::openfl::display::Shader shader){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLShaderManager","setShader",0xc09db738,"openfl._internal.renderer.opengl.GLShaderManager.setShader","openfl/_internal/renderer/opengl/GLShaderManager.hx",35,0xbe4c2a01)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE(  37)		if (hx::IsEq( this->currentShader,shader )) {
HXLINE(  39)			Bool _hx_tmp = hx::IsNotNull( this->currentShader );
HXDLIN(  39)			if (_hx_tmp) {
HXLINE(  39)				this->currentShader->_hx___update();
            			}
HXLINE(  40)			return;
            		}
HXLINE(  44)		Bool _hx_tmp1 = hx::IsNotNull( this->currentShader );
HXDLIN(  44)		if (_hx_tmp1) {
HXLINE(  46)			this->currentShader->_hx___disable();
            		}
HXLINE(  50)		Bool _hx_tmp2 = hx::IsNull( shader );
...
HXLINE(  60)		Bool _hx_tmp3 = hx::IsNull( this->currentShader->gl );
