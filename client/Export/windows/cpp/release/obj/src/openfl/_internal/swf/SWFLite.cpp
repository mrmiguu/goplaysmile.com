...
HXLINE(  60)						return Dynamic( hx::TCast<  ::openfl::_internal::symbols::SpriteSymbol >::cast(symbol)->_hx___createObject(hx::ObjectPtr<OBJ_>(this))).StaticCast<  ::openfl::display::MovieClip >();
            					}
            				}
            			}
            			_hx_goto_0:;
...
{
{
            	HX_STACK_FRAME("openfl._internal.swf.SWFLite","boot",0xfcedeacc,"openfl._internal.swf.SWFLite.boot","openfl/_internal/swf/SWFLite.hx",22,0x035d4d2d)
HXLINE(  22)		instances =  ::haxe::ds::StringMap_obj::__new();
            	}
}
