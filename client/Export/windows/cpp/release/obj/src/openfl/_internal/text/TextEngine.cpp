...
void TextEngine_obj::__construct( ::openfl::text::TextField textField){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","new",0xcc80cb52,"openfl._internal.text.TextEngine.new","openfl/_internal/text/TextEngine.hx",126,0xdff93b7f)
            	HX_STACK_THIS(this)
...
HXLINE( 134)		this->bounds =  ::openfl::geom::Rectangle_obj::__new((int)0,(int)0,(int)0,(int)0);
...
HXDLIN( 152)		 ::openfl::_Vector::FloatVector _hx_tmp =  ::openfl::_Vector::FloatVector_obj::__new(length,fixed,null());
HXDLIN( 152)		this->lineAscents = _hx_tmp;
HXLINE( 153)		Int length1 = null();
HXDLIN( 153)		Bool fixed1 = null();
HXDLIN( 153)		 ::openfl::_Vector::IntVector _hx_tmp1 =  ::openfl::_Vector::IntVector_obj::__new(length1,fixed1,null());
HXDLIN( 153)		this->lineBreaks = _hx_tmp1;
HXLINE( 154)		Int length2 = null();
HXDLIN( 154)		Bool fixed2 = null();
HXDLIN( 154)		 ::openfl::_Vector::FloatVector _hx_tmp2 =  ::openfl::_Vector::FloatVector_obj::__new(length2,fixed2,null());
HXDLIN( 154)		this->lineDescents = _hx_tmp2;
HXLINE( 155)		Int length3 = null();
HXDLIN( 155)		Bool fixed3 = null();
HXDLIN( 155)		 ::openfl::_Vector::FloatVector _hx_tmp3 =  ::openfl::_Vector::FloatVector_obj::__new(length3,fixed3,null());
HXDLIN( 155)		this->lineLeadings = _hx_tmp3;
HXLINE( 156)		Int length4 = null();
HXDLIN( 156)		Bool fixed4 = null();
HXDLIN( 156)		 ::openfl::_Vector::FloatVector _hx_tmp4 =  ::openfl::_Vector::FloatVector_obj::__new(length4,fixed4,null());
HXDLIN( 156)		this->lineHeights = _hx_tmp4;
HXLINE( 157)		Int length5 = null();
HXDLIN( 157)		Bool fixed5 = null();
HXDLIN( 157)		 ::openfl::_Vector::FloatVector _hx_tmp5 =  ::openfl::_Vector::FloatVector_obj::__new(length5,fixed5,null());
HXDLIN( 157)		this->lineWidths = _hx_tmp5;
HXLINE( 158)		Int length6 = null();
HXDLIN( 158)		Bool fixed6 = null();
HXDLIN( 158)		 ::openfl::_Vector::ObjectVector _hx_tmp6 =  ::openfl::_Vector::ObjectVector_obj::__new(length6,fixed6,null());
HXDLIN( 158)		this->layoutGroups = _hx_tmp6;
HXLINE( 159)		Int length7 = null();
HXDLIN( 159)		Bool fixed7 = null();
HXDLIN( 159)		 ::openfl::_Vector::ObjectVector _hx_tmp7 =  ::openfl::_Vector::ObjectVector_obj::__new(length7,fixed7,null());
HXDLIN( 159)		this->textFormatRanges = _hx_tmp7;
            	}
...
void TextEngine_obj::getBounds(){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getBounds",0x5ce2cc1d,"openfl._internal.text.TextEngine.getBounds","openfl/_internal/text/TextEngine.hx",201,0xdff93b7f)
            	HX_STACK_THIS(this)
...
::String TextEngine_obj::getLine(Int index){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getLine",0xf060239c,"openfl._internal.text.TextEngine.getLine","openfl/_internal/text/TextEngine.hx",475,0xdff93b7f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 477)		Bool _hx_tmp;
HXDLIN( 477)		if ((index >= (int)0)) {
HXLINE( 477)			Int _hx_tmp1 = this->lineBreaks->get_length();
HXDLIN( 477)			_hx_tmp = (index > (_hx_tmp1 + (int)1));
            		}
            		else {
...
HXLINE( 483)		Int _hx_tmp2 = this->lineBreaks->get_length();
HXDLIN( 483)		if ((_hx_tmp2 == (int)0)) {
HXLINE( 485)			return this->text;
            		}
            		else {
HXLINE( 489)			Int _hx_tmp3;
HXDLIN( 489)			if ((index > (int)0)) {
HXLINE( 489)				_hx_tmp3 = this->lineBreaks->get((index - (int)1));
            			}
            			else {
HXLINE( 489)				_hx_tmp3 = (int)0;
            			}
HXDLIN( 489)			return this->text.substring(_hx_tmp3,this->lineBreaks->get(index));
            		}
...
Int startIndex = __o_startIndex.Default(0);
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getLineBreakIndex",0x0741948f,"openfl._internal.text.TextEngine.getLineBreakIndex","openfl/_internal/text/TextEngine.hx",496,0xdff93b7f)
            	HX_STACK_THIS(this)
...
void TextEngine_obj::getLineMeasurements(){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getLineMeasurements",0x203f1eb3,"openfl._internal.text.TextEngine.getLineMeasurements","openfl/_internal/text/TextEngine.hx",509,0xdff93b7f)
            	HX_STACK_THIS(this)
...
HXDLIN( 529)			while(true){
HXLINE( 529)				Int _hx_tmp = _g1->get_length();
HXDLIN( 529)				if (!((_g < _hx_tmp))) {
HXLINE( 529)					goto _hx_goto_0;
            				}
HXDLIN( 529)				HX_VARI(  ::openfl::_internal::text::TextLayoutGroup,group) = _g1->get(_g).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >();
HXDLIN( 529)				++_g;
...
HXLINE( 535)					Float _hx_tmp1;
HXDLIN( 535)					Bool _hx_tmp2 = hx::IsNotNull( currentLineLeading );
HXDLIN( 535)					if (_hx_tmp2) {
HXLINE( 535)						_hx_tmp1 = currentLineLeading;
            					}
            					else {
HXLINE( 535)						_hx_tmp1 = (int)0;
            					}
HXDLIN( 535)					this->lineLeadings->push(_hx_tmp1);
...
HXLINE( 547)					Bool _hx_tmp3 = (this->textHeight <= (this->height - (int)2));
...
HXLINE( 558)				Bool _hx_tmp4 = hx::IsNull( currentLineLeading );
HXDLIN( 558)				if (_hx_tmp4) {
HXLINE( 560)					currentLineLeading = group->leading;
            				}
            				else {
HXLINE( 564)					Float _hx_tmp5 = ::Math_obj::max(currentLineLeading,group->leading);
HXDLIN( 564)					currentLineLeading = ::Std_obj::_hx_int(_hx_tmp5);
            				}
...
HXLINE( 571)				Bool _hx_tmp6 = (currentLineWidth > this->textWidth);
HXDLIN( 571)				if (_hx_tmp6) {
HXLINE( 573)					this->textWidth = currentLineWidth;
            				}
HXLINE( 577)				Float _hx_tmp7 = ((group->offsetY - (int)2) + group->ascent);
HXDLIN( 577)				this->textHeight = (_hx_tmp7 + group->descent);
            			}
            			_hx_goto_0:;
            		}
HXLINE( 581)		this->lineAscents->push(currentLineAscent);
HXLINE( 582)		this->lineDescents->push(currentLineDescent);
HXLINE( 583)		Float _hx_tmp8;
HXDLIN( 583)		Bool _hx_tmp9 = hx::IsNotNull( currentLineLeading );
HXDLIN( 583)		if (_hx_tmp9) {
HXLINE( 583)			_hx_tmp8 = currentLineLeading;
            		}
            		else {
HXLINE( 583)			_hx_tmp8 = (int)0;
            		}
HXDLIN( 583)		this->lineLeadings->push(_hx_tmp8);
HXLINE( 584)		this->lineHeights->push(currentLineHeight);
HXLINE( 585)		this->lineWidths->push(currentLineWidth);
HXLINE( 587)		Bool _hx_tmp10 = (this->numLines == (int)1);
HXDLIN( 587)		if (_hx_tmp10) {
HXLINE( 589)			this->bottomScrollV = (int)1;
HXLINE( 591)			if (hx::IsGreater( currentLineLeading,(int)0 )) {
HXLINE( 593)				hx::AddEq(this->textHeight,currentLineLeading);
            			}
            		}
            		else {
HXLINE( 597)			Bool _hx_tmp11 = (this->textHeight <= (this->height - (int)2));
HXDLIN( 597)			if (_hx_tmp11) {
HXLINE( 599)				this->bottomScrollV++;
            			}
            		}
HXLINE( 603)		Bool _hx_tmp12 = hx::IsNotEq( this->autoSize,(int)2 );
HXDLIN( 603)		if (_hx_tmp12) {
HXLINE( 605)			HX_VARI_NAME(  ::Dynamic,_g2,"_g") = this->autoSize;
HXDLIN( 605)			 ::Dynamic _hx_switch_0 = _g2;
            			if (  (_hx_switch_0==(int)0) ||  (_hx_switch_0==(int)1) ||  (_hx_switch_0==(int)3) ){
HXLINE( 609)				Bool _hx_tmp13 = !(this->wordWrap);
HXDLIN( 609)				if (_hx_tmp13) {
...
HXLINE( 625)		Bool _hx_tmp14 = (this->textWidth > (this->width - (int)4));
HXDLIN( 625)		if (_hx_tmp14) {
HXLINE( 627)			Float _hx_tmp15 = ((this->textWidth - this->width) + (int)4);
HXDLIN( 627)			this->maxScrollH = ::Std_obj::_hx_int(_hx_tmp15);
            		}
            		else {
HXLINE( 631)			this->maxScrollH = (int)0;
            		}
HXLINE( 635)		Int _hx_tmp16 = (this->numLines - this->bottomScrollV);
HXDLIN( 635)		this->maxScrollV = (_hx_tmp16 + (int)1);
            	}
...
void TextEngine_obj::getLayoutGroups(){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getLayoutGroups",0xa3099646,"openfl._internal.text.TextEngine.getLayoutGroups","openfl/_internal/text/TextEngine.hx",640,0xdff93b7f)
            	HX_STACK_THIS(this)
...
HXLINE( 841)		Int _hx_tmp = _gthis->textFormatRanges->get_length();
HXDLIN( 841)		if (((int)-1 < (_hx_tmp - (int)1))) {
HXLINE( 841)			rangeIndex = (int)0;
HXDLIN( 841)			formatRange = _gthis->textFormatRanges->get((int)0).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
...
HXDLIN( 841)			Bool _hx_tmp1 = hx::IsNotNull( font );
HXDLIN( 841)			if (_hx_tmp1) {
HXLINE( 841)				Int _hx_tmp2 = font->get_ascender();
HXDLIN( 841)				Int _hx_tmp3 = font->get_unitsPerEM();
HXDLIN( 841)				ascent = (((Float)_hx_tmp2 / (Float)_hx_tmp3) * currentFormat->size);
HXDLIN( 841)				Int _hx_tmp4 = font->get_descender();
HXDLIN( 841)				Int _hx_tmp5 = font->get_unitsPerEM();
HXDLIN( 841)				Float _hx_tmp6 = (((Float)_hx_tmp4 / (Float)_hx_tmp5) * currentFormat->size);
HXDLIN( 841)				descent = ::Math_obj::abs(_hx_tmp6);
...
HXLINE( 850)			Bool _hx_tmp7;
HXDLIN( 850)			Bool _hx_tmp8;
HXDLIN( 850)			if ((breakIndex > (int)-1)) {
HXLINE( 850)				if ((spaceIndex != (int)-1)) {
HXLINE( 850)					_hx_tmp8 = (breakIndex < spaceIndex);
            				}
            				else {
HXLINE( 850)					_hx_tmp8 = true;
            				}
            			}
            			else {
...
HXLINE( 850)				_hx_tmp7 = (formatRange->end >= breakIndex);
            			}
            			else {
HXLINE( 850)				_hx_tmp7 = false;
            			}
HXDLIN( 850)			if (_hx_tmp7) {
HXLINE( 852)				layoutGroup =  ::openfl::_internal::text::TextLayoutGroup_obj::__new(formatRange->format,textIndex,breakIndex);
HXLINE( 853)				HX_VARI_NAME( ::Array< Float >,advances1,"advances") = ::Array_obj< Float >::__new(0);
HXDLIN( 853)				Bool _hx_tmp9 = hx::IsNull( _gthis->_hx___textLayout );
HXDLIN( 853)				if (_hx_tmp9) {
HXLINE( 853)					_gthis->_hx___textLayout =  ::lime::text::TextLayout_obj::__new(null(),null(),null(),null(),null(),null());
            				}
HXDLIN( 853)				_gthis->_hx___textLayout->set_text(null());
HXDLIN( 853)				_gthis->_hx___textLayout->set_font(font);
HXDLIN( 853)				Bool _hx_tmp10 = hx::IsNotNull( formatRange->format->size );
HXDLIN( 853)				if (_hx_tmp10) {
HXLINE( 853)					_gthis->_hx___textLayout->set_size(formatRange->format->size);
            				}
HXDLIN( 853)				::String _hx_tmp11 = this->text.substring(textIndex,breakIndex);
HXDLIN( 853)				_gthis->_hx___textLayout->set_text(_hx_tmp11);
HXDLIN( 853)				{
...
HXDLIN( 860)						++_g2;
HXDLIN( 860)						hx::AddEq(width,advance);
            					}
            				}
HXDLIN( 860)				layoutGroup->width = width;
HXLINE( 861)				layoutGroup->height = heightValue;
HXLINE( 862)				this->layoutGroups->push(layoutGroup);
HXLINE( 864)				hx::AddEq(offsetY,heightValue);
HXLINE( 865)				offsetX = (int)2;
HXLINE( 867)				Bool _hx_tmp12 = (formatRange->end == breakIndex);
HXDLIN( 867)				if (_hx_tmp12) {
HXLINE( 869)					Int _hx_tmp13 = _gthis->textFormatRanges->get_length();
HXDLIN( 869)					if ((rangeIndex < (_hx_tmp13 - (int)1))) {
HXLINE( 869)						++rangeIndex;
HXDLIN( 869)						formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
...
HXDLIN( 869)						Bool _hx_tmp14 = hx::IsNotNull( font );
HXDLIN( 869)						if (_hx_tmp14) {
HXLINE( 869)							Int _hx_tmp15 = font->get_ascender();
HXDLIN( 869)							Int _hx_tmp16 = font->get_unitsPerEM();
HXDLIN( 869)							ascent = (((Float)_hx_tmp15 / (Float)_hx_tmp16) * currentFormat->size);
HXDLIN( 869)							Int _hx_tmp17 = font->get_descender();
HXDLIN( 869)							Int _hx_tmp18 = font->get_unitsPerEM();
HXDLIN( 869)							Float _hx_tmp19 = (((Float)_hx_tmp17 / (Float)_hx_tmp18) * currentFormat->size);
HXDLIN( 869)							descent = ::Math_obj::abs(_hx_tmp19);
...
HXLINE( 877)				++lineIndex;
HXLINE( 878)				layoutGroup = null();
            			}
            			else {
HXLINE( 880)				Bool _hx_tmp20;
HXDLIN( 880)				Bool _hx_tmp21;
HXDLIN( 880)				if ((formatRange->end >= spaceIndex)) {
HXLINE( 880)					_hx_tmp21 = (spaceIndex > (int)-1);
            				}
            				else {
HXLINE( 880)					_hx_tmp21 = false;
            				}
HXDLIN( 880)				if (_hx_tmp21) {
HXLINE( 880)					_hx_tmp20 = (textIndex < formatRange->end);
            				}
            				else {
HXLINE( 880)					_hx_tmp20 = false;
            				}
HXDLIN( 880)				if (_hx_tmp20) {
HXLINE( 882)					Bool _hx_tmp22;
HXDLIN( 882)					Bool _hx_tmp23;
HXDLIN( 882)					Bool _hx_tmp24;
HXDLIN( 882)					Bool _hx_tmp25;
HXDLIN( 882)					Bool _hx_tmp26 = hx::IsNotNull( layoutGroup );
HXDLIN( 882)					if (_hx_tmp26) {
HXLINE( 882)						_hx_tmp25 = (previousSpaceIndex != previousBreakIndex);
            					}
            					else {
HXLINE( 882)						_hx_tmp25 = false;
            					}
HXDLIN( 882)					if (_hx_tmp25) {
HXLINE( 882)						_hx_tmp24 = (previousSpaceIndex == (textIndex - (int)1));
            					}
            					else {
HXLINE( 882)						_hx_tmp24 = false;
            					}
HXDLIN( 882)					if (_hx_tmp24) {
HXLINE( 882)						_hx_tmp23 = (textIndex == formatRange->start);
            					}
            					else {
HXLINE( 882)						_hx_tmp23 = false;
            					}
HXDLIN( 882)					if (_hx_tmp23) {
HXLINE( 882)						_hx_tmp22 = (spaceIndex <= formatRange->end);
            					}
            					else {
HXLINE( 882)						_hx_tmp22 = false;
            					}
HXDLIN( 882)					if (_hx_tmp22) {
HXLINE( 885)						layoutGroup->endIndex = textIndex;
HXLINE( 886)						Int _hx_tmp27 = (layoutGroup->advances->length - (int)1);
HXDLIN( 886)						hx::AddEq(layoutGroup->width,layoutGroup->advances->__get(_hx_tmp27));
            					}
HXLINE( 889)					layoutGroup = null();
HXLINE( 890)					wrap = false;
HXLINE( 892)					while((textIndex != formatRange->end)){
HXLINE( 895)						Bool _hx_tmp28 = (spaceIndex == (int)-1);
HXDLIN( 895)						if (_hx_tmp28) {
HXLINE( 895)							spaceIndex = formatRange->end;
            						}
HXLINE( 897)						HX_VARI_NAME( ::Array< Float >,advances3,"advances") = ::Array_obj< Float >::__new(0);
HXDLIN( 897)						Bool _hx_tmp29 = hx::IsNull( _gthis->_hx___textLayout );
HXDLIN( 897)						if (_hx_tmp29) {
HXLINE( 897)							_gthis->_hx___textLayout =  ::lime::text::TextLayout_obj::__new(null(),null(),null(),null(),null(),null());
            						}
HXDLIN( 897)						_gthis->_hx___textLayout->set_text(null());
HXDLIN( 897)						_gthis->_hx___textLayout->set_font(font);
HXDLIN( 897)						Bool _hx_tmp30 = hx::IsNotNull( formatRange->format->size );
HXDLIN( 897)						if (_hx_tmp30) {
HXLINE( 897)							_gthis->_hx___textLayout->set_size(formatRange->format->size);
            						}
HXDLIN( 897)						::String _hx_tmp31 = this->text.substring(textIndex,(spaceIndex + (int)1));
HXDLIN( 897)						_gthis->_hx___textLayout->set_text(_hx_tmp31);
HXDLIN( 897)						{
...
HXDLIN( 899)								++_g4;
HXDLIN( 899)								hx::AddEq(width1,advance1);
            							}
            						}
...
HXLINE( 911)						if (wrap) {
HXLINE( 913)							hx::AddEq(offsetY,heightValue);
HXLINE( 915)							Int _hx_tmp32 = this->layoutGroups->get_length();
HXDLIN( 915)							HX_VARI( Int,i) = (_hx_tmp32 - (int)1);
...
HXLINE( 922)								Bool _hx_tmp33;
HXDLIN( 922)								if ((i > (int)0)) {
HXLINE( 922)									_hx_tmp33 = (layoutGroup->startIndex > previousSpaceIndex);
            								}
            								else {
HXLINE( 922)									_hx_tmp33 = false;
            								}
HXDLIN( 922)								if (_hx_tmp33) {
HXLINE( 924)									++offsetCount;
            								}
            								else {
HXLINE( 928)									goto _hx_goto_9;
            								}
HXLINE( 932)								--i;
            							}
            							_hx_goto_9:;
HXLINE( 936)							++lineIndex;
HXLINE( 938)							offsetX = (int)2;
HXLINE( 940)							if ((offsetCount > (int)0)) {
HXLINE( 942)								Int _hx_tmp34 = this->layoutGroups->get_length();
HXDLIN( 942)								 ::openfl::_internal::text::TextLayoutGroup _hx_tmp35 = this->layoutGroups->get((_hx_tmp34 - offsetCount)).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >();
HXDLIN( 942)								HX_VARI( Float,bumpX) = _hx_tmp35->offsetX;
HXLINE( 944)								{
HXLINE( 944)									Int _hx_tmp36 = this->layoutGroups->get_length();
HXDLIN( 944)									HX_VARI_NAME( Int,_g12,"_g1") = (_hx_tmp36 - offsetCount);
HXDLIN( 944)									HX_VARI_NAME( Int,_g5,"_g") = this->layoutGroups->get_length();
HXDLIN( 944)									while((_g12 < _g5)){
HXLINE( 944)										HX_VARI_NAME( Int,i1,"i") = _g12++;
HXLINE( 946)										layoutGroup = this->layoutGroups->get(i1).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >();
HXLINE( 947)										hx::SubEq(layoutGroup->offsetX,bumpX);
HXLINE( 948)										layoutGroup->offsetY = offsetY;
HXLINE( 949)										layoutGroup->lineIndex = lineIndex;
HXLINE( 950)										hx::AddEq(offsetX,layoutGroup->width);
            									}
            								}
            							}
HXLINE( 956)							layoutGroup =  ::openfl::_internal::text::TextLayoutGroup_obj::__new(formatRange->format,textIndex,spaceIndex);
...
HXLINE( 975)							Bool _hx_tmp37;
HXDLIN( 975)							if ((formatRange->start == previousSpaceIndex)) {
HXLINE( 975)								_hx_tmp37 = ((textIndex - (int)1) == previousSpaceIndex);
            							}
            							else {
HXLINE( 975)								_hx_tmp37 = false;
            							}
HXDLIN( 975)							if (_hx_tmp37) {
HXLINE( 978)								HX_VARI_NAME( ::Array< Float >,advances4,"advances") = ::Array_obj< Float >::__new(0);
HXDLIN( 978)								Bool _hx_tmp38 = hx::IsNull( _gthis->_hx___textLayout );
HXDLIN( 978)								if (_hx_tmp38) {
HXLINE( 978)									_gthis->_hx___textLayout =  ::lime::text::TextLayout_obj::__new(null(),null(),null(),null(),null(),null());
            								}
HXDLIN( 978)								_gthis->_hx___textLayout->set_text(null());
HXDLIN( 978)								_gthis->_hx___textLayout->set_font(font);
HXDLIN( 978)								Bool _hx_tmp39 = hx::IsNotNull( formatRange->format->size );
HXDLIN( 978)								if (_hx_tmp39) {
HXLINE( 978)									_gthis->_hx___textLayout->set_size(formatRange->format->size);
            								}
HXDLIN( 978)								::String _hx_tmp40 = this->text.substring(previousSpaceIndex,textIndex);
HXDLIN( 978)								_gthis->_hx___textLayout->set_text(_hx_tmp40);
HXDLIN( 978)								{
...
HXLINE( 979)								hx::AddEq(widthValue,advances->__get((int)0));
HXLINE( 980)								hx::SubEq(offsetX,advances->__get((int)0));
HXLINE( 982)								textIndex = previousSpaceIndex;
            							}
HXLINE( 986)							Bool _hx_tmp41;
HXDLIN( 986)							Bool _hx_tmp42 = hx::IsNotNull( layoutGroup );
HXDLIN( 986)							if (_hx_tmp42) {
HXLINE( 986)								_hx_tmp41 = (textIndex == spaceIndex);
            							}
            							else {
HXLINE( 986)								_hx_tmp41 = false;
            							}
HXDLIN( 986)							if (_hx_tmp41) {
HXLINE( 988)								Bool _hx_tmp43 = hx::IsNotEq( formatRange->format->align,(int)2 );
HXDLIN( 988)								if (_hx_tmp43) {
HXLINE( 990)									layoutGroup->endIndex = spaceIndex;
            								}
HXLINE( 994)								hx::AddEq(marginRight,spaceWidth);
            							}
            							else {
HXLINE( 996)								Bool _hx_tmp44;
HXDLIN( 996)								Bool _hx_tmp45 = hx::IsNotNull( layoutGroup );
HXDLIN( 996)								if (_hx_tmp45) {
HXLINE( 996)									_hx_tmp44 = hx::IsEq( lineFormat->align,(int)2 );
            								}
            								else {
HXLINE( 996)									_hx_tmp44 = true;
            								}
HXDLIN( 996)								if (_hx_tmp44) {
HXLINE( 998)									layoutGroup =  ::openfl::_internal::text::TextLayoutGroup_obj::__new(formatRange->format,textIndex,spaceIndex);
...
HXDLIN(1018)											++_g7;
HXDLIN(1018)											hx::AddEq(width2,advance2);
            										}
            									}
...
HXLINE(1025)							hx::AddEq(offsetX,(widthValue + spaceWidth));
            						}
...
HXLINE(1036)						Bool _hx_tmp46;
HXDLIN(1036)						Bool _hx_tmp47;
HXDLIN(1036)						if ((previousSpaceIndex != breakIndex)) {
HXLINE(1036)							_hx_tmp47 = (breakIndex > (int)-1);
            						}
            						else {
HXLINE(1036)							_hx_tmp47 = false;
            						}
HXDLIN(1036)						if (_hx_tmp47) {
HXLINE(1036)							if ((nextSpaceIndex != (int)-1)) {
HXLINE(1036)								_hx_tmp46 = (nextSpaceIndex > breakIndex);
            							}
            							else {
HXLINE(1036)								_hx_tmp46 = true;
            							}
            						}
            						else {
HXLINE(1036)							_hx_tmp46 = false;
            						}
HXDLIN(1036)						if (_hx_tmp46) {
...
HXLINE(1052)						Bool _hx_tmp48 = (formatRange->end <= previousSpaceIndex);
HXDLIN(1052)						if (_hx_tmp48) {
HXLINE(1054)							layoutGroup = null();
HXLINE(1055)							Int _hx_tmp49 = _gthis->textFormatRanges->get_length();
HXDLIN(1055)							if ((rangeIndex < (_hx_tmp49 - (int)1))) {
HXLINE(1055)								++rangeIndex;
HXDLIN(1055)								formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
...
HXDLIN(1055)								Bool _hx_tmp50 = hx::IsNotNull( font );
HXDLIN(1055)								if (_hx_tmp50) {
HXLINE(1055)									Int _hx_tmp51 = font->get_ascender();
HXDLIN(1055)									Int _hx_tmp52 = font->get_unitsPerEM();
HXDLIN(1055)									ascent = (((Float)_hx_tmp51 / (Float)_hx_tmp52) * currentFormat->size);
HXDLIN(1055)									Int _hx_tmp53 = font->get_descender();
HXDLIN(1055)									Int _hx_tmp54 = font->get_unitsPerEM();
HXDLIN(1055)									Float _hx_tmp55 = (((Float)_hx_tmp53 / (Float)_hx_tmp54) * currentFormat->size);
HXDLIN(1055)									descent = ::Math_obj::abs(_hx_tmp55);
...
HXLINE(1059)						Bool _hx_tmp56;
HXDLIN(1059)						Bool _hx_tmp57;
HXDLIN(1059)						Bool _hx_tmp58;
HXDLIN(1059)						Bool _hx_tmp59;
HXDLIN(1059)						if ((spaceIndex > breakIndex)) {
HXLINE(1059)							_hx_tmp59 = (breakIndex > (int)-1);
            						}
            						else {
HXLINE(1059)							_hx_tmp59 = false;
            						}
HXDLIN(1059)						if (!(_hx_tmp59)) {
HXLINE(1059)							_hx_tmp58 = (textIndex > this->text.length);
            						}
            						else {
HXLINE(1059)							_hx_tmp58 = true;
            						}
HXDLIN(1059)						if (!(_hx_tmp58)) {
HXLINE(1059)							_hx_tmp57 = (spaceIndex > formatRange->end);
            						}
            						else {
HXLINE(1059)							_hx_tmp57 = true;
            						}
HXDLIN(1059)						if (!(_hx_tmp57)) {
HXLINE(1059)							if ((spaceIndex == (int)-1)) {
HXLINE(1059)								_hx_tmp56 = (breakIndex > (int)-1);
            							}
            							else {
HXLINE(1059)								_hx_tmp56 = false;
            							}
            						}
            						else {
HXLINE(1059)							_hx_tmp56 = true;
            						}
HXDLIN(1059)						if (_hx_tmp56) {
HXLINE(1061)							goto _hx_goto_6;
            						}
            					}
            					_hx_goto_6:;
            				}
            				else {
HXLINE(1069)					Bool _hx_tmp60 = (textIndex > formatRange->end);
HXDLIN(1069)					if (_hx_tmp60) {
HXLINE(1071)						goto _hx_goto_3;
            					}
            					else {
HXLINE(1073)						Bool _hx_tmp61;
HXDLIN(1073)						if ((textIndex >= formatRange->end)) {
HXLINE(1073)							_hx_tmp61 = (textIndex == this->text.length);
            						}
            						else {
HXLINE(1073)							_hx_tmp61 = true;
            						}
HXDLIN(1073)						if (_hx_tmp61) {
HXLINE(1075)							Bool _hx_tmp62 = hx::IsNull( layoutGroup );
HXDLIN(1075)							if (_hx_tmp62) {
HXLINE(1077)								layoutGroup =  ::openfl::_internal::text::TextLayoutGroup_obj::__new(formatRange->format,textIndex,formatRange->end);
HXLINE(1078)								Int endIndex = formatRange->end;
HXDLIN(1078)								HX_VARI_NAME( ::Array< Float >,advances6,"advances") = ::Array_obj< Float >::__new(0);
HXDLIN(1078)								Bool _hx_tmp63 = hx::IsNull( _gthis->_hx___textLayout );
HXDLIN(1078)								if (_hx_tmp63) {
HXLINE(1078)									_gthis->_hx___textLayout =  ::lime::text::TextLayout_obj::__new(null(),null(),null(),null(),null(),null());
            								}
HXDLIN(1078)								_gthis->_hx___textLayout->set_text(null());
HXDLIN(1078)								_gthis->_hx___textLayout->set_font(font);
HXDLIN(1078)								Bool _hx_tmp64 = hx::IsNotNull( formatRange->format->size );
HXDLIN(1078)								if (_hx_tmp64) {
HXLINE(1078)									_gthis->_hx___textLayout->set_size(formatRange->format->size);
            								}
HXDLIN(1078)								::String _hx_tmp65 = this->text.substring(textIndex,endIndex);
HXDLIN(1078)								_gthis->_hx___textLayout->set_text(_hx_tmp65);
HXDLIN(1078)								{
...
HXDLIN(1085)										++_g9;
HXDLIN(1085)										hx::AddEq(width3,advance3);
            									}
            								}
...
HXLINE(1089)								hx::AddEq(offsetX,layoutGroup->width);
            							}
            							else {
HXLINE(1091)								Bool _hx_tmp66 = (layoutGroup->startIndex != layoutGroup->endIndex);
HXDLIN(1091)								if (_hx_tmp66) {
HXLINE(1093)									Int endIndex1 = formatRange->end;
HXDLIN(1093)									HX_VARI_NAME( ::Array< Float >,advances8,"advances") = ::Array_obj< Float >::__new(0);
HXDLIN(1093)									Bool _hx_tmp67 = hx::IsNull( _gthis->_hx___textLayout );
HXDLIN(1093)									if (_hx_tmp67) {
HXLINE(1093)										_gthis->_hx___textLayout =  ::lime::text::TextLayout_obj::__new(null(),null(),null(),null(),null(),null());
            									}
HXDLIN(1093)									_gthis->_hx___textLayout->set_text(null());
HXDLIN(1093)									_gthis->_hx___textLayout->set_font(font);
HXDLIN(1093)									Bool _hx_tmp68 = hx::IsNotNull( formatRange->format->size );
HXDLIN(1093)									if (_hx_tmp68) {
HXLINE(1093)										_gthis->_hx___textLayout->set_size(formatRange->format->size);
            									}
HXDLIN(1093)									::String _hx_tmp69 = this->text.substring(textIndex,endIndex1);
HXDLIN(1093)									_gthis->_hx___textLayout->set_text(_hx_tmp69);
HXDLIN(1093)									{
...
HXDLIN(1094)											++_g16;
HXDLIN(1094)											hx::AddEq(width4,advance4);
            										}
            									}
HXDLIN(1094)									widthValue = width4;
HXLINE(1095)									layoutGroup->advances = layoutGroup->advances->concat(advances8);
HXLINE(1096)									hx::AddEq(layoutGroup->width,(marginRight + widthValue));
HXLINE(1097)									layoutGroup->endIndex = formatRange->end;
HXLINE(1099)									hx::AddEq(offsetX,widthValue);
            								}
            							}
HXLINE(1103)							textIndex = formatRange->end;
            						}
            					}
HXLINE(1107)					Int _hx_tmp70 = _gthis->textFormatRanges->get_length();
HXDLIN(1107)					if ((rangeIndex < (_hx_tmp70 - (int)1))) {
HXLINE(1107)						++rangeIndex;
HXDLIN(1107)						formatRange = _gthis->textFormatRanges->get(rangeIndex).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
...
HXDLIN(1107)						Bool _hx_tmp71 = hx::IsNotNull( font );
HXDLIN(1107)						if (_hx_tmp71) {
HXLINE(1107)							Int _hx_tmp72 = font->get_ascender();
HXDLIN(1107)							Int _hx_tmp73 = font->get_unitsPerEM();
HXDLIN(1107)							ascent = (((Float)_hx_tmp72 / (Float)_hx_tmp73) * currentFormat->size);
HXDLIN(1107)							Int _hx_tmp74 = font->get_descender();
HXDLIN(1107)							Int _hx_tmp75 = font->get_unitsPerEM();
HXDLIN(1107)							Float _hx_tmp76 = (((Float)_hx_tmp74 / (Float)_hx_tmp75) * currentFormat->size);
HXDLIN(1107)							descent = ::Math_obj::abs(_hx_tmp76);
...
void TextEngine_obj::setTextAlignment(){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","setTextAlignment",0xb5caa542,"openfl._internal.text.TextEngine.setTextAlignment","openfl/_internal/text/TextEngine.hx",1123,0xdff93b7f)
            	HX_STACK_THIS(this)
...
HXLINE(1129)				HX_VARI( Int,i) = _g1++;
HXLINE(1131)				group = this->layoutGroups->get(i).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >();
HXLINE(1133)				Bool _hx_tmp = (group->lineIndex != lineIndex);
HXDLIN(1133)				if (_hx_tmp) {
HXLINE(1135)					lineIndex = group->lineIndex;
HXLINE(1137)					{
HXLINE(1137)						HX_VARI(  ::Dynamic,_g2) = group->format->align;
HXDLIN(1137)						 ::Dynamic _hx_switch_0 = _g2;
            						if (  (_hx_switch_0==(int)0) ){
HXLINE(1141)							Float _hx_tmp1 = (this->width - (int)4);
HXDLIN(1141)							Bool _hx_tmp2 = (this->lineWidths->get(lineIndex) < _hx_tmp1);
HXDLIN(1141)							if (_hx_tmp2) {
HXLINE(1143)								Float _hx_tmp3 = (this->width - (int)4);
HXDLIN(1143)								Float _hx_tmp4 = (_hx_tmp3 - this->lineWidths->get(lineIndex));
HXDLIN(1143)								offsetX = ::Math_obj::round(((Float)_hx_tmp4 / (Float)(int)2));
            							}
            							else {
HXLINE(1147)								offsetX = (int)0;
            							}
HXLINE(1141)							goto _hx_goto_18;
            						}
            						if (  (_hx_switch_0==(int)2) ){
HXLINE(1165)							Float _hx_tmp5 = (this->width - (int)4);
HXDLIN(1165)							Bool _hx_tmp6 = (this->lineWidths->get(lineIndex) < _hx_tmp5);
HXDLIN(1165)							if (_hx_tmp6) {
HXLINE(1167)								lineLength = (int)1;
HXLINE(1169)								{
HXLINE(1169)									HX_VARI( Int,_g3) = (i + (int)1);
HXDLIN(1169)									HX_VARI_NAME( Int,_g21,"_g2") = this->layoutGroups->get_length();
HXDLIN(1169)									while((_g3 < _g21)){
HXLINE(1169)										HX_VARI( Int,j) = _g3++;
HXLINE(1171)										Bool _hx_tmp7 = (this->layoutGroups->get(j).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >()->lineIndex == lineIndex);
HXDLIN(1171)										if (_hx_tmp7) {
HXLINE(1173)											++lineLength;
            										}
            										else {
HXLINE(1177)											goto _hx_goto_19;
            										}
            									}
            									_hx_goto_19:;
            								}
HXLINE(1183)								if ((lineLength > (int)1)) {
HXLINE(1185)									group = this->layoutGroups->get(((i + lineLength) - (int)1)).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >();
HXLINE(1187)									HX_VARI( ::String,endChar) = this->text.charAt(group->endIndex);
HXLINE(1188)									Bool _hx_tmp8;
HXDLIN(1188)									Bool _hx_tmp9;
HXDLIN(1188)									if ((group->endIndex < this->text.length)) {
HXLINE(1188)										_hx_tmp9 = (endChar != HX_("\n",0a,00,00,00));
            									}
            									else {
HXLINE(1188)										_hx_tmp9 = false;
            									}
HXDLIN(1188)									if (_hx_tmp9) {
HXLINE(1188)										_hx_tmp8 = (endChar != HX_("\r",0d,00,00,00));
            									}
            									else {
HXLINE(1188)										_hx_tmp8 = false;
            									}
HXDLIN(1188)									if (_hx_tmp8) {
HXLINE(1190)										Float _hx_tmp10 = (this->width - (int)4);
HXDLIN(1190)										Float _hx_tmp11 = (_hx_tmp10 - this->lineWidths->get(lineIndex));
HXDLIN(1190)										offsetX = ((Float)_hx_tmp11 / (Float)(lineLength - (int)1));
HXLINE(1192)										{
HXLINE(1192)											HX_VARI_NAME( Int,_g31,"_g3") = (int)1;
HXDLIN(1192)											HX_VARI_NAME( Int,_g22,"_g2") = lineLength;
HXDLIN(1192)											while((_g31 < _g22)){
HXLINE(1192)												HX_VARI_NAME( Int,j1,"j") = _g31++;
HXLINE(1194)												hx::AddEq(this->layoutGroups->get((i + j1)).StaticCast<  ::openfl::_internal::text::TextLayoutGroup >()->offsetX,(offsetX * j1));
            											}
            										}
            									}
            								}
...
HXLINE(1163)							goto _hx_goto_18;
            						}
            						if (  (_hx_switch_0==(int)4) ){
HXLINE(1153)							Float _hx_tmp12 = (this->width - (int)4);
HXDLIN(1153)							Bool _hx_tmp13 = (this->lineWidths->get(lineIndex) < _hx_tmp12);
HXDLIN(1153)							if (_hx_tmp13) {
HXLINE(1155)								Float _hx_tmp14 = (this->width - (int)4);
HXDLIN(1155)								Float _hx_tmp15 = (_hx_tmp14 - this->lineWidths->get(lineIndex));
HXDLIN(1155)								offsetX = ::Math_obj::round(_hx_tmp15);
            							}
            							else {
HXLINE(1159)								offsetX = (int)0;
            							}
HXLINE(1153)							goto _hx_goto_18;
            						}
            						/* default */{
...
HXLINE(1216)					hx::AddEq(group->offsetX,offsetX);
            				}
            			}
            		}
            	}
...
void TextEngine_obj::update(){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","update",0x7da66e57,"openfl._internal.text.TextEngine.update","openfl/_internal/text/TextEngine.hx",1225,0xdff93b7f)
            	HX_STACK_THIS(this)
HXLINE(1227)		Bool _hx_tmp;
HXDLIN(1227)		Bool _hx_tmp1;
HXDLIN(1227)		Bool _hx_tmp2 = hx::IsNotNull( this->text );
HXDLIN(1227)		if (_hx_tmp2) {
HXLINE(1227)			Bool _hx_tmp3 = !(this->multiline);
HXDLIN(1227)			if (_hx_tmp3) {
HXLINE(1227)				::String _hx_tmp4 = ::StringTools_obj::trim(this->text);
HXDLIN(1227)				_hx_tmp1 = (_hx_tmp4 == HX_("",00,00,00,00));
            			}
            			else {
...
HXLINE(1227)			Int _hx_tmp5 = this->textFormatRanges->get_length();
HXDLIN(1227)			_hx_tmp = (_hx_tmp5 == (int)0);
            		}
            		else {
...
Int TextEngine_obj::UTF8_HYPHEN;
 ...
 ::openfl::text::Font TextEngine_obj::findFont(::String name){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","findFont",0x253a8276,"openfl._internal.text.TextEngine.findFont","openfl/_internal/text/TextEngine.hx",169,0xdff93b7f)
...
HXDLIN( 173)				++_g;
HXLINE( 175)				Bool _hx_tmp = hx::IsNull( registeredFont );
HXDLIN( 175)				if (_hx_tmp) {
HXLINE( 175)					continue;
            				}
HXLINE( 177)				Bool _hx_tmp1;
HXDLIN( 177)				if ((registeredFont->name != name)) {
HXLINE( 177)					Bool _hx_tmp2 = hx::IsNotNull( registeredFont->_hx___fontPath );
HXDLIN( 177)					if (_hx_tmp2) {
HXLINE( 177)						if ((registeredFont->_hx___fontPath != name)) {
HXLINE( 177)							_hx_tmp1 = (registeredFont->_hx___fontPathWithoutDirectory == name);
            						}
            						else {
...
HXLINE( 187)		Bool _hx_tmp3 = hx::IsNotNull( font );
...
Float TextEngine_obj::getFormatHeight( ::openfl::text::TextFormat format){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getFormatHeight",0xaafdc226,"openfl._internal.text.TextEngine.getFormatHeight","openfl/_internal/text/TextEngine.hx",211,0xdff93b7f)
...
HXLINE( 227)		Bool _hx_tmp = hx::IsNotNull( font );
HXDLIN( 227)		if (_hx_tmp) {
HXLINE( 229)			Int _hx_tmp1 = font->get_ascender();
HXDLIN( 229)			Int _hx_tmp2 = font->get_unitsPerEM();
HXDLIN( 229)			ascent = (((Float)_hx_tmp1 / (Float)_hx_tmp2) * format->size);
HXLINE( 230)			Int _hx_tmp3 = font->get_descender();
HXDLIN( 230)			Int _hx_tmp4 = font->get_unitsPerEM();
HXDLIN( 230)			Float _hx_tmp5 = (((Float)_hx_tmp3 / (Float)_hx_tmp4) * format->size);
HXDLIN( 230)			descent = ::Math_obj::abs(_hx_tmp5);
...
::String TextEngine_obj::getFont( ::openfl::text::TextFormat format){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getFont",0xec6d6977,"openfl._internal.text.TextEngine.getFont","openfl/_internal/text/TextEngine.hx",248,0xdff93b7f)
            	HX_STACK_ARG(format,"format")
...
HXLINE( 251)		hx::AddEq(font,HX_("normal ",19,70,da,2b));
HXLINE( 252)		::String _hx_tmp;
HXDLIN( 252)		if (format->bold) {
HXLINE( 252)			_hx_tmp = HX_("bold ",fb,d2,f5,b6);
            		}
            		else {
HXLINE( 252)			_hx_tmp = HX_("normal ",19,70,da,2b);
            		}
HXDLIN( 252)		hx::AddEq(font,_hx_tmp);
HXLINE( 253)		hx::AddEq(font,(format->size + HX_("px",08,62,00,00)));
HXLINE( 254)		hx::AddEq(font,((HX_("/",2f,00,00,00) + ((format->size + format->leading) + (int)6)) + HX_("px ",18,65,55,00)));
HXLINE( 256)		HX_VARI( ::String,_g1) = format->font;
HXDLIN( 256)		::String _hx_tmp1;
HXDLIN( 256)		::String _hx_switch_0 = _g1;
            		if (  (_hx_switch_0==HX_("_sans",32,a0,5e,ff)) ){
HXLINE( 256)			_hx_tmp1 = HX_("sans-serif",c3,60,fb,08);
HXDLIN( 256)			goto _hx_goto_22;
            		}
            		if (  (_hx_switch_0==HX_("_serif",be,66,15,76)) ){
HXLINE( 256)			_hx_tmp1 = HX_("serif",7d,1f,2e,7a);
HXDLIN( 256)			goto _hx_goto_22;
            		}
            		if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
HXLINE( 256)			_hx_tmp1 = HX_("monospace",c3,d1,e5,5e);
HXDLIN( 256)			goto _hx_goto_22;
            		}
            		/* default */{
HXLINE( 261)			::String _hx_tmp2 =  ::EReg_obj::__new(HX_("^[\\s'\"]+(.*)[\\s'\"]+$",eb,e4,eb,f5),HX_("",00,00,00,00))->replace(format->font,HX_("$1",8d,1f,00,00));
HXLINE( 256)			_hx_tmp1 = ((HX_("'",27,00,00,00) + _hx_tmp2) + HX_("'",27,00,00,00));
            		}
            		_hx_goto_22:;
HXDLIN( 256)		hx::AddEq(font,(HX_("",00,00,00,00) + _hx_tmp1));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TextEngine_obj,getFont,return )
 ...
 ::openfl::text::Font TextEngine_obj::getFontInstance( ::openfl::text::TextFormat format){
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","getFontInstance",0xe749142c,"openfl._internal.text.TextEngine.getFontInstance","openfl/_internal/text/TextEngine.hx",270,0xdff93b7f)
            	HX_STACK_ARG(format,"format")
HXLINE( 274)		HX_VARI(  ::openfl::text::Font,instance) = null();
HXLINE( 275)		HX_VARI( ::Array< ::String >,fontList) = null();
HXLINE( 277)		Bool _hx_tmp;
HXDLIN( 277)		Bool _hx_tmp1 = hx::IsNotNull( format );
...
HXLINE( 279)			Bool _hx_tmp2 = ::openfl::_internal::text::TextEngine_obj::_hx___defaultFonts->exists(format->font);
...
HXLINE( 286)			Bool _hx_tmp3 = hx::IsNotNull( instance );
...
HXLINE( 295)				goto _hx_goto_23;
            			}
            			if (  (_hx_switch_0==HX_("_serif",be,66,15,76)) ){
HXLINE( 330)				goto _hx_goto_23;
            			}
            			if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
...
HXLINE( 397)					Bool _hx_tmp5 = hx::IsNotNull( instance );
...
HXLINE( 409)			Bool _hx_tmp6 = hx::IsNotNull( instance );
...
HXLINE( 457)				Bool _hx_tmp7 = hx::IsNotNull( instance );
...
{
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","boot",0x1c4a1d00,"openfl._internal.text.TextEngine.boot","openfl/_internal/text/TextEngine.hx",52,0xdff93b7f)
HXLINE(  52)		UTF8_ENDLINE = (int)10;
            	}
{
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","boot",0x1c4a1d00,"openfl._internal.text.TextEngine.boot","openfl/_internal/text/TextEngine.hx",53,0xdff93b7f)
HXLINE(  53)		UTF8_SPACE = (int)32;
            	}
{
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","boot",0x1c4a1d00,"openfl._internal.text.TextEngine.boot","openfl/_internal/text/TextEngine.hx",54,0xdff93b7f)
HXLINE(  54)		UTF8_HYPHEN = (int)45;
            	}
{
            	HX_STACK_FRAME("openfl._internal.text.TextEngine","boot",0x1c4a1d00,"openfl._internal.text.TextEngine.boot","openfl/_internal/text/TextEngine.hx",56,0xdff93b7f)
HXLINE(  56)		_hx___defaultFonts =  ::haxe::ds::StringMap_obj::__new();
            	}
}
