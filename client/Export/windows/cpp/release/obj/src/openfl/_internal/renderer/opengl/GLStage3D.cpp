...
void GLStage3D_obj::render( ::openfl::display::Stage3D stage3D, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLStage3D","render",0x8add30de,"openfl._internal.renderer.opengl.GLStage3D.render","openfl/_internal/renderer/opengl/GLStage3D.hx",21,0x575148fa)
            	HX_STACK_ARG(stage3D,"stage3D")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE(  21)		Bool _hx_tmp = hx::IsNotNull( stage3D->context3D );
HXDLIN(  21)		if (_hx_tmp) {
HXLINE(  23)			renderSession->gl->depthMask(true);
HXLINE(  25)			renderSession->blendModeManager->setBlendMode(null());
HXLINE(  27)			Bool _hx_tmp1 = hx::IsNotNull( renderSession->shaderManager->currentShader );
HXDLIN(  27)			if (_hx_tmp1) {
HXLINE(  29)				renderSession->shaderManager->setShader(null());
HXLINE(  31)				Bool _hx_tmp2 = hx::IsNotNull( stage3D->context3D->_hx___program );
