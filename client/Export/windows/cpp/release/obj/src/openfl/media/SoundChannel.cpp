...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACK_FRAME("openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",82,0xa4290000)
            	HX_STACK_THIS(this)
HXLINE(  82)		 ::openfl::media::SoundTransform _hx_tmp = this->get_soundTransform();
HXDLIN(  82)		this->set_soundTransform(_hx_tmp);
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACK_FRAME("openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",94,0xa4290000)
            	HX_STACK_THIS(this)
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACK_FRAME("openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",103,0xa4290000)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 105)		if (!(this->_hx___isValid)) {
HXLINE( 105)			return (int)0;
            		}
HXLINE( 107)		Int _hx_tmp = ::Std_obj::_hx_int(value);
HXDLIN( 107)		Int _hx_tmp1 = (_hx_tmp - this->_hx___source->offset);
HXDLIN( 107)		this->_hx___source->set_currentTime(_hx_tmp1);
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACK_FRAME("openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",115,0xa4290000)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACK_FRAME("openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",120,0xa4290000)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 122)		Bool _hx_tmp = hx::IsNotNull( value );
...
HXLINE( 127)			HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 129)			Bool _hx_tmp1 = (pan < (int)-1);
HXDLIN( 129)			if (_hx_tmp1) {
HXLINE( 129)				pan = (int)-1;
            			}
HXLINE( 130)			Bool _hx_tmp2 = (pan > (int)1);
HXDLIN( 130)			if (_hx_tmp2) {
HXLINE( 130)				pan = (int)1;
            			}
HXLINE( 132)			HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 134)			Bool _hx_tmp3 = this->_hx___isValid;
HXDLIN( 134)			if (_hx_tmp3) {
HXLINE( 136)				this->_hx___source->set_gain(volume);
HXLINE( 138)				HX_VARI(  ::lime::math::Vector4,position) = this->_hx___source->get_position();
HXLINE( 139)				position->x = pan;
HXLINE( 140)				Float _hx_tmp4 = ::Math_obj::pow(pan,(int)2);
HXDLIN( 140)				Float _hx_tmp5 = ::Math_obj::sqrt(((int)1 - _hx_tmp4));
HXDLIN( 140)				position->z = ((int)-1 * _hx_tmp5);
...
void SoundChannel_obj::source_onComplete(){
            	HX_STACK_FRAME("openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",161,0xa4290000)
            	HX_STACK_THIS(this)
HXLINE( 163)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 165)		this->_hx___dispose();
HXLINE( 166)		this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
