...
Dynamic SpreadMethod_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic SpreadMethod_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._SpreadMethod.SpreadMethod_Impl_","fromString",0xf9dd3790,"openfl.display._SpreadMethod.SpreadMethod_Impl_.fromString","openfl/display/SpreadMethod.hx",12,0x882c619e)
...
::String SpreadMethod_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._SpreadMethod.SpreadMethod_Impl_","toString",0x8d8a9321,"openfl.display._SpreadMethod.SpreadMethod_Impl_.toString","openfl/display/SpreadMethod.hx",25,0x882c619e)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._SpreadMethod.SpreadMethod_Impl_","boot",0x85bda827,"openfl.display._SpreadMethod.SpreadMethod_Impl_.boot","openfl/display/SpreadMethod.hx",6,0x882c619e)
HXLINE(   6)		PAD = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._SpreadMethod.SpreadMethod_Impl_","boot",0x85bda827,"openfl.display._SpreadMethod.SpreadMethod_Impl_.boot","openfl/display/SpreadMethod.hx",7,0x882c619e)
HXLINE(   7)		REFLECT = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._SpreadMethod.SpreadMethod_Impl_","boot",0x85bda827,"openfl.display._SpreadMethod.SpreadMethod_Impl_.boot","openfl/display/SpreadMethod.hx",8,0x882c619e)
