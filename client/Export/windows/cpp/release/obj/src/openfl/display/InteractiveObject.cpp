...
void InteractiveObject_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","new",0x042d7309,"openfl.display.InteractiveObject.new","openfl/display/InteractiveObject.hx",27,0x983a3689)
            	HX_STACK_THIS(this)
...
Bool InteractiveObject_obj::requestSoftKeyboard(){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","requestSoftKeyboard",0x985d3a49,"openfl.display.InteractiveObject.requestSoftKeyboard","openfl/display/InteractiveObject.hx",40,0x983a3689)
            	HX_STACK_THIS(this)
...
Bool InteractiveObject_obj::_hx___getInteractive(::Array< ::Dynamic> stack){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","__getInteractive",0xf3ec43c3,"openfl.display.InteractiveObject.__getInteractive","openfl/display/InteractiveObject.hx",49,0x983a3689)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stack,"stack")
HXLINE(  51)		Bool _hx_tmp = hx::IsNotNull( stack );
HXDLIN(  51)		if (_hx_tmp) {
HXLINE(  53)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(  55)			Bool _hx_tmp1 = hx::IsNotNull( this->parent );
...
Bool InteractiveObject_obj::_hx___hitTest(Float x,Float y,Bool shapeFlag,::Array< ::Dynamic> stack,Bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","__hitTest",0x5938388e,"openfl.display.InteractiveObject.__hitTest","openfl/display/InteractiveObject.hx",68,0x983a3689)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
Bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",85,0x983a3689)
            	HX_STACK_THIS(this)
...
Bool InteractiveObject_obj::set_tabEnabled(Bool value){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",92,0x983a3689)
            	HX_STACK_THIS(this)
