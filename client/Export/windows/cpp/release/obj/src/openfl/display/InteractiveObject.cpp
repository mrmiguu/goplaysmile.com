...
HXLINE(  26)		this->doubleClickEnabled = false;
HXLINE(  27)		this->mouseEnabled = true;
HXLINE(  28)		this->needsSoftKeyboard = false;
HXLINE(  29)		this->_hx___tabEnabled = false;
HXLINE(  30)		this->tabIndex = (int)-1;
            	}
...
Bool InteractiveObject_obj::requestSoftKeyboard(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  37)		::openfl::Lib_obj::notImplemented(hx::SourceInfo(HX_("InteractiveObject.hx",3d,87,79,89),37,HX_("openfl.display.InteractiveObject",97,3a,cb,f4),HX_("requestSoftKeyboard",a0,f5,a9,d4)));
...
HXLINE(  46)		Bool _hx_tmp = hx::IsNotNull( stack );
HXDLIN(  46)		if (_hx_tmp) {
HXLINE(  48)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(  50)			Bool _hx_tmp1 = hx::IsNotNull( this->parent );
HXDLIN(  50)			if (_hx_tmp1) {
HXLINE(  52)				this->parent->_hx___getInteractive(stack);
            			}
            		}
...
HXDLIN(  65)		Bool _hx_tmp2 = !(!(hitObject->get_visible()));
HXDLIN(  65)		if (_hx_tmp2) {
HXLINE(  65)			_hx_tmp1 = this->_hx___isMask;
            		}
            		else {
HXLINE(  65)			_hx_tmp1 = true;
            		}
HXDLIN(  65)		if (!(_hx_tmp1)) {
HXLINE(  65)			if (interactiveOnly) {
HXLINE(  65)				_hx_tmp = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE(  66)		return this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}


Bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",80,0x983a3689)
            	HX_STACK_THIS(this)
HXLINE(  80)		return this->_hx___tabEnabled;
            	}
...
Bool InteractiveObject_obj::set_tabEnabled(Bool value){
            	HX_STACK_FRAME("openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",87,0x983a3689)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(  87)		return (this->_hx___tabEnabled = value);
            	}
