...
void TimelineObject_obj::__construct(Int id,Int depth, ::openfl::display::DisplayObject displayObject){
            	HX_STACK_FRAME("openfl.display._MovieClip.TimelineObject","new",0xc9ce6cb5,"openfl.display._MovieClip.TimelineObject.new","openfl/display/MovieClip.hx",698,0x2b84738a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
