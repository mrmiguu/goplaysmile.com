...
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_84___renderCanvas,"openfl.display.OpenGLView","__renderCanvas",0x35af22fe,"openfl.display.OpenGLView.__renderCanvas","openfl/display/OpenGLView.hx",84,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_100___renderDOM,"openfl.display.OpenGLView","__renderDOM",0x0611a49c,"openfl.display.OpenGLView.__renderDOM","openfl/display/OpenGLView.hx",100,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_178___renderGL,"openfl.display.OpenGLView","__renderGL",0x34d59d2b,"openfl.display.OpenGLView.__renderGL","openfl/display/OpenGLView.hx",178,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_249_get_isSupported,"openfl.display.OpenGLView","get_isSupported",0x72941b6b,"openfl.display.OpenGLView.get_isSupported","openfl/display/OpenGLView.hx",249,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_24_boot,"openfl.display.OpenGLView","boot",0xd8e55742,"openfl.display.OpenGLView.boot","openfl/display/OpenGLView.hx",24,0x7a9fe7de)
HX_LOCAL_STACK_FRAME(_hx_pos_ea3b26280d7ee2f2_25_boot,"openfl.display.OpenGLView","boot",0xd8e55742,"openfl.display.OpenGLView.boot","openfl/display/OpenGLView.hx",25,0x7a9fe7de)
namespace openfl{
namespace display{
...
HXLINE( 180)			 ::openfl::geom::Rectangle rect = null();
...
HXLINE( 188)				Float rect1 = this->get_x();
HXDLIN( 188)				Float rect2 = (rect1 + this->_hx___scrollRect->x);
HXDLIN( 188)				Float rect3 = this->get_y();
HXDLIN( 188)				rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,rect2,(rect3 + this->_hx___scrollRect->y),this->_hx___scrollRect->width,this->_hx___scrollRect->height);
            			}
