...
void OpenGLView_obj::_hx___renderCanvas( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.OpenGLView","__renderCanvas",0x35af22fe,"openfl.display.OpenGLView.__renderCanvas","openfl/display/OpenGLView.hx",84,0x7a9fe7de)
            	HX_STACK_THIS(this)
...
void OpenGLView_obj::_hx___renderDOM( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.OpenGLView","__renderDOM",0x0611a49c,"openfl.display.OpenGLView.__renderDOM","openfl/display/OpenGLView.hx",100,0x7a9fe7de)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
...
void OpenGLView_obj::_hx___renderGL( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.OpenGLView","__renderGL",0x34d59d2b,"openfl.display.OpenGLView.__renderGL","openfl/display/OpenGLView.hx",178,0x7a9fe7de)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 178)		Bool _hx_tmp;
HXDLIN( 178)		Bool _hx_tmp1 = hx::IsNotNull( this->stage );
...
HXLINE( 182)			Bool _hx_tmp2 = hx::IsNull( this->_hx___scrollRect );
HXDLIN( 182)			if (_hx_tmp2) {
HXLINE( 184)				rect =  ::openfl::geom::Rectangle_obj::__new((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            			}
            			else {
HXLINE( 188)				Float _hx_tmp3 = this->get_x();
HXDLIN( 188)				Float _hx_tmp4 = (_hx_tmp3 + this->_hx___scrollRect->x);
HXDLIN( 188)				Float _hx_tmp5 = this->get_y();
HXDLIN( 188)				rect =  ::openfl::geom::Rectangle_obj::__new(_hx_tmp4,(_hx_tmp5 + this->_hx___scrollRect->y),this->_hx___scrollRect->width,this->_hx___scrollRect->height);
            			}
HXLINE( 192)			renderSession->shaderManager->setShader(null());
HXLINE( 193)			renderSession->blendModeManager->setBlendMode(null());
HXLINE( 195)			Bool _hx_tmp6 = hx::IsNotNull( this->_hx___render );
...
Bool OpenGLView_obj::get_isSupported(){
            	HX_STACK_FRAME("openfl.display.OpenGLView","get_isSupported",0x72941b6b,"openfl.display.OpenGLView.get_isSupported","openfl/display/OpenGLView.hx",249,0x7a9fe7de)
