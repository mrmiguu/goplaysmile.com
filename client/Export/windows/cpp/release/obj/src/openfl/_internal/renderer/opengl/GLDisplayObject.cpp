...
HXLINE(  48)				 ::openfl::display::Graphics graphics = displayObject->_hx___graphics;
...
HXDLIN(  48)					 ::openfl::geom::Rectangle bounds = graphics->_hx___bounds;
...
HXLINE(  48)						 ::openfl::_internal::renderer::opengl::GLRenderer renderer = ( ( ::openfl::_internal::renderer::opengl::GLRenderer)(renderSession->renderer) );
HXDLIN(  48)						 ::lime::_backend::native::NativeGLRenderContext gl1 = renderSession->gl;
HXDLIN(  48)						 ::openfl::_internal::renderer::AbstractBlendModeManager renderSession1 = renderSession->blendModeManager;
HXDLIN(  48)						renderSession1->setBlendMode(displayObject->get_blendMode());
HXDLIN(  48)						renderSession->maskManager->pushObject(displayObject,null());
HXDLIN(  48)						 ::openfl::display::Shader shader = renderSession->filterManager->pushObject(displayObject);
...
HXDLIN(  48)						int gl2 = gl1->ARRAY_BUFFER;
