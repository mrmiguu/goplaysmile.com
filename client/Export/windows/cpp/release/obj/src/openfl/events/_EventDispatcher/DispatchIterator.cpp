...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_261_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",261,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_271_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",271,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_283_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",283,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_299_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",299,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_306_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",306,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_336_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",336,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_261_new)
HXLINE( 263)		this->list = list;
HXLINE( 264)		this->index = list->length;
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_271_copy)
HXLINE( 271)		bool _hx_tmp;
HXDLIN( 271)		if ((this->index < this->list->length)) {
HXLINE( 271)			_hx_tmp = !(this->isCopy);
            		}
            		else {
HXLINE( 271)			_hx_tmp = false;
            		}
HXDLIN( 271)		if (_hx_tmp) {
HXLINE( 273)			this->list = this->list->copy();
HXLINE( 274)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_283_hasNext)
HXLINE( 283)		if ((this->index < this->list->length)) {
HXLINE( 285)			return true;
            		}
            		else {
HXLINE( 289)			this->active = false;
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_299_next)
HXLINE( 299)		::Array< ::Dynamic> _hx_tmp = this->list;
HXDLIN( 299)		return _hx_tmp->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_306_remove)
HXLINE( 306)		if (this->active) {
HXLINE( 308)			if (!(this->isCopy)) {
HXLINE( 310)				if ((listIndex < this->index)) {
HXLINE( 312)					this->index--;
            				}
            			}
            			else {
HXLINE( 318)				int _g1 = this->index;
HXDLIN( 318)				int _g = this->list->length;
HXDLIN( 318)				while((_g1 < _g)){
HXLINE( 318)					_g1 = (_g1 + (int)1);
HXDLIN( 318)					int i = (_g1 - (int)1);
HXLINE( 320)					if (hx::IsEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 322)						this->list->removeRange(i,(int)1);
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_336_reset)
HXLINE( 338)		this->list = list;
HXLINE( 340)		this->active = true;
HXLINE( 341)		this->index = (int)0;
            	}
