...
HXLINE(  33)		{
HXLINE(  33)			Int target = this->_hx___textureTarget;
HXDLIN(  33)			::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            		}
HXLINE(  34)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  36)		{
HXLINE(  36)			Int target1 = this->_hx___textureTarget;
HXDLIN(  36)			Int internalformat = this->_hx___internalFormat;
HXDLIN(  36)			Int format1 = this->_hx___format;
HXDLIN(  36)			::lime::graphics::opengl::GL_obj::context->texImage2D(target1,(int)0,internalformat,width,height,(int)0,format1,(int)5121,null());
            		}
HXLINE(  37)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  39)		{
HXLINE(  39)			Int target2 = this->_hx___textureTarget;
HXDLIN(  39)			::lime::graphics::opengl::GL_obj::context->bindTexture(target2,null());
            		}
...
HXLINE(  54)			{
HXLINE(  54)				Int target = this->_hx___textureTarget;
HXDLIN(  54)				::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            			}
...
HXLINE(  59)			{
HXLINE(  59)				Int target1 = this->_hx___textureTarget;
HXDLIN(  59)				::lime::graphics::opengl::GL_obj::context->bindTexture(target1,null());
            			}
HXLINE(  60)			::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
            		}
            		else {
HXLINE(  66)			{
HXLINE(  66)				Int target2 = this->_hx___textureTarget;
HXDLIN(  66)				::lime::graphics::opengl::GL_obj::context->bindTexture(target2,null());
            			}
...
HXLINE(  71)		if (async) {
            			...
            			void _hx_run(){
            				HX_STACK_FRAME("openfl.display3D.textures.Texture","uploadCompressedTextureFromByteArray",0xe2c5b53e,"openfl.display3D.textures.Texture.uploadCompressedTextureFromByteArray","openfl/display3D/textures/Texture.hx",75,0x3ee19dbf)
HXLINE(  75)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("textureReady",88,4d,5a,df),null(),null()));
            			}
...
Bool generateMipmap = __o_generateMipmap.Default(false);
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","uploadFromBitmapData",0x5c4e9314,"openfl.display3D.textures.Texture.uploadFromBitmapData","openfl/display3D/textures/Texture.hx",84,0x3ee19dbf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(miplevel,"miplevel")
            	HX_STACK_ARG(generateMipmap,"generateMipmap")
HXLINE(  96)		Bool _hx_tmp = hx::IsNull( source );
...
HXLINE( 101)			_hx_tmp1 = (source->height != height);
            		}
            		else {
HXLINE( 101)			_hx_tmp1 = true;
            		}
HXDLIN( 101)		if (_hx_tmp1) {
HXLINE( 103)			HX_VARI(  ::openfl::display::BitmapData,copy) =  ::openfl::display::BitmapData_obj::__new(width,height,true,(int)0);
HXLINE( 104)			copy->draw(source,null(),null(),null(),null(),null());
HXLINE( 105)			source = copy;
            		}
HXLINE( 109)		HX_VARI(  ::lime::graphics::Image,image) = this->_hx___getImage(source);
HXLINE( 111)		 ::lime::utils::ArrayBufferView _hx_tmp2 = image->get_data();
HXDLIN( 111)		this->uploadFromTypedArray(_hx_tmp2,miplevel);
            	}
...
Int miplevel = __o_miplevel.Default(0);
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","uploadFromByteArray",0x0d748876,"openfl.display3D.textures.Texture.uploadFromByteArray","openfl/display3D/textures/Texture.hx",127,0x3ee19dbf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
            	HX_STACK_ARG(miplevel,"miplevel")
...
HXDLIN( 127)		Bool _hx_tmp = hx::IsNotNull( buffer );
HXDLIN( 127)		if (_hx_tmp) {
HXLINE( 127)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
...
HXDLIN( 127)			Float _hx_tmp1 = ((Float)newByteLength / (Float)_this->bytesPerElement);
HXDLIN( 127)			_this->length = ::Std_obj::_hx_int(_hx_tmp1);
...
Int miplevel = __o_miplevel.Default(0);
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","uploadFromTypedArray",0x20dd8a2a,"openfl.display3D.textures.Texture.uploadFromTypedArray","openfl/display3D/textures/Texture.hx",132,0x3ee19dbf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(miplevel,"miplevel")
HXLINE( 134)		Bool _hx_tmp = hx::IsNull( data );
...
HXLINE( 139)		{
HXLINE( 139)			Int target = this->_hx___textureTarget;
HXDLIN( 139)			::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            		}
HXLINE( 140)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 142)		{
HXLINE( 142)			Int target1 = this->_hx___textureTarget;
HXDLIN( 142)			Int internalformat = this->_hx___internalFormat;
HXDLIN( 142)			Int format = this->_hx___format;
HXDLIN( 142)			::lime::graphics::opengl::GL_obj::context->texImage2D(target1,miplevel,internalformat,width,height,(int)0,format,(int)5121,data);
            		}
HXLINE( 143)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE( 145)		{
HXLINE( 145)			Int target2 = this->_hx___textureTarget;
HXDLIN( 145)			::lime::graphics::opengl::GL_obj::context->bindTexture(target2,null());
            		}
...
void Texture_obj::_hx___uploadATFTextureFromByteArray( ::openfl::utils::ByteArrayData data,Int byteArrayOffset){
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","__uploadATFTextureFromByteArray",0x7de383ee,"openfl.display3D.textures.Texture.__uploadATFTextureFromByteArray","openfl/display3D/textures/Texture.hx",211,0x3ee19dbf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
...
HXLINE( 220)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("ATF length exceeds byte array length",d7,29,45,0f)));
            		}
HXLINE( 224)		HX_VARI( Int,tdata) = data->readUnsignedByte();
HXLINE( 227)		if ((((int)tdata >> (int)(int)7) != (int)0)) {
HXLINE( 229)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("ATF Cube maps are not supported",0a,da,6c,45)));
            		}
...
HXLINE( 244)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("ATF width and height dont match",3f,49,15,70)));
            		}
...
HXLINE( 252)						HX_VARI( Int,gpuFormat) = _g2++;
...
HXLINE( 278)						Int _hx_tmp2 = (data->position + blockLength);
HXDLIN( 278)						data->position = _hx_tmp2;
            					}
            				}
            			}
            		}
...
Int Texture_obj::_hx___getATFVersion( ::openfl::utils::ByteArrayData data){
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","__getATFVersion",0x0832a0eb,"openfl.display3D.textures.Texture.__getATFVersion","openfl/display3D/textures/Texture.hx",154,0x3ee19dbf)
            	HX_STACK_ARG(data,"data")
HXLINE( 156)		HX_VARI( ::String,signature) = data->readUTFBytes((int)3);
HXLINE( 158)		if ((signature != HX_("ATF",f3,9b,31,00))) {
HXLINE( 160)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(HX_("ATF signature not found",a0,f7,2f,3a)));
            		}
...
HXLINE( 169)			HX_VARI( Int,sig) = ::openfl::display3D::textures::Texture_obj::_hx___readUInt32(data);
HXLINE( 171)			if ((sig == (int)255)) {
...
Int Texture_obj::_hx___readUInt24( ::openfl::utils::ByteArrayData data){
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","__readUInt24",0x2184b642,"openfl.display3D.textures.Texture.__readUInt24","openfl/display3D/textures/Texture.hx",188,0x3ee19dbf)
            	HX_STACK_ARG(data,"data")
HXLINE( 190)		HX_VAR( Int,value);
HXLINE( 191)		Int _hx_tmp = data->readUnsignedByte();
HXDLIN( 191)		value = ((int)_hx_tmp << (int)(int)16);
HXLINE( 192)		Int _hx_tmp1 = data->readUnsignedByte();
HXDLIN( 192)		value = ((int)value | (int)((int)_hx_tmp1 << (int)(int)8));
HXLINE( 193)		Int b = data->readUnsignedByte();
HXDLIN( 193)		value = ((int)value | (int)b);
...
Int Texture_obj::_hx___readUInt32( ::openfl::utils::ByteArrayData data){
            	HX_STACK_FRAME("openfl.display3D.textures.Texture","__readUInt32",0x2184b71f,"openfl.display3D.textures.Texture.__readUInt32","openfl/display3D/textures/Texture.hx",199,0x3ee19dbf)
            	HX_STACK_ARG(data,"data")
HXLINE( 201)		HX_VAR( Int,value);
HXLINE( 202)		Int _hx_tmp = data->readUnsignedByte();
HXDLIN( 202)		value = ((int)_hx_tmp << (int)(int)24);
HXLINE( 203)		Int _hx_tmp1 = data->readUnsignedByte();
HXDLIN( 203)		value = ((int)value | (int)((int)_hx_tmp1 << (int)(int)16));
HXLINE( 204)		Int _hx_tmp2 = data->readUnsignedByte();
HXDLIN( 204)		value = ((int)value | (int)((int)_hx_tmp2 << (int)(int)8));
HXLINE( 205)		Int b = data->readUnsignedByte();
HXDLIN( 205)		value = ((int)value | (int)b);
