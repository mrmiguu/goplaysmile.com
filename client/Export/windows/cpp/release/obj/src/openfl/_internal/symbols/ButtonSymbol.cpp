...
HX_LOCAL_STACK_FRAME(_hx_pos_906043296d6f2c53_26___createObject,"openfl._internal.symbols.ButtonSymbol","__createObject",0x5a781ddc,"openfl._internal.symbols.ButtonSymbol.__createObject","openfl/_internal/symbols/ButtonSymbol.hx",26,0xd0678f8e)
namespace openfl{
namespace _internal{
namespace symbols{
...
HXLINE(  28)		 ::openfl::display::SimpleButton simpleButton = null();
...
HXLINE(  35)			hx::Class symbolType = ::Type_obj::resolveClass(this->className);
