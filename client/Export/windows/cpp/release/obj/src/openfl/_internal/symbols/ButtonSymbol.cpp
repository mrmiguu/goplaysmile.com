...
void ButtonSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.ButtonSymbol","new",0x02e216df,"openfl._internal.symbols.ButtonSymbol.new","openfl/_internal/symbols/ButtonSymbol.hx",21,0xd0678f8e)
            	HX_STACK_THIS(this)
...
Dynamic ButtonSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject ButtonSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.ButtonSymbol","__createObject",0x5a781ddc,"openfl._internal.symbols.ButtonSymbol.__createObject","openfl/_internal/symbols/ButtonSymbol.hx",26,0xd0678f8e)
            	HX_STACK_THIS(this)
...
HXLINE(  33)		Bool _hx_tmp = hx::IsNotNull( this->className );
HXDLIN(  33)		if (_hx_tmp) {
HXLINE(  35)			HX_VARI( hx::Class,symbolType) = ::Type_obj::resolveClass(this->className);
HXLINE(  37)			Bool _hx_tmp1 = hx::IsNotNull( symbolType );
...
HXLINE(  49)		Bool _hx_tmp2 = hx::IsNull( simpleButton );
HXDLIN(  49)		if (_hx_tmp2) {
HXLINE(  51)			simpleButton =  ::openfl::display::SimpleButton_obj::__new(null(),null(),null(),null());
            		}
