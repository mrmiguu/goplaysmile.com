...
void ButtonSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.ButtonSymbol","new",0x02e216df,"openfl._internal.symbols.ButtonSymbol.new","openfl/_internal/symbols/ButtonSymbol.hx",22,0xd0678f8e)
            	HX_STACK_THIS(this)
...
Dynamic ButtonSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject ButtonSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.ButtonSymbol","__createObject",0x5a781ddc,"openfl._internal.symbols.ButtonSymbol.__createObject","openfl/_internal/symbols/ButtonSymbol.hx",27,0xd0678f8e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  29)		HX_VARI(  ::openfl::display::SimpleButton,simpleButton) = null();
HXLINE(  31)		::openfl::display::SimpleButton_obj::_hx___initSWF = swf;
HXLINE(  32)		::openfl::display::SimpleButton_obj::_hx___initSymbol = hx::ObjectPtr<OBJ_>(this);
HXLINE(  34)		Bool _hx_tmp = hx::IsNotNull( this->className );
HXDLIN(  34)		if (_hx_tmp) {
HXLINE(  36)			HX_VARI( hx::Class,symbolType) = ::Type_obj::resolveClass(this->className);
HXLINE(  38)			Bool _hx_tmp1 = hx::IsNotNull( symbolType );
HXDLIN(  38)			if (_hx_tmp1) {
HXLINE(  40)				simpleButton = ( ( ::openfl::display::SimpleButton)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  50)		Bool _hx_tmp2 = hx::IsNull( simpleButton );
HXDLIN(  50)		if (_hx_tmp2) {
HXLINE(  52)			simpleButton =  ::openfl::display::SimpleButton_obj::__new(null(),null(),null(),null());
            		}
HXLINE(  56)		return simpleButton;
            	}
