...
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_162_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",162,0xb64128b5)
namespace openfl{
namespace filters{
...
HXLINE( 164)		::Array< Float > multipliers = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uMultipliers",5d,5b,61,e5),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
HXLINE( 165)		::Array< Float > offsets = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uOffsets",8b,59,c4,c8),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
