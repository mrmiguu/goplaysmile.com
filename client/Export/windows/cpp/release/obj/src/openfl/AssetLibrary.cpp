...
void AssetLibrary_obj::__construct(){
            	HX_STACK_FRAME("openfl.AssetLibrary","new",0x1b1e281b,"openfl.AssetLibrary.new","openfl/Assets.hx",874,0x989d477c)
            	HX_STACK_THIS(this)
HXLINE( 874)		super::__construct();
            	}
...
Dynamic AssetLibrary_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::MovieClip AssetLibrary_obj::getMovieClip(::String id){
            	HX_STACK_FRAME("openfl.AssetLibrary","getMovieClip",0x2889f80f,"openfl.AssetLibrary.getMovieClip","openfl/Assets.hx",881,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
 ...
 ::lime::app::Future AssetLibrary_obj::loadMovieClip(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::openfl::AssetLibrary,_gthis) HXARGC(0)
            		 ::openfl::display::MovieClip _hx_run(){
            			HX_STACK_FRAME("openfl.AssetLibrary","loadMovieClip",0x8eb64315,"openfl.AssetLibrary.loadMovieClip","openfl/Assets.hx",888,0x989d477c)
HXLINE( 888)			return _gthis->getMovieClip(id);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACK_FRAME("openfl.AssetLibrary","loadMovieClip",0x8eb64315,"openfl.AssetLibrary.loadMovieClip","openfl/Assets.hx",886,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 886)		HX_VARI(  ::openfl::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 888)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)),null());
            	}
