...
void AssetLibrary_obj::__construct(){
            	HX_STACK_FRAME("openfl.AssetLibrary","new",0x1b1e281b,"openfl.AssetLibrary.new","openfl/Assets.hx",872,0x989d477c)
            	HX_STACK_THIS(this)
...
Dynamic AssetLibrary_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::MovieClip AssetLibrary_obj::getMovieClip(::String id){
            	HX_STACK_FRAME("openfl.AssetLibrary","getMovieClip",0x2889f80f,"openfl.AssetLibrary.getMovieClip","openfl/Assets.hx",879,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
HXLINE( 886)			return _gthis->getMovieClip(id);
            	...
            	HX_STACK_FRAME("openfl.AssetLibrary","loadMovieClip",0x8eb64315,"openfl.AssetLibrary.loadMovieClip","openfl/Assets.hx",884,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 884)		HX_VARI(  ::openfl::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 886)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)),null());
            	}
