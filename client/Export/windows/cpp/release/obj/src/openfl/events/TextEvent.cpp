...
Dynamic TextEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event TextEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  24)		HX_VARI(  ::openfl::events::TextEvent,event) =  ::openfl::events::TextEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text);
...
::String TextEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  35)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
