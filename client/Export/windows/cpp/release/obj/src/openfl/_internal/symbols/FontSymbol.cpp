...
void FontSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.FontSymbol","new",0x0fdcd23c,"openfl._internal.symbols.FontSymbol.new","openfl/_internal/symbols/FontSymbol.hx",21,0xbcdb7d91)
            	HX_STACK_THIS(this)
