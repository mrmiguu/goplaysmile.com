...
HXLINE(  47)				 ::openfl::_internal::renderer::AbstractBlendModeManager renderSession1 = renderSession->blendModeManager;
HXDLIN(  47)				renderSession1->setBlendMode(shape->get_blendMode());
