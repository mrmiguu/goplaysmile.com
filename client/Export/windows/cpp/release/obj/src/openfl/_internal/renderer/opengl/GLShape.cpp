...
HXLINE(  40)				HX_VARI(  ::lime::_backend::native::NativeGLRenderContext,gl) = renderSession->gl;
...
HXLINE(  53)				Int _hx_tmp5 = gl->ARRAY_BUFFER;
HXDLIN(  53)				 ::lime::graphics::opengl::GLBuffer _hx_tmp6 = graphics->_hx___bitmap->getBuffer(gl,shape->_hx___worldAlpha);
HXDLIN(  53)				gl->bindBuffer(_hx_tmp5,_hx_tmp6);
HXLINE(  54)				gl->vertexAttribPointer(shader->get_data()->aPosition->index,(int)3,gl->FLOAT,false,(int)24,(int)0);
HXLINE(  55)				gl->vertexAttribPointer(shader->get_data()->aTexCoord->index,(int)2,gl->FLOAT,false,(int)24,(int)12);
HXLINE(  56)				gl->vertexAttribPointer(shader->get_data()->aAlpha->index,(int)1,gl->FLOAT,false,(int)24,(int)20);
HXLINE(  58)				gl->drawArrays(gl->TRIANGLE_STRIP,(int)0,(int)4);
