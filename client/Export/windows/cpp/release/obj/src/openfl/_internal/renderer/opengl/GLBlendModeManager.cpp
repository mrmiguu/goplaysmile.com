...
void GLBlendModeManager_obj::__construct( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLBlendModeManager","new",0xd6095494,"openfl._internal.renderer.opengl.GLBlendModeManager.new","openfl/_internal/renderer/opengl/GLBlendModeManager.hx",21,0xe1d930ba)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gl,"gl")
...
void GLBlendModeManager_obj::setBlendMode( ::Dynamic blendMode){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLBlendModeManager","setBlendMode",0xf121f99e,"openfl._internal.renderer.opengl.GLBlendModeManager.setBlendMode","openfl/_internal/renderer/opengl/GLBlendModeManager.hx",33,0xe1d930ba)
            	HX_STACK_THIS(this)
