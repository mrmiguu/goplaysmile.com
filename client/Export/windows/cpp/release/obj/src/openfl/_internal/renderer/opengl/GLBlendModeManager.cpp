...
HXLINE(  38)			this->gl->blendEquation(this->gl->FUNC_ADD);
HXLINE(  39)			this->gl->blendFunc(this->gl->ONE,this->gl->ONE);
HXLINE(  36)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)2) ){
HXLINE(  59)			this->gl->blendEquation((int)32775);
HXLINE(  60)			this->gl->blendFunc(this->gl->ONE,this->gl->ONE);
HXLINE(  57)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)8) ){
HXLINE(  64)			this->gl->blendEquation((int)32776);
...
HXLINE(  44)			this->gl->blendFunc(this->gl->DST_COLOR,this->gl->ONE_MINUS_SRC_ALPHA);
HXLINE(  41)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)12) ){
HXLINE(  48)			this->gl->blendEquation(this->gl->FUNC_ADD);
HXLINE(  49)			this->gl->blendFunc(this->gl->ONE,this->gl->ONE_MINUS_SRC_COLOR);
HXLINE(  46)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)14) ){
HXLINE(  53)			this->gl->blendEquation(this->gl->FUNC_REVERSE_SUBTRACT);
HXLINE(  54)			this->gl->blendFunc(this->gl->ONE,this->gl->ONE);
HXLINE(  51)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(  70)			this->gl->blendEquation(this->gl->FUNC_ADD);
HXLINE(  71)			this->gl->blendFunc(this->gl->ONE,this->gl->ONE_MINUS_SRC_ALPHA);
            		}
            		_hx_goto_0:;
            	}
