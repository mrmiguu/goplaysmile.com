...
Dynamic Context3DTriangleFace_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Context3DTriangleFace_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","fromString",0x04ef1c93,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.fromString","openfl/display3D/Context3DTriangleFace.hx",14,0x186e7db4)
...
::String Context3DTriangleFace_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","toString",0xd6ea2164,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.toString","openfl/display3D/Context3DTriangleFace.hx",28,0x186e7db4)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","boot",0xb50218ea,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.boot","openfl/display3D/Context3DTriangleFace.hx",7,0x186e7db4)
HXLINE(   7)		BACK = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","boot",0xb50218ea,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.boot","openfl/display3D/Context3DTriangleFace.hx",8,0x186e7db4)
HXLINE(   8)		FRONT = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","boot",0xb50218ea,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.boot","openfl/display3D/Context3DTriangleFace.hx",9,0x186e7db4)
