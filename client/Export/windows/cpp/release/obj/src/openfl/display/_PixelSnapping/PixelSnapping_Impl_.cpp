...
Dynamic PixelSnapping_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic PixelSnapping_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._PixelSnapping.PixelSnapping_Impl_","fromString",0xc7730368,"openfl.display._PixelSnapping.PixelSnapping_Impl_.fromString","openfl/display/PixelSnapping.hx",12,0x71d03308)
...
::String PixelSnapping_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._PixelSnapping.PixelSnapping_Impl_","toString",0xd1c938f9,"openfl.display._PixelSnapping.PixelSnapping_Impl_.toString","openfl/display/PixelSnapping.hx",25,0x71d03308)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",6,0x71d03308)
HXLINE(   6)		ALWAYS = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",7,0x71d03308)
HXLINE(   7)		AUTO = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",8,0x71d03308)
