...
HX_DEFINE_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_19_new,"openfl._internal.renderer.cairo.CairoMaskManager","new",0x3e0aed8c,"openfl._internal.renderer.cairo.CairoMaskManager.new","openfl/_internal/renderer/cairo/CairoMaskManager.hx",19,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_24_pushMask,"openfl._internal.renderer.cairo.CairoMaskManager","pushMask",0xb35b173a,"openfl._internal.renderer.cairo.CairoMaskManager.pushMask","openfl/_internal/renderer/cairo/CairoMaskManager.hx",24,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_44_pushObject,"openfl._internal.renderer.cairo.CairoMaskManager","pushObject",0xebe1048d,"openfl._internal.renderer.cairo.CairoMaskManager.pushObject","openfl/_internal/renderer/cairo/CairoMaskManager.hx",44,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_61_pushRect,"openfl._internal.renderer.cairo.CairoMaskManager","pushRect",0xb6ac2372,"openfl._internal.renderer.cairo.CairoMaskManager.pushRect","openfl/_internal/renderer/cairo/CairoMaskManager.hx",61,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_77_popMask,"openfl._internal.renderer.cairo.CairoMaskManager","popMask",0x1cbc8a49,"openfl._internal.renderer.cairo.CairoMaskManager.popMask","openfl/_internal/renderer/cairo/CairoMaskManager.hx",77,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_82_popObject,"openfl._internal.renderer.cairo.CairoMaskManager","popObject",0x86d0995c,"openfl._internal.renderer.cairo.CairoMaskManager.popObject","openfl/_internal/renderer/cairo/CairoMaskManager.hx",82,0xc9e099a4)
HX_LOCAL_STACK_FRAME(_hx_pos_25d97f0861bb7f8d_101_popRect,"openfl._internal.renderer.cairo.CairoMaskManager","popRect",0x200d9681,"openfl._internal.renderer.cairo.CairoMaskManager.popRect","openfl/_internal/renderer/cairo/CairoMaskManager.hx",101,0xc9e099a4)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
void CairoMaskManager_obj::__construct( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_19_new)
...
void CairoMaskManager_obj::pushMask( ::openfl::display::DisplayObject mask){
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_24_pushMask)
HXLINE(  26)		 ::lime::graphics::cairo::Cairo cairo = this->renderSession->cairo;
HXLINE(  28)		cairo->save();
HXLINE(  31)		 ::openfl::geom::Matrix transform = mask->_hx___getRenderTransform();
HXLINE(  33)		cairo->set_matrix(transform->_hx___toMatrix3());
...
bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_44_pushObject)
...
HXLINE(  52)		if (hx::IsNotNull( object->_hx___mask )) {
...
void CairoMaskManager_obj::pushRect( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix transform){
            	HX_GC_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_61_pushRect)
HXLINE(  63)		 ::lime::graphics::cairo::Cairo cairo = this->renderSession->cairo;
HXLINE(  64)		cairo->save();
HXLINE(  66)		cairo->set_matrix( ::lime::math::Matrix3_obj::__alloc( HX_CTX ,transform->a,transform->c,transform->b,transform->d,transform->tx,transform->ty));
...
void CairoMaskManager_obj::popMask(){
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_77_popMask)
...
bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_82_popObject)
HXLINE(  84)		if (hx::IsNotNull( object->_hx___mask )) {
HXLINE(  86)			this->popMask();
            		}
HXLINE(  90)		bool _hx_tmp;
HXDLIN(  90)		if (handleScrollRect) {
HXLINE(  90)			_hx_tmp = hx::IsNotNull( object->_hx___scrollRect );
            		}
            		else {
...
void CairoMaskManager_obj::popRect(){
            	HX_STACKFRAME(&_hx_pos_25d97f0861bb7f8d_101_popRect)
