...
Dynamic StageScaleMode_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic StageScaleMode_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","fromString",0xa7123530,"openfl.display._StageScaleMode.StageScaleMode_Impl_.fromString","openfl/display/StageScaleMode.hx",13,0x7043b2c3)
...
::String StageScaleMode_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","toString",0x32c6e8c1,"openfl.display._StageScaleMode.StageScaleMode_Impl_.toString","openfl/display/StageScaleMode.hx",27,0x7043b2c3)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",6,0x7043b2c3)
HXLINE(   6)		EXACT_FIT = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",7,0x7043b2c3)
HXLINE(   7)		NO_BORDER = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",8,0x7043b2c3)
HXLINE(   8)		NO_SCALE = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",9,0x7043b2c3)
