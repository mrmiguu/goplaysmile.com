...
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_53_close,"openfl.media.Sound","close",0xfbd9cbd1,"openfl.media.Sound.close","openfl/media/Sound.hx",53,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_98_load,"openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",98,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_78_load,"openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",78,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_109_loadCompressedDataFromByteArray,"openfl.media.Sound","loadCompressedDataFromByteArray",0x8f237f2f,"openfl.media.Sound.loadCompressedDataFromByteArray","openfl/media/Sound.hx",109,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_118_loadPCMFromByteArray,"openfl.media.Sound","loadPCMFromByteArray",0xb6cc217a,"openfl.media.Sound.loadPCMFromByteArray","openfl/media/Sound.hx",118,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_123_play,"openfl.media.Sound","play",0x40d33ffb,"openfl.media.Sound.play","openfl/media/Sound.hx",123,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_173_get_id3,"openfl.media.Sound","get_id3",0xac6378e8,"openfl.media.Sound.get_id3","openfl/media/Sound.hx",173,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_178_get_length,"openfl.media.Sound","get_length",0xcc37d5f6,"openfl.media.Sound.get_length","openfl/media/Sound.hx",178,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_209_AudioBuffer_onURLLoad,"openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",209,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_62_fromAudioBuffer,"openfl.media.Sound","fromAudioBuffer",0xa9f89285,"openfl.media.Sound.fromAudioBuffer","openfl/media/Sound.hx",62,0x46a01619)
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_73_fromFile,"openfl.media.Sound","fromFile",0x06bfbe8d,"openfl.media.Sound.fromFile","openfl/media/Sound.hx",73,0x46a01619)
namespace openfl{
namespace media{
...
HXLINE(  53)		if (hx::IsNotNull( this->_hx___buffer )) {
HXLINE(  55)			this->_hx___buffer->dispose();
            		}
            	}
...
HXLINE(  78)		 ::openfl::media::Sound _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 141)		Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + sndTransform->pan);
...
HXLINE( 146)		Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * sndTransform->volume);
HXLINE( 148)		 ::lime::media::AudioSource source =  ::lime::media::AudioSource_obj::__alloc( HX_CTX ,this->_hx___buffer,null(),null(),null());
...
HXLINE( 154)		 ::lime::math::Vector4 position = source->get_position();
...
HXLINE( 188)			int samples = (this->_hx___buffer->data->length * (int)8);
HXDLIN( 188)			Float samples1 = ((Float)samples / (Float)(this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample));
HXLINE( 189)			return ::Std_obj::_hx_int((((Float)samples1 / (Float)this->_hx___buffer->sampleRate) * (int)1000));
            		}
...
HXLINE(  64)		 ::openfl::media::Sound sound =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
