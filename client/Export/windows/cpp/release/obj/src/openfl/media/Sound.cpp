...
HXLINE(  42)		Bool _hx_tmp = hx::IsNotNull( stream );
...
void Sound_obj::close(){
            	HX_STACK_FRAME("openfl.media.Sound","close",0xfbd9cbd1,"openfl.media.Sound.close","openfl/media/Sound.hx",53,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE(  53)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
...
void Sound_obj::load( ::openfl::net::URLRequest stream, ::openfl::media::SoundLoaderContext context){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_STACK_FRAME("openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",98,0x46a01619)
            			HX_STACK_ARG(_,"_")
HXLINE(  98)			_gthis->AudioBuffer_onURLLoad(null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",78,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stream,"stream")
            	HX_STACK_ARG(context,"context")
...
Bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
            	HX_STACK_FRAME("openfl.media.Sound","loadCompressedDataFromByteArray",0x8f237f2f,"openfl.media.Sound.loadCompressedDataFromByteArray","openfl/media/Sound.hx",109,0x46a01619)
            	HX_STACK_THIS(this)
...
Float sampleRate = __o_sampleRate.Default(44100);
            	HX_STACK_FRAME("openfl.media.Sound","loadPCMFromByteArray",0xb6cc217a,"openfl.media.Sound.loadPCMFromByteArray","openfl/media/Sound.hx",118,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
...
Int loops = __o_loops.Default(0);
            	HX_STACK_FRAME("openfl.media.Sound","play",0x40d33ffb,"openfl.media.Sound.play","openfl/media/Sound.hx",123,0x46a01619)
            	HX_STACK_THIS(this)
...
HXLINE( 131)		Bool _hx_tmp = hx::IsNull( sndTransform );
HXDLIN( 131)		if (_hx_tmp) {
HXLINE( 133)			sndTransform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            		}
            		else {
...
HXLINE( 143)		Bool _hx_tmp1 = (pan > (int)1);
HXDLIN( 143)		if (_hx_tmp1) {
HXLINE( 143)			pan = (int)1;
            		}
HXLINE( 144)		Bool _hx_tmp2 = (pan < (int)-1);
...
HXLINE( 148)		HX_VARI(  ::lime::media::AudioSource,source) =  ::lime::media::AudioSource_obj::__new(this->_hx___buffer,null(),null(),null());
...
HXLINE( 156)		Float _hx_tmp3 = ::Math_obj::pow(pan,(int)2);
HXDLIN( 156)		Float _hx_tmp4 = ::Math_obj::sqrt(((int)1 - _hx_tmp3));
HXDLIN( 156)		position->z = ((int)-1 * _hx_tmp4);
HXLINE( 157)		source->set_position(position);
HXLINE( 159)		return  ::openfl::media::SoundChannel_obj::__new(source,sndTransform);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Sound_obj,play,return )
 ...
 ::openfl::media::ID3Info Sound_obj::get_id3(){
            	HX_STACK_FRAME("openfl.media.Sound","get_id3",0xac6378e8,"openfl.media.Sound.get_id3","openfl/media/Sound.hx",173,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE( 173)		return  ::openfl::media::ID3Info_obj::__new();
            	}
...
Int Sound_obj::get_length(){
            	HX_STACK_FRAME("openfl.media.Sound","get_length",0xcc37d5f6,"openfl.media.Sound.get_length","openfl/media/Sound.hx",178,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE( 180)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
HXDLIN( 180)		if (_hx_tmp) {
HXLINE( 189)			Float _hx_tmp1 = (((Float)((Float)(this->_hx___buffer->data->length * (int)8) / (Float)(this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample)) / (Float)this->_hx___buffer->sampleRate) * (int)1000);
HXDLIN( 189)			return ::Std_obj::_hx_int(_hx_tmp1);
            		}
...
void Sound_obj::AudioBuffer_onURLLoad( ::lime::media::AudioBuffer buffer){
            	HX_STACK_FRAME("openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",209,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 209)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 209)		if (_hx_tmp) {
HXLINE( 211)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            		else {
HXLINE( 215)			this->_hx___buffer = buffer;
HXLINE( 216)			this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,AudioBuffer_onURLLoad,(void))
 ...
 ::openfl::media::Sound Sound_obj::fromAudioBuffer( ::lime::media::AudioBuffer buffer){
            	HX_STACK_FRAME("openfl.media.Sound","fromAudioBuffer",0xa9f89285,"openfl.media.Sound.fromAudioBuffer","openfl/media/Sound.hx",62,0x46a01619)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(  64)		HX_VARI(  ::openfl::media::Sound,sound) =  ::openfl::media::Sound_obj::__new(null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,fromAudioBuffer,return )
 ...
 ::openfl::media::Sound Sound_obj::fromFile(::String path){
            	HX_STACK_FRAME("openfl.media.Sound","fromFile",0x06bfbe8d,"openfl.media.Sound.fromFile","openfl/media/Sound.hx",73,0x46a01619)
            	HX_STACK_ARG(path,"path")
HXLINE(  73)		 ::lime::media::AudioBuffer _hx_tmp = ::lime::media::AudioBuffer_obj::fromFile(path);
HXDLIN(  73)		return ::openfl::media::Sound_obj::fromAudioBuffer(_hx_tmp);
            	}
