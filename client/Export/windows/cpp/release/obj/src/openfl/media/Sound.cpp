...
void Sound_obj::__construct( ::openfl::net::URLRequest stream, ::openfl::media::SoundLoaderContext context){
            	HX_STACK_FRAME("openfl.media.Sound","new",0xfdfd1c39,"openfl.media.Sound.new","openfl/media/Sound.hx",32,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stream,"stream")
            	HX_STACK_ARG(context,"context")
HXLINE(  34)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  36)		this->bytesLoaded = (int)0;
HXLINE(  37)		this->bytesTotal = (int)0;
HXLINE(  38)		this->isBuffering = false;
HXLINE(  39)		this->url = null();
HXLINE(  41)		Bool _hx_tmp = hx::IsNotNull( stream );
HXDLIN(  41)		if (_hx_tmp) {
HXLINE(  43)			this->load(stream,context);
            		}
            	}
...
void Sound_obj::close(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  52)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
HXDLIN(  52)		if (_hx_tmp) {
HXLINE(  54)			this->_hx___buffer->dispose();
            		}
            	}
...
void Sound_obj::load( ::openfl::net::URLRequest stream, ::openfl::media::SoundLoaderContext context){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_STACK_FRAME("openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",95,0x46a01619)
            			HX_STACK_ARG(_,"_")
HXLINE(  95)			_gthis->AudioBuffer_onURLLoad(null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("openfl.media.Sound","load",0x3e30ac2d,"openfl.media.Sound.load","openfl/media/Sound.hx",77,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stream,"stream")
            	HX_STACK_ARG(context,"context")
HXLINE(  77)		HX_VARI(  ::openfl::media::Sound,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  79)		this->url = stream->url;
HXLINE(  95)		::lime::audio::AudioBuffer_obj::loadFromFile(this->url)->onComplete(this->AudioBuffer_onURLLoad_dyn())->onError( ::Dynamic(new _hx_Closure_0(_gthis)));
            	}
...
HXLINE( 106)		this->_hx___buffer = ::lime::audio::AudioBuffer_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
            	}
...
Float sampleRate = __o_sampleRate.Default(44100);
            	HX_STACK_FRAME("openfl.media.Sound","loadPCMFromByteArray",0xb6cc217a,"openfl.media.Sound.loadPCMFromByteArray","openfl/media/Sound.hx",115,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytes,"bytes")
...
HXLINE( 115)		this->_hx___buffer = ::lime::audio::AudioBuffer_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
            	}
...
Int loops = __o_loops.Default(0);
            	HX_STACK_FRAME("openfl.media.Sound","play",0x40d33ffb,"openfl.media.Sound.play","openfl/media/Sound.hx",120,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startTime,"startTime")
            	HX_STACK_ARG(loops,"loops")
            	HX_STACK_ARG(sndTransform,"sndTransform")
HXLINE( 122)		if ((::openfl::media::SoundMixer_obj::_hx___soundChannels->length >= (int)32)) {
HXLINE( 124)			return null();
            		}
HXLINE( 128)		Bool _hx_tmp = hx::IsNull( sndTransform );
HXDLIN( 128)		if (_hx_tmp) {
HXLINE( 130)			sndTransform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            		}
            		else {
HXLINE( 134)			sndTransform = sndTransform->clone();
            		}
HXLINE( 138)		HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + sndTransform->pan);
HXLINE( 140)		Bool _hx_tmp1 = (pan > (int)1);
HXDLIN( 140)		if (_hx_tmp1) {
HXLINE( 140)			pan = (int)1;
            		}
HXLINE( 141)		Bool _hx_tmp2 = (pan < (int)-1);
HXDLIN( 141)		if (_hx_tmp2) {
HXLINE( 141)			pan = (int)-1;
            		}
HXLINE( 143)		HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * sndTransform->volume);
HXLINE( 145)		HX_VARI(  ::lime::audio::AudioSource,source) =  ::lime::audio::AudioSource_obj::__new(this->_hx___buffer,null(),null(),null());
HXLINE( 146)		source->offset = ::Std_obj::_hx_int(startTime);
HXLINE( 147)		if ((loops > (int)1)) {
HXLINE( 147)			source->set_loops((loops - (int)1));
            		}
HXLINE( 149)		source->set_gain(volume);
HXLINE( 151)		HX_VARI(  ::lime::math::Vector4,position) = source->get_position();
HXLINE( 152)		position->x = pan;
HXLINE( 153)		Float _hx_tmp3 = ::Math_obj::pow(pan,(int)2);
HXDLIN( 153)		Float _hx_tmp4 = ::Math_obj::sqrt(((int)1 - _hx_tmp3));
HXDLIN( 153)		position->z = ((int)-1 * _hx_tmp4);
HXLINE( 154)		source->set_position(position);
HXLINE( 156)		return  ::openfl::media::SoundChannel_obj::__new(source,sndTransform);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Sound_obj,play,return )
 ...
 ::openfl::media::ID3Info Sound_obj::get_id3(){
            	HX_STACK_FRAME("openfl.media.Sound","get_id3",0xac6378e8,"openfl.media.Sound.get_id3","openfl/media/Sound.hx",170,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE( 170)		return  ::openfl::media::ID3Info_obj::__new();
            	}
...
Int Sound_obj::get_length(){
            	HX_STACK_FRAME("openfl.media.Sound","get_length",0xcc37d5f6,"openfl.media.Sound.get_length","openfl/media/Sound.hx",175,0x46a01619)
            	HX_STACK_THIS(this)
HXLINE( 177)		Bool _hx_tmp = hx::IsNotNull( this->_hx___buffer );
HXDLIN( 177)		if (_hx_tmp) {
HXLINE( 186)			Float _hx_tmp1 = (((Float)((Float)(this->_hx___buffer->data->length * (int)8) / (Float)(this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample)) / (Float)this->_hx___buffer->sampleRate) * (int)1000);
HXDLIN( 186)			return ::Std_obj::_hx_int(_hx_tmp1);
            		}
HXLINE( 191)		return (int)0;
            	}
...
void Sound_obj::AudioBuffer_onURLLoad( ::lime::audio::AudioBuffer buffer){
            	HX_STACK_FRAME("openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",205,0x46a01619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 205)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 205)		if (_hx_tmp) {
HXLINE( 207)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            		else {
HXLINE( 211)			this->_hx___buffer = buffer;
HXLINE( 212)			this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Sound_obj,AudioBuffer_onURLLoad,(void))
 ...
 ::openfl::media::Sound Sound_obj::fromAudioBuffer( ::lime::audio::AudioBuffer buffer){
            	HX_STACK_FRAME("openfl.media.Sound","fromAudioBuffer",0xa9f89285,"openfl.media.Sound.fromAudioBuffer","openfl/media/Sound.hx",61,0x46a01619)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(  63)		HX_VARI(  ::openfl::media::Sound,sound) =  ::openfl::media::Sound_obj::__new(null(),null());
HXLINE(  64)		sound->_hx___buffer = buffer;
HXLINE(  65)		return sound;
            	}
...
HXLINE(  72)		 ::lime::audio::AudioBuffer _hx_tmp = ::lime::audio::AudioBuffer_obj::fromFile(path);
HXDLIN(  72)		return ::openfl::media::Sound_obj::fromAudioBuffer(_hx_tmp);
            	}
