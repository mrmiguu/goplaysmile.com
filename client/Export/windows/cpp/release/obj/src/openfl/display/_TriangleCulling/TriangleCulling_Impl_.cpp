...
Dynamic TriangleCulling_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic TriangleCulling_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._TriangleCulling.TriangleCulling_Impl_","fromString",0x878f171c,"openfl.display._TriangleCulling.TriangleCulling_Impl_.fromString","openfl/display/TriangleCulling.hx",12,0x58d0bba2)
...
::String TriangleCulling_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._TriangleCulling.TriangleCulling_Impl_","toString",0x9ce137ad,"openfl.display._TriangleCulling.TriangleCulling_Impl_.toString","openfl/display/TriangleCulling.hx",25,0x58d0bba2)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._TriangleCulling.TriangleCulling_Impl_","boot",0x162c16b3,"openfl.display._TriangleCulling.TriangleCulling_Impl_.boot","openfl/display/TriangleCulling.hx",6,0x58d0bba2)
HXLINE(   6)		NEGATIVE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._TriangleCulling.TriangleCulling_Impl_","boot",0x162c16b3,"openfl.display._TriangleCulling.TriangleCulling_Impl_.boot","openfl/display/TriangleCulling.hx",7,0x58d0bba2)
HXLINE(   7)		NONE = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._TriangleCulling.TriangleCulling_Impl_","boot",0x162c16b3,"openfl.display._TriangleCulling.TriangleCulling_Impl_.boot","openfl/display/TriangleCulling.hx",8,0x58d0bba2)
