...
HXLINE(  29)		this->renderSession =  ::openfl::_internal::renderer::RenderSession_obj::__new();
...
HXLINE(  33)		this->renderSession->maskManager =  ::openfl::_internal::renderer::cairo::CairoMaskManager_obj::__new(this->renderSession);
HXLINE(  34)		this->renderSession->blendModeManager =  ::openfl::_internal::renderer::cairo::CairoBlendModeManager_obj::__new(this->renderSession);
            	}
...
void CairoRenderer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoRenderer","clear",0x6bca5509,"openfl._internal.renderer.cairo.CairoRenderer.clear","openfl/_internal/renderer/cairo/CairoRenderer.hx",42,0x849037d4)
            	HX_STACK_THIS(this)
HXLINE(  42)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  42)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN(  42)		while(true){
HXLINE(  42)			Int _hx_tmp = _g1->get_length();
HXDLIN(  42)			if (!((_g < _hx_tmp))) {
HXLINE(  42)				goto _hx_goto_0;
            			}
HXDLIN(  42)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN(  42)			++_g;
...
void CairoRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoRenderer","render",0xe2c1945a,"openfl._internal.renderer.cairo.CairoRenderer.render","openfl/_internal/renderer/cairo/CairoRenderer.hx",51,0x849037d4)
            	HX_STACK_THIS(this)
HXLINE(  53)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE(  55)		this->cairo->identityMatrix();
HXLINE(  57)		Bool _hx_tmp = this->stage->_hx___clearBeforeRender;
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  59)			Float _hx_tmp1 = this->stage->_hx___colorSplit->__get((int)0);
HXDLIN(  59)			Float _hx_tmp2 = this->stage->_hx___colorSplit->__get((int)1);
HXDLIN(  59)			Float _hx_tmp3 = this->stage->_hx___colorSplit->__get((int)2);
HXDLIN(  59)			this->cairo->setSourceRGB(_hx_tmp1,_hx_tmp2,_hx_tmp3);
