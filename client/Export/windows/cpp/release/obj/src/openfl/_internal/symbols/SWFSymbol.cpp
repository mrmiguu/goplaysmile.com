...
void SWFSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.SWFSymbol","new",0x42b29449,"openfl._internal.symbols.SWFSymbol.new","openfl/_internal/symbols/SWFSymbol.hx",15,0xf7371d0a)
            	HX_STACK_THIS(this)
            	}
...
Dynamic SWFSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject SWFSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.SWFSymbol","__createObject",0x3e7224b2,"openfl._internal.symbols.SWFSymbol.__createObject","openfl/_internal/symbols/SWFSymbol.hx",24,0xf7371d0a)
            	HX_STACK_THIS(this)
