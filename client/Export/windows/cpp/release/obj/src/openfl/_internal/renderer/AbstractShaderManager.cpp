...
void AbstractShaderManager_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractShaderManager","new",0xdae95c9d,"openfl._internal.renderer.AbstractShaderManager.new","openfl/_internal/renderer/AbstractShaderManager.hx",14,0x593d46f2)
            	HX_STACK_THIS(this)
            	}
...
void AbstractShaderManager_obj::setShader( ::openfl::display::Shader shader){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractShaderManager","setShader",0x9aac0c64,"openfl._internal.renderer.AbstractShaderManager.setShader","openfl/_internal/renderer/AbstractShaderManager.hx",21,0x593d46f2)
            	HX_STACK_THIS(this)
