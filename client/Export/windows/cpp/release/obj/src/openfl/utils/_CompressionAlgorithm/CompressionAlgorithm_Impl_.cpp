...
Dynamic CompressionAlgorithm_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic CompressionAlgorithm_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_","fromString",0x5224159f,"openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_.fromString","openfl/utils/CompressionAlgorithm.hx",13,0x4617ecf8)
...
::String CompressionAlgorithm_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_","toString",0x36c27f70,"openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_.toString","openfl/utils/CompressionAlgorithm.hx",26,0x4617ecf8)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_","boot",0xc13780f6,"openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_.boot","openfl/utils/CompressionAlgorithm.hx",6,0x4617ecf8)
HXLINE(   6)		DEFLATE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_","boot",0xc13780f6,"openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_.boot","openfl/utils/CompressionAlgorithm.hx",8,0x4617ecf8)
HXLINE(   8)		LZMA = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_","boot",0xc13780f6,"openfl.utils._CompressionAlgorithm.CompressionAlgorithm_Impl_.boot","openfl/utils/CompressionAlgorithm.hx",9,0x4617ecf8)
HXLINE(   9)		ZLIB = (int)2;
            	}
}
