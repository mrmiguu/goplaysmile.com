...
void ShaderParameter_Float_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.ShaderParameter_Float","new",0x2b32a149,"openfl.display.ShaderParameter_Float.new","openfl/display/ShaderParameter.hx",18,0xc89f13e6)
            	HX_STACK_THIS(this)
