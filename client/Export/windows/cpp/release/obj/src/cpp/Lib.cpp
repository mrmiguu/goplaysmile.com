...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lib_obj,load,return )
 ...
 ::Dynamic Lib_obj::loadLazy(::String lib,::String prim,Int nargs){
            	HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",69,0xfc8f8c7e)
            	HX_STACK_ARG(lib,"lib")
            	HX_STACK_ARG(prim,"prim")
            	HX_STACK_ARG(nargs,"nargs")
HXLINE(  69)		try {
...
HXLINE(  72)				switch((int)(nargs)){
            					case (int)0: {
            						...
            						void _hx_run(){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",73,0xfc8f8c7e)
...
HXLINE(  73)						return  ::Dynamic(new _hx_Closure_1(e));
            					...
            					case (int)2: {
            						...
            						void _hx_run( ::Dynamic _1, ::Dynamic _2){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",74,0xfc8f8c7e)
            							HX_STACK_ARG(_1,"_1")
            							HX_STACK_ARG(_2,"_2")
...
HXLINE(  74)						return  ::Dynamic(new _hx_Closure_2(e));
            					...
            					case (int)3: {
            						...
            						void _hx_run( ::Dynamic _11, ::Dynamic _21, ::Dynamic _3){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",75,0xfc8f8c7e)
...
HXLINE(  75)						return  ::Dynamic(new _hx_Closure_3(e));
            					...
            					case (int)4: {
            						...
            						void _hx_run( ::Dynamic _12, ::Dynamic _22, ::Dynamic _31, ::Dynamic _4){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",76,0xfc8f8c7e)
...
HXLINE(  76)						return  ::Dynamic(new _hx_Closure_4(e));
            					...
            					case (int)5: {
            						...
            						void _hx_run( ::Dynamic _13, ::Dynamic _23, ::Dynamic _32, ::Dynamic _41, ::Dynamic _5){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",77,0xfc8f8c7e)
...
HXLINE(  77)						return  ::Dynamic(new _hx_Closure_5(e));
            					...
            					default:{
            						...
            						void _hx_run( ::Dynamic _14){
            							HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",78,0xfc8f8c7e)
...
void Lib_obj::rethrow( ::Dynamic inExp){
            	HX_STACK_FRAME("cpp.Lib","rethrow",0x3bf8427f,"cpp.Lib.rethrow","C:\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",84,0xfc8f8c7e)
