...
Bool quietFail = __o_quietFail.Default(false);
            	HX_STACK_FRAME("cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","C:\\HaxeToolkit\\haxe\\std/cpp/Prime.hx",35,0x547fc004)
            	HX_STACK_ARG(lib,"lib")
            	HX_STACK_ARG(prim,"prim")
            	HX_STACK_ARG(signature,"signature")
            	HX_STACK_ARG(quietFail,"quietFail")
HXLINE(  36)		HX_VARI( ::cpp::Function<   ::hx::Object *(const char*) >,factory) = ::__hxcpp_cast_get_proc_address(lib,(prim + HX_("__prime",1f,b0,e9,32)),quietFail);
HXLINE(  38)		Bool _hx_tmp = hx::IsNotNull( factory );
HXDLIN(  38)		if (_hx_tmp) {
HXLINE(  40)			HX_VARI_NAME( const char*,this1,"this") = signature.__s;
HXDLIN(  40)			 ::hx::Object * inVal = ( ( ::hx::Object *)(factory(this1)) );
HXDLIN(  40)			HX_VARI(  ::Dynamic,func) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  41)			Bool _hx_tmp1;
HXDLIN(  41)			Bool _hx_tmp2 = hx::IsNull( func );
HXDLIN(  41)			if (_hx_tmp2) {
HXLINE(  41)				_hx_tmp1 = !(quietFail);
            			}
            			else {
