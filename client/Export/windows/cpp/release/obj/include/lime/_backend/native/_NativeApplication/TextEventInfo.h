...
HX_DECLARE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_1003_new)
...
HXLINE(1005)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->type = type;
HXLINE(1006)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->windowID = windowID;
HXLINE(1007)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->text = text;
HXLINE(1008)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->start = start;
HXLINE(1009)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->length = length;
            	}
