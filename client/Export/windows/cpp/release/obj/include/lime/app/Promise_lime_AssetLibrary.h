...
class HXCPP_CLASS_ATTRIBUTES Promise_lime_AssetLibrary_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"lime.app.Promise_lime_AssetLibrary"); }
		...
		Bool isComplete;
		Bool isError;
		 ::lime::app::Promise_lime_AssetLibrary complete( ::lime::AssetLibrary data);
		::Dynamic complete_dyn();

		 ::lime::app::Promise_lime_AssetLibrary completeWith( ::lime::app::Future future);
		::Dynamic completeWith_dyn();

		 ::lime::app::Promise_lime_AssetLibrary error( ::Dynamic msg);
		::Dynamic error_dyn();

		 ::lime::app::Promise_lime_AssetLibrary progress(Int progress,Int total);
