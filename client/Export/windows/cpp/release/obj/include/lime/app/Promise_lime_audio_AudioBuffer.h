...
class HXCPP_CLASS_ATTRIBUTES Promise_lime_audio_AudioBuffer_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"lime.app.Promise_lime_audio_AudioBuffer"); }
		...
		Bool isComplete;
		Bool isError;
		 ::lime::app::Promise_lime_audio_AudioBuffer complete( ::lime::audio::AudioBuffer data);
		::Dynamic complete_dyn();

		 ::lime::app::Promise_lime_audio_AudioBuffer completeWith( ::lime::app::Future future);
		::Dynamic completeWith_dyn();

		 ::lime::app::Promise_lime_audio_AudioBuffer error( ::Dynamic msg);
		::Dynamic error_dyn();

		 ::lime::app::Promise_lime_audio_AudioBuffer progress(Int progress,Int total);
