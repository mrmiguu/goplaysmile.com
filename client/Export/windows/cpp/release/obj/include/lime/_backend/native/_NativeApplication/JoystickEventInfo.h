...
HX_DECLARE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_802_new)
...
class HXCPP_CLASS_ATTRIBUTES JoystickEventInfo_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< JoystickEventInfo_obj > __new( ::Dynamic type,hx::Null< int >  __o_id,hx::Null< int >  __o_index,hx::Null< Float >  __o_value,hx::Null< int >  __o_x,hx::Null< int >  __o_y) {
		...
		static hx::ObjectPtr< JoystickEventInfo_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic type,hx::Null< int >  __o_id,hx::Null< int >  __o_index,hx::Null< Float >  __o_value,hx::Null< int >  __o_x,hx::Null< int >  __o_y) {
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4c8f67ddac45293c_802_new)
HXLINE( 804)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->type = type;
HXLINE( 805)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->id = id;
HXLINE( 806)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->index = index;
HXLINE( 807)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->value = value;
HXLINE( 808)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->x = x;
HXLINE( 809)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->y = y;
            	}
