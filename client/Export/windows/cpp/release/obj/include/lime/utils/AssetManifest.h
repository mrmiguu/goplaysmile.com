...
class HXCPP_CLASS_ATTRIBUTES AssetManifest_obj : public hx::Object
{
	...
	public:
		...
		static  ::lime::utils::AssetManifest fromBytes( ::haxe::io::Bytes bytes);
		static ::Dynamic fromBytes_dyn();

		static  ::lime::utils::AssetManifest fromFile(::String path);
		...
		static  ::lime::utils::AssetManifest parse(::String data);
