...
class HXCPP_CLASS_ATTRIBUTES RegisterMap_obj : public hx::Object
{
	...
	public:
		...
		void addDR( ::openfl::_internal::stage3D::_AGALConverter::DestRegister dr,::hx::EnumBase usage);
		::Dynamic addDR_dyn();

		void addSaR( ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister sr,::hx::EnumBase usage);
		::Dynamic addSaR_dyn();

		void addSR( ::openfl::_internal::stage3D::_AGALConverter::SourceRegister sr,::hx::EnumBase usage,hx::Null< Int >  offset);
		::Dynamic addSR_dyn();

		::hx::EnumBase getRegisterUsage( ::openfl::_internal::stage3D::_AGALConverter::SourceRegister sr);
