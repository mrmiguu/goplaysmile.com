...
class HXCPP_CLASS_ATTRIBUTES Sound_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		Bool isBuffering;
		::String url;
		 ::lime::audio::AudioBuffer _hx___buffer;
		void close();
		::Dynamic close_dyn();
		...
		void loadCompressedDataFromByteArray( ::openfl::utils::ByteArrayData bytes,Int bytesLength,hx::Null< Bool >  forcePlayAsMusic);
		...
		void AudioBuffer_onURLLoad( ::lime::audio::AudioBuffer buffer);
