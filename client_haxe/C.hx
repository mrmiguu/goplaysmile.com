...
class C {
    ...
    public static inline var CENTER_W = WIDTH/2;
    public static inline var CENTER_H = HEIGHT/2;
    public static inline var FONT_COLOR = 0x7F0000;
    public static inline var HOST = '47.148.156.54';
    public static inline var PORT = 4200;
    public static var ROYGBIV = ['r','o','y','g','b','i','v'];

    public static inline function createParagraphs() {
    ...
    public static inline function anchor__Of(obj: Sprite, loc: String, that: Sprite) {
        switch (loc) {
        case 'tl':
            obj.x = that.x;
            obj.y = that.y;
