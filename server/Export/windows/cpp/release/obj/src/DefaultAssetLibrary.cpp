...
HX_LOCAL_STACK_FRAME(_hx_pos_fffeb3ab353ef1d6_115_loadManifest,"DefaultAssetLibrary","loadManifest",0x6f596c77,"DefaultAssetLibrary.loadManifest","DefaultAssetLibrary.hx",115,0x0fc48912)
...
HXLINE(  55)		::String id = HX_("assets/etc/app.png",55,60,ca,dd);
HXLINE(  56)		useManifest = true;
HXLINE(  57)		id = HX_("assets/etc/bg.png",a7,99,30,71);
HXDLIN(  57)		useManifest = true;
HXLINE(  58)		id = HX_("assets/etc/bgm.ogg",e2,11,f5,b3);
HXDLIN(  58)		useManifest = true;
HXLINE(  59)		id = HX_("assets/etc/card.png",f2,5a,a8,ee);
HXDLIN(  59)		useManifest = true;
HXLINE(  60)		id = HX_("assets/etc/err.ogg",bf,54,a3,77);
HXDLIN(  60)		useManifest = true;
HXLINE(  61)		id = HX_("assets/etc/info.png",90,1c,8e,eb);
HXDLIN(  61)		useManifest = true;
HXLINE(  62)		id = HX_("assets/etc/lucon.ttf",8a,7b,49,6b);
HXLINE(  63)		this->classTypes->set(id,hx::ClassOf< ::__ASSET__assets_etc_lucon_ttf >());
HXLINE(  64)		this->types->set(id,HX_("FONT",cf,25,81,2e));
HXLINE(  67)		id = HX_("assets/etc/map.png",d0,87,71,d1);
HXDLIN(  67)		useManifest = true;
HXLINE(  68)		id = HX_("assets/etc/pop.ogg",eb,30,30,e7);
HXDLIN(  68)		useManifest = true;
HXLINE(  69)		id = HX_("assets/etc/push.ogg",a2,53,da,c9);
HXDLIN(  69)		useManifest = true;
HXLINE(  70)		id = HX_("assets/etc/slide.ogg",cb,18,12,92);
HXDLIN(  70)		useManifest = true;
HXLINE(  71)		id = HX_("assets/field/l.png",86,46,51,94);
HXDLIN(  71)		useManifest = true;
HXLINE(  72)		id = HX_("assets/field/m.png",07,db,b7,27);
HXDLIN(  72)		useManifest = true;
HXLINE(  73)		id = HX_("assets/field/r.png",8c,c1,b8,08);
HXDLIN(  73)		useManifest = true;
HXLINE(  76)		if (useManifest) {
HXLINE(  78)			this->loadManifest();
            		}
            	}
...
void DefaultAssetLibrary_obj::loadManifest(){
            	HX_STACKFRAME(&_hx_pos_fffeb3ab353ef1d6_115_loadManifest)
HXLINE( 117)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET_MANIFEST__",fe,d8,3a,3a));
HXLINE( 118)		 ::Dynamic manifest;
HXLINE( 120)		if (hx::IsNotNull( bytes )) {
HXLINE( 122)			 ::lime::utils::AssetManifest manifest1 = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXLINE( 123)			manifest1->basePath = this->rootPath;
HXLINE( 124)			this->_hx___fromManifest(manifest1);
            		}
            		else {
HXLINE( 130)			 ::lime::utils::AssetManifest manifest2 = ::lime::utils::AssetManifest_obj::fromFile((this->rootPath + HX_("manifest",af,fb,29,d0)));
HXLINE( 132)			if (hx::IsNotNull( manifest2 )) {
HXLINE( 134)				manifest2->basePath = this->rootPath;
HXLINE( 135)				this->_hx___fromManifest(manifest2);
            			}
            			else {
HXLINE( 139)				::lime::utils::Log_obj::warn(HX_("Could not load asset manifest (bytes was null)",21,51,77,e6),hx::SourceInfo(HX_("DefaultAssetLibrary.hx",12,89,c4,0f),139,HX_("DefaultAssetLibrary",2c,3d,78,3a),HX_("loadManifest",f5,e7,92,89)));
            			}
            		}
            	}
