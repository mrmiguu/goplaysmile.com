...
void DefaultAssetLibrary_obj::__construct(){
            	HX_STACK_FRAME("DefaultAssetLibrary","new",0xbc37e41e,"DefaultAssetLibrary.new","DefaultAssetLibrary.hx",27,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE(  29)		super::__construct();
HXLINE(  31)		Bool _hx_tmp;
HXDLIN(  31)		Bool _hx_tmp1 = hx::IsNotNull( ::ApplicationMain_obj::config );
...
HXLINE(  33)			this->rootPath = ::Reflect_obj::field(::ApplicationMain_obj::config,HX_("assetsPrefix",75,5a,70,e4));
            		}
HXLINE(  37)		Bool _hx_tmp2 = hx::IsNull( this->rootPath );
HXDLIN(  37)		if (_hx_tmp2) {
HXLINE(  42)			::String _hx_tmp3 = ::Sys_obj::programPath();
HXDLIN(  42)			::String _hx_tmp4 = ::haxe::io::Path_obj::directory(_hx_tmp3);
HXDLIN(  42)			::String _hx_tmp5 = ::sys::FileSystem_obj::absolutePath(_hx_tmp4);
HXDLIN(  42)			this->rootPath = (_hx_tmp5 + HX_("/",2f,00,00,00));
            		}
HXLINE(  50)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__assets_etc_lucon_ttf >());
HXLINE(  63)		this->classTypes->set(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),hx::ClassOf< ::__ASSET__assets_etc_lucon_ttf >());
HXLINE(  64)		this->types->set(HX_("assets/etc/lucon.ttf",8a,7b,49,6b),HX_("FONT",cf,25,81,2e));
...
void DefaultAssetLibrary_obj::loadManifest(){
            	HX_STACK_FRAME("DefaultAssetLibrary","loadManifest",0x6f596c77,"DefaultAssetLibrary.loadManifest","DefaultAssetLibrary.hx",115,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE( 117)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(HX_("__ASSET_MANIFEST__",fe,d8,3a,3a));
HXLINE( 120)		Bool _hx_tmp = hx::IsNotNull( bytes );
HXDLIN( 120)		if (_hx_tmp) {
HXLINE( 122)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXLINE( 123)			manifest->basePath = this->rootPath;
HXLINE( 124)			this->_hx___fromManifest(manifest);
            		}
            		else {
HXLINE( 130)			HX_VARI_NAME(  ::lime::utils::AssetManifest,manifest1,"manifest") = ::lime::utils::AssetManifest_obj::fromFile((this->rootPath + HX_("manifest",af,fb,29,d0)));
HXLINE( 132)			Bool _hx_tmp1 = hx::IsNotNull( manifest1 );
HXDLIN( 132)			if (_hx_tmp1) {
HXLINE( 134)				manifest1->basePath = this->rootPath;
HXLINE( 135)				this->_hx___fromManifest(manifest1);
            			}
            			else {
