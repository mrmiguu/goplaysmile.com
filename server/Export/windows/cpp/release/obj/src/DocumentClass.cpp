...
HX_DEFINE_STACK_FRAME(_hx_pos_9453f8fd92a21d0a_336_new,"DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",336,0x0780ded5)

void DocumentClass_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_9453f8fd92a21d0a_336_new)
...
bool DocumentClass_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1b123bf8) {
		...
		if (inClassId<=(int)0x3e03a6fd) {
			return inClassId==(int)0x1f9085ab || inClassId==(int)0x3e03a6fd;
		} else {
