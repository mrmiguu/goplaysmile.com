...
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_33_toString,"openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",33,0x9d2fc215)
...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  22)		HX_VARI(  ::openfl::events::ErrorEvent,event) =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
