...
Dynamic StageQuality_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic StageQuality_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","fromString",0xd5e08bb0,"openfl.display._StageQuality.StageQuality_Impl_.fromString","openfl/display/StageQuality.hx",13,0x4c0ba3d1)
...
::String StageQuality_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","toString",0x0c5a9f41,"openfl.display._StageQuality.StageQuality_Impl_.toString","openfl/display/StageQuality.hx",27,0x4c0ba3d1)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",6,0x4c0ba3d1)
HXLINE(   6)		BEST = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",7,0x4c0ba3d1)
HXLINE(   7)		HIGH = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",8,0x4c0ba3d1)
HXLINE(   8)		LOW = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",9,0x4c0ba3d1)
