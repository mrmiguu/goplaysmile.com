...
void TileData_obj::__construct( ::openfl::geom::Rectangle rect){
            	HX_STACK_FRAME("openfl.display._Tileset.TileData","new",0xde68fe79,"openfl.display._Tileset.TileData.new","openfl/display/Tileset.hx",122,0x8bc15676)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE( 122)		Bool _hx_tmp = hx::IsNotNull( rect );
...
void TileData_obj::_hx___update( ::openfl::display::BitmapData bitmapData){
            	HX_STACK_FRAME("openfl.display._Tileset.TileData","__update",0x8e850870,"openfl.display._Tileset.TileData.__update","openfl/display/Tileset.hx",136,0x8bc15676)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bitmapData,"bitmapData")
HXLINE( 136)		Bool _hx_tmp = hx::IsNotNull( bitmapData );
...
HXLINE( 140)			Int _hx_tmp1 = (this->x + this->width);
HXDLIN( 140)			this->_hx___uvWidth = ((Float)_hx_tmp1 / (Float)bitmapData->width);
HXLINE( 141)			Int _hx_tmp2 = (this->y + this->height);
HXDLIN( 141)			this->_hx___uvHeight = ((Float)_hx_tmp2 / (Float)bitmapData->height);
            		}
            	}
