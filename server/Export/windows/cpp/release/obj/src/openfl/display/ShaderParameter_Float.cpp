...
HX_DEFINE_STACK_FRAME(_hx_pos_8c0b4e9630d09afb_18_new,"openfl.display.ShaderParameter_Float","new",0x2b32a149,"openfl.display.ShaderParameter_Float.new","openfl/display/ShaderParameter.hx",18,0xc89f13e6)
namespace openfl{
namespace display{

void ShaderParameter_Float_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8c0b4e9630d09afb_18_new)
            	HX_STACK_THIS(this)
HXLINE(  18)		this->index = (int)0;
            	}
