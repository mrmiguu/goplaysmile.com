...
HX_DEFINE_STACK_FRAME(_hx_pos_a97783d1d5c47922_698_new,"openfl.display._MovieClip.TimelineObject","new",0xc9ce6cb5,"openfl.display._MovieClip.TimelineObject.new","openfl/display/MovieClip.hx",698,0x2b84738a)
namespace openfl{
namespace display{
namespace _MovieClip{

void TimelineObject_obj::__construct(int id,int depth, ::openfl::display::DisplayObject displayObject){
            	HX_STACKFRAME(&_hx_pos_a97783d1d5c47922_698_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(depth,"depth")
            	HX_STACK_ARG(displayObject,"displayObject")
HXLINE( 700)		this->id = id;
HXLINE( 701)		this->depth = depth;
HXLINE( 702)		this->displayObject = displayObject;
            	}
...
hx::ObjectPtr< TimelineObject_obj > TimelineObject_obj::__new(int id,int depth, ::openfl::display::DisplayObject displayObject) {
	...
	__this->__construct(id,depth,displayObject);
	return __this;
}

hx::ObjectPtr< TimelineObject_obj > TimelineObject_obj::__alloc(hx::Ctx *_hx_ctx,int id,int depth, ::openfl::display::DisplayObject displayObject) {
