...
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_36_clone,"openfl.filters.BlurFilter","clone",0xcbbf4c3f,"openfl.filters.BlurFilter.clone","openfl/filters/BlurFilter.hx",36,0x46563eac)
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_41___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",41,0x46563eac)
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_71_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",71,0x46563eac)
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_13_boot,"openfl.filters.BlurFilter","boot",0xbff97d90,"openfl.filters.BlurFilter.boot","openfl/filters/BlurFilter.hx",13,0x46563eac)
namespace openfl{
namespace filters{
...
HXLINE(  48)			 ::Dynamic( ::Dynamic(data->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)0,(this->blurX * ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1))));
...
HXLINE(  53)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),((int)(pass - this->horizontalPasses) >> (int)(int)1));
...
HXLINE(  55)			 ::Dynamic( ::Dynamic(data->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)1,(this->blurY * scale));
            		}
...
HXLINE(  75)			_hx_tmp = (::Math_obj::round((this->blurX * ((Float)value / (Float)(int)4))) + (int)1);
            		}
...
HXLINE(  76)			_hx_tmp1 = (::Math_obj::round((this->blurY * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN(  76)		this->verticalPasses = _hx_tmp1;
