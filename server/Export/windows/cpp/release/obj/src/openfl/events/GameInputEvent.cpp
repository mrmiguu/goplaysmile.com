...
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_26_clone,"openfl.events.GameInputEvent","clone",0x205df1e8,"openfl.events.GameInputEvent.clone","openfl/events/GameInputEvent.hx",26,0x5318f185)
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_39_toString,"openfl.events.GameInputEvent","toString",0x31f35b01,"openfl.events.GameInputEvent.toString","openfl/events/GameInputEvent.hx",39,0x5318f185)
...
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_10_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",10,0x5318f185)
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_11_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",11,0x5318f185)
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_12_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",12,0x5318f185)
namespace openfl{
namespace events{
...
bool GameInputEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event GameInputEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  28)		HX_VARI(  ::openfl::events::GameInputEvent,event) =  ::openfl::events::GameInputEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->device);
