...
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_105___disable,"openfl.display.Shader","__disable",0x171f2ca9,"openfl.display.Shader.__disable","openfl/display/Shader.hx",105,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_114___disableGL,"openfl.display.Shader","__disableGL",0x7ec2a70e,"openfl.display.Shader.__disableGL","openfl/display/Shader.hx",114,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_150___enable,"openfl.display.Shader","__enable",0x8f5f3ee2,"openfl.display.Shader.__enable","openfl/display/Shader.hx",150,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_163___enableGL,"openfl.display.Shader","__enableGL",0x94d67987,"openfl.display.Shader.__enableGL","openfl/display/Shader.hx",163,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_185___init,"openfl.display.Shader","__init",0x2faba5af,"openfl.display.Shader.__init","openfl/display/Shader.hx",185,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_202___initGL,"openfl.display.Shader","__initGL",0x2e23ed94,"openfl.display.Shader.__initGL","openfl/display/Shader.hx",202,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_302___processGLData,"openfl.display.Shader","__processGLData",0x90b8a01f,"openfl.display.Shader.__processGLData","openfl/display/Shader.hx",302,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_399___update,"openfl.display.Shader","__update",0x1ddd1668,"openfl.display.Shader.__update","openfl/display/Shader.hx",399,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_408___updateGL,"openfl.display.Shader","__updateGL",0x201dbe8d,"openfl.display.Shader.__updateGL","openfl/display/Shader.hx",408,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_597_get_data,"openfl.display.Shader","get_data",0xb0c636f2,"openfl.display.Shader.get_data","openfl/display/Shader.hx",597,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_612_set_data,"openfl.display.Shader","set_data",0x5f239066,"openfl.display.Shader.set_data","openfl/display/Shader.hx",612,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_619_get_glFragmentSource,"openfl.display.Shader","get_glFragmentSource",0x5d5fb298,"openfl.display.Shader.get_glFragmentSource","openfl/display/Shader.hx",619,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_624_set_glFragmentSource,"openfl.display.Shader","set_glFragmentSource",0x2a176a0c,"openfl.display.Shader.set_glFragmentSource","openfl/display/Shader.hx",624,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_639_get_glVertexSource,"openfl.display.Shader","get_glVertexSource",0xa3c917ec,"openfl.display.Shader.get_glVertexSource","openfl/display/Shader.hx",639,0xae8f5dcd)
HX_DEFINE_STACK_FRAME(_hx_pos_4b006e5218f2daf8_644_set_glVertexSource,"openfl.display.Shader","set_glVertexSource",0x80784a60,"openfl.display.Shader.set_glVertexSource","openfl/display/Shader.hx",644,0xae8f5dcd)
namespace openfl{
namespace display{
...
HXLINE( 216)			this->_hx___uniformMatrix2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)4,(int)8);
HXLINE( 217)			this->_hx___uniformMatrix3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)9,(int)8);
HXLINE( 218)			this->_hx___uniformMatrix4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)16,(int)8);
...
HXLINE( 235)			this->glProgram = ::lime::utils::GLUtils_obj::createProgram(this->get_glVertexSource(),(((HX_("#ifdef GL_ES\n\t\t\t\tprecision ",df,92,6a,64) + fragment) + HX_(" float;\n\t\t\t\t#endif\n\t\t\t\t",ea,d3,26,bb)) + this->get_glFragmentSource()));
...
HXLINE( 323)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 361)					HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 369)					HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter1,"parameter") =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 367)					goto _hx_goto_17;
            				...
            				/* default */{
HXLINE( 377)					HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter2,"parameter") =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
...
HXLINE( 416)					this->gl->activeTexture((this->gl->TEXTURE0 + textureCount));
HXLINE( 417)					 ::lime::_backend::native::NativeGLRenderContext _hx_tmp = this->gl;
HXDLIN( 417)					int _hx_tmp1 = this->gl->TEXTURE_2D;
HXDLIN( 417)					_hx_tmp->bindTexture(_hx_tmp1,input->input->getTexture(this->gl));
...
HXLINE( 446)					 ::Dynamic _hx_switch_0 = parameter->type;
            					if (  (_hx_switch_0==(int)0) ){
HXLINE( 450)						int _hx_tmp2;
HXDLIN( 450)						if (value->__get((int)0)) {
HXLINE( 450)							_hx_tmp2 = (int)1;
            						}
            						else {
HXLINE( 450)							_hx_tmp2 = (int)0;
            						}
HXDLIN( 450)						this->gl->uniform1i(( (int)(index) ),_hx_tmp2);
HXDLIN( 450)						goto _hx_goto_22;
            					}
            					if (  (_hx_switch_0==(int)1) ){
HXLINE( 454)						int _hx_tmp3;
HXDLIN( 454)						if (value->__get((int)0)) {
HXLINE( 454)							_hx_tmp3 = (int)1;
            						}
            						else {
HXLINE( 454)							_hx_tmp3 = (int)0;
            						}
HXDLIN( 454)						int _hx_tmp4;
...
HXDLIN( 454)						this->gl->uniform2i(( (int)(index) ),_hx_tmp3,_hx_tmp4);
HXDLIN( 454)						goto _hx_goto_22;
            					}
            					if (  (_hx_switch_0==(int)2) ){
HXLINE( 458)						int _hx_tmp5;
HXDLIN( 458)						if (value->__get((int)0)) {
HXLINE( 458)							_hx_tmp5 = (int)1;
            						}
            						else {
HXLINE( 458)							_hx_tmp5 = (int)0;
            						}
HXDLIN( 458)						int _hx_tmp6;
...
HXDLIN( 458)						this->gl->uniform3i(( (int)(index) ),_hx_tmp5,_hx_tmp6,_hx_tmp7);
HXDLIN( 458)						goto _hx_goto_22;
            					}
            					if (  (_hx_switch_0==(int)3) ){
HXLINE( 462)						int _hx_tmp8;
HXDLIN( 462)						if (value->__get((int)0)) {
HXLINE( 462)							_hx_tmp8 = (int)1;
            						}
            						else {
HXLINE( 462)							_hx_tmp8 = (int)0;
            						}
HXDLIN( 462)						int _hx_tmp9;
...
HXDLIN( 462)						this->gl->uniform4i(( (int)(index) ),_hx_tmp8,_hx_tmp9,_hx_tmp10,_hx_tmp11);
...
HXLINE( 483)					 ::Dynamic _hx_switch_1 = parameter1->type;
            					if (  (_hx_switch_1==(int)4) ){
HXLINE( 487)						this->gl->uniform1f(( (int)(index) ),value1->__get((int)0));
HXDLIN( 487)						goto _hx_goto_24;
            					}
            					if (  (_hx_switch_1==(int)5) ){
HXLINE( 491)						this->gl->uniform2f(( (int)(index) ),value1->__get((int)0),value1->__get((int)1));
HXDLIN( 491)						goto _hx_goto_24;
            					}
            					if (  (_hx_switch_1==(int)6) ){
HXLINE( 495)						this->gl->uniform3f(( (int)(index) ),value1->__get((int)0),value1->__get((int)1),value1->__get((int)2));
HXDLIN( 495)						goto _hx_goto_24;
            					}
            					if (  (_hx_switch_1==(int)7) ){
HXLINE( 499)						this->gl->uniform4f(( (int)(index) ),value1->__get((int)0),value1->__get((int)1),value1->__get((int)2),value1->__get((int)3));
HXDLIN( 499)						goto _hx_goto_24;
            					}
            					if (  (_hx_switch_1==(int)12) ){
HXLINE( 503)						{
HXLINE( 503)							HX_VARI_NAME( int,_g21,"_g2") = (int)0;
HXDLIN( 503)							while((_g21 < (int)4)){
HXLINE( 503)								_g21 = (_g21 + (int)1);
HXDLIN( 503)								HX_VARI( int,i) = (_g21 - (int)1);
HXLINE( 505)								{
HXLINE( 505)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this1,"this") = this->_hx___uniformMatrix2;
HXDLIN( 505)									::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + (i * (int)4)),value1->__get(i));
            								}
            							}
            						}
...
HXLINE( 517)						{
HXLINE( 517)							HX_VARI_NAME( int,_g22,"_g2") = (int)0;
HXDLIN( 517)							while((_g22 < (int)9)){
HXLINE( 517)								_g22 = (_g22 + (int)1);
HXDLIN( 517)								HX_VARI_NAME( int,i1,"i") = (_g22 - (int)1);
HXLINE( 519)								{
HXLINE( 519)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this2,"this") = this->_hx___uniformMatrix3;
HXDLIN( 519)									::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + (i1 * (int)4)),value1->__get(i1));
            								}
            							}
            						}
...
HXLINE( 531)						{
HXLINE( 531)							HX_VARI_NAME( int,_g23,"_g2") = (int)0;
HXDLIN( 531)							while((_g23 < (int)16)){
HXLINE( 531)								_g23 = (_g23 + (int)1);
HXDLIN( 531)								HX_VARI_NAME( int,i2,"i") = (_g23 - (int)1);
HXLINE( 533)								{
HXLINE( 533)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this3,"this") = this->_hx___uniformMatrix4;
HXDLIN( 533)									::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (i2 * (int)4)),value1->__get(i2));
            								}
            							}
            						}
...
HXLINE( 557)					 ::Dynamic _hx_switch_2 = parameter2->type;
            					if (  (_hx_switch_2==(int)8) ){
HXLINE( 561)						this->gl->uniform1i(( (int)(index) ),value2->__get((int)0));
HXDLIN( 561)						goto _hx_goto_29;
            					}
            					if (  (_hx_switch_2==(int)9) ){
HXLINE( 565)						this->gl->uniform2i(( (int)(index) ),value2->__get((int)0),value2->__get((int)1));
HXDLIN( 565)						goto _hx_goto_29;
            					}
            					if (  (_hx_switch_2==(int)10) ){
HXLINE( 569)						this->gl->uniform3i(( (int)(index) ),value2->__get((int)0),value2->__get((int)1),value2->__get((int)2));
HXDLIN( 569)						goto _hx_goto_29;
            					}
            					if (  (_hx_switch_2==(int)11) ){
HXLINE( 573)						this->gl->uniform4i(( (int)(index) ),value2->__get((int)0),value2->__get((int)1),value2->__get((int)2),value2->__get((int)3));
