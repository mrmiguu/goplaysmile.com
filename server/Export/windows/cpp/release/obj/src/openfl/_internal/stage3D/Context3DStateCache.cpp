...
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_46_clearRegisters,"openfl._internal.stage3D.Context3DStateCache","clearRegisters",0x47eb38af,"openfl._internal.stage3D.Context3DStateCache.clearRegisters","openfl/_internal/stage3D/Context3DStateCache.hx",46,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_55_clearSettings,"openfl._internal.stage3D.Context3DStateCache","clearSettings",0x4de179c4,"openfl._internal.stage3D.Context3DStateCache.clearSettings","openfl/_internal/stage3D/Context3DStateCache.hx",55,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_76_updateActiveTextureSample,"openfl._internal.stage3D.Context3DStateCache","updateActiveTextureSample",0xbea3116a,"openfl._internal.stage3D.Context3DStateCache.updateActiveTextureSample","openfl/_internal/stage3D/Context3DStateCache.hx",76,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_90_updateActiveVertexArray,"openfl._internal.stage3D.Context3DStateCache","updateActiveVertexArray",0x147a1a5a,"openfl._internal.stage3D.Context3DStateCache.updateActiveVertexArray","openfl/_internal/stage3D/Context3DStateCache.hx",90,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_104_updateBlendDestFactor,"openfl._internal.stage3D.Context3DStateCache","updateBlendDestFactor",0xd0cb3ead,"openfl._internal.stage3D.Context3DStateCache.updateBlendDestFactor","openfl/_internal/stage3D/Context3DStateCache.hx",104,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_118_updateBlendSrcFactor,"openfl._internal.stage3D.Context3DStateCache","updateBlendSrcFactor",0x54a68877,"openfl._internal.stage3D.Context3DStateCache.updateBlendSrcFactor","openfl/_internal/stage3D/Context3DStateCache.hx",118,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_132_updateCullingMode,"openfl._internal.stage3D.Context3DStateCache","updateCullingMode",0x8ec7aa9e,"openfl._internal.stage3D.Context3DStateCache.updateCullingMode","openfl/_internal/stage3D/Context3DStateCache.hx",132,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_146_updateDepthCompareMode,"openfl._internal.stage3D.Context3DStateCache","updateDepthCompareMode",0xcaf041da,"openfl._internal.stage3D.Context3DStateCache.updateDepthCompareMode","openfl/_internal/stage3D/Context3DStateCache.hx",146,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_160_updateDepthTestEnabled,"openfl._internal.stage3D.Context3DStateCache","updateDepthTestEnabled",0x47bd6581,"openfl._internal.stage3D.Context3DStateCache.updateDepthTestEnabled","openfl/_internal/stage3D/Context3DStateCache.hx",160,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_174_updateDepthTestMask,"openfl._internal.stage3D.Context3DStateCache","updateDepthTestMask",0xcdb33fec,"openfl._internal.stage3D.Context3DStateCache.updateDepthTestMask","openfl/_internal/stage3D/Context3DStateCache.hx",174,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_188_updateProgram3D,"openfl._internal.stage3D.Context3DStateCache","updateProgram3D",0x56efe020,"openfl._internal.stage3D.Context3DStateCache.updateProgram3D","openfl/_internal/stage3D/Context3DStateCache.hx",188,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_204_updateRegisters,"openfl._internal.stage3D.Context3DStateCache","updateRegisters",0x353db09b,"openfl._internal.stage3D.Context3DStateCache.updateRegisters","openfl/_internal/stage3D/Context3DStateCache.hx",204,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_229_updateViewport,"openfl._internal.stage3D.Context3DStateCache","updateViewport",0xa0a332db,"openfl._internal.stage3D.Context3DStateCache.updateViewport","openfl/_internal/stage3D/Context3DStateCache.hx",229,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_14_boot,"openfl._internal.stage3D.Context3DStateCache","boot",0xaaeca07e,"openfl._internal.stage3D.Context3DStateCache.boot","openfl/_internal/stage3D/Context3DStateCache.hx",14,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_15_boot,"openfl._internal.stage3D.Context3DStateCache","boot",0xaaeca07e,"openfl._internal.stage3D.Context3DStateCache.boot","openfl/_internal/stage3D/Context3DStateCache.hx",15,0xc7f853df)
HX_DEFINE_STACK_FRAME(_hx_pos_f8511bb00bf8f55e_17_boot,"openfl._internal.stage3D.Context3DStateCache","boot",0xaaeca07e,"openfl._internal.stage3D.Context3DStateCache.boot","openfl/_internal/stage3D/Context3DStateCache.hx",17,0xc7f853df)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void Context3DStateCache_obj::clearRegisters(){
            	HX_STACKFRAME(&_hx_pos_f8511bb00bf8f55e_46_clearRegisters)
            	HX_STACK_THIS(this)
HXLINE(  46)		HX_VARI( int,_g1) = (int)0;
HXDLIN(  46)		while((_g1 < (int)4096)){
HXLINE(  46)			_g1 = (_g1 + (int)1);
HXLINE(  48)			this->_registers->set((_g1 - (int)1),((Float)-999999999.0));
            		}
            	}
