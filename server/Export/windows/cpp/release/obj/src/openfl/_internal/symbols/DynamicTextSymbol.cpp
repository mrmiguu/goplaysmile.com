...
HX_DEFINE_STACK_FRAME(_hx_pos_ea7b408073760da6_38_new,"openfl._internal.symbols.DynamicTextSymbol","new",0x78d87e53,"openfl._internal.symbols.DynamicTextSymbol.new","openfl/_internal/symbols/DynamicTextSymbol.hx",38,0xa6a1bd40)
HX_DEFINE_STACK_FRAME(_hx_pos_ea7b408073760da6_43___createObject,"openfl._internal.symbols.DynamicTextSymbol","__createObject",0x2c1ac2e8,"openfl._internal.symbols.DynamicTextSymbol.__createObject","openfl/_internal/symbols/DynamicTextSymbol.hx",43,0xa6a1bd40)
namespace openfl{
namespace _internal{
namespace symbols{

void DynamicTextSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ea7b408073760da6_38_new)
            	HX_STACK_THIS(this)
...
bool DynamicTextSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject DynamicTextSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_ea7b408073760da6_43___createObject)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  45)		HX_VARI(  ::openfl::text::TextField,textField) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXLINE(  46)		textField->_hx___fromSymbol(swf,hx::ObjectPtr<OBJ_>(this));
HXLINE(  47)		return textField;
            	}
