...
HXLINE(  21)		if (hx::IsNotNull( stage3D->context3D )) {
HXLINE(  23)			renderSession->blendModeManager->setBlendMode(null());
HXLINE(  25)			if (hx::IsNotNull( renderSession->shaderManager->currentShader )) {
HXLINE(  27)				renderSession->shaderManager->setShader(null());
HXLINE(  29)				if (hx::IsNotNull( stage3D->context3D->_hx___program )) {
HXLINE(  31)					stage3D->context3D->_hx___program->_hx___use();
            				}
            			}
            		}
            	}
