...
HX_DEFINE_STACK_FRAME(_hx_pos_6171a03a509a36a4_281__new,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","_new",0x02b6a548,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",281,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_6171a03a509a36a4_282_get_controlX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlX",0xd0ea894b,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlX","openfl/_internal/renderer/DrawCommandReader.hx",282,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_6171a03a509a36a4_283_get_controlY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlY",0xd0ea894c,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlY","openfl/_internal/renderer/DrawCommandReader.hx",283,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_6171a03a509a36a4_284_get_anchorX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorX",0x40299753,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorX","openfl/_internal/renderer/DrawCommandReader.hx",284,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_6171a03a509a36a4_285_get_anchorY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorY",0x40299754,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorY","openfl/_internal/renderer/DrawCommandReader.hx",285,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
HXLINE( 282)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float CurveToView_Impl__obj::get_controlY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 283)		return this1->buffer->f->__get((this1->fPos + (int)1));
            	}
...
Float CurveToView_Impl__obj::get_anchorX( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 284)		return this1->buffer->f->__get((this1->fPos + (int)2));
            	}
...
Float CurveToView_Impl__obj::get_anchorY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 285)		return this1->buffer->f->__get((this1->fPos + (int)3));
            	}
