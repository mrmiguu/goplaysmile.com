...
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_295_new,"openfl._Vector.BoolVector","new",0x3a8665a9,"openfl._Vector.BoolVector.new","openfl/Vector.hx",295,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_318_concat,"openfl._Vector.BoolVector","concat",0x25e9276b,"openfl._Vector.BoolVector.concat","openfl/Vector.hx",318,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_333_copy,"openfl._Vector.BoolVector","copy",0xf3d4c64c,"openfl._Vector.BoolVector.copy","openfl/Vector.hx",333,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_340_get,"openfl._Vector.BoolVector","get",0x3a8115df,"openfl._Vector.BoolVector.get","openfl/Vector.hx",340,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_353_indexOf,"openfl._Vector.BoolVector","indexOf",0xd8a0b692,"openfl._Vector.BoolVector.indexOf","openfl/Vector.hx",353,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_372_insertAt,"openfl._Vector.BoolVector","insertAt",0xaf7e1ea3,"openfl._Vector.BoolVector.insertAt","openfl/Vector.hx",372,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_383_iterator,"openfl._Vector.BoolVector","iterator",0x80f8ec05,"openfl._Vector.BoolVector.iterator","openfl/Vector.hx",383,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_390_join,"openfl._Vector.BoolVector","join",0xf8753e81,"openfl._Vector.BoolVector.join","openfl/Vector.hx",390,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_395_lastIndexOf,"openfl._Vector.BoolVector","lastIndexOf",0xfa91835c,"openfl._Vector.BoolVector.lastIndexOf","openfl/Vector.hx",395,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_413_pop,"openfl._Vector.BoolVector","pop",0x3a87f2da,"openfl._Vector.BoolVector.pop","openfl/Vector.hx",413,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_428_push,"openfl._Vector.BoolVector","push",0xfc711c71,"openfl._Vector.BoolVector.push","openfl/Vector.hx",428,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_443_reverse,"openfl._Vector.BoolVector","reverse",0x12dda6eb,"openfl._Vector.BoolVector.reverse","openfl/Vector.hx",443,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_450_set,"openfl._Vector.BoolVector","set",0x3a8a30eb,"openfl._Vector.BoolVector.set","openfl/Vector.hx",450,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_465_shift,"openfl._Vector.BoolVector","shift",0x981c260b,"openfl._Vector.BoolVector.shift","openfl/Vector.hx",465,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_480_slice,"openfl._Vector.BoolVector","slice",0x9ac0fddb,"openfl._Vector.BoolVector.slice","openfl/Vector.hx",480,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_487_sort,"openfl._Vector.BoolVector","sort",0xfe6831f5,"openfl._Vector.BoolVector.sort","openfl/Vector.hx",487,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_494_splice,"openfl._Vector.BoolVector","splice",0x1db7a3d3,"openfl._Vector.BoolVector.splice","openfl/Vector.hx",494,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_501_toString,"openfl._Vector.BoolVector","toString",0x25cd72c3,"openfl._Vector.BoolVector.toString","openfl/Vector.hx",501,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_508_unshift,"openfl._Vector.BoolVector","unshift",0x70955152,"openfl._Vector.BoolVector.unshift","openfl/Vector.hx",508,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_526_get_length,"openfl._Vector.BoolVector","get_length",0x8b6b9a86,"openfl._Vector.BoolVector.get_length","openfl/Vector.hx",526,0x4a01873c)
HX_DEFINE_STACK_FRAME(_hx_pos_dd7a5ba250c0e821_531_set_length,"openfl._Vector.BoolVector","set_length",0x8ee938fa,"openfl._Vector.BoolVector.set_length","openfl/Vector.hx",531,0x4a01873c)
namespace openfl{
namespace _Vector{

void BoolVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::Array< bool > array){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_295_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE( 297)		if (hx::IsNull( array )) {
HXLINE( 299)			array = ::Array_obj< bool >::__new();
            		}
HXLINE( 303)		this->_hx___array = array;
HXLINE( 305)		if (hx::IsNotNull( length )) {
HXLINE( 307)			this->set_length(length);
            		}
HXLINE( 311)		this->fixed = hx::IsEq( fixed,true );
            	}
...
::Dynamic BoolVector_obj::concat(::Dynamic a){
            	HX_GC_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_318_concat)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE( 318)		if (hx::IsNull( a )) {
HXLINE( 320)			return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            		}
            		else {
HXLINE( 324)			return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::BoolVector >::cast(a)->_hx___array));
            		}
...
::Dynamic BoolVector_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_333_copy)
            	HX_STACK_THIS(this)
HXLINE( 333)		bool _hx_tmp = this->fixed;
HXDLIN( 333)		return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),_hx_tmp,this->_hx___array->copy());
            	}
...
bool BoolVector_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_340_get)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 340)		if ((index >= this->_hx___array->length)) {
HXLINE( 342)			return false;
            		}
            		else {
HXLINE( 346)			return this->_hx___array->__get(index);
            		}
...
int BoolVector_obj::indexOf(bool x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_353_indexOf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 355)		{
HXLINE( 355)			HX_VARI( int,_g1) = from;
HXDLIN( 355)			HX_VARI( int,_g) = this->_hx___array->length;
HXDLIN( 355)			while((_g1 < _g)){
HXLINE( 355)				_g1 = (_g1 + (int)1);
HXDLIN( 355)				HX_VARI( int,i) = (_g1 - (int)1);
HXLINE( 357)				if ((this->_hx___array->__get(i) == x)) {
HXLINE( 359)					return i;
            				}
            			}
            		}
...
void BoolVector_obj::insertAt(int index,bool element){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_372_insertAt)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(element,"element")
HXLINE( 372)		bool _hx_tmp;
HXDLIN( 372)		if (!(!(this->fixed))) {
HXLINE( 372)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 372)			_hx_tmp = true;
            		}
HXDLIN( 372)		if (_hx_tmp) {
HXLINE( 374)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,insertAt,(void))
 ...
 ::Dynamic BoolVector_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_383_iterator)
            	HX_STACK_THIS(this)
HXLINE( 383)		return this->_hx___array->iterator();
            	}
...
::String BoolVector_obj::join(::String sep){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_390_join)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sep,"sep")
HXLINE( 390)		return this->_hx___array->join(sep);
            	}
...
int BoolVector_obj::lastIndexOf(bool x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_395_lastIndexOf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE( 397)		HX_VARI( int,i) = (this->_hx___array->length - (int)1);
HXLINE( 399)		while(hx::IsGreaterEq( i,from )){
HXLINE( 401)			if ((this->_hx___array->__get(i) == x)) {
HXLINE( 401)				return i;
            			}
HXLINE( 402)			i = (i - (int)1);
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,lastIndexOf,return )
 ...
 ::Dynamic BoolVector_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_413_pop)
            	HX_STACK_THIS(this)
HXLINE( 413)		if (!(this->fixed)) {
HXLINE( 415)			return this->_hx___array->pop();
            		}
            		else {
...
int BoolVector_obj::push(bool x){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_428_push)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 428)		if (!(this->fixed)) {
HXLINE( 430)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE( 434)			return this->_hx___array->length;
            		}
...
void BoolVector_obj::reverse(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 443)		this->_hx___array->reverse();
            	}
...
bool BoolVector_obj::set(int index,bool value){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_450_set)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(value,"value")
HXLINE( 450)		bool _hx_tmp;
HXDLIN( 450)		if (!(!(this->fixed))) {
HXLINE( 450)			_hx_tmp = (index < this->_hx___array->length);
            		}
            		else {
HXLINE( 450)			_hx_tmp = true;
            		}
HXDLIN( 450)		if (_hx_tmp) {
HXLINE( 452)			return (this->_hx___array[index] = value);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC2(BoolVector_obj,set,return )
 ...
 ::Dynamic BoolVector_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_465_shift)
            	HX_STACK_THIS(this)
HXLINE( 465)		if (!(this->fixed)) {
HXLINE( 467)			return this->_hx___array->shift();
            		}
            		else {
...
::Dynamic BoolVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_GC_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_480_slice)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE( 480)		return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
void BoolVector_obj::sort( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_487_sort)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 487)		this->_hx___array->sort(f);
            	}
...
::Dynamic BoolVector_obj::splice(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_494_splice)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE( 494)		return  ::openfl::_Vector::BoolVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
::String BoolVector_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_501_toString)
            	HX_STACK_THIS(this)
HXLINE( 501)		return this->_hx___array->toString();
            	}
...
void BoolVector_obj::unshift(bool x){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_508_unshift)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 508)		if (!(this->fixed)) {
HXLINE( 510)			this->_hx___array->unshift(x);
            		}
            	}
...
int BoolVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_526_get_length)
            	HX_STACK_THIS(this)
HXLINE( 526)		return this->_hx___array->length;
            	}
...
int BoolVector_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_dd7a5ba250c0e821_531_set_length)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 533)		if (!(this->fixed)) {
HXLINE( 537)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE( 566)		return this->_hx___array->length;
            	}
