...
void AbstractFilterManager_obj::__construct( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractFilterManager","new",0x8d5ceeea,"openfl._internal.renderer.AbstractFilterManager.new","openfl/_internal/renderer/AbstractFilterManager.hx",24,0x8a413d45)
            	HX_STACK_THIS(this)
...
Dynamic AbstractFilterManager_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::Shader AbstractFilterManager_obj::pushObject( ::openfl::display::DisplayObject object){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractFilterManager","pushObject",0x3dc70aef,"openfl._internal.renderer.AbstractFilterManager.pushObject","openfl/_internal/renderer/AbstractFilterManager.hx",31,0x8a413d45)
            	HX_STACK_THIS(this)
...
void AbstractFilterManager_obj::popObject( ::openfl::display::DisplayObject object){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractFilterManager","popObject",0xf9faf53a,"openfl._internal.renderer.AbstractFilterManager.popObject","openfl/_internal/renderer/AbstractFilterManager.hx",36,0x8a413d45)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	}
