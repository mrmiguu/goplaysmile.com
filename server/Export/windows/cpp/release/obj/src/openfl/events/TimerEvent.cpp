...
HX_DEFINE_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_18_clone,"openfl.events.TimerEvent","clone",0xa3bdae7b,"openfl.events.TimerEvent.clone","openfl/events/TimerEvent.hx",18,0x5c7b7b12)
HX_DEFINE_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_31_toString,"openfl.events.TimerEvent","toString",0x793b7c4e,"openfl.events.TimerEvent.toString","openfl/events/TimerEvent.hx",31,0x5c7b7b12)
static const ::String _hx_array_data_7c93b10c_3[] = {
	HX_("type",ba,f2,08,4d),HX_("bubbles",67,bb,56,61),HX_("cancelable",14,a0,79,c4),
};
HX_DEFINE_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_36_updateAfterEvent,"openfl.events.TimerEvent","updateAfterEvent",0xcd7c1969,"openfl.events.TimerEvent.updateAfterEvent","openfl/events/TimerEvent.hx",36,0x5c7b7b12)
HX_DEFINE_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_7_boot,"openfl.events.TimerEvent","boot",0xc33d36d4,"openfl.events.TimerEvent.boot","openfl/events/TimerEvent.hx",7,0x5c7b7b12)
HX_DEFINE_STACK_FRAME(_hx_pos_8ee12f816d5b32f3_8_boot,"openfl.events.TimerEvent","boot",0xc33d36d4,"openfl.events.TimerEvent.boot","openfl/events/TimerEvent.hx",8,0x5c7b7b12)
namespace openfl{
namespace events{
...
bool TimerEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TimerEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  20)		HX_VARI(  ::openfl::events::TimerEvent,event) =  ::openfl::events::TimerEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
