...
HX_DEFINE_STACK_FRAME(_hx_pos_c141c49e61a6a76a_22_new,"openfl._internal.renderer.cairo.CairoRenderer","new",0x7d599cdc,"openfl._internal.renderer.cairo.CairoRenderer.new","openfl/_internal/renderer/cairo/CairoRenderer.hx",22,0x849037d4)
HX_LOCAL_STACK_FRAME(_hx_pos_c141c49e61a6a76a_42_clear,"openfl._internal.renderer.cairo.CairoRenderer","clear",0x6bca5509,"openfl._internal.renderer.cairo.CairoRenderer.clear","openfl/_internal/renderer/cairo/CairoRenderer.hx",42,0x849037d4)
HX_LOCAL_STACK_FRAME(_hx_pos_c141c49e61a6a76a_51_render,"openfl._internal.renderer.cairo.CairoRenderer","render",0xe2c1945a,"openfl._internal.renderer.cairo.CairoRenderer.render","openfl/_internal/renderer/cairo/CairoRenderer.hx",51,0x849037d4)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
void CairoRenderer_obj::__construct( ::openfl::display::Stage stage, ::lime::graphics::cairo::Cairo cairo){
            	HX_GC_STACKFRAME(&_hx_pos_c141c49e61a6a76a_22_new)
HXLINE(  24)		super::__construct(stage);
HXLINE(  27)		this->cairo = cairo;
HXLINE(  29)		this->renderSession =  ::openfl::_internal::renderer::RenderSession_obj::__alloc( HX_CTX );
HXLINE(  30)		this->renderSession->cairo = cairo;
HXLINE(  32)		this->renderSession->renderer = hx::ObjectPtr<OBJ_>(this);
HXLINE(  33)		this->renderSession->maskManager =  ::openfl::_internal::renderer::cairo::CairoMaskManager_obj::__alloc( HX_CTX ,this->renderSession);
HXLINE(  34)		this->renderSession->blendModeManager =  ::openfl::_internal::renderer::cairo::CairoBlendModeManager_obj::__alloc( HX_CTX ,this->renderSession);
            	}
...
void CairoRenderer_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_c141c49e61a6a76a_42_clear)
HXLINE(  42)		int _g = (int)0;
HXDLIN(  42)		 ::openfl::_Vector::ObjectVector _g1 = this->stage->stage3Ds;
HXDLIN(  42)		while((_g < _g1->get_length())){
HXLINE(  42)			 ::openfl::display::Stage3D stage3D = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN(  42)			_g = (_g + (int)1);
HXLINE(  44)			stage3D->_hx___renderCairo(this->stage,this->renderSession);
            		}
            	}


void CairoRenderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_c141c49e61a6a76a_51_render)
HXLINE(  53)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE(  55)		this->cairo->identityMatrix();
HXLINE(  57)		if (this->stage->_hx___clearBeforeRender) {
HXLINE(  59)			 ::lime::graphics::cairo::Cairo _hx_tmp = this->cairo;
HXDLIN(  59)			Float _hx_tmp1 = this->stage->_hx___colorSplit->__get((int)0);
HXDLIN(  59)			Float _hx_tmp2 = this->stage->_hx___colorSplit->__get((int)1);
HXDLIN(  59)			_hx_tmp->setSourceRGB(_hx_tmp1,_hx_tmp2,this->stage->_hx___colorSplit->__get((int)2));
HXLINE(  60)			this->cairo->paint();
            		}
