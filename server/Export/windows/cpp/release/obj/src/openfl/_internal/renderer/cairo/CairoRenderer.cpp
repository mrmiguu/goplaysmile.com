...
HX_DEFINE_STACK_FRAME(_hx_pos_c141c49e61a6a76a_42_clear,"openfl._internal.renderer.cairo.CairoRenderer","clear",0x6bca5509,"openfl._internal.renderer.cairo.CairoRenderer.clear","openfl/_internal/renderer/cairo/CairoRenderer.hx",42,0x849037d4)
HX_DEFINE_STACK_FRAME(_hx_pos_c141c49e61a6a76a_51_render,"openfl._internal.renderer.cairo.CairoRenderer","render",0xe2c1945a,"openfl._internal.renderer.cairo.CairoRenderer.render","openfl/_internal/renderer/cairo/CairoRenderer.hx",51,0x849037d4)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
HXLINE(  31)		this->renderSession->roundPixels = true;
...
HXDLIN(  42)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN(  42)		while((_g < _g1->get_length())){
HXLINE(  42)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
...
HXLINE(  59)			this->cairo->setSourceRGB(this->stage->_hx___colorSplit->__get((int)0),this->stage->_hx___colorSplit->__get((int)1),this->stage->_hx___colorSplit->__get((int)2));
