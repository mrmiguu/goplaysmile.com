...
HX_DEFINE_STACK_FRAME(_hx_pos_bac8fa62cbacae74_17_new,"openfl._internal.renderer.cairo.CairoBlendModeManager","new",0xb5137212,"openfl._internal.renderer.cairo.CairoBlendModeManager.new","openfl/_internal/renderer/cairo/CairoBlendModeManager.hx",17,0x538d3b5e)
HX_DEFINE_STACK_FRAME(_hx_pos_bac8fa62cbacae74_26_setBlendMode,"openfl._internal.renderer.cairo.CairoBlendModeManager","setBlendMode",0xf5133c60,"openfl._internal.renderer.cairo.CairoBlendModeManager.setBlendMode","openfl/_internal/renderer/cairo/CairoBlendModeManager.hx",26,0x538d3b5e)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
void CairoBlendModeManager_obj::__construct( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_bac8fa62cbacae74_17_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE(  19)		super::__construct();
HXLINE(  21)		this->renderSession = renderSession;
            	}
...
void CairoBlendModeManager_obj::setBlendMode( ::Dynamic blendMode){
            	HX_STACKFRAME(&_hx_pos_bac8fa62cbacae74_26_setBlendMode)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(blendMode,"blendMode")
HXLINE(  28)		if (hx::IsEq( this->currentBlendMode,blendMode )) {
HXLINE(  28)			return;
            		}
HXLINE(  30)		this->currentBlendMode = blendMode;
HXLINE(  32)		 ::Dynamic _hx_switch_0 = blendMode;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE(  36)			this->renderSession->cairo->set_operator((int)12);
...
HXLINE(  44)			this->renderSession->cairo->set_operator((int)17);
HXDLIN(  44)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)3) ){
HXLINE(  48)			this->renderSession->cairo->set_operator((int)23);
...
HXLINE(  56)			this->renderSession->cairo->set_operator((int)21);
...
HXLINE(  64)			this->renderSession->cairo->set_operator((int)2);
HXDLIN(  64)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)8) ){
HXLINE(  68)			this->renderSession->cairo->set_operator((int)18);
HXDLIN(  68)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)9) ){
HXLINE(  72)			this->renderSession->cairo->set_operator((int)14);
HXDLIN(  72)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)10) ){
HXLINE(  76)			this->renderSession->cairo->set_operator((int)2);
HXDLIN(  76)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)11) ){
HXLINE(  80)			this->renderSession->cairo->set_operator((int)16);
HXDLIN(  80)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==(int)12) ){
HXLINE(  84)			this->renderSession->cairo->set_operator((int)15);
...
HXLINE(  90)			goto _hx_goto_1;
            		...
            		/* default */{
HXLINE(  96)			this->renderSession->cairo->set_operator((int)2);
            		}
            		_hx_goto_1:;
            	}
