...
HX_DEFINE_STACK_FRAME(_hx_pos_bc09bde916c21592_7_new,"openfl.errors.RangeError","new",0xae8f9562,"openfl.errors.RangeError.new","openfl/errors/RangeError.hx",7,0xfc04662e)
namespace openfl{
namespace errors{

void RangeError_obj::__construct(::String __o_message){
::String message = __o_message.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_bc09bde916c21592_7_new)
            	HX_STACK_THIS(this)
