...
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_52_get_colorTransform,"openfl.geom.Transform","get_colorTransform",0xc8c832c8,"openfl.geom.Transform.get_colorTransform","openfl/geom/Transform.hx",52,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_57_set_colorTransform,"openfl.geom.Transform","set_colorTransform",0xa577653c,"openfl.geom.Transform.set_colorTransform","openfl/geom/Transform.hx",57,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_78_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",78,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_91_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",91,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_104_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",104,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_127_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",127,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_141_set_matrix3D,"openfl.geom.Transform","set_matrix3D",0x1a00aaa5,"openfl.geom.Transform.set_matrix3D","openfl/geom/Transform.hx",141,0xf4f475e6)
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_162___setTransform,"openfl.geom.Transform","__setTransform",0x9df9f800,"openfl.geom.Transform.__setTransform","openfl/geom/Transform.hx",162,0xf4f475e6)
namespace openfl{
namespace geom{
...
HXDLIN( 132)			HX_VARI(  ::openfl::_Vector::FloatVector,vector) =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null());
HXDLIN( 132)			{
HXLINE( 132)				HX_VARI( int,_g1) = (int)0;
HXDLIN( 132)				HX_VARI( int,_g) = a->length;
HXDLIN( 132)				while((_g1 < _g)){
HXLINE( 132)					_g1 = (_g1 + (int)1);
HXDLIN( 132)					HX_VARI( int,i) = (_g1 - (int)1);
...
HXLINE( 190)			HX_VARI( Float,rotation) = ((((Float)(int)180 / (Float)::Math_obj::PI) * ::Math_obj::atan2(d,c)) - (int)90);
HXLINE( 192)			if ((rotation != this->_hx___displayObject->_hx___rotation)) {
...
HXDLIN( 208)				if (!(_this->_hx___transformDirty)) {
