...
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_80_clear,"openfl._internal.renderer.opengl.GLRenderer","clear",0x823f8a0b,"openfl._internal.renderer.opengl.GLRenderer.clear","openfl/_internal/renderer/opengl/GLRenderer.hx",80,0xb2b97130)
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_103_getCacheObject,"openfl._internal.renderer.opengl.GLRenderer","getCacheObject",0xc4fee56d,"openfl._internal.renderer.opengl.GLRenderer.getCacheObject","openfl/_internal/renderer/opengl/GLRenderer.hx",103,0xb2b97130)
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_115_getMatrix,"openfl._internal.renderer.opengl.GLRenderer","getMatrix",0x5e6beef5,"openfl._internal.renderer.opengl.GLRenderer.getMatrix","openfl/_internal/renderer/opengl/GLRenderer.hx",115,0xb2b97130)
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_150_getRenderTarget,"openfl._internal.renderer.opengl.GLRenderer","getRenderTarget",0x5f982efb,"openfl._internal.renderer.opengl.GLRenderer.getRenderTarget","openfl/_internal/renderer/opengl/GLRenderer.hx",150,0xb2b97130)
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_200_render,"openfl._internal.renderer.opengl.GLRenderer","render",0x72dac118,"openfl._internal.renderer.opengl.GLRenderer.render","openfl/_internal/renderer/opengl/GLRenderer.hx",200,0xb2b97130)
HX_DEFINE_STACK_FRAME(_hx_pos_c64fe149f16bcd1e_241_resize,"openfl._internal.renderer.opengl.GLRenderer","resize",0x762cafb6,"openfl._internal.renderer.opengl.GLRenderer.resize","openfl/_internal/renderer/opengl/GLRenderer.hx",241,0xb2b97130)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
HXLINE(  73)			this->resize(::Math_obj::ceil((stage->window->_hx___width * stage->window->_hx___scale)),::Math_obj::ceil((stage->window->_hx___height * stage->window->_hx___scale)));
            		}
            	}
...
HXLINE(  88)			this->gl->clearColor(this->stage->_hx___colorSplit->__get((int)0),this->stage->_hx___colorSplit->__get((int)1),this->stage->_hx___colorSplit->__get((int)2),(int)1);
            		}
...
HXLINE(  94)				HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
...
HXDLIN( 137)				HX_VARI( int,i) = (_g - (int)1);
HXLINE( 139)				this->values[i] = ::lime::math::_Matrix4::Matrix4_Impl__obj::get(this->matrix,i);
            			}
            		}
...
HXLINE( 154)				this->renderTargetA = ::openfl::display::BitmapData_obj::fromTexture(this->stage->stage3Ds->get((int)0).StaticCast<  ::openfl::display::Stage3D >()->context3D->createRectangleTexture(this->width,this->height,(int)1,true));
HXLINE( 156)				 ::lime::_backend::native::NativeGLRenderContext _hx_tmp = this->gl;
HXDLIN( 156)				int _hx_tmp1 = this->gl->TEXTURE_2D;
HXDLIN( 156)				_hx_tmp->bindTexture(_hx_tmp1,this->renderTargetA->getTexture(this->gl));
...
HXLINE( 164)				this->renderTargetB = ::openfl::display::BitmapData_obj::fromTexture(this->stage->stage3Ds->get((int)0).StaticCast<  ::openfl::display::Stage3D >()->context3D->createRectangleTexture(this->width,this->height,(int)1,true));
HXLINE( 166)				 ::lime::_backend::native::NativeGLRenderContext _hx_tmp2 = this->gl;
HXDLIN( 166)				int _hx_tmp3 = this->gl->TEXTURE_2D;
HXDLIN( 166)				_hx_tmp2->bindTexture(_hx_tmp3,this->renderTargetB->getTexture(this->gl));
...
HXLINE( 182)			 ::lime::_backend::native::NativeGLRenderContext _hx_tmp4 = this->gl;
HXDLIN( 182)			int _hx_tmp5 = this->gl->FRAMEBUFFER;
HXDLIN( 182)			_hx_tmp4->bindFramebuffer(_hx_tmp5,this->currentRenderTarget->_hx___getFramebuffer(this->gl));
...
HXLINE( 219)				this->gl->scissor((this->offsetX + this->displayWidth),(int)0,this->width,this->height);
...
HXLINE( 229)				this->gl->scissor((int)0,(this->offsetY + this->displayHeight),this->width,this->height);
...
HXDLIN( 277)		this->offsetX = ::Math_obj::round(((((int)0 * _this->a) + ((int)0 * _this->c)) + _this->tx));
HXLINE( 278)		HX_VARI_NAME(  ::openfl::geom::Matrix,_this1,"_this") = this->displayMatrix;
HXDLIN( 278)		this->offsetY = ::Math_obj::round(((((int)0 * _this1->b) + ((int)0 * _this1->d)) + _this1->ty));
HXLINE( 279)		HX_VARI_NAME(  ::openfl::geom::Matrix,_this2,"_this") = this->displayMatrix;
HXDLIN( 279)		this->displayWidth = ::Math_obj::round(((((this->stage->stageWidth * _this2->a) + ((int)0 * _this2->c)) + _this2->tx) - this->offsetX));
HXLINE( 280)		HX_VARI_NAME(  ::openfl::geom::Matrix,_this3,"_this") = this->displayMatrix;
HXDLIN( 280)		this->displayHeight = ::Math_obj::round((((((int)0 * _this3->b) + (this->stage->stageHeight * _this3->d)) + _this3->ty) - this->offsetY));
HXLINE( 282)		this->projection = ::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->offsetX,(this->displayWidth + this->offsetX),this->offsetY,(this->displayHeight + this->offsetY),(int)-1000,(int)1000);
HXLINE( 283)		this->projectionFlipped = ::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->offsetX,(this->displayWidth + this->offsetX),(this->displayHeight + this->offsetY),this->offsetY,(int)-1000,(int)1000);
            	}
