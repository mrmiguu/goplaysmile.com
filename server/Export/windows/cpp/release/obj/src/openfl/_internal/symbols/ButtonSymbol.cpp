...
HX_DEFINE_STACK_FRAME(_hx_pos_906043296d6f2c53_21_new,"openfl._internal.symbols.ButtonSymbol","new",0x02e216df,"openfl._internal.symbols.ButtonSymbol.new","openfl/_internal/symbols/ButtonSymbol.hx",21,0xd0678f8e)
HX_DEFINE_STACK_FRAME(_hx_pos_906043296d6f2c53_26___createObject,"openfl._internal.symbols.ButtonSymbol","__createObject",0x5a781ddc,"openfl._internal.symbols.ButtonSymbol.__createObject","openfl/_internal/symbols/ButtonSymbol.hx",26,0xd0678f8e)
namespace openfl{
namespace _internal{
namespace symbols{

void ButtonSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_906043296d6f2c53_21_new)
            	HX_STACK_THIS(this)
...
bool ButtonSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject ButtonSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_906043296d6f2c53_26___createObject)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  28)		HX_VARI(  ::openfl::display::SimpleButton,simpleButton) = null();
HXLINE(  30)		::openfl::display::SimpleButton_obj::_hx___initSWF = swf;
HXLINE(  31)		::openfl::display::SimpleButton_obj::_hx___initSymbol = hx::ObjectPtr<OBJ_>(this);
HXLINE(  33)		if (hx::IsNotNull( this->className )) {
HXLINE(  35)			HX_VARI( hx::Class,symbolType) = ::Type_obj::resolveClass(this->className);
HXLINE(  37)			if (hx::IsNotNull( symbolType )) {
HXLINE(  39)				simpleButton = ( ( ::openfl::display::SimpleButton)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  49)		if (hx::IsNull( simpleButton )) {
HXLINE(  51)			simpleButton =  ::openfl::display::SimpleButton_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
HXLINE(  55)		return simpleButton;
            	}
