...
HX_DEFINE_STACK_FRAME(_hx_pos_9cb7cf8686767cce_24___createObject,"openfl._internal.symbols.StaticTextSymbol","__createObject",0xe6e27b33,"openfl._internal.symbols.StaticTextSymbol.__createObject","openfl/_internal/symbols/StaticTextSymbol.hx",24,0x451958e5)
namespace openfl{
namespace _internal{
namespace symbols{
...
HXLINE(  26)		HX_VARI(  ::openfl::display::Shape,shape) =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
...
HXDLIN(  57)								HX_VARI( int,i) = (_g3 - (int)1);
...
HXLINE(  61)										HX_VARI(  ::openfl::_internal::swf::ShapeCommand,command) = _g5->__get(_g4).StaticCast<  ::openfl::_internal::swf::ShapeCommand >();
...
HXLINE(  75)												graphics->endFill();
            											...
            											break;
            											case (int)5: {
HXLINE(  77)												HX_VARI(  ::Dynamic,thickness) = command->_hx_getObject(0);
HXLINE(  79)												if (hx::IsNotNull( thickness )) {
HXLINE(  81)													graphics->lineStyle(thickness,command->_hx_getObject(1),command->_hx_getObject(2),command->_hx_getObject(3),command->_hx_getObject(4),command->_hx_getObject(5),command->_hx_getObject(6),command->_hx_getObject(7));
            												}
            												else {
