...
HX_DEFINE_STACK_FRAME(_hx_pos_8d46640c38533f59_19_new,"openfl.display.ShaderData","new",0x6406164b,"openfl.display.ShaderData.new","openfl/display/ShaderData.hx",19,0xa8261943)
namespace openfl{
namespace display{

void ShaderData_obj::__construct( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACKFRAME(&_hx_pos_8d46640c38533f59_19_new)
            	HX_STACK_THIS(this)
