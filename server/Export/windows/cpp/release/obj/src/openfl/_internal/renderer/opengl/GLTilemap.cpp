...
HX_DEFINE_STACK_FRAME(_hx_pos_40a075b64d21c9aa_31_render,"openfl._internal.renderer.opengl.GLTilemap","render",0xde22397f,"openfl._internal.renderer.opengl.GLTilemap.render","openfl/_internal/renderer/opengl/GLTilemap.hx",31,0xf59b2d1b)
HX_DEFINE_STACK_FRAME(_hx_pos_40a075b64d21c9aa_281___skipTile,"openfl._internal.renderer.opengl.GLTilemap","__skipTile",0x426fc316,"openfl._internal.renderer.opengl.GLTilemap.__skipTile","openfl/_internal/renderer/opengl/GLTilemap.hx",281,0xf59b2d1b)
HX_DEFINE_STACK_FRAME(_hx_pos_40a075b64d21c9aa_298___updateTileAlpha,"openfl._internal.renderer.opengl.GLTilemap","__updateTileAlpha",0x6bbd875e,"openfl._internal.renderer.opengl.GLTilemap.__updateTileAlpha","openfl/_internal/renderer/opengl/GLTilemap.hx",298,0xf59b2d1b)
HX_DEFINE_STACK_FRAME(_hx_pos_40a075b64d21c9aa_314___updateTileUV,"openfl._internal.renderer.opengl.GLTilemap","__updateTileUV",0xdacd8641,"openfl._internal.renderer.opengl.GLTilemap.__updateTileUV","openfl/_internal/renderer/opengl/GLTilemap.hx",314,0xf59b2d1b)
HX_DEFINE_STACK_FRAME(_hx_pos_40a075b64d21c9aa_28_boot,"openfl._internal.renderer.opengl.GLTilemap","boot",0xf7b1461b,"openfl._internal.renderer.opengl.GLTilemap.boot","openfl/_internal/renderer/opengl/GLTilemap.hx",28,0xf59b2d1b)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
void GLTilemap_obj::render( ::openfl::display::Tilemap tilemap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_GC_STACKFRAME(&_hx_pos_40a075b64d21c9aa_31_render)
...
HXLINE(  38)		renderSession->blendModeManager->setBlendMode(tilemap->get_blendMode());
...
HXLINE(  48)			_hx_tmp2 = tilemap->smoothing;
            		}
            		else {
HXLINE(  48)			_hx_tmp2 = false;
            		}
HXDLIN(  48)		shader->get_data()->uImage0->smoothing = _hx_tmp2;
...
HXDLIN(  63)		if (hx::IsNotNull( bufferData )) {
HXLINE(  63)			_hx_tmp4 = tilemap->_hx___dirty;
            		}
            		else {
HXLINE(  63)			_hx_tmp4 = true;
            		}
HXDLIN(  63)		if (!(_hx_tmp4)) {
HXLINE(  63)			_hx_tmp3 = (bufferData->length != (count * (int)30));
            		}
            		else {
...
HXLINE(  67)			if (hx::IsNull( bufferData )) {
HXLINE(  69)				HX_VARI(  ::Dynamic,elements) = (count * (int)30);
HXDLIN(  69)				HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN(  69)				if (hx::IsNotNull( elements )) {
HXLINE(  69)					this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,(int)8);
            				}
            				else {
...
HXLINE(  71)				if ((bufferData->length != (count * (int)30))) {
HXLINE(  73)					if (!(tilemap->_hx___dirty)) {
HXLINE(  75)						startIndex = ::Std_obj::_hx_int(((Float)bufferData->length / (Float)(int)30));
            					}
...
HXDLIN(  79)					if (hx::IsNotNull( elements1 )) {
HXLINE(  79)						this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,(int)8);
            					}
            					else {
...
HXLINE(  81)					if ((bufferData->length <= data->length)) {
HXLINE(  83)						if (hx::IsNotNull( bufferData )) {
HXLINE(  83)							data->buffer->blit(((int)0 * data->bytesPerElement),bufferData->buffer,bufferData->byteOffset,bufferData->byteLength);
            						}
            						else {
...
HXLINE(  87)						HX_VARI( int,len) = data->length;
...
HXDLIN(  87)						switch((int)(bufferData->type)){
            							case (int)0: {
...
HXLINE(  87)									HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)1);
...
HXDLIN(  87)								if (hx::IsNotNull( buffer1 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this1,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)2);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this1->length = ::Std_obj::_hx_int(((Float)newByteLength1 / (Float)_this1->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer2 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this2,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)3);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this2->length = ::Std_obj::_hx_int(((Float)newByteLength2 / (Float)_this2->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer3 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this3,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this3->length = ::Std_obj::_hx_int(((Float)newByteLength3 / (Float)_this3->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer4 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this4,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)5);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this4->length = ::Std_obj::_hx_int(((Float)newByteLength4 / (Float)_this4->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer5 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this5,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this5->length = ::Std_obj::_hx_int(((Float)newByteLength5 / (Float)_this5->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer6 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this6,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)7);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this6->length = ::Std_obj::_hx_int(((Float)newByteLength6 / (Float)_this6->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer7 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this7,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)8);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this7->length = ::Std_obj::_hx_int(((Float)newByteLength7 / (Float)_this7->bytesPerElement));
...
HXDLIN(  87)								if (hx::IsNotNull( buffer8 )) {
HXLINE(  87)									HX_VARI_NAME(  ::lime::utils::ArrayBufferView,_this8,"_this") =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)9);
HXDLIN(  87)									if ((byte_offset < (int)0)) {
HXLINE(  87)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXDLIN(  87)									_this8->length = ::Std_obj::_hx_int(((Float)newByteLength8 / (Float)_this8->bytesPerElement));
...
HXLINE(  87)							data->buffer->blit(((int)0 * data->bytesPerElement),view1->buffer,view1->byteOffset,view1->byteLength);
            						}
            						else {
...
HXLINE(  97)					::openfl::_internal::renderer::opengl::GLTilemap_obj::_hx___updateTileAlpha(tiles->__get(i).StaticCast<  ::openfl::display::Tile >(),worldAlpha,(i * (int)30),bufferData);
HXLINE(  99)					if (hx::IsNotNull( tiles->__get(i).StaticCast<  ::openfl::display::Tile >()->tileset )) {
HXLINE(  99)						tileset = tiles->__get(i).StaticCast<  ::openfl::display::Tile >()->tileset;
            					}
            					else {
HXLINE(  99)						tileset = tilemap->tileset;
            					}
HXLINE( 101)					if (hx::IsNotNull( tileset )) {
HXLINE( 103)						::openfl::_internal::renderer::opengl::GLTilemap_obj::_hx___updateTileUV(tiles->__get(i).StaticCast<  ::openfl::display::Tile >(),tileset,(i * (int)30),bufferData);
            					}
            				}
            			}
HXLINE( 109)			tilemap->_hx___bufferData = bufferData;
            		}
HXLINE( 113)		if (hx::IsNull( tilemap->_hx___buffer )) {
...
HXDLIN( 123)				HX_VARI_NAME( int,i1,"i") = (_g11 - (int)1);
...
HXLINE( 132)					_hx_tmp5 = (alpha <= (int)0);
            				}
            				else {
...
HXLINE( 139)				if (hx::IsNotNull( tile->tileset )) {
HXLINE( 139)					tileset = tile->tileset;
            				}
            				else {
HXLINE( 139)					tileset = defaultTileset;
            				}
HXLINE( 141)				if (hx::IsNull( tileset )) {
...
HXLINE( 150)				if (hx::IsNull( tileData )) {
...
HXLINE( 162)					_hx_tmp6 = tile->_hx___alphaDirty;
            				}
            				else {
...
HXLINE( 168)				if (tile->_hx___sourceDirty) {
HXLINE( 170)					::openfl::_internal::renderer::opengl::GLTilemap_obj::_hx___updateTileUV(tile,tileset,offset,bufferData);
            				}
HXLINE( 174)				if (tile->_hx___transformDirty) {
HXLINE( 176)					tileMatrix = tile->matrix;
HXLINE( 178)					x = (tile->_hx___transform[(int)0] = ((((int)0 * tileMatrix->a) + ((int)0 * tileMatrix->c)) + tileMatrix->tx));
HXLINE( 179)					y = (tile->_hx___transform[(int)1] = ((((int)0 * tileMatrix->b) + ((int)0 * tileMatrix->d)) + tileMatrix->ty));
HXLINE( 180)					x2 = (tile->_hx___transform[(int)2] = (((tileWidth * tileMatrix->a) + ((int)0 * tileMatrix->c)) + tileMatrix->tx));
HXLINE( 181)					y2 = (tile->_hx___transform[(int)3] = (((tileWidth * tileMatrix->b) + ((int)0 * tileMatrix->d)) + tileMatrix->ty));
HXLINE( 182)					x3 = (tile->_hx___transform[(int)4] = ((((int)0 * tileMatrix->a) + (tileHeight * tileMatrix->c)) + tileMatrix->tx));
HXLINE( 183)					y3 = (tile->_hx___transform[(int)5] = ((((int)0 * tileMatrix->b) + (tileHeight * tileMatrix->d)) + tileMatrix->ty));
HXLINE( 184)					x4 = (tile->_hx___transform[(int)6] = (((tileWidth * tileMatrix->a) + (tileHeight * tileMatrix->c)) + tileMatrix->tx));
HXLINE( 185)					y4 = (tile->_hx___transform[(int)7] = (((tileWidth * tileMatrix->b) + (tileHeight * tileMatrix->d)) + tileMatrix->ty));
...
HXLINE( 202)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + (offset * (int)4)),x);
HXLINE( 203)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)1) * (int)4)),y);
HXLINE( 204)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)5) * (int)4)),x2);
HXLINE( 205)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)6) * (int)4)),y2);
HXLINE( 206)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)10) * (int)4)),x3);
HXLINE( 207)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)11) * (int)4)),y3);
HXLINE( 209)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)15) * (int)4)),x3);
HXLINE( 210)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)16) * (int)4)),y3);
HXLINE( 211)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)20) * (int)4)),x2);
HXLINE( 212)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)21) * (int)4)),y2);
HXLINE( 213)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)25) * (int)4)),x4);
HXLINE( 214)				::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((offset + (int)26) * (int)4)),y4);
...
HXDLIN( 231)			HX_VARI( int,_g) = (drawCount + (int)1);
HXDLIN( 231)			while((_g12 < _g)){
HXLINE( 231)				_g12 = (_g12 + (int)1);
HXDLIN( 231)				HX_VARI_NAME( int,i2,"i") = (_g12 - (int)1);
HXLINE( 233)				if (( (bool)(::openfl::_internal::renderer::opengl::GLTilemap_obj::_hx___skippedTiles->get(i2)) )) {
HXLINE( 235)					continue;
            				}
HXLINE( 239)				tile = tiles->__get(i2).StaticCast<  ::openfl::display::Tile >();
HXLINE( 240)				if (hx::IsNotNull( tile->tileset )) {
...
HXLINE( 263)					gl->drawArrays(gl->TRIANGLES,(lastIndex * (int)6),(((i2 + (int)1) - lastIndex) * (int)6));
            				}
            			}
            		}
...
void GLTilemap_obj::_hx___skipTile( ::openfl::display::Tile tile,int i,int tileOffset, ::lime::utils::ArrayBufferView bufferData){
            	HX_STACKFRAME(&_hx_pos_40a075b64d21c9aa_281___skipTile)
...
HXLINE( 285)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)4) * (int)4)),(int)0);
HXLINE( 286)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)9) * (int)4)),(int)0);
HXLINE( 287)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)14) * (int)4)),(int)0);
HXLINE( 288)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)19) * (int)4)),(int)0);
HXLINE( 289)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)24) * (int)4)),(int)0);
HXLINE( 290)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset1 + (int)29) * (int)4)),(int)0);
...
void GLTilemap_obj::_hx___updateTileAlpha( ::openfl::display::Tile tile,Float worldAlpha,int tileOffset, ::lime::utils::ArrayBufferView bufferData){
            	HX_STACKFRAME(&_hx_pos_40a075b64d21c9aa_298___updateTileAlpha)
            	HX_STACK_ARG(tile,"tile")
            	HX_STACK_ARG(worldAlpha,"worldAlpha")
            	HX_STACK_ARG(tileOffset,"tileOffset")
            	HX_STACK_ARG(bufferData,"bufferData")
HXLINE( 300)		HX_VARI( Float,alpha) = (worldAlpha * tile->alpha);
HXLINE( 302)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)4) * (int)4)),alpha);
HXLINE( 303)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)9) * (int)4)),alpha);
HXLINE( 304)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)14) * (int)4)),alpha);
HXLINE( 305)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)19) * (int)4)),alpha);
HXLINE( 306)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)24) * (int)4)),alpha);
HXLINE( 307)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)29) * (int)4)),alpha);
...
void GLTilemap_obj::_hx___updateTileUV( ::openfl::display::Tile tile, ::openfl::display::Tileset tileset,int tileOffset, ::lime::utils::ArrayBufferView bufferData){
            	HX_STACKFRAME(&_hx_pos_40a075b64d21c9aa_314___updateTileUV)
            	HX_STACK_ARG(tile,"tile")
...
HXLINE( 318)		if (hx::IsNull( tileData )) {
HXLINE( 318)			return;
            		}
...
HXLINE( 325)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)2) * (int)4)),x);
HXLINE( 326)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)3) * (int)4)),y);
HXLINE( 327)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)7) * (int)4)),x2);
HXLINE( 328)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)8) * (int)4)),y);
HXLINE( 329)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)12) * (int)4)),x);
HXLINE( 330)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)13) * (int)4)),y2);
HXLINE( 332)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)17) * (int)4)),x);
HXLINE( 333)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)18) * (int)4)),y2);
HXLINE( 334)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)22) * (int)4)),x2);
HXLINE( 335)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)23) * (int)4)),y);
HXLINE( 336)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)27) * (int)4)),x2);
HXLINE( 337)		::__hxcpp_memory_set_float(bufferData->buffer->b,(bufferData->byteOffset + ((tileOffset + (int)28) * (int)4)),y2);
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_40a075b64d21c9aa_28_boot)
HXLINE(  28)		_hx___skippedTiles =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
}
