...
void DOMShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMShape","render",0x498be01e,"openfl._internal.renderer.dom.DOMShape.render","openfl/_internal/renderer/dom/DOMShape.hx",22,0xad9b03d8)
