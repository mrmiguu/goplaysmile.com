...
HX_DEFINE_STACK_FRAME(_hx_pos_53ac15441f7ae261_233__new,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","_new",0x824c6ed7,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",233,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_53ac15441f7ae261_234_get_bitmap,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_bitmap",0x65ae55ae,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",234,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_53ac15441f7ae261_235_get_matrix,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_matrix",0x306a7c00,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",235,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_53ac15441f7ae261_236_get_repeat,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_repeat",0x7b1edd1a,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",236,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_53ac15441f7ae261_237_get_smooth,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_smooth",0x7c0d4ded,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",237,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
HXLINE( 234)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginBitmapFillView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix BeginBitmapFillView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 235)		return ( ( ::openfl::geom::Matrix)(this1->buffer->o->__get((this1->oPos + (int)1))) );
            	}
...
bool BeginBitmapFillView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 236)		return this1->buffer->b->__get(this1->bPos);
            	}
...
bool BeginBitmapFillView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 237)		return this1->buffer->b->__get((this1->bPos + (int)1));
            	}
