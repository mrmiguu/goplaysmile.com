...
HX_DEFINE_STACK_FRAME(_hx_pos_cb6bac53584ced5e_405__new,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","_new",0x9bdb8896,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",405,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_cb6bac53584ced5e_406_get_x,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_x",0x5989007a,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",406,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_cb6bac53584ced5e_407_get_y,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_y",0x5989007b,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",407,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
HXLINE( 406)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float MoveToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 407)		return this1->buffer->f->__get((this1->fPos + (int)1));
            	}
