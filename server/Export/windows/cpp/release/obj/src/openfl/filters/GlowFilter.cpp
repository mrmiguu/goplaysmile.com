...
HX_DEFINE_STACK_FRAME(_hx_pos_f54e58291eefcbc3_47_clone,"openfl.filters.GlowFilter","clone",0x7c629925,"openfl.filters.GlowFilter.clone","openfl/filters/GlowFilter.hx",47,0x5f568606)
HX_DEFINE_STACK_FRAME(_hx_pos_f54e58291eefcbc3_52___initShader,"openfl.filters.GlowFilter","__initShader",0x188dd8ad,"openfl.filters.GlowFilter.__initShader","openfl/filters/GlowFilter.hx",52,0x5f568606)
HX_DEFINE_STACK_FRAME(_hx_pos_f54e58291eefcbc3_89_set_knockout,"openfl.filters.GlowFilter","set_knockout",0xf84cc4af,"openfl.filters.GlowFilter.set_knockout","openfl/filters/GlowFilter.hx",89,0x5f568606)
HX_DEFINE_STACK_FRAME(_hx_pos_f54e58291eefcbc3_94_set_quality,"openfl.filters.GlowFilter","set_quality",0xb56977aa,"openfl.filters.GlowFilter.set_quality","openfl/filters/GlowFilter.hx",94,0x5f568606)
HX_DEFINE_STACK_FRAME(_hx_pos_f54e58291eefcbc3_12_boot,"openfl.filters.GlowFilter","boot",0x4f1dcf6a,"openfl.filters.GlowFilter.boot","openfl/filters/GlowFilter.hx",12,0x5f568606)
namespace openfl{
namespace filters{
...
HXLINE(  59)			 ::Dynamic( ::Dynamic(data->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)0,(this->blurX * ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1))));
...
HXLINE(  64)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),((int)(pass - this->horizontalPasses) >> (int)(int)1));
...
HXLINE(  66)			 ::Dynamic( ::Dynamic(data->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)1,(this->blurY * scale));
            		}
HXLINE(  70)		 ::Dynamic( ::Dynamic(data->__Field(HX_("uColor",ae,18,4b,a5),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)0,((Float)((int)((int)this->color >> (int)(int)16) & (int)(int)255) / (Float)(int)255));
HXLINE(  71)		 ::Dynamic( ::Dynamic(data->__Field(HX_("uColor",ae,18,4b,a5),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)1,((Float)((int)((int)this->color >> (int)(int)8) & (int)(int)255) / (Float)(int)255));
HXLINE(  72)		 ::Dynamic( ::Dynamic(data->__Field(HX_("uColor",ae,18,4b,a5),hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))->__SetItem((int)2,((Float)((int)this->color & (int)(int)255) / (Float)(int)255));
...
HXLINE(  98)			_hx_tmp = (::Math_obj::round((this->blurX * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN(  98)		this->horizontalPasses = _hx_tmp;
HXLINE(  99)		int _hx_tmp1;
HXDLIN(  99)		if ((this->blurY <= (int)0)) {
HXLINE(  99)			_hx_tmp1 = (int)0;
            		}
            		else {
HXLINE(  99)			_hx_tmp1 = (::Math_obj::round((this->blurY * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN(  99)		this->verticalPasses = _hx_tmp1;
