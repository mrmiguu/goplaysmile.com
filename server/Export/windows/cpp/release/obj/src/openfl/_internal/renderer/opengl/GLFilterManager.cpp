...
HX_DEFINE_STACK_FRAME(_hx_pos_40ef2765f573c5ea_48_pushObject,"openfl._internal.renderer.opengl.GLFilterManager","pushObject",0x4b4ad99b,"openfl._internal.renderer.opengl.GLFilterManager.pushObject","openfl/_internal/renderer/opengl/GLFilterManager.hx",48,0xef502054)
HX_DEFINE_STACK_FRAME(_hx_pos_40ef2765f573c5ea_75_popObject,"openfl._internal.renderer.opengl.GLFilterManager","popObject",0x1feca00e,"openfl._internal.renderer.opengl.GLFilterManager.popObject","openfl/_internal/renderer/opengl/GLFilterManager.hx",75,0xef502054)
HX_DEFINE_STACK_FRAME(_hx_pos_40ef2765f573c5ea_119_renderPass,"openfl._internal.renderer.opengl.GLFilterManager","renderPass",0xc987d4a9,"openfl._internal.renderer.opengl.GLFilterManager.renderPass","openfl/_internal/renderer/opengl/GLFilterManager.hx",119,0xef502054)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
HXLINE(  80)				_hx_tmp1 = (filter->_hx___numPasses > (int)0);
            			}
            			else {
...
HXLINE(  95)						shader = filter->_hx___initShader(this->renderSession,(_g1 - (int)1));
HXLINE(  97)						this->renderPass(currentTarget,shader);
            					}
            				}
HXLINE( 103)				this->filterDepth--;
HXLINE( 104)				this->renderer->getRenderTarget((this->filterDepth > (int)0));
...
void GLFilterManager_obj::renderPass( ::openfl::display::BitmapData target, ::openfl::display::Shader shader){
            	HX_STACKFRAME(&_hx_pos_40ef2765f573c5ea_119_renderPass)
            	HX_STACK_THIS(this)
...
HXLINE( 127)		 ::lime::_backend::native::NativeGLRenderContext _hx_tmp1 = this->gl;
HXDLIN( 127)		int _hx_tmp2 = this->gl->ARRAY_BUFFER;
HXDLIN( 127)		_hx_tmp1->bindBuffer(_hx_tmp2,target->getBuffer(this->gl,(int)1));
HXLINE( 128)		 ::lime::_backend::native::NativeGLRenderContext _hx_tmp3 = this->gl;
HXDLIN( 128)		_hx_tmp3->vertexAttribPointer(shader->get_data()->aPosition->index,(int)3,this->gl->FLOAT,false,(int)24,(int)0);
HXLINE( 129)		 ::lime::_backend::native::NativeGLRenderContext _hx_tmp4 = this->gl;
HXDLIN( 129)		_hx_tmp4->vertexAttribPointer(shader->get_data()->aTexCoord->index,(int)2,this->gl->FLOAT,false,(int)24,(int)12);
HXLINE( 130)		 ::lime::_backend::native::NativeGLRenderContext _hx_tmp5 = this->gl;
HXDLIN( 130)		_hx_tmp5->vertexAttribPointer(shader->get_data()->aAlpha->index,(int)1,this->gl->FLOAT,false,(int)24,(int)20);
