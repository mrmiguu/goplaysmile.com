...
void GLShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLShape","render",0x6f8c5eac,"openfl._internal.renderer.opengl.GLShape.render","openfl/_internal/renderer/opengl/GLShape.hx",26,0xf928bb48)
...
HXLINE(  32)		Bool _hx_tmp1 = hx::IsNotNull( graphics );
...
HXDLIN(  42)			Bool _hx_tmp3 = hx::IsNotNull( graphics->_hx___bitmap );
HXDLIN(  42)			if (_hx_tmp3) {
HXLINE(  42)				_hx_tmp2 = graphics->_hx___visible;
            			}
            			else {
...
HXLINE(  47)				 ::Dynamic _hx_tmp4 = shape->get_blendMode();
HXDLIN(  47)				renderSession->blendModeManager->setBlendMode(_hx_tmp4);
...
HXLINE(  58)				Int _hx_tmp5 = gl->ARRAY_BUFFER;
HXDLIN(  58)				 ::lime::graphics::opengl::GLBuffer _hx_tmp6 = graphics->_hx___bitmap->getBuffer(gl,shape->_hx___worldAlpha);
HXDLIN(  58)				gl->bindBuffer(_hx_tmp5,_hx_tmp6);
