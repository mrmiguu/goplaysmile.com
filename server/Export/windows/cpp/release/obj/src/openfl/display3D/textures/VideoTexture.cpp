...
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_26_new,"openfl.display3D.textures.VideoTexture","new",0x6f95260f,"openfl.display3D.textures.VideoTexture.new","openfl/display3D/textures/VideoTexture.hx",26,0x1fe25aa2)
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_36_attachNetStream,"openfl.display3D.textures.VideoTexture","attachNetStream",0x7bd9e067,"openfl.display3D.textures.VideoTexture.attachNetStream","openfl/display3D/textures/VideoTexture.hx",36,0x1fe25aa2)
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_79___getTexture,"openfl.display3D.textures.VideoTexture","__getTexture",0x7429c676,"openfl.display3D.textures.VideoTexture.__getTexture","openfl/display3D/textures/VideoTexture.hx",79,0x1fe25aa2)
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_93___textureReady,"openfl.display3D.textures.VideoTexture","__textureReady",0x47bb8b59,"openfl.display3D.textures.VideoTexture.__textureReady","openfl/display3D/textures/VideoTexture.hx",93,0x1fe25aa2)
namespace openfl{
namespace display3D{
namespace textures{

void VideoTexture_obj::__construct( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_26_new)
            	HX_STACK_THIS(this)
...
void VideoTexture_obj::attachNetStream( ::openfl::net::NetStream netStream){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_36_attachNetStream)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(VideoTexture_obj,attachNetStream,(void))
 ...
 ::lime::graphics::opengl::GLTexture VideoTexture_obj::_hx___getTexture(){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_79___getTexture)
            	HX_STACK_THIS(this)
...
void VideoTexture_obj::_hx___textureReady(){
            	HX_GC_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_93___textureReady)
            	HX_STACK_THIS(this)
HXLINE(  93)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("textureReady",88,4d,5a,df),null(),null()));
            	}
