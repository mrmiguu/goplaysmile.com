...
HX_LOCAL_STACK_FRAME(_hx_pos_a9a8b88d3857954c_22_create,"openfl.display.Window","create",0xf67e9910,"openfl.display.Window.create","openfl/display/Window.hx",22,0x156e59e2)
namespace openfl{
namespace display{
...
HXDLIN(  30)		if (::Reflect_obj::hasField(this->config,HX_("resizable",6b,37,50,a9))) {
HXLINE(  30)			_hx_tmp1 = !(( (bool)(this->config->__Field(HX_("resizable",6b,37,50,a9),hx::paccDynamic)) ));
            		}
            		else {
HXLINE(  30)			_hx_tmp1 = false;
            		}
HXDLIN(  30)		if (_hx_tmp1) {
HXLINE(  32)			this->stage->_hx___setLogicalSize(( (int)(this->config->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) ),( (int)(this->config->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) ));
            		}
