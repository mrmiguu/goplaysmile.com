...
HX_DEFINE_STACK_FRAME(_hx_pos_be8b948d7a24647f_453_flush,"openfl.display3D._Program3D.Uniform","flush",0xe9cf15cb,"openfl.display3D._Program3D.Uniform.flush","openfl/display3D/Program3D.hx",453,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_be8b948d7a24647f_473___getRegisters,"openfl.display3D._Program3D.Uniform","__getRegisters",0x59704473,"openfl.display3D._Program3D.Uniform.__getRegisters","openfl/display3D/Program3D.hx",473,0x0a985b04)
namespace openfl{
namespace display3D{
...
HXLINE( 456)		switch((int)(this->type)){
            			case (int)35664: {
...
HXDLIN( 489)				HX_VARI( int,i) = (_g1 - (int)1);
HXLINE( 491)				{
HXLINE( 491)					HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this2,"this") = this->regData;
HXDLIN( 491)					HX_VARI( Float,val) = ::__hxcpp_memory_get_float(this2->buffer->b,(this2->byteOffset + ((index + i) * (int)4)));
HXDLIN( 491)					::__hxcpp_memory_set_float(result->buffer->b,(result->byteOffset + (i * (int)4)),val);
            				}
            			}
            		}
