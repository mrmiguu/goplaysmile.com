...
HX_DEFINE_STACK_FRAME(_hx_pos_934fde68ec639995_26___createObject,"openfl._internal.symbols.ShapeSymbol","__createObject",0x10144133,"openfl._internal.symbols.ShapeSymbol.__createObject","openfl/_internal/symbols/ShapeSymbol.hx",26,0x811972cb)
namespace openfl{
namespace _internal{
namespace symbols{
...
HXLINE(  28)		HX_VARI(  ::openfl::display::Shape,shape) =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
...
HXLINE(  38)				HX_VARI(  ::openfl::_internal::swf::ShapeCommand,command) = _g1->__get(_g).StaticCast<  ::openfl::_internal::swf::ShapeCommand >();
HXDLIN(  38)				_g = (_g + (int)1);
HXLINE(  40)				switch((int)(_hx_getEnumValueIndex(command))){
            					case (int)0: {
HXLINE(  48)						HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(::haxe::IMap_obj::get(swf->symbols,command->_hx_getInt(0))) );
HXLINE(  49)						HX_VARI(  ::lime::graphics::Image,bitmap) = swf->library->getImage(bitmapSymbol->path);
HXLINE(  51)						if (hx::IsNotNull( bitmap )) {
HXLINE(  53)							graphics->beginBitmapFill(::openfl::display::BitmapData_obj::fromImage(bitmap,null()),command->_hx_getObject(1).StaticCast<  ::openfl::geom::Matrix >(),command->_hx_getBool(2),command->_hx_getBool(3));
            						}
            					}
            					break;
            					case (int)1: {
...
HXLINE(  67)						graphics->endFill();
            					...
            					break;
            					case (int)5: {
HXLINE(  69)						HX_VARI(  ::Dynamic,thickness) = command->_hx_getObject(0);
HXLINE(  71)						if (hx::IsNotNull( thickness )) {
HXLINE(  73)							graphics->lineStyle(thickness,command->_hx_getObject(1),command->_hx_getObject(2),command->_hx_getObject(3),command->_hx_getObject(4),command->_hx_getObject(5),command->_hx_getObject(6),command->_hx_getObject(7));
            						}
            						else {
