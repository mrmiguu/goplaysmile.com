...
HX_DEFINE_STACK_FRAME(_hx_pos_781ff9dda627132a_302__new,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","_new",0xc710ba18,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",302,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_781ff9dda627132a_303_get_x,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_x",0xfcdf20b8,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",303,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_781ff9dda627132a_304_get_y,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_y",0xfcdf20b9,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",304,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_781ff9dda627132a_305_get_width,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_width",0xcef6f646,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",305,0xbbdbd1ae)
HX_DEFINE_STACK_FRAME(_hx_pos_781ff9dda627132a_306_get_height,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_","get_height",0xff6fffa7,"openfl._internal.renderer._DrawCommandReader.DrawEllipseView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",306,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
HXLINE( 303)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawEllipseView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 304)		return this1->buffer->f->__get((this1->fPos + (int)1));
            	}
...
Float DrawEllipseView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 305)		return this1->buffer->f->__get((this1->fPos + (int)2));
            	}
...
Float DrawEllipseView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 306)		return this1->buffer->f->__get((this1->fPos + (int)3));
            	}
