...
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_79_addFrameScript,"openfl.display.MovieClip","addFrameScript",0xff5029ef,"openfl.display.MovieClip.addFrameScript","openfl/display/MovieClip.hx",79,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_100_gotoAndPlay,"openfl.display.MovieClip","gotoAndPlay",0x3bade190,"openfl.display.MovieClip.gotoAndPlay","openfl/display/MovieClip.hx",100,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_113_gotoAndStop,"openfl.display.MovieClip","gotoAndStop",0x3dafa39e,"openfl.display.MovieClip.gotoAndStop","openfl/display/MovieClip.hx",113,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_126_nextFrame,"openfl.display.MovieClip","nextFrame",0x3b845cc2,"openfl.display.MovieClip.nextFrame","openfl/display/MovieClip.hx",126,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_145_play,"openfl.display.MovieClip","play",0x5c42706c,"openfl.display.MovieClip.play","openfl/display/MovieClip.hx",145,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_165_prevFrame,"openfl.display.MovieClip","prevFrame",0x7f95e2c2,"openfl.display.MovieClip.prevFrame","openfl/display/MovieClip.hx",165,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_184_stop,"openfl.display.MovieClip","stop",0x5e44327a,"openfl.display.MovieClip.stop","openfl/display/MovieClip.hx",184,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_199___applyTween,"openfl.display.MovieClip","__applyTween",0x55791bb5,"openfl.display.MovieClip.__applyTween","openfl/display/MovieClip.hx",199,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_204___enterFrame,"openfl.display.MovieClip","__enterFrame",0x9306f98d,"openfl.display.MovieClip.__enterFrame","openfl/display/MovieClip.hx",204,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_262___fromSymbol,"openfl.display.MovieClip","__fromSymbol",0xc2d8a9fa,"openfl.display.MovieClip.__fromSymbol","openfl/display/MovieClip.hx",262,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_314___getFrame,"openfl.display.MovieClip","__getFrame",0x8028674f,"openfl.display.MovieClip.__getFrame","openfl/display/MovieClip.hx",314,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_346___placeObject,"openfl.display.MovieClip","__placeObject",0x4de0264e,"openfl.display.MovieClip.__placeObject","openfl/display/MovieClip.hx",346,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_407___renderFrame,"openfl.display.MovieClip","__renderFrame",0xe194945f,"openfl.display.MovieClip.__renderFrame","openfl/display/MovieClip.hx",407,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_599___sortTimelineDepth,"openfl.display.MovieClip","__sortTimelineDepth",0x441c91ec,"openfl.display.MovieClip.__sortTimelineDepth","openfl/display/MovieClip.hx",599,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_604___stopAllMovieClips,"openfl.display.MovieClip","__stopAllMovieClips",0x702dce5a,"openfl.display.MovieClip.__stopAllMovieClips","openfl/display/MovieClip.hx",604,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_612___updateFrame,"openfl.display.MovieClip","__updateFrame",0xfb7bd0cc,"openfl.display.MovieClip.__updateFrame","openfl/display/MovieClip.hx",612,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_679_get_currentFrame,"openfl.display.MovieClip","get_currentFrame",0xf2ac6035,"openfl.display.MovieClip.get_currentFrame","openfl/display/MovieClip.hx",679,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_680_get_currentFrameLabel,"openfl.display.MovieClip","get_currentFrameLabel",0x543e3d7f,"openfl.display.MovieClip.get_currentFrameLabel","openfl/display/MovieClip.hx",680,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_681_get_currentLabel,"openfl.display.MovieClip","get_currentLabel",0x5bd7f5fc,"openfl.display.MovieClip.get_currentLabel","openfl/display/MovieClip.hx",681,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_682_get_currentLabels,"openfl.display.MovieClip","get_currentLabels",0x011f46f7,"openfl.display.MovieClip.get_currentLabels","openfl/display/MovieClip.hx",682,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_683_get_framesLoaded,"openfl.display.MovieClip","get_framesLoaded",0xb37eaf4c,"openfl.display.MovieClip.get_framesLoaded","openfl/display/MovieClip.hx",683,0x2b84738a)
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_684_get_totalFrames,"openfl.display.MovieClip","get_totalFrames",0x46b3baa9,"openfl.display.MovieClip.get_totalFrames","openfl/display/MovieClip.hx",684,0x2b84738a)
namespace openfl{
namespace display{
...
HXLINE( 128)			int next = (this->_hx___currentFrame + (int)1);
...
HXLINE( 167)			int previous = (this->_hx___currentFrame - (int)1);
...
HXLINE( 212)				int advanceFrames = ::Math_obj::floor(((Float)this->_hx___timeElapsed / (Float)this->_hx___frameTime));
...
HXDLIN( 220)					int _g = advanceFrames;
...
HXDLIN( 277)			int _g = this->_hx___symbol->frames->length;
...
HXLINE( 281)					::Array< ::Dynamic> _hx_tmp = this->_hx___currentLabels;
HXDLIN( 281)					::String _hx_tmp1 = this->_hx___symbol->frames->__get(i).StaticCast<  ::openfl::_internal::timeline::Frame >()->label;
HXDLIN( 281)					_hx_tmp->push( ::openfl::display::FrameLabel_obj::__alloc( HX_CTX ,_hx_tmp1,(i + (int)1)));
            				}
            			}
            		}
...
HXDLIN( 290)			::Array< ::String > _g11 = ::Type_obj::getInstanceFields(::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this)));
HXDLIN( 290)			while((_g2 < _g11->length)){
HXLINE( 290)				::String field = _g11->__get(_g2);
HXDLIN( 290)				_g2 = (_g2 + (int)1);
HXLINE( 292)				{
HXLINE( 292)					int _g21 = (int)0;
HXDLIN( 292)					::Array< ::Dynamic> _g3 = this->_hx___children;
HXDLIN( 292)					while((_g21 < _g3->length)){
HXLINE( 292)						 ::openfl::display::DisplayObject child = _g3->__get(_g21).StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE( 318)			int index = ( (int)(frame) );
...
HXLINE( 327)				::String label = ( (::String)(frame) );
HXLINE( 329)				{
HXLINE( 329)					int _g = (int)0;
HXDLIN( 329)					::Array< ::Dynamic> _g1 = this->_hx___currentLabels;
HXDLIN( 329)					while((_g < _g1->length)){
HXLINE( 329)						 ::openfl::display::FrameLabel frameLabel = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
...
HXLINE( 368)			::Array< ::Dynamic> filters = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 370)			{
HXLINE( 370)				int _g = (int)0;
HXDLIN( 370)				::Array< ::Dynamic> _g1 = frameObject->filters;
HXDLIN( 370)				while((_g < _g1->length)){
HXLINE( 370)					 ::openfl::_internal::swf::FilterType filter = _g1->__get(_g).StaticCast<  ::openfl::_internal::swf::FilterType >();
HXDLIN( 370)					_g = (_g + (int)1);
HXLINE( 372)					switch((int)(_hx_getEnumValueIndex(filter))){
            						case (int)0: {
HXLINE( 374)							int quality = filter->_hx_getInt(2);
HXDLIN( 374)							Float blurY = filter->_hx_getFloat(1);
HXDLIN( 374)							Float blurX = filter->_hx_getFloat(0);
HXLINE( 376)							filters->push( ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,blurX,blurY,quality));
            						}
            						break;
            						case (int)1: {
HXLINE( 378)							::Array< Float > matrix = filter->_hx_getObject(0).StaticCast< ::Array< Float > >();
HXLINE( 380)							filters->push( ::openfl::filters::ColorMatrixFilter_obj::__alloc( HX_CTX ,matrix));
            						}
            						break;
            						case (int)2: {
HXLINE( 382)							bool hideObject = filter->_hx_getBool(10);
HXDLIN( 382)							bool knockout = filter->_hx_getBool(9);
HXDLIN( 382)							bool inner = filter->_hx_getBool(8);
HXDLIN( 382)							int quality1 = filter->_hx_getInt(7);
HXDLIN( 382)							Float strength = filter->_hx_getFloat(6);
HXDLIN( 382)							Float blurY1 = filter->_hx_getFloat(5);
HXDLIN( 382)							Float blurX1 = filter->_hx_getFloat(4);
HXDLIN( 382)							Float alpha = filter->_hx_getFloat(3);
HXDLIN( 382)							int color = filter->_hx_getInt(2);
HXDLIN( 382)							Float angle = filter->_hx_getFloat(1);
HXDLIN( 382)							Float distance = filter->_hx_getFloat(0);
HXLINE( 384)							filters->push( ::openfl::filters::DropShadowFilter_obj::__alloc( HX_CTX ,distance,angle,color,alpha,blurX1,blurY1,strength,quality1,inner,knockout,hideObject));
            						}
            						break;
            						case (int)3: {
HXLINE( 386)							bool knockout1 = filter->_hx_getBool(7);
HXDLIN( 386)							bool inner1 = filter->_hx_getBool(6);
HXDLIN( 386)							int quality2 = filter->_hx_getInt(5);
HXDLIN( 386)							Float strength1 = filter->_hx_getFloat(4);
HXDLIN( 386)							Float blurY2 = filter->_hx_getFloat(3);
HXDLIN( 386)							Float blurX2 = filter->_hx_getFloat(2);
HXDLIN( 386)							Float alpha1 = filter->_hx_getFloat(1);
HXDLIN( 386)							int color1 = filter->_hx_getInt(0);
HXLINE( 388)							filters->push( ::openfl::filters::GlowFilter_obj::__alloc( HX_CTX ,color1,alpha1,blurX2,blurY2,strength1,quality2,inner1,knockout1));
            						}
            						break;
            					}
            				}
...
HXLINE( 409)		int previousIndex = (this->_hx___lastUpdate - (int)1);
HXLINE( 411)		if ((previousIndex > index)) {
HXLINE( 413)			 ::openfl::display::_MovieClip::TimelineObject timelineObject;
HXDLIN( 413)			bool exists;
HXLINE( 414)			int i = (int)0;
...
HXDLIN( 421)					::Array< ::Dynamic> _g1 = this->_hx___symbol->frames->__get((int)0).StaticCast<  ::openfl::_internal::timeline::Frame >()->objects;
HXDLIN( 421)					while((_g < _g1->length)){
HXLINE( 421)						 ::openfl::_internal::timeline::FrameObject frameObject = _g1->__get(_g).StaticCast<  ::openfl::_internal::timeline::FrameObject >();
...
HXLINE( 454)		 ::openfl::_internal::timeline::Frame frame;
HXDLIN( 454)		 ::openfl::display::_MovieClip::TimelineObject timelineObject1;
HXDLIN( 454)		 ::openfl::display::DisplayObject displayObject;
HXDLIN( 454)		 ::Dynamic depth;
HXDLIN( 454)		 ::openfl::_internal::symbols::SWFSymbol symbol;
HXLINE( 455)		 ::Dynamic mask = null();
HXDLIN( 455)		 ::openfl::display::DisplayObject maskObject = null();
HXLINE( 456)		bool depthChange = false;
HXLINE( 458)		{
HXLINE( 458)			int _g11 = previousIndex;
HXDLIN( 458)			int _g2 = (index + (int)1);
HXDLIN( 458)			while((_g11 < _g2)){
HXLINE( 458)				_g11 = (_g11 + (int)1);
HXDLIN( 458)				int i1 = (_g11 - (int)1);
HXLINE( 460)				if ((i1 < (int)0)) {
HXLINE( 460)					continue;
            				}
HXLINE( 462)				frame = this->_hx___symbol->frames->__get(i1).StaticCast<  ::openfl::_internal::timeline::Frame >();
HXLINE( 464)				{
HXLINE( 464)					int _g21 = (int)0;
HXDLIN( 464)					::Array< ::Dynamic> _g3 = frame->objects;
HXDLIN( 464)					while((_g21 < _g3->length)){
HXLINE( 464)						 ::openfl::_internal::timeline::FrameObject frameObject1 = _g3->__get(_g21).StaticCast<  ::openfl::_internal::timeline::FrameObject >();
...
HXLINE( 582)			int i2 = (this->_hx___objectDepths->length - (int)1);
...
HXLINE( 616)			int frameIndex = (this->_hx___currentFrame - (int)1);
...
HXLINE( 636)					int _hx_tmp1 = this->_hx___currentFrame;
HXDLIN( 636)					if ((_hx_tmp1 != (this->_hx___lastUpdate + (int)1))) {
HXLINE( 638)						this->_hx___currentLabel = null();
HXLINE( 640)						{
HXLINE( 640)							int _g = (int)0;
HXDLIN( 640)							::Array< ::Dynamic> _g1 = this->_hx___currentLabels;
HXDLIN( 640)							while((_g < _g1->length)){
HXLINE( 640)								 ::openfl::display::FrameLabel label = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 640)								_g = (_g + (int)1);
HXLINE( 642)								int _hx_tmp2 = label->get_frame();
HXDLIN( 642)								if ((_hx_tmp2 <= this->_hx___currentFrame)) {
