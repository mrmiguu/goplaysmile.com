...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_41_clone,"openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",41,0xce5f4702)
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_54_toString,"openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",54,0xce5f4702)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_10_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",10,0xce5f4702)
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_11_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",11,0xce5f4702)
namespace openfl{
namespace events{
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  43)		HX_VARI(  ::openfl::events::KeyboardEvent,event) =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
