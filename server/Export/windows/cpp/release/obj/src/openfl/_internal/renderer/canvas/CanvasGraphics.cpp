...
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_62_closePath,"openfl._internal.renderer.canvas.CanvasGraphics","closePath",0x0426588d,"openfl._internal.renderer.canvas.CanvasGraphics.closePath","openfl/_internal/renderer/canvas/CanvasGraphics.hx",62,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_103_createBitmapFill,"openfl._internal.renderer.canvas.CanvasGraphics","createBitmapFill",0x2a5c3b1e,"openfl._internal.renderer.canvas.CanvasGraphics.createBitmapFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",103,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_110_createGradientPattern,"openfl._internal.renderer.canvas.CanvasGraphics","createGradientPattern",0x6cf339b4,"openfl._internal.renderer.canvas.CanvasGraphics.createGradientPattern","openfl/_internal/renderer/canvas/CanvasGraphics.hx",110,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_158_createTempPatternCanvas,"openfl._internal.renderer.canvas.CanvasGraphics","createTempPatternCanvas",0x07b48808,"openfl._internal.renderer.canvas.CanvasGraphics.createTempPatternCanvas","openfl/_internal/renderer/canvas/CanvasGraphics.hx",158,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_184_drawRoundRect,"openfl._internal.renderer.canvas.CanvasGraphics","drawRoundRect",0x4e8f7efe,"openfl._internal.renderer.canvas.CanvasGraphics.drawRoundRect","openfl/_internal/renderer/canvas/CanvasGraphics.hx",184,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_220_endFill,"openfl._internal.renderer.canvas.CanvasGraphics","endFill",0x3478970e,"openfl._internal.renderer.canvas.CanvasGraphics.endFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",220,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_231_endStroke,"openfl._internal.renderer.canvas.CanvasGraphics","endStroke",0x411cf503,"openfl._internal.renderer.canvas.CanvasGraphics.endStroke","openfl/_internal/renderer/canvas/CanvasGraphics.hx",231,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_473_hitTest,"openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",473,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_480_isCCW,"openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",480,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_485_normalizeUVT,"openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",485,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_534_playCommands,"openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",534,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_865_render,"openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",865,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_1241_renderMask,"openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1241,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_1348_setSmoothing,"openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1348,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_40_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",40,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_41_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",41,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_48_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",48,0x0b9ff65e)
HX_DEFINE_STACK_FRAME(_hx_pos_ca7a636da47018f2_55_boot,"openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",55,0x0b9ff65e)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
bool strokeBefore = __o_strokeBefore.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_62_closePath)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CanvasGraphics_obj,closePath,(void))
 ...
 ::Dynamic CanvasGraphics_obj::createBitmapFill( ::openfl::display::BitmapData bitmap,bool bitmapRepeat,bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_103_createBitmapFill)
...
void CanvasGraphics_obj::createGradientPattern( ::Dynamic type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_110_createGradientPattern)
...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,bool repeat,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_158_createTempPatternCanvas)
            	HX_STACK_ARG(bitmap,"bitmap")
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_184_drawRoundRect)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
...
void CanvasGraphics_obj::endFill(){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_220_endFill)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_231_endStroke)
            	}
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_473_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_480_isCCW)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
            	HX_STACK_ARG(x3,"x3")
            	HX_STACK_ARG(y3,"y3")
HXLINE( 480)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
bool skipT = __o_skipT.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_485_normalizeUVT)
            	HX_STACK_ARG(uvt,"uvt")
            	HX_STACK_ARG(skipT,"skipT")
HXLINE( 487)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 488)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 489)		HX_VARI( int,len) = uvt->get_length();
HXLINE( 491)		{
HXLINE( 491)			HX_VARI( int,_g1) = (int)1;
HXDLIN( 491)			HX_VARI( int,_g) = (len + (int)1);
HXDLIN( 491)			while((_g1 < _g)){
HXLINE( 491)				_g1 = (_g1 + (int)1);
HXDLIN( 491)				HX_VARI( int,t) = (_g1 - (int)1);
HXLINE( 493)				bool _hx_tmp;
HXDLIN( 493)				if (skipT) {
HXLINE( 493)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 499)				tmp = uvt->get((t - (int)1));
HXLINE( 501)				if ((max < tmp)) {
HXLINE( 503)					max = tmp;
            				}
            			}
            		}
...
HXLINE( 515)		int length = null();
HXDLIN( 515)		bool fixed = null();
HXDLIN( 515)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null());
HXLINE( 517)		{
HXLINE( 517)			HX_VARI_NAME( int,_g11,"_g1") = (int)1;
HXDLIN( 517)			HX_VARI_NAME( int,_g2,"_g") = (len + (int)1);
HXDLIN( 517)			while((_g11 < _g2)){
HXLINE( 517)				_g11 = (_g11 + (int)1);
HXDLIN( 517)				HX_VARI_NAME( int,t1,"t") = (_g11 - (int)1);
HXLINE( 519)				bool _hx_tmp1;
HXDLIN( 519)				if (skipT) {
HXLINE( 519)					_hx_tmp1 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 525)				result->push(uvt->get((t1 - (int)1)));
            			}
            		}
HXLINE( 529)		return  ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
bool stroke = __o_stroke.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_534_playCommands)
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession, ::openfl::geom::Matrix parentTransform){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_865_render)
            	HX_STACK_ARG(graphics,"graphics")
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1241_renderMask)
            	HX_STACK_ARG(graphics,"graphics")
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1348_setSmoothing)
            	HX_STACK_ARG(smooth,"smooth")
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_40_boot)
HXLINE(  40)		SIN45 = ((Float)0.70710678118654752440084436210485);
            	}
{
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_41_boot)
HXLINE(  41)		TAN22 = ((Float)0.4142135623730950488016887242097);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_48_boot)
HXLINE(  48)		fillCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__alloc( HX_CTX );
            	}
{
