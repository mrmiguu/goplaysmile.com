...
HX_DEFINE_STACK_FRAME(_hx_pos_81bdcfb19984cb04_7_new,"openfl.errors.ArgumentError","new",0x72c6c578,"openfl.errors.ArgumentError.new","openfl/errors/ArgumentError.hx",7,0xb16d4318)
namespace openfl{
namespace errors{

void ArgumentError_obj::__construct(::String __o_message){
::String message = __o_message.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_81bdcfb19984cb04_7_new)
            	HX_STACK_THIS(this)
