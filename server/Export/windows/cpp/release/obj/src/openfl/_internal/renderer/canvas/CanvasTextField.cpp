...
HX_DEFINE_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_40_disableInputMode,"openfl._internal.renderer.canvas.CanvasTextField","disableInputMode",0x782779b9,"openfl._internal.renderer.canvas.CanvasTextField.disableInputMode","openfl/_internal/renderer/canvas/CanvasTextField.hx",40,0xcdf61a26)
HX_DEFINE_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_49_enableInputMode,"openfl._internal.renderer.canvas.CanvasTextField","enableInputMode",0x5a626bd6,"openfl._internal.renderer.canvas.CanvasTextField.enableInputMode","openfl/_internal/renderer/canvas/CanvasTextField.hx",49,0xcdf61a26)
HX_DEFINE_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_112_render,"openfl._internal.renderer.canvas.CanvasTextField","render",0xbf0ed28a,"openfl._internal.renderer.canvas.CanvasTextField.render","openfl/_internal/renderer/canvas/CanvasTextField.hx",112,0xcdf61a26)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasTextField_obj::disableInputMode( ::openfl::_internal::text::TextEngine textEngine){
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_40_disableInputMode)
...
void CanvasTextField_obj::enableInputMode( ::openfl::_internal::text::TextEngine textEngine){
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_49_enableInputMode)
            	HX_STACK_ARG(textEngine,"textEngine")
            	}
...
void CanvasTextField_obj::render( ::openfl::text::TextField textField, ::openfl::_internal::renderer::RenderSession renderSession, ::openfl::geom::Matrix transform){
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_112_render)
