...
Dynamic LineScaleMode_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic LineScaleMode_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","fromString",0x5d04613a,"openfl.display._LineScaleMode.LineScaleMode_Impl_.fromString","openfl/display/LineScaleMode.hx",13,0x274c8551)
...
::String LineScaleMode_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","toString",0x67991e4b,"openfl.display._LineScaleMode.LineScaleMode_Impl_.toString","openfl/display/LineScaleMode.hx",27,0x274c8551)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",6,0x274c8551)
HXLINE(   6)		HORIZONTAL = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",7,0x274c8551)
HXLINE(   7)		NONE = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",8,0x274c8551)
HXLINE(   8)		NORMAL = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display._LineScaleMode.LineScaleMode_Impl_","boot",0xe0c8d651,"openfl.display._LineScaleMode.LineScaleMode_Impl_.boot","openfl/display/LineScaleMode.hx",9,0x274c8551)
