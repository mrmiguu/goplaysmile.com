...
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_35_getDeviceAt,"openfl.ui.GameInput","getDeviceAt",0x22aaba0d,"openfl.ui.GameInput.getDeviceAt","openfl/ui/GameInput.hx",35,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_48___getDevice,"openfl.ui.GameInput","__getDevice",0x7418beda,"openfl.ui.GameInput.__getDevice","openfl/ui/GameInput.hx",48,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_66___onGamepadAxisMove,"openfl.ui.GameInput","__onGamepadAxisMove",0x7bd40ec2,"openfl.ui.GameInput.__onGamepadAxisMove","openfl/ui/GameInput.hx",66,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_90___onGamepadButtonDown,"openfl.ui.GameInput","__onGamepadButtonDown",0xedf461e4,"openfl.ui.GameInput.__onGamepadButtonDown","openfl/ui/GameInput.hx",90,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_114___onGamepadButtonUp,"openfl.ui.GameInput","__onGamepadButtonUp",0x48120b5d,"openfl.ui.GameInput.__onGamepadButtonUp","openfl/ui/GameInput.hx",114,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_138___onGamepadConnect,"openfl.ui.GameInput","__onGamepadConnect",0xce3c5b7a,"openfl.ui.GameInput.__onGamepadConnect","openfl/ui/GameInput.hx",138,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_152___onGamepadDisconnect,"openfl.ui.GameInput","__onGamepadDisconnect",0xaad45ecc,"openfl.ui.GameInput.__onGamepadDisconnect","openfl/ui/GameInput.hx",152,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_18_boot,"openfl.ui.GameInput","boot",0x7dac3a44,"openfl.ui.GameInput.boot","openfl/ui/GameInput.hx",18,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_19_boot,"openfl.ui.GameInput","boot",0x7dac3a44,"openfl.ui.GameInput.boot","openfl/ui/GameInput.hx",19,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_21_boot,"openfl.ui.GameInput","boot",0x7dac3a44,"openfl.ui.GameInput.boot","openfl/ui/GameInput.hx",21,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_22_boot,"openfl.ui.GameInput","boot",0x7dac3a44,"openfl.ui.GameInput.boot","openfl/ui/GameInput.hx",22,0x96cdaf42)
HX_DEFINE_STACK_FRAME(_hx_pos_bf4ee6978d1f0060_23_boot,"openfl.ui.GameInput","boot",0x7dac3a44,"openfl.ui.GameInput.boot","openfl/ui/GameInput.hx",23,0x96cdaf42)
namespace openfl{
namespace ui{
...
HXLINE(  54)			HX_VARI( ::String,device) = ( (::String)(( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_guid(gamepad->id)) )) );
HXDLIN(  54)			HX_VARI_NAME(  ::openfl::ui::GameInputDevice,device1,"device") =  ::openfl::ui::GameInputDevice_obj::__alloc( HX_CTX ,device,( (::String)(( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_name(gamepad->id)) )) ));
...
HXDLIN(  75)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("AXIS_",9e,28,6e,a7) + control),(int)-1,(int)1,null());
HXLINE(  76)				device->_hx___axis->set(axis,control1);
HXLINE(  77)				device->_hx___controls->push(control1);
            			}
HXLINE(  81)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = device->_hx___axis->get(axis).StaticCast<  ::openfl::ui::GameInputControl >();
...
HXDLIN(  99)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),(int)0,(int)1,null());
HXLINE( 100)				device->_hx___button->set(button,control1);
HXLINE( 101)				device->_hx___controls->push(control1);
            			}
HXLINE( 105)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = device->_hx___button->get(button).StaticCast<  ::openfl::ui::GameInputControl >();
...
HXDLIN( 123)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),(int)0,(int)1,null());
HXLINE( 124)				device->_hx___button->set(button,control1);
HXLINE( 125)				device->_hx___controls->push(control1);
            			}
HXLINE( 129)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = device->_hx___button->get(button).StaticCast<  ::openfl::ui::GameInputControl >();
