...
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_874_new,"openfl._internal.stage3D._AGALConverter.SamplerRegister","new",0xf340d88e,"openfl._internal.stage3D._AGALConverter.SamplerRegister.new","openfl/_internal/stage3D/AGALConverter.hx",874,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_899_toGLSL,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toGLSL",0xc158218b,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",899,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_907_toSamplerState,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toSamplerState",0x8ed80c96,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toSamplerState","openfl/_internal/stage3D/AGALConverter.hx",907,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_881_parse,"openfl._internal.stage3D._AGALConverter.SamplerRegister","parse",0x0bb77fe1,"openfl._internal.stage3D._AGALConverter.SamplerRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",881,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_874_new)
            	HX_STACK_THIS(this)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_899_toGLSL)
            	HX_STACK_THIS(this)
HXLINE( 901)		::String str = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE( 902)		return (str + this->n);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_907_toSamplerState)
            	HX_STACK_THIS(this)
...
HXLINE( 939)					minFilter = (int)9985;
            			...
            			break;
            			default:{
HXLINE( 943)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 948)		switch((int)(this->w)){
            			case (int)0: {
...
HXLINE( 958)				wrapModeT = (int)10497;
            			...
            			break;
            			default:{
HXLINE( 962)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 973)		return  ::openfl::_internal::stage3D::SamplerState_obj::__alloc( HX_CTX ,minFilter,magFilter,wrapModeS,wrapModeT,((Float)((int)((int)this->b << (int)(int)24) >> (int)(int)24) / (Float)((Float)8.0)),((Float)0.0),(((int)this->s & (int)(int)4) == (int)4),(((int)this->s & (int)(int)1) == (int)1));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( ::cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_881_parse)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(programType,"programType")
HXLINE( 883)		HX_VARI(  ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister,sr) =  ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 884)		sr->programType = programType;
HXLINE( 885)		 ::cpp::Int64Struct a = _hx_int64_shr(v,(int)60);
HXDLIN( 885)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)15))));
HXLINE( 886)		 ::cpp::Int64Struct a1 = _hx_int64_shr(v,(int)56);
HXDLIN( 886)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)15))));
HXLINE( 887)		 ::cpp::Int64Struct a2 = _hx_int64_shr(v,(int)52);
HXDLIN( 887)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 888)		 ::cpp::Int64Struct a3 = _hx_int64_shr(v,(int)48);
HXDLIN( 888)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 889)		 ::cpp::Int64Struct a4 = _hx_int64_shr(v,(int)44);
HXDLIN( 889)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)15))));
HXLINE( 890)		 ::cpp::Int64Struct a5 = _hx_int64_shr(v,(int)40);
HXDLIN( 890)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)15))));
HXLINE( 891)		 ::cpp::Int64Struct a6 = _hx_int64_shr(v,(int)32);
HXDLIN( 891)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct((int)15))));
HXLINE( 892)		 ::cpp::Int64Struct a7 = _hx_int64_shr(v,(int)16);
HXDLIN( 892)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct((int)255))));
HXLINE( 893)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
