...
HX_DEFINE_STACK_FRAME(_hx_pos_4c03b94c358d6de6_151_new,"openfl.filters._BlurFilter.BlurShader","new",0x1c9d0f9f,"openfl.filters._BlurFilter.BlurShader.new","openfl/filters/BlurFilter.hx",151,0x46563eac)
HX_DEFINE_STACK_FRAME(_hx_pos_4c03b94c358d6de6_162___update,"openfl.filters._BlurFilter.BlurShader","__update",0x96830d8a,"openfl.filters._BlurFilter.BlurShader.__update","openfl/filters/BlurFilter.hx",162,0x46563eac)
namespace openfl{
namespace filters{
namespace _BlurFilter{

void BlurShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_151_new)
            	HX_STACK_THIS(this)
...
HXLINE( 156)		 ::Dynamic(this->get_data()->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0),hx::paccDynamic);
            	}
...
void BlurShader_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_162___update)
            	HX_STACK_THIS(this)
HXLINE( 164)		int _hx_tmp = this->get_data()->uImage0->input->width;
HXDLIN( 164)		 ::Dynamic(this->get_data()->__Field(HX_("uTextureSize",c7,50,82,f3),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,_hx_tmp)->init(1,this->get_data()->uImage0->input->height),hx::paccDynamic);
HXLINE( 166)		this->super::_hx___update();
            	}
