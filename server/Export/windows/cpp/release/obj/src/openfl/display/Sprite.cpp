...
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_45_startDrag,"openfl.display.Sprite","startDrag",0x20ea0c37,"openfl.display.Sprite.startDrag","openfl/display/Sprite.hx",45,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_56_stopDrag,"openfl.display.Sprite","stopDrag",0x4d02dd75,"openfl.display.Sprite.stopDrag","openfl/display/Sprite.hx",56,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_67___getCursor,"openfl.display.Sprite","__getCursor",0x4a69b9ed,"openfl.display.Sprite.__getCursor","openfl/display/Sprite.hx",67,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_72___hitTest,"openfl.display.Sprite","__hitTest",0x895417e6,"openfl.display.Sprite.__hitTest","openfl/display/Sprite.hx",72,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_134___hitTestMask,"openfl.display.Sprite","__hitTestMask",0x9c046ff2,"openfl.display.Sprite.__hitTestMask","openfl/display/Sprite.hx",134,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_158_get_graphics,"openfl.display.Sprite","get_graphics",0x451134b3,"openfl.display.Sprite.get_graphics","openfl/display/Sprite.hx",158,0xd5438ced)
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_173_get_tabEnabled,"openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",173,0xd5438ced)
namespace openfl{
namespace display{
...
HXDLIN( 101)						point->y = (((Float)((Float)1.0) / (Float)norm) * ((_this->a * (point->y - _this->ty)) + (_this->b * (_this->tx - point->x))));
...
HXLINE( 115)					_hx_tmp6 = this->mouseEnabled;
            				}
            				else {
HXLINE( 115)					_hx_tmp6 = true;
            				}
HXDLIN( 115)				if (_hx_tmp6) {
HXLINE( 115)					_hx_tmp5 = hx::IsNotNull( this->_hx___graphics );
            				}
            				else {
HXLINE( 115)					_hx_tmp5 = false;
            				}
HXDLIN( 115)				if (_hx_tmp5) {
HXLINE( 115)					 ::openfl::display::Graphics _hx_tmp7 = this->_hx___graphics;
HXDLIN( 115)					_hx_tmp4 = _hx_tmp7->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            				}
            				else {
HXLINE( 115)					_hx_tmp4 = false;
            				}
