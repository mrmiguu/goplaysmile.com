...
HXLINE(  27)		Bool _hx_tmp = hx::IsNull( type );
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  29)			type = (int)0;
            		}
HXLINE(  33)		Bool _hx_tmp1 = hx::IsNull( spreadMethod );
HXDLIN(  33)		if (_hx_tmp1) {
HXLINE(  35)			spreadMethod = (int)0;
            		}
HXLINE(  39)		Bool _hx_tmp2 = hx::IsNull( interpolationMethod );
...
hx::ObjectPtr< GraphicsGradientFill_obj > GraphicsGradientFill_obj::__new( ::Dynamic type,::Array< Int > colors,::Array< Float > alphas,::Array< Int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,hx::Null< Float >  __o_focalPointRatio)
{
	...
	_hx_result->__construct(type,colors,alphas,ratios,matrix,spreadMethod,interpolationMethod,__o_focalPointRatio);
	return _hx_result;
}
