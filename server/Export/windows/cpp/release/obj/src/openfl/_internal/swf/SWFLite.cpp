...
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_41_createButton,"openfl._internal.swf.SWFLite","createButton",0xef1732a8,"openfl._internal.swf.SWFLite.createButton","openfl/_internal/swf/SWFLite.hx",41,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_46_createMovieClip,"openfl._internal.swf.SWFLite","createMovieClip",0x9d5307aa,"openfl._internal.swf.SWFLite.createMovieClip","openfl/_internal/swf/SWFLite.hx",46,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_75_getBitmapData,"openfl._internal.swf.SWFLite","getBitmapData",0x22b00815,"openfl._internal.swf.SWFLite.getBitmapData","openfl/_internal/swf/SWFLite.hx",75,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_97_hasSymbol,"openfl._internal.swf.SWFLite","hasSymbol",0x5477cd78,"openfl._internal.swf.SWFLite.hasSymbol","openfl/_internal/swf/SWFLite.hx",97,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_170_serialize,"openfl._internal.swf.SWFLite","serialize",0x19a3c906,"openfl._internal.swf.SWFLite.serialize","openfl/_internal/swf/SWFLite.hx",170,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_114_resolveClass,"openfl._internal.swf.SWFLite","resolveClass",0x73bf4e46,"openfl._internal.swf.SWFLite.resolveClass","openfl/_internal/swf/SWFLite.hx",114,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_140_resolveEnum,"openfl._internal.swf.SWFLite","resolveEnum",0xa29090b3,"openfl._internal.swf.SWFLite.resolveEnum","openfl/_internal/swf/SWFLite.hx",140,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_179_unserialize,"openfl._internal.swf.SWFLite","unserialize",0x3ed7e50d,"openfl._internal.swf.SWFLite.unserialize","openfl/_internal/swf/SWFLite.hx",179,0x035d4d2d)
HX_DEFINE_STACK_FRAME(_hx_pos_1ea65a35277eaab5_22_boot,"openfl._internal.swf.SWFLite","boot",0xfcedeacc,"openfl._internal.swf.SWFLite.boot","openfl/_internal/swf/SWFLite.hx",22,0x035d4d2d)
namespace openfl{
namespace _internal{
namespace swf{
...
HXLINE(  54)			HX_VARI(  ::Dynamic,symbol) = this->symbols->iterator();
HXDLIN(  54)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  54)				HX_VARI_NAME(  ::openfl::_internal::symbols::SWFSymbol,symbol1,"symbol") = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HX_DEFINE_DYNAMIC_FUNC1(SWFLite_obj,createMovieClip,return )
 ...
 ::openfl::display::BitmapData SWFLite_obj::getBitmapData(::String className){
            	...
            	HX_STACK_ARG(className,"className")
HXLINE(  77)		{
HXLINE(  77)			HX_VARI(  ::Dynamic,symbol) = this->symbols->iterator();
HXDLIN(  77)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  77)				HX_VARI_NAME(  ::openfl::_internal::symbols::SWFSymbol,symbol1,"symbol") = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  79)				if ((symbol1->className == className)) {
HXLINE(  81)					if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE(  84)						return ::openfl::Assets_obj::getBitmapData(( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) )->path,null());
            					}
            				}
            			}
            		}
...
bool SWFLite_obj::hasSymbol(::String className){
            	...
            	HX_STACK_ARG(className,"className")
HXLINE(  99)		{
HXLINE(  99)			HX_VARI(  ::Dynamic,symbol) = this->symbols->iterator();
HXDLIN(  99)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 101)				if ((( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) )->className == className)) {
...
::String SWFLite_obj::serialize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 172)		HX_VARI(  ::haxe::Serializer,serializer) =  ::haxe::Serializer_obj::__alloc( HX_CTX );
...
HXLINE( 187)		HX_VARI(  ::haxe::Unserializer,unserializer) =  ::haxe::Unserializer_obj::__alloc( HX_CTX ,data);
