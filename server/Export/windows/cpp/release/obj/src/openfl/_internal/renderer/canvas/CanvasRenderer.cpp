...
HX_LOCAL_STACK_FRAME(_hx_pos_51aed30dab802763_38_clear,"openfl._internal.renderer.canvas.CanvasRenderer","clear",0xe6eb1315,"openfl._internal.renderer.canvas.CanvasRenderer.clear","openfl/_internal/renderer/canvas/CanvasRenderer.hx",38,0x1be544e6)
HX_LOCAL_STACK_FRAME(_hx_pos_51aed30dab802763_47_render,"openfl._internal.renderer.canvas.CanvasRenderer","render",0x244720ce,"openfl._internal.renderer.canvas.CanvasRenderer.render","openfl/_internal/renderer/canvas/CanvasRenderer.hx",47,0x1be544e6)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
HXLINE(  30)		this->renderSession->maskManager =  ::openfl::_internal::renderer::canvas::CanvasMaskManager_obj::__alloc( HX_CTX ,this->renderSession);
            	}
...
void CanvasRenderer_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_51aed30dab802763_38_clear)
HXLINE(  38)		int _g = (int)0;
HXDLIN(  38)		 ::openfl::_Vector::ObjectVector _g1 = this->stage->stage3Ds;
HXDLIN(  38)		while((_g < _g1->get_length())){
HXLINE(  38)			 ::openfl::display::Stage3D stage3D = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
...
void CanvasRenderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_51aed30dab802763_47_render)
...
HXLINE(  57)			 ::lime::graphics::CanvasRenderContext _hx_tmp1 = this->context;
HXDLIN(  57)			Float _hx_tmp2 = (this->stage->stageWidth * this->stage->window->_hx___scale);
HXDLIN(  57)			_hx_tmp1->fillRect((int)0,(int)0,_hx_tmp2,(this->stage->stageHeight * this->stage->window->_hx___scale));
            		}
            		else {
...
HXLINE(  61)				 ::lime::graphics::CanvasRenderContext _hx_tmp4 = this->context;
HXDLIN(  61)				Float _hx_tmp5 = (this->stage->stageWidth * this->stage->window->_hx___scale);
HXDLIN(  61)				_hx_tmp4->clearRect((int)0,(int)0,_hx_tmp5,(this->stage->stageHeight * this->stage->window->_hx___scale));
            			}
            		}
