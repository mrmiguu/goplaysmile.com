...
HX_DEFINE_STACK_FRAME(_hx_pos_51aed30dab802763_38_clear,"openfl._internal.renderer.canvas.CanvasRenderer","clear",0xe6eb1315,"openfl._internal.renderer.canvas.CanvasRenderer.clear","openfl/_internal/renderer/canvas/CanvasRenderer.hx",38,0x1be544e6)
HX_DEFINE_STACK_FRAME(_hx_pos_51aed30dab802763_47_render,"openfl._internal.renderer.canvas.CanvasRenderer","render",0x244720ce,"openfl._internal.renderer.canvas.CanvasRenderer.render","openfl/_internal/renderer/canvas/CanvasRenderer.hx",47,0x1be544e6)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
HXLINE(  38)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
...
HXLINE(  59)				_hx_tmp1 = this->stage->_hx___clearBeforeRender;
            			}
            			else {
