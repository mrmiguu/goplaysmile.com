...
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_26_clone,"openfl.events.FullScreenEvent","clone",0xd0bfa7d7,"openfl.events.FullScreenEvent.clone","openfl/events/FullScreenEvent.hx",26,0x5d391076)
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_39_toString,"openfl.events.FullScreenEvent","toString",0x75cac472,"openfl.events.FullScreenEvent.toString","openfl/events/FullScreenEvent.hx",39,0x5d391076)
...
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_7_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",7,0x5d391076)
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_8_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",8,0x5d391076)
namespace openfl{
namespace events{
...
bool FullScreenEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FullScreenEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  28)		HX_VARI(  ::openfl::events::FullScreenEvent,event) =  ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->fullScreen,this->interactive);
