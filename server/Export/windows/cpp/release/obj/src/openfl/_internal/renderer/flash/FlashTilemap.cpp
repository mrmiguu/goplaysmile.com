...
HX_DEFINE_STACK_FRAME(_hx_pos_902fc7ae56fcb148_20_render,"openfl._internal.renderer.flash.FlashTilemap","render",0xa68b48cd,"openfl._internal.renderer.flash.FlashTilemap.render","openfl/_internal/renderer/flash/FlashTilemap.hx",20,0x8554e347)
namespace openfl{
namespace _internal{
namespace renderer{
namespace flash{
...
void FlashTilemap_obj::render( ::openfl::display::Tilemap tilemap){
            	HX_STACKFRAME(&_hx_pos_902fc7ae56fcb148_20_render)
