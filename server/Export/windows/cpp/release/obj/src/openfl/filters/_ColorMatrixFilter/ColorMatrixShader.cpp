...
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_150_new,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","new",0xf11da59b,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.new","openfl/filters/ColorMatrixFilter.hx",150,0xb64128b5)
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_162_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",162,0xb64128b5)
namespace openfl{
namespace filters{
namespace _ColorMatrixFilter{

void ColorMatrixShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_150_new)
            	HX_STACK_THIS(this)
...
void ColorMatrixShader_obj::init(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_162_init)
            	HX_STACK_THIS(this)
...
HXLINE( 167)		multipliers[(int)0] = matrix->__get((int)0);
HXLINE( 168)		multipliers[(int)1] = matrix->__get((int)1);
HXLINE( 169)		multipliers[(int)2] = matrix->__get((int)2);
HXLINE( 170)		multipliers[(int)3] = matrix->__get((int)3);
HXLINE( 171)		multipliers[(int)4] = matrix->__get((int)5);
HXLINE( 172)		multipliers[(int)5] = matrix->__get((int)6);
HXLINE( 173)		multipliers[(int)6] = matrix->__get((int)7);
HXLINE( 174)		multipliers[(int)7] = matrix->__get((int)8);
HXLINE( 175)		multipliers[(int)8] = matrix->__get((int)10);
HXLINE( 176)		multipliers[(int)9] = matrix->__get((int)11);
HXLINE( 177)		multipliers[(int)10] = matrix->__get((int)12);
HXLINE( 178)		multipliers[(int)11] = matrix->__get((int)13);
HXLINE( 179)		multipliers[(int)12] = matrix->__get((int)15);
HXLINE( 180)		multipliers[(int)13] = matrix->__get((int)16);
HXLINE( 181)		multipliers[(int)14] = matrix->__get((int)17);
HXLINE( 182)		multipliers[(int)15] = matrix->__get((int)18);
HXLINE( 184)		offsets[(int)0] = ((Float)matrix->__get((int)4) / (Float)((Float)255.0));
HXLINE( 185)		offsets[(int)1] = ((Float)matrix->__get((int)9) / (Float)((Float)255.0));
HXLINE( 186)		offsets[(int)2] = ((Float)matrix->__get((int)14) / (Float)((Float)255.0));
HXLINE( 187)		offsets[(int)3] = ((Float)matrix->__get((int)19) / (Float)((Float)255.0));
            	}
