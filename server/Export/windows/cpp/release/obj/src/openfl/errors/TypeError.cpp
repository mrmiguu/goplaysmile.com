...
HX_DEFINE_STACK_FRAME(_hx_pos_5bc3dc96f52a961d_7_new,"openfl.errors.TypeError","new",0x4857781b,"openfl.errors.TypeError.new","openfl/errors/TypeError.hx",7,0xef0d65d5)
namespace openfl{
namespace errors{

void TypeError_obj::__construct(::String __o_message){
::String message = __o_message.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_5bc3dc96f52a961d_7_new)
