...
HX_DEFINE_STACK_FRAME(_hx_pos_2687fe8a484538ac_22_render,"openfl._internal.renderer.opengl.GLDisplayObject","render",0xfc18482c,"openfl._internal.renderer.opengl.GLDisplayObject.render","openfl/_internal/renderer/opengl/GLDisplayObject.hx",22,0xe7a796c8)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
HXLINE(  34)			Float _hx_tmp4 = displayObject->get_width();
HXDLIN(  34)			rect->setTo((int)0,(int)0,_hx_tmp4,displayObject->get_height());
...
HXLINE(  48)				_hx_tmp5 = (displayObject->_hx___worldAlpha <= (int)0);
            			}
            			else {
...
HXDLIN(  48)				if (hx::IsNotNull( graphics )) {
...
HXLINE(  48)						_hx_tmp6 = graphics->_hx___visible;
            					}
            					else {
...
HXDLIN(  48)						renderSession->blendModeManager->setBlendMode(displayObject->get_blendMode());
...
HXDLIN(  48)						HX_VARI_NAME( int,gl2,"gl") = gl1->ARRAY_BUFFER;
HXDLIN(  48)						gl1->bindBuffer(gl2,graphics->_hx___bitmap->getBuffer(gl1,displayObject->_hx___worldAlpha));
