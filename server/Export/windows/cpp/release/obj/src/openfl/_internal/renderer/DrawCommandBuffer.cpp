...
void DrawCommandBuffer_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","new",0xdc2c151e,"openfl._internal.renderer.DrawCommandBuffer.new","openfl/_internal/renderer/DrawCommandBuffer.hx",44,0xbc8e6e11)
            	HX_STACK_THIS(this)
HXLINE(  44)		Bool _hx_tmp = hx::IsNull( ::openfl::_internal::renderer::DrawCommandBuffer_obj::empty );
...
Dynamic DrawCommandBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_internal::renderer::DrawCommandBuffer DrawCommandBuffer_obj::append( ::openfl::_internal::renderer::DrawCommandBuffer other){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","append",0x1b14a7dc,"openfl._internal.renderer.DrawCommandBuffer.append","openfl/_internal/renderer/DrawCommandBuffer.hx",66,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(other,"other")
HXLINE(  68)		Int _hx_tmp = this->get_length();
HXDLIN(  68)		if ((_hx_tmp == (int)0)) {
...
HXLINE(  83)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,data) =  ::openfl::_internal::renderer::DrawCommandReader_obj::__new(other);
HXLINE(  85)		{
HXLINE(  85)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  85)			HX_VARI( ::Array< ::Dynamic>,_g1) = other->types;
HXDLIN(  85)			while((_g < _g1->length)){
HXLINE(  85)				HX_VARI( ::hx::EnumBase,type) = _g1->__get(_g).StaticCast< ::hx::EnumBase >();
HXDLIN(  85)				++_g;
HXLINE(  87)				Int _hx_tmp1 = ( ( ::hx::EnumBase)(type) )->_hx_getIndex();
HXDLIN(  87)				switch((int)(_hx_tmp1)){
            					case (int)0: {
HXLINE(  89)						{
HXLINE(  89)							Int _hx_tmp2 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  89)							switch((int)(_hx_tmp2)){
            								case (int)0: {
...
HXDLIN(  89)						 ::openfl::display::BitmapData _hx_tmp3 = ( ( ::openfl::display::BitmapData)(c->buffer->o->__get(c->oPos)) );
HXDLIN(  89)						 ::openfl::geom::Matrix _hx_tmp4 = ( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + (int)1))) );
HXDLIN(  89)						Bool _hx_tmp5 = c->buffer->b->__get(c->bPos);
HXDLIN(  89)						Bool _hx_tmp6 = c->buffer->b->__get((c->bPos + (int)1));
HXDLIN(  89)						this->beginBitmapFill(_hx_tmp3,_hx_tmp4,_hx_tmp5,_hx_tmp6);
            					}
            					break;
            					case (int)1: {
HXLINE(  90)						{
HXLINE(  90)							Int _hx_tmp7 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  90)							switch((int)(_hx_tmp7)){
            								case (int)0: {
...
HXDLIN(  90)						Int _hx_tmp8 = c1->buffer->i->__get(c1->iPos);
HXDLIN(  90)						Float _hx_tmp9 = c1->buffer->f->__get(c1->fPos);
HXDLIN(  90)						this->beginFill(_hx_tmp8,_hx_tmp9);
            					}
            					break;
            					case (int)2: {
HXLINE(  91)						{
HXLINE(  91)							Int _hx_tmp10 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  91)							switch((int)(_hx_tmp10)){
            								case (int)0: {
...
HXDLIN(  91)						Int _hx_tmp11 = (c2->iiPos + (int)1);
HXDLIN(  91)						Int _hx_tmp12 = (c2->oPos + (int)1);
HXDLIN(  91)						Int _hx_tmp13 = (c2->oPos + (int)2);
HXDLIN(  91)						Int _hx_tmp14 = (c2->oPos + (int)3);
HXDLIN(  91)						this->beginGradientFill(c2->buffer->o->__get(c2->oPos),c2->buffer->ii->__get(c2->iiPos).StaticCast< ::Array< Int > >(),c2->buffer->ff->__get(c2->ffPos).StaticCast< ::Array< Float > >(),c2->buffer->ii->__get(_hx_tmp11).StaticCast< ::Array< Int > >(),( ( ::openfl::geom::Matrix)(c2->buffer->o->__get(_hx_tmp12)) ),c2->buffer->o->__get(_hx_tmp13),c2->buffer->o->__get(_hx_tmp14),c2->buffer->f->__get(c2->fPos));
            					...
            					case (int)3: {
HXLINE(  92)						{
HXLINE(  92)							Int _hx_tmp15 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  92)							switch((int)(_hx_tmp15)){
            								case (int)0: {
...
HXDLIN(  92)						Float _hx_tmp16 = c3->buffer->f->__get(c3->fPos);
HXDLIN(  92)						Float _hx_tmp17 = c3->buffer->f->__get((c3->fPos + (int)1));
HXDLIN(  92)						Float _hx_tmp18 = c3->buffer->f->__get((c3->fPos + (int)2));
HXDLIN(  92)						Float _hx_tmp19 = c3->buffer->f->__get((c3->fPos + (int)3));
HXDLIN(  92)						Float _hx_tmp20 = c3->buffer->f->__get((c3->fPos + (int)4));
HXDLIN(  92)						Float _hx_tmp21 = c3->buffer->f->__get((c3->fPos + (int)5));
HXDLIN(  92)						this->cubicCurveTo(_hx_tmp16,_hx_tmp17,_hx_tmp18,_hx_tmp19,_hx_tmp20,_hx_tmp21);
            					}
            					break;
            					case (int)4: {
HXLINE(  93)						{
HXLINE(  93)							Int _hx_tmp22 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  93)							switch((int)(_hx_tmp22)){
            								case (int)0: {
...
HXDLIN(  93)						Float _hx_tmp23 = c4->buffer->f->__get(c4->fPos);
HXDLIN(  93)						Float _hx_tmp24 = c4->buffer->f->__get((c4->fPos + (int)1));
HXDLIN(  93)						Float _hx_tmp25 = c4->buffer->f->__get((c4->fPos + (int)2));
HXDLIN(  93)						Float _hx_tmp26 = c4->buffer->f->__get((c4->fPos + (int)3));
HXDLIN(  93)						this->curveTo(_hx_tmp23,_hx_tmp24,_hx_tmp25,_hx_tmp26);
            					}
            					break;
            					case (int)5: {
HXLINE(  94)						{
HXLINE(  94)							Int _hx_tmp27 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  94)							switch((int)(_hx_tmp27)){
            								case (int)0: {
...
HXDLIN(  94)						Float _hx_tmp28 = c5->buffer->f->__get(c5->fPos);
HXDLIN(  94)						Float _hx_tmp29 = c5->buffer->f->__get((c5->fPos + (int)1));
HXDLIN(  94)						Float _hx_tmp30 = c5->buffer->f->__get((c5->fPos + (int)2));
HXDLIN(  94)						this->drawCircle(_hx_tmp28,_hx_tmp29,_hx_tmp30);
            					}
            					break;
            					case (int)6: {
HXLINE(  95)						{
HXLINE(  95)							Int _hx_tmp31 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  95)							switch((int)(_hx_tmp31)){
            								case (int)0: {
...
HXDLIN(  95)						Float _hx_tmp32 = c6->buffer->f->__get(c6->fPos);
HXDLIN(  95)						Float _hx_tmp33 = c6->buffer->f->__get((c6->fPos + (int)1));
HXDLIN(  95)						Float _hx_tmp34 = c6->buffer->f->__get((c6->fPos + (int)2));
HXDLIN(  95)						Float _hx_tmp35 = c6->buffer->f->__get((c6->fPos + (int)3));
HXDLIN(  95)						this->drawEllipse(_hx_tmp32,_hx_tmp33,_hx_tmp34,_hx_tmp35);
            					}
            					break;
            					case (int)7: {
HXLINE(  96)						{
HXLINE(  96)							Int _hx_tmp36 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  96)							switch((int)(_hx_tmp36)){
            								case (int)0: {
...
HXDLIN(  96)						Float _hx_tmp37 = c7->buffer->f->__get(c7->fPos);
HXDLIN(  96)						Float _hx_tmp38 = c7->buffer->f->__get((c7->fPos + (int)1));
HXDLIN(  96)						Float _hx_tmp39 = c7->buffer->f->__get((c7->fPos + (int)2));
HXDLIN(  96)						Float _hx_tmp40 = c7->buffer->f->__get((c7->fPos + (int)3));
HXDLIN(  96)						this->drawRect(_hx_tmp37,_hx_tmp38,_hx_tmp39,_hx_tmp40);
            					}
            					break;
            					case (int)8: {
HXLINE(  97)						{
HXLINE(  97)							Int _hx_tmp41 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  97)							switch((int)(_hx_tmp41)){
            								case (int)0: {
...
HXDLIN(  97)						Float _hx_tmp42 = c8->buffer->f->__get(c8->fPos);
HXDLIN(  97)						Float _hx_tmp43 = c8->buffer->f->__get((c8->fPos + (int)1));
HXDLIN(  97)						Float _hx_tmp44 = c8->buffer->f->__get((c8->fPos + (int)2));
HXDLIN(  97)						Float _hx_tmp45 = c8->buffer->f->__get((c8->fPos + (int)3));
HXDLIN(  97)						Float _hx_tmp46 = c8->buffer->f->__get((c8->fPos + (int)4));
HXDLIN(  97)						this->drawRoundRect(_hx_tmp42,_hx_tmp43,_hx_tmp44,_hx_tmp45,_hx_tmp46,c8->buffer->o->__get(c8->oPos));
            					}
            					break;
            					case (int)10: {
HXLINE(  98)						{
HXLINE(  98)							Int _hx_tmp47 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  98)							switch((int)(_hx_tmp47)){
            								case (int)0: {
...
HXDLIN(  98)						Int _hx_tmp48 = (c9->oPos + (int)1);
HXDLIN(  98)						Int _hx_tmp49 = (c9->oPos + (int)2);
HXDLIN(  98)						Int _hx_tmp50 = (c9->oPos + (int)3);
HXDLIN(  98)						this->drawTriangles(( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(c9->oPos)) ),( ( ::openfl::_Vector::IntVector)(c9->buffer->o->__get(_hx_tmp48)) ),( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(_hx_tmp49)) ),c9->buffer->o->__get(_hx_tmp50));
            					}
            					break;
            					case (int)11: {
HXLINE(  99)						{
HXLINE(  99)							Int _hx_tmp51 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(  99)							switch((int)(_hx_tmp51)){
            								case (int)0: {
...
HXDLIN(  99)						this->endFill();
            					...
            					case (int)12: {
HXLINE( 100)						{
HXLINE( 100)							Int _hx_tmp52 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 100)							switch((int)(_hx_tmp52)){
            								case (int)0: {
...
HXDLIN( 100)						Int _hx_tmp53 = (c10->oPos + (int)1);
HXDLIN( 100)						Int _hx_tmp54 = (c10->bPos + (int)1);
HXDLIN( 100)						this->lineBitmapStyle(( ( ::openfl::display::BitmapData)(c10->buffer->o->__get(c10->oPos)) ),( ( ::openfl::geom::Matrix)(c10->buffer->o->__get(_hx_tmp53)) ),c10->buffer->b->__get(c10->bPos),c10->buffer->b->__get(_hx_tmp54));
            					}
            					break;
            					case (int)13: {
HXLINE( 101)						{
HXLINE( 101)							Int _hx_tmp55 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 101)							switch((int)(_hx_tmp55)){
            								case (int)0: {
HXLINE( 101)									hx::AddEq(data->oPos,(int)2);
HXDLIN( 101)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE( 101)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 101)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE( 101)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 101)									hx::AddEq(data->iiPos,(int)2);
HXDLIN( 101)									hx::AddEq(data->ffPos,(int)1);
HXDLIN( 101)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)4);
...
HXLINE( 101)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)5);
HXDLIN( 101)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE( 101)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN( 101)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE( 101)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 101)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 101)									hx::AddEq(data->fPos,(int)2);
HXDLIN( 101)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE( 101)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE( 101)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXDLIN( 101)						Int _hx_tmp56 = (c11->iiPos + (int)1);
HXDLIN( 101)						Int _hx_tmp57 = (c11->oPos + (int)1);
HXDLIN( 101)						Int _hx_tmp58 = (c11->oPos + (int)2);
HXDLIN( 101)						Int _hx_tmp59 = (c11->oPos + (int)3);
HXDLIN( 101)						this->lineGradientStyle(c11->buffer->o->__get(c11->oPos),c11->buffer->ii->__get(c11->iiPos).StaticCast< ::Array< Int > >(),c11->buffer->ff->__get(c11->ffPos).StaticCast< ::Array< Float > >(),c11->buffer->ii->__get(_hx_tmp56).StaticCast< ::Array< Int > >(),( ( ::openfl::geom::Matrix)(c11->buffer->o->__get(_hx_tmp57)) ),c11->buffer->o->__get(_hx_tmp58),c11->buffer->o->__get(_hx_tmp59),c11->buffer->f->__get(c11->fPos));
            					...
            					case (int)14: {
HXLINE( 102)						{
HXLINE( 102)							Int _hx_tmp60 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 102)							switch((int)(_hx_tmp60)){
            								case (int)0: {
HXLINE( 102)									hx::AddEq(data->oPos,(int)2);
HXDLIN( 102)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE( 102)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 102)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE( 102)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 102)									hx::AddEq(data->iiPos,(int)2);
HXDLIN( 102)									hx::AddEq(data->ffPos,(int)1);
HXDLIN( 102)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)4);
...
HXLINE( 102)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)5);
HXDLIN( 102)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE( 102)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN( 102)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE( 102)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 102)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 102)									hx::AddEq(data->fPos,(int)2);
HXDLIN( 102)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE( 102)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE( 102)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXDLIN( 102)						Int _hx_tmp61 = (c12->oPos + (int)1);
HXDLIN( 102)						Int _hx_tmp62 = (c12->oPos + (int)2);
HXDLIN( 102)						Int _hx_tmp63 = (c12->oPos + (int)3);
HXDLIN( 102)						Int _hx_tmp64 = (c12->fPos + (int)1);
HXDLIN( 102)						this->lineStyle(c12->buffer->o->__get(c12->oPos),c12->buffer->i->__get(c12->iPos),c12->buffer->f->__get(c12->fPos),c12->buffer->b->__get(c12->bPos),c12->buffer->o->__get(_hx_tmp61),c12->buffer->o->__get(_hx_tmp62),c12->buffer->o->__get(_hx_tmp63),c12->buffer->f->__get(_hx_tmp64));
            					}
            					break;
            					case (int)15: {
HXLINE( 103)						{
HXLINE( 103)							Int _hx_tmp65 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 103)							switch((int)(_hx_tmp65)){
            								case (int)0: {
HXLINE( 103)									hx::AddEq(data->oPos,(int)2);
HXDLIN( 103)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE( 103)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 103)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE( 103)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 103)									hx::AddEq(data->iiPos,(int)2);
HXDLIN( 103)									hx::AddEq(data->ffPos,(int)1);
HXDLIN( 103)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)4);
...
HXLINE( 103)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)5);
HXDLIN( 103)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE( 103)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN( 103)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE( 103)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 103)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 103)									hx::AddEq(data->fPos,(int)2);
HXDLIN( 103)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE( 103)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE( 103)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXDLIN( 103)						Float _hx_tmp66 = c13->buffer->f->__get(c13->fPos);
HXDLIN( 103)						Float _hx_tmp67 = c13->buffer->f->__get((c13->fPos + (int)1));
HXDLIN( 103)						this->lineTo(_hx_tmp66,_hx_tmp67);
            					}
            					break;
            					case (int)16: {
HXLINE( 104)						{
HXLINE( 104)							Int _hx_tmp68 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 104)							switch((int)(_hx_tmp68)){
            								case (int)0: {
HXLINE( 104)									hx::AddEq(data->oPos,(int)2);
HXDLIN( 104)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE( 104)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 104)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE( 104)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 104)									hx::AddEq(data->iiPos,(int)2);
HXDLIN( 104)									hx::AddEq(data->ffPos,(int)1);
HXDLIN( 104)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)4);
...
HXLINE( 104)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)5);
HXDLIN( 104)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE( 104)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN( 104)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE( 104)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 104)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 104)									hx::AddEq(data->fPos,(int)2);
HXDLIN( 104)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE( 104)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE( 104)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
HXDLIN( 104)						Float _hx_tmp69 = c14->buffer->f->__get(c14->fPos);
HXDLIN( 104)						Float _hx_tmp70 = c14->buffer->f->__get((c14->fPos + (int)1));
HXDLIN( 104)						this->moveTo(_hx_tmp69,_hx_tmp70);
            					}
            					break;
            					case (int)17: {
HXLINE( 105)						{
HXLINE( 105)							Int _hx_tmp71 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN( 105)							switch((int)(_hx_tmp71)){
            								case (int)0: {
HXLINE( 105)									hx::AddEq(data->oPos,(int)2);
HXDLIN( 105)									hx::AddEq(data->bPos,(int)2);
            								}
            								break;
            								case (int)1: {
HXLINE( 105)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 105)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)2: {
HXLINE( 105)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 105)									hx::AddEq(data->iiPos,(int)2);
HXDLIN( 105)									hx::AddEq(data->ffPos,(int)1);
HXDLIN( 105)									hx::AddEq(data->fPos,(int)1);
            								}
            								break;
            								case (int)3: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)6);
            								}
            								break;
            								case (int)4: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)4);
            								}
            								break;
            								case (int)5: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)3);
            								}
            								break;
            								case (int)6: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)4);
...
HXLINE( 105)									hx::AddEq(data->fPos,(int)4);
            								...
            								break;
            								case (int)8: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)5);
HXDLIN( 105)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								case (int)10: {
HXLINE( 105)									hx::AddEq(data->oPos,(int)4);
...
HXDLIN( 105)									hx::AddEq(data->fPos,(int)1);
            								...
            								case (int)14: {
HXLINE( 105)									hx::AddEq(data->oPos,(int)4);
HXDLIN( 105)									hx::AddEq(data->iPos,(int)1);
HXDLIN( 105)									hx::AddEq(data->fPos,(int)2);
HXDLIN( 105)									hx::AddEq(data->bPos,(int)1);
            								}
            								break;
            								case (int)15: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)2);
            								}
            								break;
            								case (int)16: {
HXLINE( 105)									hx::AddEq(data->fPos,(int)2);
            								...
            								break;
            								case (int)17: {
HXLINE( 105)									hx::AddEq(data->oPos,(int)1);
            								}
            								break;
            								default:{
            								}
...
void DrawCommandBuffer_obj::beginBitmapFill( ::openfl::display::BitmapData bitmap, ::openfl::geom::Matrix matrix,Bool repeat,Bool smooth){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","beginBitmapFill",0x90133359,"openfl._internal.renderer.DrawCommandBuffer.beginBitmapFill","openfl/_internal/renderer/DrawCommandBuffer.hx",118,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::beginFill(Int color,Float alpha){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","beginFill",0x6ae7148a,"openfl._internal.renderer.DrawCommandBuffer.beginFill","openfl/_internal/renderer/DrawCommandBuffer.hx",130,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::beginGradientFill( ::Dynamic type,::Array< Int > colors,::Array< Float > alphas,::Array< Int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","beginGradientFill",0x7d0b119a,"openfl._internal.renderer.DrawCommandBuffer.beginGradientFill","openfl/_internal/renderer/DrawCommandBuffer.hx",141,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","clear",0xfe5ce1cb,"openfl._internal.renderer.DrawCommandBuffer.clear","openfl/_internal/renderer/DrawCommandBuffer.hx",158,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(DrawCommandBuffer_obj,clear,(void))
 ...
 ::openfl::_internal::renderer::DrawCommandBuffer DrawCommandBuffer_obj::copy(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","copy",0xc3289d37,"openfl._internal.renderer.DrawCommandBuffer.copy","openfl/_internal/renderer/DrawCommandBuffer.hx",174,0xbc8e6e11)
            	HX_STACK_THIS(this)
HXLINE( 176)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandBuffer,copy) =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__new();
...
void DrawCommandBuffer_obj::cubicCurveTo(Float controlX1,Float controlY1,Float controlX2,Float controlY2,Float anchorX,Float anchorY){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","cubicCurveTo",0x96d43b62,"openfl._internal.renderer.DrawCommandBuffer.cubicCurveTo","openfl/_internal/renderer/DrawCommandBuffer.hx",183,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::curveTo(Float controlX,Float controlY,Float anchorX,Float anchorY){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","curveTo",0x1bf4dbc8,"openfl._internal.renderer.DrawCommandBuffer.curveTo","openfl/_internal/renderer/DrawCommandBuffer.hx",197,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::destroy(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","destroy",0x71f2a8b8,"openfl._internal.renderer.DrawCommandBuffer.destroy","openfl/_internal/renderer/DrawCommandBuffer.hx",210,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::drawCircle(Float x,Float y,Float radius){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","drawCircle",0x40b9dc36,"openfl._internal.renderer.DrawCommandBuffer.drawCircle","openfl/_internal/renderer/DrawCommandBuffer.hx",226,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void DrawCommandBuffer_obj::drawEllipse(Float x,Float y,Float width,Float height){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","drawEllipse",0x77b6b7f8,"openfl._internal.renderer.DrawCommandBuffer.drawEllipse","openfl/_internal/renderer/DrawCommandBuffer.hx",238,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void DrawCommandBuffer_obj::drawRect(Float x,Float y,Float width,Float height){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","drawRect",0xd190c1ca,"openfl._internal.renderer.DrawCommandBuffer.drawRect","openfl/_internal/renderer/DrawCommandBuffer.hx",251,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
...
void DrawCommandBuffer_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","drawRoundRect",0xb613a22c,"openfl._internal.renderer.DrawCommandBuffer.drawRoundRect","openfl/_internal/renderer/DrawCommandBuffer.hx",263,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
...
void DrawCommandBuffer_obj::drawTriangles( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::Dynamic culling){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","drawTriangles",0xb1d12245,"openfl._internal.renderer.DrawCommandBuffer.drawTriangles","openfl/_internal/renderer/DrawCommandBuffer.hx",278,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::endFill(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","endFill",0x734d03bc,"openfl._internal.renderer.DrawCommandBuffer.endFill","openfl/_internal/renderer/DrawCommandBuffer.hx",291,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::lineBitmapStyle( ::openfl::display::BitmapData bitmap, ::openfl::geom::Matrix matrix,Bool repeat,Bool smooth){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","lineBitmapStyle",0x6b2ca8ec,"openfl._internal.renderer.DrawCommandBuffer.lineBitmapStyle","openfl/_internal/renderer/DrawCommandBuffer.hx",300,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bitmap,"bitmap")
            	HX_STACK_ARG(matrix,"matrix")
            	HX_STACK_ARG(repeat,"repeat")
...
void DrawCommandBuffer_obj::lineGradientStyle( ::Dynamic type,::Array< Int > colors,::Array< Float > alphas,::Array< Int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","lineGradientStyle",0x10f9f9cb,"openfl._internal.renderer.DrawCommandBuffer.lineGradientStyle","openfl/_internal/renderer/DrawCommandBuffer.hx",313,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(colors,"colors")
            	HX_STACK_ARG(alphas,"alphas")
...
void DrawCommandBuffer_obj::lineStyle( ::Dynamic thickness,Int color,Float alpha,Bool pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,Float miterLimit){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","lineStyle",0xa96a0fdb,"openfl._internal.renderer.DrawCommandBuffer.lineStyle","openfl/_internal/renderer/DrawCommandBuffer.hx",330,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
void DrawCommandBuffer_obj::lineTo(Float x,Float y){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","lineTo",0x77e10c91,"openfl._internal.renderer.DrawCommandBuffer.lineTo","openfl/_internal/renderer/DrawCommandBuffer.hx",347,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void DrawCommandBuffer_obj::moveTo(Float x,Float y){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","moveTo",0x57ed98ee,"openfl._internal.renderer.DrawCommandBuffer.moveTo","openfl/_internal/renderer/DrawCommandBuffer.hx",358,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void DrawCommandBuffer_obj::prepareWrite(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","prepareWrite",0xac4d955a,"openfl._internal.renderer.DrawCommandBuffer.prepareWrite","openfl/_internal/renderer/DrawCommandBuffer.hx",371,0xbc8e6e11)
            	HX_STACK_THIS(this)
HXLINE( 371)		Bool _hx_tmp = this->copyOnWrite;
...
void DrawCommandBuffer_obj::overrideMatrix( ::openfl::geom::Matrix matrix){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","overrideMatrix",0xe20325af,"openfl._internal.renderer.DrawCommandBuffer.overrideMatrix","openfl/_internal/renderer/DrawCommandBuffer.hx",388,0xbc8e6e11)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(matrix,"matrix")
...
Int DrawCommandBuffer_obj::get_length(){
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","get_length",0x3877f3b1,"openfl._internal.renderer.DrawCommandBuffer.get_length","openfl/_internal/renderer/DrawCommandBuffer.hx",407,0xbc8e6e11)
            	HX_STACK_THIS(this)
...
{
{
            	HX_STACK_FRAME("openfl._internal.renderer.DrawCommandBuffer","boot",0xc27f65b4,"openfl._internal.renderer.DrawCommandBuffer.boot","openfl/_internal/renderer/DrawCommandBuffer.hx",28,0xbc8e6e11)
HXLINE(  28)		empty =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__new();
            	}
}
