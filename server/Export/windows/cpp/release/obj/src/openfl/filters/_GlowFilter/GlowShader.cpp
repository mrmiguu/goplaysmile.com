...
HX_DEFINE_STACK_FRAME(_hx_pos_3849ff18b8ccdd38_177_new,"openfl.filters._GlowFilter.GlowShader","new",0x65561d5f,"openfl.filters._GlowFilter.GlowShader.new","openfl/filters/GlowFilter.hx",177,0x5f568606)
HX_DEFINE_STACK_FRAME(_hx_pos_3849ff18b8ccdd38_189___update,"openfl.filters._GlowFilter.GlowShader","__update",0x776027ca,"openfl.filters._GlowFilter.GlowShader.__update","openfl/filters/GlowFilter.hx",189,0x5f568606)
namespace openfl{
namespace filters{
namespace _GlowFilter{

void GlowShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3849ff18b8ccdd38_177_new)
            	HX_STACK_THIS(this)
...
HXLINE( 179)		super::__construct(null());
HXLINE( 182)		 ::Dynamic(this->get_data()->__Field(HX_("uRadius",a7,8a,da,e6),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0),hx::paccDynamic);
HXLINE( 183)		 ::Dynamic(this->get_data()->__Field(HX_("uColor",ae,18,4b,a5),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(4)->init(0,(int)0)->init(1,(int)0)->init(2,(int)0)->init(3,(int)0),hx::paccDynamic);
            	}
...
void GlowShader_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_3849ff18b8ccdd38_189___update)
            	HX_STACK_THIS(this)
HXLINE( 191)		int _hx_tmp = this->get_data()->uImage0->input->width;
HXDLIN( 191)		 ::Dynamic(this->get_data()->__Field(HX_("uTextureSize",c7,50,82,f3),hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(2)->init(0,_hx_tmp)->init(1,this->get_data()->uImage0->input->height),hx::paccDynamic);
HXLINE( 193)		this->super::_hx___update();
            	}
