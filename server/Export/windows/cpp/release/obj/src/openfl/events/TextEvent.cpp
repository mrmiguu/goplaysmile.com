...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_35_toString,"openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",35,0x23b91588)
...
bool TextEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TextEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  24)		HX_VARI(  ::openfl::events::TextEvent,event) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text);
