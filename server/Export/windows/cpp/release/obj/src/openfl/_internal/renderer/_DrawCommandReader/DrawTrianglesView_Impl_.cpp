...
Dynamic DrawTrianglesView_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawTrianglesView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_","_new",0x7149dbeb,"openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",337,0xbbdbd1ae)
            	HX_STACK_ARG(d,"d")
HXLINE( 337)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawTrianglesView_Impl__obj,_new,return )
 ...
 ::openfl::_Vector::FloatVector DrawTrianglesView_Impl__obj::get_vertices( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_","get_vertices",0xf8b2d48c,"openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_.get_vertices","openfl/_internal/renderer/DrawCommandReader.hx",338,0xbbdbd1ae)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawTrianglesView_Impl__obj,get_vertices,return )
 ...
 ::openfl::_Vector::IntVector DrawTrianglesView_Impl__obj::get_indices( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_","get_indices",0x09da25f4,"openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_.get_indices","openfl/_internal/renderer/DrawCommandReader.hx",339,0xbbdbd1ae)
            	HX_STACK_ARG(this1,"this1")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawTrianglesView_Impl__obj,get_indices,return )
 ...
 ::openfl::_Vector::FloatVector DrawTrianglesView_Impl__obj::get_uvtData( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_","get_uvtData",0x4da9858a,"openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_.get_uvtData","openfl/_internal/renderer/DrawCommandReader.hx",340,0xbbdbd1ae)
            	HX_STACK_ARG(this1,"this1")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawTrianglesView_Impl__obj,get_uvtData,return )
 ...
 ::Dynamic DrawTrianglesView_Impl__obj::get_culling( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_","get_culling",0x7a0dc13d,"openfl._internal.renderer._DrawCommandReader.DrawTrianglesView_Impl_.get_culling","openfl/_internal/renderer/DrawCommandReader.hx",341,0xbbdbd1ae)
            	HX_STACK_ARG(this1,"this1")
