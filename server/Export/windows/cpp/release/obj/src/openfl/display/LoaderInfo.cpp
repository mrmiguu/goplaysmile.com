...
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_79___complete,"openfl.display.LoaderInfo","__complete",0x9858c05c,"openfl.display.LoaderInfo.__complete","openfl/display/LoaderInfo.hx",79,0x88528a51)
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_97___update,"openfl.display.LoaderInfo","__update",0x44ca06ec,"openfl.display.LoaderInfo.__update","openfl/display/LoaderInfo.hx",97,0x88528a51)
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_57_create,"openfl.display.LoaderInfo","create",0xe80075ff,"openfl.display.LoaderInfo.create","openfl/display/LoaderInfo.hx",57,0x88528a51)
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_19_boot,"openfl.display.LoaderInfo","boot",0xb25bbc75,"openfl.display.LoaderInfo.boot","openfl/display/LoaderInfo.hx",19,0x88528a51)
namespace openfl{
namespace display{
...
HXLINE(  59)		HX_VARI(  ::openfl::display::LoaderInfo,loaderInfo) =  ::openfl::display::LoaderInfo_obj::__alloc( HX_CTX );
