...
void CubeTexture_obj::__construct( ::openfl::display3D::Context3D context,Int size, ::Dynamic format,Bool optimizeForRenderToTexture,Int streamingLevels){
            	HX_STACK_FRAME("openfl.display3D.textures.CubeTexture","new",0x2100f37b,"openfl.display3D.textures.CubeTexture.new","openfl/display3D/textures/CubeTexture.hx",17,0xffe9b114)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< CubeTexture_obj > CubeTexture_obj::__new( ::openfl::display3D::Context3D context,Int size, ::Dynamic format,Bool optimizeForRenderToTexture,Int streamingLevels)
{
	...
	_hx_result->__construct(context,size,format,optimizeForRenderToTexture,streamingLevels);
	return _hx_result;
}
...
Bool async = __o_async.Default(false);
            	HX_STACK_FRAME("openfl.display3D.textures.CubeTexture","uploadCompressedTextureFromByteArray",0x47d49053,"openfl.display3D.textures.CubeTexture.uploadCompressedTextureFromByteArray","openfl/display3D/textures/CubeTexture.hx",31,0xffe9b114)
            	HX_STACK_THIS(this)
...
Bool generateMipmap = __o_generateMipmap.Default(false);
            	HX_STACK_FRAME("openfl.display3D.textures.CubeTexture","uploadFromBitmapData",0xf44b3429,"openfl.display3D.textures.CubeTexture.uploadFromBitmapData","openfl/display3D/textures/CubeTexture.hx",38,0xffe9b114)
            	HX_STACK_THIS(this)
...
HXLINE(  40)		{
HXLINE(  40)			Int target = this->_hx___textureTarget;
HXDLIN(  40)			::lime::graphics::opengl::GL_obj::context->bindTexture(target,this->_hx___textureID);
            		}
HXLINE(  42)		switch((int)(side)){
            			...
            			break;
            			default:{
HXLINE(  50)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(null()));
            			}
            		}
HXLINE(  56)		hx::OrEq(this->_hx___uploadedSides,((int)(int)1 << (int)side));
HXLINE(  59)		{
...
Int miplevel = __o_miplevel.Default(0);
            	HX_STACK_FRAME("openfl.display3D.textures.CubeTexture","uploadFromByteArray",0x1e356101,"openfl.display3D.textures.CubeTexture.uploadFromByteArray","openfl/display3D/textures/CubeTexture.hx",64,0xffe9b114)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
            	HX_STACK_ARG(side,"side")
