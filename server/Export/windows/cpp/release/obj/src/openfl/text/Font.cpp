...
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_20_new,"openfl.text.Font","new",0xe13d5ce4,"openfl.text.Font.new","openfl/text/Font.hx",20,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_98_get_fontName,"openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",98,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_105_set_fontName,"openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",105,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_27_enumerateFonts,"openfl.text.Font","enumerateFonts",0x792ac3fc,"openfl.text.Font.enumerateFonts","openfl/text/Font.hx",27,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_32_fromBytes,"openfl.text.Font","fromBytes",0x95ccba25,"openfl.text.Font.fromBytes","openfl/text/Font.hx",32,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_46_fromFile,"openfl.text.Font","fromFile",0x919e3202,"openfl.text.Font.fromFile","openfl/text/Font.hx",46,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_60_registerFont,"openfl.text.Font","registerFont",0xd99a60ce,"openfl.text.Font.registerFont","openfl/text/Font.hx",60,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_79___fromLimeFont,"openfl.text.Font","__fromLimeFont",0x57c4282a,"openfl.text.Font.__fromLimeFont","openfl/text/Font.hx",79,0x076bbaac)
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_15_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",15,0x076bbaac)
namespace openfl{
namespace text{

void Font_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_20_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  20)		super::__construct(name);
            	}
...
::String Font_obj::get_fontName(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_98_get_fontName)
            	HX_STACK_THIS(this)
HXLINE(  98)		return this->name;
            	}
...
::String Font_obj::set_fontName(::String value){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_105_set_fontName)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 105)		return (this->name = value);
            	}
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_27_enumerateFonts)
            	HX_STACK_ARG(enumerateDeviceFonts,"enumerateDeviceFonts")
HXLINE(  27)		return ::openfl::text::Font_obj::_hx___registeredFonts;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::text::Font Font_obj::fromBytes( ::openfl::utils::ByteArrayData bytes){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_32_fromBytes)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  34)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE(  35)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
HXLINE(  38)		if (hx::IsNotNull( font->src )) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::text::Font Font_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_46_fromFile)
            	HX_STACK_ARG(path,"path")
HXLINE(  48)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE(  49)		font->_hx___fromFile(path);
HXLINE(  52)		if (hx::IsNotNull( font->src )) {
HXLINE(  52)			return font;
            		}
            		else {
...
void Font_obj::registerFont(hx::Class font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_60_registerFont)
            	HX_STACK_ARG(font,"font")
HXLINE(  62)		HX_VARI(  ::openfl::text::Font,instance) = hx::TCast<  ::openfl::text::Font >::cast(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0)));
HXLINE(  64)		if (hx::IsNotNull( instance )) {
HXLINE(  72)			::openfl::text::Font_obj::_hx___registeredFonts->push(instance);
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,registerFont,(void))
 ...
 ::openfl::text::Font Font_obj::_hx___fromLimeFont( ::lime::text::Font value){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_79___fromLimeFont)
            	HX_STACK_ARG(value,"value")
HXLINE(  81)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE(  82)		font->name = value->name;
HXLINE(  83)		font->src = value->src;
HXLINE(  84)		return font;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_15_boot)
HXLINE(  15)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
}
