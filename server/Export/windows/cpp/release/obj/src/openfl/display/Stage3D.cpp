...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_46_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",46,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_58_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",58,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_73_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",73,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_80___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",80,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_144___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",144,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_154___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",154,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_164___renderCairo,"openfl.display.Stage3D","__renderCairo",0x4faad7c9,"openfl.display.Stage3D.__renderCairo","openfl/display/Stage3D.hx",164,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_178___renderCanvas,"openfl.display.Stage3D","__renderCanvas",0x69230677,"openfl.display.Stage3D.__renderCanvas","openfl/display/Stage3D.hx",178,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_192___renderDOM,"openfl.display.Stage3D","__renderDOM",0x9069cb83,"openfl.display.Stage3D.__renderDOM","openfl/display/Stage3D.hx",192,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_216___renderGL,"openfl.display.Stage3D","__renderGL",0x25621024,"openfl.display.Stage3D.__renderGL","openfl/display/Stage3D.hx",216,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_236___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",236,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_250___resetContext3DStates,"openfl.display.Stage3D","__resetContext3DStates",0x6c934f5c,"openfl.display.Stage3D.__resetContext3DStates","openfl/display/Stage3D.hx",250,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_260_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",260,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_275_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",275,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_46_new)
            	HX_STACK_THIS(this)
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_58_requestContext3D)
            	HX_STACK_THIS(this)
...
HXLINE(  62)		if (hx::IsNotNull( this->context3D )) {
HXLINE(  64)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_73_requestContext3DMatchingProfiles)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(profiles,"profiles")
HXLINE(  73)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_80___createContext)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE(  80)		if (hx::IsNotNull( renderSession->gl )) {
HXLINE(  82)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),renderSession);
HXLINE(  83)			this->_hx___dispatchCreate();
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_144___dispatchError)
            	HX_STACK_THIS(this)
HXLINE( 146)		this->_hx___contextRequested = false;
HXLINE( 147)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_154___dispatchCreate)
            	HX_STACK_THIS(this)
HXLINE( 154)		if (this->_hx___contextRequested) {
HXLINE( 156)			this->_hx___contextRequested = false;
HXLINE( 157)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___renderCairo( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_164___renderCairo)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 166)		if (!(this->visible)) {
HXLINE( 166)			return;
            		}
HXLINE( 168)		if (this->_hx___contextRequested) {
HXLINE( 170)			this->_hx___dispatchError();
HXLINE( 171)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_178___renderCanvas)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 180)		if (!(this->visible)) {
HXLINE( 180)			return;
            		}
HXLINE( 182)		if (this->_hx___contextRequested) {
HXLINE( 184)			this->_hx___dispatchError();
...
void Stage3D_obj::_hx___renderDOM( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_192___renderDOM)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 194)		if (!(this->visible)) {
HXLINE( 194)			return;
            		}
HXLINE( 196)		bool _hx_tmp;
HXDLIN( 196)		if (this->_hx___contextRequested) {
HXLINE( 196)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 196)			_hx_tmp = false;
            		}
HXDLIN( 196)		if (_hx_tmp) {
HXLINE( 198)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 202)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 208)			this->_hx___resetContext3DStates();
            		}
            	}
...
void Stage3D_obj::_hx___renderGL( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_216___renderGL)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(stage,"stage")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 218)		if (!(this->visible)) {
HXLINE( 218)			return;
            		}
HXLINE( 220)		bool _hx_tmp;
HXDLIN( 220)		if (this->_hx___contextRequested) {
HXLINE( 220)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 220)			_hx_tmp = false;
            		}
HXDLIN( 220)		if (_hx_tmp) {
HXLINE( 222)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 226)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 228)			this->_hx___resetContext3DStates();
HXLINE( 229)			if (hx::IsNotNull( this->context3D )) {
HXLINE( 229)				renderSession->gl->depthMask(true);
HXDLIN( 229)				renderSession->blendModeManager->setBlendMode(null());
HXDLIN( 229)				if (hx::IsNotNull( renderSession->shaderManager->currentShader )) {
HXLINE( 229)					renderSession->shaderManager->setShader(null());
HXDLIN( 229)					if (hx::IsNotNull( this->context3D->_hx___program )) {
HXLINE( 229)						this->context3D->_hx___program->_hx___use();
            					}
            				}
            			}
            		}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_236___resize)
            	HX_STACK_THIS(this)
...
void Stage3D_obj::_hx___resetContext3DStates(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_250___resetContext3DStates)
            	HX_STACK_THIS(this)
HXLINE( 253)		this->context3D->_hx___updateBlendFactors();
HXLINE( 255)		this->context3D->_hx___updateBackbufferViewport();
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_260_set_x)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 262)		this->x = value;
HXLINE( 264)		if (hx::IsNotNull( this->context3D )) {
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_275_set_y)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 277)		this->y = value;
