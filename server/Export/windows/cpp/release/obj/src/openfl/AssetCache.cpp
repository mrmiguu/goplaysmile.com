...
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_894_new,"openfl.AssetCache","new",0x4c82a362,"openfl.AssetCache.new","openfl/Assets.hx",894,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_917_clear,"openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",917,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_968_getBitmapData,"openfl.AssetCache","getBitmapData",0x76047b71,"openfl.AssetCache.getBitmapData","openfl/Assets.hx",968,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_975_getFont,"openfl.AssetCache","getFont",0xc4a48987,"openfl.AssetCache.getFont","openfl/Assets.hx",975,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_982_getSound,"openfl.AssetCache","getSound",0xc78ea217,"openfl.AssetCache.getSound","openfl/Assets.hx",982,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_989_hasBitmapData,"openfl.AssetCache","hasBitmapData",0x33e8d735,"openfl.AssetCache.hasBitmapData","openfl/Assets.hx",989,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_996_hasFont,"openfl.AssetCache","hasFont",0xc165fa4b,"openfl.AssetCache.hasFont","openfl/Assets.hx",996,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1003_hasSound,"openfl.AssetCache","hasSound",0xf40fdcd3,"openfl.AssetCache.hasSound","openfl/Assets.hx",1003,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1008_removeBitmapData,"openfl.AssetCache","removeBitmapData",0x7d8dc6db,"openfl.AssetCache.removeBitmapData","openfl/Assets.hx",1008,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1016_removeFont,"openfl.AssetCache","removeFont",0x7ce60971,"openfl.AssetCache.removeFont","openfl/Assets.hx",1016,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1024_removeSound,"openfl.AssetCache","removeSound",0x489d0eed,"openfl.AssetCache.removeSound","openfl/Assets.hx",1024,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1034_setBitmapData,"openfl.AssetCache","setBitmapData",0xbb0a5d7d,"openfl.AssetCache.setBitmapData","openfl/Assets.hx",1034,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1041_setFont,"openfl.AssetCache","setFont",0xb7a61a93,"openfl.AssetCache.setFont","openfl/Assets.hx",1041,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1048_setSound,"openfl.AssetCache","setSound",0x75ebfb8b,"openfl.AssetCache.setSound","openfl/Assets.hx",1048,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1062_get_enabled,"openfl.AssetCache","get_enabled",0xcdc8099a,"openfl.AssetCache.get_enabled","openfl/Assets.hx",1062,0x989d477c)
HX_DEFINE_STACK_FRAME(_hx_pos_6fc5e93027d994ca_1069_set_enabled,"openfl.AssetCache","set_enabled",0xd83510a6,"openfl.AssetCache.set_enabled","openfl/Assets.hx",1069,0x989d477c)
namespace openfl{

void AssetCache_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_6fc5e93027d994ca_894_new)
            	HX_STACK_THIS(this)
HXLINE( 903)		this->_hx___enabled = true;
HXLINE( 908)		this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 909)		this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 910)		this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_GC_STACKFRAME(&_hx_pos_6fc5e93027d994ca_917_clear)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE( 917)		if (hx::IsNull( prefix )) {
HXLINE( 919)			this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 920)			this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 921)			this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
            		else {
HXLINE( 925)			HX_VARI(  ::Dynamic,keys) = this->bitmapData->keys();
HXLINE( 927)			while(( (bool)(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 927)				HX_VARI( ::String,key) = ( (::String)(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 929)				if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE( 931)					this->removeBitmapData(key);
            				}
            			}
HXLINE( 937)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE( 939)			while(( (bool)(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 939)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 941)				if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 943)					this->removeFont(key1);
            				}
            			}
HXLINE( 949)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->sound->keys();
HXLINE( 951)			while(( (bool)(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 951)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 953)				if (::StringTools_obj::startsWith(key2,prefix)) {
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,clear,(void))
 ...
 ::openfl::display::BitmapData AssetCache_obj::getBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_968_getBitmapData)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getBitmapData,return )
 ...
 ::openfl::text::Font AssetCache_obj::getFont(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_975_getFont)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getFont,return )
 ...
 ::openfl::media::Sound AssetCache_obj::getSound(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_982_getSound)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::hasBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_989_hasBitmapData)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::hasFont(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_996_hasFont)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::hasSound(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1003_hasSound)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::removeBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1008_removeBitmapData)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::removeFont(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1016_removeFont)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::removeSound(::String id){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1024_removeSound)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setBitmapData(::String id, ::openfl::display::BitmapData bitmapData){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1034_setBitmapData)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setFont(::String id, ::openfl::text::Font font){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1041_setFont)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setSound(::String id, ::openfl::media::Sound sound){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1048_setSound)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
bool AssetCache_obj::get_enabled(){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1062_get_enabled)
            	HX_STACK_THIS(this)
...
bool AssetCache_obj::set_enabled(bool value){
            	HX_STACKFRAME(&_hx_pos_6fc5e93027d994ca_1069_set_enabled)
            	HX_STACK_THIS(this)
