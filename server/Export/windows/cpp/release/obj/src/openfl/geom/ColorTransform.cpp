...
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_43_concat,"openfl.geom.ColorTransform","concat",0x6a83fc25,"openfl.geom.ColorTransform.concat","openfl/geom/ColorTransform.hx",43,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_60_toString,"openfl.geom.ColorTransform","toString",0xe65269fd,"openfl.geom.ColorTransform.toString","openfl/geom/ColorTransform.hx",60,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_67___clone,"openfl.geom.ColorTransform","__clone",0x6d82280c,"openfl.geom.ColorTransform.__clone","openfl/geom/ColorTransform.hx",67,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_72___combine,"openfl.geom.ColorTransform","__combine",0x74bf08ee,"openfl.geom.ColorTransform.__combine","openfl/geom/ColorTransform.hx",72,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_89___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",89,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_96___isDefault,"openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",96,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_110_get_color,"openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",110,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_115_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",115,0x850de941)
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_130___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",130,0x850de941)
namespace openfl{
namespace geom{
...
void ColorTransform_obj::_hx___combine( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_72___combine)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ct,"ct")
HXLINE(  74)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  74)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * ct->redMultiplier);
HXLINE(  75)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  75)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * ct->greenMultiplier);
HXLINE(  76)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  76)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * ct->blueMultiplier);
HXLINE(  77)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  77)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * ct->alphaMultiplier);
HXLINE(  79)		 ::openfl::geom::ColorTransform _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  79)		_hx_tmp4->redOffset = (_hx_tmp4->redOffset + ct->redOffset);
HXLINE(  80)		 ::openfl::geom::ColorTransform _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  80)		_hx_tmp5->greenOffset = (_hx_tmp5->greenOffset + ct->greenOffset);
HXLINE(  81)		 ::openfl::geom::ColorTransform _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  81)		_hx_tmp6->blueOffset = (_hx_tmp6->blueOffset + ct->blueOffset);
HXLINE(  82)		 ::openfl::geom::ColorTransform _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  82)		_hx_tmp7->alphaOffset = (_hx_tmp7->alphaOffset + ct->alphaOffset);
            	}
...
bool ColorTransform_obj::_hx___equals( ::openfl::geom::ColorTransform ct, ::Dynamic __o_skipAlphaMultiplier){
 ::Dynamic skipAlphaMultiplier = __o_skipAlphaMultiplier.Default(false);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_89___equals)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ct,"ct")
...
bool ColorTransform_obj::_hx___isDefault(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_96___isDefault)
            	HX_STACK_THIS(this)
...
int ColorTransform_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_110_get_color)
            	HX_STACK_THIS(this)
HXLINE( 110)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
HXDLIN( 110)		int _hx_tmp1 = ((int)_hx_tmp | (int)((int)::Std_obj::_hx_int(this->greenOffset) << (int)(int)8));
HXDLIN( 110)		return ((int)_hx_tmp1 | (int)::Std_obj::_hx_int(this->blueOffset));
            	}
...
int ColorTransform_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_115_set_color)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,set_color,return )
 ...
 ::lime::utils::ArrayBufferView ColorTransform_obj::_hx___toLimeColorMatrix(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_130___toLimeColorMatrix)
            	HX_STACK_THIS(this)
HXLINE( 132)		if (hx::IsNull( ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix )) {
HXLINE( 134)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
            		}
HXLINE( 138)		{
HXLINE( 138)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this1,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 138)			::__hxcpp_memory_set_float(this1->buffer->b,this1->byteOffset,this->redMultiplier);
            		}
HXLINE( 139)		{
HXLINE( 139)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this2,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 139)			::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + (int)16),((Float)this->redOffset / (Float)(int)255));
            		}
HXLINE( 140)		{
HXLINE( 140)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this3,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 140)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)24),this->greenMultiplier);
            		}
HXLINE( 141)		{
HXLINE( 141)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this4,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 141)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)36),((Float)this->greenOffset / (Float)(int)255));
            		}
HXLINE( 142)		{
HXLINE( 142)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this5,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 142)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)48),this->blueMultiplier);
            		}
HXLINE( 143)		{
HXLINE( 143)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this6,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 143)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)56),((Float)this->blueOffset / (Float)(int)255));
            		}
HXLINE( 144)		{
HXLINE( 144)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this7,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 144)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)72),this->alphaMultiplier);
            		}
HXLINE( 145)		{
HXLINE( 145)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,this8,"this") = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 145)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)76),((Float)this->alphaOffset / (Float)(int)255));
            		}
