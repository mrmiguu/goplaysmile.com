...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_72___combine,"openfl.geom.ColorTransform","__combine",0x74bf08ee,"openfl.geom.ColorTransform.__combine","openfl/geom/ColorTransform.hx",72,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_89___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",89,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_96___isDefault,"openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",96,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_110_get_color,"openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",110,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_115_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",115,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_130___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",130,0x850de941)
namespace openfl{
namespace geom{
...
HXLINE( 134)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
HXDLIN( 134)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix = this1;
            		}
HXLINE( 138)		{
HXLINE( 138)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 138)			Float val = this->redMultiplier;
HXDLIN( 138)			::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 139)		{
HXLINE( 139)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 139)			Float val1 = ((Float)this->redOffset / (Float)(int)255);
HXDLIN( 139)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)16),val1);
            		}
HXLINE( 140)		{
HXLINE( 140)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 140)			Float val2 = this->greenMultiplier;
HXDLIN( 140)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)24),val2);
            		}
HXLINE( 141)		{
HXLINE( 141)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 141)			Float val3 = ((Float)this->greenOffset / (Float)(int)255);
HXDLIN( 141)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)36),val3);
            		}
HXLINE( 142)		{
HXLINE( 142)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 142)			Float val4 = this->blueMultiplier;
HXDLIN( 142)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)48),val4);
            		}
HXLINE( 143)		{
HXLINE( 143)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 143)			Float val5 = ((Float)this->blueOffset / (Float)(int)255);
HXDLIN( 143)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)56),val5);
            		}
HXLINE( 144)		{
HXLINE( 144)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 144)			Float val6 = this->alphaMultiplier;
HXDLIN( 144)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)72),val6);
            		}
HXLINE( 145)		{
HXLINE( 145)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 145)			Float val7 = ((Float)this->alphaOffset / (Float)(int)255);
HXDLIN( 145)			::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)76),val7);
            		}
