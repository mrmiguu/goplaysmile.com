...
HXLINE(  31)			 ::openfl::_internal::renderer::AbstractBlendModeManager renderSession1 = renderSession->blendModeManager;
HXDLIN(  31)			renderSession1->setBlendMode(bitmap->get_blendMode());
