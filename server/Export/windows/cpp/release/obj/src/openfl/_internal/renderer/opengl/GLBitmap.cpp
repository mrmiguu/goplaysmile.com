...
void GLBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLBitmap","render",0x8d0c282c,"openfl._internal.renderer.opengl.GLBitmap.render","openfl/_internal/renderer/opengl/GLBitmap.hx",22,0x02850ac4)
...
HXDLIN(  26)		Bool _hx_tmp2 = hx::IsNotNull( bitmap->bitmapData );
...
HXLINE(  28)			HX_VARI(  ::openfl::_internal::renderer::opengl::GLRenderer,renderer) = ( ( ::openfl::_internal::renderer::opengl::GLRenderer)(renderSession->renderer) );
HXLINE(  29)			HX_VARI(  ::lime::_backend::native::NativeGLRenderContext,gl) = renderSession->gl;
HXLINE(  31)			 ::Dynamic _hx_tmp3 = bitmap->get_blendMode();
HXDLIN(  31)			renderSession->blendModeManager->setBlendMode(_hx_tmp3);
HXLINE(  32)			renderSession->maskManager->pushObject(bitmap,null());
HXLINE(  34)			HX_VARI(  ::openfl::display::Shader,shader) = renderSession->filterManager->pushObject(bitmap);
...
HXLINE(  37)					_hx_tmp4 = renderSession->upscaled;
            				}
            				else {
...
HXDLIN(  37)			shader->get_data()->uImage0->smoothing = _hx_tmp4;
...
HXLINE(  42)			Int _hx_tmp5 = gl->ARRAY_BUFFER;
HXDLIN(  42)			 ::lime::graphics::opengl::GLBuffer _hx_tmp6 = bitmap->bitmapData->getBuffer(gl,bitmap->_hx___worldAlpha);
HXDLIN(  42)			gl->bindBuffer(_hx_tmp5,_hx_tmp6);
HXLINE(  43)			gl->vertexAttribPointer(shader->get_data()->aPosition->index,(int)3,gl->FLOAT,false,(int)24,(int)0);
HXLINE(  44)			gl->vertexAttribPointer(shader->get_data()->aTexCoord->index,(int)2,gl->FLOAT,false,(int)24,(int)12);
HXLINE(  45)			gl->vertexAttribPointer(shader->get_data()->aAlpha->index,(int)1,gl->FLOAT,false,(int)24,(int)20);
