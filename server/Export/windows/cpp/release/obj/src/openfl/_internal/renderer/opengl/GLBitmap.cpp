...
HX_DEFINE_STACK_FRAME(_hx_pos_9c60723403252d5b_22_render,"openfl._internal.renderer.opengl.GLBitmap","render",0x8d0c282c,"openfl._internal.renderer.opengl.GLBitmap.render","openfl/_internal/renderer/opengl/GLBitmap.hx",22,0x02850ac4)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
HXLINE(  31)			renderSession->blendModeManager->setBlendMode(bitmap->get_blendMode());
...
HXLINE(  42)			HX_VARI_NAME( int,gl1,"gl") = gl->ARRAY_BUFFER;
