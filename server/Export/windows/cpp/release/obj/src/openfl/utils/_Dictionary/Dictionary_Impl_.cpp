...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Dictionary_Impl__obj,toObjectMap,return )
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap Dictionary_Impl__obj::toUtilsObjectMap(::Dynamic t,Bool weakKeys){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","toUtilsObjectMap",0x34d1c76b,"openfl.utils._Dictionary.Dictionary_Impl_.toUtilsObjectMap","openfl/utils/Dictionary.hx",87,0x5979b1eb)
            	HX_STACK_ARG(t,"t")
            	HX_STACK_ARG(weakKeys,"weakKeys")
HXLINE(  87)		return  ::openfl::utils::_Dictionary::UtilsObjectMap_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Dictionary_Impl__obj,toUtilsObjectMap,return )
 ...
 ::openfl::utils::_Dictionary::ClassMap Dictionary_Impl__obj::toClassMap(::Dynamic t,Bool weakKeys){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","toClassMap",0x46f4aec3,"openfl.utils._Dictionary.Dictionary_Impl_.toClassMap","openfl/utils/Dictionary.hx",94,0x5979b1eb)
            	HX_STACK_ARG(t,"t")
            	HX_STACK_ARG(weakKeys,"weakKeys")
HXLINE(  94)		return  ::openfl::utils::_Dictionary::ClassMap_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Dictionary_Impl__obj,toClassMap,return )
 ...
 ::haxe::ds::StringMap Dictionary_Impl__obj::fromStringMap( ::haxe::ds::StringMap map){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","fromStringMap",0x17b1b91d,"openfl.utils._Dictionary.Dictionary_Impl_.fromStringMap","openfl/utils/Dictionary.hx",101,0x5979b1eb)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Dictionary_Impl__obj,fromStringMap,return )
 ...
 ::haxe::ds::IntMap Dictionary_Impl__obj::fromIntMap( ::haxe::ds::IntMap map){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","fromIntMap",0xc10f16db,"openfl.utils._Dictionary.Dictionary_Impl_.fromIntMap","openfl/utils/Dictionary.hx",108,0x5979b1eb)
            	HX_STACK_ARG(map,"map")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Dictionary_Impl__obj,fromIntMap,return )
 ...
 ::haxe::ds::ObjectMap Dictionary_Impl__obj::fromObjectMap( ::haxe::ds::ObjectMap map){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","fromObjectMap",0x93764bef,"openfl.utils._Dictionary.Dictionary_Impl_.fromObjectMap","openfl/utils/Dictionary.hx",115,0x5979b1eb)
            	HX_STACK_ARG(map,"map")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Dictionary_Impl__obj,fromObjectMap,return )
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap Dictionary_Impl__obj::fromUtilsObjectMap( ::openfl::utils::_Dictionary::UtilsObjectMap map){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","fromUtilsObjectMap",0xc6e12c9a,"openfl.utils._Dictionary.Dictionary_Impl_.fromUtilsObjectMap","openfl/utils/Dictionary.hx",122,0x5979b1eb)
            	HX_STACK_ARG(map,"map")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Dictionary_Impl__obj,fromUtilsObjectMap,return )
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap Dictionary_Impl__obj::fromClassMap( ::openfl::utils::_Dictionary::ClassMap map){
            	HX_STACK_FRAME("openfl.utils._Dictionary.Dictionary_Impl_","fromClassMap",0x1e0af6b2,"openfl.utils._Dictionary.Dictionary_Impl_.fromClassMap","openfl/utils/Dictionary.hx",129,0x5979b1eb)
            	HX_STACK_ARG(map,"map")
