...
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_26_clone,"openfl.events.HTTPStatusEvent","clone",0xe75f33d8,"openfl.events.HTTPStatusEvent.clone","openfl/events/HTTPStatusEvent.hx",26,0x9d0269d5)
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_39_toString,"openfl.events.HTTPStatusEvent","toString",0x9713ef11,"openfl.events.HTTPStatusEvent.toString","openfl/events/HTTPStatusEvent.hx",39,0x9d0269d5)
...
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_7_boot,"openfl.events.HTTPStatusEvent","boot",0x668e4c17,"openfl.events.HTTPStatusEvent.boot","openfl/events/HTTPStatusEvent.hx",7,0x9d0269d5)
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_8_boot,"openfl.events.HTTPStatusEvent","boot",0x668e4c17,"openfl.events.HTTPStatusEvent.boot","openfl/events/HTTPStatusEvent.hx",8,0x9d0269d5)
namespace openfl{
namespace events{
...
bool HTTPStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event HTTPStatusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  28)		HX_VARI(  ::openfl::events::HTTPStatusEvent,event) =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,null(),this->status,this->redirected);
...
::String HTTPStatusEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  39)		return this->_hx___formatToString(HX_("HTTPStatusEvent",e0,4c,1b,fe),::Array_obj< ::String >::fromData( _hx_array_data_61c0a2a9_3,5));
            	}
