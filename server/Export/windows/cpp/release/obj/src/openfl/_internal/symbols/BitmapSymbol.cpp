...
void BitmapSymbol_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.symbols.BitmapSymbol","new",0x8818031c,"openfl._internal.symbols.BitmapSymbol.new","openfl/_internal/symbols/BitmapSymbol.hx",23,0x5876b9f1)
            	HX_STACK_THIS(this)
...
Dynamic BitmapSymbol_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::display::DisplayObject BitmapSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACK_FRAME("openfl._internal.symbols.BitmapSymbol","__createObject",0xcb0ed0bf,"openfl._internal.symbols.BitmapSymbol.__createObject","openfl/_internal/symbols/BitmapSymbol.hx",30,0x5876b9f1)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  30)		 ::lime::graphics::Image _hx_tmp = swf->library->getImage(this->path);
HXDLIN(  30)		 ::openfl::display::BitmapData _hx_tmp1 = ::openfl::display::BitmapData_obj::fromImage(_hx_tmp,null());
HXDLIN(  30)		return  ::openfl::display::Bitmap_obj::__new(_hx_tmp1,(int)1,true);
            	}
