...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebf8e17a3abb08a_23_new,"openfl._internal.symbols.BitmapSymbol","new",0x8818031c,"openfl._internal.symbols.BitmapSymbol.new","openfl/_internal/symbols/BitmapSymbol.hx",23,0x5876b9f1)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebf8e17a3abb08a_30___createObject,"openfl._internal.symbols.BitmapSymbol","__createObject",0xcb0ed0bf,"openfl._internal.symbols.BitmapSymbol.__createObject","openfl/_internal/symbols/BitmapSymbol.hx",30,0x5876b9f1)
namespace openfl{
namespace _internal{
namespace symbols{

void BitmapSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6ebf8e17a3abb08a_23_new)
            	HX_STACK_THIS(this)
...
bool BitmapSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject BitmapSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_6ebf8e17a3abb08a_30___createObject)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  30)		return  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,::openfl::display::BitmapData_obj::fromImage(swf->library->getImage(this->path),null()),(int)1,true);
            	}
