...
HX_DEFINE_STACK_FRAME(_hx_pos_cb29cd710c44e9d0_21_new,"openfl._internal.symbols.FontSymbol","new",0x0fdcd23c,"openfl._internal.symbols.FontSymbol.new","openfl/_internal/symbols/FontSymbol.hx",21,0xbcdb7d91)
namespace openfl{
namespace _internal{
namespace symbols{

void FontSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_cb29cd710c44e9d0_21_new)
            	HX_STACK_THIS(this)
