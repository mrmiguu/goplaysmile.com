...
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_37_toString,"openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",37,0xea3bf808)
...
bool ProgressEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ProgressEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->bytesLoaded,this->bytesTotal);
