...
HX_DEFINE_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_997_new,"openfl._internal.stage3D._AGALConverter.SourceRegister","new",0xf72124df,"openfl._internal.stage3D._AGALConverter.SourceRegister.new","openfl/_internal/stage3D/AGALConverter.hx",997,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1021_toGLSL,"openfl._internal.stage3D._AGALConverter.SourceRegister","toGLSL",0xdb399dda,"openfl._internal.stage3D._AGALConverter.SourceRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",1021,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1004_parse,"openfl._internal.stage3D._AGALConverter.SourceRegister","parse",0x01804272,"openfl._internal.stage3D._AGALConverter.SourceRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",1004,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_997_new)
            	}
...
int offset = __o_offset.Default(0);
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1021_toGLSL)
HXLINE(1023)		if ((this->type == (int)3)) {
HXLINE(1025)			if (hx::IsEq( this->programType,::openfl::_internal::stage3D::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE(1025)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE(1025)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE(1029)		bool fullxyzw;
HXDLIN(1029)		if ((this->s == (int)228)) {
HXLINE(1029)			fullxyzw = (this->sourceMask == (int)15);
            		}
            		else {
HXLINE(1029)			fullxyzw = false;
            		}
HXLINE(1030)		::String swizzle = HX_("",00,00,00,00);
HXLINE(1032)		bool _hx_tmp;
HXDLIN(1032)		if ((this->type != (int)5)) {
HXLINE(1032)			_hx_tmp = !(fullxyzw);
            		}
            		else {
HXLINE(1032)			_hx_tmp = false;
            		}
HXDLIN(1032)		if (_hx_tmp) {
HXLINE(1034)			int _g = (int)0;
HXDLIN(1034)			while((_g < (int)4)){
HXLINE(1034)				_g = (_g + (int)1);
HXDLIN(1034)				int i = (_g - (int)1);
HXLINE(1037)				int _hx_tmp1 = this->sourceMask;
HXDLIN(1037)				if ((((int)_hx_tmp1 & (int)((int)(int)1 << (int)i)) != (int)0)) {
HXLINE(1039)					int _g1 = this->s;
HXDLIN(1039)					int _g11 = ((int)((int)_g1 >> (int)(i * (int)2)) & (int)(int)3);
HXDLIN(1039)					switch((int)(_g11)){
            						case (int)0: {
HXLINE(1041)							swizzle = (swizzle + HX_("x",78,00,00,00));
            						}
            						break;
            						case (int)1: {
HXLINE(1042)							swizzle = (swizzle + HX_("y",79,00,00,00));
            						}
            						break;
            						case (int)2: {
HXLINE(1043)							swizzle = (swizzle + HX_("z",7a,00,00,00));
            						}
            						break;
            						case (int)3: {
HXLINE(1044)							swizzle = (swizzle + HX_("w",77,00,00,00));
            						}
            						break;
            					}
            				}
...
HXLINE(1054)		::String str = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1056)		if ((this->d == (int)0)) {
HXLINE(1059)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1064)			str = (str + this->o);
HXLINE(1065)			 ::Dynamic indexComponent = HX_("x",78,00,00,00).charCodeAt((int)0);
HXDLIN(1065)			::String indexComponent1 = ::String::fromCharCode((indexComponent + this->q));
HXLINE(1066)			::String indexRegister = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1066)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent1);
HXLINE(1067)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1071)		bool _hx_tmp2;
HXDLIN(1071)		if (emitSwizzle) {
HXLINE(1071)			_hx_tmp2 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1071)			_hx_tmp2 = false;
            		}
HXDLIN(1071)		if (_hx_tmp2) {
HXLINE(1073)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1077)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SourceRegister SourceRegister_obj::parse( ::cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1004_parse)
HXLINE(1006)		 ::openfl::_internal::stage3D::_AGALConverter::SourceRegister sr =  ::openfl::_internal::stage3D::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE(1007)		sr->programType = programType;
HXLINE(1008)		 ::cpp::Int64Struct a = _hx_int64_shr(v,(int)63);
HXDLIN(1008)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)1))));
HXLINE(1009)		 ::cpp::Int64Struct a1 = _hx_int64_shr(v,(int)48);
HXDLIN(1009)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)3))));
HXLINE(1010)		 ::cpp::Int64Struct a2 = _hx_int64_shr(v,(int)40);
HXDLIN(1010)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE(1011)		 ::cpp::Int64Struct a3 = _hx_int64_shr(v,(int)32);
HXDLIN(1011)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE(1012)		 ::cpp::Int64Struct a4 = _hx_int64_shr(v,(int)24);
HXDLIN(1012)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)255))));
HXLINE(1013)		 ::cpp::Int64Struct a5 = _hx_int64_shr(v,(int)16);
HXDLIN(1013)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)255))));
HXLINE(1014)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE(1015)		sr->sourceMask = sourceMask;
HXLINE(1016)		return sr;
            	}
