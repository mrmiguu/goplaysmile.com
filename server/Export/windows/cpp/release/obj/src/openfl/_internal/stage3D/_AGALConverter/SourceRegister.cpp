...
HX_DEFINE_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_995_new,"openfl._internal.stage3D._AGALConverter.SourceRegister","new",0xf72124df,"openfl._internal.stage3D._AGALConverter.SourceRegister.new","openfl/_internal/stage3D/AGALConverter.hx",995,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1019_toGLSL,"openfl._internal.stage3D._AGALConverter.SourceRegister","toGLSL",0xdb399dda,"openfl._internal.stage3D._AGALConverter.SourceRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",1019,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_59ffe2ae4599a6c5_1002_parse,"openfl._internal.stage3D._AGALConverter.SourceRegister","parse",0x01804272,"openfl._internal.stage3D._AGALConverter.SourceRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",1002,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_995_new)
            	HX_STACK_THIS(this)
            	}
...
int offset = __o_offset.Default(0);
            	HX_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1019_toGLSL)
            	HX_STACK_THIS(this)
...
HXLINE(1032)				_g = (_g + (int)1);
HXDLIN(1032)				HX_VARI( int,i) = (_g - (int)1);
HXLINE(1035)				if ((((int)this->sourceMask & (int)((int)(int)1 << (int)i)) != (int)0)) {
HXLINE(1037)					switch((int)(((int)((int)this->s >> (int)(i * (int)2)) & (int)(int)3))){
            						case (int)0: {
HXLINE(1039)							swizzle = (swizzle + HX_("x",78,00,00,00));
            						}
            						break;
            						case (int)1: {
HXLINE(1040)							swizzle = (swizzle + HX_("y",79,00,00,00));
            						}
            						break;
            						case (int)2: {
HXLINE(1041)							swizzle = (swizzle + HX_("z",7a,00,00,00));
            						}
            						break;
            						case (int)3: {
HXLINE(1042)							swizzle = (swizzle + HX_("w",77,00,00,00));
            						}
            						break;
            					}
            				}
...
HXLINE(1054)		if ((this->d == (int)0)) {
HXLINE(1057)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1062)			str = (str + this->o);
HXLINE(1063)			 ::Dynamic indexComponent = HX_("x",78,00,00,00).charCodeAt((int)0);
HXDLIN(1063)			HX_VARI_NAME( ::String,indexComponent1,"indexComponent") = ::String::fromCharCode((indexComponent + this->q));
HXLINE(1064)			::String indexRegister = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXLINE(1065)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent1)) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1069)		bool _hx_tmp1;
HXDLIN(1069)		if (emitSwizzle) {
HXLINE(1069)			_hx_tmp1 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1069)			_hx_tmp1 = false;
            		}
HXDLIN(1069)		if (_hx_tmp1) {
HXLINE(1071)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SourceRegister SourceRegister_obj::parse( ::cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_59ffe2ae4599a6c5_1002_parse)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(programType,"programType")
            	HX_STACK_ARG(sourceMask,"sourceMask")
HXLINE(1004)		HX_VARI(  ::openfl::_internal::stage3D::_AGALConverter::SourceRegister,sr) =  ::openfl::_internal::stage3D::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE(1005)		sr->programType = programType;
HXLINE(1006)		 ::cpp::Int64Struct a = _hx_int64_shr(v,(int)63);
HXDLIN(1006)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)1))));
HXLINE(1007)		 ::cpp::Int64Struct a1 = _hx_int64_shr(v,(int)48);
HXDLIN(1007)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)3))));
HXLINE(1008)		 ::cpp::Int64Struct a2 = _hx_int64_shr(v,(int)40);
HXDLIN(1008)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE(1009)		 ::cpp::Int64Struct a3 = _hx_int64_shr(v,(int)32);
HXDLIN(1009)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE(1010)		 ::cpp::Int64Struct a4 = _hx_int64_shr(v,(int)24);
HXDLIN(1010)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)255))));
HXLINE(1011)		 ::cpp::Int64Struct a5 = _hx_int64_shr(v,(int)16);
HXDLIN(1011)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)255))));
HXLINE(1012)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
