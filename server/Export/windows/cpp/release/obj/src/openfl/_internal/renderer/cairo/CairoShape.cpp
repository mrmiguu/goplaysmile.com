...
HX_DEFINE_STACK_FRAME(_hx_pos_1741ef9bf1a9c806_14_render,"openfl._internal.renderer.cairo.CairoShape","render",0x363dce2a,"openfl._internal.renderer.cairo.CairoShape.render","openfl/_internal/renderer/cairo/CairoShape.hx",14,0xfc9b2624)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
void CairoShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_1741ef9bf1a9c806_14_render)
...
HXLINE(  21)		if (hx::IsNotNull( graphics )) {
...
HXDLIN(  27)			if (hx::IsNotNull( graphics->_hx___cairo )) {
HXLINE(  27)				_hx_tmp4 = graphics->_hx___visible;
            			}
            			else {
HXLINE(  27)				_hx_tmp4 = false;
            			}
HXDLIN(  27)			if (_hx_tmp4) {
HXLINE(  27)				_hx_tmp3 = hx::IsNotNull( graphics->_hx___bounds );
            			}
            			else {
HXLINE(  27)				_hx_tmp3 = false;
            			}
HXDLIN(  27)			if (_hx_tmp3) {
HXLINE(  27)				_hx_tmp2 = (graphics->_hx___width >= (int)1);
            			}
            			else {
HXLINE(  27)				_hx_tmp2 = false;
            			}
HXDLIN(  27)			if (_hx_tmp2) {
HXLINE(  27)				_hx_tmp1 = (graphics->_hx___height >= (int)1);
            			}
            			else {
...
HXLINE(  42)					cairo->set_matrix(graphics->_hx___worldTransform->_hx___toMatrix3());
            				}
