...
HX_LOCAL_STACK_FRAME(_hx_pos_1741ef9bf1a9c806_14_render,"openfl._internal.renderer.cairo.CairoShape","render",0x363dce2a,"openfl._internal.renderer.cairo.CairoShape.render","openfl/_internal/renderer/cairo/CairoShape.hx",14,0xfc9b2624)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
HXLINE(  19)		 ::openfl::display::Graphics graphics = shape->_hx___graphics;
...
HXLINE(  25)			 ::openfl::geom::Rectangle bounds = graphics->_hx___bounds;
...
HXLINE(  27)				_hx_tmp3 = hx::IsNotNull( bounds );
            			}
            			else {
...
HXLINE(  35)					 ::lime::math::Matrix3 matrix = graphics->_hx___worldTransform->_hx___toMatrix3();
