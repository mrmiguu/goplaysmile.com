...
void Application_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.Application","new",0x436ec718,"openfl.display.Application.new","openfl/display/Application.hx",15,0xe1d30bda)
            	HX_STACK_THIS(this)
HXLINE(  17)		super::__construct();
HXLINE(  19)		Bool _hx_tmp = hx::IsNull( ::openfl::Lib_obj::application );
...
void Application_obj::create( ::Dynamic config){
            	HX_STACK_FRAME("openfl.display.Application","create",0xb9517344,"openfl.display.Application.create","openfl/display/Application.hx",28,0xe1d30bda)
            	HX_STACK_THIS(this)
...
HXLINE(  39)		Bool _hx_tmp = hx::IsNotNull( config );
HXDLIN(  39)		if (_hx_tmp) {
HXLINE(  41)			Bool _hx_tmp1 = ::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00));
HXDLIN(  41)			if (_hx_tmp1) {
HXLINE(  43)				Float value = ( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) );
HXDLIN(  43)				this->backend->setFrameRate(value);
            			}
HXLINE(  47)			Bool _hx_tmp2 = ::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8));
...
HXDLIN(  49)					++_g;
HXLINE(  51)					HX_VARI(  ::openfl::display::Window,window) =  ::openfl::display::Window_obj::__new(windowConfig);
HXLINE(  52)					this->createWindow(window);
            				}
            			}
HXLINE(  62)			Bool _hx_tmp3;
HXDLIN(  62)			Bool _hx_tmp4 = hx::IsNotNull( this->_hx___preloader );
HXDLIN(  62)			if (_hx_tmp4) {
HXLINE(  62)				_hx_tmp3 = this->_hx___preloader->complete;
            			}
            			else {
