...
HX_DEFINE_STACK_FRAME(_hx_pos_548c78caa19a1a14_28_create,"openfl.display.Application","create",0xb9517344,"openfl.display.Application.create","openfl/display/Application.hx",28,0xe1d30bda)
namespace openfl{
namespace display{
...
HXDLIN(  49)				HX_VARI( ::Array< ::Dynamic>,_g1) = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN(  49)				while((_g < _g1->length)){
HXLINE(  49)					HX_VARI(  ::Dynamic,windowConfig) = _g1->__get(_g);
HXDLIN(  49)					_g = (_g + (int)1);
HXLINE(  52)					this->createWindow( ::openfl::display::Window_obj::__alloc( HX_CTX ,windowConfig));
            				}
            			}
