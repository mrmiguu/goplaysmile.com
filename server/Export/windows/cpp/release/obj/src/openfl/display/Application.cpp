...
HX_DEFINE_STACK_FRAME(_hx_pos_548c78caa19a1a14_15_new,"openfl.display.Application","new",0x436ec718,"openfl.display.Application.new","openfl/display/Application.hx",15,0xe1d30bda)
HX_LOCAL_STACK_FRAME(_hx_pos_548c78caa19a1a14_28_create,"openfl.display.Application","create",0xb9517344,"openfl.display.Application.create","openfl/display/Application.hx",28,0xe1d30bda)
namespace openfl{
namespace display{

void Application_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_548c78caa19a1a14_15_new)
HXLINE(  17)		super::__construct();
HXLINE(  19)		if (hx::IsNull( ::openfl::Lib_obj::application )) {
HXLINE(  21)			::openfl::Lib_obj::application = hx::ObjectPtr<OBJ_>(this);
            		}
            	}
...
void Application_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_548c78caa19a1a14_28_create)
HXLINE(  30)		this->config = config;
HXLINE(  32)		this->backend->create(config);
HXLINE(  35)		::openfl::Lib_obj::current->_hx___loaderInfo = ::openfl::display::LoaderInfo_obj::create(null());
HXLINE(  36)		::openfl::Lib_obj::current->_hx___loaderInfo->content = ::openfl::Lib_obj::current;
HXLINE(  39)		if (hx::IsNotNull( config )) {
HXLINE(  41)			if (::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00))) {
HXLINE(  43)				this->backend->setFrameRate(( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) ));
            			}
HXLINE(  47)			if (::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8))) {
HXLINE(  49)				int _g = (int)0;
HXDLIN(  49)				::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN(  49)				while((_g < _g1->length)){
HXLINE(  49)					 ::Dynamic windowConfig = _g1->__get(_g);
HXDLIN(  49)					_g = (_g + (int)1);
HXLINE(  51)					 ::openfl::display::Window window =  ::openfl::display::Window_obj::__alloc( HX_CTX ,windowConfig);
HXLINE(  52)					this->createWindow(window);
            				}
            			}
HXLINE(  62)			bool _hx_tmp;
HXDLIN(  62)			if (hx::IsNotNull( this->_hx___preloader )) {
HXLINE(  62)				_hx_tmp = this->_hx___preloader->complete;
            			}
            			else {
HXLINE(  62)				_hx_tmp = true;
            			}
HXDLIN(  62)			if (_hx_tmp) {
HXLINE(  64)				this->onPreloadComplete();
            			}
            		}
            	}
