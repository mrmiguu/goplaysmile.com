...
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_49_close,"openfl.net.URLLoader","close",0x0328b51d,"openfl.net.URLLoader.close","openfl/net/URLLoader.hx",49,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_58_load,"openfl.net.URLLoader","load",0xd80d7061,"openfl.net.URLLoader.load","openfl/net/URLLoader.hx",58,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_69_load,"openfl.net.URLLoader","load",0xd80d7061,"openfl.net.URLLoader.load","openfl/net/URLLoader.hx",69,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_86_load,"openfl.net.URLLoader","load",0xd80d7061,"openfl.net.URLLoader.load","openfl/net/URLLoader.hx",86,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_101___prepareRequest,"openfl.net.URLLoader","__prepareRequest",0x68321263,"openfl.net.URLLoader.__prepareRequest","openfl/net/URLLoader.hx",101,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_167_httpRequest_onError,"openfl.net.URLLoader","httpRequest_onError",0x8f111376,"openfl.net.URLLoader.httpRequest_onError","openfl/net/URLLoader.hx",167,0x11daec0d)
HX_DEFINE_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_182_httpRequest_onProgress,"openfl.net.URLLoader","httpRequest_onProgress",0xf5cd30bf,"openfl.net.URLLoader.httpRequest_onProgress","openfl/net/URLLoader.hx",182,0x11daec0d)
namespace openfl{
namespace net{
...
HXLINE(  74)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  63)			HX_VARI(  ::lime::net::_HTTPRequest_openfl_utils_ByteArray,httpRequest) =  ::lime::net::_HTTPRequest_openfl_utils_ByteArray_obj::__alloc( HX_CTX ,null());
...
HXLINE(  91)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  80)			HX_VARI_NAME(  ::lime::net::_HTTPRequest_String,httpRequest1,"httpRequest") =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
...
HXLINE( 106)		::String _hx_tmp;
HXDLIN( 106)		::String _hx_switch_0 = request->method;
...
HXLINE( 147)				( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),hx::paccDynamic)) )->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 170)			this->dispatchEvent( ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,HX_("securityError",e8,28,7c,a2),null(),null(),null(),null()));
            		}
            		else {
HXLINE( 175)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            	}
...
void URLLoader_obj::httpRequest_onProgress(int bytesLoaded,int bytesTotal){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_182_httpRequest_onProgress)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytesLoaded,"bytesLoaded")
            	HX_STACK_ARG(bytesTotal,"bytesTotal")
HXLINE( 184)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
