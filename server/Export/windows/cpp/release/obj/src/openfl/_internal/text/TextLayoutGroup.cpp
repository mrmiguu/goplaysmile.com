...
void TextLayoutGroup_obj::__construct( ::openfl::text::TextFormat format,Int startIndex,Int endIndex){
            	HX_STACK_FRAME("openfl._internal.text.TextLayoutGroup","new",0x78a7f549,"openfl._internal.text.TextLayoutGroup.new","openfl/_internal/text/TextLayoutGroup.hx",32,0xbe6fd786)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< TextLayoutGroup_obj > TextLayoutGroup_obj::__new( ::openfl::text::TextFormat format,Int startIndex,Int endIndex)
{
	...
	_hx_result->__construct(format,startIndex,endIndex);
	return _hx_result;
}
