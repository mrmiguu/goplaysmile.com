...
HX_DEFINE_STACK_FRAME(_hx_pos_98cd6b2d755c8970_17_register,"openfl._internal.renderer.flash.FlashRenderer","register",0xca9c6617,"openfl._internal.renderer.flash.FlashRenderer.register","openfl/_internal/renderer/flash/FlashRenderer.hx",17,0xe57f2184)
HX_DEFINE_STACK_FRAME(_hx_pos_98cd6b2d755c8970_34_render,"openfl._internal.renderer.flash.FlashRenderer","render",0x065f160a,"openfl._internal.renderer.flash.FlashRenderer.render","openfl/_internal/renderer/flash/FlashRenderer.hx",34,0xe57f2184)
namespace openfl{
namespace _internal{
namespace renderer{
namespace flash{
...
void FlashRenderer_obj::_hx_register(::Dynamic renderObject){
            	HX_GC_STACKFRAME(&_hx_pos_98cd6b2d755c8970_17_register)
            	HX_STACK_ARG(renderObject,"renderObject")
HXLINE(  19)		if (hx::IsNull( ::openfl::_internal::renderer::flash::FlashRenderer_obj::instances )) {
HXLINE(  21)			::openfl::_internal::renderer::flash::FlashRenderer_obj::instances =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
...
void FlashRenderer_obj::render( ::Dynamic _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE(  34)		HX_VARI(  ::Dynamic,instance) = ::openfl::_internal::renderer::flash::FlashRenderer_obj::instances->keys();
HXDLIN(  34)		while(( (bool)(instance->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  36)			::openfl::_internal::renderer::flash::IDisplayObject_obj::_hx___renderFlash(instance->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)());
            		}
            	}
