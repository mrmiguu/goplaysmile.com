...
hx::ObjectPtr< FlashRenderer_obj > FlashRenderer_obj::__new()
{
...
void FlashRenderer_obj::_hx_register(::Dynamic renderObject){
            	HX_STACK_FRAME("openfl._internal.renderer.flash.FlashRenderer","register",0xca9c6617,"openfl._internal.renderer.flash.FlashRenderer.register","openfl/_internal/renderer/flash/FlashRenderer.hx",17,0xe57f2184)
            	HX_STACK_ARG(renderObject,"renderObject")
HXLINE(  19)		Bool _hx_tmp = hx::IsNull( ::openfl::_internal::renderer::flash::FlashRenderer_obj::instances );
HXDLIN(  19)		if (_hx_tmp) {
HXLINE(  21)			::openfl::_internal::renderer::flash::FlashRenderer_obj::instances =  ::haxe::ds::ObjectMap_obj::__new();
HXLINE(  23)			::openfl::Lib_obj::current->stage->addEventListener(HX_("enterFrame",f5,03,50,02),::openfl::_internal::renderer::flash::FlashRenderer_obj::render_dyn(),null(),null(),null());
            		}
...
void FlashRenderer_obj::render( ::Dynamic _){
            	HX_STACK_FRAME("openfl._internal.renderer.flash.FlashRenderer","render",0x065f160a,"openfl._internal.renderer.flash.FlashRenderer.render","openfl/_internal/renderer/flash/FlashRenderer.hx",34,0xe57f2184)
            	HX_STACK_ARG(_,"_")
HXLINE(  34)		HX_VARI(  ::Dynamic,tmp) = ::openfl::_internal::renderer::flash::FlashRenderer_obj::instances->keys();
HXDLIN(  34)		while(true){
HXLINE(  34)			Bool _hx_tmp = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(  34)			if (_hx_tmp) {
HXLINE(  34)				goto _hx_goto_0;
            			}
HXDLIN(  34)			HX_VARI( ::Dynamic,instance) =  ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))();
HXLINE(  36)			::openfl::_internal::renderer::flash::IDisplayObject_obj::_hx___renderFlash(instance);
            		}
            		_hx_goto_0:;
            	}
