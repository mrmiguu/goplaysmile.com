...
Dynamic GradientType_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic GradientType_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._GradientType.GradientType_Impl_","fromString",0x32cb6550,"openfl.display._GradientType.GradientType_Impl_.fromString","openfl/display/GradientType.hx",11,0xadf6e848)
...
::String GradientType_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._GradientType.GradientType_Impl_","toString",0xdcddd0e1,"openfl.display._GradientType.GradientType_Impl_.toString","openfl/display/GradientType.hx",23,0xadf6e848)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",6,0xadf6e848)
HXLINE(   6)		LINEAR = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",7,0xadf6e848)
