...
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_200_new,"openfl.utils._Dictionary.ClassMap","new",0xf688c28a,"openfl.utils._Dictionary.ClassMap.new","openfl/utils/Dictionary.hx",200,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_210_exists,"openfl.utils._Dictionary.ClassMap","exists",0xb39161f2,"openfl.utils._Dictionary.ClassMap.exists","openfl/utils/Dictionary.hx",210,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_217_get,"openfl.utils._Dictionary.ClassMap","get",0xf68372c0,"openfl.utils._Dictionary.ClassMap.get","openfl/utils/Dictionary.hx",217,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_224_keys,"openfl.utils._Dictionary.ClassMap","keys",0xbf25d48a,"openfl.utils._Dictionary.ClassMap.keys","openfl/utils/Dictionary.hx",224,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_231_iterator,"openfl.utils._Dictionary.ClassMap","iterator",0xc9353f84,"openfl.utils._Dictionary.ClassMap.iterator","openfl/utils/Dictionary.hx",231,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_236_remove,"openfl.utils._Dictionary.ClassMap","remove",0xf839e05a,"openfl.utils._Dictionary.ClassMap.remove","openfl/utils/Dictionary.hx",236,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_244_set,"openfl.utils._Dictionary.ClassMap","set",0xf68c8dcc,"openfl.utils._Dictionary.ClassMap.set","openfl/utils/Dictionary.hx",244,0x5979b1eb)
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_256_toString,"openfl.utils._Dictionary.ClassMap","toString",0x6e09c642,"openfl.utils._Dictionary.ClassMap.toString","openfl/utils/Dictionary.hx",256,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void ClassMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e4d60601e770703e_200_new)
            	HX_STACK_THIS(this)
HXLINE( 202)		this->types =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 203)		this->values =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool ClassMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_210_exists)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 210)		return this->types->exists(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,exists,return )
 ...
 ::Dynamic ClassMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_217_get)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 217)		return this->values->get(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,get,return )
 ...
 ::Dynamic ClassMap_obj::keys(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 224)		return this->types->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,keys,return )
 ...
 ::Dynamic ClassMap_obj::iterator(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 231)		return this->values->iterator();
            	}
...
bool ClassMap_obj::remove( ::Dynamic key){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 238)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
...
HXLINE( 246)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
...
::String ClassMap_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 256)		return this->values->toString();
            	}
