...
void ClassMap_obj::__construct(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","new",0xf688c28a,"openfl.utils._Dictionary.ClassMap.new","openfl/utils/Dictionary.hx",200,0x5979b1eb)
            	HX_STACK_THIS(this)
HXLINE( 202)		this->types =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 203)		this->values =  ::haxe::ds::StringMap_obj::__new();
            	}
...
Bool ClassMap_obj::exists( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","exists",0xb39161f2,"openfl.utils._Dictionary.ClassMap.exists","openfl/utils/Dictionary.hx",210,0x5979b1eb)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,exists,return )
 ...
 ::Dynamic ClassMap_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","get",0xf68372c0,"openfl.utils._Dictionary.ClassMap.get","openfl/utils/Dictionary.hx",217,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,get,return )
 ...
 ::Dynamic ClassMap_obj::keys(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","keys",0xbf25d48a,"openfl.utils._Dictionary.ClassMap.keys","openfl/utils/Dictionary.hx",224,0x5979b1eb)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,keys,return )
 ...
 ::Dynamic ClassMap_obj::iterator(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","iterator",0xc9353f84,"openfl.utils._Dictionary.ClassMap.iterator","openfl/utils/Dictionary.hx",231,0x5979b1eb)
            	HX_STACK_THIS(this)
...
Bool ClassMap_obj::remove( ::Dynamic key){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","remove",0xf839e05a,"openfl.utils._Dictionary.ClassMap.remove","openfl/utils/Dictionary.hx",236,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE( 238)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
HXLINE( 239)		Bool _hx_tmp = !(this->types->remove(name));
...
void ClassMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","set",0xf68c8dcc,"openfl.utils._Dictionary.ClassMap.set","openfl/utils/Dictionary.hx",244,0x5979b1eb)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
::String ClassMap_obj::toString(){
            	HX_STACK_FRAME("openfl.utils._Dictionary.ClassMap","toString",0x6e09c642,"openfl.utils._Dictionary.ClassMap.toString","openfl/utils/Dictionary.hx",256,0x5979b1eb)
            	HX_STACK_THIS(this)
