...
HX_DEFINE_STACK_FRAME(_hx_pos_e7e94d427cda442e_505_new,"openfl._internal.stage3D._AGALConverter.DestRegister","new",0x9e816f26,"openfl._internal.stage3D._AGALConverter.DestRegister.new","openfl/_internal/stage3D/AGALConverter.hx",505,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_e7e94d427cda442e_512_getWriteMask,"openfl._internal.stage3D._AGALConverter.DestRegister","getWriteMask",0xc4282a6f,"openfl._internal.stage3D._AGALConverter.DestRegister.getWriteMask","openfl/_internal/stage3D/AGALConverter.hx",512,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_e7e94d427cda442e_536_toGLSL,"openfl._internal.stage3D._AGALConverter.DestRegister","toGLSL",0x2891b9f3,"openfl._internal.stage3D._AGALConverter.DestRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",536,0x0a35cc61)
HX_DEFINE_STACK_FRAME(_hx_pos_e7e94d427cda442e_524_parse,"openfl._internal.stage3D._AGALConverter.DestRegister","parse",0x793cec79,"openfl._internal.stage3D._AGALConverter.DestRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",524,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_505_new)
            	HX_STACK_THIS(this)
            	}
...
::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_512_getWriteMask)
            	HX_STACK_THIS(this)
...
HXLINE( 516)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 517)		if ((((int)this->mask & (int)(int)4) != (int)0)) {
HXLINE( 517)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 518)		if ((((int)this->mask & (int)(int)8) != (int)0)) {
HXLINE( 518)			str = (str + HX_("w",77,00,00,00));
            		}
...
bool useMask = __o_useMask.Default(true);
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_536_toGLSL)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(useMask,"useMask")
HXLINE( 538)		HX_VAR( ::String,str);
HXLINE( 540)		if ((this->type == (int)3)) {
...
HXLINE( 546)			::String str1 = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 546)			str = (str1 + this->n);
            		}
HXLINE( 550)		bool _hx_tmp;
HXDLIN( 550)		if (useMask) {
HXLINE( 550)			_hx_tmp = (this->mask != (int)15);
            		}
            		else {
HXLINE( 550)			_hx_tmp = false;
            		}
HXDLIN( 550)		if (_hx_tmp) {
HXLINE( 552)			str = (str + this->getWriteMask());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_e7e94d427cda442e_524_parse)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(programType,"programType")
HXLINE( 526)		HX_VARI(  ::openfl::_internal::stage3D::_AGALConverter::DestRegister,dr) =  ::openfl::_internal::stage3D::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
