...
HX_DEFINE_STACK_FRAME(_hx_pos_e7e94d427cda442e_507_new,"openfl._internal.stage3D._AGALConverter.DestRegister","new",0x9e816f26,"openfl._internal.stage3D._AGALConverter.DestRegister.new","openfl/_internal/stage3D/AGALConverter.hx",507,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_e7e94d427cda442e_514_getWriteMask,"openfl._internal.stage3D._AGALConverter.DestRegister","getWriteMask",0xc4282a6f,"openfl._internal.stage3D._AGALConverter.DestRegister.getWriteMask","openfl/_internal/stage3D/AGALConverter.hx",514,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_e7e94d427cda442e_538_toGLSL,"openfl._internal.stage3D._AGALConverter.DestRegister","toGLSL",0x2891b9f3,"openfl._internal.stage3D._AGALConverter.DestRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",538,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_e7e94d427cda442e_526_parse,"openfl._internal.stage3D._AGALConverter.DestRegister","parse",0x793cec79,"openfl._internal.stage3D._AGALConverter.DestRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",526,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_507_new)
            	}
...
::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_514_getWriteMask)
HXLINE( 516)		::String str = HX_(".",2e,00,00,00);
HXLINE( 517)		if ((((int)this->mask & (int)(int)1) != (int)0)) {
HXLINE( 517)			str = (str + HX_("x",78,00,00,00));
            		}
HXLINE( 518)		if ((((int)this->mask & (int)(int)2) != (int)0)) {
HXLINE( 518)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 519)		if ((((int)this->mask & (int)(int)4) != (int)0)) {
HXLINE( 519)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 520)		if ((((int)this->mask & (int)(int)8) != (int)0)) {
HXLINE( 520)			str = (str + HX_("w",77,00,00,00));
            		}
...
bool useMask = __o_useMask.Default(true);
            	HX_STACKFRAME(&_hx_pos_e7e94d427cda442e_538_toGLSL)
HXLINE( 540)		::String str;
HXLINE( 542)		if ((this->type == (int)3)) {
HXLINE( 544)			if (hx::IsEq( this->programType,::openfl::_internal::stage3D::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 544)				str = HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 544)				str = HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
            		else {
HXLINE( 548)			::String str1 = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 548)			str = (str1 + this->n);
            		}
HXLINE( 552)		bool _hx_tmp;
HXDLIN( 552)		if (useMask) {
HXLINE( 552)			_hx_tmp = (this->mask != (int)15);
            		}
            		else {
HXLINE( 552)			_hx_tmp = false;
            		}
HXDLIN( 552)		if (_hx_tmp) {
HXLINE( 554)			str = (str + this->getWriteMask());
            		}
HXLINE( 558)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_e7e94d427cda442e_526_parse)
HXLINE( 528)		 ::openfl::_internal::stage3D::_AGALConverter::DestRegister dr =  ::openfl::_internal::stage3D::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
HXLINE( 529)		dr->programType = programType;
HXLINE( 530)		dr->type = ((int)hx::UShr(v,(int)24) & (int)(int)15);
HXLINE( 531)		dr->mask = ((int)hx::UShr(v,(int)16) & (int)(int)15);
HXLINE( 532)		dr->n = ((int)v & (int)(int)65535);
HXLINE( 533)		return dr;
            	}
