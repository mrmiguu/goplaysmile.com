...
HX_DEFINE_STACK_FRAME(_hx_pos_7714f6598ef03af2_18_new,"openfl.display.ShaderParameter","new",0x4699528c,"openfl.display.ShaderParameter.new","openfl/display/ShaderParameter.hx",18,0xc89f13e6)
namespace openfl{
namespace display{

void ShaderParameter_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7714f6598ef03af2_18_new)
