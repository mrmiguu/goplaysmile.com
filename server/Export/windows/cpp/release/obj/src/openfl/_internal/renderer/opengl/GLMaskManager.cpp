...
void GLMaskManager_obj::__construct( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","new",0xce241a4a,"openfl._internal.renderer.opengl.GLMaskManager.new","openfl/_internal/renderer/opengl/GLMaskManager.hx",33,0x0550a1c8)
            	HX_STACK_THIS(this)
...
HXLINE(  41)		this->tempRect =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            	}
...
void GLMaskManager_obj::pushMask( ::openfl::display::DisplayObject mask){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","pushMask",0xd450f9bc,"openfl._internal.renderer.opengl.GLMaskManager.pushMask","openfl/_internal/renderer/opengl/GLMaskManager.hx",50,0x0550a1c8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mask,"mask")
HXLINE(  50)		 ::openfl::geom::Rectangle _hx_tmp = mask->getBounds(mask);
HXDLIN(  50)		 ::openfl::geom::Matrix _hx_tmp1 = mask->_hx___getRenderTransform();
HXDLIN(  50)		this->pushRect(_hx_tmp,_hx_tmp1);
            	}
...
Bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","pushObject",0x9ff60b8f,"openfl._internal.renderer.opengl.GLMaskManager.pushObject","openfl/_internal/renderer/opengl/GLMaskManager.hx",55,0x0550a1c8)
            	HX_STACK_THIS(this)
...
HXLINE(  63)		Bool _hx_tmp1 = hx::IsNotNull( object->_hx___mask );
...
void GLMaskManager_obj::pushRect( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix transform){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","pushRect",0xd7a205f4,"openfl._internal.renderer.opengl.GLMaskManager.pushRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",72,0x0550a1c8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
            	HX_STACK_ARG(transform,"transform")
HXLINE(  78)		Bool _hx_tmp = (this->numClipRects == this->clipRects->length);
HXDLIN(  78)		if (_hx_tmp) {
HXLINE(  80)			Int _hx_tmp1 = this->numClipRects;
HXDLIN(  80)			this->clipRects[_hx_tmp1] =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            		}
HXLINE(  84)		HX_VARI(  ::openfl::geom::Rectangle,clipRect) = this->clipRects->__get(this->numClipRects).StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(  85)		rect->_hx___transform(clipRect,transform);
HXLINE(  87)		Bool _hx_tmp2 = (this->numClipRects > (int)0);
HXDLIN(  87)		if (_hx_tmp2) {
HXLINE(  89)			HX_VARI(  ::openfl::geom::Rectangle,parentClipRect) = this->clipRects->__get((this->numClipRects - (int)1)).StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(  90)			clipRect->_hx___contract(parentClipRect->x,parentClipRect->y,parentClipRect->width,parentClipRect->height);
            		}
HXLINE(  94)		Bool _hx_tmp3 = (clipRect->height < (int)0);
HXDLIN(  94)		if (_hx_tmp3) {
HXLINE(  96)			clipRect->height = (int)0;
            		}
HXLINE( 100)		Bool _hx_tmp4 = (clipRect->width < (int)0);
...
void GLMaskManager_obj::popMask(){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","popMask",0x34fdee07,"openfl._internal.renderer.opengl.GLMaskManager.popMask","openfl/_internal/renderer/opengl/GLMaskManager.hx",114,0x0550a1c8)
            	HX_STACK_THIS(this)
...
Bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","popObject",0x3d00e89a,"openfl._internal.renderer.opengl.GLMaskManager.popObject","openfl/_internal/renderer/opengl/GLMaskManager.hx",119,0x0550a1c8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(handleScrollRect,"handleScrollRect")
HXLINE( 121)		Bool _hx_tmp = hx::IsNotNull( object->_hx___mask );
...
void GLMaskManager_obj::popRect(){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","popRect",0x384efa3f,"openfl._internal.renderer.opengl.GLMaskManager.popRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",138,0x0550a1c8)
            	HX_STACK_THIS(this)
HXLINE( 138)		Bool _hx_tmp = (this->numClipRects > (int)0);
HXDLIN( 138)		if (_hx_tmp) {
HXLINE( 140)			this->numClipRects--;
HXLINE( 142)			Bool _hx_tmp1 = (this->numClipRects > (int)0);
HXDLIN( 142)			if (_hx_tmp1) {
HXLINE( 144)				 ::openfl::geom::Rectangle _hx_tmp2 = this->clipRects->__get((this->numClipRects - (int)1)).StaticCast<  ::openfl::geom::Rectangle >();
HXDLIN( 144)				this->scissorRect(_hx_tmp2);
            			}
            			else {
...
void GLMaskManager_obj::scissorRect( ::openfl::geom::Rectangle rect){
            	HX_STACK_FRAME("openfl._internal.renderer.opengl.GLMaskManager","scissorRect",0x26bf234a,"openfl._internal.renderer.opengl.GLMaskManager.scissorRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",159,0x0550a1c8)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE( 159)		Bool _hx_tmp = hx::IsNotNull( rect );
HXDLIN( 159)		if (_hx_tmp) {
HXLINE( 161)			HX_VARI(  ::openfl::_internal::renderer::opengl::GLRenderer,renderer) = ( ( ::openfl::_internal::renderer::opengl::GLRenderer)(this->renderSession->renderer) );
HXLINE( 163)			this->gl->enable(this->gl->SCISSOR_TEST);
HXLINE( 165)			HX_VARI(  ::openfl::geom::Rectangle,clipRect) = this->tempRect;
HXLINE( 166)			rect->_hx___transform(clipRect,renderer->displayMatrix);
HXLINE( 168)			HX_VARI( Int,x) = ::Math_obj::floor(clipRect->x);
HXLINE( 169)			Float _hx_tmp1 = ((renderer->height - clipRect->y) - clipRect->height);
HXDLIN( 169)			HX_VARI( Int,y) = ::Math_obj::floor(_hx_tmp1);
HXLINE( 170)			HX_VARI( Int,width) = ::Math_obj::ceil(clipRect->width);
HXLINE( 171)			HX_VARI( Int,height) = ::Math_obj::ceil(clipRect->height);
HXLINE( 173)			Bool _hx_tmp2 = (width < (int)0);
HXDLIN( 173)			if (_hx_tmp2) {
HXLINE( 173)				width = (int)0;
            			}
HXLINE( 174)			Bool _hx_tmp3 = (height < (int)0);
