...
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_50_pushMask,"openfl._internal.renderer.opengl.GLMaskManager","pushMask",0xd450f9bc,"openfl._internal.renderer.opengl.GLMaskManager.pushMask","openfl/_internal/renderer/opengl/GLMaskManager.hx",50,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_55_pushObject,"openfl._internal.renderer.opengl.GLMaskManager","pushObject",0x9ff60b8f,"openfl._internal.renderer.opengl.GLMaskManager.pushObject","openfl/_internal/renderer/opengl/GLMaskManager.hx",55,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_72_pushRect,"openfl._internal.renderer.opengl.GLMaskManager","pushRect",0xd7a205f4,"openfl._internal.renderer.opengl.GLMaskManager.pushRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",72,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_114_popMask,"openfl._internal.renderer.opengl.GLMaskManager","popMask",0x34fdee07,"openfl._internal.renderer.opengl.GLMaskManager.popMask","openfl/_internal/renderer/opengl/GLMaskManager.hx",114,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_119_popObject,"openfl._internal.renderer.opengl.GLMaskManager","popObject",0x3d00e89a,"openfl._internal.renderer.opengl.GLMaskManager.popObject","openfl/_internal/renderer/opengl/GLMaskManager.hx",119,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_138_popRect,"openfl._internal.renderer.opengl.GLMaskManager","popRect",0x384efa3f,"openfl._internal.renderer.opengl.GLMaskManager.popRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",138,0x0550a1c8)
HX_DEFINE_STACK_FRAME(_hx_pos_5ff60bcfe7d9703d_159_scissorRect,"openfl._internal.renderer.opengl.GLMaskManager","scissorRect",0x26bf234a,"openfl._internal.renderer.opengl.GLMaskManager.scissorRect","openfl/_internal/renderer/opengl/GLMaskManager.hx",159,0x0550a1c8)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
HXLINE(  80)			this->clipRects[this->numClipRects] =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
...
HXLINE( 144)				this->scissorRect(this->clipRects->__get((this->numClipRects - (int)1)).StaticCast<  ::openfl::geom::Rectangle >());
            			}
            			else {
...
HXLINE( 176)			this->gl->scissor(::Math_obj::floor(clipRect->x),::Math_obj::floor(((renderer->height - clipRect->y) - clipRect->height)),width,height);
            		}
            		else {
