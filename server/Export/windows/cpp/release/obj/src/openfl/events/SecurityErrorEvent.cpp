...
HX_DEFINE_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_17_clone,"openfl.events.SecurityErrorEvent","clone",0x91bd7138,"openfl.events.SecurityErrorEvent.clone","openfl/events/SecurityErrorEvent.hx",17,0x4f4e3035)
HX_DEFINE_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_30_toString,"openfl.events.SecurityErrorEvent","toString",0xccee4db1,"openfl.events.SecurityErrorEvent.toString","openfl/events/SecurityErrorEvent.hx",30,0x4f4e3035)
...
HX_DEFINE_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_7_boot,"openfl.events.SecurityErrorEvent","boot",0x0eecdab7,"openfl.events.SecurityErrorEvent.boot","openfl/events/SecurityErrorEvent.hx",7,0x4f4e3035)
namespace openfl{
namespace events{
...
bool SecurityErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event SecurityErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		HX_VARI(  ::openfl::events::SecurityErrorEvent,event) =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
