...
HX_DEFINE_STACK_FRAME(_hx_pos_344986c8325e94e5_20_render,"openfl._internal.renderer.cairo.CairoBitmap","render",0xa19c46ee,"openfl._internal.renderer.cairo.CairoBitmap.render","openfl/_internal/renderer/cairo/CairoBitmap.hx",20,0x03302068)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
void CairoBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_344986c8325e94e5_20_render)
...
HXLINE(  24)		HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderSession->cairo;
...
HXLINE(  28)			renderSession->maskManager->pushObject(bitmap,null());
HXLINE(  30)			HX_VARI(  ::openfl::geom::Matrix,transform) = bitmap->_hx___renderTransform;
HXLINE(  32)			if (renderSession->roundPixels) {
HXLINE(  34)				HX_VARI(  ::lime::math::Matrix3,matrix) = transform->_hx___toMatrix3();
...
HXLINE(  41)				cairo->set_matrix(transform->_hx___toMatrix3());
            			}
HXLINE(  45)			HX_VARI(  ::Dynamic,surface) = bitmap->bitmapData->getSurface();
HXLINE(  47)			if (hx::IsNotNull( surface )) {
HXLINE(  49)				HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXLINE(  50)				int _hx_tmp2;
HXDLIN(  50)				bool _hx_tmp3;
HXDLIN(  50)				if (renderSession->allowSmoothing) {
HXLINE(  50)					_hx_tmp3 = bitmap->smoothing;
            				}
            				else {
...
HXLINE(  50)					_hx_tmp2 = (int)3;
            				}
HXDLIN(  50)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp2);
HXLINE(  52)				cairo->set_source(pattern);
HXLINE(  54)				if ((bitmap->_hx___worldAlpha == (int)1)) {
HXLINE(  56)					cairo->paint();
            				}
            				else {
HXLINE(  60)					cairo->paintWithAlpha(bitmap->_hx___worldAlpha);
            				}
            			}
HXLINE(  66)			renderSession->maskManager->popObject(bitmap,null());
            		}
            	}
