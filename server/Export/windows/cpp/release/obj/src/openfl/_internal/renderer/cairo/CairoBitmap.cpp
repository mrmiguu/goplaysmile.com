...
HX_LOCAL_STACK_FRAME(_hx_pos_344986c8325e94e5_20_render,"openfl._internal.renderer.cairo.CairoBitmap","render",0xa19c46ee,"openfl._internal.renderer.cairo.CairoBitmap.render","openfl/_internal/renderer/cairo/CairoBitmap.hx",20,0x03302068)
namespace openfl{
namespace _internal{
namespace renderer{
namespace cairo{
...
HXLINE(  24)		 ::lime::graphics::cairo::Cairo cairo = renderSession->cairo;
...
HXLINE(  30)			 ::openfl::geom::Matrix transform = bitmap->_hx___renderTransform;
HXLINE(  32)			if (renderSession->roundPixels) {
HXLINE(  34)				 ::lime::math::Matrix3 matrix = transform->_hx___toMatrix3();
...
HXLINE(  45)			 ::Dynamic surface = bitmap->bitmapData->getSurface();
HXLINE(  47)			if (hx::IsNotNull( surface )) {
HXLINE(  49)				 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
