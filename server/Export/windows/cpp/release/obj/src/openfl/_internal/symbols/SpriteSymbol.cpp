...
HX_DEFINE_STACK_FRAME(_hx_pos_93fa5daca022a01e_17_new,"openfl._internal.symbols.SpriteSymbol","new",0x907606b2,"openfl._internal.symbols.SpriteSymbol.new","openfl/_internal/symbols/SpriteSymbol.hx",17,0x4ab9bb1b)
HX_DEFINE_STACK_FRAME(_hx_pos_93fa5daca022a01e_26___createObject,"openfl._internal.symbols.SpriteSymbol","__createObject",0xc7e3e8e9,"openfl._internal.symbols.SpriteSymbol.__createObject","openfl/_internal/symbols/SpriteSymbol.hx",26,0x4ab9bb1b)
namespace openfl{
namespace _internal{
namespace symbols{

void SpriteSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_93fa5daca022a01e_17_new)
            	HX_STACK_THIS(this)
HXLINE(  19)		super::__construct();
HXLINE(  21)		this->frames = ::Array_obj< ::Dynamic>::__new();
            	}
...
bool SpriteSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject SpriteSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_93fa5daca022a01e_26___createObject)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(swf,"swf")
HXLINE(  28)		HX_VARI(  ::openfl::display::MovieClip,movieClip) = null();
HXLINE(  31)		::openfl::display::MovieClip_obj::_hx___initSWF = swf;
HXLINE(  32)		::openfl::display::MovieClip_obj::_hx___initSymbol = hx::ObjectPtr<OBJ_>(this);
HXLINE(  35)		if (hx::IsNotNull( this->className )) {
HXLINE(  37)			HX_VARI( hx::Class,symbolType) = ::Type_obj::resolveClass(this->className);
HXLINE(  39)			if (hx::IsNotNull( symbolType )) {
HXLINE(  41)				movieClip = ( ( ::openfl::display::MovieClip)(::Type_obj::createInstance(symbolType,::cpp::VirtualArray_obj::__new(0))) );
            			}
            		}
HXLINE(  51)		if (hx::IsNull( movieClip )) {
HXLINE(  53)			movieClip =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
            		}
HXLINE(  57)		return movieClip;
            	}
