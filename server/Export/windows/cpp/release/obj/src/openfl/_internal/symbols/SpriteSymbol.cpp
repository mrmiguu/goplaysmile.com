...
HX_LOCAL_STACK_FRAME(_hx_pos_93fa5daca022a01e_26___createObject,"openfl._internal.symbols.SpriteSymbol","__createObject",0xc7e3e8e9,"openfl._internal.symbols.SpriteSymbol.__createObject","openfl/_internal/symbols/SpriteSymbol.hx",26,0x4ab9bb1b)
namespace openfl{
namespace _internal{
namespace symbols{
...
HXLINE(  28)		 ::openfl::display::MovieClip movieClip = null();
...
HXLINE(  37)			hx::Class symbolType = ::Type_obj::resolveClass(this->className);
