...
void AbstractBlendModeManager_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractBlendModeManager","new",0x10154be8,"openfl._internal.renderer.AbstractBlendModeManager.new","openfl/_internal/renderer/AbstractBlendModeManager.hx",15,0x14ce0069)
            	HX_STACK_THIS(this)
            	}
...
void AbstractBlendModeManager_obj::setBlendMode( ::Dynamic blendMode){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractBlendModeManager","setBlendMode",0x8fce77ca,"openfl._internal.renderer.AbstractBlendModeManager.setBlendMode","openfl/_internal/renderer/AbstractBlendModeManager.hx",22,0x14ce0069)
            	HX_STACK_THIS(this)
