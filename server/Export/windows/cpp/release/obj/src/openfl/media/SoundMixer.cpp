...
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_21_areSoundsInaccessible,"openfl.media.SoundMixer","areSoundsInaccessible",0xcb915307,"openfl.media.SoundMixer.areSoundsInaccessible","openfl/media/SoundMixer.hx",21,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_28_stopAll,"openfl.media.SoundMixer","stopAll",0x7ebb1d93,"openfl.media.SoundMixer.stopAll","openfl/media/SoundMixer.hx",28,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_39___registerSoundChannel,"openfl.media.SoundMixer","__registerSoundChannel",0x60ebf103,"openfl.media.SoundMixer.__registerSoundChannel","openfl/media/SoundMixer.hx",39,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_46___unregisterSoundChannel,"openfl.media.SoundMixer","__unregisterSoundChannel",0xb1bc24dc,"openfl.media.SoundMixer.__unregisterSoundChannel","openfl/media/SoundMixer.hx",46,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_60_get_soundTransform,"openfl.media.SoundMixer","get_soundTransform",0xc6a43892,"openfl.media.SoundMixer.get_soundTransform","openfl/media/SoundMixer.hx",60,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_65_set_soundTransform,"openfl.media.SoundMixer","set_soundTransform",0xa3536b06,"openfl.media.SoundMixer.set_soundTransform","openfl/media/SoundMixer.hx",65,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_10_boot,"openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",10,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_15_boot,"openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",15,0x17e3a43a)
HX_DEFINE_STACK_FRAME(_hx_pos_1587d256662a54fa_16_boot,"openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",16,0x17e3a43a)
namespace openfl{
namespace media{
...
HXDLIN(  28)		HX_VARI( ::Array< ::Dynamic>,_g1) = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  28)		while((_g < _g1->length)){
HXLINE(  28)			HX_VARI(  ::openfl::media::SoundChannel,channel) = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
...
HXDLIN(  69)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN(  69)			while((_g < _g1->length)){
HXLINE(  69)				HX_VARI(  ::openfl::media::SoundChannel,channel) = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
