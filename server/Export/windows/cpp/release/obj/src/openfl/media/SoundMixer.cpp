...
Bool SoundMixer_obj::areSoundsInaccessible(){
            	HX_STACK_FRAME("openfl.media.SoundMixer","areSoundsInaccessible",0xcb915307,"openfl.media.SoundMixer.areSoundsInaccessible","openfl/media/SoundMixer.hx",21,0x17e3a43a)
...
void SoundMixer_obj::stopAll(){
            	HX_STACK_FRAME("openfl.media.SoundMixer","stopAll",0x7ebb1d93,"openfl.media.SoundMixer.stopAll","openfl/media/SoundMixer.hx",28,0x17e3a43a)
...
void SoundMixer_obj::_hx___registerSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACK_FRAME("openfl.media.SoundMixer","__registerSoundChannel",0x60ebf103,"openfl.media.SoundMixer.__registerSoundChannel","openfl/media/SoundMixer.hx",39,0x17e3a43a)
...
void SoundMixer_obj::_hx___unregisterSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACK_FRAME("openfl.media.SoundMixer","__unregisterSoundChannel",0xb1bc24dc,"openfl.media.SoundMixer.__unregisterSoundChannel","openfl/media/SoundMixer.hx",46,0x17e3a43a)
            	HX_STACK_ARG(soundChannel,"soundChannel")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannel,(void))
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::get_soundTransform(){
            	HX_STACK_FRAME("openfl.media.SoundMixer","get_soundTransform",0xc6a43892,"openfl.media.SoundMixer.get_soundTransform","openfl/media/SoundMixer.hx",60,0x17e3a43a)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(SoundMixer_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACK_FRAME("openfl.media.SoundMixer","set_soundTransform",0xa3536b06,"openfl.media.SoundMixer.set_soundTransform","openfl/media/SoundMixer.hx",65,0x17e3a43a)
...
{
{
            	HX_STACK_FRAME("openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",10,0x17e3a43a)
HXLINE(  10)		MAX_ACTIVE_CHANNELS = (int)32;
            	}
{
            	HX_STACK_FRAME("openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",15,0x17e3a43a)
HXLINE(  15)		_hx___soundChannels = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("openfl.media.SoundMixer","boot",0x83c4785e,"openfl.media.SoundMixer.boot","openfl/media/SoundMixer.hx",16,0x17e3a43a)
HXLINE(  16)		_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            	}
}
