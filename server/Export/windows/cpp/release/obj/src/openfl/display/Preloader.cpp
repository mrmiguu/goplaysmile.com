...
HX_DEFINE_STACK_FRAME(_hx_pos_c8b942935957ff96_38_start,"openfl.display.Preloader","start",0xb00e4140,"openfl.display.Preloader.start","openfl/display/Preloader.hx",38,0xc399db74)
HX_DEFINE_STACK_FRAME(_hx_pos_c8b942935957ff96_68_update,"openfl.display.Preloader","update",0xdd75fb6b,"openfl.display.Preloader.update","openfl/display/Preloader.hx",68,0xc399db74)
HX_DEFINE_STACK_FRAME(_hx_pos_c8b942935957ff96_90_display_onUnload,"openfl.display.Preloader","display_onUnload",0xa1bcd03d,"openfl.display.Preloader.display_onUnload","openfl/display/Preloader.hx",90,0xc399db74)
namespace openfl{
namespace display{

void Preloader_obj::__construct( ::openfl::display::Sprite display){
            	HX_STACKFRAME(&_hx_pos_c8b942935957ff96_22_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(display,"display")
HXLINE(  24)		super::__construct();
HXLINE(  26)		this->display = display;
HXLINE(  28)		if (hx::IsNotNull( display )) {
HXLINE(  30)			display->addEventListener(HX_("unload",ff,a0,8c,65),this->display_onUnload_dyn(),null(),null(),null());
HXLINE(  31)			::openfl::Lib_obj::current->addChild(display);
            		}
            	}
...
void Preloader_obj::start(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  40)		if (this->simulateProgress) {
HXLINE(  40)			return;
            		}
HXLINE(  42)		this->ready = true;
HXLINE(  45)		::openfl::Lib_obj::current->get_loaderInfo()->_hx___complete();
HXLINE(  48)		if (hx::IsNotNull( this->display )) {
HXLINE(  50)			HX_VARI(  ::openfl::events::Event,complete) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),true,true);
HXLINE(  51)			this->display->dispatchEvent(complete);
HXLINE(  53)			if (!(complete->isDefaultPrevented())) {
HXLINE(  55)				this->display->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("unload",ff,a0,8c,65),null(),null()));
            			}
            		}
            		else {
HXLINE(  61)			this->super::start();
            		}
            	}
...
HXLINE(  71)		::openfl::Lib_obj::current->get_loaderInfo()->_hx___update(loaded,total);
HXLINE(  74)		if (hx::IsNotNull( this->display )) {
HXLINE(  76)			this->display->dispatchEvent( ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),true,true,loaded,total));
            		}
            	}


void Preloader_obj::display_onUnload( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_c8b942935957ff96_90_display_onUnload)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE(  92)		if (hx::IsNotNull( this->display )) {
HXLINE(  94)			this->display->removeEventListener(HX_("unload",ff,a0,8c,65),this->display_onUnload_dyn(),null());
HXLINE(  96)			if (hx::IsEq( this->display->parent,::openfl::Lib_obj::current )) {
HXLINE(  98)				::openfl::Lib_obj::current->removeChild(this->display);
            			}
HXLINE( 102)			::openfl::Lib_obj::current->stage->set_focus(null());
HXLINE( 103)			this->display = null();
            		}
HXLINE( 107)		bool _hx_tmp;
HXDLIN( 107)		if (this->ready) {
HXLINE( 107)			_hx_tmp = !(this->simulateProgress);
            		}
            		else {
HXLINE( 107)			_hx_tmp = false;
            		}
HXDLIN( 107)		if (_hx_tmp) {
HXLINE( 109)			this->super::start();
            		}
            	}
