...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_44_toString,"openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",44,0xe559e625)
...
bool FocusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FocusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  33)		HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->relatedObject,this->shiftKey,this->keyCode);
