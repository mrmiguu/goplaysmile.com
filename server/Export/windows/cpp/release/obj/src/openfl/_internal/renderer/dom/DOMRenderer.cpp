...
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_123_clear,"openfl._internal.renderer.dom.DOMRenderer","clear",0x7c37cbfd,"openfl._internal.renderer.dom.DOMRenderer.clear","openfl/_internal/renderer/dom/DOMRenderer.hx",123,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_155_render,"openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",155,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_70_applyStyle,"openfl._internal.renderer.dom.DOMRenderer","applyStyle",0x6484f073,"openfl._internal.renderer.dom.DOMRenderer.applyStyle","openfl/_internal/renderer/dom/DOMRenderer.hx",70,0xc812e2a0)
HX_LOCAL_STACK_FRAME(_hx_pos_21b95e0e91b0df21_175_updateClip,"openfl._internal.renderer.dom.DOMRenderer","updateClip",0x2f8d2909,"openfl._internal.renderer.dom.DOMRenderer.updateClip","openfl/_internal/renderer/dom/DOMRenderer.hx",175,0xc812e2a0)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMRenderer_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_123_clear)
HXLINE( 123)		int _g = (int)0;
HXDLIN( 123)		 ::openfl::_Vector::ObjectVector _g1 = this->stage->stage3Ds;
HXDLIN( 123)		while((_g < _g1->get_length())){
HXLINE( 123)			 ::openfl::display::Stage3D stage3D = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN( 123)			_g = (_g + (int)1);
HXLINE( 125)			stage3D->_hx___renderDOM(this->stage,this->renderSession);
            		}
            	}


void DOMRenderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_155_render)
HXLINE( 157)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE( 159)		if (!(this->stage->_hx___transparent)) {
HXLINE( 161)			this->element->style->__SetField(HX_("background",ee,93,1d,26),this->stage->_hx___colorString,hx::paccDynamic);
            		}
            		else {
HXLINE( 165)			this->element->style->__SetField(HX_("background",ee,93,1d,26),HX_("none",b8,12,0a,49),hx::paccDynamic);
            		}
HXLINE( 169)		this->renderSession->z = (int)1;
HXLINE( 170)		this->stage->_hx___renderDOM(this->renderSession);
            	}
...
void DOMRenderer_obj::applyStyle( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession,bool setTransform,bool setAlpha,bool setClip){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_70_applyStyle)
            	}
...
void DOMRenderer_obj::updateClip( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_175_updateClip)
HXLINE( 177)		 ::openfl::_internal::renderer::dom::DOMMaskManager maskManager = ( ( ::openfl::_internal::renderer::dom::DOMMaskManager)(renderSession->maskManager) );
HXLINE( 178)		maskManager->updateClip(displayObject);
            	}
