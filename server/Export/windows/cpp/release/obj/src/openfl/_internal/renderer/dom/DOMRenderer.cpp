...
HX_DEFINE_STACK_FRAME(_hx_pos_21b95e0e91b0df21_123_clear,"openfl._internal.renderer.dom.DOMRenderer","clear",0x7c37cbfd,"openfl._internal.renderer.dom.DOMRenderer.clear","openfl/_internal/renderer/dom/DOMRenderer.hx",123,0xc812e2a0)
HX_DEFINE_STACK_FRAME(_hx_pos_21b95e0e91b0df21_155_render,"openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",155,0xc812e2a0)
HX_DEFINE_STACK_FRAME(_hx_pos_21b95e0e91b0df21_70_applyStyle,"openfl._internal.renderer.dom.DOMRenderer","applyStyle",0x6484f073,"openfl._internal.renderer.dom.DOMRenderer.applyStyle","openfl/_internal/renderer/dom/DOMRenderer.hx",70,0xc812e2a0)
HX_DEFINE_STACK_FRAME(_hx_pos_21b95e0e91b0df21_178_updateClip,"openfl._internal.renderer.dom.DOMRenderer","updateClip",0x2f8d2909,"openfl._internal.renderer.dom.DOMRenderer.updateClip","openfl/_internal/renderer/dom/DOMRenderer.hx",178,0xc812e2a0)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
HXDLIN( 123)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN( 123)		while((_g < _g1->get_length())){
HXLINE( 123)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
...
void DOMRenderer_obj::updateClip( ::openfl::display::DisplayObject displayObject, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_21b95e0e91b0df21_178_updateClip)
            	HX_STACK_ARG(displayObject,"displayObject")
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 178)		( ( ::openfl::_internal::renderer::dom::DOMMaskManager)(renderSession->maskManager) )->updateClip(displayObject);
            	}
