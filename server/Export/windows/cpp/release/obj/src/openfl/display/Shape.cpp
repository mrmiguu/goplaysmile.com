...
HX_DEFINE_STACK_FRAME(_hx_pos_6325b0c027895dfe_15_new,"openfl.display.Shape","new",0x7b6756e9,"openfl.display.Shape.new","openfl/display/Shape.hx",15,0xe963f3a9)
HX_DEFINE_STACK_FRAME(_hx_pos_6325b0c027895dfe_27_get_graphics,"openfl.display.Shape","get_graphics",0xb4a78d2b,"openfl.display.Shape.get_graphics","openfl/display/Shape.hx",27,0xe963f3a9)
namespace openfl{
namespace display{

void Shape_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6325b0c027895dfe_15_new)
            	HX_STACK_THIS(this)
...
bool Shape_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::Graphics Shape_obj::get_graphics(){
            	HX_GC_STACKFRAME(&_hx_pos_6325b0c027895dfe_27_get_graphics)
            	HX_STACK_THIS(this)
HXLINE(  29)		if (hx::IsNull( this->_hx___graphics )) {
HXLINE(  31)			this->_hx___graphics =  ::openfl::display::Graphics_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
            		}
