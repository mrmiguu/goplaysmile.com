...
HX_DEFINE_STACK_FRAME(_hx_pos_73476240e0218aae_24___createObject,"openfl._internal.symbols.SWFSymbol","__createObject",0x3e7224b2,"openfl._internal.symbols.SWFSymbol.__createObject","openfl/_internal/symbols/SWFSymbol.hx",24,0xf7371d0a)
namespace openfl{
namespace _internal{
namespace symbols{
...
bool SWFSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject SWFSymbol_obj::_hx___createObject( ::openfl::_internal::swf::SWFLite swf){
            	HX_STACKFRAME(&_hx_pos_73476240e0218aae_24___createObject)
            	HX_STACK_THIS(this)
