...
Float y = __o_y.Default(0);
            	HX_STACK_FRAME("openfl.geom.Point","new",0xa6fb3c0e,"openfl.geom.Point.new","openfl/geom/Point.hx",23,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(  25)		this->x = x;
...
Dynamic Point_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::geom::Point Point_obj::add( ::openfl::geom::Point v){
            	HX_STACK_FRAME("openfl.geom.Point","add",0xa6f15dcf,"openfl.geom.Point.add","openfl/geom/Point.hx",33,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  33)		return  ::openfl::geom::Point_obj::__new((v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Point_obj,add,return )
 ...
 ::openfl::geom::Point Point_obj::clone(){
            	HX_STACK_FRAME("openfl.geom.Point","clone",0x787f468b,"openfl.geom.Point.clone","openfl/geom/Point.hx",40,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE(  40)		return  ::openfl::geom::Point_obj::__new(this->x,this->y);
            	}
...
void Point_obj::copyFrom( ::openfl::geom::Point sourcePoint){
            	HX_STACK_FRAME("openfl.geom.Point","copyFrom",0x660e8951,"openfl.geom.Point.copyFrom","openfl/geom/Point.hx",45,0x18173b82)
            	HX_STACK_THIS(this)
...
Bool Point_obj::equals( ::openfl::geom::Point toCompare){
            	HX_STACK_FRAME("openfl.geom.Point","equals",0xa8838351,"openfl.geom.Point.equals","openfl/geom/Point.hx",64,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
HXLINE(  64)		Bool _hx_tmp;
HXDLIN(  64)		Bool _hx_tmp1 = hx::IsNotNull( toCompare );
...
void Point_obj::normalize(Float thickness){
            	HX_STACK_FRAME("openfl.geom.Point","normalize",0x05c199bb,"openfl.geom.Point.normalize","openfl/geom/Point.hx",78,0x18173b82)
            	HX_STACK_THIS(this)
...
HXLINE(  84)			Float _hx_tmp1 = ((this->x * this->x) + (this->y * this->y));
HXDLIN(  84)			Float _hx_tmp2 = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  84)			HX_VARI( Float,norm) = ((Float)thickness / (Float)_hx_tmp2);
HXLINE(  85)			hx::MultEq(this->x,norm);
HXLINE(  86)			hx::MultEq(this->y,norm);
            		}
            	}
...
void Point_obj::offset(Float dx,Float dy){
            	HX_STACK_FRAME("openfl.geom.Point","offset",0x48d02ca5,"openfl.geom.Point.offset","openfl/geom/Point.hx",93,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  95)		hx::AddEq(this->x,dx);
HXLINE(  96)		hx::AddEq(this->y,dy);
            	}
...
void Point_obj::setTo(Float xa,Float ya){
            	HX_STACK_FRAME("openfl.geom.Point","setTo",0xaa4bc4eb,"openfl.geom.Point.setTo","openfl/geom/Point.hx",108,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xa,"xa")
            	HX_STACK_ARG(ya,"ya")
...
HX_DEFINE_DYNAMIC_FUNC2(Point_obj,setTo,(void))
 ...
 ::openfl::geom::Point Point_obj::subtract( ::openfl::geom::Point v){
            	HX_STACK_FRAME("openfl.geom.Point","subtract",0x95bef2a6,"openfl.geom.Point.subtract","openfl/geom/Point.hx",117,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 117)		return  ::openfl::geom::Point_obj::__new((this->x - v->x),(this->y - v->y));
            	}
...
::String Point_obj::toString(){
            	HX_STACK_FRAME("openfl.geom.Point","toString",0xd61c4e3e,"openfl.geom.Point.toString","openfl/geom/Point.hx",124,0x18173b82)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Point_obj,toString,return )
 ...
 ::lime::math::Vector2 Point_obj::_hx___toLimeVector2(){
            	HX_STACK_FRAME("openfl.geom.Point","__toLimeVector2",0x318eb74d,"openfl.geom.Point.__toLimeVector2","openfl/geom/Point.hx",129,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE( 131)		Bool _hx_tmp = hx::IsNull( ::openfl::geom::Point_obj::_hx___limeVector2 );
HXDLIN( 131)		if (_hx_tmp) {
HXLINE( 133)			::openfl::geom::Point_obj::_hx___limeVector2 =  ::lime::math::Vector2_obj::__new(null(),null());
            		}
HXLINE( 137)		{
HXLINE( 137)			HX_VARI(  ::lime::math::Vector2,_this) = ::openfl::geom::Point_obj::_hx___limeVector2;
HXDLIN( 137)			Float xa = this->x;
HXDLIN( 137)			Float ya = this->y;
HXDLIN( 137)			_this->x = xa;
HXDLIN( 137)			_this->y = ya;
            		}
...
Float Point_obj::get_length(){
            	HX_STACK_FRAME("openfl.geom.Point","get_length",0x11c48ac1,"openfl.geom.Point.get_length","openfl/geom/Point.hx",152,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE( 152)		Float _hx_tmp = ((this->x * this->x) + (this->y * this->y));
HXDLIN( 152)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
Float Point_obj::distance( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2){
            	HX_STACK_FRAME("openfl.geom.Point","distance",0x09a710c7,"openfl.geom.Point.distance","openfl/geom/Point.hx",53,0x18173b82)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Point_obj,distance,return )
 ...
 ::openfl::geom::Point Point_obj::interpolate( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2,Float f){
            	HX_STACK_FRAME("openfl.geom.Point","interpolate",0x8bd29e6f,"openfl.geom.Point.interpolate","openfl/geom/Point.hx",71,0x18173b82)
            	HX_STACK_ARG(pt1,"pt1")
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  71)		return  ::openfl::geom::Point_obj::__new((pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Point_obj,interpolate,return )
 ...
 ::openfl::geom::Point Point_obj::polar(Float len,Float angle){
            	HX_STACK_FRAME("openfl.geom.Point","polar",0xf6ae22ec,"openfl.geom.Point.polar","openfl/geom/Point.hx",103,0x18173b82)
            	HX_STACK_ARG(len,"len")
            	HX_STACK_ARG(angle,"angle")
HXLINE( 103)		Float _hx_tmp = ::Math_obj::cos(angle);
HXDLIN( 103)		Float _hx_tmp1 = (len * _hx_tmp);
HXDLIN( 103)		Float _hx_tmp2 = ::Math_obj::sin(angle);
HXDLIN( 103)		return  ::openfl::geom::Point_obj::__new(_hx_tmp1,(len * _hx_tmp2));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.geom.Point","boot",0x6cf250c4,"openfl.geom.Point.boot","openfl/geom/Point.hx",16,0x18173b82)
HXLINE(  16)		_hx___temp =  ::openfl::geom::Point_obj::__new(null(),null());
            	}
}
