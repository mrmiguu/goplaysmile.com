...
Dynamic CapsStyle_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic CapsStyle_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.display._CapsStyle.CapsStyle_Impl_","fromString",0xfe761d8c,"openfl.display._CapsStyle.CapsStyle_Impl_.fromString","openfl/display/CapsStyle.hx",12,0x1f3162da)
...
::String CapsStyle_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.display._CapsStyle.CapsStyle_Impl_","toString",0xedfcc21d,"openfl.display._CapsStyle.CapsStyle_Impl_.toString","openfl/display/CapsStyle.hx",25,0x1f3162da)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",6,0x1f3162da)
HXLINE(   6)		NONE = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",7,0x1f3162da)
HXLINE(   7)		ROUND = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",8,0x1f3162da)
