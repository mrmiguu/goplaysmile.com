...
HX_DEFINE_STACK_FRAME(_hx_pos_7c7ee06d9b3544d2_28_getStackTrace,"openfl.errors.Error","getStackTrace",0x0bedf2e8,"openfl.errors.Error.getStackTrace","openfl/errors/Error.hx",28,0x5096467b)
HX_DEFINE_STACK_FRAME(_hx_pos_7c7ee06d9b3544d2_35_toString,"openfl.errors.Error","toString",0x62f5b437,"openfl.errors.Error.toString","openfl/errors/Error.hx",35,0x5096467b)
HX_DEFINE_STACK_FRAME(_hx_pos_7c7ee06d9b3544d2_10_boot,"openfl.errors.Error","boot",0xc051063d,"openfl.errors.Error.boot","openfl/errors/Error.hx",10,0x5096467b)
namespace openfl{
namespace errors{
...
::String Error_obj::getStackTrace(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  28)		return ::haxe::CallStack_obj::toString(::haxe::CallStack_obj::exceptionStack());
            	}
...
::String Error_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  35)		if (hx::IsNotNull( this->message )) {
