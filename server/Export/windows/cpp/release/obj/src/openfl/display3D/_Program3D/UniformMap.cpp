...
HX_DEFINE_STACK_FRAME(_hx_pos_621d8b893318d029_521_new,"openfl.display3D._Program3D.UniformMap","new",0xd35cedd9,"openfl.display3D._Program3D.UniformMap.new","openfl/display3D/Program3D.hx",521,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_621d8b893318d029_515_new,"openfl.display3D._Program3D.UniformMap","new",0xd35cedd9,"openfl.display3D._Program3D.UniformMap.new","openfl/display3D/Program3D.hx",515,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_621d8b893318d029_556_flush,"openfl.display3D._Program3D.UniformMap","flush",0x8041907d,"openfl.display3D._Program3D.UniformMap.flush","openfl/display3D/Program3D.hx",556,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_621d8b893318d029_576_markAllDirty,"openfl.display3D._Program3D.UniformMap","markAllDirty",0xa1dc4bc5,"openfl.display3D._Program3D.UniformMap.markAllDirty","openfl/display3D/Program3D.hx",576,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_621d8b893318d029_584_markDirty,"openfl.display3D._Program3D.UniformMap","markDirty",0x0c852efe,"openfl.display3D._Program3D.UniformMap.markDirty","openfl/display3D/Program3D.hx",584,0x0a985b04)
namespace openfl{
namespace display3D{
...
void UniformMap_obj::__construct(::Array< ::Dynamic> list){
            		...
            		int _hx_run( ::openfl::display3D::_Program3D::Uniform a, ::openfl::display3D::_Program3D::Uniform b){
            			HX_STACKFRAME(&_hx_pos_621d8b893318d029_521_new)
HXLINE( 521)			return ::Reflect_obj::compare(a->regIndex,b->regIndex);
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_GC_STACKFRAME(&_hx_pos_621d8b893318d029_515_new)
HXLINE( 517)		this->_hx___uniforms = list;
HXLINE( 519)		this->_hx___uniforms->sort( ::Dynamic(new _hx_Closure_0()));
HXLINE( 525)		int total = (int)0;
HXLINE( 527)		{
HXLINE( 527)			int _g = (int)0;
HXDLIN( 527)			::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 527)			while((_g < _g1->length)){
HXLINE( 527)				 ::openfl::display3D::_Program3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
HXDLIN( 527)				_g = (_g + (int)1);
HXLINE( 529)				if (((uniform->regIndex + uniform->regCount) > total)) {
HXLINE( 531)					total = (uniform->regIndex + uniform->regCount);
            				}
            			}
            		}
HXLINE( 537)		bool fixed = null();
HXDLIN( 537)		this->_hx___registerLookup =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,null());
HXLINE( 539)		{
HXLINE( 539)			int _g2 = (int)0;
HXDLIN( 539)			::Array< ::Dynamic> _g11 = this->_hx___uniforms;
HXDLIN( 539)			while((_g2 < _g11->length)){
HXLINE( 539)				 ::openfl::display3D::_Program3D::Uniform uniform1 = _g11->__get(_g2).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
HXDLIN( 539)				_g2 = (_g2 + (int)1);
HXLINE( 541)				{
HXLINE( 541)					int _g3 = (int)0;
HXDLIN( 541)					int _g21 = uniform1->regCount;
HXDLIN( 541)					while((_g3 < _g21)){
HXLINE( 541)						_g3 = (_g3 + (int)1);
HXDLIN( 541)						int i = (_g3 - (int)1);
HXLINE( 543)						this->_hx___registerLookup->set((uniform1->regIndex + i),uniform1).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
            					}
            				}
            			}
            		}
...
void UniformMap_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_621d8b893318d029_556_flush)
HXLINE( 556)		if (this->_hx___anyDirty) {
HXLINE( 558)			{
HXLINE( 558)				int _g = (int)0;
HXDLIN( 558)				::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 558)				while((_g < _g1->length)){
HXLINE( 558)					 ::openfl::display3D::_Program3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
HXDLIN( 558)					_g = (_g + (int)1);
HXLINE( 560)					bool _hx_tmp;
HXDLIN( 560)					if (!(this->_hx___allDirty)) {
HXLINE( 560)						_hx_tmp = uniform->isDirty;
            					}
            					else {
...
void UniformMap_obj::markAllDirty(){
            	HX_STACKFRAME(&_hx_pos_621d8b893318d029_576_markAllDirty)
...
void UniformMap_obj::markDirty(int start,int count){
            	HX_STACKFRAME(&_hx_pos_621d8b893318d029_584_markDirty)
HXLINE( 586)		if (this->_hx___allDirty) {
HXLINE( 588)			return;
            		}
HXLINE( 592)		int end = (start + count);
HXLINE( 594)		if ((end > this->_hx___registerLookup->get_length())) {
HXLINE( 596)			end = this->_hx___registerLookup->get_length();
            		}
HXLINE( 600)		int index = start;
HXLINE( 602)		while((index < end)){
HXLINE( 604)			 ::openfl::display3D::_Program3D::Uniform uniform = this->_hx___registerLookup->get(index).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
HXLINE( 606)			if (hx::IsNotNull( uniform )) {
HXLINE( 608)				uniform->isDirty = true;
HXLINE( 609)				this->_hx___anyDirty = true;
HXLINE( 611)				index = (uniform->regIndex + uniform->regCount);
            			}
            			else {
HXLINE( 615)				index = (index + (int)1);
            			}
            		}
            	}
