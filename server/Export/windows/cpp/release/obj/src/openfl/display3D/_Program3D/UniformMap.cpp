...
HX_DEFINE_STACK_FRAME(_hx_pos_621d8b893318d029_556_flush,"openfl.display3D._Program3D.UniformMap","flush",0x8041907d,"openfl.display3D._Program3D.UniformMap.flush","openfl/display3D/Program3D.hx",556,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_621d8b893318d029_576_markAllDirty,"openfl.display3D._Program3D.UniformMap","markAllDirty",0xa1dc4bc5,"openfl.display3D._Program3D.UniformMap.markAllDirty","openfl/display3D/Program3D.hx",576,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_621d8b893318d029_584_markDirty,"openfl.display3D._Program3D.UniformMap","markDirty",0x0c852efe,"openfl.display3D._Program3D.UniformMap.markDirty","openfl/display3D/Program3D.hx",584,0x0a985b04)
namespace openfl{
namespace display3D{
...
HXLINE( 543)						this->_hx___registerLookup->set((uniform1->regIndex + (_g3 - (int)1)),uniform1).StaticCast<  ::openfl::display3D::_Program3D::Uniform >();
            					}
            				}
            			}
            		}
