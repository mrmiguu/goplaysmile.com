...
Dynamic TextFormatAlign_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic TextFormatAlign_Impl__obj::fromString(::String value){
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","fromString",0xac8d25d1,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.fromString","openfl/text/TextFormatAlign.hx",15,0xaa546dc0)
...
::String TextFormatAlign_Impl__obj::toString(Int value){
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","toString",0xf3d6bf22,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.toString","openfl/text/TextFormatAlign.hx",31,0xaa546dc0)
            	HX_STACK_ARG(value,"value")
...
{
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",6,0xaa546dc0)
HXLINE(   6)		CENTER = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",7,0xaa546dc0)
HXLINE(   7)		END = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",8,0xaa546dc0)
HXLINE(   8)		JUSTIFY = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",9,0xaa546dc0)
HXLINE(   9)		LEFT = (int)3;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",10,0xaa546dc0)
HXLINE(  10)		RIGHT = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",11,0xaa546dc0)
