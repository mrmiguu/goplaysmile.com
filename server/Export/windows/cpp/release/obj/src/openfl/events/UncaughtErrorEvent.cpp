...
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_34_toString,"openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",34,0x0dad2340)
...
bool UncaughtErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event UncaughtErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->error);
