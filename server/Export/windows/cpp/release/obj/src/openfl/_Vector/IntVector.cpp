...
void IntVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::Array< Int > array){
            	HX_STACK_FRAME("openfl._Vector.IntVector","new",0x6313ae9a,"openfl._Vector.IntVector.new","openfl/Vector.hx",1173,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(fixed,"fixed")
            	HX_STACK_ARG(array,"array")
HXLINE(1175)		Bool _hx_tmp = hx::IsNull( array );
HXDLIN(1175)		if (_hx_tmp) {
HXLINE(1177)			array = ::Array_obj< Int >::__new();
            		}
HXLINE(1181)		this->_hx___array = array;
HXLINE(1183)		Bool _hx_tmp1 = hx::IsNotNull( length );
...
::Dynamic IntVector_obj::concat(::Dynamic a){
            	HX_STACK_FRAME("openfl._Vector.IntVector","concat",0x4a254b1a,"openfl._Vector.IntVector.concat","openfl/Vector.hx",1196,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(1196)		Bool _hx_tmp = hx::IsNull( a );
HXDLIN(1196)		if (_hx_tmp) {
HXLINE(1198)			::Array< Int > _hx_tmp1 = this->_hx___array->copy();
HXDLIN(1198)			return  ::openfl::_Vector::IntVector_obj::__new(null(),null(),_hx_tmp1);
            		}
            		else {
HXLINE(1202)			::Array< Int > _hx_tmp2 = this->_hx___array->concat(hx::TCast<  ::openfl::_Vector::IntVector >::cast(a)->_hx___array);
HXDLIN(1202)			return  ::openfl::_Vector::IntVector_obj::__new(null(),null(),_hx_tmp2);
            		}
...
::Dynamic IntVector_obj::copy(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","copy",0x46e7503b,"openfl._Vector.IntVector.copy","openfl/Vector.hx",1211,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1211)		Bool _hx_tmp = this->fixed;
HXDLIN(1211)		::Array< Int > _hx_tmp1 = this->_hx___array->copy();
HXDLIN(1211)		return  ::openfl::_Vector::IntVector_obj::__new(null(),_hx_tmp,_hx_tmp1);
            	}
...
Int IntVector_obj::get(Int index){
            	HX_STACK_FRAME("openfl._Vector.IntVector","get",0x630e5ed0,"openfl._Vector.IntVector.get","openfl/Vector.hx",1218,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int IntVector_obj::indexOf(Int x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.IntVector","indexOf",0x6903cc03,"openfl._Vector.IntVector.indexOf","openfl/Vector.hx",1223,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE(1225)		{
HXLINE(1225)			HX_VARI( Int,_g1) = from;
HXDLIN(1225)			HX_VARI( Int,_g) = this->_hx___array->length;
HXDLIN(1225)			while((_g1 < _g)){
HXLINE(1225)				HX_VARI( Int,i) = _g1++;
...
void IntVector_obj::insertAt(Int index,Int element){
            	HX_STACK_FRAME("openfl._Vector.IntVector","insertAt",0x75cdcc12,"openfl._Vector.IntVector.insertAt","openfl/Vector.hx",1242,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,insertAt,(void))
 ...
 ::Dynamic IntVector_obj::iterator(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","iterator",0x47489974,"openfl._Vector.IntVector.iterator","openfl/Vector.hx",1253,0x4a01873c)
            	HX_STACK_THIS(this)
...
::String IntVector_obj::join(::String sep){
            	HX_STACK_FRAME("openfl._Vector.IntVector","join",0x4b87c870,"openfl._Vector.IntVector.join","openfl/Vector.hx",1260,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int IntVector_obj::lastIndexOf(Int x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACK_FRAME("openfl._Vector.IntVector","lastIndexOf",0x72eaa54d,"openfl._Vector.IntVector.lastIndexOf","openfl/Vector.hx",1265,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(from,"from")
HXLINE(1267)		HX_VARI( Int,i) = (this->_hx___array->length - (int)1);
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,lastIndexOf,return )
 ...
 ::Dynamic IntVector_obj::pop(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","pop",0x63153bcb,"openfl._Vector.IntVector.pop","openfl/Vector.hx",1283,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1283)		Bool _hx_tmp = !(this->fixed);
...
Int IntVector_obj::push(Int x){
            	HX_STACK_FRAME("openfl._Vector.IntVector","push",0x4f83a660,"openfl._Vector.IntVector.push","openfl/Vector.hx",1298,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1298)		Bool _hx_tmp = !(this->fixed);
...
void IntVector_obj::reverse(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","reverse",0xa340bc5c,"openfl._Vector.IntVector.reverse","openfl/Vector.hx",1313,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int IntVector_obj::set(Int index,Int value){
            	HX_STACK_FRAME("openfl._Vector.IntVector","set",0x631779dc,"openfl._Vector.IntVector.set","openfl/Vector.hx",1320,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC2(IntVector_obj,set,return )
 ...
 ::Dynamic IntVector_obj::shift(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","shift",0xf5424d3c,"openfl._Vector.IntVector.shift","openfl/Vector.hx",1335,0x4a01873c)
            	HX_STACK_THIS(this)
HXLINE(1335)		Bool _hx_tmp = !(this->fixed);
...
::Dynamic IntVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_STACK_FRAME("openfl._Vector.IntVector","slice",0xf7e7250c,"openfl._Vector.IntVector.slice","openfl/Vector.hx",1350,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(startIndex,"startIndex")
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1350)		::Array< Int > _hx_tmp = this->_hx___array->slice(startIndex,endIndex);
HXDLIN(1350)		return  ::openfl::_Vector::IntVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
void IntVector_obj::sort( ::Dynamic f){
            	HX_STACK_FRAME("openfl._Vector.IntVector","sort",0x517abbe4,"openfl._Vector.IntVector.sort","openfl/Vector.hx",1357,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
::Dynamic IntVector_obj::splice(Int pos,Int len){
            	HX_STACK_FRAME("openfl._Vector.IntVector","splice",0x41f3c782,"openfl._Vector.IntVector.splice","openfl/Vector.hx",1364,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
HXLINE(1364)		::Array< Int > _hx_tmp = this->_hx___array->splice(pos,len);
HXDLIN(1364)		return  ::openfl::_Vector::IntVector_obj::__new(null(),null(),_hx_tmp);
            	}
...
::String IntVector_obj::toString(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","toString",0xec1d2032,"openfl._Vector.IntVector.toString","openfl/Vector.hx",1371,0x4a01873c)
            	HX_STACK_THIS(this)
...
void IntVector_obj::unshift(Int x){
            	HX_STACK_FRAME("openfl._Vector.IntVector","unshift",0x00f866c3,"openfl._Vector.IntVector.unshift","openfl/Vector.hx",1378,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(1378)		Bool _hx_tmp = !(this->fixed);
...
Int IntVector_obj::get_length(){
            	HX_STACK_FRAME("openfl._Vector.IntVector","get_length",0x4714c1b5,"openfl._Vector.IntVector.get_length","openfl/Vector.hx",1396,0x4a01873c)
            	HX_STACK_THIS(this)
...
Int IntVector_obj::set_length(Int value){
            	HX_STACK_FRAME("openfl._Vector.IntVector","set_length",0x4a926029,"openfl._Vector.IntVector.set_length","openfl/Vector.hx",1401,0x4a01873c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(1403)		Bool _hx_tmp = !(this->fixed);
