...
Dynamic IOErrorEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event IOErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text,this->errorID);
...
::String IOErrorEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  30)		return this->_hx___formatToString(HX_("IOErrorEvent",b8,16,b3,65),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
