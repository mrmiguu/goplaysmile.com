...
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_30_toString,"openfl.events.IOErrorEvent","toString",0xfbbd53ab,"openfl.events.IOErrorEvent.toString","openfl/events/IOErrorEvent.hx",30,0x9ba976af)
...
bool IOErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event IOErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
