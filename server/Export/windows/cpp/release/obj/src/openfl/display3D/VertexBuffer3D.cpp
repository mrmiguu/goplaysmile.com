...
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_47_dispose,"openfl.display3D.VertexBuffer3D","dispose",0x6b6860bf,"openfl.display3D.VertexBuffer3D.dispose","openfl/display3D/VertexBuffer3D.hx",47,0xb1ad396e)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_58_uploadFromByteArray,"openfl.display3D.VertexBuffer3D","uploadFromByteArray",0x0096a806,"openfl.display3D.VertexBuffer3D.uploadFromByteArray","openfl/display3D/VertexBuffer3D.hx",58,0xb1ad396e)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_68_uploadFromTypedArray,"openfl.display3D.VertexBuffer3D","uploadFromTypedArray",0xeb97089a,"openfl.display3D.VertexBuffer3D.uploadFromTypedArray","openfl/display3D/VertexBuffer3D.hx",68,0xb1ad396e)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_88_uploadFromVector,"openfl.display3D.VertexBuffer3D","uploadFromVector",0xcf228b0e,"openfl.display3D.VertexBuffer3D.uploadFromVector","openfl/display3D/VertexBuffer3D.hx",88,0xb1ad396e)
namespace openfl{
namespace display3D{
...
HXLINE(  60)		int offset = (byteArrayOffset + (startVertex * this->_hx___stride));
HXLINE(  61)		int length = (numVertices * this->_hx___vertexSize);
...
HXLINE(  63)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)8);
...
HXDLIN(  63)				int newRange = (offset + newByteLength);
...
HXLINE(  80)			 ::openfl::display3D::Context3D _hx_tmp = this->_hx___context;
HXDLIN(  80)			_hx_tmp->_hx___statsAdd((int)7,(data->byteLength - this->_hx___memoryUsage));
...
HXLINE(  96)		 ::lime::utils::ArrayBufferView this1;
...
HXDLIN(  96)		 ::lime::utils::ArrayBufferView buffer = this1;
HXLINE(  98)		{
HXLINE(  98)			int _g1 = start;
HXDLIN(  98)			int _g = length;
HXDLIN(  98)			while((_g1 < _g)){
HXLINE(  98)				_g1 = (_g1 + (int)1);
HXDLIN(  98)				int i = (_g1 - (int)1);
HXLINE( 100)				{
HXLINE( 100)					Float val = data->get(i);
HXDLIN( 100)					{
HXLINE( 100)						int buffer1 = buffer->byteOffset;
HXDLIN( 100)						::__hxcpp_memory_set_float(buffer->buffer->b,(buffer1 + ((i - start) * (int)4)),val);
            					}
            				}
            			}
            		}
