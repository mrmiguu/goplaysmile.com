...
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_42_dispose,"openfl.display3D.IndexBuffer3D","dispose",0xbcffb1db,"openfl.display3D.IndexBuffer3D.dispose","openfl/display3D/IndexBuffer3D.hx",42,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_53_uploadFromByteArray,"openfl.display3D.IndexBuffer3D","uploadFromByteArray",0x61713322,"openfl.display3D.IndexBuffer3D.uploadFromByteArray","openfl/display3D/IndexBuffer3D.hx",53,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_62_uploadFromTypedArray,"openfl.display3D.IndexBuffer3D","uploadFromTypedArray",0x49f635fe,"openfl.display3D.IndexBuffer3D.uploadFromTypedArray","openfl/display3D/IndexBuffer3D.hx",62,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_82_uploadFromVector,"openfl.display3D.IndexBuffer3D","uploadFromVector",0xaabe3672,"openfl.display3D.IndexBuffer3D.uploadFromVector","openfl/display3D/IndexBuffer3D.hx",82,0x3d934296)
namespace openfl{
namespace display3D{
...
HXLINE(  57)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)2);
...
HXLINE(  74)			this->_hx___context->_hx___statsAdd((int)6,(data->byteLength - this->_hx___memoryUsage));
...
HXDLIN(  90)				HX_VARI( int,i) = (_g1 - (int)1);
HXLINE(  92)				::lime::utils::ArrayBufferIO_obj::setInt16(buffer->buffer,(buffer->byteOffset + ((i - startOffset) * (int)2)),data->get(i));
            			}
            		}
