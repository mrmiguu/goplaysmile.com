...
void AbstractMaskManager_obj::__construct( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","new",0x58c36376,"openfl._internal.renderer.AbstractMaskManager.new","openfl/_internal/renderer/AbstractMaskManager.hx",24,0x8fcbf079)
            	HX_STACK_THIS(this)
...
void AbstractMaskManager_obj::pushMask( ::openfl::display::DisplayObject mask){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","pushMask",0x0e5cf110,"openfl._internal.renderer.AbstractMaskManager.pushMask","openfl/_internal/renderer/AbstractMaskManager.hx",29,0x8fcbf079)
            	HX_STACK_THIS(this)
...
Bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","pushObject",0x6e6d7fe3,"openfl._internal.renderer.AbstractMaskManager.pushObject","openfl/_internal/renderer/AbstractMaskManager.hx",36,0x8fcbf079)
            	HX_STACK_THIS(this)
...
void AbstractMaskManager_obj::pushRect( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix transform){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","pushRect",0x11adfd48,"openfl._internal.renderer.AbstractMaskManager.pushRect","openfl/_internal/renderer/AbstractMaskManager.hx",43,0x8fcbf079)
            	HX_STACK_THIS(this)
...
void AbstractMaskManager_obj::popMask(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","popMask",0x91173d33,"openfl._internal.renderer.AbstractMaskManager.popMask","openfl/_internal/renderer/AbstractMaskManager.hx",50,0x8fcbf079)
            	HX_STACK_THIS(this)
            	}
...
Bool handleScrollRect = __o_handleScrollRect.Default(true);
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","popObject",0xcd6d5ac6,"openfl._internal.renderer.AbstractMaskManager.popObject","openfl/_internal/renderer/AbstractMaskManager.hx",57,0x8fcbf079)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(handleScrollRect,"handleScrollRect")
            	}
...
void AbstractMaskManager_obj::popRect(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","popRect",0x9468496b,"openfl._internal.renderer.AbstractMaskManager.popRect","openfl/_internal/renderer/AbstractMaskManager.hx",64,0x8fcbf079)
            	HX_STACK_THIS(this)
            	}
...
void AbstractMaskManager_obj::saveState(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","saveState",0x4e70852a,"openfl._internal.renderer.AbstractMaskManager.saveState","openfl/_internal/renderer/AbstractMaskManager.hx",71,0x8fcbf079)
            	HX_STACK_THIS(this)
            	}
...
void AbstractMaskManager_obj::restoreState(){
            	HX_STACK_FRAME("openfl._internal.renderer.AbstractMaskManager","restoreState",0xcb759e0d,"openfl._internal.renderer.AbstractMaskManager.restoreState","openfl/_internal/renderer/AbstractMaskManager.hx",78,0x8fcbf079)
            	HX_STACK_THIS(this)
            	}
