...
HX_DEFINE_STACK_FRAME(_hx_pos_de41fb15b232d4db_77___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","C:\\HaxeToolkit\\haxe\\std/haxe/Log.hx",77,0x3ca487aa)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_de41fb15b232d4db_77___default_trace)
            	HX_STACK_ARG(v,"v")
...
HXLINE(  78)			HX_VARI( ::String,extra) = HX_("",00,00,00,00);
HXLINE(  79)			{
HXLINE(  79)				HX_VARI( int,_g) = (int)0;
HXDLIN(  79)				HX_VARI( ::cpp::VirtualArray,_g1) = ( (::cpp::VirtualArray)(infos->__Field(HX_("customParams",d7,51,18,ed),hx::paccDynamic)) );
HXDLIN(  79)				while((_g < _g1->get_length())){
HXLINE(  79)					HX_VARI_NAME(  ::Dynamic,v1,"v") = _g1->__get(_g);
