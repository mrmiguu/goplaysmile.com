...
HX_DEFINE_STACK_FRAME(_hx_pos_951af697d279505e_57_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",57,0x53425a8f)
HX_DEFINE_STACK_FRAME(_hx_pos_951af697d279505e_138_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",138,0x53425a8f)
HX_DEFINE_STACK_FRAME(_hx_pos_951af697d279505e_249_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",249,0x53425a8f)
HX_DEFINE_STACK_FRAME(_hx_pos_951af697d279505e_255_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",255,0x53425a8f)
namespace haxe{
namespace format{
...
HXLINE(  58)			HX_VARI( int,c) = this->str.cca(this->pos++);
...
HXLINE( 131)							goto _hx_goto_2;
            					...
            					_hx_goto_2:;
HXDLIN( 131)					HX_VARI( Float,f) = ::Std_obj::parseFloat(this->str.substr(start,(this->pos - start)));
...
HXLINE(  92)						switch((int)(this->str.cca(this->pos++))){
            							case (int)9: case (int)10: case (int)13: case (int)32: {
            							}
            							break;
            							case (int)44: {
...
HXLINE(  66)						switch((int)(this->str.cca(this->pos++))){
            							case (int)9: case (int)10: case (int)13: case (int)32: {
            							}
            							break;
            							case (int)34: {
...
HXLINE( 142)			HX_VARI( int,c) = this->str.cca(this->pos++);
...
HXLINE( 149)				{
HXLINE( 149)					HX_VARI( ::String,s) = this->str;
HXDLIN( 149)					HX_VARI(  ::Dynamic,len) = ((this->pos - start) - (int)1);
...
HXLINE( 149)						HX_VARI_NAME( ::Array< ::String >,buf1,"buf") = buf->b;
...
HXDLIN( 154)						buf->charBuf->push((int)9);
            					...
            					break;
            					case (int)117: {
HXLINE( 159)						HX_VARI(  ::Dynamic,uc) = ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + this->str.substr(this->pos,(int)4)));
...
HXLINE( 189)						 ::haxe::format::JsonParser _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 189)						_hx_tmp1->pos = (_hx_tmp1->pos + (int)4);
            					}
            					else {
HXLINE( 190)						if ((c >= (int)248)) {
HXLINE( 190)							 ::haxe::format::JsonParser _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 190)							_hx_tmp2->pos = (_hx_tmp2->pos + (int)3);
            						}
            						else {
HXLINE( 191)							if ((c >= (int)240)) {
HXLINE( 191)								 ::haxe::format::JsonParser _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 191)								_hx_tmp3->pos = (_hx_tmp3->pos + (int)2);
            							}
            							else {
...
HXLINE( 199)			return this->str.substr(start,((this->pos - start) - (int)1));
            		}
            		else {
HXLINE( 202)			{
HXLINE( 202)				HX_VARI_NAME( ::String,s1,"s") = this->str;
HXDLIN( 202)				HX_VARI_NAME(  ::Dynamic,len1,"len") = ((this->pos - start) - (int)1);
...
HXLINE( 202)					HX_VARI_NAME( ::Array< ::String >,buf2,"buf") = buf->b;
HXDLIN( 202)					buf2->push(s1.substr(start,len1));
            				}
            			}
...
HXLINE( 255)		HX_STACK_DO_THROW((((HX_("Invalid number at position ",d8,9d,6f,13) + start) + HX_(": ",a6,32,00,00)) + this->str.substr(start,(this->pos - start))));
            	}
