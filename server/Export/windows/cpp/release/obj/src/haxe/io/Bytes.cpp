...
void Bytes_obj::__construct(Int length,::Array< unsigned char > b){
            	HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","haxe/io/Bytes.hx",43,0x68bfff33)
            	HX_STACK_THIS(this)
...
Int Bytes_obj::get(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","get",0x393385b3,"haxe.io.Bytes.get","haxe/io/Bytes.hx",59,0x68bfff33)
            	HX_STACK_THIS(this)
...
void Bytes_obj::set(Int pos,Int v){
            	HX_STACK_FRAME("haxe.io.Bytes","set",0x393ca0bf,"haxe.io.Bytes.set","haxe/io/Bytes.hx",77,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
void Bytes_obj::blit(Int pos, ::haxe::io::Bytes src,Int srcpos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","haxe/io/Bytes.hx",89,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
...
void Bytes_obj::fill(Int pos,Int len,Int value){
            	HX_STACK_FRAME("haxe.io.Bytes","fill",0xd33b42c6,"haxe.io.Bytes.fill","haxe/io/Bytes.hx",136,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
HX_DEFINE_DYNAMIC_FUNC3(Bytes_obj,fill,(void))
 ...
 ::haxe::io::Bytes Bytes_obj::sub(Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","haxe/io/Bytes.hx",143,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
HXLINE( 167)		::Array< unsigned char > _hx_tmp2 = this->b->slice(pos,(pos + len));
HXDLIN( 167)		return  ::haxe::io::Bytes_obj::__new(len,_hx_tmp2);
            	}
...
Int Bytes_obj::compare( ::haxe::io::Bytes other){
            	HX_STACK_FRAME("haxe.io.Bytes","compare",0x46537042,"haxe.io.Bytes.compare","haxe/io/Bytes.hx",205,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(other,"other")
HXLINE( 205)		return ( (Int)(this->b->memcmp(other->b)) );
            	}
...
Float Bytes_obj::getDouble(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","getDouble",0xc306ed24,"haxe.io.Bytes.getDouble","haxe/io/Bytes.hx",223,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
...
Float Bytes_obj::getFloat(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","getFloat",0x2c9026e9,"haxe.io.Bytes.getFloat","haxe/io/Bytes.hx",242,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
...
void Bytes_obj::setDouble(Int pos,Float v){
            	HX_STACK_FRAME("haxe.io.Bytes","setDouble",0xa657d930,"haxe.io.Bytes.setDouble","haxe/io/Bytes.hx",262,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
void Bytes_obj::setFloat(Int pos,Float v){
            	HX_STACK_FRAME("haxe.io.Bytes","setFloat",0xdaed805d,"haxe.io.Bytes.setFloat","haxe/io/Bytes.hx",285,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
Int Bytes_obj::getUInt16(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","getUInt16",0xa94afaf2,"haxe.io.Bytes.getUInt16","haxe/io/Bytes.hx",308,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
...
void Bytes_obj::setUInt16(Int pos,Int v){
            	HX_STACK_FRAME("haxe.io.Bytes","setUInt16",0x8c9be6fe,"haxe.io.Bytes.setUInt16","haxe/io/Bytes.hx",315,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
Int Bytes_obj::getInt32(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","getInt32",0xe819f49b,"haxe.io.Bytes.getInt32","haxe/io/Bytes.hx",337,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
...
HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,getInt32,return )
 ...
 ::cpp::Int64Struct Bytes_obj::getInt64(Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","getInt64",0xe819f73a,"haxe.io.Bytes.getInt64","haxe/io/Bytes.hx",345,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
HXLINE( 345)		HX_VARI_NAME( Int,pos1,"pos") = (pos + (int)4);
HXDLIN( 345)		Int _hx_tmp = ((int)((int)((int)this->b->__get(pos1) | (int)((int)this->b->__get((pos1 + (int)1)) << (int)(int)8)) | (int)((int)this->b->__get((pos1 + (int)2)) << (int)(int)16)) | (int)((int)this->b->__get((pos1 + (int)3)) << (int)(int)24));
HXDLIN( 345)		Int _hx_tmp1 = ((int)((int)((int)this->b->__get(pos) | (int)((int)this->b->__get((pos + (int)1)) << (int)(int)8)) | (int)((int)this->b->__get((pos + (int)2)) << (int)(int)16)) | (int)((int)this->b->__get((pos + (int)3)) << (int)(int)24));
HXDLIN( 345)		return _hx_int64_make(_hx_tmp,_hx_tmp1);
            	}
...
void Bytes_obj::setInt32(Int pos,Int v){
            	HX_STACK_FRAME("haxe.io.Bytes","setInt32",0x96774e0f,"haxe.io.Bytes.setInt32","haxe/io/Bytes.hx",351,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
void Bytes_obj::setInt64(Int pos, ::cpp::Int64Struct v){
            	HX_STACK_FRAME("haxe.io.Bytes","setInt64",0x967750ae,"haxe.io.Bytes.setInt64","haxe/io/Bytes.hx",365,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
HXLINE( 366)		{
...
::String Bytes_obj::getString(Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","haxe/io/Bytes.hx",370,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
::String Bytes_obj::readString(Int pos,Int len){
            	HX_STACK_FRAME("haxe.io.Bytes","readString",0x5f58954a,"haxe.io.Bytes.readString","haxe/io/Bytes.hx",430,0x68bfff33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
::String Bytes_obj::toString(){
            	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","haxe/io/Bytes.hx",450,0x68bfff33)
            	HX_STACK_THIS(this)
...
::String Bytes_obj::toHex(){
            	HX_STACK_FRAME("haxe.io.Bytes","toHex",0x14173a7d,"haxe.io.Bytes.toHex","haxe/io/Bytes.hx",454,0x68bfff33)
            	HX_STACK_THIS(this)
HXLINE( 455)		HX_VARI(  ::StringBuf,s) =  ::StringBuf_obj::__new();
...
HXLINE( 459)				 ::Dynamic _hx_tmp = HX_("0123456789abcdef",68,7e,d5,ef).charCodeAt(i);
HXDLIN( 459)				chars->push(_hx_tmp);
            			}
            		}
HXLINE( 460)		{
...
HXLINE( 460)				HX_VARI_NAME( Int,i1,"i") = _g11++;
HXLINE( 461)				HX_VARI( Int,c) = this->b->__get(i1);
HXLINE( 462)				{
HXLINE( 462)					Int c1 = chars->__get(((int)c >> (int)(int)4));
HXDLIN( 462)					Bool _hx_tmp1 = hx::IsNull( s->charBuf );
...
HXDLIN( 463)					Bool _hx_tmp2 = hx::IsNull( s->charBuf );
...
HXLINE( 465)		Bool _hx_tmp3 = hx::IsNotNull( s->charBuf );
HXDLIN( 465)		if (_hx_tmp3) {
HXLINE( 465)			s->flush();
            		}
HXDLIN( 465)		return s->b->join(HX_("",00,00,00,00));
            	}
...
::Array< unsigned char > Bytes_obj::getData(){
            	HX_STACK_FRAME("haxe.io.Bytes","getData",0xd7d05d7d,"haxe.io.Bytes.getData","haxe/io/Bytes.hx",469,0x68bfff33)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,getData,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(Int length){
            	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","haxe/io/Bytes.hx",472,0x68bfff33)
            	HX_STACK_ARG(length,"length")
...
HXLINE( 484)		return  ::haxe::io::Bytes_obj::__new(length,a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","haxe/io/Bytes.hx",500,0x68bfff33)
            	HX_STACK_ARG(s,"s")
HXLINE( 511)		HX_VARI( ::Array< unsigned char >,a) = ::Array_obj< unsigned char >::__new();
HXLINE( 512)		::__hxcpp_bytes_of_string(a,s);
HXLINE( 513)		return  ::haxe::io::Bytes_obj::__new(a->length,a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofData(::Array< unsigned char > b){
            	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","haxe/io/Bytes.hx",571,0x68bfff33)
            	HX_STACK_ARG(b,"b")
HXLINE( 571)		return  ::haxe::io::Bytes_obj::__new(b->length,b);
            	}
...
Int Bytes_obj::fastGet(::Array< unsigned char > b,Int pos){
            	HX_STACK_FRAME("haxe.io.Bytes","fastGet",0xa10d56f7,"haxe.io.Bytes.fastGet","haxe/io/Bytes.hx",587,0x68bfff33)
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(pos,"pos")
HXLINE( 587)		return ( (Int)(_hx_array_unsafe_get(b,pos)) );
            	}
