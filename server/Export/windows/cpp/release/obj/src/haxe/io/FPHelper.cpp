...
Float FPHelper_obj::i32ToFloat(Int i){
            	HX_STACK_FRAME("haxe.io.FPHelper","i32ToFloat",0x7999b6cf,"haxe.io.FPHelper.i32ToFloat","haxe/io/FPHelper.hx",77,0x803d7f86)
            	HX_STACK_ARG(i,"i")
...
Int FPHelper_obj::floatToI32(Float f){
            	HX_STACK_FRAME("haxe.io.FPHelper","floatToI32",0xff5a7c67,"haxe.io.FPHelper.floatToI32","haxe/io/FPHelper.hx",118,0x803d7f86)
            	HX_STACK_ARG(f,"f")
...
Float FPHelper_obj::i64ToDouble(Int low,Int high){
            	HX_STACK_FRAME("haxe.io.FPHelper","i64ToDouble",0xc51d801d,"haxe.io.FPHelper.i64ToDouble","haxe/io/FPHelper.hx",172,0x803d7f86)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FPHelper_obj,i64ToDouble,return )
 ...
 ::cpp::Int64Struct FPHelper_obj::doubleToI64(Float v){
            	HX_STACK_FRAME("haxe.io.FPHelper","doubleToI64",0xe6926a85,"haxe.io.FPHelper.doubleToI64","haxe/io/FPHelper.hx",246,0x803d7f86)
            	HX_STACK_ARG(v,"v")
HXLINE( 246)		Int high = ::__hxcpp_reinterpret_float64_as_le_int32_high(v);
HXDLIN( 246)		Int low = ::__hxcpp_reinterpret_float64_as_le_int32_low(v);
HXDLIN( 246)		return _hx_int64_make(high,low);
            	}
...
{
{
            	HX_STACK_FRAME("haxe.io.FPHelper","boot",0xe0a20cc8,"haxe.io.FPHelper.boot","haxe/io/FPHelper.hx",35,0x803d7f86)
HXLINE(  35)		i64tmp = ( ::cpp::Int64Struct((int)0));
            	}
{
            	HX_STACK_FRAME("haxe.io.FPHelper","boot",0xe0a20cc8,"haxe.io.FPHelper.boot","haxe/io/FPHelper.hx",58,0x803d7f86)
