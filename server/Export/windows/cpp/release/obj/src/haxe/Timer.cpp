...
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_270___default_run,"haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","haxe/Timer.hx",270,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_286_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",286,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_308___check,"haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",308,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_241_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",241,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_237_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",237,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_255_getMS,"haxe.Timer","getMS",0xf90fafab,"haxe.Timer.getMS","haxe/Timer.hx",255,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_260_measure,"haxe.Timer","measure",0x42373f4d,"haxe.Timer.measure","haxe/Timer.hx",260,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_279_stamp,"haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",279,0x1a690682)
HX_DEFINE_STACK_FRAME(_hx_pos_102f69689d37b2bb_220_boot,"haxe.Timer","boot",0xc6bd04e3,"haxe.Timer.boot","haxe/Timer.hx",220,0x1a690682)
namespace haxe{
...
HXDLIN( 290)				HX_VARI( int,_g) = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 290)				while((_g1 < _g)){
HXLINE( 290)					_g1 = (_g1 + (int)1);
HXDLIN( 290)					HX_VARI( int,i) = (_g1 - (int)1);
...
HXLINE( 244)			f();
            	...
            	HX_STACK_ARG(f,"f")
            	HX_STACK_ARG(time,"time")
HXLINE( 239)		HX_VARI(  ::haxe::Timer,t) =  ::haxe::Timer_obj::__alloc( HX_CTX ,time);
...
HXLINE( 262)		HX_VARI( Float,t0) = ((Float)::lime::_hx_system::System_obj::getTimer() / (Float)(int)1000);
HXLINE( 263)		HX_VARI(  ::Dynamic,r) = f();
