...
void _hx_run(){
            	HX_STACK_FRAME("haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","haxe/Timer.hx",270,0x1a690682)
            	HX_STACK_THIS(this)
            	}
...
void Timer_obj::stop(){
            	HX_STACK_FRAME("haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",286,0x1a690682)
            	HX_STACK_THIS(this)
HXLINE( 286)		Bool _hx_tmp = this->mRunning;
...
HXLINE( 290)					HX_VARI( Int,i) = _g1++;
HXLINE( 292)					Bool _hx_tmp1 = hx::IsEq( ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >(),hx::ObjectPtr<OBJ_>(this) );
HXDLIN( 292)					if (_hx_tmp1) {
HXLINE( 294)						::haxe::Timer_obj::sRunningTimers[i] = null();
HXLINE( 295)						goto _hx_goto_0;
            					}
            				}
            				_hx_goto_0:;
            			}
...
void Timer_obj::_hx___check(Float inTime){
            	HX_STACK_FRAME("haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",308,0x1a690682)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(inTime,"inTime")
HXLINE( 308)		Bool _hx_tmp = (inTime >= this->mFireAt);
HXDLIN( 308)		if (_hx_tmp) {
HXLINE( 310)			hx::AddEq(this->mFireAt,this->mTime);
HXLINE( 311)			this->run();
            		}
            	}
...
::Array< ::Dynamic> Timer_obj::sRunningTimers;
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,Int time){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",241,0x1a690682)
HXLINE( 243)			t->stop();
HXLINE( 244)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))
            	...
            	HX_STACK_ARG(f,"f")
            	HX_STACK_ARG(time,"time")
HXLINE( 239)		HX_VARI(  ::haxe::Timer,t) =  ::haxe::Timer_obj::__new(time);
...
Float Timer_obj::getMS(){
            	HX_STACK_FRAME("haxe.Timer","getMS",0xf90fafab,"haxe.Timer.getMS","haxe/Timer.hx",255,0x1a690682)
...
HXLINE( 262)		Int _hx_tmp = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 262)		HX_VARI( Float,t0) = ((Float)_hx_tmp / (Float)(int)1000);
HXLINE( 263)		HX_VARI(  ::Dynamic,r) = f();
HXLINE( 264)		Int _hx_tmp1 = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 264)		::haxe::Log_obj::trace(((((Float)_hx_tmp1 / (Float)(int)1000) - t0) + HX_("s",73,00,00,00)),pos);
HXLINE( 265)		return r;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACK_FRAME("haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",279,0x1a690682)
HXLINE( 279)		Int _hx_tmp = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 279)		return ((Float)_hx_tmp / (Float)(int)1000);
            	}
...
{
{
            	HX_STACK_FRAME("haxe.Timer","boot",0xc6bd04e3,"haxe.Timer.boot","haxe/Timer.hx",220,0x1a690682)
