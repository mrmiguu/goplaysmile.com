...
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_115_toString,"haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",115,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_134_withoutDirectory,"haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",134,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",147,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_190_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",190,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_189_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",189,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_210_normalize,"haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",210,0x4f1aa280)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_262_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",262,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_287_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",287,0x4f1aa280)
HX_DEFINE_STACK_FRAME(_hx_pos_c76bafa893b9a603_301_isAbsolute,"haxe.io.Path","isAbsolute",0xb396db4a,"haxe.io.Path.isAbsolute","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",301,0x4f1aa280)
namespace haxe{
namespace io{
...
::String Path_obj::withoutDirectory(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 135)		HX_VARI(  ::haxe::io::Path,s) =  ::haxe::io::Path_obj::__alloc( HX_CTX ,path);
...
HXLINE( 190)		HX_VARI_NAME( ::Array< ::String >,paths1,"paths") = paths->filter( ::Dynamic(new _hx_Closure_0()));
HXLINE( 191)		if ((paths1->length == (int)0)) {
HXLINE( 192)			return HX_("",00,00,00,00);
            		}
HXLINE( 194)		HX_VARI( ::String,path) = paths1->__get((int)0);
HXLINE( 195)		{
HXLINE( 195)			HX_VARI( int,_g1) = (int)1;
HXDLIN( 195)			HX_VARI( int,_g) = paths1->length;
HXDLIN( 195)			while((_g1 < _g)){
HXLINE( 195)				_g1 = (_g1 + (int)1);
HXLINE( 196)				path = ::haxe::io::Path_obj::addTrailingSlash(path);
HXLINE( 197)				path = (path + paths1->__get((_g1 - (int)1)));
            			}
            		}
...
HXLINE( 213)			return HX_("/",2f,00,00,00);
            		}
HXLINE( 215)		HX_VARI( ::Array< ::String >,target) = ::Array_obj< ::String >::__new(0);
HXLINE( 217)		{
HXLINE( 217)			HX_VARI( int,_g) = (int)0;
HXDLIN( 217)			HX_VARI( ::Array< ::String >,_g1) = path.split(HX_("/",2f,00,00,00));
HXDLIN( 217)			while((_g < _g1->length)){
HXLINE( 217)				HX_VARI( ::String,token) = _g1->__get(_g);
...
HXLINE( 225)		HX_VARI( ::String,tmp) = target->join(HX_("/",2f,00,00,00));
HXLINE( 227)		 ::EReg_obj::__alloc( HX_CTX ,HX_("([^:])/+",d7,b8,64,f0),HX_("g",67,00,00,00))->replace(tmp,(HX_("$1",8d,1f,00,00) + HX_("/",2f,00,00,00)));
HXLINE( 228)		HX_VARI(  ::StringBuf,acc) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 229)		HX_VARI( bool,colon) = false;
HXLINE( 230)		HX_VARI( bool,slashes) = false;
HXLINE( 231)		{
HXLINE( 231)			HX_VARI_NAME( int,_g11,"_g1") = (int)0;
HXDLIN( 231)			HX_VARI_NAME( int,_g2,"_g") = tmp.length;
HXDLIN( 231)			while((_g11 < _g2)){
HXLINE( 231)				_g11 = (_g11 + (int)1);
HXLINE( 232)				{
HXLINE( 232)					HX_VARI_NAME(  ::Dynamic,_g21,"_g2") = tmp.charCodeAt((_g11 - (int)1));
HXDLIN( 232)					if (hx::IsNull( _g21 )) {
...
HXLINE( 244)						{
HXLINE( 244)							HX_VARI( ::String,x) = ::String::fromCharCode(_g21);
HXDLIN( 244)							if (hx::IsNotNull( acc->charBuf )) {
HXLINE( 244)								acc->flush();
            							}
HXDLIN( 244)							if (hx::IsNull( acc->b )) {
HXLINE( 244)								acc->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            							}
            							else {
HXLINE( 244)								HX_VARI_NAME( ::Array< ::String >,acc1,"acc") = acc->b;
HXDLIN( 244)								acc1->push(::Std_obj::string(x));
            							}
            						}
            					}
            					else {
HXLINE( 232)						 ::Dynamic _hx_switch_0 = _g21;
            						if (  (_hx_switch_0==(int)47) ){
HXLINE( 236)							if (!(colon)) {
...
HXLINE( 244)								{
HXLINE( 244)									HX_VARI_NAME( ::String,x1,"x") = ::String::fromCharCode(_g21);
HXDLIN( 244)									if (hx::IsNotNull( acc->charBuf )) {
HXLINE( 244)										acc->flush();
            									}
HXDLIN( 244)									if (hx::IsNull( acc->b )) {
HXLINE( 244)										acc->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            									}
            									else {
HXLINE( 244)										HX_VARI_NAME( ::Array< ::String >,acc2,"acc") = acc->b;
HXDLIN( 244)										acc2->push(::Std_obj::string(x1));
            									}
            								}
            							}
HXLINE( 236)							goto _hx_goto_10;
            						}
            						if (  (_hx_switch_0==(int)58) ){
HXLINE( 234)							{
HXLINE( 234)								if (hx::IsNotNull( acc->charBuf )) {
HXLINE( 234)									acc->flush();
            								}
HXDLIN( 234)								if (hx::IsNull( acc->b )) {
HXLINE( 234)									acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_14,1);
            								}
            								else {
...
HXDLIN( 241)									if (hx::IsNull( acc->b )) {
HXLINE( 241)										acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_15,1);
            									}
            									else {
HXLINE( 241)										acc->b->push(HX_("/",2f,00,00,00));
            									}
...
HXLINE( 244)							{
HXLINE( 244)								HX_VARI_NAME( ::String,x2,"x") = ::String::fromCharCode(_g21);
HXDLIN( 244)								if (hx::IsNotNull( acc->charBuf )) {
HXLINE( 244)									acc->flush();
            								}
HXDLIN( 244)								if (hx::IsNull( acc->b )) {
HXLINE( 244)									acc->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            								}
            								else {
HXLINE( 244)									HX_VARI_NAME( ::Array< ::String >,acc3,"acc") = acc->b;
HXDLIN( 244)									acc3->push(::Std_obj::string(x2));
            								}
            							}
            						}
            						_hx_goto_10:;
