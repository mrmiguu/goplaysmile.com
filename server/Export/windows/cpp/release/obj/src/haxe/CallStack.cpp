...
HX_DEFINE_STACK_FRAME(_hx_pos_f7127803d415e941_77_callStack,"haxe.CallStack","callStack",0xfa9165be,"haxe.CallStack.callStack","haxe/CallStack.hx",77,0xb8d73e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_f7127803d415e941_140_exceptionStack,"haxe.CallStack","exceptionStack",0xde34d005,"haxe.CallStack.exceptionStack","haxe/CallStack.hx",140,0xb8d73e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_f7127803d415e941_206_toString,"haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","haxe/CallStack.hx",206,0xb8d73e1d)
static const ::String _hx_array_data_6d544b62_4[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_DEFINE_STACK_FRAME(_hx_pos_f7127803d415e941_220_itemToString,"haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","haxe/CallStack.hx",220,0xb8d73e1d)
...
HX_DEFINE_STACK_FRAME(_hx_pos_f7127803d415e941_246_makeStack,"haxe.CallStack","makeStack",0x41ea826e,"haxe.CallStack.makeStack","haxe/CallStack.hx",246,0xb8d73e1d)
namespace haxe{
...
HXLINE( 207)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 209)		stack = stack->copy();
HXLINE( 210)		stack->reverse();
HXLINE( 212)		{
HXLINE( 212)			HX_VARI( int,_g) = (int)0;
HXDLIN( 212)			while((_g < stack->length)){
HXLINE( 212)				HX_VARI(  ::haxe::StackItem,s) = stack->__get(_g).StaticCast<  ::haxe::StackItem >();
...
HXLINE( 222)					b->b->push(HX_("a C function",f4,1b,53,cb));
            			...
            			break;
            			case (int)1: {
HXLINE( 223)				HX_VARI( ::String,m) = s->_hx_getString(0);
HXDLIN( 223)				{
HXLINE( 224)					{
...
HXLINE( 225)							HX_VARI_NAME( ::Array< ::String >,b1,"b") = b->b;
...
HXDLIN( 226)				HX_VARI_NAME(  ::haxe::StackItem,s1,"s") = s->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 226)				{
...
HXLINE( 231)							HX_VARI_NAME( ::Array< ::String >,b2,"b") = b->b;
...
HXLINE( 233)							HX_VARI_NAME( ::Array< ::String >,b3,"b") = b->b;
...
HXLINE( 234)							b->b->push(HX_(")",29,00,00,00));
            			...
            			break;
            			case (int)3: {
HXLINE( 235)				HX_VARI( ::String,meth) = s->_hx_getString(1);
HXDLIN( 235)				HX_VARI( ::String,cname) = s->_hx_getString(0);
HXDLIN( 235)				{
HXLINE( 236)					{
...
HXLINE( 236)							HX_VARI_NAME( ::Array< ::String >,b4,"b") = b->b;
...
HXLINE( 238)							HX_VARI_NAME( ::Array< ::String >,b5,"b") = b->b;
HXDLIN( 238)							b5->push(::Std_obj::string(meth));
            			...
            			break;
            			case (int)4: {
HXLINE( 239)				HX_VARI(  ::Dynamic,n) = s->_hx_getObject(0);
HXDLIN( 239)				{
HXLINE( 240)					{
...
HXLINE( 241)							HX_VARI_NAME( ::Array< ::String >,b6,"b") = b->b;
...
HXLINE( 302)							m->push(::haxe::StackItem_obj::FilePos(::haxe::StackItem_obj::Method(words->__get((int)0),words->__get((int)1)),words->__get((int)2),::Std_obj::parseInt(words->__get((int)3))));
            						}
            					}
            				}
            			}
