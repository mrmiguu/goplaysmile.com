...
void Utf8_obj::__construct( ::Dynamic size){
            	HX_STACK_FRAME("haxe.Utf8","new",0x67cc940b,"haxe.Utf8.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",31,0xf320feca)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE(  32)		this->__s = ::Array_obj< Int >::__new();
HXLINE(  33)		Bool _hx_tmp;
HXDLIN(  33)		Bool _hx_tmp1 = hx::IsNotNull( size );
...
void Utf8_obj::addChar(Int c){
            	HX_STACK_FRAME("haxe.Utf8","addChar",0x9a1816c2,"haxe.Utf8.addChar","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",38,0xf320feca)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
...
::String Utf8_obj::toString(){
            	HX_STACK_FRAME("haxe.Utf8","toString",0xb459e121,"haxe.Utf8.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Utf8.hx",42,0xf320feca)
            	HX_STACK_THIS(this)
