...
HX_DEFINE_STACK_FRAME(_hx_pos_ddaf163b228de288_8_new,"Card","new",0x0152a2e2,"Card.new","Card.hx",8,0x90a6cece)

void Card_obj::__construct(::String name, ::Dynamic f1, ::Dynamic f2, ::Dynamic f3, ::Dynamic f4, ::Dynamic f5, ::Dynamic f6){
            	HX_STACKFRAME(&_hx_pos_ddaf163b228de288_8_new)
            	HX_STACK_THIS(this)
...
bool Card_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2c9349f0;
}
...
hx::ObjectPtr< Card_obj > Card_obj::__new(::String name, ::Dynamic f1, ::Dynamic f2, ::Dynamic f3, ::Dynamic f4, ::Dynamic f5, ::Dynamic f6) {
	...
	__this->__construct(name,f1,f2,f3,f4,f5,f6);
	return __this;
}

hx::ObjectPtr< Card_obj > Card_obj::__alloc(hx::Ctx *_hx_ctx,::String name, ::Dynamic f1, ::Dynamic f2, ::Dynamic f3, ::Dynamic f4, ::Dynamic f5, ::Dynamic f6) {
