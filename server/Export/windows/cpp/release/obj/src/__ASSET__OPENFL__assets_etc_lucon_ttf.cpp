...
HX_DEFINE_STACK_FRAME(_hx_pos_033676b558109f4c_198_new,"__ASSET__OPENFL__assets_etc_lucon_ttf","new",0x52a77d8b,"__ASSET__OPENFL__assets_etc_lucon_ttf.new","DefaultAssetLibrary.hx",198,0x0fc48912)

void __ASSET__OPENFL__assets_etc_lucon_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_033676b558109f4c_198_new)
            	HX_STACK_THIS(this)
HXLINE( 198)		this->_hx___fontPath = HX_("assets/etc/lucon.ttf",8a,7b,49,6b);
HXDLIN( 198)		this->name = HX_("Lucida Console",e3,71,b4,0b);
HXDLIN( 198)		super::__construct(null());
            	}
