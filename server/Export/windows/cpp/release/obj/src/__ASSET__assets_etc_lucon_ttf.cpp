...
HX_DEFINE_STACK_FRAME(_hx_pos_dbaef8fa3ee16f7e_194_new,"__ASSET__assets_etc_lucon_ttf","new",0xa27036db,"__ASSET__assets_etc_lucon_ttf.new","DefaultAssetLibrary.hx",194,0x0fc48912)

void __ASSET__assets_etc_lucon_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_dbaef8fa3ee16f7e_194_new)
HXLINE( 194)		this->_hx___fontPath = HX_("assets/etc/lucon.ttf",8a,7b,49,6b);
HXDLIN( 194)		this->name = HX_("Lucida Console",e3,71,b4,0b);
HXDLIN( 194)		super::__construct(null());
            	}
