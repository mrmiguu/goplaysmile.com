...
void Globals_obj::__construct(){
            		...
            		void _hx_run( ::Player p){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",16,0x4ea1ef2e)
            			HX_STACK_ARG(p,"p")
HXLINE(  16)			Int _hx_tmp;
HXDLIN(  16)			Bool _hx_tmp1 = p->on((int)405);
...
HXDLIN(  16)			p->go(_hx_tmp);
            		...
            		void _hx_run( ::Player p1){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",17,0x4ea1ef2e)
            			HX_STACK_ARG(p1,"p1")
HXLINE(  17)			p1->go((int)0);
            		...
            		void _hx_run( ::Player p2){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",18,0x4ea1ef2e)
            			HX_STACK_ARG(p2,"p2")
HXLINE(  18)			p2->to(HX_("beverlyhills",65,97,b3,6a));
            		...
            		void _hx_run( ::Player p3){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",19,0x4ea1ef2e)
            			HX_STACK_ARG(p3,"p3")
HXLINE(  19)			p3->go((int)2);
            		...
            		void _hx_run( ::Player p4){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",20,0x4ea1ef2e)
            			HX_STACK_ARG(p4,"p4")
HXLINE(  20)			p4->to(HX_("beverlyhills",65,97,b3,6a));
            		...
            		void _hx_run( ::Player p5){
            			HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",21,0x4ea1ef2e)
            			HX_STACK_ARG(p5,"p5")
HXLINE(  21)			p5->go((int)3);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACK_FRAME("Globals","new",0x7f13d682,"Globals.new","Globals.hx",7,0x4ea1ef2e)
            	HX_STACK_THIS(this)
HXLINE(  15)		this->c1 =  ::Card_obj::__new(HX_("c1",6e,56,00,00), ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()), ::Dynamic(new _hx_Closure_2()), ::Dynamic(new _hx_Closure_3()), ::Dynamic(new _hx_Closure_4()), ::Dynamic(new _hx_Closure_5()));
...
HXLINE(  10)		this->players =  ::haxe::ds::ObjectMap_obj::__new();
HXLINE(   9)		this->out = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(   8)		this->t =  ::Terrain_obj::__new();
            	}
...
Dynamic Globals_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Player Globals_obj::player( ::sys::net::Socket s){
            	HX_STACK_FRAME("Globals","player",0x7eb9e67f,"Globals.player","Globals.hx",25,0x4ea1ef2e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
void Globals_obj::errSfx(){
            	HX_STACK_FRAME("Globals","errSfx",0x9854353e,"Globals.errSfx","Globals.hx",29,0x4ea1ef2e)
            	HX_STACK_THIS(this)
