...
HX_DEFINE_STACK_FRAME(_hx_pos_0f2950a35915406f_28_decodeBytes,"lime.graphics.format.JPEG","decodeBytes",0x9c51a384,"lime.graphics.format.JPEG.decodeBytes","lime/graphics/format/JPEG.hx",28,0x0d45bec8)
HX_DEFINE_STACK_FRAME(_hx_pos_0f2950a35915406f_53_decodeFile,"lime.graphics.format.JPEG","decodeFile",0xcb0bd983,"lime.graphics.format.JPEG.decodeFile","lime/graphics/format/JPEG.hx",53,0x0d45bec8)
HX_DEFINE_STACK_FRAME(_hx_pos_0f2950a35915406f_78_encode,"lime.graphics.format.JPEG","encode",0xce6c344f,"lime.graphics.format.JPEG.encode","lime/graphics/format/JPEG.hx",78,0x0d45bec8)
namespace lime{
namespace graphics{
namespace format{
...
HXLINE(  33)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN(  33)			_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
HXDLIN(  33)			this1 = _this;
            		}
            		else {
HXLINE(  33)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN(  33)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jpeg_decode_bytes(hx::DynamicPtr(bytes),decodeData,hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())))) );
            	}
...
HXLINE(  58)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN(  58)			_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
HXDLIN(  58)			this1 = _this;
            		}
            		else {
HXLINE(  58)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN(  58)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_jpeg_decode_file(path,decodeData,hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())))) );
            	}
