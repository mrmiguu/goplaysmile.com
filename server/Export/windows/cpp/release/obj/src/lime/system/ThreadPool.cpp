...
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_69_queue,"lime.system.ThreadPool","queue",0xd03ecc0f,"lime.system.ThreadPool.queue","lime/system/ThreadPool.hx",69,0x8993fbb2)
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_101_sendComplete,"lime.system.ThreadPool","sendComplete",0x5f287f63,"lime.system.ThreadPool.sendComplete","lime/system/ThreadPool.hx",101,0x8993fbb2)
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_112_sendError,"lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",112,0x8993fbb2)
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_123_sendProgress,"lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",123,0x8993fbb2)
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_135___doWork,"lime.system.ThreadPool","__doWork",0xcfdf765e,"lime.system.ThreadPool.__doWork","lime/system/ThreadPool.hx",135,0x8993fbb2)
HX_DEFINE_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_156___update,"lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",156,0x8993fbb2)
namespace lime{
...
HXLINE(  73)		this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE(  74)		this->_hx___workQueued++;
HXLINE(  76)		bool _hx_tmp;
HXDLIN(  76)		if ((this->currentThreads < this->maxThreads)) {
HXLINE(  76)			_hx_tmp = (this->currentThreads < (this->_hx___workQueued - this->_hx___workCompleted));
            		}
            		else {
...
void ThreadPool_obj::sendComplete( ::Dynamic state){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 101)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 112)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE( 123)		this->_hx___workResult->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
            	}
...
HXLINE( 137)			HX_VARI(  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage,message) = this->_hx___workIncoming->pop(true).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
...
HXLINE( 158)			HX_VARI(  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage,message) = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 160)			while(hx::IsNotNull( message )){
HXLINE( 162)				switch((int)(_hx_getEnumValueIndex(message->type))){
            					case (int)0: case (int)1: {
HXLINE( 170)						this->_hx___workCompleted++;
HXLINE( 172)						bool _hx_tmp;
HXDLIN( 172)						if ((this->currentThreads <= (this->_hx___workQueued - this->_hx___workCompleted))) {
...
HXLINE( 175)							this->_hx___workIncoming->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            						}
...
HXLINE( 201)				_hx_tmp1 = (this->minThreads <= (int)0);
            			}
            			else {
