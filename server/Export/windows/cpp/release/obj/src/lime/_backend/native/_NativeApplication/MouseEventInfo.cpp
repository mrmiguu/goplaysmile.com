...
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_887_new,"lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",887,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_902_clone,"lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",902,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_e3566ee739d748b6_887_new)
            	HX_STACK_THIS(this)
...
HXLINE( 890)		this->windowID = (int)0;
HXLINE( 891)		this->x = x;
HXLINE( 892)		this->y = y;
HXLINE( 893)		this->button = button;
HXLINE( 894)		this->movementX = movementX;
HXLINE( 895)		this->movementY = movementY;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e3566ee739d748b6_902_clone)
            	HX_STACK_THIS(this)
HXLINE( 902)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
