...
Dynamic Bytes_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::haxe::io::Bytes Bytes_Impl__obj::_new(Int length,::Array< unsigned char > bytesData){
            	HX_STACK_FRAME("lime.utils._Bytes.Bytes_Impl_","_new",0x0e8a4e50,"lime.utils._Bytes.Bytes_Impl_._new","lime/utils/Bytes.hx",18,0x9fbf972b)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(bytesData,"bytesData")
HXLINE(  18)		return  ::haxe::io::Bytes_obj::__new(length,bytesData);
            	}
...
Int Bytes_Impl__obj::fastGet(::Array< unsigned char > b,Int pos){
            	HX_STACK_FRAME("lime.utils._Bytes.Bytes_Impl_","fastGet",0xe584c5cb,"lime.utils._Bytes.Bytes_Impl_.fastGet","lime/utils/Bytes.hx",39,0x9fbf972b)
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(pos,"pos")
HXLINE(  39)		return ( (Int)(_hx_array_unsafe_get(b,pos)) );
            	}
...
HXLINE(  46)		Bool _hx_tmp = hx::IsNull( bytes );
...
HXLINE(  58)		{
HXLINE(  58)			 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_bytes_read_file(path,hx::DynamicPtr(bytes))) );
HXDLIN(  58)			Dynamic(hx::DynamicPtr(inVal));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,fromFile,return )
 ...
 ::lime::app::Future Bytes_Impl__obj::loadFromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils._Bytes.Bytes_Impl_","loadFromBytes",0x2f7a74cc,"lime.utils._Bytes.Bytes_Impl_.loadFromBytes","lime/utils/Bytes.hx",72,0x9fbf972b)
            	HX_STACK_ARG(bytes,"bytes")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,loadFromBytes,return )
 ...
 ::lime::app::Future Bytes_Impl__obj::loadFromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(  79)		HX_VARI(  ::lime::net::_HTTPRequest_lime_utils_Bytes,request) =  ::lime::net::_HTTPRequest_lime_utils_Bytes_obj::__new(null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_Impl__obj::_hx___fromNativePointer( ::Dynamic data,Int length){
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 104)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_bytes_from_data_pointer(( (Float)(data) ),length)) );
HXDLIN( 104)		HX_VARI(  ::Dynamic,bytes) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 105)		return ::lime::utils::_Bytes::Bytes_Impl__obj::_new( ::Dynamic(bytes->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(bytes->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            	}
