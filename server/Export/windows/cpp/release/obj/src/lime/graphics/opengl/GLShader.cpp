...
HX_DEFINE_STACK_FRAME(_hx_pos_411e6a8b388e8f2b_10_new,"lime.graphics.opengl.GLShader","new",0xa0326c51,"lime.graphics.opengl.GLShader.new","lime/graphics/opengl/GLShader.hx",10,0x4f56a5be)
HX_LOCAL_STACK_FRAME(_hx_pos_411e6a8b388e8f2b_15_getType,"lime.graphics.opengl.GLShader","getType",0xe5e58ae1,"lime.graphics.opengl.GLShader.getType","lime/graphics/opengl/GLShader.hx",15,0x4f56a5be)
HX_LOCAL_STACK_FRAME(_hx_pos_411e6a8b388e8f2b_22_isValid,"lime.graphics.opengl.GLShader","isValid",0x94980123,"lime.graphics.opengl.GLShader.isValid","lime/graphics/opengl/GLShader.hx",22,0x4f56a5be)
namespace lime{
namespace graphics{
namespace opengl{

void GLShader_obj::__construct(int version, ::Dynamic id){
            	HX_STACKFRAME(&_hx_pos_411e6a8b388e8f2b_10_new)
...
::String GLShader_obj::getType(){
            	HX_STACKFRAME(&_hx_pos_411e6a8b388e8f2b_15_getType)
HXLINE(  15)		return HX_("Shader",45,33,b5,51);
            	}


bool GLShader_obj::isValid(){
            	HX_STACKFRAME(&_hx_pos_411e6a8b388e8f2b_22_isValid)
HXLINE(  22)		bool _hx_tmp;
HXDLIN(  22)		if ((::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(this->id) != (int)0)) {
HXLINE(  22)			_hx_tmp = hx::IsNotNull( this->id );
            		}
            		else {
HXLINE(  22)			_hx_tmp = false;
            		}
HXDLIN(  22)		if (_hx_tmp) {
HXLINE(  22)			int _hx_tmp1 = this->version;
HXDLIN(  22)			return (_hx_tmp1 == ::lime::graphics::opengl::GL_obj::get_version());
            		}
            		else {
