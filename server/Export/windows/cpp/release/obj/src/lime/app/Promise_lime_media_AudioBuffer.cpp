...
void Promise_lime_media_AudioBuffer_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","new",0xd173472d,"lime.app.Promise_lime_media_AudioBuffer.new","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_lime_media_AudioBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::complete( ::lime::media::AudioBuffer data){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","complete",0x5205c2cc,"lime.app.Promise_lime_media_AudioBuffer.complete","lime/app/Promise.hx",28,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,complete,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","completeWith",0xa49ebaf2,"lime.app.Promise_lime_media_AudioBuffer.completeWith","lime/app/Promise.hx",54,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","error",0x642e4fd5,"lime.app.Promise_lime_media_AudioBuffer.error","lime/app/Promise.hx",66,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,error,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","progress",0x5868b9c0,"lime.app.Promise_lime_media_AudioBuffer.progress","lime/app/Promise.hx",92,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_media_AudioBuffer_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","get_isComplete",0x687fad5f,"lime.app.Promise_lime_media_AudioBuffer.get_isComplete","lime/app/Promise.hx",122,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_lime_media_AudioBuffer_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_lime_media_AudioBuffer","get_isError",0x4f805b62,"lime.app.Promise_lime_media_AudioBuffer.get_isError","lime/app/Promise.hx",129,0x10ba4f0b)
            	HX_STACK_THIS(this)
