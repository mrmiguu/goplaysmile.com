...
Dynamic CairoPattern_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic CairoPattern_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","_new",0xc71fdbd0,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_._new","lime/graphics/cairo/CairoPattern.hx",20,0x9806f3a5)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(CairoPattern_Impl__obj,addColorStopRGBA,(void))
 ...
 ::Dynamic CairoPattern_Impl__obj::createForSurface( ::Dynamic surface){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","createForSurface",0x941f592f,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_.createForSurface","lime/graphics/cairo/CairoPattern.hx",48,0x9806f3a5)
            	HX_STACK_ARG(surface,"surface")
HXLINE(  48)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_create_for_surface(hx::DynamicPtr(surface))) );
HXDLIN(  48)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CairoPattern_Impl__obj,createForSurface,return )
 ...
 ::Dynamic CairoPattern_Impl__obj::createLinear(Float x0,Float y0,Float x1,Float y1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","createLinear",0xc4d8df70,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_.createLinear","lime/graphics/cairo/CairoPattern.hx",59,0x9806f3a5)
            	HX_STACK_ARG(x0,"x0")
            	HX_STACK_ARG(y0,"y0")
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
HXLINE(  59)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_create_linear(x0,y0,x1,y1)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(CairoPattern_Impl__obj,createLinear,return )
 ...
 ::Dynamic CairoPattern_Impl__obj::createRadial(Float cx0,Float cy0,Float radius0,Float cx1,Float cy1,Float radius1){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","createRadial",0x892f4c6a,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_.createRadial","lime/graphics/cairo/CairoPattern.hx",70,0x9806f3a5)
...
HXLINE(  70)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_create_radial(cx0,cy0,radius0,cx1,cy1,radius1)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(CairoPattern_Impl__obj,createRadial,return )
 ...
 ::Dynamic CairoPattern_Impl__obj::createRGB(Float r,Float g,Float b){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","createRGB",0xccf31ca2,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_.createRGB","lime/graphics/cairo/CairoPattern.hx",81,0x9806f3a5)
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
HXLINE(  81)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_create_rgb(r,g,b)) );
HXDLIN(  81)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(CairoPattern_Impl__obj,createRGB,return )
 ...
 ::Dynamic CairoPattern_Impl__obj::createRGBA(Float r,Float g,Float b,Float a){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoPattern.CairoPattern_Impl_","createRGBA",0x87c5f15f,"lime.graphics.cairo._CairoPattern.CairoPattern_Impl_.createRGBA","lime/graphics/cairo/CairoPattern.hx",92,0x9806f3a5)
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(a,"a")
HXLINE(  92)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_create_rgba(r,g,b,a)) );
...
Int CairoPattern_Impl__obj::get_colorStopCount( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 110)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_get_color_stop_count(hx::DynamicPtr(this1))) );
            	}
...
Int CairoPattern_Impl__obj::get_extend( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 121)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_get_extend(hx::DynamicPtr(this1))) );
            	}
...
Int CairoPattern_Impl__obj::get_filter( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 143)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_get_filter(hx::DynamicPtr(this1))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(CairoPattern_Impl__obj,set_filter,return )
 ...
 ::lime::math::Matrix3 CairoPattern_Impl__obj::get_matrix( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 165)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_get_matrix(hx::DynamicPtr(this1))) );
HXDLIN( 165)		HX_VARI(  ::Dynamic,m) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 166)		return  ::lime::math::Matrix3_obj::__new( ::Dynamic(m->__Field(HX_("a",61,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("b",62,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("c",63,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("d",64,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("tx",84,65,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("ty",85,65,00,00),hx::paccDynamic)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CairoPattern_Impl__obj,get_matrix,return )
 ...
 ::lime::math::Matrix3 CairoPattern_Impl__obj::set_matrix( ::Dynamic this1, ::lime::math::Matrix3 value){
            	...
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(value,"value")
HXLINE( 177)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(this1);
HXDLIN( 177)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_pattern_set_matrix(_hx_tmp,hx::DynamicPtr(value));
