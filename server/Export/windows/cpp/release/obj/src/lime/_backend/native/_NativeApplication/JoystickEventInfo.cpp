...
Int y = __o_y.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",802,0xb13849fd)
            	HX_STACK_THIS(this)
...
Dynamic JoystickEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",816,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 816)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__new(this->type,this->id,this->index,this->value,this->x,this->y);
            	}
