...
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_57___position,"lime.text.TextLayout","__position",0x6ec769b8,"lime.text.TextLayout.__position","lime/text/TextLayout.hx",57,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_107_get_positions,"lime.text.TextLayout","get_positions",0xf2be90f2,"lime.text.TextLayout.get_positions","lime/text/TextLayout.hx",107,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_123_get_direction,"lime.text.TextLayout","get_direction",0x32acff87,"lime.text.TextLayout.get_direction","lime/text/TextLayout.hx",123,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_128_set_direction,"lime.text.TextLayout","set_direction",0x77b2e193,"lime.text.TextLayout.set_direction","lime/text/TextLayout.hx",128,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_145_set_font,"lime.text.TextLayout","set_font",0xaa861efb,"lime.text.TextLayout.set_font","lime/text/TextLayout.hx",145,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_156_get_glyphs,"lime.text.TextLayout","get_glyphs",0x9f74beff,"lime.text.TextLayout.get_glyphs","lime/text/TextLayout.hx",156,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_173_get_language,"lime.text.TextLayout","get_language",0xbdf42410,"lime.text.TextLayout.get_language","lime/text/TextLayout.hx",173,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_178_set_language,"lime.text.TextLayout","set_language",0xd2ed4784,"lime.text.TextLayout.set_language","lime/text/TextLayout.hx",178,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_197_get_script,"lime.text.TextLayout","get_script",0x387c13c3,"lime.text.TextLayout.get_script","lime/text/TextLayout.hx",197,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_202_set_script,"lime.text.TextLayout","set_script",0x3bf9b237,"lime.text.TextLayout.set_script","lime/text/TextLayout.hx",202,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_219_set_size,"lime.text.TextLayout","set_size",0xb31961ed,"lime.text.TextLayout.set_size","lime/text/TextLayout.hx",219,0x8df0119f)
HX_DEFINE_STACK_FRAME(_hx_pos_8c74d3457815e486_230_set_text,"lime.text.TextLayout","set_text",0xb3bf8dd9,"lime.text.TextLayout.set_text","lime/text/TextLayout.hx",230,0x8df0119f)
namespace lime{
namespace text{
...
HXLINE(  72)			::lime::_backend::native::NativeCFFI_obj::cffi_lime_text_layout_position(hx::DynamicPtr(this->_hx___handle),hx::DynamicPtr(this->font->src),this->size,this->text,hx::DynamicPtr(this->_hx___buffer));
...
HXLINE(  83)							advanceX1 = ((position + (int)4) > _this2->length);
            						}
            						else {
...
HXLINE(  84)							advanceY1 = ((position + (int)4) > _this3->length);
            						}
            						else {
...
HXLINE(  85)							offsetX1 = ((position + (int)4) > _this4->length);
            						}
            						else {
...
HXLINE(  86)							offsetY1 = ((position + (int)4) > _this5->length);
            						}
            						else {
...
HXLINE(  88)						this->get_positions()->push( ::lime::text::GlyphPosition_obj::__alloc( HX_CTX ,index, ::lime::math::Vector2_obj::__alloc( HX_CTX ,advanceX,advanceY), ::lime::math::Vector2_obj::__alloc( HX_CTX ,offsetX,offsetY)));
            					}
            				}
            			}
            		}
