...
void CURLEasy_obj::cleanup(Float handle){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","cleanup",0xf4922b1c,"lime.net.curl.CURLEasy.cleanup","lime/net/curl/CURLEasy.hx",22,0x6bf34539)
...
Float CURLEasy_obj::duphandle(Float handle){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","duphandle",0xc88c719f,"lime.net.curl.CURLEasy.duphandle","lime/net/curl/CURLEasy.hx",31,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
HXLINE(  31)		return ( (Float)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_duphandle(handle)) );
            	}
...
::String CURLEasy_obj::escape(Float handle,::String url,Int length){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","escape",0x85152b89,"lime.net.curl.CURLEasy.escape","lime/net/curl/CURLEasy.hx",42,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(length,"length")
HXLINE(  42)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_escape(handle,url,length)) );
HXDLIN(  42)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(CURLEasy_obj,escape,return )
 ...
 ::Dynamic CURLEasy_obj::getinfo(Float handle,Int info){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","getinfo",0x76b4dafc,"lime.net.curl.CURLEasy.getinfo","lime/net/curl/CURLEasy.hx",53,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(info,"info")
HXLINE(  53)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_getinfo(handle,info)) );
HXDLIN(  53)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Float CURLEasy_obj::init(){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","init",0x7bee9118,"lime.net.curl.CURLEasy.init","lime/net/curl/CURLEasy.hx",64,0x6bf34539)
HXLINE(  64)		return ( (Float)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_init()) );
            	}
...
Int CURLEasy_obj::pause(Float handle,Int bitMask){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","pause",0xf40fc7ee,"lime.net.curl.CURLEasy.pause","lime/net/curl/CURLEasy.hx",75,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(bitMask,"bitMask")
HXLINE(  75)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_pause(handle,bitMask)) );
            	}
...
Int CURLEasy_obj::perform(Float handle){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","perform",0xc42e0799,"lime.net.curl.CURLEasy.perform","lime/net/curl/CURLEasy.hx",86,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
HXLINE(  86)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_perform(handle)) );
            	}
...
void CURLEasy_obj::reset(Float handle){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","reset",0x1d803ac7,"lime.net.curl.CURLEasy.reset","lime/net/curl/CURLEasy.hx",108,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
...
Int CURLEasy_obj::setopt(Float handle,Int option, ::Dynamic parameter){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","setopt",0x19bf59d9,"lime.net.curl.CURLEasy.setopt","lime/net/curl/CURLEasy.hx",125,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
...
HXDLIN( 128)		if (_hx_tmp) {
            			...
            			Int _hx_run( ::Dynamic a2,Int a3,Int a4){
            				HX_STACK_FRAME("lime.net.curl.CURLEasy","setopt",0x19bf59d9,"lime.net.curl.CURLEasy.setopt","lime/net/curl/CURLEasy.hx",130,0x6bf34539)
            				HX_STACK_ARG(a2,"a2")
            				HX_STACK_ARG(a3,"a3")
            				HX_STACK_ARG(a4,"a4")
...
HXLINE( 133)		Int _hx_tmp1 = ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_setopt(handle,option,hx::DynamicPtr(parameter))) );
HXDLIN( 133)		return _hx_tmp1;
            	}
...
::String CURLEasy_obj::strerror(Int code){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","strerror",0x6e06fb7f,"lime.net.curl.CURLEasy.strerror","lime/net/curl/CURLEasy.hx",144,0x6bf34539)
            	HX_STACK_ARG(code,"code")
HXLINE( 144)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_strerror(code)) );
HXDLIN( 144)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String CURLEasy_obj::unescape(Float handle,::String url,Int inLength,Int outLength){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","unescape",0xb9ec6ca2,"lime.net.curl.CURLEasy.unescape","lime/net/curl/CURLEasy.hx",155,0x6bf34539)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(inLength,"inLength")
            	HX_STACK_ARG(outLength,"outLength")
HXLINE( 155)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_easy_unescape(handle,url,inLength,outLength)) );
HXDLIN( 155)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int CURLEasy_obj::_hx___writeCallback( ::Dynamic callback, ::Dynamic output,Int size,Int nmemb){
            	HX_STACK_FRAME("lime.net.curl.CURLEasy","__writeCallback",0x87d6499c,"lime.net.curl.CURLEasy.__writeCallback","lime/net/curl/CURLEasy.hx",163,0x6bf34539)
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(output,"output")
            	HX_STACK_ARG(size,"size")
            	HX_STACK_ARG(nmemb,"nmemb")
HXLINE( 166)		HX_VARI(  ::haxe::io::Bytes,bytes) = null();
HXLINE( 168)		Bool _hx_tmp = hx::IsNotNull( output );
HXDLIN( 168)		if (_hx_tmp) {
HXLINE( 170)			bytes =  ::haxe::io::Bytes_obj::__new( ::Dynamic(output->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(output->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            		}
