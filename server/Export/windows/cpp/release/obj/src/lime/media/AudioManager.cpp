...
HX_DEFINE_STACK_FRAME(_hx_pos_b537b97081e2aab9_27_init,"lime.media.AudioManager","init",0x83630824,"lime.media.AudioManager.init","lime/media/AudioManager.hx",27,0x63af6ea2)
HX_DEFINE_STACK_FRAME(_hx_pos_b537b97081e2aab9_77_resume,"lime.media.AudioManager","resume",0xd988a3c1,"lime.media.AudioManager.resume","lime/media/AudioManager.hx",77,0x63af6ea2)
HX_DEFINE_STACK_FRAME(_hx_pos_b537b97081e2aab9_104_shutdown,"lime.media.AudioManager","shutdown",0xb121e3aa,"lime.media.AudioManager.shutdown","lime/media/AudioManager.hx",104,0x63af6ea2)
HX_DEFINE_STACK_FRAME(_hx_pos_b537b97081e2aab9_132_suspend,"lime.media.AudioManager","suspend",0x09fdc6e8,"lime.media.AudioManager.suspend","lime/media/AudioManager.hx",132,0x63af6ea2)
namespace lime{
namespace media{
...
HXLINE(  55)				::lime::media::AudioManager_obj::context = ::lime::media::AudioContext_obj::OPENAL( ::lime::media::ALCAudioContext_obj::__alloc( HX_CTX ), ::lime::media::ALAudioContext_obj::__alloc( HX_CTX ));
HXLINE(  58)				HX_VARI(  ::Dynamic,ctx) = ::lime::media::openal::ALC_obj::createContext(::lime::media::openal::ALC_obj::openDevice(null()),null());
...
HXLINE(  79)			HX_VARI(  ::lime::media::AudioContext,_g) = ::lime::media::AudioManager_obj::context;
...
HXLINE(  88)						alc->resumeDevice(alc->getContextsDevice(currentContext));
...
HXLINE( 106)			HX_VARI(  ::lime::media::AudioContext,_g) = ::lime::media::AudioManager_obj::context;
...
void AudioManager_obj::suspend(){
            	HX_STACKFRAME(&_hx_pos_b537b97081e2aab9_132_suspend)
HXLINE( 132)		if (hx::IsNotNull( ::lime::media::AudioManager_obj::context )) {
HXLINE( 134)			HX_VARI(  ::lime::media::AudioContext,_g) = ::lime::media::AudioManager_obj::context;
HXDLIN( 134)			if ((_hx_getEnumValueIndex(_g) == (int)0)) {
...
HXLINE( 140)					if (hx::IsNotNull( currentContext )) {
HXLINE( 142)						alc->suspendContext(currentContext);
HXLINE( 144)						alc->pauseDevice(alc->getContextsDevice(currentContext));
            					}
            				}
            			}
            		}
