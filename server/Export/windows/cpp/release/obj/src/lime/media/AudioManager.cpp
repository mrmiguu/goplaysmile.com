...
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_132_suspend,"lime.media.AudioManager","suspend",0x09fdc6e8,"lime.media.AudioManager.suspend","lime/media/AudioManager.hx",132,0x63af6ea2)
namespace lime{
namespace media{
...
HXLINE( 134)			 ::lime::media::AudioContext _g = ::lime::media::AudioManager_obj::context;
HXDLIN( 134)			if ((_hx_getEnumValueIndex(_g) == (int)0)) {
HXLINE( 136)				 ::lime::media::ALAudioContext al = _g->_hx_getObject(1).StaticCast<  ::lime::media::ALAudioContext >();
HXDLIN( 136)				 ::lime::media::ALCAudioContext alc = _g->_hx_getObject(0).StaticCast<  ::lime::media::ALCAudioContext >();
HXDLIN( 136)				{
HXLINE( 138)					 ::Dynamic currentContext = alc->getCurrentContext();
HXLINE( 140)					if (hx::IsNotNull( currentContext )) {
HXLINE( 142)						alc->suspendContext(currentContext);
HXLINE( 143)						 ::Dynamic device = alc->getContextsDevice(currentContext);
