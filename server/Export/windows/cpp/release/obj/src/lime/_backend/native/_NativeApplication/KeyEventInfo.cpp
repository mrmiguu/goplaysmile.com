...
HX_DEFINE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_846_new,"lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",846,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_858_clone,"lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",858,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
HXLINE( 848)		this->type = type;
HXLINE( 849)		this->windowID = windowID;
HXLINE( 850)		this->keyCode = keyCode;
HXLINE( 851)		this->modifier = modifier;
            	}
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4be9d6956d8ea946_858_clone)
            	HX_STACK_THIS(this)
HXLINE( 858)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}
