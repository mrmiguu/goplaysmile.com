...
void Promise_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise","new",0x895fc147,"lime.app.Promise.new","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Dynamic Promise_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise Promise_obj::complete( ::Dynamic data){
            	HX_STACK_FRAME("lime.app.Promise","complete",0x51e66a72,"lime.app.Promise.complete","lime/app/Promise.hx",28,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,complete,return )
 ...
 ::lime::app::Promise Promise_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise","completeWith",0x93e32d98,"lime.app.Promise.completeWith","lime/app/Promise.hx",54,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,completeWith,return )
 ...
 ::lime::app::Promise Promise_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise","error",0x4bc1046f,"lime.app.Promise.error","lime/app/Promise.hx",66,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,error,return )
 ...
 ::lime::app::Promise Promise_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise","progress",0x58496166,"lime.app.Promise.progress","lime/app/Promise.hx",92,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise","get_isComplete",0x07c29585,"lime.app.Promise.get_isComplete","lime/app/Promise.hx",122,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise","get_isError",0x4bfb7f7c,"lime.app.Promise.get_isError","lime/app/Promise.hx",129,0x10ba4f0b)
            	HX_STACK_THIS(this)
