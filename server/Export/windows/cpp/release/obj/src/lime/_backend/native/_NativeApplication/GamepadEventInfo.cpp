...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_759_new,"lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",759,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_772_clone,"lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",772,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float value = __o_value.Default(0);
            	HX_STACKFRAME(&_hx_pos_3b7a66bddb205621_759_new)
            	HX_STACK_THIS(this)
...
HXLINE( 761)		this->type = type;
HXLINE( 762)		this->id = id;
HXLINE( 763)		this->button = button;
HXLINE( 764)		this->axis = axis;
HXLINE( 765)		this->value = value;
            	}
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3b7a66bddb205621_772_clone)
            	HX_STACK_THIS(this)
HXLINE( 772)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->value);
            	}
