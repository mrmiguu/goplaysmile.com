...
HX_DEFINE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_691_new,"lime._backend.native._NativeApplication.ApplicationEventInfo","new",0x285f59a7,"lime._backend.native._NativeApplication.ApplicationEventInfo.new","lime/_backend/native/NativeApplication.hx",691,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_701_clone,"lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",701,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e0c2b4da9d832f26_701_clone)
            	HX_STACK_THIS(this)
HXLINE( 701)		return  ::lime::_backend::native::_NativeApplication::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
