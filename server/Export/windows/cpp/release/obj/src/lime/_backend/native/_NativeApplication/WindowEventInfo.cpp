...
Int y = __o_y.Default(0);
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",1089,0xb13849fd)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< WindowEventInfo_obj > WindowEventInfo_obj::__new( ::Dynamic type,hx::Null< Int >  __o_windowID,hx::Null< Int >  __o_width,hx::Null< Int >  __o_height,hx::Null< Int >  __o_x,hx::Null< Int >  __o_y)
{
	...
	_hx_result->__construct(type,__o_windowID,__o_width,__o_height,__o_x,__o_y);
	return _hx_result;
}
...
Dynamic WindowEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1103,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1103)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__new(this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
