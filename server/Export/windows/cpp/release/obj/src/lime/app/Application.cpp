...
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_77_addModule,"lime.app.Application","addModule",0x673258c9,"lime.app.Application.addModule","lime/app/Application.hx",77,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_112_addRenderer,"lime.app.Application","addRenderer",0x0a61eaa0,"lime.app.Application.addRenderer","lime/app/Application.hx",112,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_131_create,"lime.app.Application","create",0x35e42e60,"lime.app.Application.create","lime/app/Application.hx",131,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_182_createWindow,"lime.app.Application","createWindow",0xb3683e70,"lime.app.Application.createWindow","lime/app/Application.hx",182,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_214_exec,"lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",214,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_225_onModuleExit,"lime.app.Application","onModuleExit",0x4a2a2a4d,"lime.app.Application.onModuleExit","lime/app/Application.hx",225,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_232_onWindowClose,"lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",232,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_243_removeModule,"lime.app.Application","removeModule",0x6e873a74,"lime.app.Application.removeModule","lime/app/Application.hx",243,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_255_removeWindow,"lime.app.Application","removeWindow",0x004099b8,"lime.app.Application.removeWindow","lime/app/Application.hx",255,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_284_setPreloader,"lime.app.Application","setPreloader",0xe5520ed8,"lime.app.Application.setPreloader","lime/app/Application.hx",284,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_306_get_frameRate,"lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",306,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_313_set_frameRate,"lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",313,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_320_get_preloader,"lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",320,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_327_get_renderer,"lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",327,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_334_get_renderers,"lime.app.Application","get_renderers",0x05eb56c3,"lime.app.Application.get_renderers","lime/app/Application.hx",334,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_341_get_window,"lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",341,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_348_get_windows,"lime.app.Application","get_windows",0x94992cb6,"lime.app.Application.get_windows","lime/app/Application.hx",348,0x8bc55476)
namespace lime{
namespace app{
...
HXDLIN(  84)			::Array< ::Dynamic> _g1 = this->_hx___renderers;
HXDLIN(  84)			while((_g < _g1->length)){
HXLINE(  84)				 ::lime::graphics::Renderer renderer = _g1->__get(_g).StaticCast<  ::lime::graphics::Renderer >();
...
HXLINE(  94)			int _g2 = (int)0;
HXDLIN(  94)			::Array< ::Dynamic> _g11 = this->_hx___windows;
HXDLIN(  94)			while((_g2 < _g11->length)){
HXLINE(  94)				 ::lime::ui::Window window = _g11->__get(_g2).StaticCast<  ::lime::ui::Window >();
...
HXDLIN( 116)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 116)			while((_g < _g1->length)){
HXLINE( 116)				::Dynamic module = _g1->__get(_g);
...
HXDLIN( 147)				::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN( 147)				while((_g < _g1->length)){
HXLINE( 147)					 ::Dynamic windowConfig = _g1->__get(_g);
HXDLIN( 147)					_g = (_g + (int)1);
HXLINE( 149)					 ::lime::ui::Window window =  ::lime::ui::Window_obj::__alloc( HX_CTX ,windowConfig);
HXLINE( 150)					this->createWindow(window);
            				}
            			}
...
HXDLIN( 164)					::Array< ::Dynamic> _g11 = this->modules;
HXDLIN( 164)					while((_g2 < _g11->length)){
HXLINE( 164)						::Dynamic module = _g11->__get(_g2);
...
HXDLIN( 186)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 186)			while((_g < _g1->length)){
HXLINE( 186)				::Dynamic module = _g1->__get(_g);
HXDLIN( 186)				_g = (_g + (int)1);
HXLINE( 188)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 192)		if (hx::IsNull( window->renderer )) {
HXLINE( 194)			 ::lime::graphics::Renderer renderer =  ::lime::graphics::Renderer_obj::__alloc( HX_CTX ,window);
HXLINE( 195)			this->addRenderer(renderer);
            		}
...
HXDLIN( 288)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 288)			while((_g < _g1->length)){
HXLINE( 288)				::Dynamic module = _g1->__get(_g);
