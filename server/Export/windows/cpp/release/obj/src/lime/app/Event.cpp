...
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_43_add,"lime.app.Event","add",0xaf2ee687,"lime.app.Event.add","lime/app/Event.hx",43,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_221_cancel,"lime.app.Event","cancel",0xfb4b3cd4,"lime.app.Event.cancel","lime/app/Event.hx",221,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_257_has,"lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",257,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_272_remove,"lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",272,0xbda45bec)
namespace lime{
namespace app{
...
HXDLIN( 260)			HX_VARI( ::cpp::VirtualArray,_g1) = this->_hx___listeners;
...
void Event_obj::remove( ::Dynamic listener){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 275)		HX_VARI( int,i) = this->_hx___listeners->get_length();
