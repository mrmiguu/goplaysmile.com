...
Dynamic CairoFontFace_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic CairoFontFace_Impl__obj::_new(){
            	HX_STACK_FRAME("lime.graphics.cairo._CairoFontFace.CairoFontFace_Impl_","_new",0x1006fe04,"lime.graphics.cairo._CairoFontFace.CairoFontFace_Impl_._new","lime/graphics/cairo/CairoFontFace.hx",13,0xf163eb1b)
...
HXLINE(  23)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_cairo_font_face_status(hx::DynamicPtr(this1))) );
            	}
