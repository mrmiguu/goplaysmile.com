...
HX_DEFINE_STACK_FRAME(_hx_pos_433c85aba536dbfd_10_new,"lime.graphics.opengl.GLFramebuffer","new",0x1e731865,"lime.graphics.opengl.GLFramebuffer.new","lime/graphics/opengl/GLFramebuffer.hx",10,0x2d1110cc)
HX_DEFINE_STACK_FRAME(_hx_pos_433c85aba536dbfd_15_getType,"lime.graphics.opengl.GLFramebuffer","getType",0xf3efd0f5,"lime.graphics.opengl.GLFramebuffer.getType","lime/graphics/opengl/GLFramebuffer.hx",15,0x2d1110cc)
namespace lime{
namespace graphics{
namespace opengl{

void GLFramebuffer_obj::__construct(int version, ::Dynamic id){
            	HX_STACKFRAME(&_hx_pos_433c85aba536dbfd_10_new)
            	HX_STACK_THIS(this)
...
::String GLFramebuffer_obj::getType(){
            	HX_STACKFRAME(&_hx_pos_433c85aba536dbfd_15_getType)
            	HX_STACK_THIS(this)
