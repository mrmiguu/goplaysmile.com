...
void _Event_Float_Float_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","new",0xa66d9f8a,"lime.app._Event_Float_Float_Void.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","add",0xa663c14b,"lime.app._Event_Float_Float_Void.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_Float_Float_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","cancel",0x16a87490,"lime.app._Event_Float_Float_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_Float_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","has",0xa6690e84,"lime.app._Event_Float_Float_Void.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void _Event_Float_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","remove",0x62fd235a,"lime.app._Event_Float_Float_Void.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_Float_Float_Void_obj::dispatch(Float a,Float a1){
            	HX_STACK_FRAME("lime.app._Event_Float_Float_Void","dispatch",0x6858c750,"lime.app._Event_Float_Float_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(a1,"a1")
