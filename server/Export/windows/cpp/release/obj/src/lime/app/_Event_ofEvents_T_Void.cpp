...
void _Event_ofEvents_T_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","new",0xde11e822,"lime.app._Event_ofEvents_T_Void.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","add",0xde0809e3,"lime.app._Event_ofEvents_T_Void.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_ofEvents_T_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","cancel",0x39599af8,"lime.app._Event_ofEvents_T_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_ofEvents_T_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","has",0xde0d571c,"lime.app._Event_ofEvents_T_Void.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void _Event_ofEvents_T_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","remove",0x85ae49c2,"lime.app._Event_ofEvents_T_Void.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_ofEvents_T_Void_obj::dispatch( ::Dynamic a){
            	HX_STACK_FRAME("lime.app._Event_ofEvents_T_Void","dispatch",0x766e57b8,"lime.app._Event_ofEvents_T_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
