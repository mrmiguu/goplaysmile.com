...
HX_DEFINE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_724_new,"lime._backend.native._NativeApplication.DropEventInfo","new",0x5891dece,"lime._backend.native._NativeApplication.DropEventInfo.new","lime/_backend/native/NativeApplication.hx",724,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_734_clone,"lime._backend.native._NativeApplication.DropEventInfo","clone",0xb714194b,"lime._backend.native._NativeApplication.DropEventInfo.clone","lime/_backend/native/NativeApplication.hx",734,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void DropEventInfo_obj::__construct( ::Dynamic type,::String file){
            	HX_STACKFRAME(&_hx_pos_cc1242aa9b04079d_724_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(file,"file")
HXLINE( 726)		this->type = type;
HXLINE( 727)		this->file = file;
            	}
...
bool DropEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::DropEventInfo DropEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cc1242aa9b04079d_734_clone)
            	HX_STACK_THIS(this)
HXLINE( 734)		return  ::lime::_backend::native::_NativeApplication::DropEventInfo_obj::__alloc( HX_CTX ,this->type,this->file);
            	}
