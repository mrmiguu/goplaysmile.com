...
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_42_clone,"lime.math.Rectangle","clone",0x93be1911,"lime.math.Rectangle.clone","lime/math/Rectangle.hx",42,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_49_contains,"lime.math.Rectangle","contains",0xf10bdceb,"lime.math.Rectangle.contains","lime/math/Rectangle.hx",49,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_56_containsPoint,"lime.math.Rectangle","containsPoint",0x3a119365,"lime.math.Rectangle.containsPoint","lime/math/Rectangle.hx",56,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_63_containsRect,"lime.math.Rectangle","containsRect",0x7fd4a7af,"lime.math.Rectangle.containsRect","lime/math/Rectangle.hx",63,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_76_copyFrom,"lime.math.Rectangle","copyFrom",0x8cf18e8b,"lime.math.Rectangle.copyFrom","lime/math/Rectangle.hx",76,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_88_equals,"lime.math.Rectangle","equals",0x643ce60b,"lime.math.Rectangle.equals","lime/math/Rectangle.hx",88,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_93_inflate,"lime.math.Rectangle","inflate",0x288a773b,"lime.math.Rectangle.inflate","lime/math/Rectangle.hx",93,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_103_inflatePoint,"lime.math.Rectangle","inflatePoint",0x0bf19715,"lime.math.Rectangle.inflatePoint","lime/math/Rectangle.hx",103,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_108_intersection,"lime.math.Rectangle","intersection",0x62197b15,"lime.math.Rectangle.intersection","lime/math/Rectangle.hx",108,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_133_intersects,"lime.math.Rectangle","intersects",0x4fbb9080,"lime.math.Rectangle.intersects","lime/math/Rectangle.hx",133,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_154_isEmpty,"lime.math.Rectangle","isEmpty",0x28ceb8f7,"lime.math.Rectangle.isEmpty","lime/math/Rectangle.hx",154,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_159_offset,"lime.math.Rectangle","offset",0x04898f5f,"lime.math.Rectangle.offset","lime/math/Rectangle.hx",159,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_167_offsetPoint,"lime.math.Rectangle","offsetPoint",0x49147c71,"lime.math.Rectangle.offsetPoint","lime/math/Rectangle.hx",167,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_177_setEmpty,"lime.math.Rectangle","setEmpty",0x429f2657,"lime.math.Rectangle.setEmpty","lime/math/Rectangle.hx",177,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_182_setTo,"lime.math.Rectangle","setTo",0xc58a9771,"lime.math.Rectangle.setTo","lime/math/Rectangle.hx",182,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_192_transform,"lime.math.Rectangle","transform",0x7f751d20,"lime.math.Rectangle.transform","lime/math/Rectangle.hx",192,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_228_union,"lime.math.Rectangle","union",0xf2426ac3,"lime.math.Rectangle.union","lime/math/Rectangle.hx",228,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_250___contract,"lime.math.Rectangle","__contract",0x46ba1ffe,"lime.math.Rectangle.__contract","lime/math/Rectangle.hx",250,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_269___expand,"lime.math.Rectangle","__expand",0x3132dc46,"lime.math.Rectangle.__expand","lime/math/Rectangle.hx",269,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_297___toFlashRectangle,"lime.math.Rectangle","__toFlashRectangle",0x525ed026,"lime.math.Rectangle.__toFlashRectangle","lime/math/Rectangle.hx",297,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_310_get_bottom,"lime.math.Rectangle","get_bottom",0xc1d02480,"lime.math.Rectangle.get_bottom","lime/math/Rectangle.hx",310,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_311_set_bottom,"lime.math.Rectangle","set_bottom",0xc54dc2f4,"lime.math.Rectangle.set_bottom","lime/math/Rectangle.hx",311,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_312_get_bottomRight,"lime.math.Rectangle","get_bottomRight",0x2f6d073c,"lime.math.Rectangle.get_bottomRight","lime/math/Rectangle.hx",312,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_313_set_bottomRight,"lime.math.Rectangle","set_bottomRight",0x2b388448,"lime.math.Rectangle.set_bottomRight","lime/math/Rectangle.hx",313,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_314_get_left,"lime.math.Rectangle","get_left",0x8bfb465c,"lime.math.Rectangle.get_left","lime/math/Rectangle.hx",314,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_315_set_left,"lime.math.Rectangle","set_left",0x3a589fd0,"lime.math.Rectangle.set_left","lime/math/Rectangle.hx",315,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_316_get_right,"lime.math.Rectangle","get_right",0x66ef57e7,"lime.math.Rectangle.get_right","lime/math/Rectangle.hx",316,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_317_set_right,"lime.math.Rectangle","set_right",0x4a4043f3,"lime.math.Rectangle.set_right","lime/math/Rectangle.hx",317,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_318_get_size,"lime.math.Rectangle","get_size",0x909edf16,"lime.math.Rectangle.get_size","lime/math/Rectangle.hx",318,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_319_set_size,"lime.math.Rectangle","set_size",0x3efc388a,"lime.math.Rectangle.set_size","lime/math/Rectangle.hx",319,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_320_get_top,"lime.math.Rectangle","get_top",0x433c09e0,"lime.math.Rectangle.get_top","lime/math/Rectangle.hx",320,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_321_set_top,"lime.math.Rectangle","set_top",0x363d9aec,"lime.math.Rectangle.set_top","lime/math/Rectangle.hx",321,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_322_get_topLeft,"lime.math.Rectangle","get_topLeft",0x58bfae07,"lime.math.Rectangle.get_topLeft","lime/math/Rectangle.hx",322,0xce0be93c)
HX_DEFINE_STACK_FRAME(_hx_pos_1237f756a3e4c0a2_323_set_topLeft,"lime.math.Rectangle","set_topLeft",0x632cb513,"lime.math.Rectangle.set_topLeft","lime/math/Rectangle.hx",323,0xce0be93c)
namespace lime{
namespace math{
...
HXLINE(  65)				_hx_tmp1 = (rect->get_right() < this->get_right());
            			}
            			else {
HXLINE(  65)				_hx_tmp1 = false;
            			}
HXDLIN(  65)			if (_hx_tmp1) {
HXLINE(  65)				return (rect->get_bottom() < this->get_bottom());
            			}
            			else {
...
HXLINE(  69)				_hx_tmp4 = (rect->y >= this->y);
            			}
            			else {
HXLINE(  69)				_hx_tmp4 = false;
            			}
HXDLIN(  69)			if (_hx_tmp4) {
HXLINE(  69)				_hx_tmp3 = (rect->get_right() <= this->get_right());
            			}
            			else {
HXLINE(  69)				_hx_tmp3 = false;
            			}
HXDLIN(  69)			if (_hx_tmp3) {
HXLINE(  69)				return (rect->get_bottom() <= this->get_bottom());
            			}
            			else {
...
HXDLIN( 111)		if ((this->get_right() > toIntersect->get_right())) {
...
HXDLIN( 120)		if ((this->get_bottom() > toIntersect->get_bottom())) {
...
HXDLIN( 145)		if ((this->get_bottom() > toIntersect->get_bottom())) {
...
HXLINE( 202)		if ((tx < tx0)) {
HXLINE( 202)			tx0 = tx;
            		}
HXLINE( 203)		if ((ty < ty0)) {
HXLINE( 203)			ty0 = ty;
            		}
HXLINE( 204)		if ((tx > tx1)) {
HXLINE( 204)			tx1 = tx;
            		}
HXLINE( 205)		if ((ty > ty1)) {
HXLINE( 205)			ty1 = ty;
            		}
HXLINE( 207)		tx = ((m->a * (this->x + this->width)) + (m->c * (this->y + this->height)));
HXLINE( 208)		ty = ((m->b * (this->x + this->width)) + (m->d * (this->y + this->height)));
HXLINE( 210)		if ((tx < tx0)) {
HXLINE( 210)			tx0 = tx;
            		}
HXLINE( 211)		if ((ty < ty0)) {
HXLINE( 211)			ty0 = ty;
            		}
HXLINE( 212)		if ((tx > tx1)) {
HXLINE( 212)			tx1 = tx;
            		}
HXLINE( 213)		if ((ty > ty1)) {
HXLINE( 213)			ty1 = ty;
            		}
HXLINE( 215)		tx = ((m->a * this->x) + (m->c * (this->y + this->height)));
HXLINE( 216)		ty = ((m->b * this->x) + (m->d * (this->y + this->height)));
HXLINE( 218)		if ((tx < tx0)) {
HXLINE( 218)			tx0 = tx;
            		}
HXLINE( 219)		if ((ty < ty0)) {
HXLINE( 219)			ty0 = ty;
            		}
HXLINE( 220)		if ((tx > tx1)) {
HXLINE( 220)			tx1 = tx;
            		}
HXLINE( 221)		if ((ty > ty1)) {
HXLINE( 221)			ty1 = ty;
            		}
HXLINE( 223)		return  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,(tx0 + m->tx),(ty0 + m->ty),(tx1 - tx0),(ty1 - ty0));
            	}
...
HXDLIN( 241)		if ((this->get_right() < toUnion->get_right())) {
...
HXDLIN( 243)		if ((this->get_bottom() < toUnion->get_bottom())) {
...
HXLINE( 263)		if ((this->get_right() > (x + width))) {
HXLINE( 263)			this->width = ((x + width) - this->x);
            		}
HXLINE( 264)		if ((this->get_bottom() > (y + height))) {
...
HX_DEFINE_DYNAMIC_FUNC1(Rectangle_obj,set_bottom,return )
 ...
 ::lime::math::Vector2 Rectangle_obj::get_bottomRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 312)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(this->x + this->width),(this->y + this->height));
            	}
