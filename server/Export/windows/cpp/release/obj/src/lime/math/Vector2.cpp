...
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_32_add,"lime.math.Vector2","add",0xaee9e5f5,"lime.math.Vector2.add","lime/math/Vector2.hx",32,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_39_clone,"lime.math.Vector2","clone",0xd5c6a431,"lime.math.Vector2.clone","lime/math/Vector2.hx",39,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_55_equals,"lime.math.Vector2","equals",0xe9ae16eb,"lime.math.Vector2.equals","lime/math/Vector2.hx",55,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_69_normalize,"lime.math.Vector2","normalize",0xeaffc261,"lime.math.Vector2.normalize","lime/math/Vector2.hx",69,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_84_offset,"lime.math.Vector2","offset",0x89fac03f,"lime.math.Vector2.offset","lime/math/Vector2.hx",84,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_99_setTo,"lime.math.Vector2","setTo",0x07932291,"lime.math.Vector2.setTo","lime/math/Vector2.hx",99,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_108_subtract,"lime.math.Vector2","subtract",0x656920c0,"lime.math.Vector2.subtract","lime/math/Vector2.hx",108,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_118___toFlashPoint,"lime.math.Vector2","__toFlashPoint",0xf695b9a7,"lime.math.Vector2.__toFlashPoint","lime/math/Vector2.hx",118,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_133_get_length,"lime.math.Vector2","get_length",0xc2e9f35b,"lime.math.Vector2.get_length","lime/math/Vector2.hx",133,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_44_distance,"lime.math.Vector2","distance",0xd9513ee1,"lime.math.Vector2.distance","lime/math/Vector2.hx",44,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_62_interpolate,"lime.math.Vector2","interpolate",0xdb68bc95,"lime.math.Vector2.interpolate","lime/math/Vector2.hx",62,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_94_polar,"lime.math.Vector2","polar",0x53f58092,"lime.math.Vector2.polar","lime/math/Vector2.hx",94,0x7105521c)
namespace lime{
namespace math{
...
bool Vector2_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::math::Vector2 Vector2_obj::add( ::lime::math::Vector2 v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  32)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(v->x + this->x),(v->y + this->y));
            	}
...
HXLINE(  75)			HX_VARI( Float,norm) = ((Float)thickness / (Float)::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y))));
HXLINE(  76)			 ::lime::math::Vector2 _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  76)			_hx_tmp1->x = (_hx_tmp1->x * norm);
HXLINE(  77)			 ::lime::math::Vector2 _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  77)			_hx_tmp2->y = (_hx_tmp2->y * norm);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,setTo,(void))
 ...
 ::lime::math::Vector2 Vector2_obj::subtract( ::lime::math::Vector2 v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 108)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(this->x - v->x),(this->y - v->y));
            	}
...
Float Vector2_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 133)		return ::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y)));
            	}
...
HXLINE(  46)		HX_VARI( Float,dx) = (pt1->x - pt2->x);
HXLINE(  47)		HX_VARI( Float,dy) = (pt1->y - pt2->y);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,distance,return )
 ...
 ::lime::math::Vector2 Vector2_obj::interpolate( ::lime::math::Vector2 pt1, ::lime::math::Vector2 pt2,Float f){
            	...
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  62)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
HXLINE(  94)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(len * ::Math_obj::cos(angle)),(len * ::Math_obj::sin(angle)));
            	}
