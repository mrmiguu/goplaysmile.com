...
HX_DEFINE_STACK_FRAME(_hx_pos_cf7dae7cab1a2f06_160_load,"lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",160,0x339db723)
HX_DEFINE_STACK_FRAME(_hx_pos_cf7dae7cab1a2f06_146_load,"lime.net._HTTPRequest_String","load",0xabac7a96,"lime.net._HTTPRequest_String.load","lime/net/HTTPRequest.hx",146,0x339db723)
namespace lime{
namespace net{
...
HXLINE( 163)			promise->complete(_gthis->responseData);
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uri,"uri")
HXLINE( 146)		HX_VARI(  ::lime::net::_HTTPRequest_String,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 148)		if (hx::IsNotNull( uri )) {
HXLINE( 150)			this->uri = uri;
            		}
HXLINE( 154)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 155)		HX_VARI(  ::lime::app::Future,future) = this->backend->loadText(this->uri);
