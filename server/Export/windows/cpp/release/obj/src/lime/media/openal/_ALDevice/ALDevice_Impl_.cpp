...
Dynamic ALDevice_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic ALDevice_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.media.openal._ALDevice.ALDevice_Impl_","_new",0xc749fd0a,"lime.media.openal._ALDevice.ALDevice_Impl_._new","lime/media/openal/ALDevice.hx",13,0x64bc9f68)
