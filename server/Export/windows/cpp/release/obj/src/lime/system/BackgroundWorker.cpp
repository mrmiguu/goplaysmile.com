...
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_49_cancel,"lime.system.BackgroundWorker","cancel",0x890a1736,"lime.system.BackgroundWorker.cancel","lime/system/BackgroundWorker.hx",49,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_62_run,"lime.system.BackgroundWorker","run",0x36e7900f,"lime.system.BackgroundWorker.run","lime/system/BackgroundWorker.hx",62,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_84_sendComplete,"lime.system.BackgroundWorker","sendComplete",0x4fa2f0dd,"lime.system.BackgroundWorker.sendComplete","lime/system/BackgroundWorker.hx",84,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_107_sendError,"lime.system.BackgroundWorker","sendError",0xa2871d24,"lime.system.BackgroundWorker.sendError","lime/system/BackgroundWorker.hx",107,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_132_sendProgress,"lime.system.BackgroundWorker","sendProgress",0x5605e7d1,"lime.system.BackgroundWorker.sendProgress","lime/system/BackgroundWorker.hx",132,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_149___doWork,"lime.system.BackgroundWorker","__doWork",0x193122d8,"lime.system.BackgroundWorker.__doWork","lime/system/BackgroundWorker.hx",149,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_169___update,"lime.system.BackgroundWorker","__update",0x813601e5,"lime.system.BackgroundWorker.__update","lime/system/BackgroundWorker.hx",169,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_24_boot,"lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",24,0x4a0958ac)
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_25_boot,"lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",25,0x4a0958ac)
namespace lime{
...
void BackgroundWorker_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  31)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  30)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  29)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
            	}
...
bool BackgroundWorker_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x118c8adc;
}

void BackgroundWorker_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_49_cancel)
            	HX_STACK_THIS(this)
...
void BackgroundWorker_obj::run( ::Dynamic message){
            	HX_GC_STACKFRAME(&_hx_pos_c68e02a08e78766b_62_run)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE(  64)		this->canceled = false;
HXLINE(  65)		this->completed = false;
HXLINE(  66)		this->_hx___runMessage = message;
HXLINE(  70)		this->_hx___messageQueue =  ::cpp::vm::Deque_obj::__alloc( HX_CTX );
...
void BackgroundWorker_obj::sendComplete( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_84_sendComplete)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
...
void BackgroundWorker_obj::sendError( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_107_sendError)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
...
void BackgroundWorker_obj::sendProgress( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_132_sendProgress)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
...
void BackgroundWorker_obj::_hx___doWork(){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_149___doWork)
            	HX_STACK_THIS(this)
...
void BackgroundWorker_obj::_hx___update(int deltaTime){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_169___update)
            	HX_STACK_THIS(this)
...
HXLINE( 181)				if (!(this->canceled)) {
HXLINE( 183)					this->canceled = true;
HXLINE( 184)					 ::lime::app::_Event_Dynamic_Void _hx_tmp = this->onError;
HXDLIN( 184)					_hx_tmp->dispatch(this->_hx___messageQueue->pop(false));
            				}
            			}
            			else {
...
HXLINE( 192)					if (!(this->canceled)) {
HXLINE( 194)						this->canceled = true;
HXLINE( 195)						 ::lime::app::_Event_Dynamic_Void _hx_tmp1 = this->onComplete;
HXDLIN( 195)						_hx_tmp1->dispatch(this->_hx___messageQueue->pop(false));
            					}
            				}
            				else {
HXLINE( 201)					if (!(this->canceled)) {
...
{
	hx::Object *dummy = new BackgroundWorker_obj;
	BackgroundWorker_obj::_hx_vtable = *(void **)dummy;
...
{
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_25_boot)
