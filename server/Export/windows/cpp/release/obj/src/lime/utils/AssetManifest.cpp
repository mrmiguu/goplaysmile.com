...
void AssetManifest_obj::__construct(){
            	HX_STACK_FRAME("lime.utils.AssetManifest","new",0x762e683b,"lime.utils.AssetManifest.new","lime/utils/AssetManifest.hx",30,0x0cdd5257)
            	HX_STACK_THIS(this)
...
::String AssetManifest_obj::serialize(){
            	HX_STACK_FRAME("lime.utils.AssetManifest","serialize",0x0634cbfb,"lime.utils.AssetManifest.serialize","lime/utils/AssetManifest.hx",105,0x0cdd5257)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(AssetManifest_obj,serialize,return )
 ...
 ::lime::utils::AssetManifest AssetManifest_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.AssetManifest","fromBytes",0x836360bc,"lime.utils.AssetManifest.fromBytes","lime/utils/AssetManifest.hx",42,0x0cdd5257)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  42)		Bool _hx_tmp = hx::IsNotNull( bytes );
HXDLIN(  42)		if (_hx_tmp) {
HXLINE(  44)			::String _hx_tmp1 = bytes->getString((int)0,bytes->length);
HXDLIN(  44)			return ::lime::utils::AssetManifest_obj::parse(_hx_tmp1);
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AssetManifest_obj,fromBytes,return )
 ...
 ::lime::utils::AssetManifest AssetManifest_obj::fromFile(::String path){
            	HX_STACK_FRAME("lime.utils.AssetManifest","fromFile",0x2911ab4b,"lime.utils.AssetManifest.fromFile","lime/utils/AssetManifest.hx",57,0x0cdd5257)
            	HX_STACK_ARG(path,"path")
HXLINE(  57)		 ::haxe::io::Bytes _hx_tmp = ::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path);
HXDLIN(  57)		return ::lime::utils::AssetManifest_obj::fromBytes(_hx_tmp);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AssetManifest_obj,fromFile,return )
 ...
 ::lime::app::Future AssetManifest_obj::loadFromBytes( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.AssetManifest","loadFromBytes",0x6e69db36,"lime.utils.AssetManifest.loadFromBytes","lime/utils/AssetManifest.hx",64,0x0cdd5257)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  64)		 ::lime::utils::AssetManifest _hx_tmp = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXDLIN(  64)		return ::lime::app::Future_obj::withValue(_hx_tmp);
            	}
 ...
 ::lime::app::Future AssetManifest_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes bytes){
            			HX_STACK_FRAME("lime.utils.AssetManifest","loadFromFile",0xc63f9e11,"lime.utils.AssetManifest.loadFromFile","lime/utils/AssetManifest.hx",73,0x0cdd5257)
            			HX_STACK_ARG(bytes,"bytes")
HXLINE(  73)			 ::lime::utils::AssetManifest _hx_tmp = ::lime::utils::AssetManifest_obj::fromBytes(bytes);
HXDLIN(  73)			return ::lime::app::Future_obj::withValue(_hx_tmp);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACK_FRAME("lime.utils.AssetManifest","loadFromFile",0xc63f9e11,"lime.utils.AssetManifest.loadFromFile","lime/utils/AssetManifest.hx",71,0x0cdd5257)
            	HX_STACK_ARG(path,"path")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AssetManifest_obj,loadFromFile,return )
 ...
 ::lime::utils::AssetManifest AssetManifest_obj::parse(::String data){
            	HX_STACK_FRAME("lime.utils.AssetManifest","parse",0x50ea14ce,"lime.utils.AssetManifest.parse","lime/utils/AssetManifest.hx",80,0x0cdd5257)
            	HX_STACK_ARG(data,"data")
HXLINE(  82)		Bool _hx_tmp;
HXDLIN(  82)		Bool _hx_tmp1 = hx::IsNotNull( data );
...
HXLINE(  86)		HX_VARI(  ::Dynamic,manifestData) =  ::haxe::format::JsonParser_obj::__new(data)->parseRec();
HXLINE(  87)		HX_VARI(  ::lime::utils::AssetManifest,manifest) =  ::lime::utils::AssetManifest_obj::__new();
...
HXLINE(  92)		manifest->assets = ::haxe::Unserializer_obj::run( ::Dynamic(manifestData->__Field(HX_("assets",83,48,03,4c),hx::paccDynamic)));
