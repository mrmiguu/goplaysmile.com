...
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_33_getSensors,"lime.system.Sensor","getSensors",0xecc219d1,"lime.system.Sensor.getSensors","lime/system/Sensor.hx",33,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_58_registerSensor,"lime.system.Sensor","registerSensor",0x90f30acb,"lime.system.Sensor.registerSensor","lime/system/Sensor.hx",58,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_15_boot,"lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",15,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_16_boot,"lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",16,0x7b4cf9be)
namespace lime{
...
void Sensor_obj::registerSensor( ::lime::_hx_system::SensorType type,int id){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(id,"id")
HXLINE(  60)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) =  ::lime::_hx_system::Sensor_obj::__alloc( HX_CTX ,type,id);
