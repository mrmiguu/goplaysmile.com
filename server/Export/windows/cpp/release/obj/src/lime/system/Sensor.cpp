...
void Sensor_obj::__construct(::hx::EnumBase type,Int id){
            	HX_STACK_FRAME("lime.system.Sensor","new",0xd4cfafd2,"lime.system.Sensor.new","lime/system/Sensor.hx",12,0x7b4cf9be)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(id,"id")
HXLINE(  19)		this->onUpdate =  ::lime::app::_Event_Float_Float_Float_Void_obj::__new();
...
::Array< ::Dynamic> Sensor_obj::getSensors(::hx::EnumBase type){
            	HX_STACK_FRAME("lime.system.Sensor","getSensors",0xecc219d1,"lime.system.Sensor.getSensors","lime/system/Sensor.hx",33,0x7b4cf9be)
            	HX_STACK_ARG(type,"type")
HXLINE(  33)		Bool _hx_tmp = hx::IsNull( type );
HXDLIN(  33)		if (_hx_tmp) {
HXLINE(  35)			return ::lime::_hx_system::Sensor_obj::sensors->copy();
            		}
            		else {
HXLINE(  39)			HX_VARI( ::Array< ::Dynamic>,result) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  41)			{
HXLINE(  41)				HX_VARI( Int,_g) = (int)0;
HXDLIN(  41)				HX_VARI( ::Array< ::Dynamic>,_g1) = ::lime::_hx_system::Sensor_obj::sensors;
HXDLIN(  41)				while((_g < _g1->length)){
HXLINE(  41)					HX_VARI(  ::lime::_hx_system::Sensor,sensor) = _g1->__get(_g).StaticCast<  ::lime::_hx_system::Sensor >();
HXDLIN(  41)					++_g;
...
void Sensor_obj::registerSensor(::hx::EnumBase type,Int id){
            	HX_STACK_FRAME("lime.system.Sensor","registerSensor",0x90f30acb,"lime.system.Sensor.registerSensor","lime/system/Sensor.hx",58,0x7b4cf9be)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(id,"id")
HXLINE(  60)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) =  ::lime::_hx_system::Sensor_obj::__new(type,id);
...
{
{
            	HX_STACK_FRAME("lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",15,0x7b4cf9be)
HXLINE(  15)		sensorByID =  ::haxe::ds::IntMap_obj::__new();
            	}
{
            	HX_STACK_FRAME("lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",16,0x7b4cf9be)
