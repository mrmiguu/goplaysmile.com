...
HX_DEFINE_STACK_FRAME(_hx_pos_9902e55c2a6c6eb8_53_create,"lime._backend.native.NativeRenderer","create",0x10556119,"lime._backend.native.NativeRenderer.create","lime/_backend/native/NativeRenderer.hx",53,0x398cc96c)
HX_DEFINE_STACK_FRAME(_hx_pos_9902e55c2a6c6eb8_104_dispatch,"lime._backend.native.NativeRenderer","dispatch",0xcbb24a17,"lime._backend.native.NativeRenderer.dispatch","lime/_backend/native/NativeRenderer.hx",104,0x398cc96c)
HX_DEFINE_STACK_FRAME(_hx_pos_9902e55c2a6c6eb8_111_flip,"lime._backend.native.NativeRenderer","flip",0x29ba5b8a,"lime._backend.native.NativeRenderer.flip","lime/_backend/native/NativeRenderer.hx",111,0x398cc96c)
HX_DEFINE_STACK_FRAME(_hx_pos_9902e55c2a6c6eb8_133_readPixels,"lime._backend.native.NativeRenderer","readPixels",0x008f9fc0,"lime._backend.native.NativeRenderer.readPixels","lime/_backend/native/NativeRenderer.hx",133,0x398cc96c)
HX_DEFINE_STACK_FRAME(_hx_pos_9902e55c2a6c6eb8_160_render,"lime._backend.native.NativeRenderer","render",0x996f6573,"lime._backend.native.NativeRenderer.render","lime/_backend/native/NativeRenderer.hx",160,0x398cc96c)
namespace lime{
namespace _backend{
namespace native{
...
HXLINE(  70)		if ((( (::String)(( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_renderer_get_type(hx::DynamicPtr(this->handle))) )) ) == HX_("opengl",6f,64,94,21))) {
HXLINE(  74)			HX_VARI(  ::lime::_backend::native::NativeGLRenderContext,context) =  ::lime::_backend::native::NativeGLRenderContext_obj::__alloc( HX_CTX );
...
HXLINE( 139)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 139)			_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
HXDLIN( 139)			this1 = _this;
            		}
            		else {
HXLINE( 139)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 139)		imageBuffer = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_renderer_read_pixels(hx::DynamicPtr(handle),hx::DynamicPtr(rect),hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())))) );
...
HXLINE( 168)			HX_VARI(  ::Dynamic,lock) = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_renderer_lock(hx::DynamicPtr(this->handle))) );
