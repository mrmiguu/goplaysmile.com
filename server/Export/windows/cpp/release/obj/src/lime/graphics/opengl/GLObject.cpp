...
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_31_getType,"lime.graphics.opengl.GLObject","getType",0x2e94747b,"lime.graphics.opengl.GLObject.getType","lime/graphics/opengl/GLObject.hx",31,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_35_invalidate,"lime.graphics.opengl.GLObject","invalidate",0x6335e050,"lime.graphics.opengl.GLObject.invalidate","lime/graphics/opengl/GLObject.hx",35,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_39_isValid,"lime.graphics.opengl.GLObject","isValid",0xdd46eabd,"lime.graphics.opengl.GLObject.isValid","lime/graphics/opengl/GLObject.hx",39,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_43_isInvalid,"lime.graphics.opengl.GLObject","isInvalid",0xbfb002f8,"lime.graphics.opengl.GLObject.isInvalid","lime/graphics/opengl/GLObject.hx",43,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_47_toString,"lime.graphics.opengl.GLObject","toString",0x511dc841,"lime.graphics.opengl.GLObject.toString","lime/graphics/opengl/GLObject.hx",47,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_53_get_invalidated,"lime.graphics.opengl.GLObject","get_invalidated",0xee183f2b,"lime.graphics.opengl.GLObject.get_invalidated","lime/graphics/opengl/GLObject.hx",53,0x63842264)
HX_DEFINE_STACK_FRAME(_hx_pos_c90540f6711aaf63_57_get_valid,"lime.graphics.opengl.GLObject","get_valid",0xf5cb7c1e,"lime.graphics.opengl.GLObject.get_valid","lime/graphics/opengl/GLObject.hx",57,0x63842264)
namespace lime{
namespace graphics{
namespace opengl{
...
HXLINE(  39)			return (this->version == ::lime::graphics::opengl::GL_obj::get_version());
            		}
            		else {
...
::String GLObject_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  47)		return (((this->getType() + HX_("(",28,00,00,00)) + this->id) + HX_(")",29,00,00,00));
            	}
