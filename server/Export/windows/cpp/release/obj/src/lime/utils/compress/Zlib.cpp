...
Dynamic Zlib_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::haxe::io::Bytes Zlib_obj::compress( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.compress.Zlib","compress",0x4fedbd0f,"lime.utils.compress.Zlib.compress","lime/utils/compress/Zlib.hx",27,0xe800dd9e)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  27)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  27)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(bytes);
HXDLIN(  27)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_zlib_compress(_hx_tmp,hx::DynamicPtr(bytes1))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Zlib_obj,compress,return )
 ...
 ::haxe::io::Bytes Zlib_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACK_FRAME("lime.utils.compress.Zlib","decompress",0xe6dcf2d0,"lime.utils.compress.Zlib.decompress","lime/utils/compress/Zlib.hx",63,0xe800dd9e)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  63)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  63)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(bytes);
HXDLIN(  63)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_zlib_decompress(_hx_tmp,hx::DynamicPtr(bytes1))) );
