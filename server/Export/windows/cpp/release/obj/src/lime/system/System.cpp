...
void System_obj::exit(Int code){
            	HX_STACK_FRAME("lime.system.System","exit",0x19210697,"lime.system.System.exit","lime/system/System.hx",45,0x6434b429)
            	HX_STACK_ARG(code,"code")
HXLINE(  62)		Bool _hx_tmp = hx::IsNotNull( ::lime::app::Application_obj::current );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,exit,(void))
 ...
 ::lime::_hx_system::Display System_obj::getDisplay(Int id){
            	HX_STACK_FRAME("lime.system.System","getDisplay",0x2e892085,"lime.system.System.getDisplay","lime/system/System.hx",83,0x6434b429)
            	HX_STACK_ARG(id,"id")
HXLINE(  86)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_display(id)) );
HXDLIN(  86)		HX_VARI(  ::Dynamic,displayInfo) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  88)		Bool _hx_tmp = hx::IsNotNull( displayInfo );
HXDLIN(  88)		if (_hx_tmp) {
HXLINE(  90)			HX_VARI(  ::lime::_hx_system::Display,display) =  ::lime::_hx_system::Display_obj::__new();
HXLINE(  91)			display->id = id;
HXLINE(  92)			display->name =  ::Dynamic(displayInfo->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic));
HXLINE(  93)			display->bounds =  ::lime::math::Rectangle_obj::__new( ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("x",78,00,00,00),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("y",79,00,00,00),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)));
HXLINE( 107)			display->dpi =  ::Dynamic(displayInfo->__Field(HX_("dpi",5d,43,4c,00),hx::paccDynamic));
HXLINE( 110)			display->supportedModes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 112)			HX_VAR(  ::lime::_hx_system::DisplayMode,displayMode);
HXLINE( 114)			{
HXLINE( 114)				HX_VARI( Int,_g) = (int)0;
HXDLIN( 114)				HX_VARI( ::cpp::VirtualArray,_g1) = hx::TCast< ::cpp::VirtualArray >::cast( ::Dynamic(displayInfo->__Field(HX_("supportedModes",a2,a6,b8,b7),hx::paccDynamic)));
HXDLIN( 114)				while((_g < _g1->get_length())){
HXLINE( 114)					HX_VARI(  ::Dynamic,mode) = _g1->__get(_g);
HXDLIN( 114)					++_g;
HXLINE( 116)					displayMode =  ::lime::_hx_system::DisplayMode_obj::__new( ::Dynamic(mode->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("refreshRate",5b,e2,3f,40),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("pixelFormat",5d,72,1b,6f),hx::paccDynamic)));
HXLINE( 117)					display->supportedModes->push(displayMode);
            				}
            			}
HXLINE( 121)			Bool _hx_tmp1 = ::Reflect_obj::hasField(displayInfo,HX_("currentMode",3c,ac,f2,80));
...
HXLINE( 127)				display->currentMode =  ::lime::_hx_system::DisplayMode_obj::__new((int)0,(int)0,(int)60,(int)1);
            			}
...
Int System_obj::getTimer(){
            	HX_STACK_FRAME("lime.system.System","getTimer",0xb1bf8f48,"lime.system.System.getTimer","lime/system/System.hx",174,0x6434b429)
HXLINE( 174)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_timer()) );
            	}
...
Bool lazy = __o_lazy.Default(false);
            	HX_STACK_FRAME("lime.system.System","load",0x1dbaa99f,"lime.system.System.load","lime/system/System.hx",190,0x6434b429)
...
void System_obj::openFile(::String path){
            	HX_STACK_FRAME("lime.system.System","openFile",0x26aa6b5f,"lime.system.System.openFile","lime/system/System.hx",200,0x6434b429)
            	HX_STACK_ARG(path,"path")
HXLINE( 200)		Bool _hx_tmp = hx::IsNotNull( path );
...
::String target = __o_target.Default(HX_HCSTRING("_blank","\x95","\x26","\xd9","\xb0"));
            	HX_STACK_FRAME("lime.system.System","openURL",0x0840dfec,"lime.system.System.openURL","lime/system/System.hx",240,0x6434b429)
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(target,"target")
HXLINE( 240)		Bool _hx_tmp = hx::IsNotNull( url );
...
::String System_obj::_hx___getDirectory(Int type){
            	HX_STACK_FRAME("lime.system.System","__getDirectory",0xc98892d0,"lime.system.System.__getDirectory","lime/system/System.hx",270,0x6434b429)
            	HX_STACK_ARG(type,"type")
HXLINE( 274)		Bool _hx_tmp = ::lime::_hx_system::System_obj::_hx___directories->exists(type);
HXDLIN( 274)		if (_hx_tmp) {
HXLINE( 276)			return ( (::String)(::lime::_hx_system::System_obj::_hx___directories->get(type)) );
            		}
            		else {
HXLINE( 280)			HX_VAR( ::String,path);
HXLINE( 282)			if ((type == (int)1)) {
HXLINE( 284)				HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 285)				HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
HXLINE( 287)				Bool _hx_tmp1;
HXDLIN( 287)				Bool _hx_tmp2 = hx::IsNotNull( ::lime::app::Application_obj::current );
HXDLIN( 287)				if (_hx_tmp2) {
HXLINE( 287)					_hx_tmp1 = hx::IsNotNull( ::lime::app::Application_obj::current->config );
            				}
            				else {
HXLINE( 287)					_hx_tmp1 = false;
            				}
HXDLIN( 287)				if (_hx_tmp1) {
HXLINE( 289)					Bool _hx_tmp3 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) ) );
...
HXLINE( 295)					Bool _hx_tmp4 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) ) );
...
HXLINE( 303)				 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_directory(type,company,file)) );
HXDLIN( 303)				path = Dynamic(hx::DynamicPtr(inVal));
            			}
            			else {
HXLINE( 307)				 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_directory(type,null(),null())) );
HXDLIN( 307)				path = Dynamic(hx::DynamicPtr(inVal1));
            			}
HXLINE( 317)			Bool _hx_tmp5;
HXDLIN( 317)			Bool _hx_tmp6;
HXDLIN( 317)			Bool _hx_tmp7 = hx::IsNotNull( path );
HXDLIN( 317)			if (_hx_tmp7) {
HXLINE( 317)				_hx_tmp6 = (path.length > (int)0);
            			}
            			else {
HXLINE( 317)				_hx_tmp6 = false;
            			}
HXDLIN( 317)			if (_hx_tmp6) {
HXLINE( 317)				_hx_tmp5 = !(::StringTools_obj::endsWith(path,HX_("\\",5c,00,00,00)));
            			}
            			else {
HXLINE( 317)				_hx_tmp5 = false;
            			}
HXDLIN( 317)			if (_hx_tmp5) {
HXLINE( 319)				hx::AddEq(path,HX_("\\",5c,00,00,00));
            			}
...
Bool System_obj::get_allowScreenTimeout(){
            	HX_STACK_FRAME("lime.system.System","get_allowScreenTimeout",0x287e314e,"lime.system.System.get_allowScreenTimeout","lime/system/System.hx",363,0x6434b429)
HXLINE( 363)		return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
Bool System_obj::set_allowScreenTimeout(Bool value){
            	HX_STACK_FRAME("lime.system.System","set_allowScreenTimeout",0x5c29adc2,"lime.system.System.set_allowScreenTimeout","lime/system/System.hx",374,0x6434b429)
            	HX_STACK_ARG(value,"value")
HXLINE( 374)		return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
::String System_obj::get_applicationDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_applicationDirectory",0xf6955c7f,"lime.system.System.get_applicationDirectory","lime/system/System.hx",384,0x6434b429)
...
::String System_obj::get_applicationStorageDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_applicationStorageDirectory",0x34818fe0,"lime.system.System.get_applicationStorageDirectory","lime/system/System.hx",391,0x6434b429)
...
::String System_obj::get_desktopDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_desktopDirectory",0x483b2773,"lime.system.System.get_desktopDirectory","lime/system/System.hx",398,0x6434b429)
...
::String System_obj::get_documentsDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_documentsDirectory",0x4a6a8557,"lime.system.System.get_documentsDirectory","lime/system/System.hx",405,0x6434b429)
...
::String System_obj::get_fontsDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_fontsDirectory",0x8242b40b,"lime.system.System.get_fontsDirectory","lime/system/System.hx",412,0x6434b429)
...
Int System_obj::get_numDisplays(){
            	HX_STACK_FRAME("lime.system.System","get_numDisplays",0x5056f915,"lime.system.System.get_numDisplays","lime/system/System.hx",420,0x6434b429)
HXLINE( 420)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_num_displays()) );
            	}
...
::String System_obj::get_userDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_userDirectory",0x2b5522e0,"lime.system.System.get_userDirectory","lime/system/System.hx",430,0x6434b429)
...
::hx::EnumBase System_obj::get_endianness(){
            	HX_STACK_FRAME("lime.system.System","get_endianness",0x4df50bb4,"lime.system.System.get_endianness","lime/system/System.hx",442,0x6434b429)
...
{
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",42,0x6434b429)
HXLINE(  42)		_hx___directories =  ::haxe::ds::IntMap_obj::__new();
            	}
}
