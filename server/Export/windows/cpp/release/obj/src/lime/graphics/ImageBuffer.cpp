...
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_62_clone,"lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",62,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_146_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",146,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_153_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",153,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_185_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",185,0x6475c2cd)
namespace lime{
namespace graphics{
...
bool ImageBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  64)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this->data,this->width,this->height,this->bitsPerPixel,null());
...
HXLINE( 112)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 112)				_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
