...
HX_DEFINE_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_102_fromBytes,"lime.net._HTTPRequest_Bytes","fromBytes",0x58799e11,"lime.net._HTTPRequest_Bytes.fromBytes","lime/net/HTTPRequest.hx",102,0x339db723)
HX_DEFINE_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_121_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",121,0x339db723)
HX_DEFINE_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_107_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",107,0x339db723)
namespace lime{
namespace net{
...
HXLINE( 115)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
