...
HXLINE(  20)		 ::lime::graphics::opengl::GLShader shader = ::lime::graphics::opengl::GL_obj::context->createShader(type);
...
HXLINE(  46)		 ::lime::graphics::opengl::GLShader vertexShader = ::lime::utils::GLUtils_obj::compileShader(vertexSource,(int)35633);
HXLINE(  47)		 ::lime::graphics::opengl::GLShader fragmentShader = ::lime::utils::GLUtils_obj::compileShader(fragmentSource,(int)35632);
HXLINE(  49)		 ::lime::graphics::opengl::GLProgram program = ::lime::graphics::opengl::GL_obj::context->createProgram();
