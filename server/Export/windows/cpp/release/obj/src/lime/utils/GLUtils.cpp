...
HX_DEFINE_STACK_FRAME(_hx_pos_736ce5301d879302_18_compileShader,"lime.utils.GLUtils","compileShader",0x55bd7600,"lime.utils.GLUtils.compileShader","lime/utils/GLUtils.hx",18,0xaa32e64a)
HX_DEFINE_STACK_FRAME(_hx_pos_736ce5301d879302_44_createProgram,"lime.utils.GLUtils","createProgram",0x574727f0,"lime.utils.GLUtils.createProgram","lime/utils/GLUtils.hx",44,0xaa32e64a)
namespace lime{
namespace utils{
...
HXLINE(  24)		if ((::lime::graphics::opengl::GL_obj::context->getShaderParameter(shader,(int)35713) == (int)0)) {
...
HXLINE(  54)		if ((::lime::graphics::opengl::GL_obj::context->getProgramParameter(program,(int)35714) == (int)0)) {
