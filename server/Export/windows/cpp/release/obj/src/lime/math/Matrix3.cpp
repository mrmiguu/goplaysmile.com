...
Float ty = __o_ty.Default(0);
            	HX_STACK_FRAME("lime.math.Matrix3","new",0xb5a52a77,"lime.math.Matrix3.new","lime/math/Matrix3.hx",23,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(c,"c")
...
Dynamic Matrix3_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::math::Matrix3 Matrix3_obj::clone(){
            	HX_STACK_FRAME("lime.math.Matrix3","clone",0xf8506134,"lime.math.Matrix3.clone","lime/math/Matrix3.hx",37,0xeabca539)
            	HX_STACK_THIS(this)
HXLINE(  37)		return  ::lime::math::Matrix3_obj::__new(this->a,this->b,this->c,this->d,this->tx,this->ty);
            	}
...
void Matrix3_obj::concat( ::lime::math::Matrix3 m){
            	HX_STACK_FRAME("lime.math.Matrix3","concat",0x0786d75d,"lime.math.Matrix3.concat","lime/math/Matrix3.hx",42,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(m,"m")
HXLINE(  44)		HX_VARI( Float,a1) = ((this->a * m->a) + (this->b * m->c));
HXLINE(  45)		Float _hx_tmp = (this->a * m->b);
HXDLIN(  45)		Float _hx_tmp1 = (this->b * m->d);
HXDLIN(  45)		this->b = (_hx_tmp + _hx_tmp1);
HXLINE(  46)		this->a = a1;
HXLINE(  48)		HX_VARI( Float,c1) = ((this->c * m->a) + (this->d * m->c));
HXLINE(  49)		Float _hx_tmp2 = (this->c * m->b);
HXDLIN(  49)		Float _hx_tmp3 = (this->d * m->d);
HXDLIN(  49)		this->d = (_hx_tmp2 + _hx_tmp3);
HXLINE(  50)		this->c = c1;
HXLINE(  52)		HX_VARI( Float,tx1) = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
HXLINE(  53)		Float _hx_tmp4 = ((this->tx * m->b) + (this->ty * m->d));
HXDLIN(  53)		this->ty = (_hx_tmp4 + m->ty);
HXLINE(  54)		this->tx = tx1;
            	}
...
void Matrix3_obj::copyColumnFrom(Int column, ::lime::math::Vector4 vector4){
            	HX_STACK_FRAME("lime.math.Matrix3","copyColumnFrom",0x89c156be,"lime.math.Matrix3.copyColumnFrom","lime/math/Matrix3.hx",63,0xeabca539)
            	HX_STACK_THIS(this)
...
void Matrix3_obj::copyColumnTo(Int column, ::lime::math::Vector4 vector4){
            	HX_STACK_FRAME("lime.math.Matrix3","copyColumnTo",0x045a59cf,"lime.math.Matrix3.copyColumnTo","lime/math/Matrix3.hx",89,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(column,"column")
            	HX_STACK_ARG(vector4,"vector4")
...
void Matrix3_obj::copyFrom( ::lime::math::Matrix3 sourceMatrix3){
            	HX_STACK_FRAME("lime.math.Matrix3","copyFrom",0x7e1ebe48,"lime.math.Matrix3.copyFrom","lime/math/Matrix3.hx",116,0xeabca539)
            	HX_STACK_THIS(this)
...
void Matrix3_obj::copyRowFrom(Int row, ::lime::math::Vector4 vector4){
            	HX_STACK_FRAME("lime.math.Matrix3","copyRowFrom",0xb0770e86,"lime.math.Matrix3.copyRowFrom","lime/math/Matrix3.hx",130,0xeabca539)
            	HX_STACK_THIS(this)
...
void Matrix3_obj::copyRowTo(Int row, ::lime::math::Vector4 vector4){
            	HX_STACK_FRAME("lime.math.Matrix3","copyRowTo",0xc3a10f97,"lime.math.Matrix3.copyRowTo","lime/math/Matrix3.hx",156,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(row,"row")
            	HX_STACK_ARG(vector4,"vector4")
...
Float tx = __o_tx.Default(0);
Float ty = __o_ty.Default(0);
            	HX_STACK_FRAME("lime.math.Matrix3","createBox",0x9a1719c6,"lime.math.Matrix3.createBox","lime/math/Matrix3.hx",181,0xeabca539)
            	HX_STACK_THIS(this)
...
Float tx = __o_tx.Default(0);
Float ty = __o_ty.Default(0);
            	HX_STACK_FRAME("lime.math.Matrix3","createGradientBox",0xff9720b6,"lime.math.Matrix3.createGradientBox","lime/math/Matrix3.hx",192,0xeabca539)
            	HX_STACK_THIS(this)
...
HXLINE( 200)			HX_VARI( Float,cos) = ::Math_obj::cos(rotation);
HXLINE( 201)			HX_VARI( Float,sin) = ::Math_obj::sin(rotation);
HXLINE( 203)			this->b = (sin * this->d);
HXLINE( 204)			this->c = (-(sin) * this->a);
HXLINE( 205)			hx::MultEq(this->a,cos);
HXLINE( 206)			hx::MultEq(this->d,cos);
            		}
            		else {
...
Bool Matrix3_obj::equals( ::Dynamic Matrix3){
            	HX_STACK_FRAME("lime.math.Matrix3","equals",0xffa9bc88,"lime.math.Matrix3.equals","lime/math/Matrix3.hx",223,0xeabca539)
            	HX_STACK_THIS(this)
...
HXDLIN( 223)		Bool _hx_tmp5 = hx::IsNotNull( Matrix3 );
...
HX_DEFINE_DYNAMIC_FUNC1(Matrix3_obj,equals,return )
 ...
 ::lime::math::Vector2 Matrix3_obj::deltaTransformVector2( ::lime::math::Vector2 Vector2){
            	HX_STACK_FRAME("lime.math.Matrix3","deltaTransformVector2",0xf0c299f2,"lime.math.Matrix3.deltaTransformVector2","lime/math/Matrix3.hx",230,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Vector2,"Vector2")
HXLINE( 230)		return  ::lime::math::Vector2_obj::__new(((Vector2->x * this->a) + (Vector2->y * this->c)),((Vector2->x * this->b) + (Vector2->y * this->d)));
            	}
...
void Matrix3_obj::identity(){
            	HX_STACK_FRAME("lime.math.Matrix3","identity",0x6eecf7c7,"lime.math.Matrix3.identity","lime/math/Matrix3.hx",235,0xeabca539)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix3_obj,identity,(void))
 ...
 ::lime::math::Matrix3 Matrix3_obj::invert(){
            	HX_STACK_FRAME("lime.math.Matrix3","invert",0xdf8fb55f,"lime.math.Matrix3.invert","lime/math/Matrix3.hx",247,0xeabca539)
            	HX_STACK_THIS(this)
HXLINE( 249)		HX_VARI( Float,norm) = ((this->a * this->d) - (this->b * this->c));
HXLINE( 251)		if ((norm == (int)0)) {
HXLINE( 253)			this->a = (this->b = (this->c = (this->d = (int)0)));
HXLINE( 254)			this->tx = -(this->tx);
HXLINE( 255)			this->ty = -(this->ty);
            		}
            		else {
HXLINE( 259)			norm = ((Float)((Float)1.0) / (Float)norm);
HXLINE( 260)			HX_VARI( Float,a1) = (this->d * norm);
HXLINE( 261)			this->d = (this->a * norm);
HXLINE( 262)			this->a = a1;
HXLINE( 263)			hx::MultEq(this->b,-(norm));
HXLINE( 264)			hx::MultEq(this->c,-(norm));
HXLINE( 266)			HX_VARI( Float,tx1) = ((-(this->a) * this->tx) - (this->c * this->ty));
HXLINE( 267)			Float _hx_tmp = (-(this->b) * this->tx);
HXDLIN( 267)			Float _hx_tmp1 = (this->d * this->ty);
HXDLIN( 267)			this->ty = (_hx_tmp - _hx_tmp1);
HXLINE( 268)			this->tx = tx1;
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix3_obj,invert,return )
 ...
 ::lime::math::Matrix3 Matrix3_obj::mult( ::lime::math::Matrix3 m){
            	HX_STACK_FRAME("lime.math.Matrix3","mult",0x3a42e1f9,"lime.math.Matrix3.mult","lime/math/Matrix3.hx",279,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(m,"m")
HXLINE( 281)		HX_VARI(  ::lime::math::Matrix3,result) =  ::lime::math::Matrix3_obj::__new(this->a,this->b,this->c,this->d,this->tx,this->ty);
...
void Matrix3_obj::rotate(Float theta){
            	HX_STACK_FRAME("lime.math.Matrix3","rotate",0x0ad714a4,"lime.math.Matrix3.rotate","lime/math/Matrix3.hx",288,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(theta,"theta")
HXLINE( 304)		HX_VARI( Float,cos) = ::Math_obj::cos(theta);
HXLINE( 305)		HX_VARI( Float,sin) = ::Math_obj::sin(theta);
HXLINE( 307)		HX_VARI( Float,a1) = ((this->a * cos) - (this->b * sin));
HXLINE( 308)		Float _hx_tmp = (this->a * sin);
HXDLIN( 308)		Float _hx_tmp1 = (this->b * cos);
HXDLIN( 308)		this->b = (_hx_tmp + _hx_tmp1);
HXLINE( 309)		this->a = a1;
HXLINE( 311)		HX_VARI( Float,c1) = ((this->c * cos) - (this->d * sin));
HXLINE( 312)		Float _hx_tmp2 = (this->c * sin);
HXDLIN( 312)		Float _hx_tmp3 = (this->d * cos);
HXDLIN( 312)		this->d = (_hx_tmp2 + _hx_tmp3);
HXLINE( 313)		this->c = c1;
HXLINE( 315)		HX_VARI( Float,tx1) = ((this->tx * cos) - (this->ty * sin));
HXLINE( 316)		Float _hx_tmp4 = (this->tx * sin);
HXDLIN( 316)		Float _hx_tmp5 = (this->ty * cos);
HXDLIN( 316)		this->ty = (_hx_tmp4 + _hx_tmp5);
HXLINE( 317)		this->tx = tx1;
            	}
...
void Matrix3_obj::scale(Float sx,Float sy){
            	HX_STACK_FRAME("lime.math.Matrix3","scale",0x28bc1c61,"lime.math.Matrix3.scale","lime/math/Matrix3.hx",324,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sx,"sx")
            	HX_STACK_ARG(sy,"sy")
HXLINE( 335)		hx::MultEq(this->a,sx);
HXLINE( 336)		hx::MultEq(this->b,sy);
HXLINE( 337)		hx::MultEq(this->c,sx);
HXLINE( 338)		hx::MultEq(this->d,sy);
HXLINE( 339)		hx::MultEq(this->tx,sx);
HXLINE( 340)		hx::MultEq(this->ty,sy);
            	}
...
Float scale = __o_scale.Default(1);
            	HX_STACK_FRAME("lime.math.Matrix3","setRotation",0xf9d2d017,"lime.math.Matrix3.setRotation","lime/math/Matrix3.hx",347,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(theta,"theta")
            	HX_STACK_ARG(scale,"scale")
HXLINE( 349)		Float _hx_tmp = ::Math_obj::cos(theta);
HXDLIN( 349)		this->a = (_hx_tmp * scale);
HXLINE( 350)		Float _hx_tmp1 = ::Math_obj::sin(theta);
HXDLIN( 350)		this->c = (_hx_tmp1 * scale);
...
void Matrix3_obj::setTo(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	HX_STACK_FRAME("lime.math.Matrix3","setTo",0x2a1cdf94,"lime.math.Matrix3.setTo","lime/math/Matrix3.hx",359,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(c,"c")
...
Bool roundPixels = __o_roundPixels.Default(false);
            	HX_STACK_FRAME("lime.math.Matrix3","to3DString",0x3565e3a6,"lime.math.Matrix3.to3DString","lime/math/Matrix3.hx",381,0xeabca539)
            	HX_STACK_THIS(this)
...
HXDLIN( 383)			Int _hx_tmp1 = ::Std_obj::_hx_int(this->tx);
HXDLIN( 383)			::String _hx_tmp2 = ((_hx_tmp + _hx_tmp1) + HX_(", ",74,26,00,00));
HXDLIN( 383)			Int _hx_tmp3 = ::Std_obj::_hx_int(this->ty);
HXDLIN( 383)			return ((_hx_tmp2 + _hx_tmp3) + HX_(", 0, 1)",88,a3,85,b1));
            		}
            		else {
...
::String Matrix3_obj::toMozString(){
            	HX_STACK_FRAME("lime.math.Matrix3","toMozString",0xdc79a1e5,"lime.math.Matrix3.toMozString","lime/math/Matrix3.hx",396,0xeabca539)
            	HX_STACK_THIS(this)
...
::String Matrix3_obj::toString(){
            	HX_STACK_FRAME("lime.math.Matrix3","toString",0xee2c8335,"lime.math.Matrix3.toString","lime/math/Matrix3.hx",403,0xeabca539)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix3_obj,toString,return )
 ...
 ::lime::math::Vector2 Matrix3_obj::transformVector2( ::lime::math::Vector2 pos){
            	HX_STACK_FRAME("lime.math.Matrix3","transformVector2",0x83039d8c,"lime.math.Matrix3.transformVector2","lime/math/Matrix3.hx",410,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
HXLINE( 410)		return  ::lime::math::Vector2_obj::__new((((pos->x * this->a) + (pos->y * this->c)) + this->tx),(((pos->x * this->b) + (pos->y * this->d)) + this->ty));
            	}
...
void Matrix3_obj::translate(Float dx,Float dy){
            	HX_STACK_FRAME("lime.math.Matrix3","translate",0x99be5ca5,"lime.math.Matrix3.translate","lime/math/Matrix3.hx",415,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 417)		hx::AddEq(this->tx,dx);
HXLINE( 418)		hx::AddEq(this->ty,dy);
            	}
...
void Matrix3_obj::_hx___cleanValues(){
            	HX_STACK_FRAME("lime.math.Matrix3","__cleanValues",0x3007f402,"lime.math.Matrix3.__cleanValues","lime/math/Matrix3.hx",423,0xeabca539)
            	HX_STACK_THIS(this)
HXLINE( 425)		Float _hx_tmp = (this->a * (int)1000);
HXDLIN( 425)		Int _hx_tmp1 = ::Math_obj::round(_hx_tmp);
HXDLIN( 425)		this->a = ((Float)_hx_tmp1 / (Float)(int)1000);
HXLINE( 426)		Float _hx_tmp2 = (this->b * (int)1000);
HXDLIN( 426)		Int _hx_tmp3 = ::Math_obj::round(_hx_tmp2);
HXDLIN( 426)		this->b = ((Float)_hx_tmp3 / (Float)(int)1000);
HXLINE( 427)		Float _hx_tmp4 = (this->c * (int)1000);
HXDLIN( 427)		Int _hx_tmp5 = ::Math_obj::round(_hx_tmp4);
HXDLIN( 427)		this->c = ((Float)_hx_tmp5 / (Float)(int)1000);
HXLINE( 428)		Float _hx_tmp6 = (this->d * (int)1000);
HXDLIN( 428)		Int _hx_tmp7 = ::Math_obj::round(_hx_tmp6);
HXDLIN( 428)		this->d = ((Float)_hx_tmp7 / (Float)(int)1000);
HXLINE( 429)		Float _hx_tmp8 = (this->tx * (int)10);
HXDLIN( 429)		Int _hx_tmp9 = ::Math_obj::round(_hx_tmp8);
HXDLIN( 429)		this->tx = ((Float)_hx_tmp9 / (Float)(int)10);
HXLINE( 430)		Float _hx_tmp10 = (this->ty * (int)10);
HXDLIN( 430)		Int _hx_tmp11 = ::Math_obj::round(_hx_tmp10);
HXDLIN( 430)		this->ty = ((Float)_hx_tmp11 / (Float)(int)10);
            	}
...
Float Matrix3_obj::_hx___transformX( ::lime::math::Vector2 pos){
            	HX_STACK_FRAME("lime.math.Matrix3","__transformX",0xe12c3795,"lime.math.Matrix3.__transformX","lime/math/Matrix3.hx",437,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
HXLINE( 437)		return (((pos->x * this->a) + (pos->y * this->c)) + this->tx);
            	}
...
Float Matrix3_obj::_hx___transformY( ::lime::math::Vector2 pos){
            	HX_STACK_FRAME("lime.math.Matrix3","__transformY",0xe12c3796,"lime.math.Matrix3.__transformY","lime/math/Matrix3.hx",444,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
HXLINE( 444)		return (((pos->x * this->b) + (pos->y * this->d)) + this->ty);
            	}
...
void Matrix3_obj::_hx___translateTransformed( ::lime::math::Vector2 pos){
            	HX_STACK_FRAME("lime.math.Matrix3","__translateTransformed",0x7b249386,"lime.math.Matrix3.__translateTransformed","lime/math/Matrix3.hx",449,0xeabca539)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
HXLINE( 451)		Float _hx_tmp = ((pos->x * this->a) + (pos->y * this->c));
HXDLIN( 451)		this->tx = (_hx_tmp + this->tx);
HXLINE( 452)		Float _hx_tmp1 = ((pos->x * this->b) + (pos->y * this->d));
HXDLIN( 452)		this->ty = (_hx_tmp1 + this->ty);
            	}
...
{
{
            	HX_STACK_FRAME("lime.math.Matrix3","boot",0x32f8fe3b,"lime.math.Matrix3.boot","lime/math/Matrix3.hx",20,0xeabca539)
HXLINE(  20)		_hx___identity =  ::lime::math::Matrix3_obj::__new(null(),null(),null(),null(),null(),null());
            	}
}
