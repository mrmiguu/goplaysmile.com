...
void Promise_openfl_display_BitmapData_obj::__construct(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","new",0x68417acd,"lime.app.Promise_openfl_display_BitmapData.new","lime/app/Promise.hx",23,0x10ba4f0b)
            	HX_STACK_THIS(this)
HXLINE(  23)		this->future =  ::lime::app::Future_obj::__new(null(),null());
            	}
...
Dynamic Promise_openfl_display_BitmapData_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::complete( ::openfl::display::BitmapData data){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","complete",0x7cf86b2c,"lime.app.Promise_openfl_display_BitmapData.complete","lime/app/Promise.hx",28,0x10ba4f0b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
HXLINE(  30)		Bool _hx_tmp = !(this->future->isError);
HXDLIN(  30)		if (_hx_tmp) {
HXLINE(  32)			this->future->isComplete = true;
HXLINE(  33)			this->future->value = data;
HXLINE(  35)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___completeListeners );
HXDLIN(  35)			if (_hx_tmp1) {
HXLINE(  37)				{
HXLINE(  37)					HX_VARI( Int,_g) = (int)0;
HXDLIN(  37)					HX_VARI( ::Array< ::Dynamic>,_g1) = this->future->_hx___completeListeners;
HXDLIN(  37)					while((_g < _g1->length)){
HXLINE(  37)						HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  37)						++_g;
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,complete,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::completeWith( ::lime::app::Future future){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","completeWith",0xc87d1352,"lime.app.Promise_openfl_display_BitmapData.completeWith","lime/app/Promise.hx",54,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,completeWith,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::error( ::Dynamic msg){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","error",0xf1a8ab75,"lime.app.Promise_openfl_display_BitmapData.error","lime/app/Promise.hx",66,0x10ba4f0b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(msg,"msg")
HXLINE(  68)		Bool _hx_tmp = !(this->future->isComplete);
HXDLIN(  68)		if (_hx_tmp) {
HXLINE(  70)			this->future->isError = true;
HXLINE(  71)			this->future->error = msg;
HXLINE(  73)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___errorListeners );
HXDLIN(  73)			if (_hx_tmp1) {
HXLINE(  75)				{
HXLINE(  75)					HX_VARI( Int,_g) = (int)0;
HXDLIN(  75)					HX_VARI( ::Array< ::Dynamic>,_g1) = this->future->_hx___errorListeners;
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_openfl_display_BitmapData_obj,error,return )
 ...
 ::lime::app::Promise_openfl_display_BitmapData Promise_openfl_display_BitmapData_obj::progress(Int progress,Int total){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","progress",0x835b6220,"lime.app.Promise_openfl_display_BitmapData.progress","lime/app/Promise.hx",92,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
HXLINE(  96)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___progressListeners );
HXDLIN(  96)			if (_hx_tmp1) {
HXLINE(  98)				HX_VARI( Int,_g) = (int)0;
HXDLIN(  98)				HX_VARI( ::Array< ::Dynamic>,_g1) = this->future->_hx___progressListeners;
HXDLIN(  98)				while((_g < _g1->length)){
HXLINE(  98)					HX_VARI(  ::Dynamic,listener) = _g1->__get(_g);
HXDLIN(  98)					++_g;
...
Bool Promise_openfl_display_BitmapData_obj::get_isComplete(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isComplete",0x02ecddbf,"lime.app.Promise_openfl_display_BitmapData.get_isComplete","lime/app/Promise.hx",122,0x10ba4f0b)
            	HX_STACK_THIS(this)
...
Bool Promise_openfl_display_BitmapData_obj::get_isError(){
            	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isError",0x531b2f02,"lime.app.Promise_openfl_display_BitmapData.get_isError","lime/app/Promise.hx",129,0x10ba4f0b)
            	HX_STACK_THIS(this)
