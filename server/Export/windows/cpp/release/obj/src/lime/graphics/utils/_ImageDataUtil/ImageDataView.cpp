...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1339_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1339,0x494d921f)
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1354_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1354,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
HXLINE(1334)		this->offset = ((this->stride * (this->y + image->offsetY)) + ((this->x + image->offsetX) * (int)4));
            	}
...
HXLINE(1347)		this->offset = ((this->stride * (this->y + this->image->offsetY)) + ((this->x + this->image->offsetX) * (int)4));
            	}
