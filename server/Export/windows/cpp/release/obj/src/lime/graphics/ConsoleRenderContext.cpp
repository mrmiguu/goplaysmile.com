...
HXLINE( 112)		return  ::lime::graphics::console::IndexBuffer_obj::__new();
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ConsoleRenderContext_obj,createIndexBuffer,return )
 ...
 ::lime::graphics::console::VertexBuffer ConsoleRenderContext_obj::createVertexBuffer( ::Dynamic decl,Int count){
            	...
            	HX_STACK_ARG(count,"count")
HXLINE( 113)		return  ::lime::graphics::console::VertexBuffer_obj::__new();
            	}
...
HXLINE( 114)		return  ::lime::graphics::console::Shader_obj::__new();
            	}
