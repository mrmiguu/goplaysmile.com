...
Int loops = __o_loops.Default(0);
            	HX_STACK_FRAME("lime.media.AudioSource","new",0xf0422400,"lime.media.AudioSource.new","lime/media/AudioSource.hx",15,0xae7961b2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(offset,"offset")
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(loops,"loops")
HXLINE(  18)		this->onComplete =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  33)		this->buffer = buffer;
HXLINE(  34)		this->offset = offset;
HXLINE(  36)		this->backend =  ::lime::_backend::native::NativeAudioSource_obj::__new(hx::ObjectPtr<OBJ_>(this));
HXLINE(  38)		Bool _hx_tmp;
HXDLIN(  38)		Bool _hx_tmp1 = hx::IsNotNull( length );
...
HXLINE(  46)		Bool _hx_tmp2 = hx::IsNotNull( buffer );
...
void AudioSource_obj::dispose(){
            	HX_STACK_FRAME("lime.media.AudioSource","dispose",0x9c7d243f,"lime.media.AudioSource.dispose","lime/media/AudioSource.hx",57,0xae7961b2)
            	HX_STACK_THIS(this)
...
void AudioSource_obj::init(){
            	HX_STACK_FRAME("lime.media.AudioSource","init",0x46561370,"lime.media.AudioSource.init","lime/media/AudioSource.hx",64,0xae7961b2)
            	HX_STACK_THIS(this)
...
void AudioSource_obj::play(){
            	HX_STACK_FRAME("lime.media.AudioSource","play",0x4af50654,"lime.media.AudioSource.play","lime/media/AudioSource.hx",71,0xae7961b2)
            	HX_STACK_THIS(this)
...
void AudioSource_obj::pause(){
            	HX_STACK_FRAME("lime.media.AudioSource","pause",0x443a5296,"lime.media.AudioSource.pause","lime/media/AudioSource.hx",78,0xae7961b2)
            	HX_STACK_THIS(this)
...
void AudioSource_obj::stop(){
            	HX_STACK_FRAME("lime.media.AudioSource","stop",0x4cf6c862,"lime.media.AudioSource.stop","lime/media/AudioSource.hx",85,0xae7961b2)
            	HX_STACK_THIS(this)
...
Int AudioSource_obj::get_currentTime(){
            	HX_STACK_FRAME("lime.media.AudioSource","get_currentTime",0x645da01d,"lime.media.AudioSource.get_currentTime","lime/media/AudioSource.hx",99,0xae7961b2)
            	HX_STACK_THIS(this)
...
Int AudioSource_obj::set_currentTime(Int value){
            	HX_STACK_FRAME("lime.media.AudioSource","set_currentTime",0x60291d29,"lime.media.AudioSource.set_currentTime","lime/media/AudioSource.hx",106,0xae7961b2)
            	HX_STACK_THIS(this)
...
Float AudioSource_obj::get_gain(){
            	HX_STACK_FRAME("lime.media.AudioSource","get_gain",0xed783468,"lime.media.AudioSource.get_gain","lime/media/AudioSource.hx",113,0xae7961b2)
            	HX_STACK_THIS(this)
...
Float AudioSource_obj::set_gain(Float value){
            	HX_STACK_FRAME("lime.media.AudioSource","set_gain",0x9bd58ddc,"lime.media.AudioSource.set_gain","lime/media/AudioSource.hx",120,0xae7961b2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
Int AudioSource_obj::get_length(){
            	HX_STACK_FRAME("lime.media.AudioSource","get_length",0xb3e8650f,"lime.media.AudioSource.get_length","lime/media/AudioSource.hx",127,0xae7961b2)
            	HX_STACK_THIS(this)
...
Int AudioSource_obj::set_length(Int value){
            	HX_STACK_FRAME("lime.media.AudioSource","set_length",0xb7660383,"lime.media.AudioSource.set_length","lime/media/AudioSource.hx",134,0xae7961b2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
Int AudioSource_obj::get_loops(){
            	HX_STACK_FRAME("lime.media.AudioSource","get_loops",0xc5fc1986,"lime.media.AudioSource.get_loops","lime/media/AudioSource.hx",141,0xae7961b2)
            	HX_STACK_THIS(this)
...
Int AudioSource_obj::set_loops(Int value){
            	HX_STACK_FRAME("lime.media.AudioSource","set_loops",0xa94d0592,"lime.media.AudioSource.set_loops","lime/media/AudioSource.hx",148,0xae7961b2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
HX_DEFINE_DYNAMIC_FUNC1(AudioSource_obj,set_loops,return )
 ...
 ::lime::math::Vector4 AudioSource_obj::get_position(){
            	HX_STACK_FRAME("lime.media.AudioSource","get_position",0x75ce8d12,"lime.media.AudioSource.get_position","lime/media/AudioSource.hx",155,0xae7961b2)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(AudioSource_obj,get_position,return )
 ...
 ::lime::math::Vector4 AudioSource_obj::set_position( ::lime::math::Vector4 value){
            	HX_STACK_FRAME("lime.media.AudioSource","set_position",0x8ac7b086,"lime.media.AudioSource.set_position","lime/media/AudioSource.hx",162,0xae7961b2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
