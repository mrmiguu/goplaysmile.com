...
void ThreadPoolMessage_obj::__construct(::hx::EnumBase type, ::Dynamic state){
            	HX_STACK_FRAME("lime.system._ThreadPool.ThreadPoolMessage","new",0x973bef04,"lime.system._ThreadPool.ThreadPoolMessage.new","lime/system/ThreadPool.hx",235,0x8993fbb2)
            	HX_STACK_THIS(this)
