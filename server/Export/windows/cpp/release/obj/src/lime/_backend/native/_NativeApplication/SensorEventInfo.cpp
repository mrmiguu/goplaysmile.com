...
HX_DEFINE_STACK_FRAME(_hx_pos_07695e5bd07fa57d_964_new,"lime._backend.native._NativeApplication.SensorEventInfo","new",0x51c6b8a3,"lime._backend.native._NativeApplication.SensorEventInfo.new","lime/_backend/native/NativeApplication.hx",964,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_07695e5bd07fa57d_977_clone,"lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",977,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float z = __o_z.Default(0);
            	HX_STACKFRAME(&_hx_pos_07695e5bd07fa57d_964_new)
            	HX_STACK_THIS(this)
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_07695e5bd07fa57d_977_clone)
            	HX_STACK_THIS(this)
HXLINE( 977)		return  ::lime::_backend::native::_NativeApplication::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
