...
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_58_dispose,"lime._backend.native.NativeAudioSource","dispose",0xa24b98d4,"lime._backend.native.NativeAudioSource.dispose","lime/_backend/native/NativeAudioSource.hx",58,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_67_init,"lime._backend.native.NativeAudioSource","init",0x5d2a1fbb,"lime._backend.native.NativeAudioSource.init","lime/_backend/native/NativeAudioSource.hx",67,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_136_play,"lime._backend.native.NativeAudioSource","play",0x61c9129f,"lime._backend.native.NativeAudioSource.play","lime/_backend/native/NativeAudioSource.hx",136,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_166_pause,"lime._backend.native.NativeAudioSource","pause",0x26f107eb,"lime._backend.native.NativeAudioSource.pause","lime/_backend/native/NativeAudioSource.hx",166,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_186_readVorbisFileBuffer,"lime._backend.native.NativeAudioSource","readVorbisFileBuffer",0x14c96ff0,"lime._backend.native.NativeAudioSource.readVorbisFileBuffer","lime/_backend/native/NativeAudioSource.hx",186,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_220_refillBuffers,"lime._backend.native.NativeAudioSource","refillBuffers",0x24bcf452,"lime._backend.native.NativeAudioSource.refillBuffers","lime/_backend/native/NativeAudioSource.hx",220,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_287_stop,"lime._backend.native.NativeAudioSource","stop",0x63cad4ad,"lime._backend.native.NativeAudioSource.stop","lime/_backend/native/NativeAudioSource.hx",287,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_316_streamTimer_onRun,"lime._backend.native.NativeAudioSource","streamTimer_onRun",0xa82f4407,"lime._backend.native.NativeAudioSource.streamTimer_onRun","lime/_backend/native/NativeAudioSource.hx",316,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_321_timer_onRun,"lime._backend.native.NativeAudioSource","timer_onRun",0x4c90fae7,"lime._backend.native.NativeAudioSource.timer_onRun","lime/_backend/native/NativeAudioSource.hx",321,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_354_getCurrentTime,"lime._backend.native.NativeAudioSource","getCurrentTime",0x2632805b,"lime._backend.native.NativeAudioSource.getCurrentTime","lime/_backend/native/NativeAudioSource.hx",354,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_381_setCurrentTime,"lime._backend.native.NativeAudioSource","setCurrentTime",0x465268cf,"lime._backend.native.NativeAudioSource.setCurrentTime","lime/_backend/native/NativeAudioSource.hx",381,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_444_getGain,"lime._backend.native.NativeAudioSource","getGain",0xfde0b86a,"lime._backend.native.NativeAudioSource.getGain","lime/_backend/native/NativeAudioSource.hx",444,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_449_setGain,"lime._backend.native.NativeAudioSource","setGain",0xf0e24976,"lime._backend.native.NativeAudioSource.setGain","lime/_backend/native/NativeAudioSource.hx",449,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_457_getLength,"lime._backend.native.NativeAudioSource","getLength",0x127b6d91,"lime._backend.native.NativeAudioSource.getLength","lime/_backend/native/NativeAudioSource.hx",457,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_470_setLength,"lime._backend.native.NativeAudioSource","setLength",0xf5cc599d,"lime._backend.native.NativeAudioSource.setLength","lime/_backend/native/NativeAudioSource.hx",470,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_498_getLoops,"lime._backend.native.NativeAudioSource","getLoops",0x11071744,"lime._backend.native.NativeAudioSource.getLoops","lime/_backend/native/NativeAudioSource.hx",498,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_505_setLoops,"lime._backend.native.NativeAudioSource","setLoops",0xbf6470b8,"lime._backend.native.NativeAudioSource.setLoops","lime/_backend/native/NativeAudioSource.hx",505,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_510_getPosition,"lime._backend.native.NativeAudioSource","getPosition",0xe5963a14,"lime._backend.native.NativeAudioSource.getPosition","lime/_backend/native/NativeAudioSource.hx",510,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_521_setPosition,"lime._backend.native.NativeAudioSource","setPosition",0xf0034120,"lime._backend.native.NativeAudioSource.setPosition","lime/_backend/native/NativeAudioSource.hx",521,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_26_boot,"lime._backend.native.NativeAudioSource","boot",0x588a68dd,"lime._backend.native.NativeAudioSource.boot","lime/_backend/native/NativeAudioSource.hx",26,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_27_boot,"lime._backend.native.NativeAudioSource","boot",0x588a68dd,"lime._backend.native.NativeAudioSource.boot","lime/_backend/native/NativeAudioSource.hx",27,0xbddaa99c)
HX_DEFINE_STACK_FRAME(_hx_pos_7fb49d574da4e22e_28_boot,"lime._backend.native.NativeAudioSource","boot",0x588a68dd,"lime._backend.native.NativeAudioSource.boot","lime/_backend/native/NativeAudioSource.hx",28,0xbddaa99c)
namespace lime{
namespace _backend{
namespace native{
...
HXDLIN( 103)			this->dataLength = ::Std_obj::_hx_int(((_hx_tmp1 * this->parent->buffer->channels) * ((Float)this->parent->buffer->bitsPerSample / (Float)(int)8)));
...
HXLINE( 109)					::cpp::VirtualArray _hx_tmp2 = this->buffers;
HXDLIN( 109)					_hx_tmp2->push(::lime::media::openal::AL_obj::genBuffer());
            				}
            			}
...
HXLINE( 131)		this->samples = ::Std_obj::_hx_int(((Float)(this->dataLength * (int)8) / (Float)(this->parent->buffer->channels * this->parent->buffer->bitsPerSample)));
            	}
...
HXDLIN( 234)				HX_VARI_NAME( int,position1,"position") = _hx_int64_high(x);
...
HXDLIN( 251)				HX_VARI_NAME( int,position2,"position") = _hx_int64_high(x1);
...
HXLINE( 360)				HX_VARI( int,time) = ::Std_obj::_hx_int((this->parent->buffer->_hx___srcVorbisFile->timeTell() * (int)1000));
HXDLIN( 360)				int time1 = (time + ::Std_obj::_hx_int((::lime::media::openal::AL_obj::getSourcef(this->handle,(int)4132) * (int)1000)));
HXDLIN( 360)				HX_VARI_NAME( int,time2,"time") = (time1 - this->parent->offset);
...
HXLINE( 370)				int time3 = ::Std_obj::_hx_int(((((Float)this->samples / (Float)this->parent->buffer->sampleRate) * ((Float)offset / (Float)this->dataLength)) * (int)1000));
HXDLIN( 370)				HX_VARI_NAME( int,time4,"time") = (time3 - this->parent->offset);
...
HXLINE( 387)			this->parent->buffer->_hx___srcVorbisFile->timeSeekPage(((Float)(value + this->parent->offset) / (Float)(int)1000));
...
HXLINE( 406)				HX_VARI( int,totalOffset) = ::Std_obj::_hx_int((this->dataLength * ((Float)secondOffset / (Float)totalSeconds)));
HXLINE( 407)				HX_VARI( int,currentOffset) = ( (int)(::lime::media::openal::AL_obj::getSourcei(this->handle,(int)4134)) );
HXLINE( 409)				::lime::media::openal::AL_obj::sourcei(this->handle,(int)4134,(totalOffset - currentOffset));
            			}
            		}
HXLINE( 413)		if (this->playing) {
HXLINE( 415)			if (hx::IsNotNull( this->timer )) {
HXLINE( 417)				this->timer->stop();
            			}
HXLINE( 421)			HX_VARI( int,timeRemaining) = (this->getLength() - value);
HXLINE( 423)			if ((timeRemaining > (int)0)) {
HXLINE( 425)				this->completed = false;
HXLINE( 426)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,timeRemaining);
...
Float NativeAudioSource_obj::getGain(){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_444_getGain)
            	HX_STACK_THIS(this)
...
Float NativeAudioSource_obj::setGain(Float value){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_449_setGain)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
int NativeAudioSource_obj::getLength(){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_457_getLength)
            	HX_STACK_THIS(this)
HXLINE( 459)		if (hx::IsNotNull( this->length )) {
HXLINE( 461)			return this->length;
            		}
HXLINE( 465)		int _hx_tmp = ::Std_obj::_hx_int((((Float)this->samples / (Float)this->parent->buffer->sampleRate) * (int)1000));
HXDLIN( 465)		return (_hx_tmp - this->parent->offset);
            	}
...
int NativeAudioSource_obj::setLength(int value){
            	HX_GC_STACKFRAME(&_hx_pos_7fb49d574da4e22e_470_setLength)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
HXLINE( 474)			if (hx::IsNotNull( this->timer )) {
HXLINE( 476)				this->timer->stop();
            			}
HXLINE( 480)			HX_VARI( int,timeRemaining) = (value - this->getCurrentTime());
HXLINE( 482)			if ((timeRemaining > (int)0)) {
HXLINE( 484)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,timeRemaining);
...
int NativeAudioSource_obj::getLoops(){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_498_getLoops)
            	HX_STACK_THIS(this)
...
int NativeAudioSource_obj::setLoops(int value){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_505_setLoops)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
HX_DEFINE_DYNAMIC_FUNC1(NativeAudioSource_obj,setLoops,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::getPosition(){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_510_getPosition)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,getPosition,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::setPosition( ::lime::math::Vector4 value){
            	HX_STACKFRAME(&_hx_pos_7fb49d574da4e22e_521_setPosition)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
