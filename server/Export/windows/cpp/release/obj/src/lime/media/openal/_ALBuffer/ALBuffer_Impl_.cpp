...
Dynamic ALBuffer_Impl__obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic ALBuffer_Impl__obj::_new( ::Dynamic handle){
            	HX_STACK_FRAME("lime.media.openal._ALBuffer.ALBuffer_Impl_","_new",0x1ea1d24a,"lime.media.openal._ALBuffer.ALBuffer_Impl_._new","lime/media/openal/ALBuffer.hx",12,0xb4fc5d3e)
