...
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_603_new,"lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",603,0x95055f23)
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_613_isLocal,"lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",613,0x95055f23)
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_614_exists,"lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",614,0x95055f23)
namespace lime{
namespace utils{
namespace _Assets{

void LibrarySymbol_obj::__construct(::String id){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_603_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 605)		HX_VARI( int,colonIndex) = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 606)		this->libraryName = id.substring((int)0,colonIndex);
HXLINE( 607)		this->symbolName = id.substring((colonIndex + (int)1),null());
...
bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_613_isLocal)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 613)		return this->library->isLocal(this->symbolName,type);
            	}
...
bool LibrarySymbol_obj::exists(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_614_exists)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 614)		return this->library->exists(this->symbolName,type);
            	}
