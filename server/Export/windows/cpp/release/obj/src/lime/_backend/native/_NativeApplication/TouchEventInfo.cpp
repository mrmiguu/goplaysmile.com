...
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1045_new,"lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1045,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1061_clone,"lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1061,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1045_new)
            	HX_STACK_THIS(this)
...
HXLINE(1047)		this->type = type;
HXLINE(1048)		this->x = x;
HXLINE(1049)		this->y = y;
HXLINE(1050)		this->id = id;
HXLINE(1051)		this->dx = dx;
HXLINE(1052)		this->dy = dy;
HXLINE(1053)		this->pressure = pressure;
HXLINE(1054)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1061_clone)
            	HX_STACK_THIS(this)
HXLINE(1061)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
