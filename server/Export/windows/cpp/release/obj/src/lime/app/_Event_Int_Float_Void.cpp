...
void _Event_Int_Float_Void_obj::__construct(){
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","new",0x70f46217,"lime.app._Event_Int_Float_Void.new","lime/app/Event.hx",31,0xbda45bec)
            	HX_STACK_THIS(this)
...
Int priority = __o_priority.Default(0);
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","add",0x70ea83d8,"lime.app._Event_Int_Float_Void.add","lime/app/Event.hx",43,0xbda45bec)
            	HX_STACK_THIS(this)
...
void _Event_Int_Float_Void_obj::cancel(){
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","cancel",0xbc7a0823,"lime.app._Event_Int_Float_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
            	HX_STACK_THIS(this)
...
Bool _Event_Int_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","has",0x70efd111,"lime.app._Event_Int_Float_Void.has","lime/app/Event.hx",257,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 260)		{
...
void _Event_Int_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","remove",0x08ceb6ed,"lime.app._Event_Int_Float_Void.remove","lime/app/Event.hx",272,0xbda45bec)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void _Event_Int_Float_Void_obj::dispatch(Int a,Float a1){
            	HX_STACK_FRAME("lime.app._Event_Int_Float_Void","dispatch",0x5464a5a3,"lime.app._Event_Int_Float_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(a1,"a1")
