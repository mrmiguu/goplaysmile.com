...
Bool async = __o_async.Default(false);
            	HX_STACK_FRAME("lime.app.Future","new",0xc0e3b2bb,"lime.app.Future.new","lime/app/Future.hx",31,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(work,"work")
            	HX_STACK_ARG(async,"async")
HXLINE(  31)		Bool _hx_tmp = hx::IsNotNull( work );
HXDLIN(  31)		if (_hx_tmp) {
HXLINE(  33)			if (async) {
HXLINE(  35)				HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
...
Dynamic Future_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::app::Future Future_obj::onComplete( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Future","onComplete",0x3a7dc3fd,"lime.app.Future.onComplete","lime/app/Future.hx",74,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE(  76)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(  76)		if (_hx_tmp) {
HXLINE(  78)			Bool _hx_tmp1 = this->isComplete;
HXDLIN(  78)			if (_hx_tmp1) {
HXLINE(  80)				listener(this->value);
            			}
            			else {
HXLINE(  82)				Bool _hx_tmp2 = !(this->isError);
HXDLIN(  82)				if (_hx_tmp2) {
HXLINE(  84)					Bool _hx_tmp3 = hx::IsNull( this->_hx___completeListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onComplete,return )
 ...
 ::lime::app::Future Future_obj::onError( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Future","onError",0xb2071604,"lime.app.Future.onError","lime/app/Future.hx",101,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 103)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 105)			Bool _hx_tmp1 = this->isError;
HXDLIN( 105)			if (_hx_tmp1) {
HXLINE( 107)				listener(this->error);
            			}
            			else {
HXLINE( 109)				Bool _hx_tmp2 = !(this->isComplete);
HXDLIN( 109)				if (_hx_tmp2) {
HXLINE( 111)					Bool _hx_tmp3 = hx::IsNull( this->_hx___errorListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onError,return )
 ...
 ::lime::app::Future Future_obj::onProgress( ::Dynamic listener){
            	HX_STACK_FRAME("lime.app.Future","onProgress",0x40e0baf1,"lime.app.Future.onProgress","lime/app/Future.hx",128,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 130)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN( 130)		if (_hx_tmp) {
HXLINE( 132)			Bool _hx_tmp1 = hx::IsNull( this->_hx___progressListeners );
...
Int waitTime = __o_waitTime.Default(-1);
            	HX_STACK_FRAME("lime.app.Future","ready",0xd4cc0f7e,"lime.app.Future.ready","lime/app/Future.hx",164,0x058e0853)
            	HX_STACK_THIS(this)
...
HXLINE( 170)			HX_VARI( Int,time) = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 171)			HX_VAR( Int,end);
HXDLIN( 171)			if ((waitTime > (int)-1)) {
HXLINE( 171)				end = (time + waitTime);
            			}
            			else {
HXLINE( 171)				end = time;
            			}
...
Int waitTime = __o_waitTime.Default(-1);
            	HX_STACK_FRAME("lime.app.Future","result",0x69b43162,"lime.app.Future.result","lime/app/Future.hx",192,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(waitTime,"waitTime")
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,result,return )
 ...
 ::lime::app::Future Future_obj::then( ::Dynamic next){
            	HX_STACK_FRAME("lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",211,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(next,"next")
HXLINE( 211)		Bool _hx_tmp = this->isComplete;
HXDLIN( 211)		if (_hx_tmp) {
HXLINE( 213)			return ( ( ::lime::app::Future)(next(this->value)) );
            		}
            		else {
HXLINE( 215)			Bool _hx_tmp1 = this->isError;
HXDLIN( 215)			if (_hx_tmp1) {
HXLINE( 217)				HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__new(null(),null());
...
HXLINE( 219)				return future;
            				...
            				void _hx_run( ::Dynamic val){
            					HX_STACK_FRAME("lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",228,0x058e0853)
            					HX_STACK_ARG(val,"val")
HXLINE( 230)					HX_VARI_NAME(  ::lime::app::Future,future1,"future") = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 231)					future1->onError(promise->error_dyn());
HXLINE( 232)					future1->onComplete(promise->complete_dyn());
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 223)				HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,then,return )
 ...
 ::lime::app::Future Future_obj::ofEvents( ::lime::app::_Event_ofEvents_T_Void onComplete, ::lime::app::_Event_Dynamic_Void onError, ::lime::app::_Event_Int_Int_Void onProgress){
            		...
            		void _hx_run( ::Dynamic data){
            			HX_STACK_FRAME("lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",65,0x058e0853)
...
HXLINE(  63)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
HXLINE(  65)		onComplete->add( ::Dynamic(new _hx_Closure_0(promise)),true,null());
HXLINE(  66)		Bool _hx_tmp = hx::IsNotNull( onError );
HXDLIN(  66)		if (_hx_tmp) {
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::lime::app::Promise,promise) HXARGC(1)
            			void _hx_run( ::Dynamic error){
            				HX_STACK_FRAME("lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",66,0x058e0853)
...
HXLINE(  67)		Bool _hx_tmp1 = hx::IsNotNull( onProgress );
HXDLIN(  67)		if (_hx_tmp1) {
            			...
            			void _hx_run(Int progress,Int total){
            				HX_STACK_FRAME("lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",67,0x058e0853)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Future_obj,ofEvents,return )
 ...
 ::lime::app::Future Future_obj::withError( ::Dynamic error){
            	HX_STACK_FRAME("lime.app.Future","withError",0xc7ddc87d,"lime.app.Future.withError","lime/app/Future.hx",243,0x058e0853)
            	HX_STACK_ARG(error,"error")
HXLINE( 245)		HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__new(null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Future_obj,withError,return )
 ...
 ::lime::app::Future Future_obj::withValue( ::Dynamic value){
            	HX_STACK_FRAME("lime.app.Future","withValue",0x866c7c26,"lime.app.Future.withValue","lime/app/Future.hx",253,0x058e0853)
            	HX_STACK_ARG(value,"value")
HXLINE( 255)		HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__new(null(),null());
