...
Bool ALC_obj::closeDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.openal.ALC","closeDevice",0x299f7402,"lime.media.openal.ALC.closeDevice","lime/media/openal/ALC.hx",44,0x4354dabb)
            	HX_STACK_ARG(device,"device")
HXLINE(  44)		return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_close_device(hx::DynamicPtr(device))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,closeDevice,return )
 ...
 ::Dynamic ALC_obj::createContext( ::Dynamic device,::Array< Int > attrlist){
            	HX_STACK_FRAME("lime.media.openal.ALC","createContext",0xb9806ce7,"lime.media.openal.ALC.createContext","lime/media/openal/ALC.hx",52,0x4354dabb)
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(attrlist,"attrlist")
HXLINE(  55)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(device);
HXDLIN(  55)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_create_context(_hx_tmp,hx::DynamicPtr(attrlist))) );
HXDLIN(  55)		HX_VARI(  ::Dynamic,handle) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  57)		Bool _hx_tmp1 = hx::IsNotNull( handle );
...
void ALC_obj::destroyContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.openal.ALC","destroyContext",0x9b5c4701,"lime.media.openal.ALC.destroyContext","lime/media/openal/ALC.hx",72,0x4354dabb)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,destroyContext,(void))
 ...
 ::Dynamic ALC_obj::getContextsDevice( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.openal.ALC","getContextsDevice",0x197cc724,"lime.media.openal.ALC.getContextsDevice","lime/media/openal/ALC.hx",78,0x4354dabb)
            	HX_STACK_ARG(context,"context")
HXLINE(  81)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_contexts_device(hx::DynamicPtr(context))) );
HXDLIN(  81)		HX_VARI(  ::Dynamic,handle) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  83)		Bool _hx_tmp = hx::IsNotNull( handle );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,getContextsDevice,return )
 ...
 ::Dynamic ALC_obj::getCurrentContext(){
            	HX_STACK_FRAME("lime.media.openal.ALC","getCurrentContext",0x166a9280,"lime.media.openal.ALC.getCurrentContext","lime/media/openal/ALC.hx",95,0x4354dabb)
HXLINE(  98)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_current_context()) );
HXDLIN(  98)		HX_VARI(  ::Dynamic,handle) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 100)		Bool _hx_tmp = hx::IsNotNull( handle );
...
Int ALC_obj::getError( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.openal.ALC","getError",0xb0a3653e,"lime.media.openal.ALC.getError","lime/media/openal/ALC.hx",115,0x4354dabb)
            	HX_STACK_ARG(device,"device")
HXLINE( 115)		return ( (Int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_error(hx::DynamicPtr(device))) );
            	}
...
::String ALC_obj::getErrorString( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.openal.ALC","getErrorString",0x9cb484af,"lime.media.openal.ALC.getErrorString","lime/media/openal/ALC.hx",125,0x4354dabb)
            	HX_STACK_ARG(device,"device")
HXLINE( 125)		HX_VARI( Int,_g) = ::lime::media::openal::ALC_obj::getError(device);
...
::Array< Int > ALC_obj::getIntegerv( ::Dynamic device,Int param,Int size){
            	HX_STACK_FRAME("lime.media.openal.ALC","getIntegerv",0x44f57d42,"lime.media.openal.ALC.getIntegerv","lime/media/openal/ALC.hx",142,0x4354dabb)
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(size,"size")
HXLINE( 142)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_integerv(hx::DynamicPtr(device),param,size)) );
HXDLIN( 142)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String ALC_obj::getString( ::Dynamic device,Int param){
            	HX_STACK_FRAME("lime.media.openal.ALC","getString",0x9e1cd69b,"lime.media.openal.ALC.getString","lime/media/openal/ALC.hx",153,0x4354dabb)
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
HXLINE( 153)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_get_string(hx::DynamicPtr(device),param)) );
HXDLIN( 153)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Bool ALC_obj::makeContextCurrent( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.openal.ALC","makeContextCurrent",0x65611584,"lime.media.openal.ALC.makeContextCurrent","lime/media/openal/ALC.hx",164,0x4354dabb)
            	HX_STACK_ARG(context,"context")
HXLINE( 164)		return ( (Bool)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_make_context_current(hx::DynamicPtr(context))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,makeContextCurrent,return )
 ...
 ::Dynamic ALC_obj::openDevice(::String deviceName){
            	HX_STACK_FRAME("lime.media.openal.ALC","openDevice",0x31de24ec,"lime.media.openal.ALC.openDevice","lime/media/openal/ALC.hx",172,0x4354dabb)
            	HX_STACK_ARG(deviceName,"deviceName")
HXLINE( 175)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_alc_open_device(deviceName)) );
HXDLIN( 175)		HX_VARI(  ::Dynamic,handle) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 177)		Bool _hx_tmp = hx::IsNotNull( handle );
...
void ALC_obj::pauseDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.openal.ALC","pauseDevice",0x636035c0,"lime.media.openal.ALC.pauseDevice","lime/media/openal/ALC.hx",192,0x4354dabb)
            	HX_STACK_ARG(device,"device")
...
void ALC_obj::processContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.openal.ALC","processContext",0xe14e9a2c,"lime.media.openal.ALC.processContext","lime/media/openal/ALC.hx",201,0x4354dabb)
            	HX_STACK_ARG(context,"context")
...
void ALC_obj::resumeDevice( ::Dynamic device){
            	HX_STACK_FRAME("lime.media.openal.ALC","resumeDevice",0x6ff2aa0f,"lime.media.openal.ALC.resumeDevice","lime/media/openal/ALC.hx",210,0x4354dabb)
            	HX_STACK_ARG(device,"device")
...
void ALC_obj::suspendContext( ::Dynamic context){
            	HX_STACK_FRAME("lime.media.openal.ALC","suspendContext",0x143578bf,"lime.media.openal.ALC.suspendContext","lime/media/openal/ALC.hx",219,0x4354dabb)
            	HX_STACK_ARG(context,"context")
...
{
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",18,0x4354dabb)
HXLINE(  18)		FALSE = (int)0;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",19,0x4354dabb)
HXLINE(  19)		TRUE = (int)1;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",20,0x4354dabb)
HXLINE(  20)		FREQUENCY = (int)4103;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",21,0x4354dabb)
HXLINE(  21)		REFRESH = (int)4104;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",22,0x4354dabb)
HXLINE(  22)		SYNC = (int)4105;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",23,0x4354dabb)
HXLINE(  23)		MONO_SOURCES = (int)4112;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",24,0x4354dabb)
HXLINE(  24)		STEREO_SOURCES = (int)4113;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",25,0x4354dabb)
HXLINE(  25)		NO_ERROR = (int)0;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",26,0x4354dabb)
HXLINE(  26)		INVALID_DEVICE = (int)40961;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",27,0x4354dabb)
HXLINE(  27)		INVALID_CONTEXT = (int)40962;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",28,0x4354dabb)
HXLINE(  28)		INVALID_ENUM = (int)40963;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",29,0x4354dabb)
HXLINE(  29)		INVALID_VALUE = (int)40964;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",30,0x4354dabb)
HXLINE(  30)		OUT_OF_MEMORY = (int)40965;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",31,0x4354dabb)
HXLINE(  31)		ATTRIBUTES_SIZE = (int)4098;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",32,0x4354dabb)
HXLINE(  32)		ALL_ATTRIBUTES = (int)4099;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",33,0x4354dabb)
HXLINE(  33)		DEFAULT_DEVICE_SPECIFIER = (int)4100;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",34,0x4354dabb)
HXLINE(  34)		DEVICE_SPECIFIER = (int)4101;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",35,0x4354dabb)
HXLINE(  35)		EXTENSIONS = (int)4102;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",36,0x4354dabb)
HXLINE(  36)		ENUMERATE_ALL_EXT = (int)1;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",37,0x4354dabb)
HXLINE(  37)		DEFAULT_ALL_DEVICES_SPECIFIER = (int)4114;
            	}
{
            	HX_STACK_FRAME("lime.media.openal.ALC","boot",0x83dfa81e,"lime.media.openal.ALC.boot","lime/media/openal/ALC.hx",38,0x4354dabb)
