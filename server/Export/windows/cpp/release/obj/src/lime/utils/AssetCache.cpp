...
HX_DEFINE_STACK_FRAME(_hx_pos_77dd7e775494cb08_34_exists,"lime.utils.AssetCache","exists",0x81df4ea2,"lime.utils.AssetCache.exists","lime/utils/AssetCache.hx",34,0xcfac28d4)
HX_DEFINE_STACK_FRAME(_hx_pos_77dd7e775494cb08_61_set,"lime.utils.AssetCache","set",0x2058d31c,"lime.utils.AssetCache.set","lime/utils/AssetCache.hx",61,0xcfac28d4)
HX_DEFINE_STACK_FRAME(_hx_pos_77dd7e775494cb08_88_clear,"lime.utils.AssetCache","clear",0x54b4fb87,"lime.utils.AssetCache.clear","lime/utils/AssetCache.hx",88,0xcfac28d4)
namespace lime{
namespace utils{
...
HXLINE(  29)		this->version = (int)617550;
            	}
...
HXLINE(  98)			while(( (bool)(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  98)				HX_VARI( ::String,key) = ( (::String)(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 100)				if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE( 102)					this->audio->remove(key);
            				}
            			}
HXLINE( 108)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE( 110)			while(( (bool)(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 110)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 112)				if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 114)					this->font->remove(key1);
            				}
            			}
HXLINE( 120)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->image->keys();
HXLINE( 122)			while(( (bool)(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 122)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 124)				if (::StringTools_obj::startsWith(key2,prefix)) {
