...
HXLINE( 107)		switch((int)(format)){
            			case (int)0: {
HXLINE( 118)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),((int)hx::UShr(this1,(int)8) & (int)(int)255));
HXLINE( 119)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)1)),((int)hx::UShr(this1,(int)16) & (int)(int)255));
HXLINE( 120)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)2)),((int)hx::UShr(this1,(int)24) & (int)(int)255));
...
HXLINE( 126)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)1)),((int)hx::UShr(this1,(int)8) & (int)(int)255));
HXLINE( 127)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)2)),((int)hx::UShr(this1,(int)16) & (int)(int)255));
HXLINE( 128)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)3)),((int)hx::UShr(this1,(int)24) & (int)(int)255));
            			}
            			break;
            			case (int)2: {
HXLINE( 111)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),((int)hx::UShr(this1,(int)24) & (int)(int)255));
HXLINE( 112)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)1)),((int)hx::UShr(this1,(int)16) & (int)(int)255));
HXLINE( 113)				::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + (int)2)),((int)hx::UShr(this1,(int)8) & (int)(int)255));
