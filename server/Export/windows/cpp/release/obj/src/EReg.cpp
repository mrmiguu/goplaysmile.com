...
HX_DEFINE_STACK_FRAME(_hx_pos_2cd113ad60e10261_38_match,"EReg","match",0x18fda1a6,"EReg.match","C:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",38,0xa4513ee9)
HX_DEFINE_STACK_FRAME(_hx_pos_2cd113ad60e10261_49_matched,"EReg","matched",0x8ce62f85,"EReg.matched","C:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",49,0xa4513ee9)
HX_DEFINE_STACK_FRAME(_hx_pos_2cd113ad60e10261_64_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","C:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",64,0xa4513ee9)
HX_DEFINE_STACK_FRAME(_hx_pos_2cd113ad60e10261_67_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","C:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",67,0xa4513ee9)
HX_DEFINE_STACK_FRAME(_hx_pos_2cd113ad60e10261_100_replace,"EReg","replace",0xae923ad5,"EReg.replace","C:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",100,0xa4513ee9)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_2cd113ad60e10261_49_matched)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
...
HXDLIN(  68)		HX_VARI_NAME( bool,p1,"p") = _hx_regexp_match(this->r,s,pos,p);
HXLINE(  69)		if (p1) {
...
::String EReg_obj::replace(::String s,::String by){
            	...
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(by,"by")
HXLINE( 101)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 113)				p->__SetField(HX_("pos",94,5d,55,00),(( (int)(p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ) + (int)1),hx::paccDynamic);
            			}
HXLINE( 115)			{
...
HXLINE( 115)					HX_VARI_NAME( ::Array< ::String >,b1,"b") = b->b;
HXDLIN( 115)					b1->push(s.substr(pos,len1));
            				}
            			}
HXLINE( 116)			if ((a->length > (int)0)) {
HXLINE( 117)				HX_VARI( ::String,x) = a->__get((int)0);
...
HXLINE( 117)					HX_VARI_NAME( ::Array< ::String >,b2,"b") = b->b;
...
HXLINE( 124)						HX_VARI_NAME(  ::Dynamic,p2,"p") = this->r;
HXDLIN( 124)						p1 = _hx_regexp_matched_pos(p2,(::Std_obj::_hx_int(c) - (int)48));
            					}
            					catch( ::Dynamic _hx_e){
...
HXLINE( 127)								HX_VARI_NAME( ::Array< ::String >,b3,"b") = b->b;
...
HXLINE( 129)								HX_VARI_NAME( ::Array< ::String >,b4,"b") = b->b;
...
HXLINE( 130)								HX_VARI_NAME( ::Array< ::String >,b5,"b") = b->b;
...
HXLINE( 137)								HX_VARI_NAME( ::Array< ::String >,b6,"b") = b->b;
HXDLIN( 137)								b6->push(::Std_obj::string(k2));
            							}
            						}
            					}
            					else {
HXLINE( 139)						HX_VARI_NAME( ::String,x1,"x") = (HX_("$",24,00,00,00) + k);
...
HXLINE( 139)							HX_VARI_NAME( ::Array< ::String >,b7,"b") = b->b;
...
HXLINE( 147)				HX_VARI_NAME( ::Array< ::String >,b8,"b") = b->b;
