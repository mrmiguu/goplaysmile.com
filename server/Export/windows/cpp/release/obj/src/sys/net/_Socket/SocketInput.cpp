...
Int SocketInput_obj::readByte(){
            	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",36,0xa375f0f1)
            	HX_STACK_THIS(this)
HXLINE(  36)		try {
...
void SocketInput_obj::close(){
            	HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",65,0xa375f0f1)
            	HX_STACK_THIS(this)
