...
void SocketOutput_obj::writeByte(Int c){
            	HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",80,0xa375f0f1)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
...
Int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,Int pos,Int len){
            	HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",94,0xa375f0f1)
            	HX_STACK_THIS(this)
...
void SocketOutput_obj::close(){
            	HX_STACK_FRAME("sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",106,0xa375f0f1)
            	HX_STACK_THIS(this)
