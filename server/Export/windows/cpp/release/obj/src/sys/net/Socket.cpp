...
void Socket_obj::__construct(){
            	HX_STACK_FRAME("sys.net.Socket","new",0x202a8cf7,"sys.net.Socket.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",123,0xa375f0f1)
            	HX_STACK_THIS(this)
...
void Socket_obj::init(){
            	HX_STACK_FRAME("sys.net.Socket","init",0x01c98299,"sys.net.Socket.init","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",126,0xa375f0f1)
            	HX_STACK_THIS(this)
...
void Socket_obj::listen(Int connections){
            	HX_STACK_FRAME("sys.net.Socket","listen",0x81cfc410,"sys.net.Socket.listen","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",170,0xa375f0f1)
            	HX_STACK_THIS(this)
...
void Socket_obj::bind( ::sys::net::Host host,Int port){
            	HX_STACK_FRAME("sys.net.Socket","bind",0xfd253d46,"sys.net.Socket.bind","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",178,0xa375f0f1)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(Socket_obj,bind,(void))
 ...
 ::sys::net::Socket Socket_obj::accept(){
            	HX_STACK_FRAME("sys.net.Socket","accept",0x9cdc8ed1,"sys.net.Socket.accept","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",181,0xa375f0f1)
            	HX_STACK_THIS(this)
...
HXLINE( 184)		s->__s = c;
HXLINE( 185)		s->input =  ::sys::net::_Socket::SocketInput_obj::__new(c);
HXLINE( 186)		s->output =  ::sys::net::_Socket::SocketOutput_obj::__new(c);
HXLINE( 187)		return s;
            	}
...
void Socket_obj::setBlocking(Bool b){
            	HX_STACK_FRAME("sys.net.Socket","setBlocking",0xe5689b0e,"sys.net.Socket.setBlocking","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",219,0xa375f0f1)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
...
void Socket_obj::setFastSend(Bool b){
            	HX_STACK_FRAME("sys.net.Socket","setFastSend",0x54236f5d,"sys.net.Socket.setFastSend","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",223,0xa375f0f1)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
...
HX_DEFINE_DYNAMIC_FUNC1(Socket_obj,setFastSend,(void))
 ...
 ::Dynamic Socket_obj::select(::Array< ::Dynamic> read,::Array< ::Dynamic> write,::Array< ::Dynamic> others, ::Dynamic timeout){
            	HX_STACK_FRAME("sys.net.Socket","select",0xfc0916c5,"sys.net.Socket.select","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Socket.hx",226,0xa375f0f1)
