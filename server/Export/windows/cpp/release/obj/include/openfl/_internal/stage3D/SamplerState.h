...
HX_DECLARE_STACK_FRAME(_hx_pos_a3b6e1b35b0e3bd8_21_new)
...
HXLINE(  23)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_minFilter(minFilter);
HXLINE(  24)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_magFilter(magFilter);
HXLINE(  25)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_wrapModeS(wrapModeS);
HXLINE(  26)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_wrapModeT(wrapModeT);
HXLINE(  27)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_lodBias(lodBias);
HXLINE(  28)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->set_maxAniso(maxAniso);
HXLINE(  29)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->ignoreSampler = ignoreSampler;
HXLINE(  30)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->centroid = centroid;
HXLINE(  31)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->mipmapGenerated = mipmapGenerated;
HXLINE(  33)		( ( ::openfl::_internal::stage3D::SamplerState)(__this) )->_hx___samplerDirty = true;
            	}
