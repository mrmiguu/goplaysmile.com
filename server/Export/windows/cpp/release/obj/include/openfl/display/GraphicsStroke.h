...
class HXCPP_CLASS_ATTRIBUTES GraphicsStroke_obj : public hx::Object
{
	...
	public:
		...
		void __construct(hx::Null< Float >  __o_thickness,hx::Null< bool >  __o_pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,hx::Null< Float >  __o_miterLimit,::Dynamic fill);
		...
		static hx::ObjectPtr< GraphicsStroke_obj > __new(hx::Null< Float >  __o_thickness,hx::Null< bool >  __o_pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,hx::Null< Float >  __o_miterLimit,::Dynamic fill);
		static hx::ObjectPtr< GraphicsStroke_obj > __alloc(hx::Ctx *_hx_ctx,hx::Null< Float >  __o_thickness,hx::Null< bool >  __o_pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints,hx::Null< Float >  __o_miterLimit,::Dynamic fill);
