...
class HXCPP_CLASS_ATTRIBUTES Tile_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< Tile_obj > __alloc(hx::Ctx *_hx_ctx,hx::Null< int >  __o_id,hx::Null< Float >  __o_x,hx::Null< Float >  __o_y,hx::Null< Float >  __o_scaleX,hx::Null< Float >  __o_scaleY,hx::Null< Float >  __o_rotation);
