...
HXLINE(  43)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->activeTextures = (int)0;
HXLINE(  59)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->allowSmoothing = true;
            	}
