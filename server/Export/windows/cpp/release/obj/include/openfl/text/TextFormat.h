...
HX_DECLARE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_27_new)
...
HXLINE(  29)		( ( ::openfl::text::TextFormat)(__this) )->font = font;
HXLINE(  30)		( ( ::openfl::text::TextFormat)(__this) )->size = size;
HXLINE(  31)		( ( ::openfl::text::TextFormat)(__this) )->color = color;
HXLINE(  32)		( ( ::openfl::text::TextFormat)(__this) )->bold = bold;
HXLINE(  33)		( ( ::openfl::text::TextFormat)(__this) )->italic = italic;
HXLINE(  34)		( ( ::openfl::text::TextFormat)(__this) )->underline = underline;
HXLINE(  35)		( ( ::openfl::text::TextFormat)(__this) )->url = url;
HXLINE(  36)		( ( ::openfl::text::TextFormat)(__this) )->target = target;
HXLINE(  37)		( ( ::openfl::text::TextFormat)(__this) )->align = align;
HXLINE(  38)		( ( ::openfl::text::TextFormat)(__this) )->leftMargin = leftMargin;
HXLINE(  39)		( ( ::openfl::text::TextFormat)(__this) )->rightMargin = rightMargin;
HXLINE(  40)		( ( ::openfl::text::TextFormat)(__this) )->indent = indent;
HXLINE(  41)		( ( ::openfl::text::TextFormat)(__this) )->leading = leading;
            	}
