...
class HXCPP_CLASS_ATTRIBUTES Texture_obj : public  ::openfl::display3D::textures::TextureBase_obj
{
	...
	public:
		...
		static int _hx___getATFVersion( ::openfl::utils::ByteArrayData data);
		static ::Dynamic _hx___getATFVersion_dyn();

		static int _hx___readUInt24( ::openfl::utils::ByteArrayData data);
		static ::Dynamic _hx___readUInt24_dyn();

		static int _hx___readUInt32( ::openfl::utils::ByteArrayData data);
		static ::Dynamic _hx___readUInt32_dyn();
