...
HX_DECLARE_STACK_FRAME(_hx_pos_e18280422777664c_19_new)
...
HXLINE(  21)		( ( ::openfl::display::ShaderInput_openfl_display_BitmapData)(__this) )->channels = (int)0;
HXLINE(  22)		( ( ::openfl::display::ShaderInput_openfl_display_BitmapData)(__this) )->height = (int)0;
HXLINE(  23)		( ( ::openfl::display::ShaderInput_openfl_display_BitmapData)(__this) )->index = (int)0;
HXLINE(  24)		( ( ::openfl::display::ShaderInput_openfl_display_BitmapData)(__this) )->width = (int)0;
            	}
