...
class HXCPP_CLASS_ATTRIBUTES Assets_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< Assets_obj > __alloc(hx::Ctx *_hx_ctx) {
			Assets_obj *__this = (Assets_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Assets_obj), false, "openfl.Assets"));
