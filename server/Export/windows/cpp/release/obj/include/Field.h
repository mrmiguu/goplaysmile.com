...
class HXCPP_CLASS_ATTRIBUTES Field_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		void __construct( ::Globals g,Float x,Float y,hx::Null< bool >  __o_pw);
		...
		static hx::ObjectPtr< Field_obj > __new( ::Globals g,Float x,Float y,hx::Null< bool >  __o_pw);
		static hx::ObjectPtr< Field_obj > __alloc(hx::Ctx *_hx_ctx, ::Globals g,Float x,Float y,hx::Null< bool >  __o_pw);
		...
		void password(bool tf);
		::Dynamic password_dyn();
