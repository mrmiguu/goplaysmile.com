...
HX_DECLARE_STACK_FRAME(_hx_pos_38f389caf85c6b40_33_new)
...
HXLINE(  34)		( ( ::sys::net::Host)(__this) )->host = name;
HXLINE(  35)		( ( ::sys::net::Host)(__this) )->ip = _hx_std_host_resolve(name);
            	}
