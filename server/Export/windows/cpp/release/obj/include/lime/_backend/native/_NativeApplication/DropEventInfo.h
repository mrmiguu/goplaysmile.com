...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_724_new)
...
HXLINE( 726)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 727)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
