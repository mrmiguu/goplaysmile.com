...
HX_DECLARE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1089_new)
...
int y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1091)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->type = type;
HXLINE(1092)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1093)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->width = width;
HXLINE(1094)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->height = height;
HXLINE(1095)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->x = x;
HXLINE(1096)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->y = y;
            	}
