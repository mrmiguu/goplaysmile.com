...
HX_DECLARE_STACK_FRAME(_hx_pos_3b7a66bddb205621_759_new)
...
HXLINE( 761)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->type = type;
HXLINE( 762)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->id = id;
HXLINE( 763)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->button = button;
HXLINE( 764)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 765)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->value = value;
            	}
