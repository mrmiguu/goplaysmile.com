...
HX_DECLARE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1045_new)
...
HXLINE(1047)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->type = type;
HXLINE(1048)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->x = x;
HXLINE(1049)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->y = y;
HXLINE(1050)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->id = id;
HXLINE(1051)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1052)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1053)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1054)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->device = device;
            	}
